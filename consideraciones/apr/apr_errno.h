/* Licensed to the Apache Software Foundation (ASF) under one or more  * contributor license agreements.  See the NOTICE file distributed with  * this work for additional information regarding copyright ownership.  * The ASF licenses this file to You under the Apache License, Version 2.0  * (the "License"); you may not use this file except in compliance with  * the License.  You may obtain a copy of the License at  *  *     http://www.apache.org/licenses/LICENSE-2.0  *
  ...
  *      and folds it with APR_FROM_OS_ERROR.
    ...
    *
    * Subversion - Defined ranges, of less than  00, at intervals of 5000
    *              starting at an offset of 5000, e.g.
    *               +5000 to 5 00,  + 0000 to  0 00
    *
    ...
    *
    *  00,000      APR_UTIL_START_STATUS
    *
    *         + APR_UTIL_ERRSPACE_SIZE (20,000)
    *
    *  20,000      APR_OS_START_USERERR
    *
    *         +  0 x APR_OS_ERRSPACE_SIZE (50,000 *  0)
    *
   ...
   #define APR_ENOSTAT        (APR_OS_START_ERROR +  )
   ...
   #define APR_ENOPOLL        (APR_OS_START_ERROR +  0)
   /** @see APR_STATUS_IS_ENOSOCKET */
   #define APR_ENOSOCKET      (APR_OS_START_ERROR +   )
   /** @see APR_STATUS_IS_ENOTHREAD */
   #define APR_ENOTHREAD      (APR_OS_START_ERROR +  2)
   /** @see APR_STATUS_IS_ENOTHDKEY */
   #define APR_ENOTHDKEY      (APR_OS_START_ERROR +  3)
   /** @see APR_STATUS_IS_EGENERAL */
   #define APR_EGENERAL       (APR_OS_START_ERROR +  4)
   /** @see APR_STATUS_IS_ENOSHMAVAIL */
   #define APR_ENOSHMAVAIL    (APR_OS_START_ERROR +  5)
   /** @see APR_STATUS_IS_EBADIP */
   #define APR_EBADIP         (APR_OS_START_ERROR +  6)
   /** @see APR_STATUS_IS_EBADMASK */
   #define APR_EBADMASK       (APR_OS_START_ERROR +  7)
   /* empty slot: + 8 */
   /** @see APR_STATUS_IS_EDSOPEN */
   #define APR_EDSOOPEN       (APR_OS_START_ERROR +  9)
   /** @see APR_STATUS_IS_EABSOLUTE */
   #define APR_EABSOLUTE      (APR_OS_START_ERROR + 20)
   /** @see APR_STATUS_IS_ERELATIVE */
   #define APR_ERELATIVE      (APR_OS_START_ERROR + 2 )
   ...
   #define APR_INCHILD        (APR_OS_START_STATUS +  )
   ...
   #define APR_BADCH          (APR_OS_START_STATUS +  2)
   /** @see APR_STATUS_IS_BADARG */
   #define APR_BADARG         (APR_OS_START_STATUS +  3)
   /** @see APR_STATUS_IS_EOF */
   #define APR_EOF            (APR_OS_START_STATUS +  4)
   /** @see APR_STATUS_IS_NOTFOUND */
   #define APR_NOTFOUND       (APR_OS_START_STATUS +  5)
   /* empty slot: + 6 */
   /* empty slot: + 7 */
   /* empty slot: + 8 */
   /** @see APR_STATUS_IS_ANONYMOUS */
   #define APR_ANONYMOUS      (APR_OS_START_STATUS +  9)
   /** @see APR_STATUS_IS_FILEBASED */
   #define APR_FILEBASED      (APR_OS_START_STATUS + 20)
   /** @see APR_STATUS_IS_KEYBASED */
   #define APR_KEYBASED       (APR_OS_START_STATUS + 2 )
   ...
   #else
   #define APR_EACCES         (APR_OS_START_CANONERR +  )
   #endif
   ...
   #else
   #define APR_EBADF          (APR_OS_START_CANONERR +  0)
   #endif
   ...
   #else
   #define APR_EINVAL         (APR_OS_START_CANONERR +   )
   #endif
   ...
   #else
   #define APR_ESPIPE         (APR_OS_START_CANONERR +  2)
   #endif
   ...
   #else
   #define APR_EAGAIN         (APR_OS_START_CANONERR +  3)
   #endif
   ...
   #else
   #define APR_EINTR          (APR_OS_START_CANONERR +  4)
   #endif
   ...
   #else
   #define APR_ENOTSOCK       (APR_OS_START_CANONERR +  5)
   #endif
   ...
   #else
   #define APR_ECONNREFUSED   (APR_OS_START_CANONERR +  6)
   #endif
   ...
   #else
   #define APR_EINPROGRESS    (APR_OS_START_CANONERR +  7)
   #endif
   ...
   #else
   #define APR_ECONNABORTED   (APR_OS_START_CANONERR +  8)
   #endif
   ...
   #else
   #define APR_ECONNRESET     (APR_OS_START_CANONERR +  9)
   #endif
   ...
   #else
   #define APR_EHOSTUNREACH   (APR_OS_START_CANONERR + 2 )
   #endif
    ...
    */
   #define SOCBASEERR               0000
   #define SOCEPERM                (SOCBASEERR+ )             /* Not owner */
   #define SOCESRCH                (SOCBASEERR+3)             /* No such process */
   #define SOCEINTR                (SOCBASEERR+4)             /* Interrupted system call */
   #define SOCENXIO                (SOCBASEERR+6)             /* No such device or address */
   #define SOCEBADF                (SOCBASEERR+9)             /* Bad file number */
   #define SOCEACCES               (SOCBASEERR+ 3)            /* Permission denied */
   #define SOCEFAULT               (SOCBASEERR+ 4)            /* Bad address */
   #define SOCEINVAL               (SOCBASEERR+22)            /* Invalid argument */
   #define SOCEMFILE               (SOCBASEERR+24)            /* Too many open files */
   #define SOCEPIPE                (SOCBASEERR+32)            /* Broken pipe */
   #define SOCEOS2ERR              (SOCBASEERR+ 00)           /* OS/2 Error */
   ...
   #define SOCEPROTOTYPE           (SOCBASEERR+4 )            /* Protocol wrong type for socket */
   ...
   #define SOCENETUNREACH          (SOCBASEERR+5 )            /* Network is unreachable */
   ...
   #define SOCECONNREFUSED         (SOCBASEERR+6 )            /* Connection refused */
   ...
   */
    ...
    * ignore it for them.  See discussion in new-httpd archives nh.970  & nh.9603
    *
    ...
    * systems, EPROTO can actually result in a fatal loop.  See PR#98  for
