...
#ifndef UCI_BASE_FLOATACCESSOR_H
#define UCI_BASE_FLOATACCESSOR_H
...
/** The FloatAccessor accessor class is used to provide access to uci::xs::Float data types. */
class FloatAccessor : public virtual Accessor {
public:
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const FloatAccessor& accessor) = 0;
  ...
  /** Sets the Float accessed by this FloatAccessor to the specified Float.
    ...
    */
  virtual uci::base::FloatAccessor& setFloatValue(xs::Float value) = 0;
  ...
  /** Assigns the value of the Float accessed by this FloatAccessor to the value of the Float accessed by the FloatAccessor
    ...
    */
  virtual FloatAccessor& operator=(const FloatAccessor& rhs) {
  ...
  /** Assigns the value of the Float accessed by this FloatAccessor to the value of the Float accessed by the FloatAccessor
    * on the right hand side (rhs) of the assignment operator.
    *
    * @param rhs The Float whose value will be used to set the value of the Float accessed by this accessor.
    * @return A constant reference to this FloatAccessor.
    */
  virtual FloatAccessor& operator=(xs::Float rhs) {
    setFloatValue(rhs);
    return *this;
  }

  /** Conversion operator to convert this FloatAccessor to an xs::Float.
    *
...
#endif // UCI_BASE_FLOATACCESSOR_H
