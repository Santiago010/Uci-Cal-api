...
#ifndef UCI_TYPE_TASKPLANSTATUSMT_H
#define UCI_TYPE_TASKPLANSTATUSMT_H
...
class TaskPlanStatusMT : public virtual MessageType {
public:

  /** This method constructs a new TaskPlanStatusMT.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed TaskPlanStatusMT.
    */
  static UCI_EXPORT TaskPlanStatusMT& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new TaskPlanStatusMT initializing the data accessed by the new TaskPlanStatusMT using the
    * data accessed by the specified TaskPlanStatusMT (cloning).
    *
    * @param accessor The TaskPlanStatusMT that provides access to the data that is to be used to initialize the data
    *      accessed by the new created TaskPlanStatusMT.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed TaskPlanStatusMT.
    */
  static UCI_EXPORT TaskPlanStatusMT& create(const TaskPlanStatusMT& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified TaskPlanStatusMT. Use of the specified accessor after it has been destroyed will
    * result in undefined behavior.
    *
    * @param accessor The TaskPlanStatusMT that is to be destroyed.
    */
  static UCI_EXPORT void destroy(TaskPlanStatusMT& accessor);

  /** Returns this accessor's type constant, i.e. taskPlanStatusMT.
    *
    * @return This accessor's type constant, i.e. taskPlanStatusMT.
    */
  virtual uci::base::accessorType::AccessorType getAccessorType() const noexception {
    return uci::type::accessorType::taskPlanStatusMT;
  }

  /** Returns the version that was initialized from the uci:version attribute of TaskPlanStatusMT.
    *
    * @return The version that was initialized from the uci:version attribute of TaskPlanStatusMT.
    */
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const TaskPlanStatusMT& accessor) = 0;
  ...
  /** Returns a const reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual const uci::type::TaskPlanStatusMDT& getMessageData() const = 0;
  ...
  /** Returns a reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual uci::type::TaskPlanStatusMDT& getMessageData() = 0;
  ...
  /** Sets the complex content identified by MessageData to the contents of the complex content accessed by the specified
    ...
    */
  virtual uci::type::TaskPlanStatusMT& setMessageData(const uci::type::TaskPlanStatusMDT& value) = 0;

  /** The Listener provides the support to listen and handle incoming messages of the type uci::type::TaskPlanStatusMT. */
  ...
  public:
    ...
    /** The method is used to handle incoming messages.
      ...
      */
    virtual void handleMessage(const uci::type::TaskPlanStatusMT& message) = 0;
  ...
  public:
    ...
    /** Adds a listener to this reader to handle incoming messages.
      ...
      */
    virtual void addListener(uci::type::TaskPlanStatusMT::Listener& listener) = 0;

    /** Removes the specified listener from this reader.
      *
      * @param listener The listener that is to be removed from this reader.
      */
    virtual void removeListener(uci::type::TaskPlanStatusMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s). Returns immediately if no messages are available.
      ...
      */
    virtual unsigned long readNoWait(unsigned long maxNumberOfMessages, uci::type::TaskPlanStatusMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s).
      ...
      * @return The number of messages that were handled.
      */
    virtual unsigned long read(unsigned long timeout, unsigned long maxNumberOfMessages, uci::type::TaskPlanStatusMT::Listener& listener) = 0;
  ...
  /** This method creates a new reader that can be used to read a TaskPlanStatusMT.
    *
    * @param topic The specification of the topic the reader is to read from.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A reader that can read a TaskPlanStatusMT.
    */
  static UCI_EXPORT uci::type::TaskPlanStatusMT::Reader& createReader(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a reader. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyReader(uci::type::TaskPlanStatusMT::Reader& reader);
  ...
  public:
    ...
    /** Writes the OMS message to the topic specified when this Writer was created.
      ...
      */
    virtual void write(uci::type::TaskPlanStatusMT& accessor) = 0;
  ...
  /** This method creates a new writer that can be used to write a TaskPlanStatusMT.
    *
    * @param topic The specification of the topic the writer is to write to.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A writer that can write a TaskPlanStatusMT.
    */
  static UCI_EXPORT uci::type::TaskPlanStatusMT::Writer& createWriter(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a writer. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyWriter(uci::type::TaskPlanStatusMT::Writer& writer);
...
protected:
  ...
  /** The copy constructor [only available to derived classes].
    *
    * @param rhs The TaskPlanStatusMT to copy from.
    */
  TaskPlanStatusMT(const TaskPlanStatusMT& rhs) {
    (void)rhs;
  }

  /** The assignment operator. Sets the contents of this TaskPlanStatusMT to the contents of the TaskPlanStatusMT on the
    * right hand side (rhs) of the assignment operator [only available to derived classes].
    *
    * @param rhs The TaskPlanStatusMT on the right hand side (rhs) of the assignment operator whose contents are used to
    *      set the contents of this TaskPlanStatusMT.
    * @return A reference to this TaskPlanStatusMT.
    */
  TaskPlanStatusMT& operator=(const TaskPlanStatusMT& rhs) {
    (void)rhs;
...
#endif // UCI_TYPE_TASKPLANSTATUSMT_H
