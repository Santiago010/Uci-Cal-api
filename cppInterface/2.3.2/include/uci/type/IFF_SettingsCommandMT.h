...
#ifndef UCI_TYPE_IFF_SETTINGSCOMMANDMT_H
#define UCI_TYPE_IFF_SETTINGSCOMMANDMT_H

#include "../base/Listener.h"
#include "../base/Reader.h"
#include "../base/Writer.h"
#include "../base/export.h"
#include "IFF_SettingsCommandMDT.h"
...
class IFF_SettingsCommandMT : public virtual MessageType {
public:

  /** This method constructs a new IFF_SettingsCommandMT.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed IFF_SettingsCommandMT.
    */
  static UCI_EXPORT IFF_SettingsCommandMT& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new IFF_SettingsCommandMT initializing the data accessed by the new IFF_SettingsCommandMT
    * using the data accessed by the specified IFF_SettingsCommandMT (cloning).
    *
    * @param accessor The IFF_SettingsCommandMT that provides access to the data that is to be used to initialize the data
    *      accessed by the new created IFF_SettingsCommandMT.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed IFF_SettingsCommandMT.
    */
  static UCI_EXPORT IFF_SettingsCommandMT& create(const IFF_SettingsCommandMT& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified IFF_SettingsCommandMT. Use of the specified accessor after it has been destroyed
    * will result in undefined behavior.
    *
    * @param accessor The IFF_SettingsCommandMT that is to be destroyed.
    */
  static UCI_EXPORT void destroy(IFF_SettingsCommandMT& accessor);

  /** Returns this accessor's type constant, i.e. iFF_SettingsCommandMT.
    *
    * @return This accessor's type constant, i.e. iFF_SettingsCommandMT.
    */
  virtual uci::base::accessorType::AccessorType getAccessorType() const noexception {
    return uci::type::accessorType::iFF_SettingsCommandMT;
  }

  /** Returns the version that was initialized from the uci:version attribute of IFF_SettingsCommandMT.
    *
    * @return The version that was initialized from the uci:version attribute of IFF_SettingsCommandMT.
    */
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const IFF_SettingsCommandMT& accessor) = 0;
  ...
  /** Returns a const reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual const uci::type::IFF_SettingsCommandMDT& getMessageData() const = 0;
  ...
  /** Returns a reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual uci::type::IFF_SettingsCommandMDT& getMessageData() = 0;
  ...
  /** Sets the complex content identified by MessageData to the contents of the complex content accessed by the specified
    ...
    */
  virtual uci::type::IFF_SettingsCommandMT& setMessageData(const uci::type::IFF_SettingsCommandMDT& value) = 0;

  /** The Listener provides the support to listen and handle incoming messages of the type
    * uci::type::IFF_SettingsCommandMT.
    */
  ...
  public:
    ...
    /** The method is used to handle incoming messages.
      ...
      */
    virtual void handleMessage(const uci::type::IFF_SettingsCommandMT& message) = 0;
  ...
  public:
    ...
    /** Adds a listener to this reader to handle incoming messages.
      ...
      */
    virtual void addListener(uci::type::IFF_SettingsCommandMT::Listener& listener) = 0;

    /** Removes the specified listener from this reader.
      *
      * @param listener The listener that is to be removed from this reader.
      */
    virtual void removeListener(uci::type::IFF_SettingsCommandMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s). Returns immediately if no messages are available.
      ...
      */
    virtual unsigned long readNoWait(unsigned long maxNumberOfMessages, uci::type::IFF_SettingsCommandMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s).
      ...
      * @return The number of messages that were handled.
      */
    virtual unsigned long read(unsigned long timeout, unsigned long maxNumberOfMessages, uci::type::IFF_SettingsCommandMT::Listener& listener) = 0;
  ...
  /** This method creates a new reader that can be used to read a IFF_SettingsCommandMT.
    *
    * @param topic The specification of the topic the reader is to read from.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A reader that can read a IFF_SettingsCommandMT.
    */
  static UCI_EXPORT uci::type::IFF_SettingsCommandMT::Reader& createReader(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a reader. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyReader(uci::type::IFF_SettingsCommandMT::Reader& reader);
  ...
  public:
    ...
    /** Writes the OMS message to the topic specified when this Writer was created.
      ...
      */
    virtual void write(uci::type::IFF_SettingsCommandMT& accessor) = 0;
  ...
  /** This method creates a new writer that can be used to write a IFF_SettingsCommandMT.
    *
    * @param topic The specification of the topic the writer is to write to.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A writer that can write a IFF_SettingsCommandMT.
    */
  static UCI_EXPORT uci::type::IFF_SettingsCommandMT::Writer& createWriter(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a writer. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyWriter(uci::type::IFF_SettingsCommandMT::Writer& writer);

protected:

  /** The constructor [only available to derived classes]. */
  IFF_SettingsCommandMT() {
  }
  ...
  /** The copy constructor [only available to derived classes].
    *
    * @param rhs The IFF_SettingsCommandMT to copy from.
    */
  IFF_SettingsCommandMT(const IFF_SettingsCommandMT& rhs) {
    (void)rhs;
  }

  /** The assignment operator. Sets the contents of this IFF_SettingsCommandMT to the contents of the IFF_SettingsCommandMT
    * on the right hand side (rhs) of the assignment operator [only available to derived classes].
    *
    * @param rhs The IFF_SettingsCommandMT on the right hand side (rhs) of the assignment operator whose contents are used
    *      to set the contents of this IFF_SettingsCommandMT.
    * @return A reference to this IFF_SettingsCommandMT.
    */
  IFF_SettingsCommandMT& operator=(const IFF_SettingsCommandMT& rhs) {
    (void)rhs;
...
#endif // UCI_TYPE_IFF_SETTINGSCOMMANDMT_H
