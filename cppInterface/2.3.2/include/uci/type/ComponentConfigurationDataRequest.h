/** @file ComponentConfigurationDataRequest.h
 *
...
typedef uci::type::ComponentConfigurationDataRequestMT ComponentConfigurationDataRequest;

} // namespace type
} // namespace uci

#endif // UCI_TYPE_COMPONENTCONFIGURATIONDATAREQUEST_H
