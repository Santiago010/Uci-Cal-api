/** @file SOB_CorrelationRecordMT.h
 *
...
#ifndef UCI_TYPE_SOB_CORRELATIONRECORDMT_H
#define UCI_TYPE_SOB_CORRELATIONRECORDMT_H
...
#include "SOB_CorrelationRecordMDT.h"
...
/** Indicates the potential correlation between a SOB record and a message. */
class SOB_CorrelationRecordMT : public virtual MessageType {
public:

  /** This method constructs a new SOB_CorrelationRecordMT.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed SOB_CorrelationRecordMT.
    */
  static UCI_EXPORT SOB_CorrelationRecordMT& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new SOB_CorrelationRecordMT initializing the data accessed by the new
    * SOB_CorrelationRecordMT using the data accessed by the specified SOB_CorrelationRecordMT (cloning).
    *
    * @param accessor The SOB_CorrelationRecordMT that provides access to the data that is to be used to initialize the
    *      data accessed by the new created SOB_CorrelationRecordMT.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed SOB_CorrelationRecordMT.
    */
  static UCI_EXPORT SOB_CorrelationRecordMT& create(const SOB_CorrelationRecordMT& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified SOB_CorrelationRecordMT. Use of the specified accessor after it has been destroyed
    * will result in undefined behavior.
    *
    * @param accessor The SOB_CorrelationRecordMT that is to be destroyed.
    */
  static UCI_EXPORT void destroy(SOB_CorrelationRecordMT& accessor);

  /** Returns this accessor's type constant, i.e. sOB_CorrelationRecordMT.
    *
    * @return This accessor's type constant, i.e. sOB_CorrelationRecordMT.
    */
  virtual uci::base::accessorType::AccessorType getAccessorType() const noexception {
    return uci::type::accessorType::sOB_CorrelationRecordMT;
  }

  /** Returns the version that was initialized from the uci:version attribute of SOB_CorrelationRecordMT.
    *
    * @return The version that was initialized from the uci:version attribute of SOB_CorrelationRecordMT.
    */
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const SOB_CorrelationRecordMT& accessor) = 0;
  ...
  /** Sets the value of the enumeration identified by ObjectState.
    ...
    */
  virtual uci::type::SOB_CorrelationRecordMT& setObjectState(const uci::type::ObjectStateEnum& value) = 0;
  ...
  /** Sets the value of the enumeration identified by ObjectState.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::SOB_CorrelationRecordMT& setObjectState(uci::type::ObjectStateEnum::EnumerationItem value) = 0;
  ...
  /** Clears (disabled) the Element identified by ObjectState.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::SOB_CorrelationRecordMT& clearObjectState() = 0;
  ...
  /** Returns a const reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual const uci::type::SOB_CorrelationRecordMDT& getMessageData() const = 0;
  ...
  /** Returns a reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual uci::type::SOB_CorrelationRecordMDT& getMessageData() = 0;
  ...
  /** Sets the complex content identified by MessageData to the contents of the complex content accessed by the specified
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::SOB_CorrelationRecordMT& setMessageData(const uci::type::SOB_CorrelationRecordMDT& value) = 0;

  /** The Listener provides the support to listen and handle incoming messages of the type
    * uci::type::SOB_CorrelationRecordMT.
    */
  ...
  public:
    ...
    /** The method is used to handle incoming messages.
      ...
      */
    virtual void handleMessage(const uci::type::SOB_CorrelationRecordMT& message) = 0;
  ...
  public:
    ...
    /** Adds a listener to this reader to handle incoming messages.
      ...
      */
    virtual void addListener(uci::type::SOB_CorrelationRecordMT::Listener& listener) = 0;

    /** Removes the specified listener from this reader.
      *
      * @param listener The listener that is to be removed from this reader.
      */
    virtual void removeListener(uci::type::SOB_CorrelationRecordMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s). Returns immediately if no messages are available.
      ...
      */
    virtual unsigned long readNoWait(unsigned long maxNumberOfMessages, uci::type::SOB_CorrelationRecordMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s).
      ...
      * @return The number of messages that were handled.
      */
    virtual unsigned long read(unsigned long timeout, unsigned long maxNumberOfMessages, uci::type::SOB_CorrelationRecordMT::Listener& listener) = 0;
  ...
  /** This method creates a new reader that can be used to read a SOB_CorrelationRecordMT.
    *
    * @param topic The specification of the topic the reader is to read from.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A reader that can read a SOB_CorrelationRecordMT.
    */
  static UCI_EXPORT uci::type::SOB_CorrelationRecordMT::Reader& createReader(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a reader. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyReader(uci::type::SOB_CorrelationRecordMT::Reader& reader);
  ...
  public:
    ...
    /** Writes the OMS message to the topic specified when this Writer was created.
      ...
      */
    virtual void write(uci::type::SOB_CorrelationRecordMT& accessor) = 0;
  ...
  /** This method creates a new writer that can be used to write a SOB_CorrelationRecordMT.
    *
    * @param topic The specification of the topic the writer is to write to.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A writer that can write a SOB_CorrelationRecordMT.
    */
  static UCI_EXPORT uci::type::SOB_CorrelationRecordMT::Writer& createWriter(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a writer. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyWriter(uci::type::SOB_CorrelationRecordMT::Writer& writer);

protected:

  /** The constructor [only available to derived classes]. */
  SOB_CorrelationRecordMT() {
  }
  ...
  /** The copy constructor [only available to derived classes].
    *
    * @param rhs The SOB_CorrelationRecordMT to copy from.
    */
  SOB_CorrelationRecordMT(const SOB_CorrelationRecordMT& rhs) {
    (void)rhs;
  }

  /** The assignment operator. Sets the contents of this SOB_CorrelationRecordMT to the contents of the
    * SOB_CorrelationRecordMT on the right hand side (rhs) of the assignment operator [only available to derived classes].
    *
    * @param rhs The SOB_CorrelationRecordMT on the right hand side (rhs) of the assignment operator whose contents are
    *      used to set the contents of this SOB_CorrelationRecordMT.
    * @return A reference to this SOB_CorrelationRecordMT.
    */
  SOB_CorrelationRecordMT& operator=(const SOB_CorrelationRecordMT& rhs) {
    (void)rhs;
...
#endif // UCI_TYPE_SOB_CORRELATIONRECORDMT_H
