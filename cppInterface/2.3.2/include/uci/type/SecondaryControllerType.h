/** @file SecondaryControllerType.h
 *
...
#ifndef UCI_TYPE_SECONDARYCONTROLLERTYPE_H
#define UCI_TYPE_SECONDARYCONTROLLERTYPE_H
...
public:
  ...
  /** This method constructs a new SecondaryControllerType.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed SecondaryControllerType.
    */
  static UCI_EXPORT SecondaryControllerType& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new SecondaryControllerType initializing the data accessed by the new
    * SecondaryControllerType using the data accessed by the specified SecondaryControllerType (cloning).
    *
    * @param accessor The SecondaryControllerType that provides access to the data that is to be used to initialize the
    *      data accessed by the new created SecondaryControllerType.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed SecondaryControllerType.
    */
  static UCI_EXPORT SecondaryControllerType& create(const SecondaryControllerType& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified SecondaryControllerType. Use of the specified accessor after it has been destroyed
    * will result in undefined behavior.
    *
    * @param accessor The SecondaryControllerType that is to be destroyed.
    */
  static UCI_EXPORT void destroy(SecondaryControllerType& accessor);
  ...
  /** Returns the version that was initialized from the uci:version attribute of SecondaryControllerType.
    *
    * @return The version that was initialized from the uci:version attribute of SecondaryControllerType.
    */
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const SecondaryControllerType& accessor) = 0;
  ...
  /** Sets the complex content identified by SystemID to the contents of the complex content accessed by the specified
    ...
    */
  virtual uci::type::SecondaryControllerType& setSystemID(const uci::type::SystemID_Type& value) = 0;
  ...
  /** Sets the complex content identified by ServiceID to the contents of the complex content accessed by the specified
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::SecondaryControllerType& setServiceID(const uci::type::ServiceID_Type& value) = 0;
...
protected:
  ...
  /** The assignment operator. Sets the contents of this SecondaryControllerType to the contents of the
    * SecondaryControllerType on the right hand side (rhs) of the assignment operator [only available to derived classes].
    *
    * @param rhs The SecondaryControllerType on the right hand side (rhs) of the assignment operator whose contents are
    *      used to set the contents of this SecondaryControllerType.
    * @return A reference to this SecondaryControllerType.
    */
  SecondaryControllerType& operator=(const SecondaryControllerType& rhs) {
    (void)rhs;
...
#endif // UCI_TYPE_SECONDARYCONTROLLERTYPE_H
