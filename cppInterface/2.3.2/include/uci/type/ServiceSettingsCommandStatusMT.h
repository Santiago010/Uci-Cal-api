/** @file ServiceSettingsCommandStatusMT.h
 *
...
#ifndef UCI_TYPE_SERVICESETTINGSCOMMANDSTATUSMT_H
#define UCI_TYPE_SERVICESETTINGSCOMMANDSTATUSMT_H
...
#include "ServiceSettingsCommandStatusMDT.h"
...
class ServiceSettingsCommandStatusMT : public virtual MessageType {
public:

  /** This method constructs a new ServiceSettingsCommandStatusMT.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed ServiceSettingsCommandStatusMT.
    */
  static UCI_EXPORT ServiceSettingsCommandStatusMT& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new ServiceSettingsCommandStatusMT initializing the data accessed by the new
    * ServiceSettingsCommandStatusMT using the data accessed by the specified ServiceSettingsCommandStatusMT (cloning).
    *
    * @param accessor The ServiceSettingsCommandStatusMT that provides access to the data that is to be used to initialize
    *      the data accessed by the new created ServiceSettingsCommandStatusMT.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed ServiceSettingsCommandStatusMT.
    */
  static UCI_EXPORT ServiceSettingsCommandStatusMT& create(const ServiceSettingsCommandStatusMT& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified ServiceSettingsCommandStatusMT. Use of the specified accessor after it has been
    * destroyed will result in undefined behavior.
    *
    * @param accessor The ServiceSettingsCommandStatusMT that is to be destroyed.
    */
  static UCI_EXPORT void destroy(ServiceSettingsCommandStatusMT& accessor);
  ...
  /** Returns the version that was initialized from the uci:version attribute of ServiceSettingsCommandStatusMT.
    *
    * @return The version that was initialized from the uci:version attribute of ServiceSettingsCommandStatusMT.
    */
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const ServiceSettingsCommandStatusMT& accessor) = 0;
  ...
  /** Returns a const reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual const uci::type::ServiceSettingsCommandStatusMDT& getMessageData() const = 0;
  ...
  /** Returns a reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual uci::type::ServiceSettingsCommandStatusMDT& getMessageData() = 0;
  ...
  /** Sets the complex content identified by MessageData to the contents of the complex content accessed by the specified
    ...
    */
  virtual uci::type::ServiceSettingsCommandStatusMT& setMessageData(const uci::type::ServiceSettingsCommandStatusMDT& value) = 0;

  /** The Listener provides the support to listen and handle incoming messages of the type
    * uci::type::ServiceSettingsCommandStatusMT.
    */
  ...
  public:
    ...
    /** The method is used to handle incoming messages.
      ...
      */
    virtual void handleMessage(const uci::type::ServiceSettingsCommandStatusMT& message) = 0;
  ...
  public:
    ...
    /** Adds a listener to this reader to handle incoming messages.
      ...
      */
    virtual void addListener(uci::type::ServiceSettingsCommandStatusMT::Listener& listener) = 0;

    /** Removes the specified listener from this reader.
      *
      * @param listener The listener that is to be removed from this reader.
      */
    virtual void removeListener(uci::type::ServiceSettingsCommandStatusMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s). Returns immediately if no messages are available.
      ...
      */
    virtual unsigned long readNoWait(unsigned long maxNumberOfMessages, uci::type::ServiceSettingsCommandStatusMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s).
      ...
      * @return The number of messages that were handled.
      */
    virtual unsigned long read(unsigned long timeout, unsigned long maxNumberOfMessages, uci::type::ServiceSettingsCommandStatusMT::Listener& listener) = 0;
  ...
  /** This method creates a new reader that can be used to read a ServiceSettingsCommandStatusMT.
    *
    * @param topic The specification of the topic the reader is to read from.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A reader that can read a ServiceSettingsCommandStatusMT.
    */
  static UCI_EXPORT uci::type::ServiceSettingsCommandStatusMT::Reader& createReader(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a reader. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyReader(uci::type::ServiceSettingsCommandStatusMT::Reader& reader);
  ...
  public:
    ...
    /** Writes the OMS message to the topic specified when this Writer was created.
      ...
      */
    virtual void write(uci::type::ServiceSettingsCommandStatusMT& accessor) = 0;
  ...
  /** This method creates a new writer that can be used to write a ServiceSettingsCommandStatusMT.
    *
    * @param topic The specification of the topic the writer is to write to.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A writer that can write a ServiceSettingsCommandStatusMT.
    */
  static UCI_EXPORT uci::type::ServiceSettingsCommandStatusMT::Writer& createWriter(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a writer. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyWriter(uci::type::ServiceSettingsCommandStatusMT::Writer& writer);
...
protected:
  ...
  /** The assignment operator. Sets the contents of this ServiceSettingsCommandStatusMT to the contents of the
    * ServiceSettingsCommandStatusMT on the right hand side (rhs) of the assignment operator [only available to derived
    * classes].
    *
    * @param rhs The ServiceSettingsCommandStatusMT on the right hand side (rhs) of the assignment operator whose contents
    *      are used to set the contents of this ServiceSettingsCommandStatusMT.
    * @return A reference to this ServiceSettingsCommandStatusMT.
    */
  ServiceSettingsCommandStatusMT& operator=(const ServiceSettingsCommandStatusMT& rhs) {
    (void)rhs;
...
#endif // UCI_TYPE_SERVICESETTINGSCOMMANDSTATUSMT_H
