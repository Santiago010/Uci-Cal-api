/** @file RoutePlanSegmentReferenceType.h
 *
...
#ifndef UCI_TYPE_ROUTEPLANSEGMENTREFERENCETYPE_H
#define UCI_TYPE_ROUTEPLANSEGMENTREFERENCETYPE_H
...
class RoutePlanSegmentReferenceType : public virtual uci::base::Accessor {
public:

  /** This method constructs a new RoutePlanSegmentReferenceType.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed RoutePlanSegmentReferenceType.
    */
  static UCI_EXPORT RoutePlanSegmentReferenceType& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new RoutePlanSegmentReferenceType initializing the data accessed by the new
    * RoutePlanSegmentReferenceType using the data accessed by the specified RoutePlanSegmentReferenceType (cloning).
    *
    * @param accessor The RoutePlanSegmentReferenceType that provides access to the data that is to be used to initialize
    *      the data accessed by the new created RoutePlanSegmentReferenceType.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed RoutePlanSegmentReferenceType.
    */
  static UCI_EXPORT RoutePlanSegmentReferenceType& create(const RoutePlanSegmentReferenceType& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified RoutePlanSegmentReferenceType. Use of the specified accessor after it has been
    * destroyed will result in undefined behavior.
    *
    * @param accessor The RoutePlanSegmentReferenceType that is to be destroyed.
    */
  static UCI_EXPORT void destroy(RoutePlanSegmentReferenceType& accessor);

  /** Returns this accessor's type constant, i.e. routePlanSegmentReferenceType.
    *
    * @return This accessor's type constant, i.e. routePlanSegmentReferenceType.
    */
  virtual uci::base::accessorType::AccessorType getAccessorType() const noexception {
    return uci::type::accessorType::routePlanSegmentReferenceType;
  }

  /** Returns the version that was initialized from the uci:version attribute of RoutePlanSegmentReferenceType.
    *
    * @return The version that was initialized from the uci:version attribute of RoutePlanSegmentReferenceType.
    */
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const RoutePlanSegmentReferenceType& accessor) = 0;
  ...
  /** Sets the complex content identified by RoutePlanID to the contents of the complex content accessed by the specified
    ...
    */
  virtual uci::type::RoutePlanSegmentReferenceType& setRoutePlanID(const uci::type::RoutePlanID_Type& value) = 0;
  ...
  /** Sets the complex content identified by PathID to the contents of the complex content accessed by the specified
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::RoutePlanSegmentReferenceType& setPathID(const uci::type::PathID_Type& value) = 0;
  ...
  /** Sets the complex content identified by PathSegmentID to the contents of the complex content accessed by the specified
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::RoutePlanSegmentReferenceType& setPathSegmentID(const uci::type::SegmentID_Type& value) = 0;
  ...
  /** Sets the complex content identified by MissionPlanID to the contents of the complex content accessed by the specified
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::RoutePlanSegmentReferenceType& setMissionPlanID(const uci::type::MissionPlanID_Type& value) = 0;
  ...
  /** Clears (disabled) the Element identified by MissionPlanID.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::RoutePlanSegmentReferenceType& clearMissionPlanID() = 0;
...
protected:
  ...
  /** The copy constructor [only available to derived classes].
    *
    * @param rhs The RoutePlanSegmentReferenceType to copy from.
    */
  RoutePlanSegmentReferenceType(const RoutePlanSegmentReferenceType& rhs) {
    (void)rhs;
  }

  /** The assignment operator. Sets the contents of this RoutePlanSegmentReferenceType to the contents of the
    * RoutePlanSegmentReferenceType on the right hand side (rhs) of the assignment operator [only available to derived
    * classes].
    *
    * @param rhs The RoutePlanSegmentReferenceType on the right hand side (rhs) of the assignment operator whose contents
    *      are used to set the contents of this RoutePlanSegmentReferenceType.
    * @return A reference to this RoutePlanSegmentReferenceType.
    */
  RoutePlanSegmentReferenceType& operator=(const RoutePlanSegmentReferenceType& rhs) {
    (void)rhs;
...
#endif // UCI_TYPE_ROUTEPLANSEGMENTREFERENCETYPE_H
