...
#ifndef UCI_TYPE_ROUTEMETRICSREQUESTMT_H
#define UCI_TYPE_ROUTEMETRICSREQUESTMT_H
...
#include "RouteMetricsRequestMDT.h"
...
class RouteMetricsRequestMT : public virtual MessageType {
public:

  /** This method constructs a new RouteMetricsRequestMT.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed RouteMetricsRequestMT.
    */
  static UCI_EXPORT RouteMetricsRequestMT& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new RouteMetricsRequestMT initializing the data accessed by the new RouteMetricsRequestMT
    * using the data accessed by the specified RouteMetricsRequestMT (cloning).
    *
    * @param accessor The RouteMetricsRequestMT that provides access to the data that is to be used to initialize the data
    *      accessed by the new created RouteMetricsRequestMT.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed RouteMetricsRequestMT.
    */
  static UCI_EXPORT RouteMetricsRequestMT& create(const RouteMetricsRequestMT& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified RouteMetricsRequestMT. Use of the specified accessor after it has been destroyed
    * will result in undefined behavior.
    *
    * @param accessor The RouteMetricsRequestMT that is to be destroyed.
    */
  static UCI_EXPORT void destroy(RouteMetricsRequestMT& accessor);

  /** Returns this accessor's type constant, i.e. routeMetricsRequestMT.
    *
    * @return This accessor's type constant, i.e. routeMetricsRequestMT.
    */
  virtual uci::base::accessorType::AccessorType getAccessorType() const noexception {
    return uci::type::accessorType::routeMetricsRequestMT;
  }

  /** Returns the version that was initialized from the uci:version attribute of RouteMetricsRequestMT.
    *
    * @return The version that was initialized from the uci:version attribute of RouteMetricsRequestMT.
    */
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const RouteMetricsRequestMT& accessor) = 0;
  ...
  /** Returns a const reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual const uci::type::RouteMetricsRequestMDT& getMessageData() const = 0;
  ...
  /** Returns a reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual uci::type::RouteMetricsRequestMDT& getMessageData() = 0;
  ...
  /** Sets the complex content identified by MessageData to the contents of the complex content accessed by the specified
    ...
    */
  virtual uci::type::RouteMetricsRequestMT& setMessageData(const uci::type::RouteMetricsRequestMDT& value) = 0;

  /** The Listener provides the support to listen and handle incoming messages of the type
    * uci::type::RouteMetricsRequestMT.
    */
  ...
  public:
    ...
    /** The method is used to handle incoming messages.
      ...
      */
    virtual void handleMessage(const uci::type::RouteMetricsRequestMT& message) = 0;
  ...
  public:
    ...
    /** Adds a listener to this reader to handle incoming messages.
      ...
      */
    virtual void addListener(uci::type::RouteMetricsRequestMT::Listener& listener) = 0;

    /** Removes the specified listener from this reader.
      *
      * @param listener The listener that is to be removed from this reader.
      */
    virtual void removeListener(uci::type::RouteMetricsRequestMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s). Returns immediately if no messages are available.
      ...
      */
    virtual unsigned long readNoWait(unsigned long maxNumberOfMessages, uci::type::RouteMetricsRequestMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s).
      ...
      * @return The number of messages that were handled.
      */
    virtual unsigned long read(unsigned long timeout, unsigned long maxNumberOfMessages, uci::type::RouteMetricsRequestMT::Listener& listener) = 0;
  ...
  /** This method creates a new reader that can be used to read a RouteMetricsRequestMT.
    *
    * @param topic The specification of the topic the reader is to read from.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A reader that can read a RouteMetricsRequestMT.
    */
  static UCI_EXPORT uci::type::RouteMetricsRequestMT::Reader& createReader(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a reader. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyReader(uci::type::RouteMetricsRequestMT::Reader& reader);
  ...
  public:
    ...
    /** Writes the OMS message to the topic specified when this Writer was created.
      ...
      */
    virtual void write(uci::type::RouteMetricsRequestMT& accessor) = 0;
  ...
  /** This method creates a new writer that can be used to write a RouteMetricsRequestMT.
    *
    * @param topic The specification of the topic the writer is to write to.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A writer that can write a RouteMetricsRequestMT.
    */
  static UCI_EXPORT uci::type::RouteMetricsRequestMT::Writer& createWriter(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a writer. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyWriter(uci::type::RouteMetricsRequestMT::Writer& writer);
...
protected:
  ...
  /** The copy constructor [only available to derived classes].
    *
    * @param rhs The RouteMetricsRequestMT to copy from.
    */
  RouteMetricsRequestMT(const RouteMetricsRequestMT& rhs) {
    (void)rhs;
  }

  /** The assignment operator. Sets the contents of this RouteMetricsRequestMT to the contents of the RouteMetricsRequestMT
    * on the right hand side (rhs) of the assignment operator [only available to derived classes].
    *
    * @param rhs The RouteMetricsRequestMT on the right hand side (rhs) of the assignment operator whose contents are used
    *      to set the contents of this RouteMetricsRequestMT.
    * @return A reference to this RouteMetricsRequestMT.
    */
  RouteMetricsRequestMT& operator=(const RouteMetricsRequestMT& rhs) {
    (void)rhs;
...
#endif // UCI_TYPE_ROUTEMETRICSREQUESTMT_H
