/** @file ActionPlanValidationCommand.h
 *
...
typedef uci::type::ActionPlanValidationCommandMT ActionPlanValidationCommand;

} // namespace type
} // namespace uci

#endif // UCI_TYPE_ACTIONPLANVALIDATIONCOMMAND_H
