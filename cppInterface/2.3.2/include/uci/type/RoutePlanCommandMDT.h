...
#ifndef UCI_TYPE_ROUTEPLANCOMMANDMDT_H
#define UCI_TYPE_ROUTEPLANCOMMANDMDT_H
...
class RoutePlanCommandMDT : public virtual uci::base::Accessor {
public:

  /** This method constructs a new RoutePlanCommandMDT.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed RoutePlanCommandMDT.
    */
  static UCI_EXPORT RoutePlanCommandMDT& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new RoutePlanCommandMDT initializing the data accessed by the new RoutePlanCommandMDT using
    * the data accessed by the specified RoutePlanCommandMDT (cloning).
    *
    * @param accessor The RoutePlanCommandMDT that provides access to the data that is to be used to initialize the data
    *      accessed by the new created RoutePlanCommandMDT.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed RoutePlanCommandMDT.
    */
  static UCI_EXPORT RoutePlanCommandMDT& create(const RoutePlanCommandMDT& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified RoutePlanCommandMDT. Use of the specified accessor after it has been destroyed
    * will result in undefined behavior.
    *
    * @param accessor The RoutePlanCommandMDT that is to be destroyed.
    */
  static UCI_EXPORT void destroy(RoutePlanCommandMDT& accessor);

  /** Returns this accessor's type constant, i.e. routePlanCommandMDT.
    *
    * @return This accessor's type constant, i.e. routePlanCommandMDT.
    */
  virtual uci::base::accessorType::AccessorType getAccessorType() const noexception {
    return uci::type::accessorType::routePlanCommandMDT;
  }

  /** Returns the version that was initialized from the uci:version attribute of RoutePlanCommandMDT.
    *
    * @return The version that was initialized from the uci:version attribute of RoutePlanCommandMDT.
    */
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const RoutePlanCommandMDT& accessor) = 0;
  ...
  /** Sets the complex content identified by CommandID to the contents of the complex content accessed by the specified
    ...
    */
  virtual uci::type::RoutePlanCommandMDT& setCommandID(const uci::type::RoutePlanCommandID_Type& value) = 0;
  ...
  /** Sets the complex content identified by ParentMissionPlanCommandID to the contents of the complex content accessed by
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::RoutePlanCommandMDT& setParentMissionPlanCommandID(const uci::type::MissionPlanCommandID_Type& value) = 0;
  ...
  /** Clears (disabled) the Element identified by ParentMissionPlanCommandID.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::RoutePlanCommandMDT& clearParentMissionPlanCommandID() = 0;
  ...
  /** Sets the value of the enumeration identified by CommandState.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::RoutePlanCommandMDT& setCommandState(const uci::type::CommandStateEnum& value) = 0;
  ...
  /** Sets the value of the enumeration identified by CommandState.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::RoutePlanCommandMDT& setCommandState(uci::type::CommandStateEnum::EnumerationItem value) = 0;
  ...
  /** Returns a const reference to the accessor that provides access to the complex content identified by Inputs.
    ...
    */
  virtual const uci::type::RoutePlanInputsType& getInputs() const = 0;
  ...
  /** Returns a reference to the accessor that provides access to the complex content identified by Inputs.
    ...
    */
  virtual uci::type::RoutePlanInputsType& getInputs() = 0;
  ...
  /** Sets the complex content identified by Inputs to the contents of the complex content accessed by the specified
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::RoutePlanCommandMDT& setInputs(const uci::type::RoutePlanInputsType& value) = 0;
  ...
  /** Sets the value of the SimplePrimitive data type identified by ForPlanningUseOnly.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::RoutePlanCommandMDT& setForPlanningUseOnly(xs::Boolean value) = 0;
...
protected:
  ...
  /** The copy constructor [only available to derived classes].
    ...
    */
  RoutePlanCommandMDT(const RoutePlanCommandMDT& rhs) {
    (void)rhs;
  }

  /** The assignment operator. Sets the contents of this RoutePlanCommandMDT to the contents of the RoutePlanCommandMDT on
    * the right hand side (rhs) of the assignment operator [only available to derived classes].
    *
    * @param rhs The RoutePlanCommandMDT on the right hand side (rhs) of the assignment operator whose contents are used to
    *      set the contents of this RoutePlanCommandMDT.
    * @return A reference to this RoutePlanCommandMDT.
    */
  RoutePlanCommandMDT& operator=(const RoutePlanCommandMDT& rhs) {
    (void)rhs;
...
#endif // UCI_TYPE_ROUTEPLANCOMMANDMDT_H
