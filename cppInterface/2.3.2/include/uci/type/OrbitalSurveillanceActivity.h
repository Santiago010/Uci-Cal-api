/** @file OrbitalSurveillanceActivity.h
 *
...
typedef uci::type::OrbitalSurveillanceActivityMT OrbitalSurveillanceActivity;

} // namespace type
} // namespace uci

#endif // UCI_TYPE_ORBITALSURVEILLANCEACTIVITY_H
