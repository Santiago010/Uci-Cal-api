...
#ifndef UCI_TYPE_SMTI_SETTINGSCOMMANDMDT_H
#define UCI_TYPE_SMTI_SETTINGSCOMMANDMDT_H
...
class SMTI_SettingsCommandMDT : public virtual CapabilitySettingsCommandBaseType {
public:

  /** This method constructs a new SMTI_SettingsCommandMDT.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed SMTI_SettingsCommandMDT.
    */
  static UCI_EXPORT SMTI_SettingsCommandMDT& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new SMTI_SettingsCommandMDT initializing the data accessed by the new
    * SMTI_SettingsCommandMDT using the data accessed by the specified SMTI_SettingsCommandMDT (cloning).
    *
    * @param accessor The SMTI_SettingsCommandMDT that provides access to the data that is to be used to initialize the
    *      data accessed by the new created SMTI_SettingsCommandMDT.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed SMTI_SettingsCommandMDT.
    */
  static UCI_EXPORT SMTI_SettingsCommandMDT& create(const SMTI_SettingsCommandMDT& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified SMTI_SettingsCommandMDT. Use of the specified accessor after it has been destroyed
    * will result in undefined behavior.
    *
    * @param accessor The SMTI_SettingsCommandMDT that is to be destroyed.
    */
  static UCI_EXPORT void destroy(SMTI_SettingsCommandMDT& accessor);
  ...
  /** Returns the version that was initialized from the uci:version attribute of SMTI_SettingsCommandMDT.
    *
    * @return The version that was initialized from the uci:version attribute of SMTI_SettingsCommandMDT.
    */
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const SMTI_SettingsCommandMDT& accessor) = 0;
  ...
  /** Sets the value of the enumeration identified by EmissionBalanceState.
    ...
    */
  virtual uci::type::SMTI_SettingsCommandMDT& setEmissionBalanceState(const uci::type::EmissionBalanceEnum& value) = 0;
  ...
  /** Sets the value of the enumeration identified by EmissionBalanceState.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::SMTI_SettingsCommandMDT& setEmissionBalanceState(uci::type::EmissionBalanceEnum::EnumerationItem value) = 0;
  ...
  /** Clears (disabled) the Element identified by EmissionBalanceState.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::SMTI_SettingsCommandMDT& clearEmissionBalanceState() = 0;
  ...
  /** Returns a const reference to the bounded list identified by MessageOutput.
    ...
    */
  virtual const uci::type::SMTI_SettingsCommandMDT::MessageOutput& getMessageOutput() const = 0;
  ...
  /** Returns a reference to the bounded list identified by MessageOutput.
    ...
    */
  virtual uci::type::SMTI_SettingsCommandMDT::MessageOutput& getMessageOutput() = 0;
  ...
  /** Sets the bounded list identified by MessageOutput.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::SMTI_SettingsCommandMDT& setMessageOutput(const uci::type::SMTI_SettingsCommandMDT::MessageOutput& value) = 0;
  ...
  /** Returns a const reference to the accessor that provides access to the complex content identified by
    ...
    *      DefaultPackingPlan.
    */
  virtual const uci::type::STANAG_4607_PackingPlanPET& getDefaultPackingPlan() const = 0;
  ...
  /** Returns a reference to the accessor that provides access to the complex content identified by DefaultPackingPlan.
    ...
    */
  virtual uci::type::STANAG_4607_PackingPlanPET& getDefaultPackingPlan() = 0;
  ...
  /** Sets the complex content identified by DefaultPackingPlan to the contents of the complex content accessed by the
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::SMTI_SettingsCommandMDT& setDefaultPackingPlan(const uci::type::STANAG_4607_PackingPlanPET& value) = 0;
  ...
  /** Enables the Element identified by DefaultPackingPlan.
    ...
    * @return A reference to the accessor that provides access to the complex content identified by DefaultPackingPlan.
    */
  virtual uci::type::STANAG_4607_PackingPlanPET& enableDefaultPackingPlan(uci::base::accessorType::AccessorType type = uci::base::accessorType::null) = 0;

  /** Clears (disabled) the Element identified by DefaultPackingPlan.
    *
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::SMTI_SettingsCommandMDT& clearDefaultPackingPlan() = 0;
  ...
  /** Sets the value of the SimplePrimitive data type identified by UnassignAll.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::SMTI_SettingsCommandMDT& setUnassignAll(xs::Boolean value) = 0;
  ...
  /** Clears (disabled) the Element identified by UnassignAll.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::SMTI_SettingsCommandMDT& clearUnassignAll() = 0;
  ...
  /** Sets the complex content identified by DefaultEmcon to the contents of the complex content accessed by the specified
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::SMTI_SettingsCommandMDT& setDefaultEmcon(const uci::type::EmconSettingType& value) = 0;
  ...
  /** Clears (disabled) the Element identified by DefaultEmcon.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::SMTI_SettingsCommandMDT& clearDefaultEmcon() = 0;
  ...
  /** Returns a const reference to the bounded list identified by DefaultElectronicProtectionOptions.
    ...
    */
  virtual const uci::type::SMTI_SettingsCommandMDT::DefaultElectronicProtectionOptions& getDefaultElectronicProtectionOptions() const = 0;
  ...
  /** Returns a reference to the bounded list identified by DefaultElectronicProtectionOptions.
    ...
    */
  virtual uci::type::SMTI_SettingsCommandMDT::DefaultElectronicProtectionOptions& getDefaultElectronicProtectionOptions() = 0;
  ...
  /** Sets the bounded list identified by DefaultElectronicProtectionOptions.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::SMTI_SettingsCommandMDT& setDefaultElectronicProtectionOptions(const uci::type::SMTI_SettingsCommandMDT::DefaultElectronicProtectionOptions& value) = 0;
...
protected:
  ...
  /** The assignment operator. Sets the contents of this SMTI_SettingsCommandMDT to the contents of the
    * SMTI_SettingsCommandMDT on the right hand side (rhs) of the assignment operator [only available to derived classes].
    *
    * @param rhs The SMTI_SettingsCommandMDT on the right hand side (rhs) of the assignment operator whose contents are
    *      used to set the contents of this SMTI_SettingsCommandMDT.
    * @return A reference to this SMTI_SettingsCommandMDT.
    */
  SMTI_SettingsCommandMDT& operator=(const SMTI_SettingsCommandMDT& rhs) {
    (void)rhs;
...
#endif // UCI_TYPE_SMTI_SETTINGSCOMMANDMDT_H
