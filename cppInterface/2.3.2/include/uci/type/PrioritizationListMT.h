...
#ifndef UCI_TYPE_PRIORITIZATIONLISTMT_H
#define UCI_TYPE_PRIORITIZATIONLISTMT_H
...
#include "PrioritizationListMDT.h"
...
class PrioritizationListMT : public virtual MessageType {
public:

  /** This method constructs a new PrioritizationListMT.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed PrioritizationListMT.
    */
  static UCI_EXPORT PrioritizationListMT& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new PrioritizationListMT initializing the data accessed by the new PrioritizationListMT
    * using the data accessed by the specified PrioritizationListMT (cloning).
    *
    * @param accessor The PrioritizationListMT that provides access to the data that is to be used to initialize the data
    *      accessed by the new created PrioritizationListMT.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed PrioritizationListMT.
    */
  static UCI_EXPORT PrioritizationListMT& create(const PrioritizationListMT& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified PrioritizationListMT. Use of the specified accessor after it has been destroyed
    * will result in undefined behavior.
    *
    * @param accessor The PrioritizationListMT that is to be destroyed.
    */
  static UCI_EXPORT void destroy(PrioritizationListMT& accessor);

  /** Returns this accessor's type constant, i.e. prioritizationListMT.
    *
    * @return This accessor's type constant, i.e. prioritizationListMT.
    */
  virtual uci::base::accessorType::AccessorType getAccessorType() const noexception {
    return uci::type::accessorType::prioritizationListMT;
  }

  /** Returns the version that was initialized from the uci:version attribute of PrioritizationListMT.
    *
    * @return The version that was initialized from the uci:version attribute of PrioritizationListMT.
    */
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const PrioritizationListMT& accessor) = 0;
  ...
  /** Sets the value of the enumeration identified by ObjectState.
    ...
    */
  virtual uci::type::PrioritizationListMT& setObjectState(const uci::type::ObjectStateEnum& value) = 0;
  ...
  /** Sets the value of the enumeration identified by ObjectState.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::PrioritizationListMT& setObjectState(uci::type::ObjectStateEnum::EnumerationItem value) = 0;
  ...
  /** Clears (disabled) the Element identified by ObjectState.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::PrioritizationListMT& clearObjectState() = 0;
  ...
  /** Returns a const reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual const uci::type::PrioritizationListMDT& getMessageData() const = 0;
  ...
  /** Returns a reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual uci::type::PrioritizationListMDT& getMessageData() = 0;
  ...
  /** Sets the complex content identified by MessageData to the contents of the complex content accessed by the specified
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::PrioritizationListMT& setMessageData(const uci::type::PrioritizationListMDT& value) = 0;

  /** The Listener provides the support to listen and handle incoming messages of the type uci::type::PrioritizationListMT. */
  ...
  public:
    ...
    /** The method is used to handle incoming messages.
      ...
      */
    virtual void handleMessage(const uci::type::PrioritizationListMT& message) = 0;
  ...
  public:
    ...
    /** Adds a listener to this reader to handle incoming messages.
      ...
      */
    virtual void addListener(uci::type::PrioritizationListMT::Listener& listener) = 0;

    /** Removes the specified listener from this reader.
      *
      * @param listener The listener that is to be removed from this reader.
      */
    virtual void removeListener(uci::type::PrioritizationListMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s). Returns immediately if no messages are available.
      ...
      */
    virtual unsigned long readNoWait(unsigned long maxNumberOfMessages, uci::type::PrioritizationListMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s).
      ...
      * @return The number of messages that were handled.
      */
    virtual unsigned long read(unsigned long timeout, unsigned long maxNumberOfMessages, uci::type::PrioritizationListMT::Listener& listener) = 0;
  ...
  /** This method creates a new reader that can be used to read a PrioritizationListMT.
    *
    * @param topic The specification of the topic the reader is to read from.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A reader that can read a PrioritizationListMT.
    */
  static UCI_EXPORT uci::type::PrioritizationListMT::Reader& createReader(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a reader. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyReader(uci::type::PrioritizationListMT::Reader& reader);
  ...
  public:
    ...
    /** Writes the OMS message to the topic specified when this Writer was created.
      ...
      */
    virtual void write(uci::type::PrioritizationListMT& accessor) = 0;
  ...
  /** This method creates a new writer that can be used to write a PrioritizationListMT.
    *
    * @param topic The specification of the topic the writer is to write to.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A writer that can write a PrioritizationListMT.
    */
  static UCI_EXPORT uci::type::PrioritizationListMT::Writer& createWriter(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a writer. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyWriter(uci::type::PrioritizationListMT::Writer& writer);
...
protected:
  ...
  /** The copy constructor [only available to derived classes].
    ...
    */
  PrioritizationListMT(const PrioritizationListMT& rhs) {
    (void)rhs;
  }

  /** The assignment operator. Sets the contents of this PrioritizationListMT to the contents of the PrioritizationListMT
    * on the right hand side (rhs) of the assignment operator [only available to derived classes].
    *
    * @param rhs The PrioritizationListMT on the right hand side (rhs) of the assignment operator whose contents are used
    *      to set the contents of this PrioritizationListMT.
    * @return A reference to this PrioritizationListMT.
    */
  PrioritizationListMT& operator=(const PrioritizationListMT& rhs) {
    (void)rhs;
...
#endif // UCI_TYPE_PRIORITIZATIONLISTMT_H
