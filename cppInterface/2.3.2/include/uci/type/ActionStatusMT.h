...
#ifndef UCI_TYPE_ACTIONSTATUSMT_H
#define UCI_TYPE_ACTIONSTATUSMT_H

#include "../base/Listener.h"
#include "../base/Reader.h"
#include "../base/Writer.h"
#include "../base/export.h"
#include "ActionStatusMDT.h"
...
class ActionStatusMT : public virtual MessageType {
public:

  /** This method constructs a new ActionStatusMT.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed ActionStatusMT.
    */
  static UCI_EXPORT ActionStatusMT& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new ActionStatusMT initializing the data accessed by the new ActionStatusMT using the data
    * accessed by the specified ActionStatusMT (cloning).
    *
    * @param accessor The ActionStatusMT that provides access to the data that is to be used to initialize the data
    *      accessed by the new created ActionStatusMT.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed ActionStatusMT.
    */
  static UCI_EXPORT ActionStatusMT& create(const ActionStatusMT& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified ActionStatusMT. Use of the specified accessor after it has been destroyed will
    * result in undefined behavior.
    *
    * @param accessor The ActionStatusMT that is to be destroyed.
    */
  static UCI_EXPORT void destroy(ActionStatusMT& accessor);

  /** Returns this accessor's type constant, i.e. actionStatusMT.
    *
    * @return This accessor's type constant, i.e. actionStatusMT.
    */
  virtual uci::base::accessorType::AccessorType getAccessorType() const noexception {
    return uci::type::accessorType::actionStatusMT;
  }

  /** Returns the version that was initialized from the uci:version attribute of ActionStatusMT.
    *
    * @return The version that was initialized from the uci:version attribute of ActionStatusMT.
    */
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const ActionStatusMT& accessor) = 0;
  ...
  /** Returns a const reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual const uci::type::ActionStatusMDT& getMessageData() const = 0;
  ...
  /** Returns a reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual uci::type::ActionStatusMDT& getMessageData() = 0;
  ...
  /** Sets the complex content identified by MessageData to the contents of the complex content accessed by the specified
    ...
    */
  virtual uci::type::ActionStatusMT& setMessageData(const uci::type::ActionStatusMDT& value) = 0;

  /** The Listener provides the support to listen and handle incoming messages of the type uci::type::ActionStatusMT. */
  ...
  public:
    ...
    /** The method is used to handle incoming messages.
      ...
      */
    virtual void handleMessage(const uci::type::ActionStatusMT& message) = 0;
  ...
  public:
    ...
    /** Adds a listener to this reader to handle incoming messages.
      ...
      */
    virtual void addListener(uci::type::ActionStatusMT::Listener& listener) = 0;

    /** Removes the specified listener from this reader.
      *
      * @param listener The listener that is to be removed from this reader.
      */
    virtual void removeListener(uci::type::ActionStatusMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s). Returns immediately if no messages are available.
      ...
      */
    virtual unsigned long readNoWait(unsigned long maxNumberOfMessages, uci::type::ActionStatusMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s).
      ...
      * @return The number of messages that were handled.
      */
    virtual unsigned long read(unsigned long timeout, unsigned long maxNumberOfMessages, uci::type::ActionStatusMT::Listener& listener) = 0;
  ...
  /** This method creates a new reader that can be used to read a ActionStatusMT.
    *
    * @param topic The specification of the topic the reader is to read from.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A reader that can read a ActionStatusMT.
    */
  static UCI_EXPORT uci::type::ActionStatusMT::Reader& createReader(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a reader. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyReader(uci::type::ActionStatusMT::Reader& reader);
  ...
  public:
    ...
    /** Writes the OMS message to the topic specified when this Writer was created.
      ...
      */
    virtual void write(uci::type::ActionStatusMT& accessor) = 0;
  ...
  /** This method creates a new writer that can be used to write a ActionStatusMT.
    *
    * @param topic The specification of the topic the writer is to write to.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A writer that can write a ActionStatusMT.
    */
  static UCI_EXPORT uci::type::ActionStatusMT::Writer& createWriter(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a writer. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyWriter(uci::type::ActionStatusMT::Writer& writer);
...
protected:
  ...
  /** The copy constructor [only available to derived classes].
    *
    * @param rhs The ActionStatusMT to copy from.
    */
  ActionStatusMT(const ActionStatusMT& rhs) {
    (void)rhs;
  }

  /** The assignment operator. Sets the contents of this ActionStatusMT to the contents of the ActionStatusMT on the right
    * hand side (rhs) of the assignment operator [only available to derived classes].
    *
    * @param rhs The ActionStatusMT on the right hand side (rhs) of the assignment operator whose contents are used to set
    *      the contents of this ActionStatusMT.
    * @return A reference to this ActionStatusMT.
    */
  ActionStatusMT& operator=(const ActionStatusMT& rhs) {
    (void)rhs;
...
#endif // UCI_TYPE_ACTIONSTATUSMT_H
