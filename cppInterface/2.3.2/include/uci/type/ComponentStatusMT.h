...
#ifndef UCI_TYPE_COMPONENTSTATUSMT_H
#define UCI_TYPE_COMPONENTSTATUSMT_H
...
class ComponentStatusMT : public virtual MessageType {
public:

  /** This method constructs a new ComponentStatusMT.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed ComponentStatusMT.
    */
  static UCI_EXPORT ComponentStatusMT& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new ComponentStatusMT initializing the data accessed by the new ComponentStatusMT using the
    * data accessed by the specified ComponentStatusMT (cloning).
    *
    * @param accessor The ComponentStatusMT that provides access to the data that is to be used to initialize the data
    *      accessed by the new created ComponentStatusMT.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed ComponentStatusMT.
    */
  static UCI_EXPORT ComponentStatusMT& create(const ComponentStatusMT& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified ComponentStatusMT. Use of the specified accessor after it has been destroyed will
    * result in undefined behavior.
    *
    * @param accessor The ComponentStatusMT that is to be destroyed.
    */
  static UCI_EXPORT void destroy(ComponentStatusMT& accessor);

  /** Returns this accessor's type constant, i.e. componentStatusMT.
    *
    * @return This accessor's type constant, i.e. componentStatusMT.
    */
  virtual uci::base::accessorType::AccessorType getAccessorType() const noexception {
    return uci::type::accessorType::componentStatusMT;
  }

  /** Returns the version that was initialized from the uci:version attribute of ComponentStatusMT.
    *
    * @return The version that was initialized from the uci:version attribute of ComponentStatusMT.
    */
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const ComponentStatusMT& accessor) = 0;
  ...
  /** Returns a const reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual const uci::type::ComponentStatusMDT& getMessageData() const = 0;
  ...
  /** Returns a reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual uci::type::ComponentStatusMDT& getMessageData() = 0;
  ...
  /** Sets the complex content identified by MessageData to the contents of the complex content accessed by the specified
    ...
    */
  virtual uci::type::ComponentStatusMT& setMessageData(const uci::type::ComponentStatusMDT& value) = 0;

  /** The Listener provides the support to listen and handle incoming messages of the type uci::type::ComponentStatusMT. */
  ...
  public:
    ...
    /** The method is used to handle incoming messages.
      ...
      */
    virtual void handleMessage(const uci::type::ComponentStatusMT& message) = 0;
  ...
  public:
    ...
    /** Adds a listener to this reader to handle incoming messages.
      ...
      */
    virtual void addListener(uci::type::ComponentStatusMT::Listener& listener) = 0;

    /** Removes the specified listener from this reader.
      *
      * @param listener The listener that is to be removed from this reader.
      */
    virtual void removeListener(uci::type::ComponentStatusMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s). Returns immediately if no messages are available.
      ...
      */
    virtual unsigned long readNoWait(unsigned long maxNumberOfMessages, uci::type::ComponentStatusMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s).
      ...
      * @return The number of messages that were handled.
      */
    virtual unsigned long read(unsigned long timeout, unsigned long maxNumberOfMessages, uci::type::ComponentStatusMT::Listener& listener) = 0;
  ...
  /** This method creates a new reader that can be used to read a ComponentStatusMT.
    *
    * @param topic The specification of the topic the reader is to read from.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A reader that can read a ComponentStatusMT.
    */
  static UCI_EXPORT uci::type::ComponentStatusMT::Reader& createReader(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a reader. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyReader(uci::type::ComponentStatusMT::Reader& reader);
  ...
  public:
    ...
    /** Writes the OMS message to the topic specified when this Writer was created.
      ...
      */
    virtual void write(uci::type::ComponentStatusMT& accessor) = 0;
  ...
  /** This method creates a new writer that can be used to write a ComponentStatusMT.
    *
    * @param topic The specification of the topic the writer is to write to.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A writer that can write a ComponentStatusMT.
    */
  static UCI_EXPORT uci::type::ComponentStatusMT::Writer& createWriter(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a writer. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyWriter(uci::type::ComponentStatusMT::Writer& writer);
...
protected:
  ...
  /** The copy constructor [only available to derived classes].
    *
    * @param rhs The ComponentStatusMT to copy from.
    */
  ComponentStatusMT(const ComponentStatusMT& rhs) {
    (void)rhs;
  }

  /** The assignment operator. Sets the contents of this ComponentStatusMT to the contents of the ComponentStatusMT on the
    * right hand side (rhs) of the assignment operator [only available to derived classes].
    *
    * @param rhs The ComponentStatusMT on the right hand side (rhs) of the assignment operator whose contents are used to
    *      set the contents of this ComponentStatusMT.
    * @return A reference to this ComponentStatusMT.
    */
  ComponentStatusMT& operator=(const ComponentStatusMT& rhs) {
    (void)rhs;
...
#endif // UCI_TYPE_COMPONENTSTATUSMT_H
