/** @file CommAssetEstimationRequestMT.h
 *
...
#ifndef UCI_TYPE_COMMASSETESTIMATIONREQUESTMT_H
#define UCI_TYPE_COMMASSETESTIMATIONREQUESTMT_H

#include "../base/Listener.h"
#include "../base/Reader.h"
#include "../base/Writer.h"
#include "../base/export.h"
#include "CommAssetEstimationRequestMDT.h"
...
/** This message is used as an event to generate a position estimate assessment. This message should always have the
  ...
  * Assessment.
  */
class CommAssetEstimationRequestMT : public virtual MessageType {
public:

  /** This method constructs a new CommAssetEstimationRequestMT.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed CommAssetEstimationRequestMT.
    */
  static UCI_EXPORT CommAssetEstimationRequestMT& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new CommAssetEstimationRequestMT initializing the data accessed by the new
    * CommAssetEstimationRequestMT using the data accessed by the specified CommAssetEstimationRequestMT (cloning).
    *
    * @param accessor The CommAssetEstimationRequestMT that provides access to the data that is to be used to initialize
    *      the data accessed by the new created CommAssetEstimationRequestMT.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed CommAssetEstimationRequestMT.
    */
  static UCI_EXPORT CommAssetEstimationRequestMT& create(const CommAssetEstimationRequestMT& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified CommAssetEstimationRequestMT. Use of the specified accessor after it has been
    * destroyed will result in undefined behavior.
    *
    * @param accessor The CommAssetEstimationRequestMT that is to be destroyed.
    */
  static UCI_EXPORT void destroy(CommAssetEstimationRequestMT& accessor);
  ...
  /** Returns the version that was initialized from the uci:version attribute of CommAssetEstimationRequestMT.
    *
    * @return The version that was initialized from the uci:version attribute of CommAssetEstimationRequestMT.
    */
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const CommAssetEstimationRequestMT& accessor) = 0;
  ...
  /** Returns a const reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual const uci::type::CommAssetEstimationRequestMDT& getMessageData() const = 0;
  ...
  /** Returns a reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual uci::type::CommAssetEstimationRequestMDT& getMessageData() = 0;
  ...
  /** Sets the complex content identified by MessageData to the contents of the complex content accessed by the specified
    ...
    */
  virtual uci::type::CommAssetEstimationRequestMT& setMessageData(const uci::type::CommAssetEstimationRequestMDT& value) = 0;

  /** The Listener provides the support to listen and handle incoming messages of the type
    * uci::type::CommAssetEstimationRequestMT.
    */
  ...
  public:
    ...
    /** The method is used to handle incoming messages.
      ...
      */
    virtual void handleMessage(const uci::type::CommAssetEstimationRequestMT& message) = 0;
  ...
  public:
    ...
    /** Adds a listener to this reader to handle incoming messages.
      ...
      */
    virtual void addListener(uci::type::CommAssetEstimationRequestMT::Listener& listener) = 0;

    /** Removes the specified listener from this reader.
      *
      * @param listener The listener that is to be removed from this reader.
      */
    virtual void removeListener(uci::type::CommAssetEstimationRequestMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s). Returns immediately if no messages are available.
      ...
      */
    virtual unsigned long readNoWait(unsigned long maxNumberOfMessages, uci::type::CommAssetEstimationRequestMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s).
      ...
      * @return The number of messages that were handled.
      */
    virtual unsigned long read(unsigned long timeout, unsigned long maxNumberOfMessages, uci::type::CommAssetEstimationRequestMT::Listener& listener) = 0;
  ...
  /** This method creates a new reader that can be used to read a CommAssetEstimationRequestMT.
    *
    * @param topic The specification of the topic the reader is to read from.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A reader that can read a CommAssetEstimationRequestMT.
    */
  static UCI_EXPORT uci::type::CommAssetEstimationRequestMT::Reader& createReader(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a reader. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyReader(uci::type::CommAssetEstimationRequestMT::Reader& reader);
  ...
  public:
    ...
    /** Writes the OMS message to the topic specified when this Writer was created.
      ...
      */
    virtual void write(uci::type::CommAssetEstimationRequestMT& accessor) = 0;
  ...
  /** This method creates a new writer that can be used to write a CommAssetEstimationRequestMT.
    *
    * @param topic The specification of the topic the writer is to write to.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A writer that can write a CommAssetEstimationRequestMT.
    */
  static UCI_EXPORT uci::type::CommAssetEstimationRequestMT::Writer& createWriter(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a writer. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyWriter(uci::type::CommAssetEstimationRequestMT::Writer& writer);
...
protected:
  ...
  /** The assignment operator. Sets the contents of this CommAssetEstimationRequestMT to the contents of the
    * CommAssetEstimationRequestMT on the right hand side (rhs) of the assignment operator [only available to derived
    * classes].
    *
    * @param rhs The CommAssetEstimationRequestMT on the right hand side (rhs) of the assignment operator whose contents
    *      are used to set the contents of this CommAssetEstimationRequestMT.
    * @return A reference to this CommAssetEstimationRequestMT.
    */
  CommAssetEstimationRequestMT& operator=(const CommAssetEstimationRequestMT& rhs) {
    (void)rhs;
...
#endif // UCI_TYPE_COMMASSETESTIMATIONREQUESTMT_H
