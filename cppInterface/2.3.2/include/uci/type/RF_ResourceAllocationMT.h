/** @file RF_ResourceAllocationMT.h
 *
...
#ifndef UCI_TYPE_RF_RESOURCEALLOCATIONMT_H
#define UCI_TYPE_RF_RESOURCEALLOCATIONMT_H
...
#include "RF_ResourceAllocationMDT.h"
...
/** Message type used in response to a successful RF_ResourceAllocationRequest. */
class RF_ResourceAllocationMT : public virtual MessageType {
public:

  /** This method constructs a new RF_ResourceAllocationMT.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed RF_ResourceAllocationMT.
    */
  static UCI_EXPORT RF_ResourceAllocationMT& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new RF_ResourceAllocationMT initializing the data accessed by the new
    * RF_ResourceAllocationMT using the data accessed by the specified RF_ResourceAllocationMT (cloning).
    *
    * @param accessor The RF_ResourceAllocationMT that provides access to the data that is to be used to initialize the
    *      data accessed by the new created RF_ResourceAllocationMT.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed RF_ResourceAllocationMT.
    */
  static UCI_EXPORT RF_ResourceAllocationMT& create(const RF_ResourceAllocationMT& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified RF_ResourceAllocationMT. Use of the specified accessor after it has been destroyed
    * will result in undefined behavior.
    *
    * @param accessor The RF_ResourceAllocationMT that is to be destroyed.
    */
  static UCI_EXPORT void destroy(RF_ResourceAllocationMT& accessor);
  ...
  /** Returns the version that was initialized from the uci:version attribute of RF_ResourceAllocationMT.
    *
    * @return The version that was initialized from the uci:version attribute of RF_ResourceAllocationMT.
    */
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const RF_ResourceAllocationMT& accessor) = 0;
  ...
  /** Sets the value of the enumeration identified by ObjectState.
    ...
    */
  virtual uci::type::RF_ResourceAllocationMT& setObjectState(const uci::type::ObjectStateEnum& value) = 0;
  ...
  /** Sets the value of the enumeration identified by ObjectState.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::RF_ResourceAllocationMT& setObjectState(uci::type::ObjectStateEnum::EnumerationItem value) = 0;
  ...
  /** Clears (disabled) the Element identified by ObjectState.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::RF_ResourceAllocationMT& clearObjectState() = 0;
  ...
  /** Returns a const reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual const uci::type::RF_ResourceAllocationMDT& getMessageData() const = 0;
  ...
  /** Returns a reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual uci::type::RF_ResourceAllocationMDT& getMessageData() = 0;
  ...
  /** Sets the complex content identified by MessageData to the contents of the complex content accessed by the specified
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::RF_ResourceAllocationMT& setMessageData(const uci::type::RF_ResourceAllocationMDT& value) = 0;

  /** The Listener provides the support to listen and handle incoming messages of the type
    * uci::type::RF_ResourceAllocationMT.
    */
  ...
  public:
    ...
    /** The method is used to handle incoming messages.
      ...
      */
    virtual void handleMessage(const uci::type::RF_ResourceAllocationMT& message) = 0;
  ...
  public:
    ...
    /** Adds a listener to this reader to handle incoming messages.
      ...
      */
    virtual void addListener(uci::type::RF_ResourceAllocationMT::Listener& listener) = 0;

    /** Removes the specified listener from this reader.
      *
      * @param listener The listener that is to be removed from this reader.
      */
    virtual void removeListener(uci::type::RF_ResourceAllocationMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s). Returns immediately if no messages are available.
      ...
      */
    virtual unsigned long readNoWait(unsigned long maxNumberOfMessages, uci::type::RF_ResourceAllocationMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s).
      ...
      * @return The number of messages that were handled.
      */
    virtual unsigned long read(unsigned long timeout, unsigned long maxNumberOfMessages, uci::type::RF_ResourceAllocationMT::Listener& listener) = 0;
  ...
  /** This method creates a new reader that can be used to read a RF_ResourceAllocationMT.
    *
    * @param topic The specification of the topic the reader is to read from.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A reader that can read a RF_ResourceAllocationMT.
    */
  static UCI_EXPORT uci::type::RF_ResourceAllocationMT::Reader& createReader(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a reader. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyReader(uci::type::RF_ResourceAllocationMT::Reader& reader);
  ...
  public:
    ...
    /** Writes the OMS message to the topic specified when this Writer was created.
      ...
      */
    virtual void write(uci::type::RF_ResourceAllocationMT& accessor) = 0;
  ...
  /** This method creates a new writer that can be used to write a RF_ResourceAllocationMT.
    *
    * @param topic The specification of the topic the writer is to write to.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A writer that can write a RF_ResourceAllocationMT.
    */
  static UCI_EXPORT uci::type::RF_ResourceAllocationMT::Writer& createWriter(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a writer. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyWriter(uci::type::RF_ResourceAllocationMT::Writer& writer);
...
protected:
  ...
  /** The assignment operator. Sets the contents of this RF_ResourceAllocationMT to the contents of the
    * RF_ResourceAllocationMT on the right hand side (rhs) of the assignment operator [only available to derived classes].
    *
    * @param rhs The RF_ResourceAllocationMT on the right hand side (rhs) of the assignment operator whose contents are
    *      used to set the contents of this RF_ResourceAllocationMT.
    * @return A reference to this RF_ResourceAllocationMT.
    */
  RF_ResourceAllocationMT& operator=(const RF_ResourceAllocationMT& rhs) {
    (void)rhs;
...
#endif // UCI_TYPE_RF_RESOURCEALLOCATIONMT_H
