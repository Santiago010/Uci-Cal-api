/** @file STANAG_4607_PlatformTypeEnum.h
 *
...
#ifndef UCI_TYPE_STANAG_4607_PLATFORMTYPEENUM_H
#define UCI_TYPE_STANAG_4607_PLATFORMTYPEENUM_H
...
public:
  ...
  /** The assignment operator. Sets the contents of this STANAG_4607_PlatformTypeEnum to the contents of the
    * STANAG_4607_PlatformTypeEnum on the right hand side (rhs) of the assignment operator.
    *
    ...
    * @return A reference to this STANAG_4607_PlatformTypeEnum.
    */
  STANAG_4607_PlatformTypeEnum& operator=(const STANAG_4607_PlatformTypeEnum& rhs) {
    setValue(rhs.getValue());
    return *this;
  }

  /** The assignment operator that sets the value of this STANAG_4607_PlatformTypeEnum enumeration to the EnumerationItem
    * on the right hand side of the assignment operator.
    *
    * @param rhs The EnumerationItem whose value is to be assigned to this STANAG_4607_PlatformTypeEnum enumeration.
    * @return A reference to this STANAG_4607_PlatformTypeEnum enumeration.
    */
  STANAG_4607_PlatformTypeEnum& operator=(EnumerationItem rhs) {
    setValue(rhs);
    return *this;
  }
  ...
  /** Sets the value of this STANAG_4607_PlatformTypeEnum enumeration to the value of the specified enumeration item.
    *
    * @param item The EnumerationItem whose value is to be used to set the value of this STANAG_4607_PlatformTypeEnum
    *      enumeration.
    */
...
#endif // UCI_TYPE_STANAG_4607_PLATFORMTYPEENUM_H
