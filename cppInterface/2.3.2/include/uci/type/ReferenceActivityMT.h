...
#ifndef UCI_TYPE_REFERENCEACTIVITYMT_H
#define UCI_TYPE_REFERENCEACTIVITYMT_H
...
#include "ReferenceActivityMDT.h"
...
class ReferenceActivityMT : public virtual MessageType {
public:

  /** This method constructs a new ReferenceActivityMT.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed ReferenceActivityMT.
    */
  static UCI_EXPORT ReferenceActivityMT& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new ReferenceActivityMT initializing the data accessed by the new ReferenceActivityMT using
    * the data accessed by the specified ReferenceActivityMT (cloning).
    *
    * @param accessor The ReferenceActivityMT that provides access to the data that is to be used to initialize the data
    *      accessed by the new created ReferenceActivityMT.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed ReferenceActivityMT.
    */
  static UCI_EXPORT ReferenceActivityMT& create(const ReferenceActivityMT& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified ReferenceActivityMT. Use of the specified accessor after it has been destroyed
    * will result in undefined behavior.
    *
    * @param accessor The ReferenceActivityMT that is to be destroyed.
    */
  static UCI_EXPORT void destroy(ReferenceActivityMT& accessor);

  /** Returns this accessor's type constant, i.e. referenceActivityMT.
    *
    * @return This accessor's type constant, i.e. referenceActivityMT.
    */
  virtual uci::base::accessorType::AccessorType getAccessorType() const noexception {
    return uci::type::accessorType::referenceActivityMT;
  }

  /** Returns the version that was initialized from the uci:version attribute of ReferenceActivityMT.
    *
    * @return The version that was initialized from the uci:version attribute of ReferenceActivityMT.
    */
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const ReferenceActivityMT& accessor) = 0;
  ...
  /** Sets the value of the enumeration identified by ObjectState.
    ...
    */
  virtual uci::type::ReferenceActivityMT& setObjectState(const uci::type::ObjectStateEnum& value) = 0;
  ...
  /** Sets the value of the enumeration identified by ObjectState.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::ReferenceActivityMT& setObjectState(uci::type::ObjectStateEnum::EnumerationItem value) = 0;
  ...
  /** Clears (disabled) the Element identified by ObjectState.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::ReferenceActivityMT& clearObjectState() = 0;
  ...
  /** Returns a const reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual const uci::type::ReferenceActivityMDT& getMessageData() const = 0;
  ...
  /** Returns a reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual uci::type::ReferenceActivityMDT& getMessageData() = 0;
  ...
  /** Sets the complex content identified by MessageData to the contents of the complex content accessed by the specified
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::ReferenceActivityMT& setMessageData(const uci::type::ReferenceActivityMDT& value) = 0;

  /** The Listener provides the support to listen and handle incoming messages of the type uci::type::ReferenceActivityMT. */
  ...
  public:
    ...
    /** The method is used to handle incoming messages.
      ...
      */
    virtual void handleMessage(const uci::type::ReferenceActivityMT& message) = 0;
  ...
  public:
    ...
    /** Adds a listener to this reader to handle incoming messages.
      ...
      */
    virtual void addListener(uci::type::ReferenceActivityMT::Listener& listener) = 0;

    /** Removes the specified listener from this reader.
      *
      * @param listener The listener that is to be removed from this reader.
      */
    virtual void removeListener(uci::type::ReferenceActivityMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s). Returns immediately if no messages are available.
      ...
      */
    virtual unsigned long readNoWait(unsigned long maxNumberOfMessages, uci::type::ReferenceActivityMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s).
      ...
      * @return The number of messages that were handled.
      */
    virtual unsigned long read(unsigned long timeout, unsigned long maxNumberOfMessages, uci::type::ReferenceActivityMT::Listener& listener) = 0;
  ...
  /** This method creates a new reader that can be used to read a ReferenceActivityMT.
    *
    * @param topic The specification of the topic the reader is to read from.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A reader that can read a ReferenceActivityMT.
    */
  static UCI_EXPORT uci::type::ReferenceActivityMT::Reader& createReader(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a reader. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyReader(uci::type::ReferenceActivityMT::Reader& reader);
  ...
  public:
    ...
    /** Writes the OMS message to the topic specified when this Writer was created.
      ...
      */
    virtual void write(uci::type::ReferenceActivityMT& accessor) = 0;
  ...
  /** This method creates a new writer that can be used to write a ReferenceActivityMT.
    *
    * @param topic The specification of the topic the writer is to write to.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A writer that can write a ReferenceActivityMT.
    */
  static UCI_EXPORT uci::type::ReferenceActivityMT::Writer& createWriter(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a writer. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyWriter(uci::type::ReferenceActivityMT::Writer& writer);
...
protected:
  ...
  /** The copy constructor [only available to derived classes].
    *
    * @param rhs The ReferenceActivityMT to copy from.
    */
  ReferenceActivityMT(const ReferenceActivityMT& rhs) {
    (void)rhs;
  }

  /** The assignment operator. Sets the contents of this ReferenceActivityMT to the contents of the ReferenceActivityMT on
    * the right hand side (rhs) of the assignment operator [only available to derived classes].
    *
    * @param rhs The ReferenceActivityMT on the right hand side (rhs) of the assignment operator whose contents are used to
    *      set the contents of this ReferenceActivityMT.
    * @return A reference to this ReferenceActivityMT.
    */
  ReferenceActivityMT& operator=(const ReferenceActivityMT& rhs) {
    (void)rhs;
...
#endif // UCI_TYPE_REFERENCEACTIVITYMT_H
