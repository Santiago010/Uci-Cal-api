...
#ifndef UCI_TYPE_DMPI_CANCELCOMMANDMT_H
#define UCI_TYPE_DMPI_CANCELCOMMANDMT_H

#include "../base/Listener.h"
#include "../base/Reader.h"
#include "../base/Writer.h"
#include "../base/export.h"
#include "DMPI_CancelCommandMDT.h"
...
class DMPI_CancelCommandMT : public virtual MessageType {
public:

  /** This method constructs a new DMPI_CancelCommandMT.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed DMPI_CancelCommandMT.
    */
  static UCI_EXPORT DMPI_CancelCommandMT& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new DMPI_CancelCommandMT initializing the data accessed by the new DMPI_CancelCommandMT
    * using the data accessed by the specified DMPI_CancelCommandMT (cloning).
    *
    * @param accessor The DMPI_CancelCommandMT that provides access to the data that is to be used to initialize the data
    *      accessed by the new created DMPI_CancelCommandMT.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed DMPI_CancelCommandMT.
    */
  static UCI_EXPORT DMPI_CancelCommandMT& create(const DMPI_CancelCommandMT& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified DMPI_CancelCommandMT. Use of the specified accessor after it has been destroyed
    * will result in undefined behavior.
    *
    * @param accessor The DMPI_CancelCommandMT that is to be destroyed.
    */
  static UCI_EXPORT void destroy(DMPI_CancelCommandMT& accessor);

  /** Returns this accessor's type constant, i.e. dMPI_CancelCommandMT.
    *
    * @return This accessor's type constant, i.e. dMPI_CancelCommandMT.
    */
  virtual uci::base::accessorType::AccessorType getAccessorType() const noexception {
    return uci::type::accessorType::dMPI_CancelCommandMT;
  }

  /** Returns the version that was initialized from the uci:version attribute of DMPI_CancelCommandMT.
    *
    * @return The version that was initialized from the uci:version attribute of DMPI_CancelCommandMT.
    */
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const DMPI_CancelCommandMT& accessor) = 0;
  ...
  /** Returns a const reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual const uci::type::DMPI_CancelCommandMDT& getMessageData() const = 0;
  ...
  /** Returns a reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual uci::type::DMPI_CancelCommandMDT& getMessageData() = 0;
  ...
  /** Sets the complex content identified by MessageData to the contents of the complex content accessed by the specified
    ...
    */
  virtual uci::type::DMPI_CancelCommandMT& setMessageData(const uci::type::DMPI_CancelCommandMDT& value) = 0;

  /** The Listener provides the support to listen and handle incoming messages of the type uci::type::DMPI_CancelCommandMT. */
  ...
  public:
    ...
    /** The method is used to handle incoming messages.
      ...
      */
    virtual void handleMessage(const uci::type::DMPI_CancelCommandMT& message) = 0;
  ...
  public:
    ...
    /** Adds a listener to this reader to handle incoming messages.
      ...
      */
    virtual void addListener(uci::type::DMPI_CancelCommandMT::Listener& listener) = 0;

    /** Removes the specified listener from this reader.
      *
      * @param listener The listener that is to be removed from this reader.
      */
    virtual void removeListener(uci::type::DMPI_CancelCommandMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s). Returns immediately if no messages are available.
      ...
      */
    virtual unsigned long readNoWait(unsigned long maxNumberOfMessages, uci::type::DMPI_CancelCommandMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s).
      ...
      * @return The number of messages that were handled.
      */
    virtual unsigned long read(unsigned long timeout, unsigned long maxNumberOfMessages, uci::type::DMPI_CancelCommandMT::Listener& listener) = 0;
  ...
  /** This method creates a new reader that can be used to read a DMPI_CancelCommandMT.
    *
    * @param topic The specification of the topic the reader is to read from.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A reader that can read a DMPI_CancelCommandMT.
    */
  static UCI_EXPORT uci::type::DMPI_CancelCommandMT::Reader& createReader(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a reader. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyReader(uci::type::DMPI_CancelCommandMT::Reader& reader);
  ...
  public:
    ...
    /** Writes the OMS message to the topic specified when this Writer was created.
      ...
      */
    virtual void write(uci::type::DMPI_CancelCommandMT& accessor) = 0;
  ...
  /** This method creates a new writer that can be used to write a DMPI_CancelCommandMT.
    *
    * @param topic The specification of the topic the writer is to write to.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A writer that can write a DMPI_CancelCommandMT.
    */
  static UCI_EXPORT uci::type::DMPI_CancelCommandMT::Writer& createWriter(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a writer. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyWriter(uci::type::DMPI_CancelCommandMT::Writer& writer);

protected:

  /** The constructor [only available to derived classes]. */
  DMPI_CancelCommandMT() {
  }
  ...
  /** The copy constructor [only available to derived classes].
    *
    * @param rhs The DMPI_CancelCommandMT to copy from.
    */
  DMPI_CancelCommandMT(const DMPI_CancelCommandMT& rhs) {
    (void)rhs;
  }

  /** The assignment operator. Sets the contents of this DMPI_CancelCommandMT to the contents of the DMPI_CancelCommandMT
    * on the right hand side (rhs) of the assignment operator [only available to derived classes].
    *
    * @param rhs The DMPI_CancelCommandMT on the right hand side (rhs) of the assignment operator whose contents are used
    *      to set the contents of this DMPI_CancelCommandMT.
    * @return A reference to this DMPI_CancelCommandMT.
    */
  DMPI_CancelCommandMT& operator=(const DMPI_CancelCommandMT& rhs) {
    (void)rhs;
...
#endif // UCI_TYPE_DMPI_CANCELCOMMANDMT_H
