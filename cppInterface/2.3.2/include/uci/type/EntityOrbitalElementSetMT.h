/** @file EntityOrbitalElementSetMT.h
 *
...
#ifndef UCI_TYPE_ENTITYORBITALELEMENTSETMT_H
#define UCI_TYPE_ENTITYORBITALELEMENTSETMT_H

#include "../base/Listener.h"
#include "../base/Reader.h"
#include "../base/Writer.h"
#include "../base/export.h"
#include "EntityOrbitalElementSetMDT.h"
...
/** Indicates the element set's ID, Entity's ID, the parameters used for creating the element set, the element set data,
  * and the Request's ID (if message is generated in response to a request).
  */
class EntityOrbitalElementSetMT : public virtual MessageType {
public:

  /** This method constructs a new EntityOrbitalElementSetMT.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed EntityOrbitalElementSetMT.
    */
  static UCI_EXPORT EntityOrbitalElementSetMT& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new EntityOrbitalElementSetMT initializing the data accessed by the new
    * EntityOrbitalElementSetMT using the data accessed by the specified EntityOrbitalElementSetMT (cloning).
    *
    * @param accessor The EntityOrbitalElementSetMT that provides access to the data that is to be used to initialize the
    *      data accessed by the new created EntityOrbitalElementSetMT.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed EntityOrbitalElementSetMT.
    */
  static UCI_EXPORT EntityOrbitalElementSetMT& create(const EntityOrbitalElementSetMT& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified EntityOrbitalElementSetMT. Use of the specified accessor after it has been
    * destroyed will result in undefined behavior.
    *
    * @param accessor The EntityOrbitalElementSetMT that is to be destroyed.
    */
  static UCI_EXPORT void destroy(EntityOrbitalElementSetMT& accessor);

  /** Returns this accessor's type constant, i.e. entityOrbitalElementSetMT.
    *
    * @return This accessor's type constant, i.e. entityOrbitalElementSetMT.
    */
  virtual uci::base::accessorType::AccessorType getAccessorType() const noexception {
    return uci::type::accessorType::entityOrbitalElementSetMT;
  }

  /** Returns the version that was initialized from the uci:version attribute of EntityOrbitalElementSetMT.
    *
    * @return The version that was initialized from the uci:version attribute of EntityOrbitalElementSetMT.
    */
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const EntityOrbitalElementSetMT& accessor) = 0;
  ...
  /** Sets the value of the enumeration identified by ObjectState.
    ...
    */
  virtual uci::type::EntityOrbitalElementSetMT& setObjectState(const uci::type::ObjectStateEnum& value) = 0;
  ...
  /** Sets the value of the enumeration identified by ObjectState.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::EntityOrbitalElementSetMT& setObjectState(uci::type::ObjectStateEnum::EnumerationItem value) = 0;
  ...
  /** Clears (disabled) the Element identified by ObjectState.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::EntityOrbitalElementSetMT& clearObjectState() = 0;
  ...
  /** Returns a const reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual const uci::type::EntityOrbitalElementSetMDT& getMessageData() const = 0;
  ...
  /** Returns a reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual uci::type::EntityOrbitalElementSetMDT& getMessageData() = 0;
  ...
  /** Sets the complex content identified by MessageData to the contents of the complex content accessed by the specified
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::EntityOrbitalElementSetMT& setMessageData(const uci::type::EntityOrbitalElementSetMDT& value) = 0;

  /** The Listener provides the support to listen and handle incoming messages of the type
    * uci::type::EntityOrbitalElementSetMT.
    */
  ...
  public:
    ...
    /** The method is used to handle incoming messages.
      ...
      */
    virtual void handleMessage(const uci::type::EntityOrbitalElementSetMT& message) = 0;
  ...
  public:
    ...
    /** Adds a listener to this reader to handle incoming messages.
      ...
      */
    virtual void addListener(uci::type::EntityOrbitalElementSetMT::Listener& listener) = 0;

    /** Removes the specified listener from this reader.
      *
      * @param listener The listener that is to be removed from this reader.
      */
    virtual void removeListener(uci::type::EntityOrbitalElementSetMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s). Returns immediately if no messages are available.
      ...
      */
    virtual unsigned long readNoWait(unsigned long maxNumberOfMessages, uci::type::EntityOrbitalElementSetMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s).
      ...
      * @return The number of messages that were handled.
      */
    virtual unsigned long read(unsigned long timeout, unsigned long maxNumberOfMessages, uci::type::EntityOrbitalElementSetMT::Listener& listener) = 0;
  ...
  /** This method creates a new reader that can be used to read a EntityOrbitalElementSetMT.
    *
    * @param topic The specification of the topic the reader is to read from.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A reader that can read a EntityOrbitalElementSetMT.
    */
  static UCI_EXPORT uci::type::EntityOrbitalElementSetMT::Reader& createReader(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a reader. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyReader(uci::type::EntityOrbitalElementSetMT::Reader& reader);
  ...
  public:
    ...
    /** Writes the OMS message to the topic specified when this Writer was created.
      ...
      */
    virtual void write(uci::type::EntityOrbitalElementSetMT& accessor) = 0;
  ...
  /** This method creates a new writer that can be used to write a EntityOrbitalElementSetMT.
    *
    * @param topic The specification of the topic the writer is to write to.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A writer that can write a EntityOrbitalElementSetMT.
    */
  static UCI_EXPORT uci::type::EntityOrbitalElementSetMT::Writer& createWriter(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a writer. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyWriter(uci::type::EntityOrbitalElementSetMT::Writer& writer);
...
protected:
  ...
  /** The copy constructor [only available to derived classes].
    *
    * @param rhs The EntityOrbitalElementSetMT to copy from.
    */
  EntityOrbitalElementSetMT(const EntityOrbitalElementSetMT& rhs) {
    (void)rhs;
  }

  /** The assignment operator. Sets the contents of this EntityOrbitalElementSetMT to the contents of the
    * EntityOrbitalElementSetMT on the right hand side (rhs) of the assignment operator [only available to derived
    * classes].
    *
    * @param rhs The EntityOrbitalElementSetMT on the right hand side (rhs) of the assignment operator whose contents are
    *      used to set the contents of this EntityOrbitalElementSetMT.
    * @return A reference to this EntityOrbitalElementSetMT.
    */
  EntityOrbitalElementSetMT& operator=(const EntityOrbitalElementSetMT& rhs) {
    (void)rhs;
...
#endif // UCI_TYPE_ENTITYORBITALELEMENTSETMT_H
