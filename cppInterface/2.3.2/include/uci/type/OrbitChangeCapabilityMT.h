/** @file OrbitChangeCapabilityMT.h
 *
...
#ifndef UCI_TYPE_ORBITCHANGECAPABILITYMT_H
#define UCI_TYPE_ORBITCHANGECAPABILITYMT_H
...
#include "OrbitChangeCapabilityMDT.h"
...
class OrbitChangeCapabilityMT : public virtual MessageType {
public:

  /** This method constructs a new OrbitChangeCapabilityMT.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed OrbitChangeCapabilityMT.
    */
  static UCI_EXPORT OrbitChangeCapabilityMT& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new OrbitChangeCapabilityMT initializing the data accessed by the new
    * OrbitChangeCapabilityMT using the data accessed by the specified OrbitChangeCapabilityMT (cloning).
    *
    * @param accessor The OrbitChangeCapabilityMT that provides access to the data that is to be used to initialize the
    *      data accessed by the new created OrbitChangeCapabilityMT.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed OrbitChangeCapabilityMT.
    */
  static UCI_EXPORT OrbitChangeCapabilityMT& create(const OrbitChangeCapabilityMT& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified OrbitChangeCapabilityMT. Use of the specified accessor after it has been destroyed
    * will result in undefined behavior.
    *
    * @param accessor The OrbitChangeCapabilityMT that is to be destroyed.
    */
  static UCI_EXPORT void destroy(OrbitChangeCapabilityMT& accessor);

  /** Returns this accessor's type constant, i.e. orbitChangeCapabilityMT.
    *
    * @return This accessor's type constant, i.e. orbitChangeCapabilityMT.
    */
  virtual uci::base::accessorType::AccessorType getAccessorType() const noexception {
    return uci::type::accessorType::orbitChangeCapabilityMT;
  }

  /** Returns the version that was initialized from the uci:version attribute of OrbitChangeCapabilityMT.
    *
    * @return The version that was initialized from the uci:version attribute of OrbitChangeCapabilityMT.
    */
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const OrbitChangeCapabilityMT& accessor) = 0;
  ...
  /** Sets the value of the enumeration identified by ObjectState.
    ...
    */
  virtual uci::type::OrbitChangeCapabilityMT& setObjectState(const uci::type::ObjectStateEnum& value) = 0;
  ...
  /** Sets the value of the enumeration identified by ObjectState.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::OrbitChangeCapabilityMT& setObjectState(uci::type::ObjectStateEnum::EnumerationItem value) = 0;
  ...
  /** Clears (disabled) the Element identified by ObjectState.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::OrbitChangeCapabilityMT& clearObjectState() = 0;
  ...
  /** Returns a const reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual const uci::type::OrbitChangeCapabilityMDT& getMessageData() const = 0;
  ...
  /** Returns a reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual uci::type::OrbitChangeCapabilityMDT& getMessageData() = 0;
  ...
  /** Sets the complex content identified by MessageData to the contents of the complex content accessed by the specified
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::OrbitChangeCapabilityMT& setMessageData(const uci::type::OrbitChangeCapabilityMDT& value) = 0;

  /** The Listener provides the support to listen and handle incoming messages of the type
    * uci::type::OrbitChangeCapabilityMT.
    */
  ...
  public:
    ...
    /** The method is used to handle incoming messages.
      ...
      */
    virtual void handleMessage(const uci::type::OrbitChangeCapabilityMT& message) = 0;
  ...
  public:
    ...
    /** Adds a listener to this reader to handle incoming messages.
      ...
      */
    virtual void addListener(uci::type::OrbitChangeCapabilityMT::Listener& listener) = 0;

    /** Removes the specified listener from this reader.
      *
      * @param listener The listener that is to be removed from this reader.
      */
    virtual void removeListener(uci::type::OrbitChangeCapabilityMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s). Returns immediately if no messages are available.
      ...
      */
    virtual unsigned long readNoWait(unsigned long maxNumberOfMessages, uci::type::OrbitChangeCapabilityMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s).
      ...
      * @return The number of messages that were handled.
      */
    virtual unsigned long read(unsigned long timeout, unsigned long maxNumberOfMessages, uci::type::OrbitChangeCapabilityMT::Listener& listener) = 0;
  ...
  /** This method creates a new reader that can be used to read a OrbitChangeCapabilityMT.
    *
    * @param topic The specification of the topic the reader is to read from.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A reader that can read a OrbitChangeCapabilityMT.
    */
  static UCI_EXPORT uci::type::OrbitChangeCapabilityMT::Reader& createReader(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a reader. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyReader(uci::type::OrbitChangeCapabilityMT::Reader& reader);
  ...
  public:
    ...
    /** Writes the OMS message to the topic specified when this Writer was created.
      ...
      */
    virtual void write(uci::type::OrbitChangeCapabilityMT& accessor) = 0;
  ...
  /** This method creates a new writer that can be used to write a OrbitChangeCapabilityMT.
    *
    * @param topic The specification of the topic the writer is to write to.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A writer that can write a OrbitChangeCapabilityMT.
    */
  static UCI_EXPORT uci::type::OrbitChangeCapabilityMT::Writer& createWriter(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a writer. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyWriter(uci::type::OrbitChangeCapabilityMT::Writer& writer);
...
protected:
  ...
  /** The copy constructor [only available to derived classes].
    *
    * @param rhs The OrbitChangeCapabilityMT to copy from.
    */
  OrbitChangeCapabilityMT(const OrbitChangeCapabilityMT& rhs) {
    (void)rhs;
  }

  /** The assignment operator. Sets the contents of this OrbitChangeCapabilityMT to the contents of the
    * OrbitChangeCapabilityMT on the right hand side (rhs) of the assignment operator [only available to derived classes].
    *
    * @param rhs The OrbitChangeCapabilityMT on the right hand side (rhs) of the assignment operator whose contents are
    *      used to set the contents of this OrbitChangeCapabilityMT.
    * @return A reference to this OrbitChangeCapabilityMT.
    */
  OrbitChangeCapabilityMT& operator=(const OrbitChangeCapabilityMT& rhs) {
    (void)rhs;
...
#endif // UCI_TYPE_ORBITCHANGECAPABILITYMT_H
