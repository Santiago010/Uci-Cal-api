/** @file RequirementMetricsRequestStatus.h
 *
...
typedef uci::type::RequirementMetricsRequestStatusMT RequirementMetricsRequestStatus;

} // namespace type
} // namespace uci

#endif // UCI_TYPE_REQUIREMENTMETRICSREQUESTSTATUS_H
