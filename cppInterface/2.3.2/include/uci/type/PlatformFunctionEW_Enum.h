/** @file PlatformFunctionEW_Enum.h
 *
...
#ifndef UCI_TYPE_PLATFORMFUNCTIONEW_ENUM_H
#define UCI_TYPE_PLATFORMFUNCTIONEW_ENUM_H
...
public:
  ...
  /** The assignment operator. Sets the contents of this PlatformFunctionEW_Enum to the contents of the
    * PlatformFunctionEW_Enum on the right hand side (rhs) of the assignment operator.
    *
    ...
    * @return A reference to this PlatformFunctionEW_Enum.
    */
  PlatformFunctionEW_Enum& operator=(const PlatformFunctionEW_Enum& rhs) {
    setValue(rhs.getValue());
    return *this;
  }

  /** The assignment operator that sets the value of this PlatformFunctionEW_Enum enumeration to the EnumerationItem on the
    * right hand side of the assignment operator.
    *
    * @param rhs The EnumerationItem whose value is to be assigned to this PlatformFunctionEW_Enum enumeration.
    * @return A reference to this PlatformFunctionEW_Enum enumeration.
    */
  PlatformFunctionEW_Enum& operator=(EnumerationItem rhs) {
    setValue(rhs);
    return *this;
  }
  ...
  /** Sets the value of this PlatformFunctionEW_Enum enumeration to the value of the specified enumeration item.
    *
    * @param item The EnumerationItem whose value is to be used to set the value of this PlatformFunctionEW_Enum
    *      enumeration.
    */
...
#endif // UCI_TYPE_PLATFORMFUNCTIONEW_ENUM_H
