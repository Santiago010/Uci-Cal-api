...
#ifndef UCI_TYPE_REFERENCEFRAMEORIGINTYPE_H
#define UCI_TYPE_REFERENCEFRAMEORIGINTYPE_H
...
class ReferenceFrameOriginType : public virtual uci::base::Accessor {
public:

  /** This method constructs a new ReferenceFrameOriginType.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed ReferenceFrameOriginType.
    */
  static UCI_EXPORT ReferenceFrameOriginType& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new ReferenceFrameOriginType initializing the data accessed by the new
    * ReferenceFrameOriginType using the data accessed by the specified ReferenceFrameOriginType (cloning).
    *
    * @param accessor The ReferenceFrameOriginType that provides access to the data that is to be used to initialize the
    *      data accessed by the new created ReferenceFrameOriginType.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed ReferenceFrameOriginType.
    */
  static UCI_EXPORT ReferenceFrameOriginType& create(const ReferenceFrameOriginType& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified ReferenceFrameOriginType. Use of the specified accessor after it has been
    * destroyed will result in undefined behavior.
    *
    * @param accessor The ReferenceFrameOriginType that is to be destroyed.
    */
  static UCI_EXPORT void destroy(ReferenceFrameOriginType& accessor);

  /** Returns this accessor's type constant, i.e. referenceFrameOriginType.
    *
    * @return This accessor's type constant, i.e. referenceFrameOriginType.
    */
  virtual uci::base::accessorType::AccessorType getAccessorType() const noexception {
    return uci::type::accessorType::referenceFrameOriginType;
  }

  /** Returns the version that was initialized from the uci:version attribute of ReferenceFrameOriginType.
    *
    * @return The version that was initialized from the uci:version attribute of ReferenceFrameOriginType.
    */
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const ReferenceFrameOriginType& accessor) = 0;
  ...
  /** Returns a const reference to the accessor that provides access to the complex content identified by Location.
    ...
    */
  virtual const uci::type::Point4D_Type& getLocation() const = 0;
  ...
  /** Returns a reference to the accessor that provides access to the complex content identified by Location.
    ...
    */
  virtual uci::type::Point4D_Type& getLocation() = 0;
  ...
  /** Sets the complex content identified by Location to the contents of the complex content accessed by the specified
    ...
    */
  virtual uci::type::ReferenceFrameOriginType& setLocation(const uci::type::Point4D_Type& value) = 0;
  ...
  /** Sets the complex content identified by GroundVelocity to the contents of the complex content accessed by the
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::ReferenceFrameOriginType& setGroundVelocity(const uci::type::Velocity2D_Type& value) = 0;
  ...
  /** Clears (disabled) the Element identified by GroundVelocity.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::ReferenceFrameOriginType& clearGroundVelocity() = 0;
  ...
  /** Sets the complex content identified by Orientation to the contents of the complex content accessed by the specified
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::ReferenceFrameOriginType& setOrientation(const uci::type::OrientationType& value) = 0;
  ...
  /** Clears (disabled) the Element identified by Orientation.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::ReferenceFrameOriginType& clearOrientation() = 0;
...
protected:
  ...
  /** The copy constructor [only available to derived classes].
    ...
    */
  ReferenceFrameOriginType(const ReferenceFrameOriginType& rhs) {
    (void)rhs;
  }

  /** The assignment operator. Sets the contents of this ReferenceFrameOriginType to the contents of the
    * ReferenceFrameOriginType on the right hand side (rhs) of the assignment operator [only available to derived classes].
    *
    * @param rhs The ReferenceFrameOriginType on the right hand side (rhs) of the assignment operator whose contents are
    *      used to set the contents of this ReferenceFrameOriginType.
    * @return A reference to this ReferenceFrameOriginType.
    */
  ReferenceFrameOriginType& operator=(const ReferenceFrameOriginType& rhs) {
    (void)rhs;
...
#endif // UCI_TYPE_REFERENCEFRAMEORIGINTYPE_H
