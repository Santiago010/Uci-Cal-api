...
#ifndef UCI_TYPE_COMMTERMINALPLANTRIGGERTYPE_H
#define UCI_TYPE_COMMTERMINALPLANTRIGGERTYPE_H
...
class CommTerminalPlanTriggerType : public virtual uci::base::Accessor {
public:

  /** This method constructs a new CommTerminalPlanTriggerType.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed CommTerminalPlanTriggerType.
    */
  static UCI_EXPORT CommTerminalPlanTriggerType& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new CommTerminalPlanTriggerType initializing the data accessed by the new
    * CommTerminalPlanTriggerType using the data accessed by the specified CommTerminalPlanTriggerType (cloning).
    *
    * @param accessor The CommTerminalPlanTriggerType that provides access to the data that is to be used to initialize the
    *      data accessed by the new created CommTerminalPlanTriggerType.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed CommTerminalPlanTriggerType.
    */
  static UCI_EXPORT CommTerminalPlanTriggerType& create(const CommTerminalPlanTriggerType& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified CommTerminalPlanTriggerType. Use of the specified accessor after it has been
    * destroyed will result in undefined behavior.
    *
    * @param accessor The CommTerminalPlanTriggerType that is to be destroyed.
    */
  static UCI_EXPORT void destroy(CommTerminalPlanTriggerType& accessor);

  /** Returns this accessor's type constant, i.e. commTerminalPlanTriggerType.
    *
    * @return This accessor's type constant, i.e. commTerminalPlanTriggerType.
    */
  virtual uci::base::accessorType::AccessorType getAccessorType() const noexception {
    return uci::type::accessorType::commTerminalPlanTriggerType;
  }

  /** Returns the version that was initialized from the uci:version attribute of CommTerminalPlanTriggerType.
    *
    * @return The version that was initialized from the uci:version attribute of CommTerminalPlanTriggerType.
    */
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const CommTerminalPlanTriggerType& accessor) = 0;
  ...
  /** Returns a const reference to the bounded list identified by MissionID.
    ...
    */
  virtual const uci::type::CommTerminalPlanTriggerType::MissionID& getMissionID() const = 0;
  ...
  /** Returns a reference to the bounded list identified by MissionID.
    ...
    */
  virtual uci::type::CommTerminalPlanTriggerType::MissionID& getMissionID() = 0;
  ...
  /** Sets the bounded list identified by MissionID.
    ...
    */
  virtual uci::type::CommTerminalPlanTriggerType& setMissionID(const uci::type::CommTerminalPlanTriggerType::MissionID& value) = 0;
  ...
  /** Sets the complex content identified by PlanIdentifier to the contents of the complex content accessed by the
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::CommTerminalPlanTriggerType& setPlanIdentifier(const uci::type::PlansReferenceType& value) = 0;
  ...
  /** Clears (disabled) the Element identified by PlanIdentifier.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::CommTerminalPlanTriggerType& clearPlanIdentifier() = 0;
  ...
  /** Returns a const reference to the bounded list identified by EffectiveTimeSpans.
    ...
    */
  virtual const uci::type::CommTerminalPlanTriggerType::EffectiveTimeSpans& getEffectiveTimeSpans() const = 0;
  ...
  /** Returns a reference to the bounded list identified by EffectiveTimeSpans.
    ...
    */
  virtual uci::type::CommTerminalPlanTriggerType::EffectiveTimeSpans& getEffectiveTimeSpans() = 0;
  ...
  /** Sets the bounded list identified by EffectiveTimeSpans.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::CommTerminalPlanTriggerType& setEffectiveTimeSpans(const uci::type::CommTerminalPlanTriggerType::EffectiveTimeSpans& value) = 0;
  ...
  /** Returns a const reference to the bounded list identified by OpZoneID.
    ...
    */
  virtual const uci::type::CommTerminalPlanTriggerType::OpZoneID& getOpZoneID() const = 0;
  ...
  /** Returns a reference to the bounded list identified by OpZoneID.
    ...
    */
  virtual uci::type::CommTerminalPlanTriggerType::OpZoneID& getOpZoneID() = 0;
  ...
  /** Sets the bounded list identified by OpZoneID.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::CommTerminalPlanTriggerType& setOpZoneID(const uci::type::CommTerminalPlanTriggerType::OpZoneID& value) = 0;
  ...
  /** Returns a const reference to the bounded list identified by OpVolumeID.
    ...
    */
  virtual const uci::type::CommTerminalPlanTriggerType::OpVolumeID& getOpVolumeID() const = 0;
  ...
  /** Returns a reference to the bounded list identified by OpVolumeID.
    ...
    */
  virtual uci::type::CommTerminalPlanTriggerType::OpVolumeID& getOpVolumeID() = 0;
  ...
  /** Sets the bounded list identified by OpVolumeID.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::CommTerminalPlanTriggerType& setOpVolumeID(const uci::type::CommTerminalPlanTriggerType::OpVolumeID& value) = 0;
...
protected:
  ...
  /** The copy constructor [only available to derived classes].
    ...
    */
  CommTerminalPlanTriggerType(const CommTerminalPlanTriggerType& rhs) {
    (void)rhs;
  }

  /** The assignment operator. Sets the contents of this CommTerminalPlanTriggerType to the contents of the
    * CommTerminalPlanTriggerType on the right hand side (rhs) of the assignment operator [only available to derived
    * classes].
    *
    * @param rhs The CommTerminalPlanTriggerType on the right hand side (rhs) of the assignment operator whose contents are
    *      used to set the contents of this CommTerminalPlanTriggerType.
    * @return A reference to this CommTerminalPlanTriggerType.
    */
  CommTerminalPlanTriggerType& operator=(const CommTerminalPlanTriggerType& rhs) {
    (void)rhs;
...
#endif // UCI_TYPE_COMMTERMINALPLANTRIGGERTYPE_H
