/** @file OperatorNotificationOverrideMT.h
 *
...
#ifndef UCI_TYPE_OPERATORNOTIFICATIONOVERRIDEMT_H
#define UCI_TYPE_OPERATORNOTIFICATIONOVERRIDEMT_H
...
#include "OperatorNotificationOverrideMDT.h"
...
class OperatorNotificationOverrideMT : public virtual MessageType {
public:

  /** This method constructs a new OperatorNotificationOverrideMT.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed OperatorNotificationOverrideMT.
    */
  static UCI_EXPORT OperatorNotificationOverrideMT& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new OperatorNotificationOverrideMT initializing the data accessed by the new
    * OperatorNotificationOverrideMT using the data accessed by the specified OperatorNotificationOverrideMT (cloning).
    *
    * @param accessor The OperatorNotificationOverrideMT that provides access to the data that is to be used to initialize
    *      the data accessed by the new created OperatorNotificationOverrideMT.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed OperatorNotificationOverrideMT.
    */
  static UCI_EXPORT OperatorNotificationOverrideMT& create(const OperatorNotificationOverrideMT& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified OperatorNotificationOverrideMT. Use of the specified accessor after it has been
    * destroyed will result in undefined behavior.
    *
    * @param accessor The OperatorNotificationOverrideMT that is to be destroyed.
    */
  static UCI_EXPORT void destroy(OperatorNotificationOverrideMT& accessor);
  ...
  /** Returns the version that was initialized from the uci:version attribute of OperatorNotificationOverrideMT.
    *
    * @return The version that was initialized from the uci:version attribute of OperatorNotificationOverrideMT.
    */
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const OperatorNotificationOverrideMT& accessor) = 0;
  ...
  /** Sets the value of the enumeration identified by ObjectState.
    ...
    */
  virtual uci::type::OperatorNotificationOverrideMT& setObjectState(const uci::type::ObjectStateEnum& value) = 0;
  ...
  /** Sets the value of the enumeration identified by ObjectState.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::OperatorNotificationOverrideMT& setObjectState(uci::type::ObjectStateEnum::EnumerationItem value) = 0;
  ...
  /** Clears (disabled) the Element identified by ObjectState.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::OperatorNotificationOverrideMT& clearObjectState() = 0;
  ...
  /** Returns a const reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual const uci::type::OperatorNotificationOverrideMDT& getMessageData() const = 0;
  ...
  /** Returns a reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual uci::type::OperatorNotificationOverrideMDT& getMessageData() = 0;
  ...
  /** Sets the complex content identified by MessageData to the contents of the complex content accessed by the specified
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::OperatorNotificationOverrideMT& setMessageData(const uci::type::OperatorNotificationOverrideMDT& value) = 0;

  /** The Listener provides the support to listen and handle incoming messages of the type
    * uci::type::OperatorNotificationOverrideMT.
    */
  ...
  public:
    ...
    /** The method is used to handle incoming messages.
      ...
      */
    virtual void handleMessage(const uci::type::OperatorNotificationOverrideMT& message) = 0;
  ...
  public:
    ...
    /** Adds a listener to this reader to handle incoming messages.
      ...
      */
    virtual void addListener(uci::type::OperatorNotificationOverrideMT::Listener& listener) = 0;

    /** Removes the specified listener from this reader.
      *
      * @param listener The listener that is to be removed from this reader.
      */
    virtual void removeListener(uci::type::OperatorNotificationOverrideMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s). Returns immediately if no messages are available.
      ...
      */
    virtual unsigned long readNoWait(unsigned long maxNumberOfMessages, uci::type::OperatorNotificationOverrideMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s).
      ...
      * @return The number of messages that were handled.
      */
    virtual unsigned long read(unsigned long timeout, unsigned long maxNumberOfMessages, uci::type::OperatorNotificationOverrideMT::Listener& listener) = 0;
  ...
  /** This method creates a new reader that can be used to read a OperatorNotificationOverrideMT.
    *
    * @param topic The specification of the topic the reader is to read from.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A reader that can read a OperatorNotificationOverrideMT.
    */
  static UCI_EXPORT uci::type::OperatorNotificationOverrideMT::Reader& createReader(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a reader. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyReader(uci::type::OperatorNotificationOverrideMT::Reader& reader);
  ...
  public:
    ...
    /** Writes the OMS message to the topic specified when this Writer was created.
      ...
      */
    virtual void write(uci::type::OperatorNotificationOverrideMT& accessor) = 0;
  ...
  /** This method creates a new writer that can be used to write a OperatorNotificationOverrideMT.
    *
    * @param topic The specification of the topic the writer is to write to.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A writer that can write a OperatorNotificationOverrideMT.
    */
  static UCI_EXPORT uci::type::OperatorNotificationOverrideMT::Writer& createWriter(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a writer. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyWriter(uci::type::OperatorNotificationOverrideMT::Writer& writer);
...
protected:
  ...
  /** The assignment operator. Sets the contents of this OperatorNotificationOverrideMT to the contents of the
    * OperatorNotificationOverrideMT on the right hand side (rhs) of the assignment operator [only available to derived
    * classes].
    *
    * @param rhs The OperatorNotificationOverrideMT on the right hand side (rhs) of the assignment operator whose contents
    *      are used to set the contents of this OperatorNotificationOverrideMT.
    * @return A reference to this OperatorNotificationOverrideMT.
    */
  OperatorNotificationOverrideMT& operator=(const OperatorNotificationOverrideMT& rhs) {
    (void)rhs;
...
#endif // UCI_TYPE_OPERATORNOTIFICATIONOVERRIDEMT_H
