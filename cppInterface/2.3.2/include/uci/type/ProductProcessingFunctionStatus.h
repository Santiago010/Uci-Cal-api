/** @file ProductProcessingFunctionStatus.h
 *
...
typedef uci::type::ProductProcessingFunctionStatusMT ProductProcessingFunctionStatus;

} // namespace type
} // namespace uci

#endif // UCI_TYPE_PRODUCTPROCESSINGFUNCTIONSTATUS_H
