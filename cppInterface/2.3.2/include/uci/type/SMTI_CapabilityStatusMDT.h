...
class SMTI_CapabilityStatusMDT : public virtual CapabilityStatusBaseType {
public:

  /** This method constructs a new SMTI_CapabilityStatusMDT.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed SMTI_CapabilityStatusMDT.
    */
  static UCI_EXPORT SMTI_CapabilityStatusMDT& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new SMTI_CapabilityStatusMDT initializing the data accessed by the new
    * SMTI_CapabilityStatusMDT using the data accessed by the specified SMTI_CapabilityStatusMDT (cloning).
    *
    * @param accessor The SMTI_CapabilityStatusMDT that provides access to the data that is to be used to initialize the
    *      data accessed by the new created SMTI_CapabilityStatusMDT.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed SMTI_CapabilityStatusMDT.
    */
  static UCI_EXPORT SMTI_CapabilityStatusMDT& create(const SMTI_CapabilityStatusMDT& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified SMTI_CapabilityStatusMDT. Use of the specified accessor after it has been
    * destroyed will result in undefined behavior.
    *
    * @param accessor The SMTI_CapabilityStatusMDT that is to be destroyed.
    */
  static UCI_EXPORT void destroy(SMTI_CapabilityStatusMDT& accessor);
  ...
  /** Returns the version that was initialized from the uci:version attribute of SMTI_CapabilityStatusMDT.
    *
    * @return The version that was initialized from the uci:version attribute of SMTI_CapabilityStatusMDT.
    */
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const SMTI_CapabilityStatusMDT& accessor) = 0;
  ...
  /** Returns a const reference to the bounded list identified by CapabilityStatus.
    ...
    */
  virtual const uci::type::SMTI_CapabilityStatusMDT::CapabilityStatus& getCapabilityStatus() const = 0;
  ...
  /** Returns a reference to the bounded list identified by CapabilityStatus.
    ...
    */
  virtual uci::type::SMTI_CapabilityStatusMDT::CapabilityStatus& getCapabilityStatus() = 0;
  ...
  /** Sets the bounded list identified by CapabilityStatus.
    ...
    */
  virtual uci::type::SMTI_CapabilityStatusMDT& setCapabilityStatus(const uci::type::SMTI_CapabilityStatusMDT::CapabilityStatus& value) = 0;
  ...
  /** Returns a const reference to the bounded list identified by RF_Profile.
    ...
    */
  virtual const uci::type::SMTI_CapabilityStatusMDT::RF_Profile& getRF_Profile() const = 0;
  ...
  /** Returns a reference to the bounded list identified by RF_Profile.
    ...
    */
  virtual uci::type::SMTI_CapabilityStatusMDT::RF_Profile& getRF_Profile() = 0;
  ...
  /** Sets the bounded list identified by RF_Profile.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::SMTI_CapabilityStatusMDT& setRF_Profile(const uci::type::SMTI_CapabilityStatusMDT::RF_Profile& value) = 0;
  ...
  /** Sets the value of the enumeration identified by EmissionBalanceState.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::SMTI_CapabilityStatusMDT& setEmissionBalanceState(const uci::type::EmissionBalanceEnum& value) = 0;
  ...
  /** Sets the value of the enumeration identified by EmissionBalanceState.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::SMTI_CapabilityStatusMDT& setEmissionBalanceState(uci::type::EmissionBalanceEnum::EnumerationItem value) = 0;
  ...
  /** Clears (disabled) the Element identified by EmissionBalanceState.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::SMTI_CapabilityStatusMDT& clearEmissionBalanceState() = 0;
  ...
  /** Returns a const reference to the bounded list identified by MessageOutput.
    ...
    */
  virtual const uci::type::SMTI_CapabilityStatusMDT::MessageOutput& getMessageOutput() const = 0;
  ...
  /** Returns a reference to the bounded list identified by MessageOutput.
    ...
    */
  virtual uci::type::SMTI_CapabilityStatusMDT::MessageOutput& getMessageOutput() = 0;
  ...
  /** Sets the bounded list identified by MessageOutput.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::SMTI_CapabilityStatusMDT& setMessageOutput(const uci::type::SMTI_CapabilityStatusMDT::MessageOutput& value) = 0;
  ...
  /** Sets the complex content identified by DefaultPackingPlan to the contents of the complex content accessed by the
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::SMTI_CapabilityStatusMDT& setDefaultPackingPlan(const uci::type::STANAG_4607_PackingPlanPET& value) = 0;
  ...
  /** Clears (disabled) the Element identified by DefaultPackingPlan.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::SMTI_CapabilityStatusMDT& clearDefaultPackingPlan() = 0;
  ...
  /** Returns a const reference to the bounded list identified by ElectronicProtectionOptionsEnabled.
    ...
    */
  virtual const uci::type::SMTI_CapabilityStatusMDT::ElectronicProtectionOptionsEnabled& getElectronicProtectionOptionsEnabled() const = 0;
  ...
  /** Returns a reference to the bounded list identified by ElectronicProtectionOptionsEnabled.
    ...
    */
  virtual uci::type::SMTI_CapabilityStatusMDT::ElectronicProtectionOptionsEnabled& getElectronicProtectionOptionsEnabled() = 0;
  ...
  /** Sets the bounded list identified by ElectronicProtectionOptionsEnabled.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::SMTI_CapabilityStatusMDT& setElectronicProtectionOptionsEnabled(const uci::type::SMTI_CapabilityStatusMDT::ElectronicProtectionOptionsEnabled& value) = 0;
...
protected:
  ...
  /** The assignment operator. Sets the contents of this SMTI_CapabilityStatusMDT to the contents of the
    * SMTI_CapabilityStatusMDT on the right hand side (rhs) of the assignment operator [only available to derived classes].
    *
    * @param rhs The SMTI_CapabilityStatusMDT on the right hand side (rhs) of the assignment operator whose contents are
    *      used to set the contents of this SMTI_CapabilityStatusMDT.
    * @return A reference to this SMTI_CapabilityStatusMDT.
    */
  SMTI_CapabilityStatusMDT& operator=(const SMTI_CapabilityStatusMDT& rhs) {
    (void)rhs;
...
#endif // UCI_TYPE_SMTI_CAPABILITYSTATUSMDT_H
