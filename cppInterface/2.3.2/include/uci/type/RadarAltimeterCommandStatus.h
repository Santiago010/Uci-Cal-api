/** @file RadarAltimeterCommandStatus.h
 *
...
typedef uci::type::RadarAltimeterCommandStatusMT RadarAltimeterCommandStatus;

} // namespace type
} // namespace uci

#endif // UCI_TYPE_RADARALTIMETERCOMMANDSTATUS_H
