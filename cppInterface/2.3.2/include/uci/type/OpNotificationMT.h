...
#ifndef UCI_TYPE_OPNOTIFICATIONMT_H
#define UCI_TYPE_OPNOTIFICATIONMT_H
...
/** This message provides the real-time notification of an OpLine, OpPoint OpVolume, and/or OpZone. Since the operational
  ...
  */
class OpNotificationMT : public virtual MessageType {
public:

  /** This method constructs a new OpNotificationMT.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed OpNotificationMT.
    */
  static UCI_EXPORT OpNotificationMT& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new OpNotificationMT initializing the data accessed by the new OpNotificationMT using the
    * data accessed by the specified OpNotificationMT (cloning).
    *
    * @param accessor The OpNotificationMT that provides access to the data that is to be used to initialize the data
    *      accessed by the new created OpNotificationMT.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed OpNotificationMT.
    */
  static UCI_EXPORT OpNotificationMT& create(const OpNotificationMT& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified OpNotificationMT. Use of the specified accessor after it has been destroyed will
    * result in undefined behavior.
    *
    * @param accessor The OpNotificationMT that is to be destroyed.
    */
  static UCI_EXPORT void destroy(OpNotificationMT& accessor);

  /** Returns this accessor's type constant, i.e. opNotificationMT.
    *
    * @return This accessor's type constant, i.e. opNotificationMT.
    */
  virtual uci::base::accessorType::AccessorType getAccessorType() const noexception {
    return uci::type::accessorType::opNotificationMT;
  }

  /** Returns the version that was initialized from the uci:version attribute of OpNotificationMT.
    *
    * @return The version that was initialized from the uci:version attribute of OpNotificationMT.
    */
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const OpNotificationMT& accessor) = 0;
  ...
  /** Sets the value of the enumeration identified by ObjectState.
    ...
    */
  virtual uci::type::OpNotificationMT& setObjectState(const uci::type::ObjectStateEnum& value) = 0;
  ...
  /** Sets the value of the enumeration identified by ObjectState.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::OpNotificationMT& setObjectState(uci::type::ObjectStateEnum::EnumerationItem value) = 0;
  ...
  /** Clears (disabled) the Element identified by ObjectState.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::OpNotificationMT& clearObjectState() = 0;
  ...
  /** Returns a const reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual const uci::type::OpNotificationMDT& getMessageData() const = 0;
  ...
  /** Returns a reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual uci::type::OpNotificationMDT& getMessageData() = 0;
  ...
  /** Sets the complex content identified by MessageData to the contents of the complex content accessed by the specified
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::OpNotificationMT& setMessageData(const uci::type::OpNotificationMDT& value) = 0;

  /** The Listener provides the support to listen and handle incoming messages of the type uci::type::OpNotificationMT. */
  ...
  public:
    ...
    /** The method is used to handle incoming messages.
      ...
      */
    virtual void handleMessage(const uci::type::OpNotificationMT& message) = 0;
  ...
  public:
    ...
    /** Adds a listener to this reader to handle incoming messages.
      ...
      */
    virtual void addListener(uci::type::OpNotificationMT::Listener& listener) = 0;

    /** Removes the specified listener from this reader.
      *
      * @param listener The listener that is to be removed from this reader.
      */
    virtual void removeListener(uci::type::OpNotificationMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s). Returns immediately if no messages are available.
      ...
      */
    virtual unsigned long readNoWait(unsigned long maxNumberOfMessages, uci::type::OpNotificationMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s).
      ...
      * @return The number of messages that were handled.
      */
    virtual unsigned long read(unsigned long timeout, unsigned long maxNumberOfMessages, uci::type::OpNotificationMT::Listener& listener) = 0;
  ...
  /** This method creates a new reader that can be used to read a OpNotificationMT.
    *
    * @param topic The specification of the topic the reader is to read from.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A reader that can read a OpNotificationMT.
    */
  static UCI_EXPORT uci::type::OpNotificationMT::Reader& createReader(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a reader. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyReader(uci::type::OpNotificationMT::Reader& reader);
  ...
  public:
    ...
    /** Writes the OMS message to the topic specified when this Writer was created.
      ...
      */
    virtual void write(uci::type::OpNotificationMT& accessor) = 0;
  ...
  /** This method creates a new writer that can be used to write a OpNotificationMT.
    *
    * @param topic The specification of the topic the writer is to write to.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A writer that can write a OpNotificationMT.
    */
  static UCI_EXPORT uci::type::OpNotificationMT::Writer& createWriter(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a writer. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyWriter(uci::type::OpNotificationMT::Writer& writer);
...
protected:
  ...
  /** The copy constructor [only available to derived classes].
    *
    * @param rhs The OpNotificationMT to copy from.
    */
  OpNotificationMT(const OpNotificationMT& rhs) {
    (void)rhs;
  }

  /** The assignment operator. Sets the contents of this OpNotificationMT to the contents of the OpNotificationMT on the
    * right hand side (rhs) of the assignment operator [only available to derived classes].
    *
    * @param rhs The OpNotificationMT on the right hand side (rhs) of the assignment operator whose contents are used to
    *      set the contents of this OpNotificationMT.
    * @return A reference to this OpNotificationMT.
    */
  OpNotificationMT& operator=(const OpNotificationMT& rhs) {
    (void)rhs;
...
#endif // UCI_TYPE_OPNOTIFICATIONMT_H
