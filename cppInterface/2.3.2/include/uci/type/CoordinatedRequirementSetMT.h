/** @file CoordinatedRequirementSetMT.h
 *
...
#ifndef UCI_TYPE_COORDINATEDREQUIREMENTSETMT_H
#define UCI_TYPE_COORDINATEDREQUIREMENTSETMT_H

#include "../base/Listener.h"
#include "../base/Reader.h"
#include "../base/Writer.h"
#include "../base/export.h"
#include "CoordinatedRequirementSetMDT.h"
...
class CoordinatedRequirementSetMT : public virtual MessageType {
public:

  /** This method constructs a new CoordinatedRequirementSetMT.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed CoordinatedRequirementSetMT.
    */
  static UCI_EXPORT CoordinatedRequirementSetMT& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new CoordinatedRequirementSetMT initializing the data accessed by the new
    * CoordinatedRequirementSetMT using the data accessed by the specified CoordinatedRequirementSetMT (cloning).
    *
    * @param accessor The CoordinatedRequirementSetMT that provides access to the data that is to be used to initialize the
    *      data accessed by the new created CoordinatedRequirementSetMT.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed CoordinatedRequirementSetMT.
    */
  static UCI_EXPORT CoordinatedRequirementSetMT& create(const CoordinatedRequirementSetMT& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified CoordinatedRequirementSetMT. Use of the specified accessor after it has been
    * destroyed will result in undefined behavior.
    *
    * @param accessor The CoordinatedRequirementSetMT that is to be destroyed.
    */
  static UCI_EXPORT void destroy(CoordinatedRequirementSetMT& accessor);

  /** Returns this accessor's type constant, i.e. coordinatedRequirementSetMT.
    *
    * @return This accessor's type constant, i.e. coordinatedRequirementSetMT.
    */
  virtual uci::base::accessorType::AccessorType getAccessorType() const noexception {
    return uci::type::accessorType::coordinatedRequirementSetMT;
  }

  /** Returns the version that was initialized from the uci:version attribute of CoordinatedRequirementSetMT.
    *
    * @return The version that was initialized from the uci:version attribute of CoordinatedRequirementSetMT.
    */
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const CoordinatedRequirementSetMT& accessor) = 0;
  ...
  /** Sets the value of the enumeration identified by ObjectState.
    ...
    */
  virtual uci::type::CoordinatedRequirementSetMT& setObjectState(const uci::type::ObjectStateEnum& value) = 0;
  ...
  /** Sets the value of the enumeration identified by ObjectState.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::CoordinatedRequirementSetMT& setObjectState(uci::type::ObjectStateEnum::EnumerationItem value) = 0;
  ...
  /** Clears (disabled) the Element identified by ObjectState.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::CoordinatedRequirementSetMT& clearObjectState() = 0;
  ...
  /** Returns a const reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual const uci::type::CoordinatedRequirementSetMDT& getMessageData() const = 0;
  ...
  /** Returns a reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual uci::type::CoordinatedRequirementSetMDT& getMessageData() = 0;
  ...
  /** Sets the complex content identified by MessageData to the contents of the complex content accessed by the specified
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::CoordinatedRequirementSetMT& setMessageData(const uci::type::CoordinatedRequirementSetMDT& value) = 0;

  /** The Listener provides the support to listen and handle incoming messages of the type
    * uci::type::CoordinatedRequirementSetMT.
    */
  ...
  public:
    ...
    /** The method is used to handle incoming messages.
      ...
      */
    virtual void handleMessage(const uci::type::CoordinatedRequirementSetMT& message) = 0;
  ...
  public:
    ...
    /** Adds a listener to this reader to handle incoming messages.
      ...
      */
    virtual void addListener(uci::type::CoordinatedRequirementSetMT::Listener& listener) = 0;

    /** Removes the specified listener from this reader.
      *
      * @param listener The listener that is to be removed from this reader.
      */
    virtual void removeListener(uci::type::CoordinatedRequirementSetMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s). Returns immediately if no messages are available.
      ...
      */
    virtual unsigned long readNoWait(unsigned long maxNumberOfMessages, uci::type::CoordinatedRequirementSetMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s).
      ...
      * @return The number of messages that were handled.
      */
    virtual unsigned long read(unsigned long timeout, unsigned long maxNumberOfMessages, uci::type::CoordinatedRequirementSetMT::Listener& listener) = 0;
  ...
  /** This method creates a new reader that can be used to read a CoordinatedRequirementSetMT.
    *
    * @param topic The specification of the topic the reader is to read from.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A reader that can read a CoordinatedRequirementSetMT.
    */
  static UCI_EXPORT uci::type::CoordinatedRequirementSetMT::Reader& createReader(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a reader. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyReader(uci::type::CoordinatedRequirementSetMT::Reader& reader);
  ...
  public:
    ...
    /** Writes the OMS message to the topic specified when this Writer was created.
      ...
      */
    virtual void write(uci::type::CoordinatedRequirementSetMT& accessor) = 0;
  ...
  /** This method creates a new writer that can be used to write a CoordinatedRequirementSetMT.
    *
    * @param topic The specification of the topic the writer is to write to.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A writer that can write a CoordinatedRequirementSetMT.
    */
  static UCI_EXPORT uci::type::CoordinatedRequirementSetMT::Writer& createWriter(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a writer. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyWriter(uci::type::CoordinatedRequirementSetMT::Writer& writer);
...
protected:
  ...
  /** The copy constructor [only available to derived classes].
    *
    * @param rhs The CoordinatedRequirementSetMT to copy from.
    */
  CoordinatedRequirementSetMT(const CoordinatedRequirementSetMT& rhs) {
    (void)rhs;
  }

  /** The assignment operator. Sets the contents of this CoordinatedRequirementSetMT to the contents of the
    * CoordinatedRequirementSetMT on the right hand side (rhs) of the assignment operator [only available to derived
    * classes].
    *
    * @param rhs The CoordinatedRequirementSetMT on the right hand side (rhs) of the assignment operator whose contents are
    *      used to set the contents of this CoordinatedRequirementSetMT.
    * @return A reference to this CoordinatedRequirementSetMT.
    */
  CoordinatedRequirementSetMT& operator=(const CoordinatedRequirementSetMT& rhs) {
    (void)rhs;
...
#endif // UCI_TYPE_COORDINATEDREQUIREMENTSETMT_H
