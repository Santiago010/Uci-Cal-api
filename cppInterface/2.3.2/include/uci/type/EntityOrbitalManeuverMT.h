/** @file EntityOrbitalManeuverMT.h
 *
...
#ifndef UCI_TYPE_ENTITYORBITALMANEUVERMT_H
#define UCI_TYPE_ENTITYORBITALMANEUVERMT_H

#include "../base/Listener.h"
#include "../base/Reader.h"
#include "../base/Writer.h"
#include "../base/export.h"
#include "EntityOrbitalManeuverMDT.h"
...
/** Indicates the ID of the maneuver, the state of the maneuver, the Entity's ID, the ID of the sensor that detected the
  * maneuver, characteristics of the maneuver, and the maneuver solution.
  */
class EntityOrbitalManeuverMT : public virtual MessageType {
public:

  /** This method constructs a new EntityOrbitalManeuverMT.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed EntityOrbitalManeuverMT.
    */
  static UCI_EXPORT EntityOrbitalManeuverMT& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new EntityOrbitalManeuverMT initializing the data accessed by the new
    * EntityOrbitalManeuverMT using the data accessed by the specified EntityOrbitalManeuverMT (cloning).
    *
    * @param accessor The EntityOrbitalManeuverMT that provides access to the data that is to be used to initialize the
    *      data accessed by the new created EntityOrbitalManeuverMT.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed EntityOrbitalManeuverMT.
    */
  static UCI_EXPORT EntityOrbitalManeuverMT& create(const EntityOrbitalManeuverMT& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified EntityOrbitalManeuverMT. Use of the specified accessor after it has been destroyed
    * will result in undefined behavior.
    *
    * @param accessor The EntityOrbitalManeuverMT that is to be destroyed.
    */
  static UCI_EXPORT void destroy(EntityOrbitalManeuverMT& accessor);

  /** Returns this accessor's type constant, i.e. entityOrbitalManeuverMT.
    *
    * @return This accessor's type constant, i.e. entityOrbitalManeuverMT.
    */
  virtual uci::base::accessorType::AccessorType getAccessorType() const noexception {
    return uci::type::accessorType::entityOrbitalManeuverMT;
  }

  /** Returns the version that was initialized from the uci:version attribute of EntityOrbitalManeuverMT.
    *
    * @return The version that was initialized from the uci:version attribute of EntityOrbitalManeuverMT.
    */
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const EntityOrbitalManeuverMT& accessor) = 0;
  ...
  /** Sets the value of the enumeration identified by ObjectState.
    ...
    */
  virtual uci::type::EntityOrbitalManeuverMT& setObjectState(const uci::type::ObjectStateEnum& value) = 0;
  ...
  /** Sets the value of the enumeration identified by ObjectState.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::EntityOrbitalManeuverMT& setObjectState(uci::type::ObjectStateEnum::EnumerationItem value) = 0;
  ...
  /** Clears (disabled) the Element identified by ObjectState.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::EntityOrbitalManeuverMT& clearObjectState() = 0;
  ...
  /** Returns a const reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual const uci::type::EntityOrbitalManeuverMDT& getMessageData() const = 0;
  ...
  /** Returns a reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual uci::type::EntityOrbitalManeuverMDT& getMessageData() = 0;
  ...
  /** Sets the complex content identified by MessageData to the contents of the complex content accessed by the specified
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::EntityOrbitalManeuverMT& setMessageData(const uci::type::EntityOrbitalManeuverMDT& value) = 0;

  /** The Listener provides the support to listen and handle incoming messages of the type
    * uci::type::EntityOrbitalManeuverMT.
    */
  ...
  public:
    ...
    /** The method is used to handle incoming messages.
      ...
      */
    virtual void handleMessage(const uci::type::EntityOrbitalManeuverMT& message) = 0;
  ...
  public:
    ...
    /** Adds a listener to this reader to handle incoming messages.
      ...
      */
    virtual void addListener(uci::type::EntityOrbitalManeuverMT::Listener& listener) = 0;

    /** Removes the specified listener from this reader.
      *
      * @param listener The listener that is to be removed from this reader.
      */
    virtual void removeListener(uci::type::EntityOrbitalManeuverMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s). Returns immediately if no messages are available.
      ...
      */
    virtual unsigned long readNoWait(unsigned long maxNumberOfMessages, uci::type::EntityOrbitalManeuverMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s).
      ...
      * @return The number of messages that were handled.
      */
    virtual unsigned long read(unsigned long timeout, unsigned long maxNumberOfMessages, uci::type::EntityOrbitalManeuverMT::Listener& listener) = 0;
  ...
  /** This method creates a new reader that can be used to read a EntityOrbitalManeuverMT.
    *
    * @param topic The specification of the topic the reader is to read from.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A reader that can read a EntityOrbitalManeuverMT.
    */
  static UCI_EXPORT uci::type::EntityOrbitalManeuverMT::Reader& createReader(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a reader. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyReader(uci::type::EntityOrbitalManeuverMT::Reader& reader);
  ...
  public:
    ...
    /** Writes the OMS message to the topic specified when this Writer was created.
      ...
      */
    virtual void write(uci::type::EntityOrbitalManeuverMT& accessor) = 0;
  ...
  /** This method creates a new writer that can be used to write a EntityOrbitalManeuverMT.
    *
    * @param topic The specification of the topic the writer is to write to.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A writer that can write a EntityOrbitalManeuverMT.
    */
  static UCI_EXPORT uci::type::EntityOrbitalManeuverMT::Writer& createWriter(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a writer. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyWriter(uci::type::EntityOrbitalManeuverMT::Writer& writer);
...
protected:
  ...
  /** The copy constructor [only available to derived classes].
    *
    * @param rhs The EntityOrbitalManeuverMT to copy from.
    */
  EntityOrbitalManeuverMT(const EntityOrbitalManeuverMT& rhs) {
    (void)rhs;
  }

  /** The assignment operator. Sets the contents of this EntityOrbitalManeuverMT to the contents of the
    * EntityOrbitalManeuverMT on the right hand side (rhs) of the assignment operator [only available to derived classes].
    *
    * @param rhs The EntityOrbitalManeuverMT on the right hand side (rhs) of the assignment operator whose contents are
    *      used to set the contents of this EntityOrbitalManeuverMT.
    * @return A reference to this EntityOrbitalManeuverMT.
    */
  EntityOrbitalManeuverMT& operator=(const EntityOrbitalManeuverMT& rhs) {
    (void)rhs;
...
#endif // UCI_TYPE_ENTITYORBITALMANEUVERMT_H
