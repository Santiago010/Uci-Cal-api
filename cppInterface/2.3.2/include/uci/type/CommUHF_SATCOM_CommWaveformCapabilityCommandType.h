...
#ifndef UCI_TYPE_COMMUHF_SATCOM_COMMWAVEFORMCAPABILITYCOMMANDTYPE_H
#define UCI_TYPE_COMMUHF_SATCOM_COMMWAVEFORMCAPABILITYCOMMANDTYPE_H
...
/** This is a polymorphic extension which allows for the extension of the base CommWaveformCapabilityCommandPET for
  ...
  */
class CommUHF_SATCOM_CommWaveformCapabilityCommandType : public virtual CommWaveformCapabilityCommandPET {
public:

  /** This method constructs a new CommUHF_SATCOM_CommWaveformCapabilityCommandType.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed CommUHF_SATCOM_CommWaveformCapabilityCommandType.
    */
  static UCI_EXPORT CommUHF_SATCOM_CommWaveformCapabilityCommandType& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new CommUHF_SATCOM_CommWaveformCapabilityCommandType initializing the data accessed by the
    * new CommUHF_SATCOM_CommWaveformCapabilityCommandType using the data accessed by the specified
    * CommUHF_SATCOM_CommWaveformCapabilityCommandType (cloning).
    *
    * @param accessor The CommUHF_SATCOM_CommWaveformCapabilityCommandType that provides access to the data that is to be
    *      used to initialize the data accessed by the new created CommUHF_SATCOM_CommWaveformCapabilityCommandType.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed CommUHF_SATCOM_CommWaveformCapabilityCommandType.
    */
  static UCI_EXPORT CommUHF_SATCOM_CommWaveformCapabilityCommandType& create(const CommUHF_SATCOM_CommWaveformCapabilityCommandType& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified CommUHF_SATCOM_CommWaveformCapabilityCommandType. Use of the specified accessor
    * after it has been destroyed will result in undefined behavior.
    *
    * @param accessor The CommUHF_SATCOM_CommWaveformCapabilityCommandType that is to be destroyed.
    */
  static UCI_EXPORT void destroy(CommUHF_SATCOM_CommWaveformCapabilityCommandType& accessor);
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const CommUHF_SATCOM_CommWaveformCapabilityCommandType& accessor) = 0;
  ...
  /** Returns a const reference to the accessor that provides access to the complex content identified by RangeDelay.
    *
    * @return A const reference to the accessor that provides access to the complex content identified by RangeDelay.
    */
  virtual const uci::type::CommRangeDelayChoiceType& getRangeDelay() const = 0;

  /** Returns a reference to the accessor that provides access to the complex content identified by RangeDelay.
    *
    * @return A reference to the accessor that provides access to the complex content identified by RangeDelay.
    */
  virtual uci::type::CommRangeDelayChoiceType& getRangeDelay() = 0;

  /** Sets the complex content identified by RangeDelay to the contents of the complex content accessed by the specified
    * accessor.
    *
    * @param value The accessor that provides access to the complex content whose contents are to be used to set the
    *      contents of the complex content identified by RangeDelay.
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::CommUHF_SATCOM_CommWaveformCapabilityCommandType& setRangeDelay(const uci::type::CommRangeDelayChoiceType& value) = 0;
  ...
  /** Sets the value of the enumeration identified by RangeMode.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::CommUHF_SATCOM_CommWaveformCapabilityCommandType& setRangeMode(const uci::type::CommRangeModeTypeEnum& value) = 0;
  ...
  /** Sets the value of the enumeration identified by RangeMode.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::CommUHF_SATCOM_CommWaveformCapabilityCommandType& setRangeMode(uci::type::CommRangeModeTypeEnum::EnumerationItem value) = 0;
  ...
  /** Clears (disabled) the Element identified by RangeMode.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::CommUHF_SATCOM_CommWaveformCapabilityCommandType& clearRangeMode() = 0;
  ...
  /** Sets the value of the enumeration identified by ServiceType.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::CommUHF_SATCOM_CommWaveformCapabilityCommandType& setServiceType(const uci::type::CommSATCOM_ServiceTypeEnum& value) = 0;
  ...
  /** Sets the value of the enumeration identified by ServiceType.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::CommUHF_SATCOM_CommWaveformCapabilityCommandType& setServiceType(uci::type::CommSATCOM_ServiceTypeEnum::EnumerationItem value) = 0;
  ...
  /** Clears (disabled) the Element identified by ServiceType.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::CommUHF_SATCOM_CommWaveformCapabilityCommandType& clearServiceType() = 0;
  ...
  /** Sets the complex content identified by ConfigurationCode to the contents of the complex content accessed by the
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::CommUHF_SATCOM_CommWaveformCapabilityCommandType& setConfigurationCode(const uci::type::ForeignKeyType& value) = 0;
  ...
  /** Clears (disabled) the Element identified by ConfigurationCode.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::CommUHF_SATCOM_CommWaveformCapabilityCommandType& clearConfigurationCode() = 0;
  ...
  /** Sets the value of the SimplePrimitive data type identified by OrderwireEncryption.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::CommUHF_SATCOM_CommWaveformCapabilityCommandType& setOrderwireEncryption(xs::Boolean value) = 0;
  ...
  /** Clears (disabled) the Element identified by OrderwireEncryption.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::CommUHF_SATCOM_CommWaveformCapabilityCommandType& clearOrderwireEncryption() = 0;
  ...
  /** Sets the complex content identified by SatelliteKey to the contents of the complex content accessed by the specified
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::CommUHF_SATCOM_CommWaveformCapabilityCommandType& setSatelliteKey(const uci::type::ForeignKeyType& value) = 0;
  ...
  /** Clears (disabled) the Element identified by SatelliteKey.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::CommUHF_SATCOM_CommWaveformCapabilityCommandType& clearSatelliteKey() = 0;
  ...
  /** Returns a const reference to the bounded list identified by GuardSlotKey.
    ...
    */
  virtual const uci::type::CommUHF_SATCOM_CommWaveformCapabilityCommandType::GuardSlotKey& getGuardSlotKey() const = 0;
  ...
  /** Returns a reference to the bounded list identified by GuardSlotKey.
    ...
    */
  virtual uci::type::CommUHF_SATCOM_CommWaveformCapabilityCommandType::GuardSlotKey& getGuardSlotKey() = 0;
  ...
  /** Sets the bounded list identified by GuardSlotKey.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::CommUHF_SATCOM_CommWaveformCapabilityCommandType& setGuardSlotKey(const uci::type::CommUHF_SATCOM_CommWaveformCapabilityCommandType::GuardSlotKey& value) = 0;
...
protected:
  ...
  /** The assignment operator. Sets the contents of this CommUHF_SATCOM_CommWaveformCapabilityCommandType to the contents
    * of the CommUHF_SATCOM_CommWaveformCapabilityCommandType on the right hand side (rhs) of the assignment operator [only
    * available to derived classes].
    *
    * @param rhs The CommUHF_SATCOM_CommWaveformCapabilityCommandType on the right hand side (rhs) of the assignment
    *      operator whose contents are used to set the contents of this CommUHF_SATCOM_CommWaveformCapabilityCommandType.
    * @return A reference to this CommUHF_SATCOM_CommWaveformCapabilityCommandType.
    */
  CommUHF_SATCOM_CommWaveformCapabilityCommandType& operator=(const CommUHF_SATCOM_CommWaveformCapabilityCommandType& rhs) {
    (void)rhs;
...
#endif // UCI_TYPE_COMMUHF_SATCOM_COMMWAVEFORMCAPABILITYCOMMANDTYPE_H
