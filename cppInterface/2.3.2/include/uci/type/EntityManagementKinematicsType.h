/** @file EntityManagementKinematicsType.h
 *
...
#ifndef UCI_TYPE_ENTITYMANAGEMENTKINEMATICSTYPE_H
#define UCI_TYPE_ENTITYMANAGEMENTKINEMATICSTYPE_H
...
public:
  ...
  /** This method constructs a new EntityManagementKinematicsType.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed EntityManagementKinematicsType.
    */
  static UCI_EXPORT EntityManagementKinematicsType& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new EntityManagementKinematicsType initializing the data accessed by the new
    * EntityManagementKinematicsType using the data accessed by the specified EntityManagementKinematicsType (cloning).
    *
    * @param accessor The EntityManagementKinematicsType that provides access to the data that is to be used to initialize
    *      the data accessed by the new created EntityManagementKinematicsType.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed EntityManagementKinematicsType.
    */
  static UCI_EXPORT EntityManagementKinematicsType& create(const EntityManagementKinematicsType& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified EntityManagementKinematicsType. Use of the specified accessor after it has been
    * destroyed will result in undefined behavior.
    *
    * @param accessor The EntityManagementKinematicsType that is to be destroyed.
    */
  static UCI_EXPORT void destroy(EntityManagementKinematicsType& accessor);
  ...
  /** Returns the version that was initialized from the uci:version attribute of EntityManagementKinematicsType.
    *
    * @return The version that was initialized from the uci:version attribute of EntityManagementKinematicsType.
    */
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const EntityManagementKinematicsType& accessor) = 0;
  ...
  /** Sets the complex content identified by EntityID to the contents of the complex content accessed by the specified
    ...
    */
  virtual uci::type::EntityManagementKinematicsType& setEntityID(const uci::type::EntityID_Type& value) = 0;
  ...
  /** Sets the complex content identified by Kinematics to the contents of the complex content accessed by the specified
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::EntityManagementKinematicsType& setKinematics(const uci::type::KinematicsType& value) = 0;
...
protected:
  ...
  /** The assignment operator. Sets the contents of this EntityManagementKinematicsType to the contents of the
    * EntityManagementKinematicsType on the right hand side (rhs) of the assignment operator [only available to derived
    * classes].
    *
    * @param rhs The EntityManagementKinematicsType on the right hand side (rhs) of the assignment operator whose contents
    *      are used to set the contents of this EntityManagementKinematicsType.
    * @return A reference to this EntityManagementKinematicsType.
    */
  EntityManagementKinematicsType& operator=(const EntityManagementKinematicsType& rhs) {
    (void)rhs;
...
#endif // UCI_TYPE_ENTITYMANAGEMENTKINEMATICSTYPE_H
