...
#ifndef UCI_TYPE_ZONECHOICETYPE_H
#define UCI_TYPE_ZONECHOICETYPE_H
...
public:
  ...
  /** This method constructs a new ZoneChoiceType.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed ZoneChoiceType.
    */
  static UCI_EXPORT ZoneChoiceType& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new ZoneChoiceType initializing the data accessed by the new ZoneChoiceType using the data
    * accessed by the specified ZoneChoiceType (cloning).
    *
    * @param accessor The ZoneChoiceType that provides access to the data that is to be used to initialize the data
    *      accessed by the new created ZoneChoiceType.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed ZoneChoiceType.
    */
  static UCI_EXPORT ZoneChoiceType& create(const ZoneChoiceType& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified ZoneChoiceType. Use of the specified accessor after it has been destroyed will
    * result in undefined behavior.
    *
    * @param accessor The ZoneChoiceType that is to be destroyed.
    */
  static UCI_EXPORT void destroy(ZoneChoiceType& accessor);
  ...
  /** Returns the version that was initialized from the uci:version attribute of ZoneChoiceType.
    *
    * @return The version that was initialized from the uci:version attribute of ZoneChoiceType.
    */
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const ZoneChoiceType& accessor) = 0;
  ...
  /** This method returns this choice's "selection ordinal." A choice's "selection ordinal" is used to specify which
    ...
    */
  virtual ZoneChoiceTypeChoice getZoneChoiceTypeChoiceOrdinal() const = 0;
  ...
  /** This method is used to set this choice's "selection ordinal." A choice's "selection ordinal" is used to specify which
    ...
    */
  virtual uci::type::ZoneChoiceType& setZoneChoiceTypeChoiceOrdinal(ZoneChoiceTypeChoice chosenElementOrdinal, uci::base::accessorType::AccessorType type = uci::base::accessorType::null) = 0;
  ...
  /** Sets the complex content identified by OpZoneID to the contents of the complex content accessed by the specified
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::ZoneChoiceType& setOpZoneID(const uci::type::OpZoneID_Type& value) = 0;
  ...
  /** Sets the complex content identified by ZoneTarget to the contents of the complex content accessed by the specified
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::ZoneChoiceType& setZoneTarget(const uci::type::ZoneExternalType& value) = 0;
...
protected:
  ...
  /** The assignment operator. Sets the contents of this ZoneChoiceType to the contents of the ZoneChoiceType on the right
    ...
    *      the contents of this ZoneChoiceType.
    * @return A reference to this ZoneChoiceType.
    */
  ZoneChoiceType& operator=(const ZoneChoiceType& rhs) {
    (void)rhs;
...
#endif // UCI_TYPE_ZONECHOICETYPE_H
