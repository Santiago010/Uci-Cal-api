...
#ifndef UCI_TYPE_TASKPLANCOMMANDMT_H
#define UCI_TYPE_TASKPLANCOMMANDMT_H
...
class TaskPlanCommandMT : public virtual MessageType {
public:

  /** This method constructs a new TaskPlanCommandMT.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed TaskPlanCommandMT.
    */
  static UCI_EXPORT TaskPlanCommandMT& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new TaskPlanCommandMT initializing the data accessed by the new TaskPlanCommandMT using the
    * data accessed by the specified TaskPlanCommandMT (cloning).
    *
    * @param accessor The TaskPlanCommandMT that provides access to the data that is to be used to initialize the data
    *      accessed by the new created TaskPlanCommandMT.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed TaskPlanCommandMT.
    */
  static UCI_EXPORT TaskPlanCommandMT& create(const TaskPlanCommandMT& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified TaskPlanCommandMT. Use of the specified accessor after it has been destroyed will
    * result in undefined behavior.
    *
    * @param accessor The TaskPlanCommandMT that is to be destroyed.
    */
  static UCI_EXPORT void destroy(TaskPlanCommandMT& accessor);

  /** Returns this accessor's type constant, i.e. taskPlanCommandMT.
    *
    * @return This accessor's type constant, i.e. taskPlanCommandMT.
    */
  virtual uci::base::accessorType::AccessorType getAccessorType() const noexception {
    return uci::type::accessorType::taskPlanCommandMT;
  }

  /** Returns the version that was initialized from the uci:version attribute of TaskPlanCommandMT.
    *
    * @return The version that was initialized from the uci:version attribute of TaskPlanCommandMT.
    */
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const TaskPlanCommandMT& accessor) = 0;
  ...
  /** Returns a const reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual const uci::type::TaskPlanCommandMDT& getMessageData() const = 0;
  ...
  /** Returns a reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual uci::type::TaskPlanCommandMDT& getMessageData() = 0;
  ...
  /** Sets the complex content identified by MessageData to the contents of the complex content accessed by the specified
    ...
    */
  virtual uci::type::TaskPlanCommandMT& setMessageData(const uci::type::TaskPlanCommandMDT& value) = 0;

  /** The Listener provides the support to listen and handle incoming messages of the type uci::type::TaskPlanCommandMT. */
  ...
  public:
    ...
    /** The method is used to handle incoming messages.
      ...
      */
    virtual void handleMessage(const uci::type::TaskPlanCommandMT& message) = 0;
  ...
  public:
    ...
    /** Adds a listener to this reader to handle incoming messages.
      ...
      */
    virtual void addListener(uci::type::TaskPlanCommandMT::Listener& listener) = 0;

    /** Removes the specified listener from this reader.
      *
      * @param listener The listener that is to be removed from this reader.
      */
    virtual void removeListener(uci::type::TaskPlanCommandMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s). Returns immediately if no messages are available.
      ...
      */
    virtual unsigned long readNoWait(unsigned long maxNumberOfMessages, uci::type::TaskPlanCommandMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s).
      ...
      * @return The number of messages that were handled.
      */
    virtual unsigned long read(unsigned long timeout, unsigned long maxNumberOfMessages, uci::type::TaskPlanCommandMT::Listener& listener) = 0;
  ...
  /** This method creates a new reader that can be used to read a TaskPlanCommandMT.
    *
    * @param topic The specification of the topic the reader is to read from.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A reader that can read a TaskPlanCommandMT.
    */
  static UCI_EXPORT uci::type::TaskPlanCommandMT::Reader& createReader(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a reader. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyReader(uci::type::TaskPlanCommandMT::Reader& reader);
  ...
  public:
    ...
    /** Writes the OMS message to the topic specified when this Writer was created.
      ...
      */
    virtual void write(uci::type::TaskPlanCommandMT& accessor) = 0;
  ...
  /** This method creates a new writer that can be used to write a TaskPlanCommandMT.
    *
    * @param topic The specification of the topic the writer is to write to.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A writer that can write a TaskPlanCommandMT.
    */
  static UCI_EXPORT uci::type::TaskPlanCommandMT::Writer& createWriter(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a writer. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyWriter(uci::type::TaskPlanCommandMT::Writer& writer);
...
protected:
  ...
  /** The copy constructor [only available to derived classes].
    *
    * @param rhs The TaskPlanCommandMT to copy from.
    */
  TaskPlanCommandMT(const TaskPlanCommandMT& rhs) {
    (void)rhs;
  }

  /** The assignment operator. Sets the contents of this TaskPlanCommandMT to the contents of the TaskPlanCommandMT on the
    * right hand side (rhs) of the assignment operator [only available to derived classes].
    *
    * @param rhs The TaskPlanCommandMT on the right hand side (rhs) of the assignment operator whose contents are used to
    *      set the contents of this TaskPlanCommandMT.
    * @return A reference to this TaskPlanCommandMT.
    */
  TaskPlanCommandMT& operator=(const TaskPlanCommandMT& rhs) {
    (void)rhs;
...
#endif // UCI_TYPE_TASKPLANCOMMANDMT_H
