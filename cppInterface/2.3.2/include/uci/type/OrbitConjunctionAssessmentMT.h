/** @file OrbitConjunctionAssessmentMT.h
 *
...
#ifndef UCI_TYPE_ORBITCONJUNCTIONASSESSMENTMT_H
#define UCI_TYPE_ORBITCONJUNCTIONASSESSMENTMT_H
...
#include "OrbitConjunctionAssessmentMDT.h"
...
/** Indicates the top level details of the message that includes the message header, object state, and the data for the
  ...
  */
class OrbitConjunctionAssessmentMT : public virtual MessageType {
public:

  /** This method constructs a new OrbitConjunctionAssessmentMT.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed OrbitConjunctionAssessmentMT.
    */
  static UCI_EXPORT OrbitConjunctionAssessmentMT& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new OrbitConjunctionAssessmentMT initializing the data accessed by the new
    * OrbitConjunctionAssessmentMT using the data accessed by the specified OrbitConjunctionAssessmentMT (cloning).
    *
    * @param accessor The OrbitConjunctionAssessmentMT that provides access to the data that is to be used to initialize
    *      the data accessed by the new created OrbitConjunctionAssessmentMT.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed OrbitConjunctionAssessmentMT.
    */
  static UCI_EXPORT OrbitConjunctionAssessmentMT& create(const OrbitConjunctionAssessmentMT& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified OrbitConjunctionAssessmentMT. Use of the specified accessor after it has been
    * destroyed will result in undefined behavior.
    *
    * @param accessor The OrbitConjunctionAssessmentMT that is to be destroyed.
    */
  static UCI_EXPORT void destroy(OrbitConjunctionAssessmentMT& accessor);

  /** Returns this accessor's type constant, i.e. orbitConjunctionAssessmentMT.
    *
    * @return This accessor's type constant, i.e. orbitConjunctionAssessmentMT.
    */
  virtual uci::base::accessorType::AccessorType getAccessorType() const noexception {
    return uci::type::accessorType::orbitConjunctionAssessmentMT;
  }

  /** Returns the version that was initialized from the uci:version attribute of OrbitConjunctionAssessmentMT.
    *
    * @return The version that was initialized from the uci:version attribute of OrbitConjunctionAssessmentMT.
    */
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const OrbitConjunctionAssessmentMT& accessor) = 0;
  ...
  /** Sets the value of the enumeration identified by ObjectState.
    ...
    */
  virtual uci::type::OrbitConjunctionAssessmentMT& setObjectState(const uci::type::ObjectStateEnum& value) = 0;
  ...
  /** Sets the value of the enumeration identified by ObjectState.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::OrbitConjunctionAssessmentMT& setObjectState(uci::type::ObjectStateEnum::EnumerationItem value) = 0;
  ...
  /** Clears (disabled) the Element identified by ObjectState.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::OrbitConjunctionAssessmentMT& clearObjectState() = 0;
  ...
  /** Returns a const reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual const uci::type::OrbitConjunctionAssessmentMDT& getMessageData() const = 0;
  ...
  /** Returns a reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual uci::type::OrbitConjunctionAssessmentMDT& getMessageData() = 0;
  ...
  /** Sets the complex content identified by MessageData to the contents of the complex content accessed by the specified
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::OrbitConjunctionAssessmentMT& setMessageData(const uci::type::OrbitConjunctionAssessmentMDT& value) = 0;

  /** The Listener provides the support to listen and handle incoming messages of the type
    * uci::type::OrbitConjunctionAssessmentMT.
    */
  ...
  public:
    ...
    /** The method is used to handle incoming messages.
      ...
      */
    virtual void handleMessage(const uci::type::OrbitConjunctionAssessmentMT& message) = 0;
  ...
  public:
    ...
    /** Adds a listener to this reader to handle incoming messages.
      ...
      */
    virtual void addListener(uci::type::OrbitConjunctionAssessmentMT::Listener& listener) = 0;

    /** Removes the specified listener from this reader.
      *
      * @param listener The listener that is to be removed from this reader.
      */
    virtual void removeListener(uci::type::OrbitConjunctionAssessmentMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s). Returns immediately if no messages are available.
      ...
      */
    virtual unsigned long readNoWait(unsigned long maxNumberOfMessages, uci::type::OrbitConjunctionAssessmentMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s).
      ...
      * @return The number of messages that were handled.
      */
    virtual unsigned long read(unsigned long timeout, unsigned long maxNumberOfMessages, uci::type::OrbitConjunctionAssessmentMT::Listener& listener) = 0;
  ...
  /** This method creates a new reader that can be used to read a OrbitConjunctionAssessmentMT.
    *
    * @param topic The specification of the topic the reader is to read from.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A reader that can read a OrbitConjunctionAssessmentMT.
    */
  static UCI_EXPORT uci::type::OrbitConjunctionAssessmentMT::Reader& createReader(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a reader. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyReader(uci::type::OrbitConjunctionAssessmentMT::Reader& reader);
  ...
  public:
    ...
    /** Writes the OMS message to the topic specified when this Writer was created.
      ...
      */
    virtual void write(uci::type::OrbitConjunctionAssessmentMT& accessor) = 0;
  ...
  /** This method creates a new writer that can be used to write a OrbitConjunctionAssessmentMT.
    *
    * @param topic The specification of the topic the writer is to write to.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A writer that can write a OrbitConjunctionAssessmentMT.
    */
  static UCI_EXPORT uci::type::OrbitConjunctionAssessmentMT::Writer& createWriter(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a writer. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyWriter(uci::type::OrbitConjunctionAssessmentMT::Writer& writer);
...
protected:
  ...
  /** The copy constructor [only available to derived classes].
    *
    * @param rhs The OrbitConjunctionAssessmentMT to copy from.
    */
  OrbitConjunctionAssessmentMT(const OrbitConjunctionAssessmentMT& rhs) {
    (void)rhs;
  }

  /** The assignment operator. Sets the contents of this OrbitConjunctionAssessmentMT to the contents of the
    * OrbitConjunctionAssessmentMT on the right hand side (rhs) of the assignment operator [only available to derived
    * classes].
    *
    * @param rhs The OrbitConjunctionAssessmentMT on the right hand side (rhs) of the assignment operator whose contents
    *      are used to set the contents of this OrbitConjunctionAssessmentMT.
    * @return A reference to this OrbitConjunctionAssessmentMT.
    */
  OrbitConjunctionAssessmentMT& operator=(const OrbitConjunctionAssessmentMT& rhs) {
    (void)rhs;
...
#endif // UCI_TYPE_ORBITCONJUNCTIONASSESSMENTMT_H
