...
#ifndef UCI_TYPE_COMINT_CHANGEGEOLOCATIONTYPE_H
#define UCI_TYPE_COMINT_CHANGEGEOLOCATIONTYPE_H
...
public:
  ...
  /** This method constructs a new COMINT_ChangeGeolocationType.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed COMINT_ChangeGeolocationType.
    */
  static UCI_EXPORT COMINT_ChangeGeolocationType& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new COMINT_ChangeGeolocationType initializing the data accessed by the new
    * COMINT_ChangeGeolocationType using the data accessed by the specified COMINT_ChangeGeolocationType (cloning).
    *
    * @param accessor The COMINT_ChangeGeolocationType that provides access to the data that is to be used to initialize
    *      the data accessed by the new created COMINT_ChangeGeolocationType.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed COMINT_ChangeGeolocationType.
    */
  static UCI_EXPORT COMINT_ChangeGeolocationType& create(const COMINT_ChangeGeolocationType& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified COMINT_ChangeGeolocationType. Use of the specified accessor after it has been
    * destroyed will result in undefined behavior.
    *
    * @param accessor The COMINT_ChangeGeolocationType that is to be destroyed.
    */
  static UCI_EXPORT void destroy(COMINT_ChangeGeolocationType& accessor);
  ...
  /** Returns the version that was initialized from the uci:version attribute of COMINT_ChangeGeolocationType.
    *
    * @return The version that was initialized from the uci:version attribute of COMINT_ChangeGeolocationType.
    */
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const COMINT_ChangeGeolocationType& accessor) = 0;
  ...
  /** Sets the value of the enumeration identified by GeolocationControlState.
    ...
    */
  virtual uci::type::COMINT_ChangeGeolocationType& setGeolocationControlState(const uci::type::SignalGeolocationControlEnum& value) = 0;
  ...
  /** Sets the value of the enumeration identified by GeolocationControlState.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::COMINT_ChangeGeolocationType& setGeolocationControlState(uci::type::SignalGeolocationControlEnum::EnumerationItem value) = 0;
  ...
  /** Sets the complex content identified by EntityID to the contents of the complex content accessed by the specified
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::COMINT_ChangeGeolocationType& setEntityID(const uci::type::EntityID_Type& value) = 0;
  ...
  /** Clears (disabled) the Element identified by EntityID.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::COMINT_ChangeGeolocationType& clearEntityID() = 0;
...
protected:
  ...
  /** The assignment operator. Sets the contents of this COMINT_ChangeGeolocationType to the contents of the
    * COMINT_ChangeGeolocationType on the right hand side (rhs) of the assignment operator [only available to derived
    * classes].
    *
    * @param rhs The COMINT_ChangeGeolocationType on the right hand side (rhs) of the assignment operator whose contents
    *      are used to set the contents of this COMINT_ChangeGeolocationType.
    * @return A reference to this COMINT_ChangeGeolocationType.
    */
  COMINT_ChangeGeolocationType& operator=(const COMINT_ChangeGeolocationType& rhs) {
    (void)rhs;
...
#endif // UCI_TYPE_COMINT_CHANGEGEOLOCATIONTYPE_H
