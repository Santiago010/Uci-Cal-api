/** @file OrbitalDebrisEstimateRequest.h
 *
...
typedef uci::type::OrbitalDebrisEstimateRequestMT OrbitalDebrisEstimateRequest;

} // namespace type
} // namespace uci

#endif // UCI_TYPE_ORBITALDEBRISESTIMATEREQUEST_H
