...
#ifndef UCI_TYPE_BCRS_KINEMATICSTYPE_H
#define UCI_TYPE_BCRS_KINEMATICSTYPE_H

#include "../base/Accessor.h"
#include "../base/export.h"
#include "BCRS_PositionType.h"
...
public:
  ...
  /** This method constructs a new BCRS_KinematicsType.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed BCRS_KinematicsType.
    */
  static UCI_EXPORT BCRS_KinematicsType& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new BCRS_KinematicsType initializing the data accessed by the new BCRS_KinematicsType using
    * the data accessed by the specified BCRS_KinematicsType (cloning).
    *
    * @param accessor The BCRS_KinematicsType that provides access to the data that is to be used to initialize the data
    *      accessed by the new created BCRS_KinematicsType.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed BCRS_KinematicsType.
    */
  static UCI_EXPORT BCRS_KinematicsType& create(const BCRS_KinematicsType& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified BCRS_KinematicsType. Use of the specified accessor after it has been destroyed
    * will result in undefined behavior.
    *
    * @param accessor The BCRS_KinematicsType that is to be destroyed.
    */
  static UCI_EXPORT void destroy(BCRS_KinematicsType& accessor);
  ...
  /** Returns the version that was initialized from the uci:version attribute of BCRS_KinematicsType.
    *
    * @return The version that was initialized from the uci:version attribute of BCRS_KinematicsType.
    */
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const BCRS_KinematicsType& accessor) = 0;
  ...
  /** Sets the value of the SimplePrimitive data type identified by Epoch.
    ...
    */
  virtual uci::type::BCRS_KinematicsType& setEpoch(uci::type::DateTimeTypeValue value) = 0;
  ...
  /** Returns a const reference to the accessor that provides access to the complex content identified by Position.
    ...
    */
  virtual const uci::type::BCRS_PositionType& getPosition() const = 0;
  ...
  /** Returns a reference to the accessor that provides access to the complex content identified by Position.
    ...
    */
  virtual uci::type::BCRS_PositionType& getPosition() = 0;
  ...
  /** Sets the complex content identified by Position to the contents of the complex content accessed by the specified
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::BCRS_KinematicsType& setPosition(const uci::type::BCRS_PositionType& value) = 0;
  ...
  /** Sets the complex content identified by Velocity to the contents of the complex content accessed by the specified
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::BCRS_KinematicsType& setVelocity(const uci::type::OrbitalKinematicsVelocityType& value) = 0;
  ...
  /** Sets the complex content identified by Acceleration to the contents of the complex content accessed by the specified
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::BCRS_KinematicsType& setAcceleration(const uci::type::OrbitalKinematicsAccelerationType& value) = 0;
  ...
  /** Clears (disabled) the Element identified by Acceleration.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::BCRS_KinematicsType& clearAcceleration() = 0;
  ...
  /** Sets the complex content identified by Attitude to the contents of the complex content accessed by the specified
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::BCRS_KinematicsType& setAttitude(const uci::type::QuaternionType& value) = 0;
  ...
  /** Clears (disabled) the Element identified by Attitude.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::BCRS_KinematicsType& clearAttitude() = 0;
  ...
  /** Sets the complex content identified by Covariance to the contents of the complex content accessed by the specified
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::BCRS_KinematicsType& setCovariance(const uci::type::CovarianceMatrixType& value) = 0;
  ...
  /** Clears (disabled) the Element identified by Covariance.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::BCRS_KinematicsType& clearCovariance() = 0;
...
protected:
  ...
  /** The assignment operator. Sets the contents of this BCRS_KinematicsType to the contents of the BCRS_KinematicsType on
    ...
    *      set the contents of this BCRS_KinematicsType.
    * @return A reference to this BCRS_KinematicsType.
    */
  BCRS_KinematicsType& operator=(const BCRS_KinematicsType& rhs) {
    (void)rhs;
...
#endif // UCI_TYPE_BCRS_KINEMATICSTYPE_H
