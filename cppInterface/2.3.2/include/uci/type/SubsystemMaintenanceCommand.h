/** @file SubsystemMaintenanceCommand.h
 *
...
typedef uci::type::SubsystemMaintenanceCommandMT SubsystemMaintenanceCommand;

} // namespace type
} // namespace uci

#endif // UCI_TYPE_SUBSYSTEMMAINTENANCECOMMAND_H
