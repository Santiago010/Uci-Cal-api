...
#ifndef UCI_TYPE_SOB_SATELLITERECORDMT_H
#define UCI_TYPE_SOB_SATELLITERECORDMT_H
...
#include "SOB_SatelliteRecordMDT.h"
...
/** Indicates the attributes associated with a specific satellite. */
class SOB_SatelliteRecordMT : public virtual MessageType {
public:

  /** This method constructs a new SOB_SatelliteRecordMT.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed SOB_SatelliteRecordMT.
    */
  static UCI_EXPORT SOB_SatelliteRecordMT& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new SOB_SatelliteRecordMT initializing the data accessed by the new SOB_SatelliteRecordMT
    * using the data accessed by the specified SOB_SatelliteRecordMT (cloning).
    *
    * @param accessor The SOB_SatelliteRecordMT that provides access to the data that is to be used to initialize the data
    *      accessed by the new created SOB_SatelliteRecordMT.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed SOB_SatelliteRecordMT.
    */
  static UCI_EXPORT SOB_SatelliteRecordMT& create(const SOB_SatelliteRecordMT& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified SOB_SatelliteRecordMT. Use of the specified accessor after it has been destroyed
    * will result in undefined behavior.
    *
    * @param accessor The SOB_SatelliteRecordMT that is to be destroyed.
    */
  static UCI_EXPORT void destroy(SOB_SatelliteRecordMT& accessor);

  /** Returns this accessor's type constant, i.e. sOB_SatelliteRecordMT.
    *
    * @return This accessor's type constant, i.e. sOB_SatelliteRecordMT.
    */
  virtual uci::base::accessorType::AccessorType getAccessorType() const noexception {
    return uci::type::accessorType::sOB_SatelliteRecordMT;
  }

  /** Returns the version that was initialized from the uci:version attribute of SOB_SatelliteRecordMT.
    *
    * @return The version that was initialized from the uci:version attribute of SOB_SatelliteRecordMT.
    */
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const SOB_SatelliteRecordMT& accessor) = 0;
  ...
  /** Sets the value of the enumeration identified by ObjectState.
    ...
    */
  virtual uci::type::SOB_SatelliteRecordMT& setObjectState(const uci::type::ObjectStateEnum& value) = 0;
  ...
  /** Sets the value of the enumeration identified by ObjectState.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::SOB_SatelliteRecordMT& setObjectState(uci::type::ObjectStateEnum::EnumerationItem value) = 0;
  ...
  /** Clears (disabled) the Element identified by ObjectState.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::SOB_SatelliteRecordMT& clearObjectState() = 0;
  ...
  /** Returns a const reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual const uci::type::SOB_SatelliteRecordMDT& getMessageData() const = 0;
  ...
  /** Returns a reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual uci::type::SOB_SatelliteRecordMDT& getMessageData() = 0;
  ...
  /** Sets the complex content identified by MessageData to the contents of the complex content accessed by the specified
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::SOB_SatelliteRecordMT& setMessageData(const uci::type::SOB_SatelliteRecordMDT& value) = 0;

  /** The Listener provides the support to listen and handle incoming messages of the type
    * uci::type::SOB_SatelliteRecordMT.
    */
  ...
  public:
    ...
    /** The method is used to handle incoming messages.
      ...
      */
    virtual void handleMessage(const uci::type::SOB_SatelliteRecordMT& message) = 0;
  ...
  public:
    ...
    /** Adds a listener to this reader to handle incoming messages.
      ...
      */
    virtual void addListener(uci::type::SOB_SatelliteRecordMT::Listener& listener) = 0;

    /** Removes the specified listener from this reader.
      *
      * @param listener The listener that is to be removed from this reader.
      */
    virtual void removeListener(uci::type::SOB_SatelliteRecordMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s). Returns immediately if no messages are available.
      ...
      */
    virtual unsigned long readNoWait(unsigned long maxNumberOfMessages, uci::type::SOB_SatelliteRecordMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s).
      ...
      * @return The number of messages that were handled.
      */
    virtual unsigned long read(unsigned long timeout, unsigned long maxNumberOfMessages, uci::type::SOB_SatelliteRecordMT::Listener& listener) = 0;
  ...
  /** This method creates a new reader that can be used to read a SOB_SatelliteRecordMT.
    *
    * @param topic The specification of the topic the reader is to read from.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A reader that can read a SOB_SatelliteRecordMT.
    */
  static UCI_EXPORT uci::type::SOB_SatelliteRecordMT::Reader& createReader(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a reader. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyReader(uci::type::SOB_SatelliteRecordMT::Reader& reader);
  ...
  public:
    ...
    /** Writes the OMS message to the topic specified when this Writer was created.
      ...
      */
    virtual void write(uci::type::SOB_SatelliteRecordMT& accessor) = 0;
  ...
  /** This method creates a new writer that can be used to write a SOB_SatelliteRecordMT.
    *
    * @param topic The specification of the topic the writer is to write to.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A writer that can write a SOB_SatelliteRecordMT.
    */
  static UCI_EXPORT uci::type::SOB_SatelliteRecordMT::Writer& createWriter(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a writer. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyWriter(uci::type::SOB_SatelliteRecordMT::Writer& writer);

protected:

  /** The constructor [only available to derived classes]. */
  SOB_SatelliteRecordMT() {
  }
  ...
  /** The copy constructor [only available to derived classes].
    *
    * @param rhs The SOB_SatelliteRecordMT to copy from.
    */
  SOB_SatelliteRecordMT(const SOB_SatelliteRecordMT& rhs) {
    (void)rhs;
  }

  /** The assignment operator. Sets the contents of this SOB_SatelliteRecordMT to the contents of the SOB_SatelliteRecordMT
    * on the right hand side (rhs) of the assignment operator [only available to derived classes].
    *
    * @param rhs The SOB_SatelliteRecordMT on the right hand side (rhs) of the assignment operator whose contents are used
    *      to set the contents of this SOB_SatelliteRecordMT.
    * @return A reference to this SOB_SatelliteRecordMT.
    */
  SOB_SatelliteRecordMT& operator=(const SOB_SatelliteRecordMT& rhs) {
    (void)rhs;
...
#endif // UCI_TYPE_SOB_SATELLITERECORDMT_H
