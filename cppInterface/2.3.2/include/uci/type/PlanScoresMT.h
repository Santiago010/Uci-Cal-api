...
#ifndef UCI_TYPE_PLANSCORESMT_H
#define UCI_TYPE_PLANSCORESMT_H
...
/** Indicates the contents of the PlanScores message details, and also includes the message header and object state. */
class PlanScoresMT : public virtual MessageType {
public:

  /** This method constructs a new PlanScoresMT.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed PlanScoresMT.
    */
  static UCI_EXPORT PlanScoresMT& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new PlanScoresMT initializing the data accessed by the new PlanScoresMT using the data
    * accessed by the specified PlanScoresMT (cloning).
    *
    * @param accessor The PlanScoresMT that provides access to the data that is to be used to initialize the data accessed
    *      by the new created PlanScoresMT.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed PlanScoresMT.
    */
  static UCI_EXPORT PlanScoresMT& create(const PlanScoresMT& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified PlanScoresMT. Use of the specified accessor after it has been destroyed will
    * result in undefined behavior.
    *
    * @param accessor The PlanScoresMT that is to be destroyed.
    */
  static UCI_EXPORT void destroy(PlanScoresMT& accessor);

  /** Returns this accessor's type constant, i.e. planScoresMT.
    *
    * @return This accessor's type constant, i.e. planScoresMT.
    */
  virtual uci::base::accessorType::AccessorType getAccessorType() const noexception {
    return uci::type::accessorType::planScoresMT;
  }

  /** Returns the version that was initialized from the uci:version attribute of PlanScoresMT.
    *
    * @return The version that was initialized from the uci:version attribute of PlanScoresMT.
    */
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const PlanScoresMT& accessor) = 0;
  ...
  /** Sets the value of the enumeration identified by ObjectState.
    ...
    */
  virtual uci::type::PlanScoresMT& setObjectState(const uci::type::ObjectStateEnum& value) = 0;
  ...
  /** Sets the value of the enumeration identified by ObjectState.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::PlanScoresMT& setObjectState(uci::type::ObjectStateEnum::EnumerationItem value) = 0;
  ...
  /** Clears (disabled) the Element identified by ObjectState.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::PlanScoresMT& clearObjectState() = 0;
  ...
  /** Returns a const reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual const uci::type::PlanScoresMDT& getMessageData() const = 0;
  ...
  /** Returns a reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual uci::type::PlanScoresMDT& getMessageData() = 0;
  ...
  /** Sets the complex content identified by MessageData to the contents of the complex content accessed by the specified
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::PlanScoresMT& setMessageData(const uci::type::PlanScoresMDT& value) = 0;

  /** The Listener provides the support to listen and handle incoming messages of the type uci::type::PlanScoresMT. */
  ...
  public:
    ...
    /** The method is used to handle incoming messages.
      ...
      */
    virtual void handleMessage(const uci::type::PlanScoresMT& message) = 0;
  ...
  public:
    ...
    /** Adds a listener to this reader to handle incoming messages.
      ...
      */
    virtual void addListener(uci::type::PlanScoresMT::Listener& listener) = 0;

    /** Removes the specified listener from this reader.
      *
      * @param listener The listener that is to be removed from this reader.
      */
    virtual void removeListener(uci::type::PlanScoresMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s). Returns immediately if no messages are available.
      ...
      */
    virtual unsigned long readNoWait(unsigned long maxNumberOfMessages, uci::type::PlanScoresMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s).
      ...
      * @return The number of messages that were handled.
      */
    virtual unsigned long read(unsigned long timeout, unsigned long maxNumberOfMessages, uci::type::PlanScoresMT::Listener& listener) = 0;
  ...
  /** This method creates a new reader that can be used to read a PlanScoresMT.
    *
    * @param topic The specification of the topic the reader is to read from.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A reader that can read a PlanScoresMT.
    */
  static UCI_EXPORT uci::type::PlanScoresMT::Reader& createReader(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a reader. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyReader(uci::type::PlanScoresMT::Reader& reader);
  ...
  public:
    ...
    /** Writes the OMS message to the topic specified when this Writer was created.
      ...
      */
    virtual void write(uci::type::PlanScoresMT& accessor) = 0;
  ...
  /** This method creates a new writer that can be used to write a PlanScoresMT.
    *
    * @param topic The specification of the topic the writer is to write to.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A writer that can write a PlanScoresMT.
    */
  static UCI_EXPORT uci::type::PlanScoresMT::Writer& createWriter(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a writer. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyWriter(uci::type::PlanScoresMT::Writer& writer);
...
protected:
  ...
  /** The copy constructor [only available to derived classes].
    *
    * @param rhs The PlanScoresMT to copy from.
    */
  PlanScoresMT(const PlanScoresMT& rhs) {
    (void)rhs;
  }

  /** The assignment operator. Sets the contents of this PlanScoresMT to the contents of the PlanScoresMT on the right hand
    * side (rhs) of the assignment operator [only available to derived classes].
    *
    * @param rhs The PlanScoresMT on the right hand side (rhs) of the assignment operator whose contents are used to set
    *      the contents of this PlanScoresMT.
    * @return A reference to this PlanScoresMT.
    */
  PlanScoresMT& operator=(const PlanScoresMT& rhs) {
    (void)rhs;
