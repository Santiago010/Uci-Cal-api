/** @file PlannedSubsystemCommandType.h
 *
...
#ifndef UCI_TYPE_PLANNEDSUBSYSTEMCOMMANDTYPE_H
#define UCI_TYPE_PLANNEDSUBSYSTEMCOMMANDTYPE_H
...
public:
  ...
  /** This method constructs a new PlannedSubsystemCommandType.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed PlannedSubsystemCommandType.
    */
  static UCI_EXPORT PlannedSubsystemCommandType& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new PlannedSubsystemCommandType initializing the data accessed by the new
    * PlannedSubsystemCommandType using the data accessed by the specified PlannedSubsystemCommandType (cloning).
    *
    * @param accessor The PlannedSubsystemCommandType that provides access to the data that is to be used to initialize the
    *      data accessed by the new created PlannedSubsystemCommandType.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed PlannedSubsystemCommandType.
    */
  static UCI_EXPORT PlannedSubsystemCommandType& create(const PlannedSubsystemCommandType& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified PlannedSubsystemCommandType. Use of the specified accessor after it has been
    * destroyed will result in undefined behavior.
    *
    * @param accessor The PlannedSubsystemCommandType that is to be destroyed.
    */
  static UCI_EXPORT void destroy(PlannedSubsystemCommandType& accessor);
  ...
  /** Returns the version that was initialized from the uci:version attribute of PlannedSubsystemCommandType.
    *
    * @return The version that was initialized from the uci:version attribute of PlannedSubsystemCommandType.
    */
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const PlannedSubsystemCommandType& accessor) = 0;
  ...
  /** Sets the complex content identified by SubsystemID to the contents of the complex content accessed by the specified
    ...
    */
  virtual uci::type::PlannedSubsystemCommandType& setSubsystemID(const uci::type::SubsystemID_Type& value) = 0;
  ...
  /** Sets the complex content identified by ActivateMDF to the contents of the complex content accessed by the specified
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::PlannedSubsystemCommandType& setActivateMDF(const uci::type::MDF_CommandType& value) = 0;
  ...
  /** Clears (disabled) the Element identified by ActivateMDF.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::PlannedSubsystemCommandType& clearActivateMDF() = 0;
...
protected:
  ...
  /** The assignment operator. Sets the contents of this PlannedSubsystemCommandType to the contents of the
    * PlannedSubsystemCommandType on the right hand side (rhs) of the assignment operator [only available to derived
    * classes].
    *
    * @param rhs The PlannedSubsystemCommandType on the right hand side (rhs) of the assignment operator whose contents are
    *      used to set the contents of this PlannedSubsystemCommandType.
    * @return A reference to this PlannedSubsystemCommandType.
    */
  PlannedSubsystemCommandType& operator=(const PlannedSubsystemCommandType& rhs) {
    (void)rhs;
...
#endif // UCI_TYPE_PLANNEDSUBSYSTEMCOMMANDTYPE_H
