...
class VolumeChoiceType : public virtual uci::base::Accessor {
public:

  /** This method constructs a new VolumeChoiceType.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed VolumeChoiceType.
    */
  static UCI_EXPORT VolumeChoiceType& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new VolumeChoiceType initializing the data accessed by the new VolumeChoiceType using the
    * data accessed by the specified VolumeChoiceType (cloning).
    *
    * @param accessor The VolumeChoiceType that provides access to the data that is to be used to initialize the data
    *      accessed by the new created VolumeChoiceType.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed VolumeChoiceType.
    */
  static UCI_EXPORT VolumeChoiceType& create(const VolumeChoiceType& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified VolumeChoiceType. Use of the specified accessor after it has been destroyed will
    * result in undefined behavior.
    *
    * @param accessor The VolumeChoiceType that is to be destroyed.
    */
  static UCI_EXPORT void destroy(VolumeChoiceType& accessor);

  /** Returns this accessor's type constant, i.e. volumeChoiceType.
    *
    * @return This accessor's type constant, i.e. volumeChoiceType.
    */
  virtual uci::base::accessorType::AccessorType getAccessorType() const noexception {
    return uci::type::accessorType::volumeChoiceType;
  }

  /** Returns the version that was initialized from the uci:version attribute of VolumeChoiceType.
    *
    * @return The version that was initialized from the uci:version attribute of VolumeChoiceType.
    */
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const VolumeChoiceType& accessor) = 0;

  /** The following enumeration is used to identify which element of this Choice has been chosen. */
  enum VolumeChoiceTypeChoice {
    VOLUMECHOICETYPE_CHOICE_NONE,
    VOLUMECHOICETYPE_CHOICE_OPVOLUMEID,
    VOLUMECHOICETYPE_CHOICE_VOLUMETARGET
  };
  ...
  /** This method returns this choice's "selection ordinal." A choice's "selection ordinal" is used to specify which
    ...
    */
  virtual VolumeChoiceTypeChoice getVolumeChoiceTypeChoiceOrdinal() const = 0;
  ...
  /** This method is used to set this choice's "selection ordinal." A choice's "selection ordinal" is used to specify which
    ...
    */
  virtual uci::type::VolumeChoiceType& setVolumeChoiceTypeChoiceOrdinal(VolumeChoiceTypeChoice chosenElementOrdinal, uci::base::accessorType::AccessorType type = uci::base::accessorType::null) = 0;
  ...
  /** Sets the complex content identified by OpVolumeID to the contents of the complex content accessed by the specified
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::VolumeChoiceType& setOpVolumeID(const uci::type::OpVolumeID_Type& value) = 0;
  ...
  /** Sets the complex content identified by VolumeTarget to the contents of the complex content accessed by the specified
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::VolumeChoiceType& setVolumeTarget(const uci::type::OpVolumeType& value) = 0;
...
protected:
  ...
  /** The copy constructor [only available to derived classes].
    ...
    */
  VolumeChoiceType(const VolumeChoiceType& rhs) {
    (void)rhs;
  }

  /** The assignment operator. Sets the contents of this VolumeChoiceType to the contents of the VolumeChoiceType on the
    * right hand side (rhs) of the assignment operator [only available to derived classes].
    *
    * @param rhs The VolumeChoiceType on the right hand side (rhs) of the assignment operator whose contents are used to
    *      set the contents of this VolumeChoiceType.
    * @return A reference to this VolumeChoiceType.
    */
  VolumeChoiceType& operator=(const VolumeChoiceType& rhs) {
    (void)rhs;
...
#endif // UCI_TYPE_VOLUMECHOICETYPE_H
