/** @file ProductClassificationPlanMT.h
 *
...
#ifndef UCI_TYPE_PRODUCTCLASSIFICATIONPLANMT_H
#define UCI_TYPE_PRODUCTCLASSIFICATIONPLANMT_H
...
#include "ProductClassificationPlanMDT.h"
...
class ProductClassificationPlanMT : public virtual MessageType {
public:

  /** This method constructs a new ProductClassificationPlanMT.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed ProductClassificationPlanMT.
    */
  static UCI_EXPORT ProductClassificationPlanMT& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new ProductClassificationPlanMT initializing the data accessed by the new
    * ProductClassificationPlanMT using the data accessed by the specified ProductClassificationPlanMT (cloning).
    *
    * @param accessor The ProductClassificationPlanMT that provides access to the data that is to be used to initialize the
    *      data accessed by the new created ProductClassificationPlanMT.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed ProductClassificationPlanMT.
    */
  static UCI_EXPORT ProductClassificationPlanMT& create(const ProductClassificationPlanMT& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified ProductClassificationPlanMT. Use of the specified accessor after it has been
    * destroyed will result in undefined behavior.
    *
    * @param accessor The ProductClassificationPlanMT that is to be destroyed.
    */
  static UCI_EXPORT void destroy(ProductClassificationPlanMT& accessor);
  ...
  /** Returns the version that was initialized from the uci:version attribute of ProductClassificationPlanMT.
    *
    * @return The version that was initialized from the uci:version attribute of ProductClassificationPlanMT.
    */
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const ProductClassificationPlanMT& accessor) = 0;
  ...
  /** Sets the value of the enumeration identified by ObjectState.
    ...
    */
  virtual uci::type::ProductClassificationPlanMT& setObjectState(const uci::type::ObjectStateEnum& value) = 0;
  ...
  /** Sets the value of the enumeration identified by ObjectState.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::ProductClassificationPlanMT& setObjectState(uci::type::ObjectStateEnum::EnumerationItem value) = 0;
  ...
  /** Clears (disabled) the Element identified by ObjectState.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::ProductClassificationPlanMT& clearObjectState() = 0;
  ...
  /** Returns a const reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual const uci::type::ProductClassificationPlanMDT& getMessageData() const = 0;
  ...
  /** Returns a reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual uci::type::ProductClassificationPlanMDT& getMessageData() = 0;
  ...
  /** Sets the complex content identified by MessageData to the contents of the complex content accessed by the specified
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::ProductClassificationPlanMT& setMessageData(const uci::type::ProductClassificationPlanMDT& value) = 0;

  /** The Listener provides the support to listen and handle incoming messages of the type
    * uci::type::ProductClassificationPlanMT.
    */
  ...
  public:
    ...
    /** The method is used to handle incoming messages.
      ...
      */
    virtual void handleMessage(const uci::type::ProductClassificationPlanMT& message) = 0;
  ...
  public:
    ...
    /** Adds a listener to this reader to handle incoming messages.
      ...
      */
    virtual void addListener(uci::type::ProductClassificationPlanMT::Listener& listener) = 0;

    /** Removes the specified listener from this reader.
      *
      * @param listener The listener that is to be removed from this reader.
      */
    virtual void removeListener(uci::type::ProductClassificationPlanMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s). Returns immediately if no messages are available.
      ...
      */
    virtual unsigned long readNoWait(unsigned long maxNumberOfMessages, uci::type::ProductClassificationPlanMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s).
      ...
      * @return The number of messages that were handled.
      */
    virtual unsigned long read(unsigned long timeout, unsigned long maxNumberOfMessages, uci::type::ProductClassificationPlanMT::Listener& listener) = 0;
  ...
  /** This method creates a new reader that can be used to read a ProductClassificationPlanMT.
    *
    * @param topic The specification of the topic the reader is to read from.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A reader that can read a ProductClassificationPlanMT.
    */
  static UCI_EXPORT uci::type::ProductClassificationPlanMT::Reader& createReader(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a reader. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyReader(uci::type::ProductClassificationPlanMT::Reader& reader);
  ...
  public:
    ...
    /** Writes the OMS message to the topic specified when this Writer was created.
      ...
      */
    virtual void write(uci::type::ProductClassificationPlanMT& accessor) = 0;
  ...
  /** This method creates a new writer that can be used to write a ProductClassificationPlanMT.
    *
    * @param topic The specification of the topic the writer is to write to.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A writer that can write a ProductClassificationPlanMT.
    */
  static UCI_EXPORT uci::type::ProductClassificationPlanMT::Writer& createWriter(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a writer. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyWriter(uci::type::ProductClassificationPlanMT::Writer& writer);
...
protected:
  ...
  /** The assignment operator. Sets the contents of this ProductClassificationPlanMT to the contents of the
    * ProductClassificationPlanMT on the right hand side (rhs) of the assignment operator [only available to derived
    * classes].
    *
    * @param rhs The ProductClassificationPlanMT on the right hand side (rhs) of the assignment operator whose contents are
    *      used to set the contents of this ProductClassificationPlanMT.
    * @return A reference to this ProductClassificationPlanMT.
    */
  ProductClassificationPlanMT& operator=(const ProductClassificationPlanMT& rhs) {
    (void)rhs;
...
#endif // UCI_TYPE_PRODUCTCLASSIFICATIONPLANMT_H
