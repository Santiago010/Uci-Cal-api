...
#ifndef UCI_TYPE_SERVICEERRORREPORTMT_H
#define UCI_TYPE_SERVICEERRORREPORTMT_H
...
#include "ServiceErrorReportMDT.h"
...
class ServiceErrorReportMT : public virtual MessageType {
public:

  /** This method constructs a new ServiceErrorReportMT.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed ServiceErrorReportMT.
    */
  static UCI_EXPORT ServiceErrorReportMT& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new ServiceErrorReportMT initializing the data accessed by the new ServiceErrorReportMT
    * using the data accessed by the specified ServiceErrorReportMT (cloning).
    *
    * @param accessor The ServiceErrorReportMT that provides access to the data that is to be used to initialize the data
    *      accessed by the new created ServiceErrorReportMT.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed ServiceErrorReportMT.
    */
  static UCI_EXPORT ServiceErrorReportMT& create(const ServiceErrorReportMT& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified ServiceErrorReportMT. Use of the specified accessor after it has been destroyed
    * will result in undefined behavior.
    *
    * @param accessor The ServiceErrorReportMT that is to be destroyed.
    */
  static UCI_EXPORT void destroy(ServiceErrorReportMT& accessor);
  ...
  /** Returns the version that was initialized from the uci:version attribute of ServiceErrorReportMT.
    *
    * @return The version that was initialized from the uci:version attribute of ServiceErrorReportMT.
    */
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const ServiceErrorReportMT& accessor) = 0;
  ...
  /** Sets the value of the enumeration identified by ObjectState.
    ...
    */
  virtual uci::type::ServiceErrorReportMT& setObjectState(const uci::type::ObjectStateEnum& value) = 0;
  ...
  /** Sets the value of the enumeration identified by ObjectState.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::ServiceErrorReportMT& setObjectState(uci::type::ObjectStateEnum::EnumerationItem value) = 0;
  ...
  /** Clears (disabled) the Element identified by ObjectState.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::ServiceErrorReportMT& clearObjectState() = 0;
  ...
  /** Returns a const reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual const uci::type::ServiceErrorReportMDT& getMessageData() const = 0;
  ...
  /** Returns a reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual uci::type::ServiceErrorReportMDT& getMessageData() = 0;
  ...
  /** Sets the complex content identified by MessageData to the contents of the complex content accessed by the specified
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::ServiceErrorReportMT& setMessageData(const uci::type::ServiceErrorReportMDT& value) = 0;

  /** The Listener provides the support to listen and handle incoming messages of the type uci::type::ServiceErrorReportMT. */
  ...
  public:
    ...
    /** The method is used to handle incoming messages.
      ...
      */
    virtual void handleMessage(const uci::type::ServiceErrorReportMT& message) = 0;
  ...
  public:
    ...
    /** Adds a listener to this reader to handle incoming messages.
      ...
      */
    virtual void addListener(uci::type::ServiceErrorReportMT::Listener& listener) = 0;

    /** Removes the specified listener from this reader.
      *
      * @param listener The listener that is to be removed from this reader.
      */
    virtual void removeListener(uci::type::ServiceErrorReportMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s). Returns immediately if no messages are available.
      ...
      */
    virtual unsigned long readNoWait(unsigned long maxNumberOfMessages, uci::type::ServiceErrorReportMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s).
      ...
      * @return The number of messages that were handled.
      */
    virtual unsigned long read(unsigned long timeout, unsigned long maxNumberOfMessages, uci::type::ServiceErrorReportMT::Listener& listener) = 0;
  ...
  /** This method creates a new reader that can be used to read a ServiceErrorReportMT.
    *
    * @param topic The specification of the topic the reader is to read from.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A reader that can read a ServiceErrorReportMT.
    */
  static UCI_EXPORT uci::type::ServiceErrorReportMT::Reader& createReader(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a reader. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyReader(uci::type::ServiceErrorReportMT::Reader& reader);
  ...
  public:
    ...
    /** Writes the OMS message to the topic specified when this Writer was created.
      ...
      */
    virtual void write(uci::type::ServiceErrorReportMT& accessor) = 0;
  ...
  /** This method creates a new writer that can be used to write a ServiceErrorReportMT.
    *
    * @param topic The specification of the topic the writer is to write to.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A writer that can write a ServiceErrorReportMT.
    */
  static UCI_EXPORT uci::type::ServiceErrorReportMT::Writer& createWriter(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a writer. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyWriter(uci::type::ServiceErrorReportMT::Writer& writer);
...
protected:
  ...
  /** The assignment operator. Sets the contents of this ServiceErrorReportMT to the contents of the ServiceErrorReportMT
    ...
    *      to set the contents of this ServiceErrorReportMT.
    * @return A reference to this ServiceErrorReportMT.
    */
  ServiceErrorReportMT& operator=(const ServiceErrorReportMT& rhs) {
    (void)rhs;
...
#endif // UCI_TYPE_SERVICEERRORREPORTMT_H
