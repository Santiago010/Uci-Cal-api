/** @file EOB_CorrelationRecordMT.h
 *
...
#ifndef UCI_TYPE_EOB_CORRELATIONRECORDMT_H
#define UCI_TYPE_EOB_CORRELATIONRECORDMT_H

#include "../base/Listener.h"
#include "../base/Reader.h"
#include "../base/Writer.h"
#include "../base/export.h"
#include "EOB_CorrelationRecordMDT.h"
...
class EOB_CorrelationRecordMT : public virtual MessageType {
public:

  /** This method constructs a new EOB_CorrelationRecordMT.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed EOB_CorrelationRecordMT.
    */
  static UCI_EXPORT EOB_CorrelationRecordMT& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new EOB_CorrelationRecordMT initializing the data accessed by the new
    * EOB_CorrelationRecordMT using the data accessed by the specified EOB_CorrelationRecordMT (cloning).
    *
    * @param accessor The EOB_CorrelationRecordMT that provides access to the data that is to be used to initialize the
    *      data accessed by the new created EOB_CorrelationRecordMT.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed EOB_CorrelationRecordMT.
    */
  static UCI_EXPORT EOB_CorrelationRecordMT& create(const EOB_CorrelationRecordMT& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified EOB_CorrelationRecordMT. Use of the specified accessor after it has been destroyed
    * will result in undefined behavior.
    *
    * @param accessor The EOB_CorrelationRecordMT that is to be destroyed.
    */
  static UCI_EXPORT void destroy(EOB_CorrelationRecordMT& accessor);
  ...
  /** Returns the version that was initialized from the uci:version attribute of EOB_CorrelationRecordMT.
    *
    * @return The version that was initialized from the uci:version attribute of EOB_CorrelationRecordMT.
    */
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const EOB_CorrelationRecordMT& accessor) = 0;
  ...
  /** Sets the value of the enumeration identified by ObjectState.
    ...
    */
  virtual uci::type::EOB_CorrelationRecordMT& setObjectState(const uci::type::ObjectStateEnum& value) = 0;
  ...
  /** Sets the value of the enumeration identified by ObjectState.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::EOB_CorrelationRecordMT& setObjectState(uci::type::ObjectStateEnum::EnumerationItem value) = 0;
  ...
  /** Clears (disabled) the Element identified by ObjectState.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::EOB_CorrelationRecordMT& clearObjectState() = 0;
  ...
  /** Returns a const reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual const uci::type::EOB_CorrelationRecordMDT& getMessageData() const = 0;
  ...
  /** Returns a reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual uci::type::EOB_CorrelationRecordMDT& getMessageData() = 0;
  ...
  /** Sets the complex content identified by MessageData to the contents of the complex content accessed by the specified
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::EOB_CorrelationRecordMT& setMessageData(const uci::type::EOB_CorrelationRecordMDT& value) = 0;

  /** The Listener provides the support to listen and handle incoming messages of the type
    * uci::type::EOB_CorrelationRecordMT.
    */
  ...
  public:
    ...
    /** The method is used to handle incoming messages.
      ...
      */
    virtual void handleMessage(const uci::type::EOB_CorrelationRecordMT& message) = 0;
  ...
  public:
    ...
    /** Adds a listener to this reader to handle incoming messages.
      ...
      */
    virtual void addListener(uci::type::EOB_CorrelationRecordMT::Listener& listener) = 0;

    /** Removes the specified listener from this reader.
      *
      * @param listener The listener that is to be removed from this reader.
      */
    virtual void removeListener(uci::type::EOB_CorrelationRecordMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s). Returns immediately if no messages are available.
      ...
      */
    virtual unsigned long readNoWait(unsigned long maxNumberOfMessages, uci::type::EOB_CorrelationRecordMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s).
      ...
      * @return The number of messages that were handled.
      */
    virtual unsigned long read(unsigned long timeout, unsigned long maxNumberOfMessages, uci::type::EOB_CorrelationRecordMT::Listener& listener) = 0;
  ...
  /** This method creates a new reader that can be used to read a EOB_CorrelationRecordMT.
    *
    * @param topic The specification of the topic the reader is to read from.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A reader that can read a EOB_CorrelationRecordMT.
    */
  static UCI_EXPORT uci::type::EOB_CorrelationRecordMT::Reader& createReader(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a reader. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyReader(uci::type::EOB_CorrelationRecordMT::Reader& reader);
  ...
  public:
    ...
    /** Writes the OMS message to the topic specified when this Writer was created.
      ...
      */
    virtual void write(uci::type::EOB_CorrelationRecordMT& accessor) = 0;
  ...
  /** This method creates a new writer that can be used to write a EOB_CorrelationRecordMT.
    *
    * @param topic The specification of the topic the writer is to write to.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A writer that can write a EOB_CorrelationRecordMT.
    */
  static UCI_EXPORT uci::type::EOB_CorrelationRecordMT::Writer& createWriter(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a writer. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyWriter(uci::type::EOB_CorrelationRecordMT::Writer& writer);
...
protected:
  ...
  /** The assignment operator. Sets the contents of this EOB_CorrelationRecordMT to the contents of the
    * EOB_CorrelationRecordMT on the right hand side (rhs) of the assignment operator [only available to derived classes].
    *
    * @param rhs The EOB_CorrelationRecordMT on the right hand side (rhs) of the assignment operator whose contents are
    *      used to set the contents of this EOB_CorrelationRecordMT.
    * @return A reference to this EOB_CorrelationRecordMT.
    */
  EOB_CorrelationRecordMT& operator=(const EOB_CorrelationRecordMT& rhs) {
    (void)rhs;
...
#endif // UCI_TYPE_EOB_CORRELATIONRECORDMT_H
