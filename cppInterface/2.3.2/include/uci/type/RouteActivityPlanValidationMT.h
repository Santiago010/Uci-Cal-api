/** @file RouteActivityPlanValidationMT.h
 *
...
#ifndef UCI_TYPE_ROUTEACTIVITYPLANVALIDATIONMT_H
#define UCI_TYPE_ROUTEACTIVITYPLANVALIDATIONMT_H
...
#include "RouteActivityPlanValidationMDT.h"
...
class RouteActivityPlanValidationMT : public virtual MessageType {
public:

  /** This method constructs a new RouteActivityPlanValidationMT.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed RouteActivityPlanValidationMT.
    */
  static UCI_EXPORT RouteActivityPlanValidationMT& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new RouteActivityPlanValidationMT initializing the data accessed by the new
    * RouteActivityPlanValidationMT using the data accessed by the specified RouteActivityPlanValidationMT (cloning).
    *
    * @param accessor The RouteActivityPlanValidationMT that provides access to the data that is to be used to initialize
    *      the data accessed by the new created RouteActivityPlanValidationMT.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed RouteActivityPlanValidationMT.
    */
  static UCI_EXPORT RouteActivityPlanValidationMT& create(const RouteActivityPlanValidationMT& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified RouteActivityPlanValidationMT. Use of the specified accessor after it has been
    * destroyed will result in undefined behavior.
    *
    * @param accessor The RouteActivityPlanValidationMT that is to be destroyed.
    */
  static UCI_EXPORT void destroy(RouteActivityPlanValidationMT& accessor);

  /** Returns this accessor's type constant, i.e. routeActivityPlanValidationMT.
    *
    * @return This accessor's type constant, i.e. routeActivityPlanValidationMT.
    */
  virtual uci::base::accessorType::AccessorType getAccessorType() const noexception {
    return uci::type::accessorType::routeActivityPlanValidationMT;
  }

  /** Returns the version that was initialized from the uci:version attribute of RouteActivityPlanValidationMT.
    *
    * @return The version that was initialized from the uci:version attribute of RouteActivityPlanValidationMT.
    */
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const RouteActivityPlanValidationMT& accessor) = 0;
  ...
  /** Sets the value of the enumeration identified by ObjectState.
    ...
    */
  virtual uci::type::RouteActivityPlanValidationMT& setObjectState(const uci::type::ObjectStateEnum& value) = 0;
  ...
  /** Sets the value of the enumeration identified by ObjectState.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::RouteActivityPlanValidationMT& setObjectState(uci::type::ObjectStateEnum::EnumerationItem value) = 0;
  ...
  /** Clears (disabled) the Element identified by ObjectState.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::RouteActivityPlanValidationMT& clearObjectState() = 0;
  ...
  /** Returns a const reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual const uci::type::RouteActivityPlanValidationMDT& getMessageData() const = 0;
  ...
  /** Returns a reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual uci::type::RouteActivityPlanValidationMDT& getMessageData() = 0;
  ...
  /** Sets the complex content identified by MessageData to the contents of the complex content accessed by the specified
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::RouteActivityPlanValidationMT& setMessageData(const uci::type::RouteActivityPlanValidationMDT& value) = 0;

  /** The Listener provides the support to listen and handle incoming messages of the type
    * uci::type::RouteActivityPlanValidationMT.
    */
  ...
  public:
    ...
    /** The method is used to handle incoming messages.
      ...
      */
    virtual void handleMessage(const uci::type::RouteActivityPlanValidationMT& message) = 0;
  ...
  public:
    ...
    /** Adds a listener to this reader to handle incoming messages.
      ...
      */
    virtual void addListener(uci::type::RouteActivityPlanValidationMT::Listener& listener) = 0;

    /** Removes the specified listener from this reader.
      *
      * @param listener The listener that is to be removed from this reader.
      */
    virtual void removeListener(uci::type::RouteActivityPlanValidationMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s). Returns immediately if no messages are available.
      ...
      */
    virtual unsigned long readNoWait(unsigned long maxNumberOfMessages, uci::type::RouteActivityPlanValidationMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s).
      ...
      * @return The number of messages that were handled.
      */
    virtual unsigned long read(unsigned long timeout, unsigned long maxNumberOfMessages, uci::type::RouteActivityPlanValidationMT::Listener& listener) = 0;
  ...
  /** This method creates a new reader that can be used to read a RouteActivityPlanValidationMT.
    *
    * @param topic The specification of the topic the reader is to read from.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A reader that can read a RouteActivityPlanValidationMT.
    */
  static UCI_EXPORT uci::type::RouteActivityPlanValidationMT::Reader& createReader(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a reader. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyReader(uci::type::RouteActivityPlanValidationMT::Reader& reader);
  ...
  public:
    ...
    /** Writes the OMS message to the topic specified when this Writer was created.
      ...
      */
    virtual void write(uci::type::RouteActivityPlanValidationMT& accessor) = 0;
  ...
  /** This method creates a new writer that can be used to write a RouteActivityPlanValidationMT.
    *
    * @param topic The specification of the topic the writer is to write to.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A writer that can write a RouteActivityPlanValidationMT.
    */
  static UCI_EXPORT uci::type::RouteActivityPlanValidationMT::Writer& createWriter(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a writer. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyWriter(uci::type::RouteActivityPlanValidationMT::Writer& writer);
...
protected:
  ...
  /** The copy constructor [only available to derived classes].
    *
    * @param rhs The RouteActivityPlanValidationMT to copy from.
    */
  RouteActivityPlanValidationMT(const RouteActivityPlanValidationMT& rhs) {
    (void)rhs;
  }

  /** The assignment operator. Sets the contents of this RouteActivityPlanValidationMT to the contents of the
    * RouteActivityPlanValidationMT on the right hand side (rhs) of the assignment operator [only available to derived
    * classes].
    *
    * @param rhs The RouteActivityPlanValidationMT on the right hand side (rhs) of the assignment operator whose contents
    *      are used to set the contents of this RouteActivityPlanValidationMT.
    * @return A reference to this RouteActivityPlanValidationMT.
    */
  RouteActivityPlanValidationMT& operator=(const RouteActivityPlanValidationMT& rhs) {
    (void)rhs;
...
#endif // UCI_TYPE_ROUTEACTIVITYPLANVALIDATIONMT_H
