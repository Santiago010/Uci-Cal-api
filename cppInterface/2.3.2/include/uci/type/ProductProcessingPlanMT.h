/** @file ProductProcessingPlanMT.h
 *
...
#ifndef UCI_TYPE_PRODUCTPROCESSINGPLANMT_H
#define UCI_TYPE_PRODUCTPROCESSINGPLANMT_H
...
#include "ProductProcessingPlanMDT.h"
...
class ProductProcessingPlanMT : public virtual MessageType {
public:

  /** This method constructs a new ProductProcessingPlanMT.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed ProductProcessingPlanMT.
    */
  static UCI_EXPORT ProductProcessingPlanMT& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new ProductProcessingPlanMT initializing the data accessed by the new
    * ProductProcessingPlanMT using the data accessed by the specified ProductProcessingPlanMT (cloning).
    *
    * @param accessor The ProductProcessingPlanMT that provides access to the data that is to be used to initialize the
    *      data accessed by the new created ProductProcessingPlanMT.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed ProductProcessingPlanMT.
    */
  static UCI_EXPORT ProductProcessingPlanMT& create(const ProductProcessingPlanMT& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified ProductProcessingPlanMT. Use of the specified accessor after it has been destroyed
    * will result in undefined behavior.
    *
    * @param accessor The ProductProcessingPlanMT that is to be destroyed.
    */
  static UCI_EXPORT void destroy(ProductProcessingPlanMT& accessor);
  ...
  /** Returns the version that was initialized from the uci:version attribute of ProductProcessingPlanMT.
    *
    * @return The version that was initialized from the uci:version attribute of ProductProcessingPlanMT.
    */
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const ProductProcessingPlanMT& accessor) = 0;
  ...
  /** Sets the value of the enumeration identified by ObjectState.
    ...
    */
  virtual uci::type::ProductProcessingPlanMT& setObjectState(const uci::type::ObjectStateEnum& value) = 0;
  ...
  /** Sets the value of the enumeration identified by ObjectState.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::ProductProcessingPlanMT& setObjectState(uci::type::ObjectStateEnum::EnumerationItem value) = 0;
  ...
  /** Clears (disabled) the Element identified by ObjectState.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::ProductProcessingPlanMT& clearObjectState() = 0;
  ...
  /** Returns a const reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual const uci::type::ProductProcessingPlanMDT& getMessageData() const = 0;
  ...
  /** Returns a reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual uci::type::ProductProcessingPlanMDT& getMessageData() = 0;
  ...
  /** Sets the complex content identified by MessageData to the contents of the complex content accessed by the specified
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::ProductProcessingPlanMT& setMessageData(const uci::type::ProductProcessingPlanMDT& value) = 0;

  /** The Listener provides the support to listen and handle incoming messages of the type
    * uci::type::ProductProcessingPlanMT.
    */
  ...
  public:
    ...
    /** The method is used to handle incoming messages.
      ...
      */
    virtual void handleMessage(const uci::type::ProductProcessingPlanMT& message) = 0;
  ...
  public:
    ...
    /** Adds a listener to this reader to handle incoming messages.
      ...
      */
    virtual void addListener(uci::type::ProductProcessingPlanMT::Listener& listener) = 0;

    /** Removes the specified listener from this reader.
      *
      * @param listener The listener that is to be removed from this reader.
      */
    virtual void removeListener(uci::type::ProductProcessingPlanMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s). Returns immediately if no messages are available.
      ...
      */
    virtual unsigned long readNoWait(unsigned long maxNumberOfMessages, uci::type::ProductProcessingPlanMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s).
      ...
      * @return The number of messages that were handled.
      */
    virtual unsigned long read(unsigned long timeout, unsigned long maxNumberOfMessages, uci::type::ProductProcessingPlanMT::Listener& listener) = 0;
  ...
  /** This method creates a new reader that can be used to read a ProductProcessingPlanMT.
    *
    * @param topic The specification of the topic the reader is to read from.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A reader that can read a ProductProcessingPlanMT.
    */
  static UCI_EXPORT uci::type::ProductProcessingPlanMT::Reader& createReader(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a reader. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyReader(uci::type::ProductProcessingPlanMT::Reader& reader);
  ...
  public:
    ...
    /** Writes the OMS message to the topic specified when this Writer was created.
      ...
      */
    virtual void write(uci::type::ProductProcessingPlanMT& accessor) = 0;
  ...
  /** This method creates a new writer that can be used to write a ProductProcessingPlanMT.
    *
    * @param topic The specification of the topic the writer is to write to.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A writer that can write a ProductProcessingPlanMT.
    */
  static UCI_EXPORT uci::type::ProductProcessingPlanMT::Writer& createWriter(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a writer. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyWriter(uci::type::ProductProcessingPlanMT::Writer& writer);
...
protected:
  ...
  /** The assignment operator. Sets the contents of this ProductProcessingPlanMT to the contents of the
    * ProductProcessingPlanMT on the right hand side (rhs) of the assignment operator [only available to derived classes].
    *
    * @param rhs The ProductProcessingPlanMT on the right hand side (rhs) of the assignment operator whose contents are
    *      used to set the contents of this ProductProcessingPlanMT.
    * @return A reference to this ProductProcessingPlanMT.
    */
  ProductProcessingPlanMT& operator=(const ProductProcessingPlanMT& rhs) {
    (void)rhs;
...
#endif // UCI_TYPE_PRODUCTPROCESSINGPLANMT_H
