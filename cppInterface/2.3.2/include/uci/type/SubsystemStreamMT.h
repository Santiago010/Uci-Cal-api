...
#ifndef UCI_TYPE_SUBSYSTEMSTREAMMT_H
#define UCI_TYPE_SUBSYSTEMSTREAMMT_H
...
class SubsystemStreamMT : public virtual MessageType {
public:

  /** This method constructs a new SubsystemStreamMT.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed SubsystemStreamMT.
    */
  static UCI_EXPORT SubsystemStreamMT& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new SubsystemStreamMT initializing the data accessed by the new SubsystemStreamMT using the
    * data accessed by the specified SubsystemStreamMT (cloning).
    *
    * @param accessor The SubsystemStreamMT that provides access to the data that is to be used to initialize the data
    *      accessed by the new created SubsystemStreamMT.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed SubsystemStreamMT.
    */
  static UCI_EXPORT SubsystemStreamMT& create(const SubsystemStreamMT& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified SubsystemStreamMT. Use of the specified accessor after it has been destroyed will
    * result in undefined behavior.
    *
    * @param accessor The SubsystemStreamMT that is to be destroyed.
    */
  static UCI_EXPORT void destroy(SubsystemStreamMT& accessor);
  ...
  /** Returns the version that was initialized from the uci:version attribute of SubsystemStreamMT.
    *
    * @return The version that was initialized from the uci:version attribute of SubsystemStreamMT.
    */
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const SubsystemStreamMT& accessor) = 0;
  ...
  /** Returns a const reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual const uci::type::SubsystemStreamMDT& getMessageData() const = 0;
  ...
  /** Returns a reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual uci::type::SubsystemStreamMDT& getMessageData() = 0;
  ...
  /** Sets the complex content identified by MessageData to the contents of the complex content accessed by the specified
    ...
    */
  virtual uci::type::SubsystemStreamMT& setMessageData(const uci::type::SubsystemStreamMDT& value) = 0;

  /** The Listener provides the support to listen and handle incoming messages of the type uci::type::SubsystemStreamMT. */
  ...
  public:
    ...
    /** The method is used to handle incoming messages.
      ...
      */
    virtual void handleMessage(const uci::type::SubsystemStreamMT& message) = 0;
  ...
  public:
    ...
    /** Adds a listener to this reader to handle incoming messages.
      ...
      */
    virtual void addListener(uci::type::SubsystemStreamMT::Listener& listener) = 0;

    /** Removes the specified listener from this reader.
      *
      * @param listener The listener that is to be removed from this reader.
      */
    virtual void removeListener(uci::type::SubsystemStreamMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s). Returns immediately if no messages are available.
      ...
      */
    virtual unsigned long readNoWait(unsigned long maxNumberOfMessages, uci::type::SubsystemStreamMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s).
      ...
      * @return The number of messages that were handled.
      */
    virtual unsigned long read(unsigned long timeout, unsigned long maxNumberOfMessages, uci::type::SubsystemStreamMT::Listener& listener) = 0;
  ...
  /** This method creates a new reader that can be used to read a SubsystemStreamMT.
    *
    * @param topic The specification of the topic the reader is to read from.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A reader that can read a SubsystemStreamMT.
    */
  static UCI_EXPORT uci::type::SubsystemStreamMT::Reader& createReader(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a reader. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyReader(uci::type::SubsystemStreamMT::Reader& reader);
  ...
  public:
    ...
    /** Writes the OMS message to the topic specified when this Writer was created.
      ...
      */
    virtual void write(uci::type::SubsystemStreamMT& accessor) = 0;
  ...
  /** This method creates a new writer that can be used to write a SubsystemStreamMT.
    *
    * @param topic The specification of the topic the writer is to write to.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A writer that can write a SubsystemStreamMT.
    */
  static UCI_EXPORT uci::type::SubsystemStreamMT::Writer& createWriter(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a writer. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyWriter(uci::type::SubsystemStreamMT::Writer& writer);
...
protected:
  ...
  /** The assignment operator. Sets the contents of this SubsystemStreamMT to the contents of the SubsystemStreamMT on the
    ...
    *      set the contents of this SubsystemStreamMT.
    * @return A reference to this SubsystemStreamMT.
    */
  SubsystemStreamMT& operator=(const SubsystemStreamMT& rhs) {
    (void)rhs;
...
#endif // UCI_TYPE_SUBSYSTEMSTREAMMT_H
