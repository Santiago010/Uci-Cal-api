...
#ifndef UCI_TYPE_COMMTERMINALCOMMANDMT_H
#define UCI_TYPE_COMMTERMINALCOMMANDMT_H

#include "../base/Listener.h"
#include "../base/Reader.h"
#include "../base/Writer.h"
#include "../base/export.h"
#include "CommTerminalCommandMDT.h"
...
class CommTerminalCommandMT : public virtual MessageType {
public:

  /** This method constructs a new CommTerminalCommandMT.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed CommTerminalCommandMT.
    */
  static UCI_EXPORT CommTerminalCommandMT& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new CommTerminalCommandMT initializing the data accessed by the new CommTerminalCommandMT
    * using the data accessed by the specified CommTerminalCommandMT (cloning).
    *
    * @param accessor The CommTerminalCommandMT that provides access to the data that is to be used to initialize the data
    *      accessed by the new created CommTerminalCommandMT.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed CommTerminalCommandMT.
    */
  static UCI_EXPORT CommTerminalCommandMT& create(const CommTerminalCommandMT& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified CommTerminalCommandMT. Use of the specified accessor after it has been destroyed
    * will result in undefined behavior.
    *
    * @param accessor The CommTerminalCommandMT that is to be destroyed.
    */
  static UCI_EXPORT void destroy(CommTerminalCommandMT& accessor);
  ...
  /** Returns the version that was initialized from the uci:version attribute of CommTerminalCommandMT.
    *
    * @return The version that was initialized from the uci:version attribute of CommTerminalCommandMT.
    */
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const CommTerminalCommandMT& accessor) = 0;
  ...
  /** Returns a const reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual const uci::type::CommTerminalCommandMDT& getMessageData() const = 0;
  ...
  /** Returns a reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual uci::type::CommTerminalCommandMDT& getMessageData() = 0;
  ...
  /** Sets the complex content identified by MessageData to the contents of the complex content accessed by the specified
    ...
    */
  virtual uci::type::CommTerminalCommandMT& setMessageData(const uci::type::CommTerminalCommandMDT& value) = 0;

  /** The Listener provides the support to listen and handle incoming messages of the type
    * uci::type::CommTerminalCommandMT.
    */
  ...
  public:
    ...
    /** The method is used to handle incoming messages.
      ...
      */
    virtual void handleMessage(const uci::type::CommTerminalCommandMT& message) = 0;
  ...
  public:
    ...
    /** Adds a listener to this reader to handle incoming messages.
      ...
      */
    virtual void addListener(uci::type::CommTerminalCommandMT::Listener& listener) = 0;

    /** Removes the specified listener from this reader.
      *
      * @param listener The listener that is to be removed from this reader.
      */
    virtual void removeListener(uci::type::CommTerminalCommandMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s). Returns immediately if no messages are available.
      ...
      */
    virtual unsigned long readNoWait(unsigned long maxNumberOfMessages, uci::type::CommTerminalCommandMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s).
      ...
      * @return The number of messages that were handled.
      */
    virtual unsigned long read(unsigned long timeout, unsigned long maxNumberOfMessages, uci::type::CommTerminalCommandMT::Listener& listener) = 0;
  ...
  /** This method creates a new reader that can be used to read a CommTerminalCommandMT.
    *
    * @param topic The specification of the topic the reader is to read from.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A reader that can read a CommTerminalCommandMT.
    */
  static UCI_EXPORT uci::type::CommTerminalCommandMT::Reader& createReader(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a reader. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyReader(uci::type::CommTerminalCommandMT::Reader& reader);
  ...
  public:
    ...
    /** Writes the OMS message to the topic specified when this Writer was created.
      ...
      */
    virtual void write(uci::type::CommTerminalCommandMT& accessor) = 0;
  ...
  /** This method creates a new writer that can be used to write a CommTerminalCommandMT.
    *
    * @param topic The specification of the topic the writer is to write to.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A writer that can write a CommTerminalCommandMT.
    */
  static UCI_EXPORT uci::type::CommTerminalCommandMT::Writer& createWriter(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a writer. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyWriter(uci::type::CommTerminalCommandMT::Writer& writer);
...
protected:
  ...
  /** The assignment operator. Sets the contents of this CommTerminalCommandMT to the contents of the CommTerminalCommandMT
    ...
    *      to set the contents of this CommTerminalCommandMT.
    * @return A reference to this CommTerminalCommandMT.
    */
  CommTerminalCommandMT& operator=(const CommTerminalCommandMT& rhs) {
    (void)rhs;
...
#endif // UCI_TYPE_COMMTERMINALCOMMANDMT_H
