...
#ifndef UCI_TYPE_OPPOINTSTATIONENUM_H
#define UCI_TYPE_OPPOINTSTATIONENUM_H
...
/** The type of a station point. Based on MIL-STD-6016 Point Type (DFI 363/DUI 003) and Point Amplification (DFI 379/DUI
  * 002).
  */
...
public:
  ...
  enum EnumerationItem {
    ...
    /** A general station point where the function must be described by other procedures. */
    UCI_GENERAL_STATION,

    /** A point occupied by a surface unit capable of performing air control functions whose purpose is to screen returning
      * aircraft to prevent enemy aircraft from locating the force.
      */
    UCI_TOMCAT,

    /** A point outside a formation or geographic area where an aircraft or ship is stationed as a rescue or warning unit. */
    UCI_PICKET,

    /** A point for a prearranged meeting at a given time and location from which to begin an action or phase of an operation
      * or to which to return, after an operation.
      */
    UCI_RENDEZVOUS,

    /** A point where rearming and resupply of units other than aircraft may be conducted. */
    UCI_REPLENISHMENT,

    /** A point used to mark the position of a rescue operation. */
    UCI_RESCUE,
    ...
    /** A point denoting a station where a fixed wing aircraft on an antisubmarine warfare mission will operate. */
    UCI_ASW_FIXED_WING,

    /** A point denoting a station where a helicopter whose mission is antisubmarine warfare will operate. */
    UCI_ASW_HELO,

    /** A point where aircraft rearming and resupply may be conducted. */
    UCI_REPLENISHMENT_AIR,

    /** A point in space that aircraft (IP) rendezvous or pass through prior to attacking a ground target. */
    UCI_STRIKE_IP,

    /** A point at which a TACAN is located. */
    UCI_TACAN,
    ...
    /** A point that does not fit into any of the other predefined categories. */
    UCI_OTHER,
  ...
  /** The assignment operator. Sets the contents of this OpPointStationEnum to the contents of the OpPointStationEnum on
    ...
    * @return A reference to this OpPointStationEnum.
    */
  OpPointStationEnum& operator=(const OpPointStationEnum& rhs) {
    setValue(rhs.getValue());
    return *this;
  }

  /** The assignment operator that sets the value of this OpPointStationEnum enumeration to the EnumerationItem on the
    * right hand side of the assignment operator.
    *
    * @param rhs The EnumerationItem whose value is to be assigned to this OpPointStationEnum enumeration.
    * @return A reference to this OpPointStationEnum enumeration.
    */
  OpPointStationEnum& operator=(EnumerationItem rhs) {
    setValue(rhs);
    return *this;
  }
  ...
  /** Sets the value of this OpPointStationEnum enumeration to the value of the specified enumeration item.
    *
    * @param item The EnumerationItem whose value is to be used to set the value of this OpPointStationEnum enumeration.
    */
  ...
  /** Tests whether the value of the specified EnumerationItem is not equal to the value of the specified
    ...
    * @param rhs The OpPointStationEnum enumeration whose value is to be compared against the value of the specified
    *      EnumerationItem.
    * @return True if the value of the EnumerationItem (lhs) is not equal to the value of the OpPointStationEnum
  ...
  /** Tests whether the value of the specified EnumerationItem is greater than the value of the specified
    ...
    * @param rhs The OpPointStationEnum enumeration whose value is to be compared against the value of the specified
    *      EnumerationItem.
    * @return True if the value of the EnumerationItem (lhs) is greater than the value of the OpPointStationEnum
    *      enumeration (rhs), false otherwise.
    */
  friend bool operator>(EnumerationItem lhs, const OpPointStationEnum& rhs) {
    testForValidItem(lhs);
  ...
  /** Tests whether the value of the specified EnumerationItem is greater than or equal to the value of the specified
    ...
    *      OpPointStationEnum enumeration (rhs), false otherwise.
    */
  friend bool operator>=(EnumerationItem lhs, const OpPointStationEnum& rhs) {
    testForValidItem(lhs);
    return lhs >= rhs.getValue();
...
#endif // UCI_TYPE_OPPOINTSTATIONENUM_H
