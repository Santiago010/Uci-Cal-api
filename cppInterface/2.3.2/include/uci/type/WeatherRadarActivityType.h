...
class WeatherRadarActivityType : public virtual ActivityBaseType {
public:

  /** This method constructs a new WeatherRadarActivityType.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed WeatherRadarActivityType.
    */
  static UCI_EXPORT WeatherRadarActivityType& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new WeatherRadarActivityType initializing the data accessed by the new
    * WeatherRadarActivityType using the data accessed by the specified WeatherRadarActivityType (cloning).
    *
    * @param accessor The WeatherRadarActivityType that provides access to the data that is to be used to initialize the
    *      data accessed by the new created WeatherRadarActivityType.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed WeatherRadarActivityType.
    */
  static UCI_EXPORT WeatherRadarActivityType& create(const WeatherRadarActivityType& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified WeatherRadarActivityType. Use of the specified accessor after it has been
    * destroyed will result in undefined behavior.
    *
    * @param accessor The WeatherRadarActivityType that is to be destroyed.
    */
  static UCI_EXPORT void destroy(WeatherRadarActivityType& accessor);
  ...
  /** Returns the version that was initialized from the uci:version attribute of WeatherRadarActivityType.
    *
    * @return The version that was initialized from the uci:version attribute of WeatherRadarActivityType.
    */
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const WeatherRadarActivityType& accessor) = 0;
  ...
  /** Returns a const reference to the accessor that provides access to the complex content identified by Metrics.
    ...
    */
  virtual const uci::type::WeatherRadarActivityStatusDetailType& getMetrics() const = 0;
  ...
  /** Returns a reference to the accessor that provides access to the complex content identified by Metrics.
    ...
    */
  virtual uci::type::WeatherRadarActivityStatusDetailType& getMetrics() = 0;
  ...
  /** Sets the complex content identified by Metrics to the contents of the complex content accessed by the specified
    ...
    */
  virtual uci::type::WeatherRadarActivityType& setMetrics(const uci::type::WeatherRadarActivityStatusDetailType& value) = 0;
  ...
  /** Enables the Element identified by Metrics.
    ...
    * @return A reference to the accessor that provides access to the complex content identified by Metrics.
    */
  virtual uci::type::WeatherRadarActivityStatusDetailType& enableMetrics(uci::base::accessorType::AccessorType type = uci::base::accessorType::null) = 0;

  /** Clears (disabled) the Element identified by Metrics.
    *
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::WeatherRadarActivityType& clearMetrics() = 0;
  ...
  /** Sets the complex content identified by AirVolume to the contents of the complex content accessed by the specified
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::WeatherRadarActivityType& setAirVolume(const uci::type::AirVolumeSensorReferencedType& value) = 0;
  ...
  /** Sets the value of the SimplePrimitive data type identified by PolicyApplied.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::WeatherRadarActivityType& setPolicyApplied(xs::Boolean value) = 0;
  ...
  /** Clears (disabled) the Element identified by PolicyApplied.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::WeatherRadarActivityType& clearPolicyApplied() = 0;
  ...
  /** Sets the value of the SimplePrimitive data type identified by AllProductsAndMessagesProduced.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::WeatherRadarActivityType& setAllProductsAndMessagesProduced(xs::Boolean value) = 0;
  ...
  /** Returns a const reference to the bounded list identified by ElectronicProtectionOptionsEmployed.
    ...
    */
  virtual const uci::type::WeatherRadarActivityType::ElectronicProtectionOptionsEmployed& getElectronicProtectionOptionsEmployed() const = 0;
  ...
  /** Returns a reference to the bounded list identified by ElectronicProtectionOptionsEmployed.
    ...
    */
  virtual uci::type::WeatherRadarActivityType::ElectronicProtectionOptionsEmployed& getElectronicProtectionOptionsEmployed() = 0;
  ...
  /** Sets the bounded list identified by ElectronicProtectionOptionsEmployed.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::WeatherRadarActivityType& setElectronicProtectionOptionsEmployed(const uci::type::WeatherRadarActivityType::ElectronicProtectionOptionsEmployed& value) = 0;
...
protected:
  ...
  /** The assignment operator. Sets the contents of this WeatherRadarActivityType to the contents of the
    * WeatherRadarActivityType on the right hand side (rhs) of the assignment operator [only available to derived classes].
    *
    * @param rhs The WeatherRadarActivityType on the right hand side (rhs) of the assignment operator whose contents are
    *      used to set the contents of this WeatherRadarActivityType.
    * @return A reference to this WeatherRadarActivityType.
    */
  WeatherRadarActivityType& operator=(const WeatherRadarActivityType& rhs) {
    (void)rhs;
...
#endif // UCI_TYPE_WEATHERRADARACTIVITYTYPE_H
