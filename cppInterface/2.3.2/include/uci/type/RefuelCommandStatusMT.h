...
#ifndef UCI_TYPE_REFUELCOMMANDSTATUSMT_H
#define UCI_TYPE_REFUELCOMMANDSTATUSMT_H
...
#include "RefuelCommandStatusMDT.h"
...
class RefuelCommandStatusMT : public virtual MessageType {
public:

  /** This method constructs a new RefuelCommandStatusMT.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed RefuelCommandStatusMT.
    */
  static UCI_EXPORT RefuelCommandStatusMT& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new RefuelCommandStatusMT initializing the data accessed by the new RefuelCommandStatusMT
    * using the data accessed by the specified RefuelCommandStatusMT (cloning).
    *
    * @param accessor The RefuelCommandStatusMT that provides access to the data that is to be used to initialize the data
    *      accessed by the new created RefuelCommandStatusMT.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed RefuelCommandStatusMT.
    */
  static UCI_EXPORT RefuelCommandStatusMT& create(const RefuelCommandStatusMT& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified RefuelCommandStatusMT. Use of the specified accessor after it has been destroyed
    * will result in undefined behavior.
    *
    * @param accessor The RefuelCommandStatusMT that is to be destroyed.
    */
  static UCI_EXPORT void destroy(RefuelCommandStatusMT& accessor);
  ...
  /** Returns the version that was initialized from the uci:version attribute of RefuelCommandStatusMT.
    *
    * @return The version that was initialized from the uci:version attribute of RefuelCommandStatusMT.
    */
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const RefuelCommandStatusMT& accessor) = 0;
  ...
  /** Returns a const reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual const uci::type::RefuelCommandStatusMDT& getMessageData() const = 0;
  ...
  /** Returns a reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual uci::type::RefuelCommandStatusMDT& getMessageData() = 0;
  ...
  /** Sets the complex content identified by MessageData to the contents of the complex content accessed by the specified
    ...
    */
  virtual uci::type::RefuelCommandStatusMT& setMessageData(const uci::type::RefuelCommandStatusMDT& value) = 0;

  /** The Listener provides the support to listen and handle incoming messages of the type
    * uci::type::RefuelCommandStatusMT.
    */
  ...
  public:
    ...
    /** The method is used to handle incoming messages.
      ...
      */
    virtual void handleMessage(const uci::type::RefuelCommandStatusMT& message) = 0;
  ...
  public:
    ...
    /** Adds a listener to this reader to handle incoming messages.
      ...
      */
    virtual void addListener(uci::type::RefuelCommandStatusMT::Listener& listener) = 0;

    /** Removes the specified listener from this reader.
      *
      * @param listener The listener that is to be removed from this reader.
      */
    virtual void removeListener(uci::type::RefuelCommandStatusMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s). Returns immediately if no messages are available.
      ...
      */
    virtual unsigned long readNoWait(unsigned long maxNumberOfMessages, uci::type::RefuelCommandStatusMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s).
      ...
      * @return The number of messages that were handled.
      */
    virtual unsigned long read(unsigned long timeout, unsigned long maxNumberOfMessages, uci::type::RefuelCommandStatusMT::Listener& listener) = 0;
  ...
  /** This method creates a new reader that can be used to read a RefuelCommandStatusMT.
    *
    * @param topic The specification of the topic the reader is to read from.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A reader that can read a RefuelCommandStatusMT.
    */
  static UCI_EXPORT uci::type::RefuelCommandStatusMT::Reader& createReader(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a reader. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyReader(uci::type::RefuelCommandStatusMT::Reader& reader);
  ...
  public:
    ...
    /** Writes the OMS message to the topic specified when this Writer was created.
      ...
      */
    virtual void write(uci::type::RefuelCommandStatusMT& accessor) = 0;
  ...
  /** This method creates a new writer that can be used to write a RefuelCommandStatusMT.
    *
    * @param topic The specification of the topic the writer is to write to.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A writer that can write a RefuelCommandStatusMT.
    */
  static UCI_EXPORT uci::type::RefuelCommandStatusMT::Writer& createWriter(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a writer. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyWriter(uci::type::RefuelCommandStatusMT::Writer& writer);
...
protected:
  ...
  /** The assignment operator. Sets the contents of this RefuelCommandStatusMT to the contents of the RefuelCommandStatusMT
    ...
    *      to set the contents of this RefuelCommandStatusMT.
    * @return A reference to this RefuelCommandStatusMT.
    */
  RefuelCommandStatusMT& operator=(const RefuelCommandStatusMT& rhs) {
    (void)rhs;
...
#endif // UCI_TYPE_REFUELCOMMANDSTATUSMT_H
