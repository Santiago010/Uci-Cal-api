...
#ifndef UCI_TYPE_EA_MODEENUM_H
#define UCI_TYPE_EA_MODEENUM_H
...
public:
  ...
  enum EnumerationItem {
    ...
    /** No annotation will be provided. */
    UCI_IFF_DECEPTIVE_INTERROGATOR,
  ...
  /** The assignment operator. Sets the contents of this EA_ModeEnum to the contents of the EA_ModeEnum on the right hand
    ...
    * @return A reference to this EA_ModeEnum.
    */
  EA_ModeEnum& operator=(const EA_ModeEnum& rhs) {
    setValue(rhs.getValue());
    return *this;
  }

  /** The assignment operator that sets the value of this EA_ModeEnum enumeration to the EnumerationItem on the right hand
    * side of the assignment operator.
    *
    * @param rhs The EnumerationItem whose value is to be assigned to this EA_ModeEnum enumeration.
    * @return A reference to this EA_ModeEnum enumeration.
    */
  EA_ModeEnum& operator=(EnumerationItem rhs) {
    setValue(rhs);
    return *this;
  }
  ...
  /** Sets the value of this EA_ModeEnum enumeration to the value of the specified enumeration item.
    *
    * @param item The EnumerationItem whose value is to be used to set the value of this EA_ModeEnum enumeration.
    */
  ...
  /** Tests whether the value of the specified EnumerationItem is not equal to the value of the specified EA_ModeEnum
    ...
    * @param rhs The EA_ModeEnum enumeration whose value is to be compared against the value of the specified
    *      EnumerationItem.
    * @return True if the value of the EnumerationItem (lhs) is not equal to the value of the EA_ModeEnum enumeration
    *      (rhs), false otherwise.
    */
  friend bool operator!=(EnumerationItem lhs, const EA_ModeEnum& rhs) {
    testForValidItem(lhs);
  ...
  /** Tests whether the value of the specified EnumerationItem is greater than the value of the specified EA_ModeEnum
    ...
    * @param rhs The EA_ModeEnum enumeration whose value is to be compared against the value of the specified
    *      EnumerationItem.
    * @return True if the value of the EnumerationItem (lhs) is greater than the value of the EA_ModeEnum enumeration
    *      (rhs), false otherwise.
    */
  friend bool operator>(EnumerationItem lhs, const EA_ModeEnum& rhs) {
    testForValidItem(lhs);
