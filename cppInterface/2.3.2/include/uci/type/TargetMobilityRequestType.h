/** @file TargetMobilityRequestType.h
 *
...
#ifndef UCI_TYPE_TARGETMOBILITYREQUESTTYPE_H
#define UCI_TYPE_TARGETMOBILITYREQUESTTYPE_H
...
public:
  ...
  /** This method constructs a new TargetMobilityRequestType.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed TargetMobilityRequestType.
    */
  static UCI_EXPORT TargetMobilityRequestType& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new TargetMobilityRequestType initializing the data accessed by the new
    * TargetMobilityRequestType using the data accessed by the specified TargetMobilityRequestType (cloning).
    *
    * @param accessor The TargetMobilityRequestType that provides access to the data that is to be used to initialize the
    *      data accessed by the new created TargetMobilityRequestType.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed TargetMobilityRequestType.
    */
  static UCI_EXPORT TargetMobilityRequestType& create(const TargetMobilityRequestType& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified TargetMobilityRequestType. Use of the specified accessor after it has been
    * destroyed will result in undefined behavior.
    *
    * @param accessor The TargetMobilityRequestType that is to be destroyed.
    */
  static UCI_EXPORT void destroy(TargetMobilityRequestType& accessor);
  ...
  /** Returns the version that was initialized from the uci:version attribute of TargetMobilityRequestType.
    *
    * @return The version that was initialized from the uci:version attribute of TargetMobilityRequestType.
    */
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const TargetMobilityRequestType& accessor) = 0;
  ...
  /** Sets the complex content identified by EntityID to the contents of the complex content accessed by the specified
    ...
    */
  virtual uci::type::TargetMobilityRequestType& setEntityID(const uci::type::EntityID_Type& value) = 0;
  ...
  /** Sets the complex content identified by WeatherEffects to the contents of the complex content accessed by the
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::TargetMobilityRequestType& setWeatherEffects(const uci::type::WeatherEffectsType& value) = 0;
  ...
  /** Clears (disabled) the Element identified by WeatherEffects.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::TargetMobilityRequestType& clearWeatherEffects() = 0;

  /** Returns a const reference to the accessor that provides access to the complex content identified by
    * EntityAssessmentLocation.
    *
    * @return A const reference to the accessor that provides access to the complex content identified by
    *      EntityAssessmentLocation.
    */
  virtual const uci::type::Point4D_Type& getEntityAssessmentLocation() const = 0;
  ...
  /** Returns a reference to the accessor that provides access to the complex content identified by
    ...
    *      EntityAssessmentLocation.
    */
  virtual uci::type::Point4D_Type& getEntityAssessmentLocation() = 0;

  /** Sets the complex content identified by EntityAssessmentLocation to the contents of the complex content accessed by
    * the specified accessor.
    *
    * @param value The accessor that provides access to the complex content whose contents are to be used to set the
    *      contents of the complex content identified by EntityAssessmentLocation.
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::TargetMobilityRequestType& setEntityAssessmentLocation(const uci::type::Point4D_Type& value) = 0;

  /** Returns whether the Element identified by EntityAssessmentLocation exists (is enabled) or not.
    *
    * @return A boolean indicating whether the Element identified by EntityAssessmentLocation is enabled or not.
    */
  virtual bool hasEntityAssessmentLocation() const = 0;

  /** Enables the Element identified by EntityAssessmentLocation.
    *
    * @param type = uci::base::accessorType::null This Accessor's accessor type.
    * @return A reference to the accessor that provides access to the complex content identified by
    *      EntityAssessmentLocation.
    */
  virtual uci::type::Point4D_Type& enableEntityAssessmentLocation(uci::base::accessorType::AccessorType type = uci::base::accessorType::null) = 0;

  /** Clears (disabled) the Element identified by EntityAssessmentLocation.
    *
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::TargetMobilityRequestType& clearEntityAssessmentLocation() = 0;
...
protected:
  ...
  /** The assignment operator. Sets the contents of this TargetMobilityRequestType to the contents of the
    * TargetMobilityRequestType on the right hand side (rhs) of the assignment operator [only available to derived
    * classes].
    *
    * @param rhs The TargetMobilityRequestType on the right hand side (rhs) of the assignment operator whose contents are
    *      used to set the contents of this TargetMobilityRequestType.
    * @return A reference to this TargetMobilityRequestType.
    */
  TargetMobilityRequestType& operator=(const TargetMobilityRequestType& rhs) {
    (void)rhs;
...
#endif // UCI_TYPE_TARGETMOBILITYREQUESTTYPE_H
