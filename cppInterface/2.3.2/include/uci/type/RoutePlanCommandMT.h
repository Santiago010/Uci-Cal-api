...
#ifndef UCI_TYPE_ROUTEPLANCOMMANDMT_H
#define UCI_TYPE_ROUTEPLANCOMMANDMT_H
...
class RoutePlanCommandMT : public virtual MessageType {
public:

  /** This method constructs a new RoutePlanCommandMT.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed RoutePlanCommandMT.
    */
  static UCI_EXPORT RoutePlanCommandMT& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new RoutePlanCommandMT initializing the data accessed by the new RoutePlanCommandMT using
    * the data accessed by the specified RoutePlanCommandMT (cloning).
    *
    * @param accessor The RoutePlanCommandMT that provides access to the data that is to be used to initialize the data
    *      accessed by the new created RoutePlanCommandMT.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed RoutePlanCommandMT.
    */
  static UCI_EXPORT RoutePlanCommandMT& create(const RoutePlanCommandMT& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified RoutePlanCommandMT. Use of the specified accessor after it has been destroyed will
    * result in undefined behavior.
    *
    * @param accessor The RoutePlanCommandMT that is to be destroyed.
    */
  static UCI_EXPORT void destroy(RoutePlanCommandMT& accessor);

  /** Returns this accessor's type constant, i.e. routePlanCommandMT.
    *
    * @return This accessor's type constant, i.e. routePlanCommandMT.
    */
  virtual uci::base::accessorType::AccessorType getAccessorType() const noexception {
    return uci::type::accessorType::routePlanCommandMT;
  }

  /** Returns the version that was initialized from the uci:version attribute of RoutePlanCommandMT.
    *
    * @return The version that was initialized from the uci:version attribute of RoutePlanCommandMT.
    */
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const RoutePlanCommandMT& accessor) = 0;
  ...
  /** Returns a const reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual const uci::type::RoutePlanCommandMDT& getMessageData() const = 0;
  ...
  /** Returns a reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual uci::type::RoutePlanCommandMDT& getMessageData() = 0;
  ...
  /** Sets the complex content identified by MessageData to the contents of the complex content accessed by the specified
    ...
    */
  virtual uci::type::RoutePlanCommandMT& setMessageData(const uci::type::RoutePlanCommandMDT& value) = 0;

  /** The Listener provides the support to listen and handle incoming messages of the type uci::type::RoutePlanCommandMT. */
  ...
  public:
    ...
    /** The method is used to handle incoming messages.
      ...
      */
    virtual void handleMessage(const uci::type::RoutePlanCommandMT& message) = 0;
  ...
  public:
    ...
    /** Adds a listener to this reader to handle incoming messages.
      ...
      */
    virtual void addListener(uci::type::RoutePlanCommandMT::Listener& listener) = 0;

    /** Removes the specified listener from this reader.
      *
      * @param listener The listener that is to be removed from this reader.
      */
    virtual void removeListener(uci::type::RoutePlanCommandMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s). Returns immediately if no messages are available.
      ...
      */
    virtual unsigned long readNoWait(unsigned long maxNumberOfMessages, uci::type::RoutePlanCommandMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s).
      ...
      * @return The number of messages that were handled.
      */
    virtual unsigned long read(unsigned long timeout, unsigned long maxNumberOfMessages, uci::type::RoutePlanCommandMT::Listener& listener) = 0;
  ...
  /** This method creates a new reader that can be used to read a RoutePlanCommandMT.
    *
    * @param topic The specification of the topic the reader is to read from.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A reader that can read a RoutePlanCommandMT.
    */
  static UCI_EXPORT uci::type::RoutePlanCommandMT::Reader& createReader(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a reader. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyReader(uci::type::RoutePlanCommandMT::Reader& reader);
  ...
  public:
    ...
    /** Writes the OMS message to the topic specified when this Writer was created.
      ...
      */
    virtual void write(uci::type::RoutePlanCommandMT& accessor) = 0;
  ...
  /** This method creates a new writer that can be used to write a RoutePlanCommandMT.
    *
    * @param topic The specification of the topic the writer is to write to.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A writer that can write a RoutePlanCommandMT.
    */
  static UCI_EXPORT uci::type::RoutePlanCommandMT::Writer& createWriter(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a writer. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyWriter(uci::type::RoutePlanCommandMT::Writer& writer);
...
protected:
  ...
  /** The copy constructor [only available to derived classes].
    *
    * @param rhs The RoutePlanCommandMT to copy from.
    */
  RoutePlanCommandMT(const RoutePlanCommandMT& rhs) {
    (void)rhs;
  }

  /** The assignment operator. Sets the contents of this RoutePlanCommandMT to the contents of the RoutePlanCommandMT on
    * the right hand side (rhs) of the assignment operator [only available to derived classes].
    *
    * @param rhs The RoutePlanCommandMT on the right hand side (rhs) of the assignment operator whose contents are used to
    *      set the contents of this RoutePlanCommandMT.
    * @return A reference to this RoutePlanCommandMT.
    */
  RoutePlanCommandMT& operator=(const RoutePlanCommandMT& rhs) {
    (void)rhs;
...
#endif // UCI_TYPE_ROUTEPLANCOMMANDMT_H
