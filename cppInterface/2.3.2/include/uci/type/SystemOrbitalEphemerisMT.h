/** @file SystemOrbitalEphemerisMT.h
 *
...
#ifndef UCI_TYPE_SYSTEMORBITALEPHEMERISMT_H
#define UCI_TYPE_SYSTEMORBITALEPHEMERISMT_H
...
#include "SystemOrbitalEphemerisMDT.h"
...
/** Indicates the Ephemeris ID, System's ID, the parameters used for creating the ephemeris, the ephemeris data, and the
  * Request's ID (if message is generated in response to a request).
  */
class SystemOrbitalEphemerisMT : public virtual MessageType {
public:

  /** This method constructs a new SystemOrbitalEphemerisMT.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed SystemOrbitalEphemerisMT.
    */
  static UCI_EXPORT SystemOrbitalEphemerisMT& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new SystemOrbitalEphemerisMT initializing the data accessed by the new
    * SystemOrbitalEphemerisMT using the data accessed by the specified SystemOrbitalEphemerisMT (cloning).
    *
    * @param accessor The SystemOrbitalEphemerisMT that provides access to the data that is to be used to initialize the
    *      data accessed by the new created SystemOrbitalEphemerisMT.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed SystemOrbitalEphemerisMT.
    */
  static UCI_EXPORT SystemOrbitalEphemerisMT& create(const SystemOrbitalEphemerisMT& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified SystemOrbitalEphemerisMT. Use of the specified accessor after it has been
    * destroyed will result in undefined behavior.
    *
    * @param accessor The SystemOrbitalEphemerisMT that is to be destroyed.
    */
  static UCI_EXPORT void destroy(SystemOrbitalEphemerisMT& accessor);

  /** Returns this accessor's type constant, i.e. systemOrbitalEphemerisMT.
    *
    * @return This accessor's type constant, i.e. systemOrbitalEphemerisMT.
    */
  virtual uci::base::accessorType::AccessorType getAccessorType() const noexception {
    return uci::type::accessorType::systemOrbitalEphemerisMT;
  }

  /** Returns the version that was initialized from the uci:version attribute of SystemOrbitalEphemerisMT.
    *
    * @return The version that was initialized from the uci:version attribute of SystemOrbitalEphemerisMT.
    */
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const SystemOrbitalEphemerisMT& accessor) = 0;
  ...
  /** Sets the value of the enumeration identified by ObjectState.
    ...
    */
  virtual uci::type::SystemOrbitalEphemerisMT& setObjectState(const uci::type::ObjectStateEnum& value) = 0;
  ...
  /** Sets the value of the enumeration identified by ObjectState.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::SystemOrbitalEphemerisMT& setObjectState(uci::type::ObjectStateEnum::EnumerationItem value) = 0;
  ...
  /** Clears (disabled) the Element identified by ObjectState.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::SystemOrbitalEphemerisMT& clearObjectState() = 0;
  ...
  /** Returns a const reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual const uci::type::SystemOrbitalEphemerisMDT& getMessageData() const = 0;
  ...
  /** Returns a reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual uci::type::SystemOrbitalEphemerisMDT& getMessageData() = 0;
  ...
  /** Sets the complex content identified by MessageData to the contents of the complex content accessed by the specified
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::SystemOrbitalEphemerisMT& setMessageData(const uci::type::SystemOrbitalEphemerisMDT& value) = 0;

  /** The Listener provides the support to listen and handle incoming messages of the type
    * uci::type::SystemOrbitalEphemerisMT.
    */
  ...
  public:
    ...
    /** The method is used to handle incoming messages.
      ...
      */
    virtual void handleMessage(const uci::type::SystemOrbitalEphemerisMT& message) = 0;
  ...
  public:
    ...
    /** Adds a listener to this reader to handle incoming messages.
      ...
      */
    virtual void addListener(uci::type::SystemOrbitalEphemerisMT::Listener& listener) = 0;

    /** Removes the specified listener from this reader.
      *
      * @param listener The listener that is to be removed from this reader.
      */
    virtual void removeListener(uci::type::SystemOrbitalEphemerisMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s). Returns immediately if no messages are available.
      ...
      */
    virtual unsigned long readNoWait(unsigned long maxNumberOfMessages, uci::type::SystemOrbitalEphemerisMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s).
      ...
      * @return The number of messages that were handled.
      */
    virtual unsigned long read(unsigned long timeout, unsigned long maxNumberOfMessages, uci::type::SystemOrbitalEphemerisMT::Listener& listener) = 0;
  ...
  /** This method creates a new reader that can be used to read a SystemOrbitalEphemerisMT.
    *
    * @param topic The specification of the topic the reader is to read from.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A reader that can read a SystemOrbitalEphemerisMT.
    */
  static UCI_EXPORT uci::type::SystemOrbitalEphemerisMT::Reader& createReader(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a reader. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyReader(uci::type::SystemOrbitalEphemerisMT::Reader& reader);
  ...
  public:
    ...
    /** Writes the OMS message to the topic specified when this Writer was created.
      ...
      */
    virtual void write(uci::type::SystemOrbitalEphemerisMT& accessor) = 0;
  ...
  /** This method creates a new writer that can be used to write a SystemOrbitalEphemerisMT.
    *
    * @param topic The specification of the topic the writer is to write to.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A writer that can write a SystemOrbitalEphemerisMT.
    */
  static UCI_EXPORT uci::type::SystemOrbitalEphemerisMT::Writer& createWriter(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a writer. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyWriter(uci::type::SystemOrbitalEphemerisMT::Writer& writer);
...
protected:
  ...
  /** The copy constructor [only available to derived classes].
    *
    * @param rhs The SystemOrbitalEphemerisMT to copy from.
    */
  SystemOrbitalEphemerisMT(const SystemOrbitalEphemerisMT& rhs) {
    (void)rhs;
  }

  /** The assignment operator. Sets the contents of this SystemOrbitalEphemerisMT to the contents of the
    * SystemOrbitalEphemerisMT on the right hand side (rhs) of the assignment operator [only available to derived classes].
    *
    * @param rhs The SystemOrbitalEphemerisMT on the right hand side (rhs) of the assignment operator whose contents are
    *      used to set the contents of this SystemOrbitalEphemerisMT.
    * @return A reference to this SystemOrbitalEphemerisMT.
    */
  SystemOrbitalEphemerisMT& operator=(const SystemOrbitalEphemerisMT& rhs) {
    (void)rhs;
...
#endif // UCI_TYPE_SYSTEMORBITALEPHEMERISMT_H
