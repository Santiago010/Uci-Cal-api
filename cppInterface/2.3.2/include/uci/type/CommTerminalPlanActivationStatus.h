/** @file CommTerminalPlanActivationStatus.h
 *
...
typedef uci::type::CommTerminalPlanActivationStatusMT CommTerminalPlanActivationStatus;

} // namespace type
} // namespace uci

#endif // UCI_TYPE_COMMTERMINALPLANACTIVATIONSTATUS_H
