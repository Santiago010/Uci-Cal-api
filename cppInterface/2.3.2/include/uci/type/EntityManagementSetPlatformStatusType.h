...
#ifndef UCI_TYPE_ENTITYMANAGEMENTSETPLATFORMSTATUSTYPE_H
#define UCI_TYPE_ENTITYMANAGEMENTSETPLATFORMSTATUSTYPE_H
...
public:
  ...
  /** This method constructs a new EntityManagementSetPlatformStatusType.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed EntityManagementSetPlatformStatusType.
    */
  static UCI_EXPORT EntityManagementSetPlatformStatusType& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new EntityManagementSetPlatformStatusType initializing the data accessed by the new
    * EntityManagementSetPlatformStatusType using the data accessed by the specified EntityManagementSetPlatformStatusType
    * (cloning).
    *
    * @param accessor The EntityManagementSetPlatformStatusType that provides access to the data that is to be used to
    *      initialize the data accessed by the new created EntityManagementSetPlatformStatusType.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed EntityManagementSetPlatformStatusType.
    */
  static UCI_EXPORT EntityManagementSetPlatformStatusType& create(const EntityManagementSetPlatformStatusType& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified EntityManagementSetPlatformStatusType. Use of the specified accessor after it has
    * been destroyed will result in undefined behavior.
    *
    * @param accessor The EntityManagementSetPlatformStatusType that is to be destroyed.
    */
  static UCI_EXPORT void destroy(EntityManagementSetPlatformStatusType& accessor);
  ...
  /** Returns the version that was initialized from the uci:version attribute of EntityManagementSetPlatformStatusType.
    *
    * @return The version that was initialized from the uci:version attribute of EntityManagementSetPlatformStatusType.
    */
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const EntityManagementSetPlatformStatusType& accessor) = 0;
  ...
  /** Sets the complex content identified by EntityID to the contents of the complex content accessed by the specified
    ...
    */
  virtual uci::type::EntityManagementSetPlatformStatusType& setEntityID(const uci::type::EntityID_Type& value) = 0;
  ...
  /** Sets the complex content identified by PlatformStatus to the contents of the complex content accessed by the
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::EntityManagementSetPlatformStatusType& setPlatformStatus(const uci::type::PlatformStatusType& value) = 0;
...
protected:
  ...
  /** The assignment operator. Sets the contents of this EntityManagementSetPlatformStatusType to the contents of the
    * EntityManagementSetPlatformStatusType on the right hand side (rhs) of the assignment operator [only available to
    * derived classes].
    *
    * @param rhs The EntityManagementSetPlatformStatusType on the right hand side (rhs) of the assignment operator whose
    *      contents are used to set the contents of this EntityManagementSetPlatformStatusType.
    * @return A reference to this EntityManagementSetPlatformStatusType.
    */
  EntityManagementSetPlatformStatusType& operator=(const EntityManagementSetPlatformStatusType& rhs) {
    (void)rhs;
...
#endif // UCI_TYPE_ENTITYMANAGEMENTSETPLATFORMSTATUSTYPE_H
