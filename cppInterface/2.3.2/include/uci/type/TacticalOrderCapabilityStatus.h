/** @file TacticalOrderCapabilityStatus.h
 *
...
typedef uci::type::TacticalOrderCapabilityStatusMT TacticalOrderCapabilityStatus;

} // namespace type
} // namespace uci

#endif // UCI_TYPE_TACTICALORDERCAPABILITYSTATUS_H
