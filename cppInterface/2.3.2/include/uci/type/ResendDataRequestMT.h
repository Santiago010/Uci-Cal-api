...
#ifndef UCI_TYPE_RESENDDATAREQUESTMT_H
#define UCI_TYPE_RESENDDATAREQUESTMT_H
...
#include "ResendDataRequestMDT.h"
...
class ResendDataRequestMT : public virtual MessageType {
public:

  /** This method constructs a new ResendDataRequestMT.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed ResendDataRequestMT.
    */
  static UCI_EXPORT ResendDataRequestMT& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new ResendDataRequestMT initializing the data accessed by the new ResendDataRequestMT using
    * the data accessed by the specified ResendDataRequestMT (cloning).
    *
    * @param accessor The ResendDataRequestMT that provides access to the data that is to be used to initialize the data
    *      accessed by the new created ResendDataRequestMT.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed ResendDataRequestMT.
    */
  static UCI_EXPORT ResendDataRequestMT& create(const ResendDataRequestMT& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified ResendDataRequestMT. Use of the specified accessor after it has been destroyed
    * will result in undefined behavior.
    *
    * @param accessor The ResendDataRequestMT that is to be destroyed.
    */
  static UCI_EXPORT void destroy(ResendDataRequestMT& accessor);

  /** Returns this accessor's type constant, i.e. resendDataRequestMT.
    *
    * @return This accessor's type constant, i.e. resendDataRequestMT.
    */
  virtual uci::base::accessorType::AccessorType getAccessorType() const noexception {
    return uci::type::accessorType::resendDataRequestMT;
  }

  /** Returns the version that was initialized from the uci:version attribute of ResendDataRequestMT.
    *
    * @return The version that was initialized from the uci:version attribute of ResendDataRequestMT.
    */
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const ResendDataRequestMT& accessor) = 0;
  ...
  /** Returns a const reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual const uci::type::ResendDataRequestMDT& getMessageData() const = 0;
  ...
  /** Returns a reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual uci::type::ResendDataRequestMDT& getMessageData() = 0;
  ...
  /** Sets the complex content identified by MessageData to the contents of the complex content accessed by the specified
    ...
    */
  virtual uci::type::ResendDataRequestMT& setMessageData(const uci::type::ResendDataRequestMDT& value) = 0;

  /** The Listener provides the support to listen and handle incoming messages of the type uci::type::ResendDataRequestMT. */
  ...
  public:
    ...
    /** The method is used to handle incoming messages.
      ...
      */
    virtual void handleMessage(const uci::type::ResendDataRequestMT& message) = 0;
  ...
  public:
    ...
    /** Adds a listener to this reader to handle incoming messages.
      ...
      */
    virtual void addListener(uci::type::ResendDataRequestMT::Listener& listener) = 0;

    /** Removes the specified listener from this reader.
      *
      * @param listener The listener that is to be removed from this reader.
      */
    virtual void removeListener(uci::type::ResendDataRequestMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s). Returns immediately if no messages are available.
      ...
      */
    virtual unsigned long readNoWait(unsigned long maxNumberOfMessages, uci::type::ResendDataRequestMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s).
      ...
      * @return The number of messages that were handled.
      */
    virtual unsigned long read(unsigned long timeout, unsigned long maxNumberOfMessages, uci::type::ResendDataRequestMT::Listener& listener) = 0;
  ...
  /** This method creates a new reader that can be used to read a ResendDataRequestMT.
    *
    * @param topic The specification of the topic the reader is to read from.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A reader that can read a ResendDataRequestMT.
    */
  static UCI_EXPORT uci::type::ResendDataRequestMT::Reader& createReader(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a reader. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyReader(uci::type::ResendDataRequestMT::Reader& reader);
  ...
  public:
    ...
    /** Writes the OMS message to the topic specified when this Writer was created.
      ...
      */
    virtual void write(uci::type::ResendDataRequestMT& accessor) = 0;
  ...
  /** This method creates a new writer that can be used to write a ResendDataRequestMT.
    *
    * @param topic The specification of the topic the writer is to write to.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A writer that can write a ResendDataRequestMT.
    */
  static UCI_EXPORT uci::type::ResendDataRequestMT::Writer& createWriter(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a writer. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyWriter(uci::type::ResendDataRequestMT::Writer& writer);
...
protected:
  ...
  /** The copy constructor [only available to derived classes].
    *
    * @param rhs The ResendDataRequestMT to copy from.
    */
  ResendDataRequestMT(const ResendDataRequestMT& rhs) {
    (void)rhs;
  }

  /** The assignment operator. Sets the contents of this ResendDataRequestMT to the contents of the ResendDataRequestMT on
    * the right hand side (rhs) of the assignment operator [only available to derived classes].
    *
    * @param rhs The ResendDataRequestMT on the right hand side (rhs) of the assignment operator whose contents are used to
    *      set the contents of this ResendDataRequestMT.
    * @return A reference to this ResendDataRequestMT.
    */
  ResendDataRequestMT& operator=(const ResendDataRequestMT& rhs) {
    (void)rhs;
...
#endif // UCI_TYPE_RESENDDATAREQUESTMT_H
