/** @file PlatformFunctionAirEnum.h
 *
...
#ifndef UCI_TYPE_PLATFORMFUNCTIONAIRENUM_H
#define UCI_TYPE_PLATFORMFUNCTIONAIRENUM_H
...
public:
  ...
  /** The assignment operator. Sets the contents of this PlatformFunctionAirEnum to the contents of the
    * PlatformFunctionAirEnum on the right hand side (rhs) of the assignment operator.
    *
    ...
    * @return A reference to this PlatformFunctionAirEnum.
    */
  PlatformFunctionAirEnum& operator=(const PlatformFunctionAirEnum& rhs) {
    setValue(rhs.getValue());
    return *this;
  }

  /** The assignment operator that sets the value of this PlatformFunctionAirEnum enumeration to the EnumerationItem on the
    * right hand side of the assignment operator.
    *
    * @param rhs The EnumerationItem whose value is to be assigned to this PlatformFunctionAirEnum enumeration.
    * @return A reference to this PlatformFunctionAirEnum enumeration.
    */
  PlatformFunctionAirEnum& operator=(EnumerationItem rhs) {
    setValue(rhs);
    return *this;
  }
  ...
  /** Sets the value of this PlatformFunctionAirEnum enumeration to the value of the specified enumeration item.
    *
    * @param item The EnumerationItem whose value is to be used to set the value of this PlatformFunctionAirEnum
    *      enumeration.
    */
...
#endif // UCI_TYPE_PLATFORMFUNCTIONAIRENUM_H
