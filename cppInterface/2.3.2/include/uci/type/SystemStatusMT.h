...
#ifndef UCI_TYPE_SYSTEMSTATUSMT_H
#define UCI_TYPE_SYSTEMSTATUSMT_H
...
class SystemStatusMT : public virtual MessageType {
public:

  /** This method constructs a new SystemStatusMT.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed SystemStatusMT.
    */
  static UCI_EXPORT SystemStatusMT& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new SystemStatusMT initializing the data accessed by the new SystemStatusMT using the data
    * accessed by the specified SystemStatusMT (cloning).
    *
    * @param accessor The SystemStatusMT that provides access to the data that is to be used to initialize the data
    *      accessed by the new created SystemStatusMT.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed SystemStatusMT.
    */
  static UCI_EXPORT SystemStatusMT& create(const SystemStatusMT& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified SystemStatusMT. Use of the specified accessor after it has been destroyed will
    * result in undefined behavior.
    *
    * @param accessor The SystemStatusMT that is to be destroyed.
    */
  static UCI_EXPORT void destroy(SystemStatusMT& accessor);
  ...
  /** Returns the version that was initialized from the uci:version attribute of SystemStatusMT.
    *
    * @return The version that was initialized from the uci:version attribute of SystemStatusMT.
    */
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const SystemStatusMT& accessor) = 0;
  ...
  /** Returns a const reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual const uci::type::SystemStatusMDT& getMessageData() const = 0;
  ...
  /** Returns a reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual uci::type::SystemStatusMDT& getMessageData() = 0;
  ...
  /** Sets the complex content identified by MessageData to the contents of the complex content accessed by the specified
    ...
    */
  virtual uci::type::SystemStatusMT& setMessageData(const uci::type::SystemStatusMDT& value) = 0;

  /** The Listener provides the support to listen and handle incoming messages of the type uci::type::SystemStatusMT. */
  ...
  public:
    ...
    /** The method is used to handle incoming messages.
      ...
      */
    virtual void handleMessage(const uci::type::SystemStatusMT& message) = 0;
  ...
  public:
    ...
    /** Adds a listener to this reader to handle incoming messages.
      ...
      */
    virtual void addListener(uci::type::SystemStatusMT::Listener& listener) = 0;

    /** Removes the specified listener from this reader.
      *
      * @param listener The listener that is to be removed from this reader.
      */
    virtual void removeListener(uci::type::SystemStatusMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s). Returns immediately if no messages are available.
      ...
      */
    virtual unsigned long readNoWait(unsigned long maxNumberOfMessages, uci::type::SystemStatusMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s).
      ...
      * @return The number of messages that were handled.
      */
    virtual unsigned long read(unsigned long timeout, unsigned long maxNumberOfMessages, uci::type::SystemStatusMT::Listener& listener) = 0;
  ...
  /** This method creates a new reader that can be used to read a SystemStatusMT.
    *
    * @param topic The specification of the topic the reader is to read from.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A reader that can read a SystemStatusMT.
    */
  static UCI_EXPORT uci::type::SystemStatusMT::Reader& createReader(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a reader. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyReader(uci::type::SystemStatusMT::Reader& reader);
  ...
  public:
    ...
    /** Writes the OMS message to the topic specified when this Writer was created.
      ...
      */
    virtual void write(uci::type::SystemStatusMT& accessor) = 0;
  ...
  /** This method creates a new writer that can be used to write a SystemStatusMT.
    *
    * @param topic The specification of the topic the writer is to write to.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A writer that can write a SystemStatusMT.
    */
  static UCI_EXPORT uci::type::SystemStatusMT::Writer& createWriter(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a writer. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyWriter(uci::type::SystemStatusMT::Writer& writer);
...
protected:
  ...
  /** The assignment operator. Sets the contents of this SystemStatusMT to the contents of the SystemStatusMT on the right
    ...
    *      the contents of this SystemStatusMT.
    * @return A reference to this SystemStatusMT.
    */
  SystemStatusMT& operator=(const SystemStatusMT& rhs) {
    (void)rhs;
...
#endif // UCI_TYPE_SYSTEMSTATUSMT_H
