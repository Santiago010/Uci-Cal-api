...
#ifndef UCI_TYPE_J2K_KINEMATICSTYPE_H
#define UCI_TYPE_J2K_KINEMATICSTYPE_H

#include "../base/Accessor.h"
#include "../base/export.h"
#include "CovarianceMatrixType.h"
#include "DateTimeType.h"
#include "J2K_PositionType.h"
...
class J2K_KinematicsType : public virtual uci::base::Accessor {
public:

  /** This method constructs a new J2K_KinematicsType.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed J2K_KinematicsType.
    */
  static UCI_EXPORT J2K_KinematicsType& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new J2K_KinematicsType initializing the data accessed by the new J2K_KinematicsType using
    * the data accessed by the specified J2K_KinematicsType (cloning).
    *
    * @param accessor The J2K_KinematicsType that provides access to the data that is to be used to initialize the data
    *      accessed by the new created J2K_KinematicsType.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed J2K_KinematicsType.
    */
  static UCI_EXPORT J2K_KinematicsType& create(const J2K_KinematicsType& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified J2K_KinematicsType. Use of the specified accessor after it has been destroyed will
    * result in undefined behavior.
    *
    * @param accessor The J2K_KinematicsType that is to be destroyed.
    */
  static UCI_EXPORT void destroy(J2K_KinematicsType& accessor);

  /** Returns this accessor's type constant, i.e. j2K_KinematicsType.
    *
    * @return This accessor's type constant, i.e. j2K_KinematicsType.
    */
  virtual uci::base::accessorType::AccessorType getAccessorType() const noexception {
    return uci::type::accessorType::j2K_KinematicsType;
  }

  /** Returns the version that was initialized from the uci:version attribute of J2K_KinematicsType.
    *
    * @return The version that was initialized from the uci:version attribute of J2K_KinematicsType.
    */
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const J2K_KinematicsType& accessor) = 0;
  ...
  /** Sets the value of the SimplePrimitive data type identified by Epoch.
    ...
    */
  virtual uci::type::J2K_KinematicsType& setEpoch(uci::type::DateTimeTypeValue value) = 0;
  ...
  /** Returns a const reference to the accessor that provides access to the complex content identified by Position.
    ...
    */
  virtual const uci::type::J2K_PositionType& getPosition() const = 0;
  ...
  /** Returns a reference to the accessor that provides access to the complex content identified by Position.
    ...
    */
  virtual uci::type::J2K_PositionType& getPosition() = 0;
  ...
  /** Sets the complex content identified by Position to the contents of the complex content accessed by the specified
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::J2K_KinematicsType& setPosition(const uci::type::J2K_PositionType& value) = 0;
  ...
  /** Sets the complex content identified by Velocity to the contents of the complex content accessed by the specified
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::J2K_KinematicsType& setVelocity(const uci::type::OrbitalKinematicsVelocityType& value) = 0;
  ...
  /** Sets the complex content identified by Acceleration to the contents of the complex content accessed by the specified
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::J2K_KinematicsType& setAcceleration(const uci::type::OrbitalKinematicsAccelerationType& value) = 0;
  ...
  /** Clears (disabled) the Element identified by Acceleration.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::J2K_KinematicsType& clearAcceleration() = 0;
  ...
  /** Sets the complex content identified by Attitude to the contents of the complex content accessed by the specified
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::J2K_KinematicsType& setAttitude(const uci::type::QuaternionType& value) = 0;
  ...
  /** Clears (disabled) the Element identified by Attitude.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::J2K_KinematicsType& clearAttitude() = 0;
  ...
  /** Sets the complex content identified by Covariance to the contents of the complex content accessed by the specified
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::J2K_KinematicsType& setCovariance(const uci::type::CovarianceMatrixType& value) = 0;
  ...
  /** Clears (disabled) the Element identified by Covariance.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::J2K_KinematicsType& clearCovariance() = 0;
...
protected:
  ...
  /** The copy constructor [only available to derived classes].
    ...
    */
  J2K_KinematicsType(const J2K_KinematicsType& rhs) {
    (void)rhs;
  }

  /** The assignment operator. Sets the contents of this J2K_KinematicsType to the contents of the J2K_KinematicsType on
    * the right hand side (rhs) of the assignment operator [only available to derived classes].
    *
    * @param rhs The J2K_KinematicsType on the right hand side (rhs) of the assignment operator whose contents are used to
    *      set the contents of this J2K_KinematicsType.
    * @return A reference to this J2K_KinematicsType.
    */
  J2K_KinematicsType& operator=(const J2K_KinematicsType& rhs) {
    (void)rhs;
...
#endif // UCI_TYPE_J2K_KINEMATICSTYPE_H
