...
#ifndef UCI_TYPE_COMPONENTFIELDOFREGARDTYPE_H
#define UCI_TYPE_COMPONENTFIELDOFREGARDTYPE_H
...
public:
  ...
  /** This method constructs a new ComponentFieldOfRegardType.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed ComponentFieldOfRegardType.
    */
  static UCI_EXPORT ComponentFieldOfRegardType& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new ComponentFieldOfRegardType initializing the data accessed by the new
    * ComponentFieldOfRegardType using the data accessed by the specified ComponentFieldOfRegardType (cloning).
    *
    * @param accessor The ComponentFieldOfRegardType that provides access to the data that is to be used to initialize the
    *      data accessed by the new created ComponentFieldOfRegardType.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed ComponentFieldOfRegardType.
    */
  static UCI_EXPORT ComponentFieldOfRegardType& create(const ComponentFieldOfRegardType& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified ComponentFieldOfRegardType. Use of the specified accessor after it has been
    * destroyed will result in undefined behavior.
    *
    * @param accessor The ComponentFieldOfRegardType that is to be destroyed.
    */
  static UCI_EXPORT void destroy(ComponentFieldOfRegardType& accessor);
  ...
  /** Returns the version that was initialized from the uci:version attribute of ComponentFieldOfRegardType.
    *
    * @return The version that was initialized from the uci:version attribute of ComponentFieldOfRegardType.
    */
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const ComponentFieldOfRegardType& accessor) = 0;
  ...
  /** Sets the complex content identified by ComponentID to the contents of the complex content accessed by the specified
    ...
    */
  virtual uci::type::ComponentFieldOfRegardType& setComponentID(const uci::type::ComponentID_Type& value) = 0;
  ...
  /** Sets the complex content identified by FieldOfRegard to the contents of the complex content accessed by the specified
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::ComponentFieldOfRegardType& setFieldOfRegard(const uci::type::FieldOfRegardType& value) = 0;
...
protected:
  ...
  /** The assignment operator. Sets the contents of this ComponentFieldOfRegardType to the contents of the
    * ComponentFieldOfRegardType on the right hand side (rhs) of the assignment operator [only available to derived
    * classes].
    *
    * @param rhs The ComponentFieldOfRegardType on the right hand side (rhs) of the assignment operator whose contents are
    *      used to set the contents of this ComponentFieldOfRegardType.
    * @return A reference to this ComponentFieldOfRegardType.
    */
  ComponentFieldOfRegardType& operator=(const ComponentFieldOfRegardType& rhs) {
    (void)rhs;
...
#endif // UCI_TYPE_COMPONENTFIELDOFREGARDTYPE_H
