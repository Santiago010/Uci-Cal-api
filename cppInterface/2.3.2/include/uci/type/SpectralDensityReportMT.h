/** @file SpectralDensityReportMT.h
 *
...
#ifndef UCI_TYPE_SPECTRALDENSITYREPORTMT_H
#define UCI_TYPE_SPECTRALDENSITYREPORTMT_H
...
#include "SpectralDensityReportMDT.h"
...
class SpectralDensityReportMT : public virtual MessageType {
public:

  /** This method constructs a new SpectralDensityReportMT.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed SpectralDensityReportMT.
    */
  static UCI_EXPORT SpectralDensityReportMT& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new SpectralDensityReportMT initializing the data accessed by the new
    * SpectralDensityReportMT using the data accessed by the specified SpectralDensityReportMT (cloning).
    *
    * @param accessor The SpectralDensityReportMT that provides access to the data that is to be used to initialize the
    *      data accessed by the new created SpectralDensityReportMT.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed SpectralDensityReportMT.
    */
  static UCI_EXPORT SpectralDensityReportMT& create(const SpectralDensityReportMT& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified SpectralDensityReportMT. Use of the specified accessor after it has been destroyed
    * will result in undefined behavior.
    *
    * @param accessor The SpectralDensityReportMT that is to be destroyed.
    */
  static UCI_EXPORT void destroy(SpectralDensityReportMT& accessor);
  ...
  /** Returns the version that was initialized from the uci:version attribute of SpectralDensityReportMT.
    *
    * @return The version that was initialized from the uci:version attribute of SpectralDensityReportMT.
    */
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const SpectralDensityReportMT& accessor) = 0;
  ...
  /** Sets the value of the enumeration identified by ObjectState.
    ...
    */
  virtual uci::type::SpectralDensityReportMT& setObjectState(const uci::type::ObjectStateEnum& value) = 0;
  ...
  /** Sets the value of the enumeration identified by ObjectState.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::SpectralDensityReportMT& setObjectState(uci::type::ObjectStateEnum::EnumerationItem value) = 0;
  ...
  /** Clears (disabled) the Element identified by ObjectState.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::SpectralDensityReportMT& clearObjectState() = 0;
  ...
  /** Returns a const reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual const uci::type::SpectralDensityReportMDT& getMessageData() const = 0;
  ...
  /** Returns a reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual uci::type::SpectralDensityReportMDT& getMessageData() = 0;
  ...
  /** Sets the complex content identified by MessageData to the contents of the complex content accessed by the specified
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::SpectralDensityReportMT& setMessageData(const uci::type::SpectralDensityReportMDT& value) = 0;

  /** The Listener provides the support to listen and handle incoming messages of the type
    * uci::type::SpectralDensityReportMT.
    */
  ...
  public:
    ...
    /** The method is used to handle incoming messages.
      ...
      */
    virtual void handleMessage(const uci::type::SpectralDensityReportMT& message) = 0;
  ...
  public:
    ...
    /** Adds a listener to this reader to handle incoming messages.
      ...
      */
    virtual void addListener(uci::type::SpectralDensityReportMT::Listener& listener) = 0;

    /** Removes the specified listener from this reader.
      *
      * @param listener The listener that is to be removed from this reader.
      */
    virtual void removeListener(uci::type::SpectralDensityReportMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s). Returns immediately if no messages are available.
      ...
      */
    virtual unsigned long readNoWait(unsigned long maxNumberOfMessages, uci::type::SpectralDensityReportMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s).
      ...
      * @return The number of messages that were handled.
      */
    virtual unsigned long read(unsigned long timeout, unsigned long maxNumberOfMessages, uci::type::SpectralDensityReportMT::Listener& listener) = 0;
  ...
  /** This method creates a new reader that can be used to read a SpectralDensityReportMT.
    *
    * @param topic The specification of the topic the reader is to read from.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A reader that can read a SpectralDensityReportMT.
    */
  static UCI_EXPORT uci::type::SpectralDensityReportMT::Reader& createReader(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a reader. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyReader(uci::type::SpectralDensityReportMT::Reader& reader);
  ...
  public:
    ...
    /** Writes the OMS message to the topic specified when this Writer was created.
      ...
      */
    virtual void write(uci::type::SpectralDensityReportMT& accessor) = 0;
  ...
  /** This method creates a new writer that can be used to write a SpectralDensityReportMT.
    *
    * @param topic The specification of the topic the writer is to write to.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A writer that can write a SpectralDensityReportMT.
    */
  static UCI_EXPORT uci::type::SpectralDensityReportMT::Writer& createWriter(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a writer. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyWriter(uci::type::SpectralDensityReportMT::Writer& writer);
...
protected:
  ...
  /** The assignment operator. Sets the contents of this SpectralDensityReportMT to the contents of the
    * SpectralDensityReportMT on the right hand side (rhs) of the assignment operator [only available to derived classes].
    *
    * @param rhs The SpectralDensityReportMT on the right hand side (rhs) of the assignment operator whose contents are
    *      used to set the contents of this SpectralDensityReportMT.
    * @return A reference to this SpectralDensityReportMT.
    */
  SpectralDensityReportMT& operator=(const SpectralDensityReportMT& rhs) {
    (void)rhs;
...
#endif // UCI_TYPE_SPECTRALDENSITYREPORTMT_H
