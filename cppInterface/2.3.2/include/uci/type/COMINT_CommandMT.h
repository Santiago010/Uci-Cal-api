...
#ifndef UCI_TYPE_COMINT_COMMANDMT_H
#define UCI_TYPE_COMINT_COMMANDMT_H

#include "../base/Listener.h"
#include "../base/Reader.h"
#include "../base/Writer.h"
#include "../base/export.h"
#include "COMINT_CommandMDT.h"
...
class COMINT_CommandMT : public virtual MessageType {
public:

  /** This method constructs a new COMINT_CommandMT.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed COMINT_CommandMT.
    */
  static UCI_EXPORT COMINT_CommandMT& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new COMINT_CommandMT initializing the data accessed by the new COMINT_CommandMT using the
    * data accessed by the specified COMINT_CommandMT (cloning).
    *
    * @param accessor The COMINT_CommandMT that provides access to the data that is to be used to initialize the data
    *      accessed by the new created COMINT_CommandMT.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed COMINT_CommandMT.
    */
  static UCI_EXPORT COMINT_CommandMT& create(const COMINT_CommandMT& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified COMINT_CommandMT. Use of the specified accessor after it has been destroyed will
    * result in undefined behavior.
    *
    * @param accessor The COMINT_CommandMT that is to be destroyed.
    */
  static UCI_EXPORT void destroy(COMINT_CommandMT& accessor);
  ...
  /** Returns the version that was initialized from the uci:version attribute of COMINT_CommandMT.
    *
    * @return The version that was initialized from the uci:version attribute of COMINT_CommandMT.
    */
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const COMINT_CommandMT& accessor) = 0;
  ...
  /** Returns a const reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual const uci::type::COMINT_CommandMDT& getMessageData() const = 0;
  ...
  /** Returns a reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual uci::type::COMINT_CommandMDT& getMessageData() = 0;
  ...
  /** Sets the complex content identified by MessageData to the contents of the complex content accessed by the specified
    ...
    */
  virtual uci::type::COMINT_CommandMT& setMessageData(const uci::type::COMINT_CommandMDT& value) = 0;

  /** The Listener provides the support to listen and handle incoming messages of the type uci::type::COMINT_CommandMT. */
  ...
  public:
    ...
    /** The method is used to handle incoming messages.
      ...
      */
    virtual void handleMessage(const uci::type::COMINT_CommandMT& message) = 0;
  ...
  public:
    ...
    /** Adds a listener to this reader to handle incoming messages.
      ...
      */
    virtual void addListener(uci::type::COMINT_CommandMT::Listener& listener) = 0;

    /** Removes the specified listener from this reader.
      *
      * @param listener The listener that is to be removed from this reader.
      */
    virtual void removeListener(uci::type::COMINT_CommandMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s). Returns immediately if no messages are available.
      ...
      */
    virtual unsigned long readNoWait(unsigned long maxNumberOfMessages, uci::type::COMINT_CommandMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s).
      ...
      * @return The number of messages that were handled.
      */
    virtual unsigned long read(unsigned long timeout, unsigned long maxNumberOfMessages, uci::type::COMINT_CommandMT::Listener& listener) = 0;
  ...
  /** This method creates a new reader that can be used to read a COMINT_CommandMT.
    *
    * @param topic The specification of the topic the reader is to read from.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A reader that can read a COMINT_CommandMT.
    */
  static UCI_EXPORT uci::type::COMINT_CommandMT::Reader& createReader(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a reader. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyReader(uci::type::COMINT_CommandMT::Reader& reader);
  ...
  public:
    ...
    /** Writes the OMS message to the topic specified when this Writer was created.
      ...
      */
    virtual void write(uci::type::COMINT_CommandMT& accessor) = 0;
  ...
  /** This method creates a new writer that can be used to write a COMINT_CommandMT.
    *
    * @param topic The specification of the topic the writer is to write to.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A writer that can write a COMINT_CommandMT.
    */
  static UCI_EXPORT uci::type::COMINT_CommandMT::Writer& createWriter(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a writer. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyWriter(uci::type::COMINT_CommandMT::Writer& writer);
...
protected:
  ...
  /** The assignment operator. Sets the contents of this COMINT_CommandMT to the contents of the COMINT_CommandMT on the
    ...
    *      set the contents of this COMINT_CommandMT.
    * @return A reference to this COMINT_CommandMT.
    */
  COMINT_CommandMT& operator=(const COMINT_CommandMT& rhs) {
    (void)rhs;
...
#endif // UCI_TYPE_COMINT_COMMANDMT_H
