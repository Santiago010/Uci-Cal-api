...
#ifndef UCI_TYPE_ORBITMETRICSREQUESTMT_H
#define UCI_TYPE_ORBITMETRICSREQUESTMT_H
...
#include "OrbitMetricsRequestMDT.h"
...
class OrbitMetricsRequestMT : public virtual MessageType {
public:

  /** This method constructs a new OrbitMetricsRequestMT.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed OrbitMetricsRequestMT.
    */
  static UCI_EXPORT OrbitMetricsRequestMT& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new OrbitMetricsRequestMT initializing the data accessed by the new OrbitMetricsRequestMT
    * using the data accessed by the specified OrbitMetricsRequestMT (cloning).
    *
    * @param accessor The OrbitMetricsRequestMT that provides access to the data that is to be used to initialize the data
    *      accessed by the new created OrbitMetricsRequestMT.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed OrbitMetricsRequestMT.
    */
  static UCI_EXPORT OrbitMetricsRequestMT& create(const OrbitMetricsRequestMT& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified OrbitMetricsRequestMT. Use of the specified accessor after it has been destroyed
    * will result in undefined behavior.
    *
    * @param accessor The OrbitMetricsRequestMT that is to be destroyed.
    */
  static UCI_EXPORT void destroy(OrbitMetricsRequestMT& accessor);

  /** Returns this accessor's type constant, i.e. orbitMetricsRequestMT.
    *
    * @return This accessor's type constant, i.e. orbitMetricsRequestMT.
    */
  virtual uci::base::accessorType::AccessorType getAccessorType() const noexception {
    return uci::type::accessorType::orbitMetricsRequestMT;
  }

  /** Returns the version that was initialized from the uci:version attribute of OrbitMetricsRequestMT.
    *
    * @return The version that was initialized from the uci:version attribute of OrbitMetricsRequestMT.
    */
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const OrbitMetricsRequestMT& accessor) = 0;
  ...
  /** Returns a const reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual const uci::type::OrbitMetricsRequestMDT& getMessageData() const = 0;
  ...
  /** Returns a reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual uci::type::OrbitMetricsRequestMDT& getMessageData() = 0;
  ...
  /** Sets the complex content identified by MessageData to the contents of the complex content accessed by the specified
    ...
    */
  virtual uci::type::OrbitMetricsRequestMT& setMessageData(const uci::type::OrbitMetricsRequestMDT& value) = 0;

  /** The Listener provides the support to listen and handle incoming messages of the type
    * uci::type::OrbitMetricsRequestMT.
    */
  ...
  public:
    ...
    /** The method is used to handle incoming messages.
      ...
      */
    virtual void handleMessage(const uci::type::OrbitMetricsRequestMT& message) = 0;
  ...
  public:
    ...
    /** Adds a listener to this reader to handle incoming messages.
      ...
      */
    virtual void addListener(uci::type::OrbitMetricsRequestMT::Listener& listener) = 0;

    /** Removes the specified listener from this reader.
      *
      * @param listener The listener that is to be removed from this reader.
      */
    virtual void removeListener(uci::type::OrbitMetricsRequestMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s). Returns immediately if no messages are available.
      ...
      */
    virtual unsigned long readNoWait(unsigned long maxNumberOfMessages, uci::type::OrbitMetricsRequestMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s).
      ...
      * @return The number of messages that were handled.
      */
    virtual unsigned long read(unsigned long timeout, unsigned long maxNumberOfMessages, uci::type::OrbitMetricsRequestMT::Listener& listener) = 0;
  ...
  /** This method creates a new reader that can be used to read a OrbitMetricsRequestMT.
    *
    * @param topic The specification of the topic the reader is to read from.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A reader that can read a OrbitMetricsRequestMT.
    */
  static UCI_EXPORT uci::type::OrbitMetricsRequestMT::Reader& createReader(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a reader. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyReader(uci::type::OrbitMetricsRequestMT::Reader& reader);
  ...
  public:
    ...
    /** Writes the OMS message to the topic specified when this Writer was created.
      ...
      */
    virtual void write(uci::type::OrbitMetricsRequestMT& accessor) = 0;
  ...
  /** This method creates a new writer that can be used to write a OrbitMetricsRequestMT.
    *
    * @param topic The specification of the topic the writer is to write to.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A writer that can write a OrbitMetricsRequestMT.
    */
  static UCI_EXPORT uci::type::OrbitMetricsRequestMT::Writer& createWriter(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a writer. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyWriter(uci::type::OrbitMetricsRequestMT::Writer& writer);
...
protected:
  ...
  /** The copy constructor [only available to derived classes].
    *
    * @param rhs The OrbitMetricsRequestMT to copy from.
    */
  OrbitMetricsRequestMT(const OrbitMetricsRequestMT& rhs) {
    (void)rhs;
  }

  /** The assignment operator. Sets the contents of this OrbitMetricsRequestMT to the contents of the OrbitMetricsRequestMT
    * on the right hand side (rhs) of the assignment operator [only available to derived classes].
    *
    * @param rhs The OrbitMetricsRequestMT on the right hand side (rhs) of the assignment operator whose contents are used
    *      to set the contents of this OrbitMetricsRequestMT.
    * @return A reference to this OrbitMetricsRequestMT.
    */
  OrbitMetricsRequestMT& operator=(const OrbitMetricsRequestMT& rhs) {
    (void)rhs;
...
#endif // UCI_TYPE_ORBITMETRICSREQUESTMT_H
