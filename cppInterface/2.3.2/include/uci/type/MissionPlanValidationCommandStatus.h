/** @file MissionPlanValidationCommandStatus.h
 *
...
typedef uci::type::MissionPlanValidationCommandStatusMT MissionPlanValidationCommandStatus;

} // namespace type
} // namespace uci

#endif // UCI_TYPE_MISSIONPLANVALIDATIONCOMMANDSTATUS_H
