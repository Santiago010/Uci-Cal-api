...
#ifndef UCI_TYPE_GENERICUNITTYPEENUM_H
#define UCI_TYPE_GENERICUNITTYPEENUM_H
...
public:
  ...
  /** The assignment operator. Sets the contents of this GenericUnitTypeEnum to the contents of the GenericUnitTypeEnum on
    ...
    * @return A reference to this GenericUnitTypeEnum.
    */
  GenericUnitTypeEnum& operator=(const GenericUnitTypeEnum& rhs) {
    setValue(rhs.getValue());
    return *this;
  }

  /** The assignment operator that sets the value of this GenericUnitTypeEnum enumeration to the EnumerationItem on the
    * right hand side of the assignment operator.
    *
    * @param rhs The EnumerationItem whose value is to be assigned to this GenericUnitTypeEnum enumeration.
    * @return A reference to this GenericUnitTypeEnum enumeration.
    */
  GenericUnitTypeEnum& operator=(EnumerationItem rhs) {
    setValue(rhs);
    return *this;
  }
  ...
  /** Sets the value of this GenericUnitTypeEnum enumeration to the value of the specified enumeration item.
    *
    * @param item The EnumerationItem whose value is to be used to set the value of this GenericUnitTypeEnum enumeration.
    */
  ...
  /** Tests whether the value of this GenericUnitTypeEnum enumeration is less than the value of the specified
    ...
    * @param rhs The EnumerationItem whose value is to be compared against the value of this GenericUnitTypeEnum
    *      enumeration.
    * @return True if the value of the EnumerationItem (rhs) is less than the value of this GenericUnitTypeEnum
    *      enumeration, false otherwise.
    */
  bool operator<(EnumerationItem rhs) const {
    testForValidItem(rhs);
...
#endif // UCI_TYPE_GENERICUNITTYPEENUM_H
