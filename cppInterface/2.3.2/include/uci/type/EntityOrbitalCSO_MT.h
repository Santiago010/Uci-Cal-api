...
#ifndef UCI_TYPE_ENTITYORBITALCSO_MT_H
#define UCI_TYPE_ENTITYORBITALCSO_MT_H

#include "../base/Listener.h"
#include "../base/Reader.h"
#include "../base/Writer.h"
#include "../base/export.h"
#include "EntityOrbitalCSO_MDT.h"
...
/** This type indicates the ID of the CSO, the state of the CSO, the IDs of the primary object and the secondary object,
  * the Operator's ID, and details of CSO.
  */
class EntityOrbitalCSO_MT : public virtual MessageType {
public:

  /** This method constructs a new EntityOrbitalCSO_MT.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed EntityOrbitalCSO_MT.
    */
  static UCI_EXPORT EntityOrbitalCSO_MT& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new EntityOrbitalCSO_MT initializing the data accessed by the new EntityOrbitalCSO_MT using
    * the data accessed by the specified EntityOrbitalCSO_MT (cloning).
    *
    * @param accessor The EntityOrbitalCSO_MT that provides access to the data that is to be used to initialize the data
    *      accessed by the new created EntityOrbitalCSO_MT.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed EntityOrbitalCSO_MT.
    */
  static UCI_EXPORT EntityOrbitalCSO_MT& create(const EntityOrbitalCSO_MT& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified EntityOrbitalCSO_MT. Use of the specified accessor after it has been destroyed
    * will result in undefined behavior.
    *
    * @param accessor The EntityOrbitalCSO_MT that is to be destroyed.
    */
  static UCI_EXPORT void destroy(EntityOrbitalCSO_MT& accessor);

  /** Returns this accessor's type constant, i.e. entityOrbitalCSO_MT.
    *
    * @return This accessor's type constant, i.e. entityOrbitalCSO_MT.
    */
  virtual uci::base::accessorType::AccessorType getAccessorType() const noexception {
    return uci::type::accessorType::entityOrbitalCSO_MT;
  }

  /** Returns the version that was initialized from the uci:version attribute of EntityOrbitalCSO_MT.
    *
    * @return The version that was initialized from the uci:version attribute of EntityOrbitalCSO_MT.
    */
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const EntityOrbitalCSO_MT& accessor) = 0;
  ...
  /** Sets the value of the enumeration identified by ObjectState.
    ...
    */
  virtual uci::type::EntityOrbitalCSO_MT& setObjectState(const uci::type::ObjectStateEnum& value) = 0;
  ...
  /** Sets the value of the enumeration identified by ObjectState.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::EntityOrbitalCSO_MT& setObjectState(uci::type::ObjectStateEnum::EnumerationItem value) = 0;
  ...
  /** Clears (disabled) the Element identified by ObjectState.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::EntityOrbitalCSO_MT& clearObjectState() = 0;
  ...
  /** Returns a const reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual const uci::type::EntityOrbitalCSO_MDT& getMessageData() const = 0;
  ...
  /** Returns a reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual uci::type::EntityOrbitalCSO_MDT& getMessageData() = 0;
  ...
  /** Sets the complex content identified by MessageData to the contents of the complex content accessed by the specified
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::EntityOrbitalCSO_MT& setMessageData(const uci::type::EntityOrbitalCSO_MDT& value) = 0;

  /** The Listener provides the support to listen and handle incoming messages of the type uci::type::EntityOrbitalCSO_MT. */
  ...
  public:
    ...
    /** The method is used to handle incoming messages.
      ...
      */
    virtual void handleMessage(const uci::type::EntityOrbitalCSO_MT& message) = 0;
  ...
  public:
    ...
    /** Adds a listener to this reader to handle incoming messages.
      ...
      */
    virtual void addListener(uci::type::EntityOrbitalCSO_MT::Listener& listener) = 0;

    /** Removes the specified listener from this reader.
      *
      * @param listener The listener that is to be removed from this reader.
      */
    virtual void removeListener(uci::type::EntityOrbitalCSO_MT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s). Returns immediately if no messages are available.
      ...
      */
    virtual unsigned long readNoWait(unsigned long maxNumberOfMessages, uci::type::EntityOrbitalCSO_MT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s).
      ...
      * @return The number of messages that were handled.
      */
    virtual unsigned long read(unsigned long timeout, unsigned long maxNumberOfMessages, uci::type::EntityOrbitalCSO_MT::Listener& listener) = 0;
  ...
  /** This method creates a new reader that can be used to read a EntityOrbitalCSO_MT.
    *
    * @param topic The specification of the topic the reader is to read from.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A reader that can read a EntityOrbitalCSO_MT.
    */
  static UCI_EXPORT uci::type::EntityOrbitalCSO_MT::Reader& createReader(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a reader. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyReader(uci::type::EntityOrbitalCSO_MT::Reader& reader);
  ...
  public:
    ...
    /** Writes the OMS message to the topic specified when this Writer was created.
      ...
      */
    virtual void write(uci::type::EntityOrbitalCSO_MT& accessor) = 0;
  ...
  /** This method creates a new writer that can be used to write a EntityOrbitalCSO_MT.
    *
    * @param topic The specification of the topic the writer is to write to.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A writer that can write a EntityOrbitalCSO_MT.
    */
  static UCI_EXPORT uci::type::EntityOrbitalCSO_MT::Writer& createWriter(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a writer. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyWriter(uci::type::EntityOrbitalCSO_MT::Writer& writer);
...
protected:
  ...
  /** The copy constructor [only available to derived classes].
    *
    * @param rhs The EntityOrbitalCSO_MT to copy from.
    */
  EntityOrbitalCSO_MT(const EntityOrbitalCSO_MT& rhs) {
    (void)rhs;
  }

  /** The assignment operator. Sets the contents of this EntityOrbitalCSO_MT to the contents of the EntityOrbitalCSO_MT on
    * the right hand side (rhs) of the assignment operator [only available to derived classes].
    *
    * @param rhs The EntityOrbitalCSO_MT on the right hand side (rhs) of the assignment operator whose contents are used to
    *      set the contents of this EntityOrbitalCSO_MT.
    * @return A reference to this EntityOrbitalCSO_MT.
    */
  EntityOrbitalCSO_MT& operator=(const EntityOrbitalCSO_MT& rhs) {
    (void)rhs;
...
#endif // UCI_TYPE_ENTITYORBITALCSO_MT_H
