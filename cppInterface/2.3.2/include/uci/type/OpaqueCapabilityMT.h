...
#ifndef UCI_TYPE_OPAQUECAPABILITYMT_H
#define UCI_TYPE_OPAQUECAPABILITYMT_H
...
class OpaqueCapabilityMT : public virtual MessageType {
public:

  /** This method constructs a new OpaqueCapabilityMT.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed OpaqueCapabilityMT.
    */
  static UCI_EXPORT OpaqueCapabilityMT& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new OpaqueCapabilityMT initializing the data accessed by the new OpaqueCapabilityMT using
    * the data accessed by the specified OpaqueCapabilityMT (cloning).
    *
    * @param accessor The OpaqueCapabilityMT that provides access to the data that is to be used to initialize the data
    *      accessed by the new created OpaqueCapabilityMT.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed OpaqueCapabilityMT.
    */
  static UCI_EXPORT OpaqueCapabilityMT& create(const OpaqueCapabilityMT& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified OpaqueCapabilityMT. Use of the specified accessor after it has been destroyed will
    * result in undefined behavior.
    *
    * @param accessor The OpaqueCapabilityMT that is to be destroyed.
    */
  static UCI_EXPORT void destroy(OpaqueCapabilityMT& accessor);

  /** Returns this accessor's type constant, i.e. opaqueCapabilityMT.
    *
    * @return This accessor's type constant, i.e. opaqueCapabilityMT.
    */
  virtual uci::base::accessorType::AccessorType getAccessorType() const noexception {
    return uci::type::accessorType::opaqueCapabilityMT;
  }

  /** Returns the version that was initialized from the uci:version attribute of OpaqueCapabilityMT.
    *
    * @return The version that was initialized from the uci:version attribute of OpaqueCapabilityMT.
    */
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const OpaqueCapabilityMT& accessor) = 0;
  ...
  /** Sets the value of the enumeration identified by ObjectState.
    ...
    */
  virtual uci::type::OpaqueCapabilityMT& setObjectState(const uci::type::ObjectStateEnum& value) = 0;
  ...
  /** Sets the value of the enumeration identified by ObjectState.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::OpaqueCapabilityMT& setObjectState(uci::type::ObjectStateEnum::EnumerationItem value) = 0;
  ...
  /** Clears (disabled) the Element identified by ObjectState.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::OpaqueCapabilityMT& clearObjectState() = 0;
  ...
  /** Returns a const reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual const uci::type::OpaqueCapabilityMDT& getMessageData() const = 0;
  ...
  /** Returns a reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual uci::type::OpaqueCapabilityMDT& getMessageData() = 0;
  ...
  /** Sets the complex content identified by MessageData to the contents of the complex content accessed by the specified
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::OpaqueCapabilityMT& setMessageData(const uci::type::OpaqueCapabilityMDT& value) = 0;

  /** The Listener provides the support to listen and handle incoming messages of the type uci::type::OpaqueCapabilityMT. */
  ...
  public:
    ...
    /** The method is used to handle incoming messages.
      ...
      */
    virtual void handleMessage(const uci::type::OpaqueCapabilityMT& message) = 0;
  ...
  public:
    ...
    /** Adds a listener to this reader to handle incoming messages.
      ...
      */
    virtual void addListener(uci::type::OpaqueCapabilityMT::Listener& listener) = 0;

    /** Removes the specified listener from this reader.
      *
      * @param listener The listener that is to be removed from this reader.
      */
    virtual void removeListener(uci::type::OpaqueCapabilityMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s). Returns immediately if no messages are available.
      ...
      */
    virtual unsigned long readNoWait(unsigned long maxNumberOfMessages, uci::type::OpaqueCapabilityMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s).
      ...
      * @return The number of messages that were handled.
      */
    virtual unsigned long read(unsigned long timeout, unsigned long maxNumberOfMessages, uci::type::OpaqueCapabilityMT::Listener& listener) = 0;
  ...
  /** This method creates a new reader that can be used to read a OpaqueCapabilityMT.
    *
    * @param topic The specification of the topic the reader is to read from.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A reader that can read a OpaqueCapabilityMT.
    */
  static UCI_EXPORT uci::type::OpaqueCapabilityMT::Reader& createReader(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a reader. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyReader(uci::type::OpaqueCapabilityMT::Reader& reader);
  ...
  public:
    ...
    /** Writes the OMS message to the topic specified when this Writer was created.
      ...
      */
    virtual void write(uci::type::OpaqueCapabilityMT& accessor) = 0;
  ...
  /** This method creates a new writer that can be used to write a OpaqueCapabilityMT.
    *
    * @param topic The specification of the topic the writer is to write to.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A writer that can write a OpaqueCapabilityMT.
    */
  static UCI_EXPORT uci::type::OpaqueCapabilityMT::Writer& createWriter(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a writer. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyWriter(uci::type::OpaqueCapabilityMT::Writer& writer);
...
protected:
  ...
  /** The copy constructor [only available to derived classes].
    *
    * @param rhs The OpaqueCapabilityMT to copy from.
    */
  OpaqueCapabilityMT(const OpaqueCapabilityMT& rhs) {
    (void)rhs;
  }

  /** The assignment operator. Sets the contents of this OpaqueCapabilityMT to the contents of the OpaqueCapabilityMT on
    * the right hand side (rhs) of the assignment operator [only available to derived classes].
    *
    * @param rhs The OpaqueCapabilityMT on the right hand side (rhs) of the assignment operator whose contents are used to
    *      set the contents of this OpaqueCapabilityMT.
    * @return A reference to this OpaqueCapabilityMT.
    */
  OpaqueCapabilityMT& operator=(const OpaqueCapabilityMT& rhs) {
    (void)rhs;
...
#endif // UCI_TYPE_OPAQUECAPABILITYMT_H
