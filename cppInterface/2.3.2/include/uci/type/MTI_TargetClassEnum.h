...
#ifndef UCI_TYPE_MTI_TARGETCLASSENUM_H
#define UCI_TYPE_MTI_TARGETCLASSENUM_H
...
public:
  ...
  enum EnumerationItem {
    ...
    /** Small-sized targets. Specific target size values are defined outside of this schema. */
    UCI_SMALL,

    /** Medium-sized targets. Specific target size values are defined outside of this schema. */
    UCI_MEDIUM,

    /** Large-sized targets. Specific target size values are defined outside of this schema. */
    UCI_LARGE,
  ...
  /** The assignment operator. Sets the contents of this MTI_TargetClassEnum to the contents of the MTI_TargetClassEnum on
    ...
    * @return A reference to this MTI_TargetClassEnum.
    */
  MTI_TargetClassEnum& operator=(const MTI_TargetClassEnum& rhs) {
    setValue(rhs.getValue());
    return *this;
  }

  /** The assignment operator that sets the value of this MTI_TargetClassEnum enumeration to the EnumerationItem on the
    * right hand side of the assignment operator.
    *
    * @param rhs The EnumerationItem whose value is to be assigned to this MTI_TargetClassEnum enumeration.
    * @return A reference to this MTI_TargetClassEnum enumeration.
    */
  MTI_TargetClassEnum& operator=(EnumerationItem rhs) {
    setValue(rhs);
    return *this;
  }
  ...
  /** Sets the value of this MTI_TargetClassEnum enumeration to the value of the specified enumeration item.
    *
    * @param item The EnumerationItem whose value is to be used to set the value of this MTI_TargetClassEnum enumeration.
    */
  ...
  /** Tests whether the value of this MTI_TargetClassEnum enumeration is less than the value of the specified
    ...
    * @param rhs The EnumerationItem whose value is to be compared against the value of this MTI_TargetClassEnum
    *      enumeration.
    * @return True if the value of the EnumerationItem (rhs) is less than the value of this MTI_TargetClassEnum
    *      enumeration, false otherwise.
    */
  bool operator<(EnumerationItem rhs) const {
    testForValidItem(rhs);
...
#endif // UCI_TYPE_MTI_TARGETCLASSENUM_H
