...
#ifndef UCI_TYPE_RDMA_INITIALIZESETUPMT_H
#define UCI_TYPE_RDMA_INITIALIZESETUPMT_H
...
#include "RDMA_InitializeSetupMDT.h"
...
class RDMA_InitializeSetupMT : public virtual MessageType {
public:

  /** This method constructs a new RDMA_InitializeSetupMT.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed RDMA_InitializeSetupMT.
    */
  static UCI_EXPORT RDMA_InitializeSetupMT& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new RDMA_InitializeSetupMT initializing the data accessed by the new RDMA_InitializeSetupMT
    * using the data accessed by the specified RDMA_InitializeSetupMT (cloning).
    *
    * @param accessor The RDMA_InitializeSetupMT that provides access to the data that is to be used to initialize the data
    *      accessed by the new created RDMA_InitializeSetupMT.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed RDMA_InitializeSetupMT.
    */
  static UCI_EXPORT RDMA_InitializeSetupMT& create(const RDMA_InitializeSetupMT& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified RDMA_InitializeSetupMT. Use of the specified accessor after it has been destroyed
    * will result in undefined behavior.
    *
    * @param accessor The RDMA_InitializeSetupMT that is to be destroyed.
    */
  static UCI_EXPORT void destroy(RDMA_InitializeSetupMT& accessor);

  /** Returns this accessor's type constant, i.e. rDMA_InitializeSetupMT.
    *
    * @return This accessor's type constant, i.e. rDMA_InitializeSetupMT.
    */
  virtual uci::base::accessorType::AccessorType getAccessorType() const noexception {
    return uci::type::accessorType::rDMA_InitializeSetupMT;
  }

  /** Returns the version that was initialized from the uci:version attribute of RDMA_InitializeSetupMT.
    *
    * @return The version that was initialized from the uci:version attribute of RDMA_InitializeSetupMT.
    */
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const RDMA_InitializeSetupMT& accessor) = 0;
  ...
  /** Sets the value of the enumeration identified by ObjectState.
    ...
    */
  virtual uci::type::RDMA_InitializeSetupMT& setObjectState(const uci::type::ObjectStateEnum& value) = 0;
  ...
  /** Sets the value of the enumeration identified by ObjectState.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::RDMA_InitializeSetupMT& setObjectState(uci::type::ObjectStateEnum::EnumerationItem value) = 0;
  ...
  /** Clears (disabled) the Element identified by ObjectState.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::RDMA_InitializeSetupMT& clearObjectState() = 0;
  ...
  /** Returns a const reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual const uci::type::RDMA_InitializeSetupMDT& getMessageData() const = 0;
  ...
  /** Returns a reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual uci::type::RDMA_InitializeSetupMDT& getMessageData() = 0;
  ...
  /** Sets the complex content identified by MessageData to the contents of the complex content accessed by the specified
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::RDMA_InitializeSetupMT& setMessageData(const uci::type::RDMA_InitializeSetupMDT& value) = 0;

  /** The Listener provides the support to listen and handle incoming messages of the type
    * uci::type::RDMA_InitializeSetupMT.
    */
  ...
  public:
    ...
    /** The method is used to handle incoming messages.
      ...
      */
    virtual void handleMessage(const uci::type::RDMA_InitializeSetupMT& message) = 0;
  ...
  public:
    ...
    /** Adds a listener to this reader to handle incoming messages.
      ...
      */
    virtual void addListener(uci::type::RDMA_InitializeSetupMT::Listener& listener) = 0;

    /** Removes the specified listener from this reader.
      *
      * @param listener The listener that is to be removed from this reader.
      */
    virtual void removeListener(uci::type::RDMA_InitializeSetupMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s). Returns immediately if no messages are available.
      ...
      */
    virtual unsigned long readNoWait(unsigned long maxNumberOfMessages, uci::type::RDMA_InitializeSetupMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s).
      ...
      * @return The number of messages that were handled.
      */
    virtual unsigned long read(unsigned long timeout, unsigned long maxNumberOfMessages, uci::type::RDMA_InitializeSetupMT::Listener& listener) = 0;
  ...
  /** This method creates a new reader that can be used to read a RDMA_InitializeSetupMT.
    *
    * @param topic The specification of the topic the reader is to read from.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A reader that can read a RDMA_InitializeSetupMT.
    */
  static UCI_EXPORT uci::type::RDMA_InitializeSetupMT::Reader& createReader(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a reader. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyReader(uci::type::RDMA_InitializeSetupMT::Reader& reader);
  ...
  public:
    ...
    /** Writes the OMS message to the topic specified when this Writer was created.
      ...
      */
    virtual void write(uci::type::RDMA_InitializeSetupMT& accessor) = 0;
  ...
  /** This method creates a new writer that can be used to write a RDMA_InitializeSetupMT.
    *
    * @param topic The specification of the topic the writer is to write to.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A writer that can write a RDMA_InitializeSetupMT.
    */
  static UCI_EXPORT uci::type::RDMA_InitializeSetupMT::Writer& createWriter(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a writer. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyWriter(uci::type::RDMA_InitializeSetupMT::Writer& writer);
...
protected:
  ...
  /** The copy constructor [only available to derived classes].
    *
    * @param rhs The RDMA_InitializeSetupMT to copy from.
    */
  RDMA_InitializeSetupMT(const RDMA_InitializeSetupMT& rhs) {
    (void)rhs;
  }

  /** The assignment operator. Sets the contents of this RDMA_InitializeSetupMT to the contents of the
    * RDMA_InitializeSetupMT on the right hand side (rhs) of the assignment operator [only available to derived classes].
    *
    * @param rhs The RDMA_InitializeSetupMT on the right hand side (rhs) of the assignment operator whose contents are used
    *      to set the contents of this RDMA_InitializeSetupMT.
    * @return A reference to this RDMA_InitializeSetupMT.
    */
  RDMA_InitializeSetupMT& operator=(const RDMA_InitializeSetupMT& rhs) {
    (void)rhs;
...
#endif // UCI_TYPE_RDMA_INITIALIZESETUPMT_H
