...
#ifndef UCI_TYPE_PACKAGESTATUSMT_H
#define UCI_TYPE_PACKAGESTATUSMT_H
...
class PackageStatusMT : public virtual MessageType {
public:

  /** This method constructs a new PackageStatusMT.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed PackageStatusMT.
    */
  static UCI_EXPORT PackageStatusMT& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new PackageStatusMT initializing the data accessed by the new PackageStatusMT using the data
    * accessed by the specified PackageStatusMT (cloning).
    *
    * @param accessor The PackageStatusMT that provides access to the data that is to be used to initialize the data
    *      accessed by the new created PackageStatusMT.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed PackageStatusMT.
    */
  static UCI_EXPORT PackageStatusMT& create(const PackageStatusMT& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified PackageStatusMT. Use of the specified accessor after it has been destroyed will
    * result in undefined behavior.
    *
    * @param accessor The PackageStatusMT that is to be destroyed.
    */
  static UCI_EXPORT void destroy(PackageStatusMT& accessor);

  /** Returns this accessor's type constant, i.e. packageStatusMT.
    *
    * @return This accessor's type constant, i.e. packageStatusMT.
    */
  virtual uci::base::accessorType::AccessorType getAccessorType() const noexception {
    return uci::type::accessorType::packageStatusMT;
  }

  /** Returns the version that was initialized from the uci:version attribute of PackageStatusMT.
    *
    * @return The version that was initialized from the uci:version attribute of PackageStatusMT.
    */
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const PackageStatusMT& accessor) = 0;
  ...
  /** Returns a const reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual const uci::type::PackageStatusMDT& getMessageData() const = 0;
  ...
  /** Returns a reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual uci::type::PackageStatusMDT& getMessageData() = 0;
  ...
  /** Sets the complex content identified by MessageData to the contents of the complex content accessed by the specified
    ...
    */
  virtual uci::type::PackageStatusMT& setMessageData(const uci::type::PackageStatusMDT& value) = 0;

  /** The Listener provides the support to listen and handle incoming messages of the type uci::type::PackageStatusMT. */
  ...
  public:
    ...
    /** The method is used to handle incoming messages.
      ...
      */
    virtual void handleMessage(const uci::type::PackageStatusMT& message) = 0;
  ...
  public:
    ...
    /** Adds a listener to this reader to handle incoming messages.
      ...
      */
    virtual void addListener(uci::type::PackageStatusMT::Listener& listener) = 0;

    /** Removes the specified listener from this reader.
      *
      * @param listener The listener that is to be removed from this reader.
      */
    virtual void removeListener(uci::type::PackageStatusMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s). Returns immediately if no messages are available.
      ...
      */
    virtual unsigned long readNoWait(unsigned long maxNumberOfMessages, uci::type::PackageStatusMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s).
      ...
      * @return The number of messages that were handled.
      */
    virtual unsigned long read(unsigned long timeout, unsigned long maxNumberOfMessages, uci::type::PackageStatusMT::Listener& listener) = 0;
  ...
  /** This method creates a new reader that can be used to read a PackageStatusMT.
    *
    * @param topic The specification of the topic the reader is to read from.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A reader that can read a PackageStatusMT.
    */
  static UCI_EXPORT uci::type::PackageStatusMT::Reader& createReader(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a reader. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyReader(uci::type::PackageStatusMT::Reader& reader);
  ...
  public:
    ...
    /** Writes the OMS message to the topic specified when this Writer was created.
      ...
      */
    virtual void write(uci::type::PackageStatusMT& accessor) = 0;
  ...
  /** This method creates a new writer that can be used to write a PackageStatusMT.
    *
    * @param topic The specification of the topic the writer is to write to.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A writer that can write a PackageStatusMT.
    */
  static UCI_EXPORT uci::type::PackageStatusMT::Writer& createWriter(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a writer. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyWriter(uci::type::PackageStatusMT::Writer& writer);
...
protected:
  ...
  /** The copy constructor [only available to derived classes].
    *
    * @param rhs The PackageStatusMT to copy from.
    */
  PackageStatusMT(const PackageStatusMT& rhs) {
    (void)rhs;
  }

  /** The assignment operator. Sets the contents of this PackageStatusMT to the contents of the PackageStatusMT on the
    * right hand side (rhs) of the assignment operator [only available to derived classes].
    *
    * @param rhs The PackageStatusMT on the right hand side (rhs) of the assignment operator whose contents are used to set
    *      the contents of this PackageStatusMT.
    * @return A reference to this PackageStatusMT.
    */
  PackageStatusMT& operator=(const PackageStatusMT& rhs) {
    (void)rhs;
...
#endif // UCI_TYPE_PACKAGESTATUSMT_H
