...
#ifndef UCI_TYPE_DMPI_STATUSMT_H
#define UCI_TYPE_DMPI_STATUSMT_H

#include "../base/Listener.h"
#include "../base/Reader.h"
#include "../base/Writer.h"
#include "../base/export.h"
#include "DMPI_StatusMDT.h"
...
class DMPI_StatusMT : public virtual MessageType {
public:

  /** This method constructs a new DMPI_StatusMT.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed DMPI_StatusMT.
    */
  static UCI_EXPORT DMPI_StatusMT& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new DMPI_StatusMT initializing the data accessed by the new DMPI_StatusMT using the data
    * accessed by the specified DMPI_StatusMT (cloning).
    *
    * @param accessor The DMPI_StatusMT that provides access to the data that is to be used to initialize the data accessed
    *      by the new created DMPI_StatusMT.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed DMPI_StatusMT.
    */
  static UCI_EXPORT DMPI_StatusMT& create(const DMPI_StatusMT& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified DMPI_StatusMT. Use of the specified accessor after it has been destroyed will
    * result in undefined behavior.
    *
    * @param accessor The DMPI_StatusMT that is to be destroyed.
    */
  static UCI_EXPORT void destroy(DMPI_StatusMT& accessor);
  ...
  /** Returns the version that was initialized from the uci:version attribute of DMPI_StatusMT.
    *
    * @return The version that was initialized from the uci:version attribute of DMPI_StatusMT.
    */
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const DMPI_StatusMT& accessor) = 0;
  ...
  /** Returns a const reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual const uci::type::DMPI_StatusMDT& getMessageData() const = 0;
  ...
  /** Returns a reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual uci::type::DMPI_StatusMDT& getMessageData() = 0;
  ...
  /** Sets the complex content identified by MessageData to the contents of the complex content accessed by the specified
    ...
    */
  virtual uci::type::DMPI_StatusMT& setMessageData(const uci::type::DMPI_StatusMDT& value) = 0;

  /** The Listener provides the support to listen and handle incoming messages of the type uci::type::DMPI_StatusMT. */
  ...
  public:
    ...
    /** The method is used to handle incoming messages.
      ...
      */
    virtual void handleMessage(const uci::type::DMPI_StatusMT& message) = 0;
  ...
  public:
    ...
    /** Adds a listener to this reader to handle incoming messages.
      ...
      */
    virtual void addListener(uci::type::DMPI_StatusMT::Listener& listener) = 0;

    /** Removes the specified listener from this reader.
      *
      * @param listener The listener that is to be removed from this reader.
      */
    virtual void removeListener(uci::type::DMPI_StatusMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s). Returns immediately if no messages are available.
      ...
      */
    virtual unsigned long readNoWait(unsigned long maxNumberOfMessages, uci::type::DMPI_StatusMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s).
      ...
      * @return The number of messages that were handled.
      */
    virtual unsigned long read(unsigned long timeout, unsigned long maxNumberOfMessages, uci::type::DMPI_StatusMT::Listener& listener) = 0;
  ...
  /** This method creates a new reader that can be used to read a DMPI_StatusMT.
    *
    * @param topic The specification of the topic the reader is to read from.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A reader that can read a DMPI_StatusMT.
    */
  static UCI_EXPORT uci::type::DMPI_StatusMT::Reader& createReader(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a reader. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyReader(uci::type::DMPI_StatusMT::Reader& reader);
  ...
  public:
    ...
    /** Writes the OMS message to the topic specified when this Writer was created.
      ...
      */
    virtual void write(uci::type::DMPI_StatusMT& accessor) = 0;
  ...
  /** This method creates a new writer that can be used to write a DMPI_StatusMT.
    *
    * @param topic The specification of the topic the writer is to write to.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A writer that can write a DMPI_StatusMT.
    */
  static UCI_EXPORT uci::type::DMPI_StatusMT::Writer& createWriter(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a writer. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyWriter(uci::type::DMPI_StatusMT::Writer& writer);
...
protected:
  ...
  /** The assignment operator. Sets the contents of this DMPI_StatusMT to the contents of the DMPI_StatusMT on the right
    ...
    *      the contents of this DMPI_StatusMT.
    * @return A reference to this DMPI_StatusMT.
    */
  DMPI_StatusMT& operator=(const DMPI_StatusMT& rhs) {
    (void)rhs;
...
#endif // UCI_TYPE_DMPI_STATUSMT_H
