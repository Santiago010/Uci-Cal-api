...
#ifndef UCI_TYPE_EA_INDICATORENUM_H
#define UCI_TYPE_EA_INDICATORENUM_H
...
/** This enumerated type is a placeholder for a standardized enumeration defined by the specific program implementation.
...
public:
  ...
  enum EnumerationItem {
    ...
    /** PROGRAM_SPECIFIC_TYPE_A EA response. */
    UCI_PROGRAM_SPECIFIC_TYPE_A,

    /** PROGRAM_SPECIFIC_TYPE_B EA response. */
    UCI_PROGRAM_SPECIFIC_TYPE_B,

    /** PROGRAM_SPECIFIC_TYPE_C EA response. */
    UCI_PROGRAM_SPECIFIC_TYPE_C,

    /** PROGRAM_SPECIFIC_TYPE_D EA response. */
    UCI_PROGRAM_SPECIFIC_TYPE_D,

    /** PROGRAM_SPECIFIC_TYPE_E EA response. */
  ...
  /** The assignment operator. Sets the contents of this EA_IndicatorEnum to the contents of the EA_IndicatorEnum on the
    ...
    * @return A reference to this EA_IndicatorEnum.
    */
  EA_IndicatorEnum& operator=(const EA_IndicatorEnum& rhs) {
    setValue(rhs.getValue());
    return *this;
  }

  /** The assignment operator that sets the value of this EA_IndicatorEnum enumeration to the EnumerationItem on the right
    * hand side of the assignment operator.
    *
    * @param rhs The EnumerationItem whose value is to be assigned to this EA_IndicatorEnum enumeration.
    * @return A reference to this EA_IndicatorEnum enumeration.
    */
  EA_IndicatorEnum& operator=(EnumerationItem rhs) {
    setValue(rhs);
    return *this;
  }
  ...
  /** Sets the value of this EA_IndicatorEnum enumeration to the value of the specified enumeration item.
    *
    * @param item The EnumerationItem whose value is to be used to set the value of this EA_IndicatorEnum enumeration.
    */
  ...
  /** Tests whether the value of this EA_IndicatorEnum enumeration is not equal to the value of the specified
    ...
    *
    * @param rhs The EnumerationItem whose value is to be compared against the value of this EA_IndicatorEnum enumeration.
    * @return True if the value of the EnumerationItem (rhs) is not equal to the value of this EA_IndicatorEnum
  ...
  /** Tests whether the value of this EA_IndicatorEnum enumeration is greater than the value of the specified
    ...
    *
    * @param rhs The EnumerationItem whose value is to be compared against the value of this EA_IndicatorEnum enumeration.
    * @return True if the value of the EnumerationItem (rhs) is greater than the value of this EA_IndicatorEnum
    *      enumeration, false otherwise.
    */
  bool operator>(EnumerationItem rhs) const {
    testForValidItem(rhs);
...
#endif // UCI_TYPE_EA_INDICATORENUM_H
