/** @file OrbitChangeCapabilityStatus.h
 *
...
typedef uci::type::OrbitChangeCapabilityStatusMT OrbitChangeCapabilityStatus;

} // namespace type
} // namespace uci

#endif // UCI_TYPE_ORBITCHANGECAPABILITYSTATUS_H
