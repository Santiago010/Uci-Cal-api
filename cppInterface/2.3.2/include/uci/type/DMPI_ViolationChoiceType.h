...
#ifndef UCI_TYPE_DMPI_VIOLATIONCHOICETYPE_H
#define UCI_TYPE_DMPI_VIOLATIONCHOICETYPE_H
...
public:
  ...
  /** This method constructs a new DMPI_ViolationChoiceType.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed DMPI_ViolationChoiceType.
    */
  static UCI_EXPORT DMPI_ViolationChoiceType& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new DMPI_ViolationChoiceType initializing the data accessed by the new
    * DMPI_ViolationChoiceType using the data accessed by the specified DMPI_ViolationChoiceType (cloning).
    *
    * @param accessor The DMPI_ViolationChoiceType that provides access to the data that is to be used to initialize the
    *      data accessed by the new created DMPI_ViolationChoiceType.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed DMPI_ViolationChoiceType.
    */
  static UCI_EXPORT DMPI_ViolationChoiceType& create(const DMPI_ViolationChoiceType& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified DMPI_ViolationChoiceType. Use of the specified accessor after it has been
    * destroyed will result in undefined behavior.
    *
    * @param accessor The DMPI_ViolationChoiceType that is to be destroyed.
    */
  static UCI_EXPORT void destroy(DMPI_ViolationChoiceType& accessor);
  ...
  /** Returns the version that was initialized from the uci:version attribute of DMPI_ViolationChoiceType.
    *
    * @return The version that was initialized from the uci:version attribute of DMPI_ViolationChoiceType.
    */
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const DMPI_ViolationChoiceType& accessor) = 0;
  ...
  enum DMPI_ViolationChoiceTypeChoice {
    ...
    DMPI_VIOLATIONCHOICETYPE_CHOICE_OPVOLUMEID
  };
  ...
  /** This method returns this choice's "selection ordinal." A choice's "selection ordinal" is used to specify which
    ...
    */
  virtual DMPI_ViolationChoiceTypeChoice getDMPI_ViolationChoiceTypeChoiceOrdinal() const = 0;
  ...
  /** This method is used to set this choice's "selection ordinal." A choice's "selection ordinal" is used to specify which
    ...
    */
  virtual uci::type::DMPI_ViolationChoiceType& setDMPI_ViolationChoiceTypeChoiceOrdinal(DMPI_ViolationChoiceTypeChoice chosenElementOrdinal, uci::base::accessorType::AccessorType type = uci::base::accessorType::null) = 0;
  ...
  /** Sets the complex content identified by OpLineID to the contents of the complex content accessed by the specified
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::DMPI_ViolationChoiceType& setOpLineID(const uci::type::OpLineID_Type& value) = 0;
  ...
  /** Sets the complex content identified by OpZoneID to the contents of the complex content accessed by the specified
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::DMPI_ViolationChoiceType& setOpZoneID(const uci::type::OpZoneID_Type& value) = 0;
  ...
  /** Sets the complex content identified by OpVolumeID to the contents of the complex content accessed by the specified
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::DMPI_ViolationChoiceType& setOpVolumeID(const uci::type::OpVolumeID_Type& value) = 0;
...
protected:
  ...
  /** The assignment operator. Sets the contents of this DMPI_ViolationChoiceType to the contents of the
    * DMPI_ViolationChoiceType on the right hand side (rhs) of the assignment operator [only available to derived classes].
    *
    * @param rhs The DMPI_ViolationChoiceType on the right hand side (rhs) of the assignment operator whose contents are
    *      used to set the contents of this DMPI_ViolationChoiceType.
    * @return A reference to this DMPI_ViolationChoiceType.
    */
  DMPI_ViolationChoiceType& operator=(const DMPI_ViolationChoiceType& rhs) {
    (void)rhs;
...
#endif // UCI_TYPE_DMPI_VIOLATIONCHOICETYPE_H
