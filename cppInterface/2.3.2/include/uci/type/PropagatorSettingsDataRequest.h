/** @file PropagatorSettingsDataRequest.h
 *
...
typedef uci::type::PropagatorSettingsDataRequestMT PropagatorSettingsDataRequest;

} // namespace type
} // namespace uci

#endif // UCI_TYPE_PROPAGATORSETTINGSDATAREQUEST_H
