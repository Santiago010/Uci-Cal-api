...
#ifndef UCI_TYPE_ENTITYLOSTMT_H
#define UCI_TYPE_ENTITYLOSTMT_H

#include "../base/Listener.h"
#include "../base/Reader.h"
#include "../base/Writer.h"
#include "../base/export.h"
#include "EntityLostMDT.h"
...
/** This type identifies an Entity that was not observed in the time frame and/or location expected. In Space operations,
  * a Resident Space Object (RSO) entity is considered "lost" if it does not have any associated metric observations
  * within the last 30 days.
  */
class EntityLostMT : public virtual MessageType {
public:

  /** This method constructs a new EntityLostMT.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed EntityLostMT.
    */
  static UCI_EXPORT EntityLostMT& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new EntityLostMT initializing the data accessed by the new EntityLostMT using the data
    * accessed by the specified EntityLostMT (cloning).
    *
    * @param accessor The EntityLostMT that provides access to the data that is to be used to initialize the data accessed
    *      by the new created EntityLostMT.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed EntityLostMT.
    */
  static UCI_EXPORT EntityLostMT& create(const EntityLostMT& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified EntityLostMT. Use of the specified accessor after it has been destroyed will
    * result in undefined behavior.
    *
    * @param accessor The EntityLostMT that is to be destroyed.
    */
  static UCI_EXPORT void destroy(EntityLostMT& accessor);

  /** Returns this accessor's type constant, i.e. entityLostMT.
    *
    * @return This accessor's type constant, i.e. entityLostMT.
    */
  virtual uci::base::accessorType::AccessorType getAccessorType() const noexception {
    return uci::type::accessorType::entityLostMT;
  }

  /** Returns the version that was initialized from the uci:version attribute of EntityLostMT.
    *
    * @return The version that was initialized from the uci:version attribute of EntityLostMT.
    */
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const EntityLostMT& accessor) = 0;
  ...
  /** Returns a const reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual const uci::type::EntityLostMDT& getMessageData() const = 0;
  ...
  /** Returns a reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual uci::type::EntityLostMDT& getMessageData() = 0;
  ...
  /** Sets the complex content identified by MessageData to the contents of the complex content accessed by the specified
    ...
    */
  virtual uci::type::EntityLostMT& setMessageData(const uci::type::EntityLostMDT& value) = 0;

  /** The Listener provides the support to listen and handle incoming messages of the type uci::type::EntityLostMT. */
  ...
  public:
    ...
    /** The method is used to handle incoming messages.
      ...
      */
    virtual void handleMessage(const uci::type::EntityLostMT& message) = 0;
  ...
  public:
    ...
    /** Adds a listener to this reader to handle incoming messages.
      ...
      */
    virtual void addListener(uci::type::EntityLostMT::Listener& listener) = 0;

    /** Removes the specified listener from this reader.
      *
      * @param listener The listener that is to be removed from this reader.
      */
    virtual void removeListener(uci::type::EntityLostMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s). Returns immediately if no messages are available.
      ...
      */
    virtual unsigned long readNoWait(unsigned long maxNumberOfMessages, uci::type::EntityLostMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s).
      ...
      * @return The number of messages that were handled.
      */
    virtual unsigned long read(unsigned long timeout, unsigned long maxNumberOfMessages, uci::type::EntityLostMT::Listener& listener) = 0;
  ...
  /** This method creates a new reader that can be used to read a EntityLostMT.
    *
    * @param topic The specification of the topic the reader is to read from.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A reader that can read a EntityLostMT.
    */
  static UCI_EXPORT uci::type::EntityLostMT::Reader& createReader(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a reader. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyReader(uci::type::EntityLostMT::Reader& reader);
  ...
  public:
    ...
    /** Writes the OMS message to the topic specified when this Writer was created.
      ...
      */
    virtual void write(uci::type::EntityLostMT& accessor) = 0;
  ...
  /** This method creates a new writer that can be used to write a EntityLostMT.
    *
    * @param topic The specification of the topic the writer is to write to.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A writer that can write a EntityLostMT.
    */
  static UCI_EXPORT uci::type::EntityLostMT::Writer& createWriter(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a writer. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyWriter(uci::type::EntityLostMT::Writer& writer);
...
protected:
  ...
  /** The copy constructor [only available to derived classes].
    *
    * @param rhs The EntityLostMT to copy from.
    */
  EntityLostMT(const EntityLostMT& rhs) {
    (void)rhs;
  }

  /** The assignment operator. Sets the contents of this EntityLostMT to the contents of the EntityLostMT on the right hand
    * side (rhs) of the assignment operator [only available to derived classes].
    *
    * @param rhs The EntityLostMT on the right hand side (rhs) of the assignment operator whose contents are used to set
    *      the contents of this EntityLostMT.
    * @return A reference to this EntityLostMT.
    */
  EntityLostMT& operator=(const EntityLostMT& rhs) {
    (void)rhs;
