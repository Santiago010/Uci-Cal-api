/** @file SurvivabilityRiskLevelMT.h
 *
...
#ifndef UCI_TYPE_SURVIVABILITYRISKLEVELMT_H
#define UCI_TYPE_SURVIVABILITYRISKLEVELMT_H
...
#include "SurvivabilityRiskLevelMDT.h"
...
class SurvivabilityRiskLevelMT : public virtual MessageType {
public:

  /** This method constructs a new SurvivabilityRiskLevelMT.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed SurvivabilityRiskLevelMT.
    */
  static UCI_EXPORT SurvivabilityRiskLevelMT& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new SurvivabilityRiskLevelMT initializing the data accessed by the new
    * SurvivabilityRiskLevelMT using the data accessed by the specified SurvivabilityRiskLevelMT (cloning).
    *
    * @param accessor The SurvivabilityRiskLevelMT that provides access to the data that is to be used to initialize the
    *      data accessed by the new created SurvivabilityRiskLevelMT.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed SurvivabilityRiskLevelMT.
    */
  static UCI_EXPORT SurvivabilityRiskLevelMT& create(const SurvivabilityRiskLevelMT& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified SurvivabilityRiskLevelMT. Use of the specified accessor after it has been
    * destroyed will result in undefined behavior.
    *
    * @param accessor The SurvivabilityRiskLevelMT that is to be destroyed.
    */
  static UCI_EXPORT void destroy(SurvivabilityRiskLevelMT& accessor);
  ...
  /** Returns the version that was initialized from the uci:version attribute of SurvivabilityRiskLevelMT.
    *
    * @return The version that was initialized from the uci:version attribute of SurvivabilityRiskLevelMT.
    */
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const SurvivabilityRiskLevelMT& accessor) = 0;
  ...
  /** Sets the value of the enumeration identified by ObjectState.
    ...
    */
  virtual uci::type::SurvivabilityRiskLevelMT& setObjectState(const uci::type::ObjectStateEnum& value) = 0;
  ...
  /** Sets the value of the enumeration identified by ObjectState.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::SurvivabilityRiskLevelMT& setObjectState(uci::type::ObjectStateEnum::EnumerationItem value) = 0;
  ...
  /** Clears (disabled) the Element identified by ObjectState.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::SurvivabilityRiskLevelMT& clearObjectState() = 0;
  ...
  /** Returns a const reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual const uci::type::SurvivabilityRiskLevelMDT& getMessageData() const = 0;
  ...
  /** Returns a reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual uci::type::SurvivabilityRiskLevelMDT& getMessageData() = 0;
  ...
  /** Sets the complex content identified by MessageData to the contents of the complex content accessed by the specified
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::SurvivabilityRiskLevelMT& setMessageData(const uci::type::SurvivabilityRiskLevelMDT& value) = 0;

  /** The Listener provides the support to listen and handle incoming messages of the type
    * uci::type::SurvivabilityRiskLevelMT.
    */
  ...
  public:
    ...
    /** The method is used to handle incoming messages.
      ...
      */
    virtual void handleMessage(const uci::type::SurvivabilityRiskLevelMT& message) = 0;
  ...
  public:
    ...
    /** Adds a listener to this reader to handle incoming messages.
      ...
      */
    virtual void addListener(uci::type::SurvivabilityRiskLevelMT::Listener& listener) = 0;

    /** Removes the specified listener from this reader.
      *
      * @param listener The listener that is to be removed from this reader.
      */
    virtual void removeListener(uci::type::SurvivabilityRiskLevelMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s). Returns immediately if no messages are available.
      ...
      */
    virtual unsigned long readNoWait(unsigned long maxNumberOfMessages, uci::type::SurvivabilityRiskLevelMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s).
      ...
      * @return The number of messages that were handled.
      */
    virtual unsigned long read(unsigned long timeout, unsigned long maxNumberOfMessages, uci::type::SurvivabilityRiskLevelMT::Listener& listener) = 0;
  ...
  /** This method creates a new reader that can be used to read a SurvivabilityRiskLevelMT.
    *
    * @param topic The specification of the topic the reader is to read from.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A reader that can read a SurvivabilityRiskLevelMT.
    */
  static UCI_EXPORT uci::type::SurvivabilityRiskLevelMT::Reader& createReader(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a reader. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyReader(uci::type::SurvivabilityRiskLevelMT::Reader& reader);
  ...
  public:
    ...
    /** Writes the OMS message to the topic specified when this Writer was created.
      ...
      */
    virtual void write(uci::type::SurvivabilityRiskLevelMT& accessor) = 0;
  ...
  /** This method creates a new writer that can be used to write a SurvivabilityRiskLevelMT.
    *
    * @param topic The specification of the topic the writer is to write to.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A writer that can write a SurvivabilityRiskLevelMT.
    */
  static UCI_EXPORT uci::type::SurvivabilityRiskLevelMT::Writer& createWriter(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a writer. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyWriter(uci::type::SurvivabilityRiskLevelMT::Writer& writer);
...
protected:
  ...
  /** The assignment operator. Sets the contents of this SurvivabilityRiskLevelMT to the contents of the
    * SurvivabilityRiskLevelMT on the right hand side (rhs) of the assignment operator [only available to derived classes].
    *
    * @param rhs The SurvivabilityRiskLevelMT on the right hand side (rhs) of the assignment operator whose contents are
    *      used to set the contents of this SurvivabilityRiskLevelMT.
    * @return A reference to this SurvivabilityRiskLevelMT.
    */
  SurvivabilityRiskLevelMT& operator=(const SurvivabilityRiskLevelMT& rhs) {
    (void)rhs;
...
#endif // UCI_TYPE_SURVIVABILITYRISKLEVELMT_H
