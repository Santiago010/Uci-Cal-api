...
#ifndef UCI_TYPE_WEATHERDATASETMT_H
#define UCI_TYPE_WEATHERDATASETMT_H
...
class WeatherDatasetMT : public virtual MessageType {
public:

  /** This method constructs a new WeatherDatasetMT.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed WeatherDatasetMT.
    */
  static UCI_EXPORT WeatherDatasetMT& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new WeatherDatasetMT initializing the data accessed by the new WeatherDatasetMT using the
    * data accessed by the specified WeatherDatasetMT (cloning).
    *
    * @param accessor The WeatherDatasetMT that provides access to the data that is to be used to initialize the data
    *      accessed by the new created WeatherDatasetMT.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed WeatherDatasetMT.
    */
  static UCI_EXPORT WeatherDatasetMT& create(const WeatherDatasetMT& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified WeatherDatasetMT. Use of the specified accessor after it has been destroyed will
    * result in undefined behavior.
    *
    * @param accessor The WeatherDatasetMT that is to be destroyed.
    */
  static UCI_EXPORT void destroy(WeatherDatasetMT& accessor);
  ...
  /** Returns the version that was initialized from the uci:version attribute of WeatherDatasetMT.
    *
    * @return The version that was initialized from the uci:version attribute of WeatherDatasetMT.
    */
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const WeatherDatasetMT& accessor) = 0;
  ...
  /** Sets the value of the enumeration identified by ObjectState.
    ...
    */
  virtual uci::type::WeatherDatasetMT& setObjectState(const uci::type::ObjectStateEnum& value) = 0;
  ...
  /** Sets the value of the enumeration identified by ObjectState.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::WeatherDatasetMT& setObjectState(uci::type::ObjectStateEnum::EnumerationItem value) = 0;
  ...
  /** Clears (disabled) the Element identified by ObjectState.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::WeatherDatasetMT& clearObjectState() = 0;
  ...
  /** Returns a const reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual const uci::type::WeatherDatasetMDT& getMessageData() const = 0;
  ...
  /** Returns a reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual uci::type::WeatherDatasetMDT& getMessageData() = 0;
  ...
  /** Sets the complex content identified by MessageData to the contents of the complex content accessed by the specified
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::WeatherDatasetMT& setMessageData(const uci::type::WeatherDatasetMDT& value) = 0;

  /** The Listener provides the support to listen and handle incoming messages of the type uci::type::WeatherDatasetMT. */
  ...
  public:
    ...
    /** The method is used to handle incoming messages.
      ...
      */
    virtual void handleMessage(const uci::type::WeatherDatasetMT& message) = 0;
  ...
  public:
    ...
    /** Adds a listener to this reader to handle incoming messages.
      ...
      */
    virtual void addListener(uci::type::WeatherDatasetMT::Listener& listener) = 0;

    /** Removes the specified listener from this reader.
      *
      * @param listener The listener that is to be removed from this reader.
      */
    virtual void removeListener(uci::type::WeatherDatasetMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s). Returns immediately if no messages are available.
      ...
      */
    virtual unsigned long readNoWait(unsigned long maxNumberOfMessages, uci::type::WeatherDatasetMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s).
      ...
      * @return The number of messages that were handled.
      */
    virtual unsigned long read(unsigned long timeout, unsigned long maxNumberOfMessages, uci::type::WeatherDatasetMT::Listener& listener) = 0;
  ...
  /** This method creates a new reader that can be used to read a WeatherDatasetMT.
    *
    * @param topic The specification of the topic the reader is to read from.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A reader that can read a WeatherDatasetMT.
    */
  static UCI_EXPORT uci::type::WeatherDatasetMT::Reader& createReader(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a reader. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyReader(uci::type::WeatherDatasetMT::Reader& reader);
  ...
  public:
    ...
    /** Writes the OMS message to the topic specified when this Writer was created.
      ...
      */
    virtual void write(uci::type::WeatherDatasetMT& accessor) = 0;
  ...
  /** This method creates a new writer that can be used to write a WeatherDatasetMT.
    *
    * @param topic The specification of the topic the writer is to write to.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A writer that can write a WeatherDatasetMT.
    */
  static UCI_EXPORT uci::type::WeatherDatasetMT::Writer& createWriter(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a writer. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyWriter(uci::type::WeatherDatasetMT::Writer& writer);
...
protected:
  ...
  /** The assignment operator. Sets the contents of this WeatherDatasetMT to the contents of the WeatherDatasetMT on the
    ...
    *      set the contents of this WeatherDatasetMT.
    * @return A reference to this WeatherDatasetMT.
    */
  WeatherDatasetMT& operator=(const WeatherDatasetMT& rhs) {
    (void)rhs;
...
#endif // UCI_TYPE_WEATHERDATASETMT_H
