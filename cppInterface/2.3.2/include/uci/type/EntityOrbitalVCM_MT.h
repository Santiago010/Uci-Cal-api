...
#ifndef UCI_TYPE_ENTITYORBITALVCM_MT_H
#define UCI_TYPE_ENTITYORBITALVCM_MT_H

#include "../base/Listener.h"
#include "../base/Reader.h"
#include "../base/Writer.h"
#include "../base/export.h"
#include "EntityOrbitalVCM_MDT.h"
...
/** Indicates the VCM's ID, Entity's ID, the parameters used for creating the VCM, state vector and covariance data
  * results, and the Request's ID (if message is generated in response to a request).
  */
class EntityOrbitalVCM_MT : public virtual MessageType {
public:

  /** This method constructs a new EntityOrbitalVCM_MT.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed EntityOrbitalVCM_MT.
    */
  static UCI_EXPORT EntityOrbitalVCM_MT& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new EntityOrbitalVCM_MT initializing the data accessed by the new EntityOrbitalVCM_MT using
    * the data accessed by the specified EntityOrbitalVCM_MT (cloning).
    *
    * @param accessor The EntityOrbitalVCM_MT that provides access to the data that is to be used to initialize the data
    *      accessed by the new created EntityOrbitalVCM_MT.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed EntityOrbitalVCM_MT.
    */
  static UCI_EXPORT EntityOrbitalVCM_MT& create(const EntityOrbitalVCM_MT& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified EntityOrbitalVCM_MT. Use of the specified accessor after it has been destroyed
    * will result in undefined behavior.
    *
    * @param accessor The EntityOrbitalVCM_MT that is to be destroyed.
    */
  static UCI_EXPORT void destroy(EntityOrbitalVCM_MT& accessor);

  /** Returns this accessor's type constant, i.e. entityOrbitalVCM_MT.
    *
    * @return This accessor's type constant, i.e. entityOrbitalVCM_MT.
    */
  virtual uci::base::accessorType::AccessorType getAccessorType() const noexception {
    return uci::type::accessorType::entityOrbitalVCM_MT;
  }

  /** Returns the version that was initialized from the uci:version attribute of EntityOrbitalVCM_MT.
    *
    * @return The version that was initialized from the uci:version attribute of EntityOrbitalVCM_MT.
    */
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const EntityOrbitalVCM_MT& accessor) = 0;
  ...
  /** Sets the value of the enumeration identified by ObjectState.
    ...
    */
  virtual uci::type::EntityOrbitalVCM_MT& setObjectState(const uci::type::ObjectStateEnum& value) = 0;
  ...
  /** Sets the value of the enumeration identified by ObjectState.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::EntityOrbitalVCM_MT& setObjectState(uci::type::ObjectStateEnum::EnumerationItem value) = 0;
  ...
  /** Clears (disabled) the Element identified by ObjectState.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::EntityOrbitalVCM_MT& clearObjectState() = 0;
  ...
  /** Returns a const reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual const uci::type::EntityOrbitalVCM_MDT& getMessageData() const = 0;
  ...
  /** Returns a reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual uci::type::EntityOrbitalVCM_MDT& getMessageData() = 0;
  ...
  /** Sets the complex content identified by MessageData to the contents of the complex content accessed by the specified
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::EntityOrbitalVCM_MT& setMessageData(const uci::type::EntityOrbitalVCM_MDT& value) = 0;

  /** The Listener provides the support to listen and handle incoming messages of the type uci::type::EntityOrbitalVCM_MT. */
  ...
  public:
    ...
    /** The method is used to handle incoming messages.
      ...
      */
    virtual void handleMessage(const uci::type::EntityOrbitalVCM_MT& message) = 0;
  ...
  public:
    ...
    /** Adds a listener to this reader to handle incoming messages.
      ...
      */
    virtual void addListener(uci::type::EntityOrbitalVCM_MT::Listener& listener) = 0;

    /** Removes the specified listener from this reader.
      *
      * @param listener The listener that is to be removed from this reader.
      */
    virtual void removeListener(uci::type::EntityOrbitalVCM_MT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s). Returns immediately if no messages are available.
      ...
      */
    virtual unsigned long readNoWait(unsigned long maxNumberOfMessages, uci::type::EntityOrbitalVCM_MT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s).
      ...
      * @return The number of messages that were handled.
      */
    virtual unsigned long read(unsigned long timeout, unsigned long maxNumberOfMessages, uci::type::EntityOrbitalVCM_MT::Listener& listener) = 0;
  ...
  /** This method creates a new reader that can be used to read a EntityOrbitalVCM_MT.
    *
    * @param topic The specification of the topic the reader is to read from.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A reader that can read a EntityOrbitalVCM_MT.
    */
  static UCI_EXPORT uci::type::EntityOrbitalVCM_MT::Reader& createReader(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a reader. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyReader(uci::type::EntityOrbitalVCM_MT::Reader& reader);
  ...
  public:
    ...
    /** Writes the OMS message to the topic specified when this Writer was created.
      ...
      */
    virtual void write(uci::type::EntityOrbitalVCM_MT& accessor) = 0;
  ...
  /** This method creates a new writer that can be used to write a EntityOrbitalVCM_MT.
    *
    * @param topic The specification of the topic the writer is to write to.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A writer that can write a EntityOrbitalVCM_MT.
    */
  static UCI_EXPORT uci::type::EntityOrbitalVCM_MT::Writer& createWriter(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a writer. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyWriter(uci::type::EntityOrbitalVCM_MT::Writer& writer);
...
protected:
  ...
  /** The copy constructor [only available to derived classes].
    *
    * @param rhs The EntityOrbitalVCM_MT to copy from.
    */
  EntityOrbitalVCM_MT(const EntityOrbitalVCM_MT& rhs) {
    (void)rhs;
  }

  /** The assignment operator. Sets the contents of this EntityOrbitalVCM_MT to the contents of the EntityOrbitalVCM_MT on
    * the right hand side (rhs) of the assignment operator [only available to derived classes].
    *
    * @param rhs The EntityOrbitalVCM_MT on the right hand side (rhs) of the assignment operator whose contents are used to
    *      set the contents of this EntityOrbitalVCM_MT.
    * @return A reference to this EntityOrbitalVCM_MT.
    */
  EntityOrbitalVCM_MT& operator=(const EntityOrbitalVCM_MT& rhs) {
    (void)rhs;
...
#endif // UCI_TYPE_ENTITYORBITALVCM_MT_H
