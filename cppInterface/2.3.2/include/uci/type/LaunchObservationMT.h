...
#ifndef UCI_TYPE_LAUNCHOBSERVATIONMT_H
#define UCI_TYPE_LAUNCHOBSERVATIONMT_H

#include "../base/Listener.h"
#include "../base/Reader.h"
#include "../base/Writer.h"
#include "../base/export.h"
#include "LaunchObservationMDT.h"
...
class LaunchObservationMT : public virtual MessageType {
public:

  /** This method constructs a new LaunchObservationMT.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed LaunchObservationMT.
    */
  static UCI_EXPORT LaunchObservationMT& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new LaunchObservationMT initializing the data accessed by the new LaunchObservationMT using
    * the data accessed by the specified LaunchObservationMT (cloning).
    *
    * @param accessor The LaunchObservationMT that provides access to the data that is to be used to initialize the data
    *      accessed by the new created LaunchObservationMT.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed LaunchObservationMT.
    */
  static UCI_EXPORT LaunchObservationMT& create(const LaunchObservationMT& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified LaunchObservationMT. Use of the specified accessor after it has been destroyed
    * will result in undefined behavior.
    *
    * @param accessor The LaunchObservationMT that is to be destroyed.
    */
  static UCI_EXPORT void destroy(LaunchObservationMT& accessor);

  /** Returns this accessor's type constant, i.e. launchObservationMT.
    *
    * @return This accessor's type constant, i.e. launchObservationMT.
    */
  virtual uci::base::accessorType::AccessorType getAccessorType() const noexception {
    return uci::type::accessorType::launchObservationMT;
  }

  /** Returns the version that was initialized from the uci:version attribute of LaunchObservationMT.
    *
    * @return The version that was initialized from the uci:version attribute of LaunchObservationMT.
    */
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const LaunchObservationMT& accessor) = 0;
  ...
  /** Sets the value of the enumeration identified by ObjectState.
    ...
    */
  virtual uci::type::LaunchObservationMT& setObjectState(const uci::type::ObjectStateEnum& value) = 0;
  ...
  /** Sets the value of the enumeration identified by ObjectState.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::LaunchObservationMT& setObjectState(uci::type::ObjectStateEnum::EnumerationItem value) = 0;
  ...
  /** Clears (disabled) the Element identified by ObjectState.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::LaunchObservationMT& clearObjectState() = 0;
  ...
  /** Returns a const reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual const uci::type::LaunchObservationMDT& getMessageData() const = 0;
  ...
  /** Returns a reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual uci::type::LaunchObservationMDT& getMessageData() = 0;
  ...
  /** Sets the complex content identified by MessageData to the contents of the complex content accessed by the specified
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::LaunchObservationMT& setMessageData(const uci::type::LaunchObservationMDT& value) = 0;

  /** The Listener provides the support to listen and handle incoming messages of the type uci::type::LaunchObservationMT. */
  ...
  public:
    ...
    /** The method is used to handle incoming messages.
      ...
      */
    virtual void handleMessage(const uci::type::LaunchObservationMT& message) = 0;
  ...
  public:
    ...
    /** Adds a listener to this reader to handle incoming messages.
      ...
      */
    virtual void addListener(uci::type::LaunchObservationMT::Listener& listener) = 0;

    /** Removes the specified listener from this reader.
      *
      * @param listener The listener that is to be removed from this reader.
      */
    virtual void removeListener(uci::type::LaunchObservationMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s). Returns immediately if no messages are available.
      ...
      */
    virtual unsigned long readNoWait(unsigned long maxNumberOfMessages, uci::type::LaunchObservationMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s).
      ...
      * @return The number of messages that were handled.
      */
    virtual unsigned long read(unsigned long timeout, unsigned long maxNumberOfMessages, uci::type::LaunchObservationMT::Listener& listener) = 0;
  ...
  /** This method creates a new reader that can be used to read a LaunchObservationMT.
    *
    * @param topic The specification of the topic the reader is to read from.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A reader that can read a LaunchObservationMT.
    */
  static UCI_EXPORT uci::type::LaunchObservationMT::Reader& createReader(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a reader. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyReader(uci::type::LaunchObservationMT::Reader& reader);
  ...
  public:
    ...
    /** Writes the OMS message to the topic specified when this Writer was created.
      ...
      */
    virtual void write(uci::type::LaunchObservationMT& accessor) = 0;
  ...
  /** This method creates a new writer that can be used to write a LaunchObservationMT.
    *
    * @param topic The specification of the topic the writer is to write to.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A writer that can write a LaunchObservationMT.
    */
  static UCI_EXPORT uci::type::LaunchObservationMT::Writer& createWriter(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a writer. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyWriter(uci::type::LaunchObservationMT::Writer& writer);
...
protected:
  ...
  /** The copy constructor [only available to derived classes].
    *
    * @param rhs The LaunchObservationMT to copy from.
    */
  LaunchObservationMT(const LaunchObservationMT& rhs) {
    (void)rhs;
  }

  /** The assignment operator. Sets the contents of this LaunchObservationMT to the contents of the LaunchObservationMT on
    * the right hand side (rhs) of the assignment operator [only available to derived classes].
    *
    * @param rhs The LaunchObservationMT on the right hand side (rhs) of the assignment operator whose contents are used to
    *      set the contents of this LaunchObservationMT.
    * @return A reference to this LaunchObservationMT.
    */
  LaunchObservationMT& operator=(const LaunchObservationMT& rhs) {
    (void)rhs;
...
#endif // UCI_TYPE_LAUNCHOBSERVATIONMT_H
