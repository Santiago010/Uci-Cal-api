...
#ifndef UCI_TYPE_SOURCEFILTERTYPE_H
#define UCI_TYPE_SOURCEFILTERTYPE_H
...
public:
  ...
  /** This method constructs a new SourceFilterType.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed SourceFilterType.
    */
  static UCI_EXPORT SourceFilterType& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new SourceFilterType initializing the data accessed by the new SourceFilterType using the
    * data accessed by the specified SourceFilterType (cloning).
    *
    * @param accessor The SourceFilterType that provides access to the data that is to be used to initialize the data
    *      accessed by the new created SourceFilterType.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed SourceFilterType.
    */
  static UCI_EXPORT SourceFilterType& create(const SourceFilterType& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified SourceFilterType. Use of the specified accessor after it has been destroyed will
    * result in undefined behavior.
    *
    * @param accessor The SourceFilterType that is to be destroyed.
    */
  static UCI_EXPORT void destroy(SourceFilterType& accessor);
  ...
  /** Returns the version that was initialized from the uci:version attribute of SourceFilterType.
    *
    * @return The version that was initialized from the uci:version attribute of SourceFilterType.
    */
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const SourceFilterType& accessor) = 0;
  ...
  /** Sets the complex content identified by SystemID to the contents of the complex content accessed by the specified
    ...
    */
  virtual uci::type::SourceFilterType& setSystemID(const uci::type::SystemID_Type& value) = 0;
  ...
  /** Sets the complex content identified by CapabilityID to the contents of the complex content accessed by the specified
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::SourceFilterType& setCapabilityID(const uci::type::CapabilityID_Type& value) = 0;
  ...
  /** Clears (disabled) the Element identified by CapabilityID.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::SourceFilterType& clearCapabilityID() = 0;
  ...
  /** Sets the complex content identified by ComponentID to the contents of the complex content accessed by the specified
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::SourceFilterType& setComponentID(const uci::type::ComponentID_Type& value) = 0;
  ...
  /** Clears (disabled) the Element identified by ComponentID.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::SourceFilterType& clearComponentID() = 0;
...
protected:
  ...
  /** The assignment operator. Sets the contents of this SourceFilterType to the contents of the SourceFilterType on the
    ...
    *      set the contents of this SourceFilterType.
    * @return A reference to this SourceFilterType.
    */
  SourceFilterType& operator=(const SourceFilterType& rhs) {
    (void)rhs;
...
#endif // UCI_TYPE_SOURCEFILTERTYPE_H
