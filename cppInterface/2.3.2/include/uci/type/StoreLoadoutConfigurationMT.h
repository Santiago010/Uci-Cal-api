/** @file StoreLoadoutConfigurationMT.h
 *
...
#ifndef UCI_TYPE_STORELOADOUTCONFIGURATIONMT_H
#define UCI_TYPE_STORELOADOUTCONFIGURATIONMT_H
...
#include "StoreLoadoutConfigurationMDT.h"
...
/** This represents the different possible loadouts for the aircraft. Each loadout is a valid combination of items that
  * could be installed on the aircraft at the same time.
  */
class StoreLoadoutConfigurationMT : public virtual MessageType {
public:

  /** This method constructs a new StoreLoadoutConfigurationMT.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed StoreLoadoutConfigurationMT.
    */
  static UCI_EXPORT StoreLoadoutConfigurationMT& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new StoreLoadoutConfigurationMT initializing the data accessed by the new
    * StoreLoadoutConfigurationMT using the data accessed by the specified StoreLoadoutConfigurationMT (cloning).
    *
    * @param accessor The StoreLoadoutConfigurationMT that provides access to the data that is to be used to initialize the
    *      data accessed by the new created StoreLoadoutConfigurationMT.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed StoreLoadoutConfigurationMT.
    */
  static UCI_EXPORT StoreLoadoutConfigurationMT& create(const StoreLoadoutConfigurationMT& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified StoreLoadoutConfigurationMT. Use of the specified accessor after it has been
    * destroyed will result in undefined behavior.
    *
    * @param accessor The StoreLoadoutConfigurationMT that is to be destroyed.
    */
  static UCI_EXPORT void destroy(StoreLoadoutConfigurationMT& accessor);

  /** Returns this accessor's type constant, i.e. storeLoadoutConfigurationMT.
    *
    * @return This accessor's type constant, i.e. storeLoadoutConfigurationMT.
    */
  virtual uci::base::accessorType::AccessorType getAccessorType() const noexception {
    return uci::type::accessorType::storeLoadoutConfigurationMT;
  }

  /** Returns the version that was initialized from the uci:version attribute of StoreLoadoutConfigurationMT.
    *
    * @return The version that was initialized from the uci:version attribute of StoreLoadoutConfigurationMT.
    */
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const StoreLoadoutConfigurationMT& accessor) = 0;
  ...
  /** Sets the value of the enumeration identified by ObjectState.
    ...
    */
  virtual uci::type::StoreLoadoutConfigurationMT& setObjectState(const uci::type::ObjectStateEnum& value) = 0;
  ...
  /** Sets the value of the enumeration identified by ObjectState.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::StoreLoadoutConfigurationMT& setObjectState(uci::type::ObjectStateEnum::EnumerationItem value) = 0;
  ...
  /** Clears (disabled) the Element identified by ObjectState.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::StoreLoadoutConfigurationMT& clearObjectState() = 0;
  ...
  /** Returns a const reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual const uci::type::StoreLoadoutConfigurationMDT& getMessageData() const = 0;
  ...
  /** Returns a reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual uci::type::StoreLoadoutConfigurationMDT& getMessageData() = 0;
  ...
  /** Sets the complex content identified by MessageData to the contents of the complex content accessed by the specified
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::StoreLoadoutConfigurationMT& setMessageData(const uci::type::StoreLoadoutConfigurationMDT& value) = 0;

  /** The Listener provides the support to listen and handle incoming messages of the type
    * uci::type::StoreLoadoutConfigurationMT.
    */
  ...
  public:
    ...
    /** The method is used to handle incoming messages.
      ...
      */
    virtual void handleMessage(const uci::type::StoreLoadoutConfigurationMT& message) = 0;
  ...
  public:
    ...
    /** Adds a listener to this reader to handle incoming messages.
      ...
      */
    virtual void addListener(uci::type::StoreLoadoutConfigurationMT::Listener& listener) = 0;

    /** Removes the specified listener from this reader.
      *
      * @param listener The listener that is to be removed from this reader.
      */
    virtual void removeListener(uci::type::StoreLoadoutConfigurationMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s). Returns immediately if no messages are available.
      ...
      */
    virtual unsigned long readNoWait(unsigned long maxNumberOfMessages, uci::type::StoreLoadoutConfigurationMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s).
      ...
      * @return The number of messages that were handled.
      */
    virtual unsigned long read(unsigned long timeout, unsigned long maxNumberOfMessages, uci::type::StoreLoadoutConfigurationMT::Listener& listener) = 0;
  ...
  /** This method creates a new reader that can be used to read a StoreLoadoutConfigurationMT.
    *
    * @param topic The specification of the topic the reader is to read from.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A reader that can read a StoreLoadoutConfigurationMT.
    */
  static UCI_EXPORT uci::type::StoreLoadoutConfigurationMT::Reader& createReader(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a reader. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyReader(uci::type::StoreLoadoutConfigurationMT::Reader& reader);
  ...
  public:
    ...
    /** Writes the OMS message to the topic specified when this Writer was created.
      ...
      */
    virtual void write(uci::type::StoreLoadoutConfigurationMT& accessor) = 0;
  ...
  /** This method creates a new writer that can be used to write a StoreLoadoutConfigurationMT.
    *
    * @param topic The specification of the topic the writer is to write to.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A writer that can write a StoreLoadoutConfigurationMT.
    */
  static UCI_EXPORT uci::type::StoreLoadoutConfigurationMT::Writer& createWriter(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a writer. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyWriter(uci::type::StoreLoadoutConfigurationMT::Writer& writer);
...
protected:
  ...
  /** The copy constructor [only available to derived classes].
    *
    * @param rhs The StoreLoadoutConfigurationMT to copy from.
    */
  StoreLoadoutConfigurationMT(const StoreLoadoutConfigurationMT& rhs) {
    (void)rhs;
  }

  /** The assignment operator. Sets the contents of this StoreLoadoutConfigurationMT to the contents of the
    * StoreLoadoutConfigurationMT on the right hand side (rhs) of the assignment operator [only available to derived
    * classes].
    *
    * @param rhs The StoreLoadoutConfigurationMT on the right hand side (rhs) of the assignment operator whose contents are
    *      used to set the contents of this StoreLoadoutConfigurationMT.
    * @return A reference to this StoreLoadoutConfigurationMT.
    */
  StoreLoadoutConfigurationMT& operator=(const StoreLoadoutConfigurationMT& rhs) {
    (void)rhs;
...
#endif // UCI_TYPE_STORELOADOUTCONFIGURATIONMT_H
