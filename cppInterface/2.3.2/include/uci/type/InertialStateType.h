...
#ifndef UCI_TYPE_INERTIALSTATETYPE_H
#define UCI_TYPE_INERTIALSTATETYPE_H

#include "../base/Accessor.h"
#include "../base/export.h"
#include "Acceleration3D_Type.h"
#include "Link16_PositionQualityType.h"
...
public:
  ...
  /** This method constructs a new InertialStateType.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed InertialStateType.
    */
  static UCI_EXPORT InertialStateType& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new InertialStateType initializing the data accessed by the new InertialStateType using the
    * data accessed by the specified InertialStateType (cloning).
    *
    * @param accessor The InertialStateType that provides access to the data that is to be used to initialize the data
    *      accessed by the new created InertialStateType.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed InertialStateType.
    */
  static UCI_EXPORT InertialStateType& create(const InertialStateType& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified InertialStateType. Use of the specified accessor after it has been destroyed will
    * result in undefined behavior.
    *
    * @param accessor The InertialStateType that is to be destroyed.
    */
  static UCI_EXPORT void destroy(InertialStateType& accessor);
  ...
  /** Returns the version that was initialized from the uci:version attribute of InertialStateType.
    *
    * @return The version that was initialized from the uci:version attribute of InertialStateType.
    */
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const InertialStateType& accessor) = 0;
  ...
  /** Sets the complex content identified by Position to the contents of the complex content accessed by the specified
    ...
    */
  virtual uci::type::InertialStateType& setPosition(const uci::type::Point4D_Type& value) = 0;
  ...
  /** Sets the complex content identified by PositionUncertainty to the contents of the complex content accessed by the
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::InertialStateType& setPositionUncertainty(const uci::type::UncertaintyType& value) = 0;
  ...
  /** Clears (disabled) the Element identified by PositionUncertainty.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::InertialStateType& clearPositionUncertainty() = 0;
  ...
  /** Sets the complex content identified by DomainVelocity to the contents of the complex content accessed by the
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::InertialStateType& setDomainVelocity(const uci::type::Velocity3D_Type& value) = 0;
  ...
  /** Clears (disabled) the Element identified by DomainVelocity.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::InertialStateType& clearDomainVelocity() = 0;
  ...
  /** Sets the complex content identified by GroundVelocity to the contents of the complex content accessed by the
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::InertialStateType& setGroundVelocity(const uci::type::Velocity2D_Type& value) = 0;
  ...
  /** Clears (disabled) the Element identified by GroundVelocity.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::InertialStateType& clearGroundVelocity() = 0;
  ...
  /** Sets the complex content identified by DomainAcceleration to the contents of the complex content accessed by the
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::InertialStateType& setDomainAcceleration(const uci::type::Acceleration3D_Type& value) = 0;
  ...
  /** Clears (disabled) the Element identified by DomainAcceleration.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::InertialStateType& clearDomainAcceleration() = 0;
  ...
  /** Sets the complex content identified by Orientation to the contents of the complex content accessed by the specified
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::InertialStateType& setOrientation(const uci::type::OrientationType& value) = 0;
  ...
  /** Clears (disabled) the Element identified by Orientation.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::InertialStateType& clearOrientation() = 0;
  ...
  /** Sets the complex content identified by OrientationRate to the contents of the complex content accessed by the
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::InertialStateType& setOrientationRate(const uci::type::OrientationRateType& value) = 0;
  ...
  /** Clears (disabled) the Element identified by OrientationRate.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::InertialStateType& clearOrientationRate() = 0;

  /** Returns the value of the SimplePrimitive data type identified by Link16PositionQuality.
    *
    * @return The value of the simple primitive data type identified by Link16PositionQuality.
    */
  virtual uci::type::Link16_PositionQualityTypeValue getLink16PositionQuality() const = 0;

  /** Sets the value of the SimplePrimitive data type identified by Link16PositionQuality.
    *
    * @param value The value to set the SimplePrimitve data type to.
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::InertialStateType& setLink16PositionQuality(uci::type::Link16_PositionQualityTypeValue value) = 0;

  /** Returns whether the Element identified by Link16PositionQuality exists (is enabled) or not.
    *
    * @return A boolean indicating whether the Element identified by Link16PositionQuality is enabled or not.
    */
  virtual bool hasLink16PositionQuality() const = 0;

  /** Clears (disabled) the Element identified by Link16PositionQuality.
    *
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::InertialStateType& clearLink16PositionQuality() = 0;
...
protected:
  ...
  /** The assignment operator. Sets the contents of this InertialStateType to the contents of the InertialStateType on the
    ...
    *      set the contents of this InertialStateType.
    * @return A reference to this InertialStateType.
    */
  InertialStateType& operator=(const InertialStateType& rhs) {
    (void)rhs;
...
#endif // UCI_TYPE_INERTIALSTATETYPE_H
