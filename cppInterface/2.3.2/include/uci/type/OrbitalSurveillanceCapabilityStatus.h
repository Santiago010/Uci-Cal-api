/** @file OrbitalSurveillanceCapabilityStatus.h
 *
...
typedef uci::type::OrbitalSurveillanceCapabilityStatusMT OrbitalSurveillanceCapabilityStatus;

} // namespace type
} // namespace uci

#endif // UCI_TYPE_ORBITALSURVEILLANCECAPABILITYSTATUS_H
