/** @file EntityOrbitalEphemerisMT.h
 *
...
#ifndef UCI_TYPE_ENTITYORBITALEPHEMERISMT_H
#define UCI_TYPE_ENTITYORBITALEPHEMERISMT_H

#include "../base/Listener.h"
#include "../base/Reader.h"
#include "../base/Writer.h"
#include "../base/export.h"
#include "EntityOrbitalEphemerisMDT.h"
...
/** Indicates the Ephemeris ID, Entity's ID, the parameters used for creating the ephemeris, the ephemeris data, and the
  * Request's ID (if message is generated in response to a request).
  */
class EntityOrbitalEphemerisMT : public virtual MessageType {
public:

  /** This method constructs a new EntityOrbitalEphemerisMT.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed EntityOrbitalEphemerisMT.
    */
  static UCI_EXPORT EntityOrbitalEphemerisMT& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new EntityOrbitalEphemerisMT initializing the data accessed by the new
    * EntityOrbitalEphemerisMT using the data accessed by the specified EntityOrbitalEphemerisMT (cloning).
    *
    * @param accessor The EntityOrbitalEphemerisMT that provides access to the data that is to be used to initialize the
    *      data accessed by the new created EntityOrbitalEphemerisMT.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed EntityOrbitalEphemerisMT.
    */
  static UCI_EXPORT EntityOrbitalEphemerisMT& create(const EntityOrbitalEphemerisMT& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified EntityOrbitalEphemerisMT. Use of the specified accessor after it has been
    * destroyed will result in undefined behavior.
    *
    * @param accessor The EntityOrbitalEphemerisMT that is to be destroyed.
    */
  static UCI_EXPORT void destroy(EntityOrbitalEphemerisMT& accessor);

  /** Returns this accessor's type constant, i.e. entityOrbitalEphemerisMT.
    *
    * @return This accessor's type constant, i.e. entityOrbitalEphemerisMT.
    */
  virtual uci::base::accessorType::AccessorType getAccessorType() const noexception {
    return uci::type::accessorType::entityOrbitalEphemerisMT;
  }

  /** Returns the version that was initialized from the uci:version attribute of EntityOrbitalEphemerisMT.
    *
    * @return The version that was initialized from the uci:version attribute of EntityOrbitalEphemerisMT.
    */
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const EntityOrbitalEphemerisMT& accessor) = 0;
  ...
  /** Sets the value of the enumeration identified by ObjectState.
    ...
    */
  virtual uci::type::EntityOrbitalEphemerisMT& setObjectState(const uci::type::ObjectStateEnum& value) = 0;
  ...
  /** Sets the value of the enumeration identified by ObjectState.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::EntityOrbitalEphemerisMT& setObjectState(uci::type::ObjectStateEnum::EnumerationItem value) = 0;
  ...
  /** Clears (disabled) the Element identified by ObjectState.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::EntityOrbitalEphemerisMT& clearObjectState() = 0;
  ...
  /** Returns a const reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual const uci::type::EntityOrbitalEphemerisMDT& getMessageData() const = 0;
  ...
  /** Returns a reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual uci::type::EntityOrbitalEphemerisMDT& getMessageData() = 0;
  ...
  /** Sets the complex content identified by MessageData to the contents of the complex content accessed by the specified
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::EntityOrbitalEphemerisMT& setMessageData(const uci::type::EntityOrbitalEphemerisMDT& value) = 0;

  /** The Listener provides the support to listen and handle incoming messages of the type
    * uci::type::EntityOrbitalEphemerisMT.
    */
  ...
  public:
    ...
    /** The method is used to handle incoming messages.
      ...
      */
    virtual void handleMessage(const uci::type::EntityOrbitalEphemerisMT& message) = 0;
  ...
  public:
    ...
    /** Adds a listener to this reader to handle incoming messages.
      ...
      */
    virtual void addListener(uci::type::EntityOrbitalEphemerisMT::Listener& listener) = 0;

    /** Removes the specified listener from this reader.
      *
      * @param listener The listener that is to be removed from this reader.
      */
    virtual void removeListener(uci::type::EntityOrbitalEphemerisMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s). Returns immediately if no messages are available.
      ...
      */
    virtual unsigned long readNoWait(unsigned long maxNumberOfMessages, uci::type::EntityOrbitalEphemerisMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s).
      ...
      * @return The number of messages that were handled.
      */
    virtual unsigned long read(unsigned long timeout, unsigned long maxNumberOfMessages, uci::type::EntityOrbitalEphemerisMT::Listener& listener) = 0;
  ...
  /** This method creates a new reader that can be used to read a EntityOrbitalEphemerisMT.
    *
    * @param topic The specification of the topic the reader is to read from.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A reader that can read a EntityOrbitalEphemerisMT.
    */
  static UCI_EXPORT uci::type::EntityOrbitalEphemerisMT::Reader& createReader(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a reader. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyReader(uci::type::EntityOrbitalEphemerisMT::Reader& reader);
  ...
  public:
    ...
    /** Writes the OMS message to the topic specified when this Writer was created.
      ...
      */
    virtual void write(uci::type::EntityOrbitalEphemerisMT& accessor) = 0;
  ...
  /** This method creates a new writer that can be used to write a EntityOrbitalEphemerisMT.
    *
    * @param topic The specification of the topic the writer is to write to.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A writer that can write a EntityOrbitalEphemerisMT.
    */
  static UCI_EXPORT uci::type::EntityOrbitalEphemerisMT::Writer& createWriter(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a writer. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyWriter(uci::type::EntityOrbitalEphemerisMT::Writer& writer);
...
protected:
  ...
  /** The copy constructor [only available to derived classes].
    *
    * @param rhs The EntityOrbitalEphemerisMT to copy from.
    */
  EntityOrbitalEphemerisMT(const EntityOrbitalEphemerisMT& rhs) {
    (void)rhs;
  }

  /** The assignment operator. Sets the contents of this EntityOrbitalEphemerisMT to the contents of the
    * EntityOrbitalEphemerisMT on the right hand side (rhs) of the assignment operator [only available to derived classes].
    *
    * @param rhs The EntityOrbitalEphemerisMT on the right hand side (rhs) of the assignment operator whose contents are
    *      used to set the contents of this EntityOrbitalEphemerisMT.
    * @return A reference to this EntityOrbitalEphemerisMT.
    */
  EntityOrbitalEphemerisMT& operator=(const EntityOrbitalEphemerisMT& rhs) {
    (void)rhs;
...
#endif // UCI_TYPE_ENTITYORBITALEPHEMERISMT_H
