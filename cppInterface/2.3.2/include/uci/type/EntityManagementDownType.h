/** @file EntityManagementDownType.h
 *
...
#ifndef UCI_TYPE_ENTITYMANAGEMENTDOWNTYPE_H
#define UCI_TYPE_ENTITYMANAGEMENTDOWNTYPE_H
...
public:
  ...
  /** This method constructs a new EntityManagementDownType.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed EntityManagementDownType.
    */
  static UCI_EXPORT EntityManagementDownType& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new EntityManagementDownType initializing the data accessed by the new
    * EntityManagementDownType using the data accessed by the specified EntityManagementDownType (cloning).
    *
    * @param accessor The EntityManagementDownType that provides access to the data that is to be used to initialize the
    *      data accessed by the new created EntityManagementDownType.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed EntityManagementDownType.
    */
  static UCI_EXPORT EntityManagementDownType& create(const EntityManagementDownType& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified EntityManagementDownType. Use of the specified accessor after it has been
    * destroyed will result in undefined behavior.
    *
    * @param accessor The EntityManagementDownType that is to be destroyed.
    */
  static UCI_EXPORT void destroy(EntityManagementDownType& accessor);
  ...
  /** Returns the version that was initialized from the uci:version attribute of EntityManagementDownType.
    *
    * @return The version that was initialized from the uci:version attribute of EntityManagementDownType.
    */
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const EntityManagementDownType& accessor) = 0;
  ...
  /** Sets the complex content identified by EntityID to the contents of the complex content accessed by the specified
    ...
    */
  virtual uci::type::EntityManagementDownType& setEntityID(const uci::type::EntityID_Type& value) = 0;
  ...
  /** Sets the value of the SimplePrimitive data type identified by Enabled.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::EntityManagementDownType& setEnabled(xs::Boolean value) = 0;
  ...
  /** Sets the complex content identified by DownLocation to the contents of the complex content accessed by the specified
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::EntityManagementDownType& setDownLocation(const uci::type::Point2D_Type& value) = 0;
  ...
  /** Clears (disabled) the Element identified by DownLocation.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::EntityManagementDownType& clearDownLocation() = 0;
...
protected:
  ...
  /** The assignment operator. Sets the contents of this EntityManagementDownType to the contents of the
    * EntityManagementDownType on the right hand side (rhs) of the assignment operator [only available to derived classes].
    *
    * @param rhs The EntityManagementDownType on the right hand side (rhs) of the assignment operator whose contents are
    *      used to set the contents of this EntityManagementDownType.
    * @return A reference to this EntityManagementDownType.
    */
  EntityManagementDownType& operator=(const EntityManagementDownType& rhs) {
    (void)rhs;
...
#endif // UCI_TYPE_ENTITYMANAGEMENTDOWNTYPE_H
