...
#ifndef UCI_TYPE_ACTIVITYPLANCOMMANDMT_H
#define UCI_TYPE_ACTIVITYPLANCOMMANDMT_H

#include "../base/Listener.h"
#include "../base/Reader.h"
#include "../base/Writer.h"
#include "../base/export.h"
#include "ActivityPlanCommandMDT.h"
...
class ActivityPlanCommandMT : public virtual MessageType {
public:

  /** This method constructs a new ActivityPlanCommandMT.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed ActivityPlanCommandMT.
    */
  static UCI_EXPORT ActivityPlanCommandMT& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new ActivityPlanCommandMT initializing the data accessed by the new ActivityPlanCommandMT
    * using the data accessed by the specified ActivityPlanCommandMT (cloning).
    *
    * @param accessor The ActivityPlanCommandMT that provides access to the data that is to be used to initialize the data
    *      accessed by the new created ActivityPlanCommandMT.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed ActivityPlanCommandMT.
    */
  static UCI_EXPORT ActivityPlanCommandMT& create(const ActivityPlanCommandMT& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified ActivityPlanCommandMT. Use of the specified accessor after it has been destroyed
    * will result in undefined behavior.
    *
    * @param accessor The ActivityPlanCommandMT that is to be destroyed.
    */
  static UCI_EXPORT void destroy(ActivityPlanCommandMT& accessor);

  /** Returns this accessor's type constant, i.e. activityPlanCommandMT.
    *
    * @return This accessor's type constant, i.e. activityPlanCommandMT.
    */
  virtual uci::base::accessorType::AccessorType getAccessorType() const noexception {
    return uci::type::accessorType::activityPlanCommandMT;
  }

  /** Returns the version that was initialized from the uci:version attribute of ActivityPlanCommandMT.
    *
    * @return The version that was initialized from the uci:version attribute of ActivityPlanCommandMT.
    */
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const ActivityPlanCommandMT& accessor) = 0;
  ...
  /** Returns a const reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual const uci::type::ActivityPlanCommandMDT& getMessageData() const = 0;
  ...
  /** Returns a reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual uci::type::ActivityPlanCommandMDT& getMessageData() = 0;
  ...
  /** Sets the complex content identified by MessageData to the contents of the complex content accessed by the specified
    ...
    */
  virtual uci::type::ActivityPlanCommandMT& setMessageData(const uci::type::ActivityPlanCommandMDT& value) = 0;

  /** The Listener provides the support to listen and handle incoming messages of the type
    * uci::type::ActivityPlanCommandMT.
    */
  ...
  public:
    ...
    /** The method is used to handle incoming messages.
      ...
      */
    virtual void handleMessage(const uci::type::ActivityPlanCommandMT& message) = 0;
  ...
  public:
    ...
    /** Adds a listener to this reader to handle incoming messages.
      ...
      */
    virtual void addListener(uci::type::ActivityPlanCommandMT::Listener& listener) = 0;

    /** Removes the specified listener from this reader.
      *
      * @param listener The listener that is to be removed from this reader.
      */
    virtual void removeListener(uci::type::ActivityPlanCommandMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s). Returns immediately if no messages are available.
      ...
      */
    virtual unsigned long readNoWait(unsigned long maxNumberOfMessages, uci::type::ActivityPlanCommandMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s).
      ...
      * @return The number of messages that were handled.
      */
    virtual unsigned long read(unsigned long timeout, unsigned long maxNumberOfMessages, uci::type::ActivityPlanCommandMT::Listener& listener) = 0;
  ...
  /** This method creates a new reader that can be used to read a ActivityPlanCommandMT.
    *
    * @param topic The specification of the topic the reader is to read from.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A reader that can read a ActivityPlanCommandMT.
    */
  static UCI_EXPORT uci::type::ActivityPlanCommandMT::Reader& createReader(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a reader. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyReader(uci::type::ActivityPlanCommandMT::Reader& reader);
  ...
  public:
    ...
    /** Writes the OMS message to the topic specified when this Writer was created.
      ...
      */
    virtual void write(uci::type::ActivityPlanCommandMT& accessor) = 0;
  ...
  /** This method creates a new writer that can be used to write a ActivityPlanCommandMT.
    *
    * @param topic The specification of the topic the writer is to write to.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A writer that can write a ActivityPlanCommandMT.
    */
  static UCI_EXPORT uci::type::ActivityPlanCommandMT::Writer& createWriter(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a writer. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyWriter(uci::type::ActivityPlanCommandMT::Writer& writer);
...
protected:
  ...
  /** The copy constructor [only available to derived classes].
    *
    * @param rhs The ActivityPlanCommandMT to copy from.
    */
  ActivityPlanCommandMT(const ActivityPlanCommandMT& rhs) {
    (void)rhs;
  }

  /** The assignment operator. Sets the contents of this ActivityPlanCommandMT to the contents of the ActivityPlanCommandMT
    * on the right hand side (rhs) of the assignment operator [only available to derived classes].
    *
    * @param rhs The ActivityPlanCommandMT on the right hand side (rhs) of the assignment operator whose contents are used
    *      to set the contents of this ActivityPlanCommandMT.
    * @return A reference to this ActivityPlanCommandMT.
    */
  ActivityPlanCommandMT& operator=(const ActivityPlanCommandMT& rhs) {
    (void)rhs;
...
#endif // UCI_TYPE_ACTIVITYPLANCOMMANDMT_H
