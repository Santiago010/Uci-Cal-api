...
#ifndef UCI_TYPE_SYSTEMREADINESSMT_H
#define UCI_TYPE_SYSTEMREADINESSMT_H
...
class SystemReadinessMT : public virtual MessageType {
public:

  /** This method constructs a new SystemReadinessMT.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed SystemReadinessMT.
    */
  static UCI_EXPORT SystemReadinessMT& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new SystemReadinessMT initializing the data accessed by the new SystemReadinessMT using the
    * data accessed by the specified SystemReadinessMT (cloning).
    *
    * @param accessor The SystemReadinessMT that provides access to the data that is to be used to initialize the data
    *      accessed by the new created SystemReadinessMT.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed SystemReadinessMT.
    */
  static UCI_EXPORT SystemReadinessMT& create(const SystemReadinessMT& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified SystemReadinessMT. Use of the specified accessor after it has been destroyed will
    * result in undefined behavior.
    *
    * @param accessor The SystemReadinessMT that is to be destroyed.
    */
  static UCI_EXPORT void destroy(SystemReadinessMT& accessor);

  /** Returns this accessor's type constant, i.e. systemReadinessMT.
    *
    * @return This accessor's type constant, i.e. systemReadinessMT.
    */
  virtual uci::base::accessorType::AccessorType getAccessorType() const noexception {
    return uci::type::accessorType::systemReadinessMT;
  }

  /** Returns the version that was initialized from the uci:version attribute of SystemReadinessMT.
    *
    * @return The version that was initialized from the uci:version attribute of SystemReadinessMT.
    */
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const SystemReadinessMT& accessor) = 0;
  ...
  /** Sets the value of the enumeration identified by ObjectState.
    ...
    */
  virtual uci::type::SystemReadinessMT& setObjectState(const uci::type::ObjectStateEnum& value) = 0;
  ...
  /** Sets the value of the enumeration identified by ObjectState.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::SystemReadinessMT& setObjectState(uci::type::ObjectStateEnum::EnumerationItem value) = 0;
  ...
  /** Clears (disabled) the Element identified by ObjectState.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::SystemReadinessMT& clearObjectState() = 0;
  ...
  /** Returns a const reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual const uci::type::SystemReadinessMDT& getMessageData() const = 0;
  ...
  /** Returns a reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual uci::type::SystemReadinessMDT& getMessageData() = 0;
  ...
  /** Sets the complex content identified by MessageData to the contents of the complex content accessed by the specified
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::SystemReadinessMT& setMessageData(const uci::type::SystemReadinessMDT& value) = 0;

  /** The Listener provides the support to listen and handle incoming messages of the type uci::type::SystemReadinessMT. */
  ...
  public:
    ...
    /** The method is used to handle incoming messages.
      ...
      */
    virtual void handleMessage(const uci::type::SystemReadinessMT& message) = 0;
  ...
  public:
    ...
    /** Adds a listener to this reader to handle incoming messages.
      ...
      */
    virtual void addListener(uci::type::SystemReadinessMT::Listener& listener) = 0;

    /** Removes the specified listener from this reader.
      *
      * @param listener The listener that is to be removed from this reader.
      */
    virtual void removeListener(uci::type::SystemReadinessMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s). Returns immediately if no messages are available.
      ...
      */
    virtual unsigned long readNoWait(unsigned long maxNumberOfMessages, uci::type::SystemReadinessMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s).
      ...
      * @return The number of messages that were handled.
      */
    virtual unsigned long read(unsigned long timeout, unsigned long maxNumberOfMessages, uci::type::SystemReadinessMT::Listener& listener) = 0;
  ...
  /** This method creates a new reader that can be used to read a SystemReadinessMT.
    *
    * @param topic The specification of the topic the reader is to read from.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A reader that can read a SystemReadinessMT.
    */
  static UCI_EXPORT uci::type::SystemReadinessMT::Reader& createReader(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a reader. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyReader(uci::type::SystemReadinessMT::Reader& reader);
  ...
  public:
    ...
    /** Writes the OMS message to the topic specified when this Writer was created.
      ...
      */
    virtual void write(uci::type::SystemReadinessMT& accessor) = 0;
  ...
  /** This method creates a new writer that can be used to write a SystemReadinessMT.
    *
    * @param topic The specification of the topic the writer is to write to.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A writer that can write a SystemReadinessMT.
    */
  static UCI_EXPORT uci::type::SystemReadinessMT::Writer& createWriter(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a writer. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyWriter(uci::type::SystemReadinessMT::Writer& writer);
...
protected:
  ...
  /** The copy constructor [only available to derived classes].
    *
    * @param rhs The SystemReadinessMT to copy from.
    */
  SystemReadinessMT(const SystemReadinessMT& rhs) {
    (void)rhs;
  }

  /** The assignment operator. Sets the contents of this SystemReadinessMT to the contents of the SystemReadinessMT on the
    * right hand side (rhs) of the assignment operator [only available to derived classes].
    *
    * @param rhs The SystemReadinessMT on the right hand side (rhs) of the assignment operator whose contents are used to
    *      set the contents of this SystemReadinessMT.
    * @return A reference to this SystemReadinessMT.
    */
  SystemReadinessMT& operator=(const SystemReadinessMT& rhs) {
    (void)rhs;
...
#endif // UCI_TYPE_SYSTEMREADINESSMT_H
