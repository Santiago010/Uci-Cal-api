...
/** This is a polymorphic extension which allows for the extension of the base CommWaveformActivityCommandPET for
  ...
  */
class CommUHF_SATCOM_CommWaveformActivityCommandType : public virtual CommWaveformActivityCommandPET {
public:

  /** This method constructs a new CommUHF_SATCOM_CommWaveformActivityCommandType.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed CommUHF_SATCOM_CommWaveformActivityCommandType.
    */
  static UCI_EXPORT CommUHF_SATCOM_CommWaveformActivityCommandType& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new CommUHF_SATCOM_CommWaveformActivityCommandType initializing the data accessed by the new
    * CommUHF_SATCOM_CommWaveformActivityCommandType using the data accessed by the specified
    * CommUHF_SATCOM_CommWaveformActivityCommandType (cloning).
    *
    * @param accessor The CommUHF_SATCOM_CommWaveformActivityCommandType that provides access to the data that is to be
    *      used to initialize the data accessed by the new created CommUHF_SATCOM_CommWaveformActivityCommandType.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed CommUHF_SATCOM_CommWaveformActivityCommandType.
    */
  static UCI_EXPORT CommUHF_SATCOM_CommWaveformActivityCommandType& create(const CommUHF_SATCOM_CommWaveformActivityCommandType& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified CommUHF_SATCOM_CommWaveformActivityCommandType. Use of the specified accessor
    * after it has been destroyed will result in undefined behavior.
    *
    * @param accessor The CommUHF_SATCOM_CommWaveformActivityCommandType that is to be destroyed.
    */
  static UCI_EXPORT void destroy(CommUHF_SATCOM_CommWaveformActivityCommandType& accessor);
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const CommUHF_SATCOM_CommWaveformActivityCommandType& accessor) = 0;
  ...
  /** Sets the complex content identified by RangeDelay to the contents of the complex content accessed by the specified
    ...
    */
  virtual uci::type::CommUHF_SATCOM_CommWaveformActivityCommandType& setRangeDelay(const uci::type::CommRangeDelayChoiceType& value) = 0;
  ...
  /** Sets the value of the enumeration identified by RangeMode.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::CommUHF_SATCOM_CommWaveformActivityCommandType& setRangeMode(const uci::type::CommRangeModeTypeEnum& value) = 0;
  ...
  /** Sets the value of the enumeration identified by RangeMode.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::CommUHF_SATCOM_CommWaveformActivityCommandType& setRangeMode(uci::type::CommRangeModeTypeEnum::EnumerationItem value) = 0;
  ...
  /** Clears (disabled) the Element identified by RangeMode.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::CommUHF_SATCOM_CommWaveformActivityCommandType& clearRangeMode() = 0;
  ...
  /** Sets the value of the enumeration identified by ServiceType.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::CommUHF_SATCOM_CommWaveformActivityCommandType& setServiceType(const uci::type::CommSATCOM_ServiceTypeEnum& value) = 0;
  ...
  /** Sets the value of the enumeration identified by ServiceType.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::CommUHF_SATCOM_CommWaveformActivityCommandType& setServiceType(uci::type::CommSATCOM_ServiceTypeEnum::EnumerationItem value) = 0;
  ...
  /** Clears (disabled) the Element identified by ServiceType.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::CommUHF_SATCOM_CommWaveformActivityCommandType& clearServiceType() = 0;
  ...
  /** Sets the complex content identified by ConfigurationCode to the contents of the complex content accessed by the
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::CommUHF_SATCOM_CommWaveformActivityCommandType& setConfigurationCode(const uci::type::ForeignKeyType& value) = 0;
  ...
  /** Clears (disabled) the Element identified by ConfigurationCode.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::CommUHF_SATCOM_CommWaveformActivityCommandType& clearConfigurationCode() = 0;
  ...
  /** Sets the value of the SimplePrimitive data type identified by OrderwireEncryption.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::CommUHF_SATCOM_CommWaveformActivityCommandType& setOrderwireEncryption(xs::Boolean value) = 0;
  ...
  /** Clears (disabled) the Element identified by OrderwireEncryption.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::CommUHF_SATCOM_CommWaveformActivityCommandType& clearOrderwireEncryption() = 0;
  ...
  /** Sets the complex content identified by SatelliteKey to the contents of the complex content accessed by the specified
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::CommUHF_SATCOM_CommWaveformActivityCommandType& setSatelliteKey(const uci::type::ForeignKeyType& value) = 0;
  ...
  /** Clears (disabled) the Element identified by SatelliteKey.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::CommUHF_SATCOM_CommWaveformActivityCommandType& clearSatelliteKey() = 0;
  ...
  /** Returns a const reference to the bounded list identified by GuardSlotKey.
    ...
    */
  virtual const uci::type::CommUHF_SATCOM_CommWaveformActivityCommandType::GuardSlotKey& getGuardSlotKey() const = 0;
  ...
  /** Returns a reference to the bounded list identified by GuardSlotKey.
    ...
    */
  virtual uci::type::CommUHF_SATCOM_CommWaveformActivityCommandType::GuardSlotKey& getGuardSlotKey() = 0;
  ...
  /** Sets the bounded list identified by GuardSlotKey.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::CommUHF_SATCOM_CommWaveformActivityCommandType& setGuardSlotKey(const uci::type::CommUHF_SATCOM_CommWaveformActivityCommandType::GuardSlotKey& value) = 0;
...
protected:
  ...
  /** The assignment operator. Sets the contents of this CommUHF_SATCOM_CommWaveformActivityCommandType to the contents of
    * the CommUHF_SATCOM_CommWaveformActivityCommandType on the right hand side (rhs) of the assignment operator [only
    * available to derived classes].
    *
    * @param rhs The CommUHF_SATCOM_CommWaveformActivityCommandType on the right hand side (rhs) of the assignment operator
    *      whose contents are used to set the contents of this CommUHF_SATCOM_CommWaveformActivityCommandType.
    * @return A reference to this CommUHF_SATCOM_CommWaveformActivityCommandType.
    */
  CommUHF_SATCOM_CommWaveformActivityCommandType& operator=(const CommUHF_SATCOM_CommWaveformActivityCommandType& rhs) {
    (void)rhs;
...
#endif // UCI_TYPE_COMMUHF_SATCOM_COMMWAVEFORMACTIVITYCOMMANDTYPE_H
