...
#ifndef UCI_TYPE_ENTITYMANAGEMENTSETVOICECONTROLTYPE_H
#define UCI_TYPE_ENTITYMANAGEMENTSETVOICECONTROLTYPE_H
...
public:
  ...
  /** This method constructs a new EntityManagementSetVoiceControlType.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed EntityManagementSetVoiceControlType.
    */
  static UCI_EXPORT EntityManagementSetVoiceControlType& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new EntityManagementSetVoiceControlType initializing the data accessed by the new
    * EntityManagementSetVoiceControlType using the data accessed by the specified EntityManagementSetVoiceControlType
    * (cloning).
    *
    * @param accessor The EntityManagementSetVoiceControlType that provides access to the data that is to be used to
    *      initialize the data accessed by the new created EntityManagementSetVoiceControlType.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed EntityManagementSetVoiceControlType.
    */
  static UCI_EXPORT EntityManagementSetVoiceControlType& create(const EntityManagementSetVoiceControlType& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified EntityManagementSetVoiceControlType. Use of the specified accessor after it has
    * been destroyed will result in undefined behavior.
    *
    * @param accessor The EntityManagementSetVoiceControlType that is to be destroyed.
    */
  static UCI_EXPORT void destroy(EntityManagementSetVoiceControlType& accessor);
  ...
  /** Returns the version that was initialized from the uci:version attribute of EntityManagementSetVoiceControlType.
    *
    * @return The version that was initialized from the uci:version attribute of EntityManagementSetVoiceControlType.
    */
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const EntityManagementSetVoiceControlType& accessor) = 0;
  ...
  /** Sets the complex content identified by EntityID to the contents of the complex content accessed by the specified
    ...
    */
  virtual uci::type::EntityManagementSetVoiceControlType& setEntityID(const uci::type::EntityID_Type& value) = 0;
  ...
  /** Sets the complex content identified by VoiceControl to the contents of the complex content accessed by the specified
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::EntityManagementSetVoiceControlType& setVoiceControl(const uci::type::VoiceControlType& value) = 0;
...
protected:
  ...
  /** The assignment operator. Sets the contents of this EntityManagementSetVoiceControlType to the contents of the
    * EntityManagementSetVoiceControlType on the right hand side (rhs) of the assignment operator [only available to
    * derived classes].
    *
    * @param rhs The EntityManagementSetVoiceControlType on the right hand side (rhs) of the assignment operator whose
    *      contents are used to set the contents of this EntityManagementSetVoiceControlType.
    * @return A reference to this EntityManagementSetVoiceControlType.
    */
  EntityManagementSetVoiceControlType& operator=(const EntityManagementSetVoiceControlType& rhs) {
    (void)rhs;
...
#endif // UCI_TYPE_ENTITYMANAGEMENTSETVOICECONTROLTYPE_H
