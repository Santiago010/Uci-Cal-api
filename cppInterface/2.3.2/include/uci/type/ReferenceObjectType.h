...
#ifndef UCI_TYPE_REFERENCEOBJECTTYPE_H
#define UCI_TYPE_REFERENCEOBJECTTYPE_H
...
public:
  ...
  /** This method constructs a new ReferenceObjectType.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed ReferenceObjectType.
    */
  static UCI_EXPORT ReferenceObjectType& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new ReferenceObjectType initializing the data accessed by the new ReferenceObjectType using
    * the data accessed by the specified ReferenceObjectType (cloning).
    *
    * @param accessor The ReferenceObjectType that provides access to the data that is to be used to initialize the data
    *      accessed by the new created ReferenceObjectType.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed ReferenceObjectType.
    */
  static UCI_EXPORT ReferenceObjectType& create(const ReferenceObjectType& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified ReferenceObjectType. Use of the specified accessor after it has been destroyed
    * will result in undefined behavior.
    *
    * @param accessor The ReferenceObjectType that is to be destroyed.
    */
  static UCI_EXPORT void destroy(ReferenceObjectType& accessor);
  ...
  /** Returns the version that was initialized from the uci:version attribute of ReferenceObjectType.
    *
    * @return The version that was initialized from the uci:version attribute of ReferenceObjectType.
    */
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const ReferenceObjectType& accessor) = 0;
  ...
  /** This method returns this choice's "selection ordinal." A choice's "selection ordinal" is used to specify which
    ...
    */
  virtual ReferenceObjectTypeChoice getReferenceObjectTypeChoiceOrdinal() const = 0;
  ...
  /** This method is used to set this choice's "selection ordinal." A choice's "selection ordinal" is used to specify which
    ...
    */
  virtual uci::type::ReferenceObjectType& setReferenceObjectTypeChoiceOrdinal(ReferenceObjectTypeChoice chosenElementOrdinal, uci::base::accessorType::AccessorType type = uci::base::accessorType::null) = 0;
  ...
  /** Sets the complex content identified by EntityID to the contents of the complex content accessed by the specified
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::ReferenceObjectType& setEntityID(const uci::type::EntityID_Type& value) = 0;
  ...
  /** Sets the complex content identified by OpPointID to the contents of the complex content accessed by the specified
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::ReferenceObjectType& setOpPointID(const uci::type::OpPointID_Type& value) = 0;
  ...
  /** Sets the complex content identified by SystemID to the contents of the complex content accessed by the specified
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::ReferenceObjectType& setSystemID(const uci::type::SystemID_Type& value) = 0;
...
protected:
  ...
  /** The assignment operator. Sets the contents of this ReferenceObjectType to the contents of the ReferenceObjectType on
    ...
    *      set the contents of this ReferenceObjectType.
    * @return A reference to this ReferenceObjectType.
    */
  ReferenceObjectType& operator=(const ReferenceObjectType& rhs) {
    (void)rhs;
...
#endif // UCI_TYPE_REFERENCEOBJECTTYPE_H
