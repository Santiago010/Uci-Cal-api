...
#ifndef UCI_TYPE_SEGMENTCONFLICTSTYPE_H
#define UCI_TYPE_SEGMENTCONFLICTSTYPE_H
...
public:
  ...
  /** This method constructs a new SegmentConflictsType.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed SegmentConflictsType.
    */
  static UCI_EXPORT SegmentConflictsType& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new SegmentConflictsType initializing the data accessed by the new SegmentConflictsType
    * using the data accessed by the specified SegmentConflictsType (cloning).
    *
    * @param accessor The SegmentConflictsType that provides access to the data that is to be used to initialize the data
    *      accessed by the new created SegmentConflictsType.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed SegmentConflictsType.
    */
  static UCI_EXPORT SegmentConflictsType& create(const SegmentConflictsType& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified SegmentConflictsType. Use of the specified accessor after it has been destroyed
    * will result in undefined behavior.
    *
    * @param accessor The SegmentConflictsType that is to be destroyed.
    */
  static UCI_EXPORT void destroy(SegmentConflictsType& accessor);
  ...
  /** Returns the version that was initialized from the uci:version attribute of SegmentConflictsType.
    *
    * @return The version that was initialized from the uci:version attribute of SegmentConflictsType.
    */
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const SegmentConflictsType& accessor) = 0;
  ...
  /** Sets the complex content identified by RoutePlanID to the contents of the complex content accessed by the specified
    ...
    */
  virtual uci::type::SegmentConflictsType& setRoutePlanID(const uci::type::RoutePlanID_Type& value) = 0;
  ...
  /** Sets the complex content identified by MissionPlanID to the contents of the complex content accessed by the specified
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::SegmentConflictsType& setMissionPlanID(const uci::type::MissionPlanID_Type& value) = 0;
  ...
  /** Clears (disabled) the Element identified by MissionPlanID.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::SegmentConflictsType& clearMissionPlanID() = 0;
  ...
  /** Sets the complex content identified by PathID to the contents of the complex content accessed by the specified
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::SegmentConflictsType& setPathID(const uci::type::PathID_Type& value) = 0;
  ...
  /** Sets the complex content identified by PathSegmentID to the contents of the complex content accessed by the specified
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::SegmentConflictsType& setPathSegmentID(const uci::type::SegmentID_Type& value) = 0;
...
protected:
  ...
  /** The assignment operator. Sets the contents of this SegmentConflictsType to the contents of the SegmentConflictsType
    ...
    *      to set the contents of this SegmentConflictsType.
    * @return A reference to this SegmentConflictsType.
    */
  SegmentConflictsType& operator=(const SegmentConflictsType& rhs) {
    (void)rhs;
...
#endif // UCI_TYPE_SEGMENTCONFLICTSTYPE_H
