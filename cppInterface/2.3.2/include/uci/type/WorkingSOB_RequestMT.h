...
#ifndef UCI_TYPE_WORKINGSOB_REQUESTMT_H
#define UCI_TYPE_WORKINGSOB_REQUESTMT_H
...
#include "WorkingSOB_RequestMDT.h"
...
class WorkingSOB_RequestMT : public virtual MessageType {
public:

  /** This method constructs a new WorkingSOB_RequestMT.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed WorkingSOB_RequestMT.
    */
  static UCI_EXPORT WorkingSOB_RequestMT& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new WorkingSOB_RequestMT initializing the data accessed by the new WorkingSOB_RequestMT
    * using the data accessed by the specified WorkingSOB_RequestMT (cloning).
    *
    * @param accessor The WorkingSOB_RequestMT that provides access to the data that is to be used to initialize the data
    *      accessed by the new created WorkingSOB_RequestMT.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed WorkingSOB_RequestMT.
    */
  static UCI_EXPORT WorkingSOB_RequestMT& create(const WorkingSOB_RequestMT& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified WorkingSOB_RequestMT. Use of the specified accessor after it has been destroyed
    * will result in undefined behavior.
    *
    * @param accessor The WorkingSOB_RequestMT that is to be destroyed.
    */
  static UCI_EXPORT void destroy(WorkingSOB_RequestMT& accessor);

  /** Returns this accessor's type constant, i.e. workingSOB_RequestMT.
    *
    * @return This accessor's type constant, i.e. workingSOB_RequestMT.
    */
  virtual uci::base::accessorType::AccessorType getAccessorType() const noexception {
    return uci::type::accessorType::workingSOB_RequestMT;
  }

  /** Returns the version that was initialized from the uci:version attribute of WorkingSOB_RequestMT.
    *
    * @return The version that was initialized from the uci:version attribute of WorkingSOB_RequestMT.
    */
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const WorkingSOB_RequestMT& accessor) = 0;
  ...
  /** Returns a const reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual const uci::type::WorkingSOB_RequestMDT& getMessageData() const = 0;
  ...
  /** Returns a reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual uci::type::WorkingSOB_RequestMDT& getMessageData() = 0;
  ...
  /** Sets the complex content identified by MessageData to the contents of the complex content accessed by the specified
    ...
    */
  virtual uci::type::WorkingSOB_RequestMT& setMessageData(const uci::type::WorkingSOB_RequestMDT& value) = 0;

  /** The Listener provides the support to listen and handle incoming messages of the type uci::type::WorkingSOB_RequestMT. */
  ...
  public:
    ...
    /** The method is used to handle incoming messages.
      ...
      */
    virtual void handleMessage(const uci::type::WorkingSOB_RequestMT& message) = 0;
  ...
  public:
    ...
    /** Adds a listener to this reader to handle incoming messages.
      ...
      */
    virtual void addListener(uci::type::WorkingSOB_RequestMT::Listener& listener) = 0;

    /** Removes the specified listener from this reader.
      *
      * @param listener The listener that is to be removed from this reader.
      */
    virtual void removeListener(uci::type::WorkingSOB_RequestMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s). Returns immediately if no messages are available.
      ...
      */
    virtual unsigned long readNoWait(unsigned long maxNumberOfMessages, uci::type::WorkingSOB_RequestMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s).
      ...
      * @return The number of messages that were handled.
      */
    virtual unsigned long read(unsigned long timeout, unsigned long maxNumberOfMessages, uci::type::WorkingSOB_RequestMT::Listener& listener) = 0;
  ...
  /** This method creates a new reader that can be used to read a WorkingSOB_RequestMT.
    *
    * @param topic The specification of the topic the reader is to read from.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A reader that can read a WorkingSOB_RequestMT.
    */
  static UCI_EXPORT uci::type::WorkingSOB_RequestMT::Reader& createReader(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a reader. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyReader(uci::type::WorkingSOB_RequestMT::Reader& reader);
  ...
  public:
    ...
    /** Writes the OMS message to the topic specified when this Writer was created.
      ...
      */
    virtual void write(uci::type::WorkingSOB_RequestMT& accessor) = 0;
  ...
  /** This method creates a new writer that can be used to write a WorkingSOB_RequestMT.
    *
    * @param topic The specification of the topic the writer is to write to.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A writer that can write a WorkingSOB_RequestMT.
    */
  static UCI_EXPORT uci::type::WorkingSOB_RequestMT::Writer& createWriter(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a writer. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyWriter(uci::type::WorkingSOB_RequestMT::Writer& writer);

protected:

  /** The constructor [only available to derived classes]. */
  WorkingSOB_RequestMT() {
  }
  ...
  /** The copy constructor [only available to derived classes].
    *
    * @param rhs The WorkingSOB_RequestMT to copy from.
    */
  WorkingSOB_RequestMT(const WorkingSOB_RequestMT& rhs) {
    (void)rhs;
  }

  /** The assignment operator. Sets the contents of this WorkingSOB_RequestMT to the contents of the WorkingSOB_RequestMT
    * on the right hand side (rhs) of the assignment operator [only available to derived classes].
    *
    * @param rhs The WorkingSOB_RequestMT on the right hand side (rhs) of the assignment operator whose contents are used
    *      to set the contents of this WorkingSOB_RequestMT.
    * @return A reference to this WorkingSOB_RequestMT.
    */
  WorkingSOB_RequestMT& operator=(const WorkingSOB_RequestMT& rhs) {
    (void)rhs;
...
#endif // UCI_TYPE_WORKINGSOB_REQUESTMT_H
