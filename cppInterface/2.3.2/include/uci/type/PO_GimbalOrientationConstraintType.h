...
class PO_GimbalOrientationConstraintType : public virtual uci::base::Accessor {
public:

  /** This method constructs a new PO_GimbalOrientationConstraintType.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed PO_GimbalOrientationConstraintType.
    */
  static UCI_EXPORT PO_GimbalOrientationConstraintType& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new PO_GimbalOrientationConstraintType initializing the data accessed by the new
    * PO_GimbalOrientationConstraintType using the data accessed by the specified PO_GimbalOrientationConstraintType
    * (cloning).
    *
    * @param accessor The PO_GimbalOrientationConstraintType that provides access to the data that is to be used to
    *      initialize the data accessed by the new created PO_GimbalOrientationConstraintType.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed PO_GimbalOrientationConstraintType.
    */
  static UCI_EXPORT PO_GimbalOrientationConstraintType& create(const PO_GimbalOrientationConstraintType& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified PO_GimbalOrientationConstraintType. Use of the specified accessor after it has
    * been destroyed will result in undefined behavior.
    *
    * @param accessor The PO_GimbalOrientationConstraintType that is to be destroyed.
    */
  static UCI_EXPORT void destroy(PO_GimbalOrientationConstraintType& accessor);

  /** Returns this accessor's type constant, i.e. pO_GimbalOrientationConstraintType.
    *
    * @return This accessor's type constant, i.e. pO_GimbalOrientationConstraintType.
    */
  virtual uci::base::accessorType::AccessorType getAccessorType() const noexception {
    return uci::type::accessorType::pO_GimbalOrientationConstraintType;
  }

  /** Returns the version that was initialized from the uci:version attribute of PO_GimbalOrientationConstraintType.
    *
    * @return The version that was initialized from the uci:version attribute of PO_GimbalOrientationConstraintType.
    */
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const PO_GimbalOrientationConstraintType& accessor) = 0;
  ...
  /** The constraint controls on individual axis for gimbals with more than three degrees of freedom. [Occurrences:
    ...
    */
  typedef uci::base::BoundedList<uci::type::GimbalAxisControlType, uci::type::accessorType::gimbalAxisControlType> Axis;
  ...
  /** Sets the value of the enumeration identified by ReferenceFrame.
    ...
    */
  virtual uci::type::PO_GimbalOrientationConstraintType& setReferenceFrame(const uci::type::PO_GimbalOrientationReferenceFrameEnum& value) = 0;
  ...
  /** Sets the value of the enumeration identified by ReferenceFrame.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::PO_GimbalOrientationConstraintType& setReferenceFrame(uci::type::PO_GimbalOrientationReferenceFrameEnum::EnumerationItem value) = 0;
  ...
  /** Sets the complex content identified by ComponentID to the contents of the complex content accessed by the specified
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::PO_GimbalOrientationConstraintType& setComponentID(const uci::type::ComponentID_Type& value) = 0;
  ...
  /** Clears (disabled) the Element identified by ComponentID.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::PO_GimbalOrientationConstraintType& clearComponentID() = 0;
  ...
  /** Returns a const reference to the accessor that provides access to the complex content identified by PitchAngle.
    ...
    */
  virtual const uci::type::PO_AngleConstraintControlsType& getPitchAngle() const = 0;
  ...
  /** Returns a reference to the accessor that provides access to the complex content identified by PitchAngle.
    ...
    */
  virtual uci::type::PO_AngleConstraintControlsType& getPitchAngle() = 0;
  ...
  /** Sets the complex content identified by PitchAngle to the contents of the complex content accessed by the specified
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::PO_GimbalOrientationConstraintType& setPitchAngle(const uci::type::PO_AngleConstraintControlsType& value) = 0;
  ...
  /** Enables the Element identified by PitchAngle.
    ...
    * @return A reference to the accessor that provides access to the complex content identified by PitchAngle.
    */
  virtual uci::type::PO_AngleConstraintControlsType& enablePitchAngle(uci::base::accessorType::AccessorType type = uci::base::accessorType::null) = 0;

  /** Clears (disabled) the Element identified by PitchAngle.
    *
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::PO_GimbalOrientationConstraintType& clearPitchAngle() = 0;
  ...
  /** Returns a const reference to the accessor that provides access to the complex content identified by RollAngle.
    ...
    */
  virtual const uci::type::PO_AngleConstraintControlsType& getRollAngle() const = 0;
  ...
  /** Returns a reference to the accessor that provides access to the complex content identified by RollAngle.
    ...
    */
  virtual uci::type::PO_AngleConstraintControlsType& getRollAngle() = 0;
  ...
  /** Sets the complex content identified by RollAngle to the contents of the complex content accessed by the specified
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::PO_GimbalOrientationConstraintType& setRollAngle(const uci::type::PO_AngleConstraintControlsType& value) = 0;
  ...
  /** Enables the Element identified by RollAngle.
    ...
    * @return A reference to the accessor that provides access to the complex content identified by RollAngle.
    */
  virtual uci::type::PO_AngleConstraintControlsType& enableRollAngle(uci::base::accessorType::AccessorType type = uci::base::accessorType::null) = 0;

  /** Clears (disabled) the Element identified by RollAngle.
    *
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::PO_GimbalOrientationConstraintType& clearRollAngle() = 0;
  ...
  /** Returns a const reference to the accessor that provides access to the complex content identified by YawAngle.
    ...
    */
  virtual const uci::type::PO_AngleConstraintControlsType& getYawAngle() const = 0;
  ...
  /** Returns a reference to the accessor that provides access to the complex content identified by YawAngle.
    ...
    */
  virtual uci::type::PO_AngleConstraintControlsType& getYawAngle() = 0;
  ...
  /** Sets the complex content identified by YawAngle to the contents of the complex content accessed by the specified
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::PO_GimbalOrientationConstraintType& setYawAngle(const uci::type::PO_AngleConstraintControlsType& value) = 0;
  ...
  /** Enables the Element identified by YawAngle.
    ...
    * @return A reference to the accessor that provides access to the complex content identified by YawAngle.
    */
  virtual uci::type::PO_AngleConstraintControlsType& enableYawAngle(uci::base::accessorType::AccessorType type = uci::base::accessorType::null) = 0;

  /** Clears (disabled) the Element identified by YawAngle.
    *
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::PO_GimbalOrientationConstraintType& clearYawAngle() = 0;
  ...
  /** Returns a const reference to the bounded list identified by Axis.
    ...
    */
  virtual const uci::type::PO_GimbalOrientationConstraintType::Axis& getAxis() const = 0;

  /** Returns a reference to the bounded list identified by Axis.
    *
    * @return A reference to the bounded list identified by Axis.
    */
  virtual uci::type::PO_GimbalOrientationConstraintType::Axis& getAxis() = 0;
  ...
  /** Sets the bounded list identified by Axis.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::PO_GimbalOrientationConstraintType& setAxis(const uci::type::PO_GimbalOrientationConstraintType::Axis& value) = 0;
...
protected:
  ...
  /** The copy constructor [only available to derived classes].
    ...
    */
  PO_GimbalOrientationConstraintType(const PO_GimbalOrientationConstraintType& rhs) {
    (void)rhs;
  }

  /** The assignment operator. Sets the contents of this PO_GimbalOrientationConstraintType to the contents of the
    * PO_GimbalOrientationConstraintType on the right hand side (rhs) of the assignment operator [only available to derived
    * classes].
    *
    * @param rhs The PO_GimbalOrientationConstraintType on the right hand side (rhs) of the assignment operator whose
    *      contents are used to set the contents of this PO_GimbalOrientationConstraintType.
    * @return A reference to this PO_GimbalOrientationConstraintType.
    */
  PO_GimbalOrientationConstraintType& operator=(const PO_GimbalOrientationConstraintType& rhs) {
    (void)rhs;
...
#endif // UCI_TYPE_PO_GIMBALORIENTATIONCONSTRAINTTYPE_H
