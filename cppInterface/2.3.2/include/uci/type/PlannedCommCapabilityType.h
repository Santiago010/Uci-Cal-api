/** @file PlannedCommCapabilityType.h
 *
...
#ifndef UCI_TYPE_PLANNEDCOMMCAPABILITYTYPE_H
#define UCI_TYPE_PLANNEDCOMMCAPABILITYTYPE_H
...
public:
  ...
  /** This method constructs a new PlannedCommCapabilityType.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed PlannedCommCapabilityType.
    */
  static UCI_EXPORT PlannedCommCapabilityType& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new PlannedCommCapabilityType initializing the data accessed by the new
    * PlannedCommCapabilityType using the data accessed by the specified PlannedCommCapabilityType (cloning).
    *
    * @param accessor The PlannedCommCapabilityType that provides access to the data that is to be used to initialize the
    *      data accessed by the new created PlannedCommCapabilityType.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed PlannedCommCapabilityType.
    */
  static UCI_EXPORT PlannedCommCapabilityType& create(const PlannedCommCapabilityType& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified PlannedCommCapabilityType. Use of the specified accessor after it has been
    * destroyed will result in undefined behavior.
    *
    * @param accessor The PlannedCommCapabilityType that is to be destroyed.
    */
  static UCI_EXPORT void destroy(PlannedCommCapabilityType& accessor);
  ...
  /** Returns the version that was initialized from the uci:version attribute of PlannedCommCapabilityType.
    *
    * @return The version that was initialized from the uci:version attribute of PlannedCommCapabilityType.
    */
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const PlannedCommCapabilityType& accessor) = 0;
  ...
  /** Sets the value of the enumeration identified by Action.
    ...
    */
  virtual uci::type::PlannedCommCapabilityType& setAction(const uci::type::NetworkLinkActionTypeEnum& value) = 0;
  ...
  /** Sets the value of the enumeration identified by Action.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::PlannedCommCapabilityType& setAction(uci::type::NetworkLinkActionTypeEnum::EnumerationItem value) = 0;
  ...
  /** Returns a const reference to the bounded list identified by CapabilityID.
    ...
    */
  virtual const uci::type::PlannedCommCapabilityType::CapabilityID& getCapabilityID() const = 0;
  ...
  /** Returns a reference to the bounded list identified by CapabilityID.
    ...
    */
  virtual uci::type::PlannedCommCapabilityType::CapabilityID& getCapabilityID() = 0;
  ...
  /** Sets the bounded list identified by CapabilityID.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::PlannedCommCapabilityType& setCapabilityID(const uci::type::PlannedCommCapabilityType::CapabilityID& value) = 0;
  ...
  /** Sets the complex content identified by SubsystemID to the contents of the complex content accessed by the specified
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::PlannedCommCapabilityType& setSubsystemID(const uci::type::SubsystemID_Type& value) = 0;
  ...
  /** Clears (disabled) the Element identified by SubsystemID.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::PlannedCommCapabilityType& clearSubsystemID() = 0;
  ...
  /** Sets the complex content identified by Ranking to the contents of the complex content accessed by the specified
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::PlannedCommCapabilityType& setRanking(const uci::type::CapabilityCommandRankingType& value) = 0;
  ...
  /** Clears (disabled) the Element identified by Ranking.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::PlannedCommCapabilityType& clearRanking() = 0;
  ...
  /** Sets the complex content identified by Classification to the contents of the complex content accessed by the
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::PlannedCommCapabilityType& setClassification(const uci::type::SecurityInformationType& value) = 0;
  ...
  /** Clears (disabled) the Element identified by Classification.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::PlannedCommCapabilityType& clearClassification() = 0;
  ...
  /** Sets the value of the enumeration identified by ConnectionRequest.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::PlannedCommCapabilityType& setConnectionRequest(const uci::type::CommConnectionCommandEnum& value) = 0;
  ...
  /** Sets the value of the enumeration identified by ConnectionRequest.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::PlannedCommCapabilityType& setConnectionRequest(uci::type::CommConnectionCommandEnum::EnumerationItem value) = 0;
  ...
  /** Clears (disabled) the Element identified by ConnectionRequest.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::PlannedCommCapabilityType& clearConnectionRequest() = 0;
  ...
  /** Sets the complex content identified by ActivateProfileID to the contents of the complex content accessed by the
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::PlannedCommCapabilityType& setActivateProfileID(const uci::type::CommProfileID_Type& value) = 0;
  ...
  /** Clears (disabled) the Element identified by ActivateProfileID.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::PlannedCommCapabilityType& clearActivateProfileID() = 0;
  ...
  /** Sets the complex content identified by NetworkLinkID to the contents of the complex content accessed by the specified
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::PlannedCommCapabilityType& setNetworkLinkID(const uci::type::NetworkLinkID_Type& value) = 0;
  ...
  /** Clears (disabled) the Element identified by NetworkLinkID.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::PlannedCommCapabilityType& clearNetworkLinkID() = 0;
  ...
  /** Sets the complex content identified by CommonSettings to the contents of the complex content accessed by the
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::PlannedCommCapabilityType& setCommonSettings(const uci::type::CommControlType& value) = 0;
  ...
  /** Clears (disabled) the Element identified by CommonSettings.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::PlannedCommCapabilityType& clearCommonSettings() = 0;
  ...
  /** Returns a const reference to the bounded list identified by CryptoKey.
    ...
    */
  virtual const uci::type::PlannedCommCapabilityType::CryptoKey& getCryptoKey() const = 0;
  ...
  /** Returns a reference to the bounded list identified by CryptoKey.
    ...
    */
  virtual uci::type::PlannedCommCapabilityType::CryptoKey& getCryptoKey() = 0;
  ...
  /** Sets the bounded list identified by CryptoKey.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::PlannedCommCapabilityType& setCryptoKey(const uci::type::PlannedCommCapabilityType::CryptoKey& value) = 0;
  ...
  /** Returns a const reference to the bounded list identified by CryptoZeroize.
    ...
    */
  virtual const uci::type::PlannedCommCapabilityType::CryptoZeroize& getCryptoZeroize() const = 0;
  ...
  /** Returns a reference to the bounded list identified by CryptoZeroize.
    ...
    */
  virtual uci::type::PlannedCommCapabilityType::CryptoZeroize& getCryptoZeroize() = 0;
  ...
  /** Sets the bounded list identified by CryptoZeroize.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::PlannedCommCapabilityType& setCryptoZeroize(const uci::type::PlannedCommCapabilityType::CryptoZeroize& value) = 0;
  ...
  /** Sets the complex content identified by CryptoRollover to the contents of the complex content accessed by the
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::PlannedCommCapabilityType& setCryptoRollover(const uci::type::CryptoRolloverCommandType& value) = 0;
  ...
  /** Clears (disabled) the Element identified by CryptoRollover.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::PlannedCommCapabilityType& clearCryptoRollover() = 0;
  ...
  /** Sets the complex content identified by LinkPortAssignments to the contents of the complex content accessed by the
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::PlannedCommCapabilityType& setLinkPortAssignments(const uci::type::CommLinkPortMapType& value) = 0;
  ...
  /** Clears (disabled) the Element identified by LinkPortAssignments.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::PlannedCommCapabilityType& clearLinkPortAssignments() = 0;
  ...
  /** Sets the complex content identified by VerboseStatus to the contents of the complex content accessed by the specified
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::PlannedCommCapabilityType& setVerboseStatus(const uci::type::VerboseStatusType& value) = 0;
  ...
  /** Clears (disabled) the Element identified by VerboseStatus.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::PlannedCommCapabilityType& clearVerboseStatus() = 0;
  ...
  /** Sets the complex content identified by WaveformSpecificSettings to the contents of the complex content accessed by
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::PlannedCommCapabilityType& setWaveformSpecificSettings(const uci::type::CommWaveformCapabilityCommandPET& value) = 0;
  ...
  /** Clears (disabled) the Element identified by WaveformSpecificSettings.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::PlannedCommCapabilityType& clearWaveformSpecificSettings() = 0;
  ...
  /** Returns a const reference to the bounded list identified by LinkConnectionRequest.
    ...
    */
  virtual const uci::type::PlannedCommCapabilityType::LinkConnectionRequest& getLinkConnectionRequest() const = 0;
  ...
  /** Returns a reference to the bounded list identified by LinkConnectionRequest.
    ...
    */
  virtual uci::type::PlannedCommCapabilityType::LinkConnectionRequest& getLinkConnectionRequest() = 0;
  ...
  /** Sets the bounded list identified by LinkConnectionRequest.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::PlannedCommCapabilityType& setLinkConnectionRequest(const uci::type::PlannedCommCapabilityType::LinkConnectionRequest& value) = 0;
...
protected:
  ...
  /** The assignment operator. Sets the contents of this PlannedCommCapabilityType to the contents of the
    * PlannedCommCapabilityType on the right hand side (rhs) of the assignment operator [only available to derived
    * classes].
    *
    * @param rhs The PlannedCommCapabilityType on the right hand side (rhs) of the assignment operator whose contents are
    *      used to set the contents of this PlannedCommCapabilityType.
    * @return A reference to this PlannedCommCapabilityType.
    */
  PlannedCommCapabilityType& operator=(const PlannedCommCapabilityType& rhs) {
    (void)rhs;
...
#endif // UCI_TYPE_PLANNEDCOMMCAPABILITYTYPE_H
