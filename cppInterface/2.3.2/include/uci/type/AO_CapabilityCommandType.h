...
class AO_CapabilityCommandType : public virtual CapabilityCommandBaseType {
public:

  /** This method constructs a new AO_CapabilityCommandType.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed AO_CapabilityCommandType.
    */
  static UCI_EXPORT AO_CapabilityCommandType& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new AO_CapabilityCommandType initializing the data accessed by the new
    * AO_CapabilityCommandType using the data accessed by the specified AO_CapabilityCommandType (cloning).
    *
    * @param accessor The AO_CapabilityCommandType that provides access to the data that is to be used to initialize the
    *      data accessed by the new created AO_CapabilityCommandType.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed AO_CapabilityCommandType.
    */
  static UCI_EXPORT AO_CapabilityCommandType& create(const AO_CapabilityCommandType& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified AO_CapabilityCommandType. Use of the specified accessor after it has been
    * destroyed will result in undefined behavior.
    *
    * @param accessor The AO_CapabilityCommandType that is to be destroyed.
    */
  static UCI_EXPORT void destroy(AO_CapabilityCommandType& accessor);
  ...
  /** Returns the version that was initialized from the uci:version attribute of AO_CapabilityCommandType.
    *
    * @return The version that was initialized from the uci:version attribute of AO_CapabilityCommandType.
    */
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const AO_CapabilityCommandType& accessor) = 0;
  ...
  /** Sets the complex content identified by Target to the contents of the complex content accessed by the specified
    ...
    */
  virtual uci::type::AO_CapabilityCommandType& setTarget(const uci::type::TargetType& value) = 0;
  ...
  /** Returns a const reference to the accessor that provides access to the complex content identified by
    ...
    *      ComponentSettings.
    */
  virtual const uci::type::AO_ComponentSettingsType& getComponentSettings() const = 0;

  /** Returns a reference to the accessor that provides access to the complex content identified by ComponentSettings.
    *
    * @return A reference to the accessor that provides access to the complex content identified by ComponentSettings.
    */
  virtual uci::type::AO_ComponentSettingsType& getComponentSettings() = 0;

  /** Sets the complex content identified by ComponentSettings to the contents of the complex content accessed by the
    * specified accessor.
    *
    * @param value The accessor that provides access to the complex content whose contents are to be used to set the
    *      contents of the complex content identified by ComponentSettings.
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::AO_CapabilityCommandType& setComponentSettings(const uci::type::AO_ComponentSettingsType& value) = 0;

  /** Returns whether the Element identified by ComponentSettings exists (is enabled) or not.
    *
    * @return A boolean indicating whether the Element identified by ComponentSettings is enabled or not.
    */
  virtual bool hasComponentSettings() const = 0;

  /** Enables the Element identified by ComponentSettings.
    *
    * @param type = uci::base::accessorType::null This Accessor's accessor type.
    * @return A reference to the accessor that provides access to the complex content identified by ComponentSettings.
    */
  virtual uci::type::AO_ComponentSettingsType& enableComponentSettings(uci::base::accessorType::AccessorType type = uci::base::accessorType::null) = 0;

  /** Clears (disabled) the Element identified by ComponentSettings.
    *
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::AO_CapabilityCommandType& clearComponentSettings() = 0;
  ...
  /** Sets the complex content identified by EmissionConstraints to the contents of the complex content accessed by the
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::AO_CapabilityCommandType& setEmissionConstraints(const uci::type::OpticalCollectionConstraintsType& value) = 0;
  ...
  /** Clears (disabled) the Element identified by EmissionConstraints.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::AO_CapabilityCommandType& clearEmissionConstraints() = 0;
  ...
  /** Sets the complex content identified by Repetition to the contents of the complex content accessed by the specified
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::AO_CapabilityCommandType& setRepetition(const uci::type::RepetitionType& value) = 0;
  ...
  /** Clears (disabled) the Element identified by Repetition.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::AO_CapabilityCommandType& clearRepetition() = 0;
...
protected:
  ...
  /** The assignment operator. Sets the contents of this AO_CapabilityCommandType to the contents of the
    * AO_CapabilityCommandType on the right hand side (rhs) of the assignment operator [only available to derived classes].
    *
    * @param rhs The AO_CapabilityCommandType on the right hand side (rhs) of the assignment operator whose contents are
    *      used to set the contents of this AO_CapabilityCommandType.
    * @return A reference to this AO_CapabilityCommandType.
    */
  AO_CapabilityCommandType& operator=(const AO_CapabilityCommandType& rhs) {
    (void)rhs;
...
#endif // UCI_TYPE_AO_CAPABILITYCOMMANDTYPE_H
