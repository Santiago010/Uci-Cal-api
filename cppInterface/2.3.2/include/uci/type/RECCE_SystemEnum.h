...
#ifndef UCI_TYPE_RECCE_SYSTEMENUM_H
#define UCI_TYPE_RECCE_SYSTEMENUM_H
...
public:
  ...
  /** The assignment operator. Sets the contents of this RECCE_SystemEnum to the contents of the RECCE_SystemEnum on the
    ...
    * @return A reference to this RECCE_SystemEnum.
    */
  RECCE_SystemEnum& operator=(const RECCE_SystemEnum& rhs) {
    setValue(rhs.getValue());
    return *this;
  }

  /** The assignment operator that sets the value of this RECCE_SystemEnum enumeration to the EnumerationItem on the right
    * hand side of the assignment operator.
    *
    * @param rhs The EnumerationItem whose value is to be assigned to this RECCE_SystemEnum enumeration.
    * @return A reference to this RECCE_SystemEnum enumeration.
    */
  RECCE_SystemEnum& operator=(EnumerationItem rhs) {
    setValue(rhs);
    return *this;
  }
  ...
  /** Sets the value of this RECCE_SystemEnum enumeration to the value of the specified enumeration item.
    *
    * @param item The EnumerationItem whose value is to be used to set the value of this RECCE_SystemEnum enumeration.
    */
  ...
  /** Tests whether the value of this RECCE_SystemEnum enumeration is not equal to the value of the specified
    ...
    *
    * @param rhs The EnumerationItem whose value is to be compared against the value of this RECCE_SystemEnum enumeration.
    * @return True if the value of the EnumerationItem (rhs) is not equal to the value of this RECCE_SystemEnum
  ...
  /** Tests whether the value of this RECCE_SystemEnum enumeration is greater than the value of the specified
    ...
    *
    * @param rhs The EnumerationItem whose value is to be compared against the value of this RECCE_SystemEnum enumeration.
    * @return True if the value of the EnumerationItem (rhs) is greater than the value of this RECCE_SystemEnum
    *      enumeration, false otherwise.
    */
  bool operator>(EnumerationItem rhs) const {
    testForValidItem(rhs);
...
#endif // UCI_TYPE_RECCE_SYSTEMENUM_H
