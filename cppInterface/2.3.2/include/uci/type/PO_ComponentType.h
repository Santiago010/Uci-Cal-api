...
#ifndef UCI_TYPE_PO_COMPONENTTYPE_H
#define UCI_TYPE_PO_COMPONENTTYPE_H

#include "../base/Accessor.h"
#include "../base/BoundedList.h"
#include "../base/export.h"
#include "ComponentID_Type.h"
#include "PO_ComponentApertureType.h"
#include "PO_ComponentFilterType.h"
#include "PO_ComponentFocalPlaneArrayType.h"
#include "PO_ComponentLensAssemblyType.h"
#include "PO_ComponentProcessingStageType.h"
#include "PO_ComponentProductGeneratorType.h"
...
public:
  ...
  /** This method constructs a new PO_ComponentType.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed PO_ComponentType.
    */
  static UCI_EXPORT PO_ComponentType& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new PO_ComponentType initializing the data accessed by the new PO_ComponentType using the
    * data accessed by the specified PO_ComponentType (cloning).
    *
    * @param accessor The PO_ComponentType that provides access to the data that is to be used to initialize the data
    *      accessed by the new created PO_ComponentType.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed PO_ComponentType.
    */
  static UCI_EXPORT PO_ComponentType& create(const PO_ComponentType& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified PO_ComponentType. Use of the specified accessor after it has been destroyed will
    * result in undefined behavior.
    *
    * @param accessor The PO_ComponentType that is to be destroyed.
    */
  static UCI_EXPORT void destroy(PO_ComponentType& accessor);
  ...
  /** Returns the version that was initialized from the uci:version attribute of PO_ComponentType.
    *
    * @return The version that was initialized from the uci:version attribute of PO_ComponentType.
    */
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const PO_ComponentType& accessor) = 0;
  ...
  /** Indicates a space through which light passes in an optical or photographic instrument, especially the variable
    ...
    */
  typedef uci::base::BoundedList<uci::type::PO_ComponentApertureType, uci::type::accessorType::pO_ComponentApertureType> Aperture;
  ...
  /** Sets the complex content identified by ComponentID to the contents of the complex content accessed by the specified
    ...
    */
  virtual uci::type::PO_ComponentType& setComponentID(const uci::type::ComponentID_Type& value) = 0;
  ...
  /** Returns a const reference to the bounded list identified by FocalPlaneArray.
    ...
    */
  virtual const uci::type::PO_ComponentType::FocalPlaneArray& getFocalPlaneArray() const = 0;
  ...
  /** Returns a reference to the bounded list identified by FocalPlaneArray.
    ...
    */
  virtual uci::type::PO_ComponentType::FocalPlaneArray& getFocalPlaneArray() = 0;
  ...
  /** Sets the bounded list identified by FocalPlaneArray.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::PO_ComponentType& setFocalPlaneArray(const uci::type::PO_ComponentType::FocalPlaneArray& value) = 0;
  ...
  /** Sets the bounded list identified by Lens.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::PO_ComponentType& setLens(const uci::type::PO_ComponentType::Lens& value) = 0;
  ...
  /** Returns a const reference to the bounded list identified by Aperture.
    ...
    */
  virtual const uci::type::PO_ComponentType::Aperture& getAperture() const = 0;
  ...
  /** Returns a reference to the bounded list identified by Aperture.
    ...
    */
  virtual uci::type::PO_ComponentType::Aperture& getAperture() = 0;
  ...
  /** Sets the bounded list identified by Aperture.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::PO_ComponentType& setAperture(const uci::type::PO_ComponentType::Aperture& value) = 0;
  ...
  /** Sets the bounded list identified by Filter.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::PO_ComponentType& setFilter(const uci::type::PO_ComponentType::Filter& value) = 0;
  ...
  /** Returns a const reference to the bounded list identified by ProcessingStage.
    ...
    */
  virtual const uci::type::PO_ComponentType::ProcessingStage& getProcessingStage() const = 0;
  ...
  /** Returns a reference to the bounded list identified by ProcessingStage.
    ...
    */
  virtual uci::type::PO_ComponentType::ProcessingStage& getProcessingStage() = 0;
  ...
  /** Sets the bounded list identified by ProcessingStage.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::PO_ComponentType& setProcessingStage(const uci::type::PO_ComponentType::ProcessingStage& value) = 0;
  ...
  /** Returns a const reference to the bounded list identified by ProductGenerator.
    ...
    */
  virtual const uci::type::PO_ComponentType::ProductGenerator& getProductGenerator() const = 0;
  ...
  /** Returns a reference to the bounded list identified by ProductGenerator.
    ...
    */
  virtual uci::type::PO_ComponentType::ProductGenerator& getProductGenerator() = 0;
  ...
  /** Sets the bounded list identified by ProductGenerator.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::PO_ComponentType& setProductGenerator(const uci::type::PO_ComponentType::ProductGenerator& value) = 0;
...
protected:
  ...
  /** The assignment operator. Sets the contents of this PO_ComponentType to the contents of the PO_ComponentType on the
    ...
    *      set the contents of this PO_ComponentType.
    * @return A reference to this PO_ComponentType.
    */
  PO_ComponentType& operator=(const PO_ComponentType& rhs) {
    (void)rhs;
...
#endif // UCI_TYPE_PO_COMPONENTTYPE_H
