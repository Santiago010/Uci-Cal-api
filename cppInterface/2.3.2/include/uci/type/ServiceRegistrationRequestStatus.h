/** @file ServiceRegistrationRequestStatus.h
 *
...
typedef uci::type::ServiceRegistrationRequestStatusMT ServiceRegistrationRequestStatus;

} // namespace type
} // namespace uci

#endif // UCI_TYPE_SERVICEREGISTRATIONREQUESTSTATUS_H
