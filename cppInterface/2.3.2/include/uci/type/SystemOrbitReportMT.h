...
#ifndef UCI_TYPE_SYSTEMORBITREPORTMT_H
#define UCI_TYPE_SYSTEMORBITREPORTMT_H
...
/** Indicates the System's ID, source of the message, contingency state of the System, and the System's remaining
  * endurance.
  */
class SystemOrbitReportMT : public virtual MessageType {
public:

  /** This method constructs a new SystemOrbitReportMT.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed SystemOrbitReportMT.
    */
  static UCI_EXPORT SystemOrbitReportMT& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new SystemOrbitReportMT initializing the data accessed by the new SystemOrbitReportMT using
    * the data accessed by the specified SystemOrbitReportMT (cloning).
    *
    * @param accessor The SystemOrbitReportMT that provides access to the data that is to be used to initialize the data
    *      accessed by the new created SystemOrbitReportMT.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed SystemOrbitReportMT.
    */
  static UCI_EXPORT SystemOrbitReportMT& create(const SystemOrbitReportMT& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified SystemOrbitReportMT. Use of the specified accessor after it has been destroyed
    * will result in undefined behavior.
    *
    * @param accessor The SystemOrbitReportMT that is to be destroyed.
    */
  static UCI_EXPORT void destroy(SystemOrbitReportMT& accessor);

  /** Returns this accessor's type constant, i.e. systemOrbitReportMT.
    *
    * @return This accessor's type constant, i.e. systemOrbitReportMT.
    */
  virtual uci::base::accessorType::AccessorType getAccessorType() const noexception {
    return uci::type::accessorType::systemOrbitReportMT;
  }

  /** Returns the version that was initialized from the uci:version attribute of SystemOrbitReportMT.
    *
    * @return The version that was initialized from the uci:version attribute of SystemOrbitReportMT.
    */
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const SystemOrbitReportMT& accessor) = 0;
  ...
  /** Returns a const reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual const uci::type::SystemOrbitReportMDT& getMessageData() const = 0;
  ...
  /** Returns a reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual uci::type::SystemOrbitReportMDT& getMessageData() = 0;
  ...
  /** Sets the complex content identified by MessageData to the contents of the complex content accessed by the specified
    ...
    */
  virtual uci::type::SystemOrbitReportMT& setMessageData(const uci::type::SystemOrbitReportMDT& value) = 0;

  /** The Listener provides the support to listen and handle incoming messages of the type uci::type::SystemOrbitReportMT. */
  ...
  public:
    ...
    /** The method is used to handle incoming messages.
      ...
      */
    virtual void handleMessage(const uci::type::SystemOrbitReportMT& message) = 0;
  ...
  public:
    ...
    /** Adds a listener to this reader to handle incoming messages.
      ...
      */
    virtual void addListener(uci::type::SystemOrbitReportMT::Listener& listener) = 0;

    /** Removes the specified listener from this reader.
      *
      * @param listener The listener that is to be removed from this reader.
      */
    virtual void removeListener(uci::type::SystemOrbitReportMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s). Returns immediately if no messages are available.
      ...
      */
    virtual unsigned long readNoWait(unsigned long maxNumberOfMessages, uci::type::SystemOrbitReportMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s).
      ...
      * @return The number of messages that were handled.
      */
    virtual unsigned long read(unsigned long timeout, unsigned long maxNumberOfMessages, uci::type::SystemOrbitReportMT::Listener& listener) = 0;
  ...
  /** This method creates a new reader that can be used to read a SystemOrbitReportMT.
    *
    * @param topic The specification of the topic the reader is to read from.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A reader that can read a SystemOrbitReportMT.
    */
  static UCI_EXPORT uci::type::SystemOrbitReportMT::Reader& createReader(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a reader. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyReader(uci::type::SystemOrbitReportMT::Reader& reader);
  ...
  public:
    ...
    /** Writes the OMS message to the topic specified when this Writer was created.
      ...
      */
    virtual void write(uci::type::SystemOrbitReportMT& accessor) = 0;
  ...
  /** This method creates a new writer that can be used to write a SystemOrbitReportMT.
    *
    * @param topic The specification of the topic the writer is to write to.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A writer that can write a SystemOrbitReportMT.
    */
  static UCI_EXPORT uci::type::SystemOrbitReportMT::Writer& createWriter(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a writer. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyWriter(uci::type::SystemOrbitReportMT::Writer& writer);
...
protected:
  ...
  /** The copy constructor [only available to derived classes].
    *
    * @param rhs The SystemOrbitReportMT to copy from.
    */
  SystemOrbitReportMT(const SystemOrbitReportMT& rhs) {
    (void)rhs;
  }

  /** The assignment operator. Sets the contents of this SystemOrbitReportMT to the contents of the SystemOrbitReportMT on
    * the right hand side (rhs) of the assignment operator [only available to derived classes].
    *
    * @param rhs The SystemOrbitReportMT on the right hand side (rhs) of the assignment operator whose contents are used to
    *      set the contents of this SystemOrbitReportMT.
    * @return A reference to this SystemOrbitReportMT.
    */
  SystemOrbitReportMT& operator=(const SystemOrbitReportMT& rhs) {
    (void)rhs;
...
#endif // UCI_TYPE_SYSTEMORBITREPORTMT_H
