...
#ifndef UCI_TYPE_MISSIONPLANSTATUSMT_H
#define UCI_TYPE_MISSIONPLANSTATUSMT_H
...
#include "MissionPlanStatusMDT.h"
...
class MissionPlanStatusMT : public virtual MessageType {
public:

  /** This method constructs a new MissionPlanStatusMT.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed MissionPlanStatusMT.
    */
  static UCI_EXPORT MissionPlanStatusMT& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new MissionPlanStatusMT initializing the data accessed by the new MissionPlanStatusMT using
    * the data accessed by the specified MissionPlanStatusMT (cloning).
    *
    * @param accessor The MissionPlanStatusMT that provides access to the data that is to be used to initialize the data
    *      accessed by the new created MissionPlanStatusMT.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed MissionPlanStatusMT.
    */
  static UCI_EXPORT MissionPlanStatusMT& create(const MissionPlanStatusMT& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified MissionPlanStatusMT. Use of the specified accessor after it has been destroyed
    * will result in undefined behavior.
    *
    * @param accessor The MissionPlanStatusMT that is to be destroyed.
    */
  static UCI_EXPORT void destroy(MissionPlanStatusMT& accessor);
  ...
  /** Returns the version that was initialized from the uci:version attribute of MissionPlanStatusMT.
    *
    * @return The version that was initialized from the uci:version attribute of MissionPlanStatusMT.
    */
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const MissionPlanStatusMT& accessor) = 0;
  ...
  /** Returns a const reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual const uci::type::MissionPlanStatusMDT& getMessageData() const = 0;
  ...
  /** Returns a reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual uci::type::MissionPlanStatusMDT& getMessageData() = 0;
  ...
  /** Sets the complex content identified by MessageData to the contents of the complex content accessed by the specified
    ...
    */
  virtual uci::type::MissionPlanStatusMT& setMessageData(const uci::type::MissionPlanStatusMDT& value) = 0;

  /** The Listener provides the support to listen and handle incoming messages of the type uci::type::MissionPlanStatusMT. */
  ...
  public:
    ...
    /** The method is used to handle incoming messages.
      ...
      */
    virtual void handleMessage(const uci::type::MissionPlanStatusMT& message) = 0;
  ...
  public:
    ...
    /** Adds a listener to this reader to handle incoming messages.
      ...
      */
    virtual void addListener(uci::type::MissionPlanStatusMT::Listener& listener) = 0;

    /** Removes the specified listener from this reader.
      *
      * @param listener The listener that is to be removed from this reader.
      */
    virtual void removeListener(uci::type::MissionPlanStatusMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s). Returns immediately if no messages are available.
      ...
      */
    virtual unsigned long readNoWait(unsigned long maxNumberOfMessages, uci::type::MissionPlanStatusMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s).
      ...
      * @return The number of messages that were handled.
      */
    virtual unsigned long read(unsigned long timeout, unsigned long maxNumberOfMessages, uci::type::MissionPlanStatusMT::Listener& listener) = 0;
  ...
  /** This method creates a new reader that can be used to read a MissionPlanStatusMT.
    *
    * @param topic The specification of the topic the reader is to read from.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A reader that can read a MissionPlanStatusMT.
    */
  static UCI_EXPORT uci::type::MissionPlanStatusMT::Reader& createReader(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a reader. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyReader(uci::type::MissionPlanStatusMT::Reader& reader);
  ...
  public:
    ...
    /** Writes the OMS message to the topic specified when this Writer was created.
      ...
      */
    virtual void write(uci::type::MissionPlanStatusMT& accessor) = 0;
  ...
  /** This method creates a new writer that can be used to write a MissionPlanStatusMT.
    *
    * @param topic The specification of the topic the writer is to write to.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A writer that can write a MissionPlanStatusMT.
    */
  static UCI_EXPORT uci::type::MissionPlanStatusMT::Writer& createWriter(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a writer. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyWriter(uci::type::MissionPlanStatusMT::Writer& writer);
...
protected:
  ...
  /** The assignment operator. Sets the contents of this MissionPlanStatusMT to the contents of the MissionPlanStatusMT on
    ...
    *      set the contents of this MissionPlanStatusMT.
    * @return A reference to this MissionPlanStatusMT.
    */
  MissionPlanStatusMT& operator=(const MissionPlanStatusMT& rhs) {
    (void)rhs;
...
#endif // UCI_TYPE_MISSIONPLANSTATUSMT_H
