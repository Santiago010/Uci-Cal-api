...
#ifndef UCI_TYPE_WORKINGEOB_REQUESTMT_H
#define UCI_TYPE_WORKINGEOB_REQUESTMT_H
...
#include "WorkingEOB_RequestMDT.h"
...
class WorkingEOB_RequestMT : public virtual MessageType {
public:

  /** This method constructs a new WorkingEOB_RequestMT.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed WorkingEOB_RequestMT.
    */
  static UCI_EXPORT WorkingEOB_RequestMT& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new WorkingEOB_RequestMT initializing the data accessed by the new WorkingEOB_RequestMT
    * using the data accessed by the specified WorkingEOB_RequestMT (cloning).
    *
    * @param accessor The WorkingEOB_RequestMT that provides access to the data that is to be used to initialize the data
    *      accessed by the new created WorkingEOB_RequestMT.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed WorkingEOB_RequestMT.
    */
  static UCI_EXPORT WorkingEOB_RequestMT& create(const WorkingEOB_RequestMT& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified WorkingEOB_RequestMT. Use of the specified accessor after it has been destroyed
    * will result in undefined behavior.
    *
    * @param accessor The WorkingEOB_RequestMT that is to be destroyed.
    */
  static UCI_EXPORT void destroy(WorkingEOB_RequestMT& accessor);

  /** Returns this accessor's type constant, i.e. workingEOB_RequestMT.
    *
    * @return This accessor's type constant, i.e. workingEOB_RequestMT.
    */
  virtual uci::base::accessorType::AccessorType getAccessorType() const noexception {
    return uci::type::accessorType::workingEOB_RequestMT;
  }

  /** Returns the version that was initialized from the uci:version attribute of WorkingEOB_RequestMT.
    *
    * @return The version that was initialized from the uci:version attribute of WorkingEOB_RequestMT.
    */
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const WorkingEOB_RequestMT& accessor) = 0;
  ...
  /** Returns a const reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual const uci::type::WorkingEOB_RequestMDT& getMessageData() const = 0;
  ...
  /** Returns a reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual uci::type::WorkingEOB_RequestMDT& getMessageData() = 0;
  ...
  /** Sets the complex content identified by MessageData to the contents of the complex content accessed by the specified
    ...
    */
  virtual uci::type::WorkingEOB_RequestMT& setMessageData(const uci::type::WorkingEOB_RequestMDT& value) = 0;

  /** The Listener provides the support to listen and handle incoming messages of the type uci::type::WorkingEOB_RequestMT. */
  ...
  public:
    ...
    /** The method is used to handle incoming messages.
      ...
      */
    virtual void handleMessage(const uci::type::WorkingEOB_RequestMT& message) = 0;
  ...
  public:
    ...
    /** Adds a listener to this reader to handle incoming messages.
      ...
      */
    virtual void addListener(uci::type::WorkingEOB_RequestMT::Listener& listener) = 0;

    /** Removes the specified listener from this reader.
      *
      * @param listener The listener that is to be removed from this reader.
      */
    virtual void removeListener(uci::type::WorkingEOB_RequestMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s). Returns immediately if no messages are available.
      ...
      */
    virtual unsigned long readNoWait(unsigned long maxNumberOfMessages, uci::type::WorkingEOB_RequestMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s).
      ...
      * @return The number of messages that were handled.
      */
    virtual unsigned long read(unsigned long timeout, unsigned long maxNumberOfMessages, uci::type::WorkingEOB_RequestMT::Listener& listener) = 0;
  ...
  /** This method creates a new reader that can be used to read a WorkingEOB_RequestMT.
    *
    * @param topic The specification of the topic the reader is to read from.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A reader that can read a WorkingEOB_RequestMT.
    */
  static UCI_EXPORT uci::type::WorkingEOB_RequestMT::Reader& createReader(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a reader. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyReader(uci::type::WorkingEOB_RequestMT::Reader& reader);
  ...
  public:
    ...
    /** Writes the OMS message to the topic specified when this Writer was created.
      ...
      */
    virtual void write(uci::type::WorkingEOB_RequestMT& accessor) = 0;
  ...
  /** This method creates a new writer that can be used to write a WorkingEOB_RequestMT.
    *
    * @param topic The specification of the topic the writer is to write to.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A writer that can write a WorkingEOB_RequestMT.
    */
  static UCI_EXPORT uci::type::WorkingEOB_RequestMT::Writer& createWriter(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a writer. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyWriter(uci::type::WorkingEOB_RequestMT::Writer& writer);

protected:

  /** The constructor [only available to derived classes]. */
  WorkingEOB_RequestMT() {
  }
  ...
  /** The copy constructor [only available to derived classes].
    *
    * @param rhs The WorkingEOB_RequestMT to copy from.
    */
  WorkingEOB_RequestMT(const WorkingEOB_RequestMT& rhs) {
    (void)rhs;
  }

  /** The assignment operator. Sets the contents of this WorkingEOB_RequestMT to the contents of the WorkingEOB_RequestMT
    * on the right hand side (rhs) of the assignment operator [only available to derived classes].
    *
    * @param rhs The WorkingEOB_RequestMT on the right hand side (rhs) of the assignment operator whose contents are used
    *      to set the contents of this WorkingEOB_RequestMT.
    * @return A reference to this WorkingEOB_RequestMT.
    */
  WorkingEOB_RequestMT& operator=(const WorkingEOB_RequestMT& rhs) {
    (void)rhs;
...
#endif // UCI_TYPE_WORKINGEOB_REQUESTMT_H
