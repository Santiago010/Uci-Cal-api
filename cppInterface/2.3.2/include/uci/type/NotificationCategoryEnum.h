/** @file NotificationCategoryEnum.h
 *
...
#ifndef UCI_TYPE_NOTIFICATIONCATEGORYENUM_H
#define UCI_TYPE_NOTIFICATIONCATEGORYENUM_H
...
public:
  ...
  enum EnumerationItem {
    ...
    /** The mission category describes a general notification that applies to the mission as a whole. */
    UCI_MISSION,

    /** The system category describes a notification that applies to a system in the mission. */
    UCI_SYSTEM,

    /** The vehicle category describes a notification that applies to a vehicle in the mission. */
    UCI_VEHICLE,
  ...
  /** The assignment operator. Sets the contents of this NotificationCategoryEnum to the contents of the
    * NotificationCategoryEnum on the right hand side (rhs) of the assignment operator.
    *
    ...
    * @return A reference to this NotificationCategoryEnum.
    */
  NotificationCategoryEnum& operator=(const NotificationCategoryEnum& rhs) {
    setValue(rhs.getValue());
    return *this;
  }

  /** The assignment operator that sets the value of this NotificationCategoryEnum enumeration to the EnumerationItem on
    * the right hand side of the assignment operator.
    *
    * @param rhs The EnumerationItem whose value is to be assigned to this NotificationCategoryEnum enumeration.
    * @return A reference to this NotificationCategoryEnum enumeration.
    */
  NotificationCategoryEnum& operator=(EnumerationItem rhs) {
    setValue(rhs);
    return *this;
  }
  ...
  /** Sets the value of this NotificationCategoryEnum enumeration to the value of the specified enumeration item.
    *
    * @param item The EnumerationItem whose value is to be used to set the value of this NotificationCategoryEnum
    *      enumeration.
    */
...
#endif // UCI_TYPE_NOTIFICATIONCATEGORYENUM_H
