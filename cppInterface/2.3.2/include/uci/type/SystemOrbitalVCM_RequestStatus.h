/** @file SystemOrbitalVCM_RequestStatus.h
 *
...
typedef uci::type::SystemOrbitalVCM_RequestStatusMT SystemOrbitalVCM_RequestStatus;

} // namespace type
} // namespace uci

#endif // UCI_TYPE_SYSTEMORBITALVCM_REQUESTSTATUS_H
