/** @file MissionPlanningOrchestration.h
 *
...
typedef uci::type::MissionPlanningOrchestrationMT MissionPlanningOrchestration;

} // namespace type
} // namespace uci

#endif // UCI_TYPE_MISSIONPLANNINGORCHESTRATION_H
