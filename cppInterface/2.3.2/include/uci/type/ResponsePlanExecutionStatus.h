/** @file ResponsePlanExecutionStatus.h
 *
...
typedef uci::type::ResponsePlanExecutionStatusMT ResponsePlanExecutionStatus;

} // namespace type
} // namespace uci

#endif // UCI_TYPE_RESPONSEPLANEXECUTIONSTATUS_H
