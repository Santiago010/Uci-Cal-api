/** @file MultistaticEmitterDataMT.h
 *
...
#ifndef UCI_TYPE_MULTISTATICEMITTERDATAMT_H
#define UCI_TYPE_MULTISTATICEMITTERDATAMT_H
...
#include "MultistaticEmitterDataMDT.h"
...
class MultistaticEmitterDataMT : public virtual MessageType {
public:

  /** This method constructs a new MultistaticEmitterDataMT.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed MultistaticEmitterDataMT.
    */
  static UCI_EXPORT MultistaticEmitterDataMT& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new MultistaticEmitterDataMT initializing the data accessed by the new
    * MultistaticEmitterDataMT using the data accessed by the specified MultistaticEmitterDataMT (cloning).
    *
    * @param accessor The MultistaticEmitterDataMT that provides access to the data that is to be used to initialize the
    *      data accessed by the new created MultistaticEmitterDataMT.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed MultistaticEmitterDataMT.
    */
  static UCI_EXPORT MultistaticEmitterDataMT& create(const MultistaticEmitterDataMT& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified MultistaticEmitterDataMT. Use of the specified accessor after it has been
    * destroyed will result in undefined behavior.
    *
    * @param accessor The MultistaticEmitterDataMT that is to be destroyed.
    */
  static UCI_EXPORT void destroy(MultistaticEmitterDataMT& accessor);

  /** Returns this accessor's type constant, i.e. multistaticEmitterDataMT.
    *
    * @return This accessor's type constant, i.e. multistaticEmitterDataMT.
    */
  virtual uci::base::accessorType::AccessorType getAccessorType() const noexception {
    return uci::type::accessorType::multistaticEmitterDataMT;
  }

  /** Returns the version that was initialized from the uci:version attribute of MultistaticEmitterDataMT.
    *
    * @return The version that was initialized from the uci:version attribute of MultistaticEmitterDataMT.
    */
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const MultistaticEmitterDataMT& accessor) = 0;
  ...
  /** Sets the value of the enumeration identified by ObjectState.
    ...
    */
  virtual uci::type::MultistaticEmitterDataMT& setObjectState(const uci::type::ObjectStateEnum& value) = 0;
  ...
  /** Sets the value of the enumeration identified by ObjectState.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::MultistaticEmitterDataMT& setObjectState(uci::type::ObjectStateEnum::EnumerationItem value) = 0;
  ...
  /** Clears (disabled) the Element identified by ObjectState.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::MultistaticEmitterDataMT& clearObjectState() = 0;
  ...
  /** Returns a const reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual const uci::type::MultistaticEmitterDataMDT& getMessageData() const = 0;
  ...
  /** Returns a reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual uci::type::MultistaticEmitterDataMDT& getMessageData() = 0;
  ...
  /** Sets the complex content identified by MessageData to the contents of the complex content accessed by the specified
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::MultistaticEmitterDataMT& setMessageData(const uci::type::MultistaticEmitterDataMDT& value) = 0;

  /** The Listener provides the support to listen and handle incoming messages of the type
    * uci::type::MultistaticEmitterDataMT.
    */
  ...
  public:
    ...
    /** The method is used to handle incoming messages.
      ...
      */
    virtual void handleMessage(const uci::type::MultistaticEmitterDataMT& message) = 0;
  ...
  public:
    ...
    /** Adds a listener to this reader to handle incoming messages.
      ...
      */
    virtual void addListener(uci::type::MultistaticEmitterDataMT::Listener& listener) = 0;

    /** Removes the specified listener from this reader.
      *
      * @param listener The listener that is to be removed from this reader.
      */
    virtual void removeListener(uci::type::MultistaticEmitterDataMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s). Returns immediately if no messages are available.
      ...
      */
    virtual unsigned long readNoWait(unsigned long maxNumberOfMessages, uci::type::MultistaticEmitterDataMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s).
      ...
      * @return The number of messages that were handled.
      */
    virtual unsigned long read(unsigned long timeout, unsigned long maxNumberOfMessages, uci::type::MultistaticEmitterDataMT::Listener& listener) = 0;
  ...
  /** This method creates a new reader that can be used to read a MultistaticEmitterDataMT.
    *
    * @param topic The specification of the topic the reader is to read from.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A reader that can read a MultistaticEmitterDataMT.
    */
  static UCI_EXPORT uci::type::MultistaticEmitterDataMT::Reader& createReader(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a reader. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyReader(uci::type::MultistaticEmitterDataMT::Reader& reader);
  ...
  public:
    ...
    /** Writes the OMS message to the topic specified when this Writer was created.
      ...
      */
    virtual void write(uci::type::MultistaticEmitterDataMT& accessor) = 0;
  ...
  /** This method creates a new writer that can be used to write a MultistaticEmitterDataMT.
    *
    * @param topic The specification of the topic the writer is to write to.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A writer that can write a MultistaticEmitterDataMT.
    */
  static UCI_EXPORT uci::type::MultistaticEmitterDataMT::Writer& createWriter(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a writer. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyWriter(uci::type::MultistaticEmitterDataMT::Writer& writer);
...
protected:
  ...
  /** The copy constructor [only available to derived classes].
    *
    * @param rhs The MultistaticEmitterDataMT to copy from.
    */
  MultistaticEmitterDataMT(const MultistaticEmitterDataMT& rhs) {
    (void)rhs;
  }

  /** The assignment operator. Sets the contents of this MultistaticEmitterDataMT to the contents of the
    * MultistaticEmitterDataMT on the right hand side (rhs) of the assignment operator [only available to derived classes].
    *
    * @param rhs The MultistaticEmitterDataMT on the right hand side (rhs) of the assignment operator whose contents are
    *      used to set the contents of this MultistaticEmitterDataMT.
    * @return A reference to this MultistaticEmitterDataMT.
    */
  MultistaticEmitterDataMT& operator=(const MultistaticEmitterDataMT& rhs) {
    (void)rhs;
...
#endif // UCI_TYPE_MULTISTATICEMITTERDATAMT_H
