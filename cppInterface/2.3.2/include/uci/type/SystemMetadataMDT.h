...
#ifndef UCI_TYPE_SYSTEMMETADATAMDT_H
#define UCI_TYPE_SYSTEMMETADATAMDT_H
...
public:
  ...
  /** This method constructs a new SystemMetadataMDT.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed SystemMetadataMDT.
    */
  static UCI_EXPORT SystemMetadataMDT& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new SystemMetadataMDT initializing the data accessed by the new SystemMetadataMDT using the
    * data accessed by the specified SystemMetadataMDT (cloning).
    *
    * @param accessor The SystemMetadataMDT that provides access to the data that is to be used to initialize the data
    *      accessed by the new created SystemMetadataMDT.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed SystemMetadataMDT.
    */
  static UCI_EXPORT SystemMetadataMDT& create(const SystemMetadataMDT& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified SystemMetadataMDT. Use of the specified accessor after it has been destroyed will
    * result in undefined behavior.
    *
    * @param accessor The SystemMetadataMDT that is to be destroyed.
    */
  static UCI_EXPORT void destroy(SystemMetadataMDT& accessor);
  ...
  /** Returns the version that was initialized from the uci:version attribute of SystemMetadataMDT.
    *
    * @return The version that was initialized from the uci:version attribute of SystemMetadataMDT.
    */
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const SystemMetadataMDT& accessor) = 0;
  ...
  /** Sets the complex content identified by MetadataID to the contents of the complex content accessed by the specified
    ...
    */
  virtual uci::type::SystemMetadataMDT& setMetadataID(const uci::type::MetadataID_Type& value) = 0;
  ...
  /** Sets the complex content identified by SystemID to the contents of the complex content accessed by the specified
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::SystemMetadataMDT& setSystemID(const uci::type::SystemID_Type& value) = 0;
  ...
  /** Returns a const reference to the bounded list identified by Metadata.
    ...
    */
  virtual const uci::type::SystemMetadataMDT::Metadata& getMetadata() const = 0;
  ...
  /** Returns a reference to the bounded list identified by Metadata.
    ...
    */
  virtual uci::type::SystemMetadataMDT::Metadata& getMetadata() = 0;
  ...
  /** Sets the bounded list identified by Metadata.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::SystemMetadataMDT& setMetadata(const uci::type::SystemMetadataMDT::Metadata& value) = 0;
...
protected:
  ...
  /** The assignment operator. Sets the contents of this SystemMetadataMDT to the contents of the SystemMetadataMDT on the
    ...
    *      set the contents of this SystemMetadataMDT.
    * @return A reference to this SystemMetadataMDT.
    */
  SystemMetadataMDT& operator=(const SystemMetadataMDT& rhs) {
    (void)rhs;
...
#endif // UCI_TYPE_SYSTEMMETADATAMDT_H
