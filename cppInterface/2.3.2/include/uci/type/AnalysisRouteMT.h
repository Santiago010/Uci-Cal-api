...
#ifndef UCI_TYPE_ANALYSISROUTEMT_H
#define UCI_TYPE_ANALYSISROUTEMT_H

#include "../base/Listener.h"
#include "../base/Reader.h"
#include "../base/Writer.h"
#include "../base/export.h"
#include "AnalysisRouteMDT.h"
...
class AnalysisRouteMT : public virtual MessageType {
public:

  /** This method constructs a new AnalysisRouteMT.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed AnalysisRouteMT.
    */
  static UCI_EXPORT AnalysisRouteMT& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new AnalysisRouteMT initializing the data accessed by the new AnalysisRouteMT using the data
    * accessed by the specified AnalysisRouteMT (cloning).
    *
    * @param accessor The AnalysisRouteMT that provides access to the data that is to be used to initialize the data
    *      accessed by the new created AnalysisRouteMT.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed AnalysisRouteMT.
    */
  static UCI_EXPORT AnalysisRouteMT& create(const AnalysisRouteMT& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified AnalysisRouteMT. Use of the specified accessor after it has been destroyed will
    * result in undefined behavior.
    *
    * @param accessor The AnalysisRouteMT that is to be destroyed.
    */
  static UCI_EXPORT void destroy(AnalysisRouteMT& accessor);

  /** Returns this accessor's type constant, i.e. analysisRouteMT.
    *
    * @return This accessor's type constant, i.e. analysisRouteMT.
    */
  virtual uci::base::accessorType::AccessorType getAccessorType() const noexception {
    return uci::type::accessorType::analysisRouteMT;
  }

  /** Returns the version that was initialized from the uci:version attribute of AnalysisRouteMT.
    *
    * @return The version that was initialized from the uci:version attribute of AnalysisRouteMT.
    */
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const AnalysisRouteMT& accessor) = 0;
  ...
  /** Sets the value of the enumeration identified by ObjectState.
    ...
    */
  virtual uci::type::AnalysisRouteMT& setObjectState(const uci::type::ObjectStateEnum& value) = 0;
  ...
  /** Sets the value of the enumeration identified by ObjectState.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::AnalysisRouteMT& setObjectState(uci::type::ObjectStateEnum::EnumerationItem value) = 0;
  ...
  /** Clears (disabled) the Element identified by ObjectState.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::AnalysisRouteMT& clearObjectState() = 0;
  ...
  /** Returns a const reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual const uci::type::AnalysisRouteMDT& getMessageData() const = 0;
  ...
  /** Returns a reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual uci::type::AnalysisRouteMDT& getMessageData() = 0;
  ...
  /** Sets the complex content identified by MessageData to the contents of the complex content accessed by the specified
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::AnalysisRouteMT& setMessageData(const uci::type::AnalysisRouteMDT& value) = 0;

  /** The Listener provides the support to listen and handle incoming messages of the type uci::type::AnalysisRouteMT. */
  ...
  public:
    ...
    /** The method is used to handle incoming messages.
      ...
      */
    virtual void handleMessage(const uci::type::AnalysisRouteMT& message) = 0;
  ...
  public:
    ...
    /** Adds a listener to this reader to handle incoming messages.
      ...
      */
    virtual void addListener(uci::type::AnalysisRouteMT::Listener& listener) = 0;

    /** Removes the specified listener from this reader.
      *
      * @param listener The listener that is to be removed from this reader.
      */
    virtual void removeListener(uci::type::AnalysisRouteMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s). Returns immediately if no messages are available.
      ...
      */
    virtual unsigned long readNoWait(unsigned long maxNumberOfMessages, uci::type::AnalysisRouteMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s).
      ...
      * @return The number of messages that were handled.
      */
    virtual unsigned long read(unsigned long timeout, unsigned long maxNumberOfMessages, uci::type::AnalysisRouteMT::Listener& listener) = 0;
  ...
  /** This method creates a new reader that can be used to read a AnalysisRouteMT.
    *
    * @param topic The specification of the topic the reader is to read from.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A reader that can read a AnalysisRouteMT.
    */
  static UCI_EXPORT uci::type::AnalysisRouteMT::Reader& createReader(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a reader. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyReader(uci::type::AnalysisRouteMT::Reader& reader);
  ...
  public:
    ...
    /** Writes the OMS message to the topic specified when this Writer was created.
      ...
      */
    virtual void write(uci::type::AnalysisRouteMT& accessor) = 0;
  ...
  /** This method creates a new writer that can be used to write a AnalysisRouteMT.
    *
    * @param topic The specification of the topic the writer is to write to.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A writer that can write a AnalysisRouteMT.
    */
  static UCI_EXPORT uci::type::AnalysisRouteMT::Writer& createWriter(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a writer. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyWriter(uci::type::AnalysisRouteMT::Writer& writer);
...
protected:
  ...
  /** The copy constructor [only available to derived classes].
    *
    * @param rhs The AnalysisRouteMT to copy from.
    */
  AnalysisRouteMT(const AnalysisRouteMT& rhs) {
    (void)rhs;
  }

  /** The assignment operator. Sets the contents of this AnalysisRouteMT to the contents of the AnalysisRouteMT on the
    * right hand side (rhs) of the assignment operator [only available to derived classes].
    *
    * @param rhs The AnalysisRouteMT on the right hand side (rhs) of the assignment operator whose contents are used to set
    *      the contents of this AnalysisRouteMT.
    * @return A reference to this AnalysisRouteMT.
    */
  AnalysisRouteMT& operator=(const AnalysisRouteMT& rhs) {
    (void)rhs;
...
#endif // UCI_TYPE_ANALYSISROUTEMT_H
