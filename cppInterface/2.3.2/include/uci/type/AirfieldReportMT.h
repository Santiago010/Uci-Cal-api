...
#ifndef UCI_TYPE_AIRFIELDREPORTMT_H
#define UCI_TYPE_AIRFIELDREPORTMT_H

#include "../base/Listener.h"
#include "../base/Reader.h"
#include "../base/Writer.h"
#include "../base/export.h"
#include "AirfieldReportMDT.h"
...
class AirfieldReportMT : public virtual MessageType {
public:

  /** This method constructs a new AirfieldReportMT.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed AirfieldReportMT.
    */
  static UCI_EXPORT AirfieldReportMT& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new AirfieldReportMT initializing the data accessed by the new AirfieldReportMT using the
    * data accessed by the specified AirfieldReportMT (cloning).
    *
    * @param accessor The AirfieldReportMT that provides access to the data that is to be used to initialize the data
    *      accessed by the new created AirfieldReportMT.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed AirfieldReportMT.
    */
  static UCI_EXPORT AirfieldReportMT& create(const AirfieldReportMT& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified AirfieldReportMT. Use of the specified accessor after it has been destroyed will
    * result in undefined behavior.
    *
    * @param accessor The AirfieldReportMT that is to be destroyed.
    */
  static UCI_EXPORT void destroy(AirfieldReportMT& accessor);

  /** Returns this accessor's type constant, i.e. airfieldReportMT.
    *
    * @return This accessor's type constant, i.e. airfieldReportMT.
    */
  virtual uci::base::accessorType::AccessorType getAccessorType() const noexception {
    return uci::type::accessorType::airfieldReportMT;
  }

  /** Returns the version that was initialized from the uci:version attribute of AirfieldReportMT.
    *
    * @return The version that was initialized from the uci:version attribute of AirfieldReportMT.
    */
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const AirfieldReportMT& accessor) = 0;
  ...
  /** Sets the value of the enumeration identified by ObjectState.
    ...
    */
  virtual uci::type::AirfieldReportMT& setObjectState(const uci::type::ObjectStateEnum& value) = 0;
  ...
  /** Sets the value of the enumeration identified by ObjectState.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::AirfieldReportMT& setObjectState(uci::type::ObjectStateEnum::EnumerationItem value) = 0;
  ...
  /** Clears (disabled) the Element identified by ObjectState.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::AirfieldReportMT& clearObjectState() = 0;
  ...
  /** Returns a const reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual const uci::type::AirfieldReportMDT& getMessageData() const = 0;
  ...
  /** Returns a reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual uci::type::AirfieldReportMDT& getMessageData() = 0;
  ...
  /** Sets the complex content identified by MessageData to the contents of the complex content accessed by the specified
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::AirfieldReportMT& setMessageData(const uci::type::AirfieldReportMDT& value) = 0;

  /** The Listener provides the support to listen and handle incoming messages of the type uci::type::AirfieldReportMT. */
  ...
  public:
    ...
    /** The method is used to handle incoming messages.
      ...
      */
    virtual void handleMessage(const uci::type::AirfieldReportMT& message) = 0;
  ...
  public:
    ...
    /** Adds a listener to this reader to handle incoming messages.
      ...
      */
    virtual void addListener(uci::type::AirfieldReportMT::Listener& listener) = 0;

    /** Removes the specified listener from this reader.
      *
      * @param listener The listener that is to be removed from this reader.
      */
    virtual void removeListener(uci::type::AirfieldReportMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s). Returns immediately if no messages are available.
      ...
      */
    virtual unsigned long readNoWait(unsigned long maxNumberOfMessages, uci::type::AirfieldReportMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s).
      ...
      * @return The number of messages that were handled.
      */
    virtual unsigned long read(unsigned long timeout, unsigned long maxNumberOfMessages, uci::type::AirfieldReportMT::Listener& listener) = 0;
  ...
  /** This method creates a new reader that can be used to read a AirfieldReportMT.
    *
    * @param topic The specification of the topic the reader is to read from.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A reader that can read a AirfieldReportMT.
    */
  static UCI_EXPORT uci::type::AirfieldReportMT::Reader& createReader(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a reader. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyReader(uci::type::AirfieldReportMT::Reader& reader);
  ...
  public:
    ...
    /** Writes the OMS message to the topic specified when this Writer was created.
      ...
      */
    virtual void write(uci::type::AirfieldReportMT& accessor) = 0;
  ...
  /** This method creates a new writer that can be used to write a AirfieldReportMT.
    *
    * @param topic The specification of the topic the writer is to write to.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A writer that can write a AirfieldReportMT.
    */
  static UCI_EXPORT uci::type::AirfieldReportMT::Writer& createWriter(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a writer. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyWriter(uci::type::AirfieldReportMT::Writer& writer);
...
protected:
  ...
  /** The copy constructor [only available to derived classes].
    ...
    */
  AirfieldReportMT(const AirfieldReportMT& rhs) {
    (void)rhs;
  }

  /** The assignment operator. Sets the contents of this AirfieldReportMT to the contents of the AirfieldReportMT on the
    * right hand side (rhs) of the assignment operator [only available to derived classes].
    *
    * @param rhs The AirfieldReportMT on the right hand side (rhs) of the assignment operator whose contents are used to
    *      set the contents of this AirfieldReportMT.
    * @return A reference to this AirfieldReportMT.
    */
  AirfieldReportMT& operator=(const AirfieldReportMT& rhs) {
    (void)rhs;
...
#endif // UCI_TYPE_AIRFIELDREPORTMT_H
