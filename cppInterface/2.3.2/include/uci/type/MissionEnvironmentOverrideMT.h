/** @file MissionEnvironmentOverrideMT.h
 *
...
#ifndef UCI_TYPE_MISSIONENVIRONMENTOVERRIDEMT_H
#define UCI_TYPE_MISSIONENVIRONMENTOVERRIDEMT_H
...
#include "MissionEnvironmentOverrideMDT.h"
...
class MissionEnvironmentOverrideMT : public virtual MessageType {
public:

  /** This method constructs a new MissionEnvironmentOverrideMT.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed MissionEnvironmentOverrideMT.
    */
  static UCI_EXPORT MissionEnvironmentOverrideMT& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new MissionEnvironmentOverrideMT initializing the data accessed by the new
    * MissionEnvironmentOverrideMT using the data accessed by the specified MissionEnvironmentOverrideMT (cloning).
    *
    * @param accessor The MissionEnvironmentOverrideMT that provides access to the data that is to be used to initialize
    *      the data accessed by the new created MissionEnvironmentOverrideMT.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed MissionEnvironmentOverrideMT.
    */
  static UCI_EXPORT MissionEnvironmentOverrideMT& create(const MissionEnvironmentOverrideMT& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified MissionEnvironmentOverrideMT. Use of the specified accessor after it has been
    * destroyed will result in undefined behavior.
    *
    * @param accessor The MissionEnvironmentOverrideMT that is to be destroyed.
    */
  static UCI_EXPORT void destroy(MissionEnvironmentOverrideMT& accessor);
  ...
  /** Returns the version that was initialized from the uci:version attribute of MissionEnvironmentOverrideMT.
    *
    * @return The version that was initialized from the uci:version attribute of MissionEnvironmentOverrideMT.
    */
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const MissionEnvironmentOverrideMT& accessor) = 0;
  ...
  /** Sets the value of the enumeration identified by ObjectState.
    ...
    */
  virtual uci::type::MissionEnvironmentOverrideMT& setObjectState(const uci::type::ObjectStateEnum& value) = 0;
  ...
  /** Sets the value of the enumeration identified by ObjectState.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::MissionEnvironmentOverrideMT& setObjectState(uci::type::ObjectStateEnum::EnumerationItem value) = 0;
  ...
  /** Clears (disabled) the Element identified by ObjectState.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::MissionEnvironmentOverrideMT& clearObjectState() = 0;
  ...
  /** Returns a const reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual const uci::type::MissionEnvironmentOverrideMDT& getMessageData() const = 0;
  ...
  /** Returns a reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual uci::type::MissionEnvironmentOverrideMDT& getMessageData() = 0;
  ...
  /** Sets the complex content identified by MessageData to the contents of the complex content accessed by the specified
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::MissionEnvironmentOverrideMT& setMessageData(const uci::type::MissionEnvironmentOverrideMDT& value) = 0;

  /** The Listener provides the support to listen and handle incoming messages of the type
    * uci::type::MissionEnvironmentOverrideMT.
    */
  ...
  public:
    ...
    /** The method is used to handle incoming messages.
      ...
      */
    virtual void handleMessage(const uci::type::MissionEnvironmentOverrideMT& message) = 0;
  ...
  public:
    ...
    /** Adds a listener to this reader to handle incoming messages.
      ...
      */
    virtual void addListener(uci::type::MissionEnvironmentOverrideMT::Listener& listener) = 0;

    /** Removes the specified listener from this reader.
      *
      * @param listener The listener that is to be removed from this reader.
      */
    virtual void removeListener(uci::type::MissionEnvironmentOverrideMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s). Returns immediately if no messages are available.
      ...
      */
    virtual unsigned long readNoWait(unsigned long maxNumberOfMessages, uci::type::MissionEnvironmentOverrideMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s).
      ...
      * @return The number of messages that were handled.
      */
    virtual unsigned long read(unsigned long timeout, unsigned long maxNumberOfMessages, uci::type::MissionEnvironmentOverrideMT::Listener& listener) = 0;
  ...
  /** This method creates a new reader that can be used to read a MissionEnvironmentOverrideMT.
    *
    * @param topic The specification of the topic the reader is to read from.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A reader that can read a MissionEnvironmentOverrideMT.
    */
  static UCI_EXPORT uci::type::MissionEnvironmentOverrideMT::Reader& createReader(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a reader. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyReader(uci::type::MissionEnvironmentOverrideMT::Reader& reader);
  ...
  public:
    ...
    /** Writes the OMS message to the topic specified when this Writer was created.
      ...
      */
    virtual void write(uci::type::MissionEnvironmentOverrideMT& accessor) = 0;
  ...
  /** This method creates a new writer that can be used to write a MissionEnvironmentOverrideMT.
    *
    * @param topic The specification of the topic the writer is to write to.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A writer that can write a MissionEnvironmentOverrideMT.
    */
  static UCI_EXPORT uci::type::MissionEnvironmentOverrideMT::Writer& createWriter(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a writer. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyWriter(uci::type::MissionEnvironmentOverrideMT::Writer& writer);
...
protected:
  ...
  /** The assignment operator. Sets the contents of this MissionEnvironmentOverrideMT to the contents of the
    * MissionEnvironmentOverrideMT on the right hand side (rhs) of the assignment operator [only available to derived
    * classes].
    *
    * @param rhs The MissionEnvironmentOverrideMT on the right hand side (rhs) of the assignment operator whose contents
    *      are used to set the contents of this MissionEnvironmentOverrideMT.
    * @return A reference to this MissionEnvironmentOverrideMT.
    */
  MissionEnvironmentOverrideMT& operator=(const MissionEnvironmentOverrideMT& rhs) {
    (void)rhs;
...
#endif // UCI_TYPE_MISSIONENVIRONMENTOVERRIDEMT_H
