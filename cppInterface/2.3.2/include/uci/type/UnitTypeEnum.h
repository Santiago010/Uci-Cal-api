...
#ifndef UCI_TYPE_UNITTYPEENUM_H
#define UCI_TYPE_UNITTYPEENUM_H
...
public:
  ...
  /** The assignment operator. Sets the contents of this UnitTypeEnum to the contents of the UnitTypeEnum on the right hand
    ...
    * @return A reference to this UnitTypeEnum.
    */
  UnitTypeEnum& operator=(const UnitTypeEnum& rhs) {
    setValue(rhs.getValue());
    return *this;
  }

  /** The assignment operator that sets the value of this UnitTypeEnum enumeration to the EnumerationItem on the right hand
    * side of the assignment operator.
    *
    * @param rhs The EnumerationItem whose value is to be assigned to this UnitTypeEnum enumeration.
    * @return A reference to this UnitTypeEnum enumeration.
    */
  UnitTypeEnum& operator=(EnumerationItem rhs) {
    setValue(rhs);
    return *this;
  }
  ...
  /** Sets the value of this UnitTypeEnum enumeration to the value of the specified enumeration item.
    *
    * @param item The EnumerationItem whose value is to be used to set the value of this UnitTypeEnum enumeration.
    */
