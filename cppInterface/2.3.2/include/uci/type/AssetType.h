...
#ifndef UCI_TYPE_ASSETTYPE_H
#define UCI_TYPE_ASSETTYPE_H
...
public:
  ...
  /** This method constructs a new AssetType.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed AssetType.
    */
  static UCI_EXPORT AssetType& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new AssetType initializing the data accessed by the new AssetType using the data accessed by
    * the specified AssetType (cloning).
    *
    * @param accessor The AssetType that provides access to the data that is to be used to initialize the data accessed by
    *      the new created AssetType.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed AssetType.
    */
  static UCI_EXPORT AssetType& create(const AssetType& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified AssetType. Use of the specified accessor after it has been destroyed will result
    * in undefined behavior.
    *
    * @param accessor The AssetType that is to be destroyed.
    */
  static UCI_EXPORT void destroy(AssetType& accessor);
  ...
  /** Returns the version that was initialized from the uci:version attribute of AssetType.
    *
    * @return The version that was initialized from the uci:version attribute of AssetType.
    */
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const AssetType& accessor) = 0;
  ...
  /** This method returns this choice's "selection ordinal." A choice's "selection ordinal" is used to specify which
    ...
    */
  virtual AssetTypeChoice getAssetTypeChoiceOrdinal() const = 0;
  ...
  /** This method is used to set this choice's "selection ordinal." A choice's "selection ordinal" is used to specify which
    ...
    */
  virtual uci::type::AssetType& setAssetTypeChoiceOrdinal(AssetTypeChoice chosenElementOrdinal, uci::base::accessorType::AccessorType type = uci::base::accessorType::null) = 0;
  ...
  /** Sets the complex content identified by SystemID to the contents of the complex content accessed by the specified
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::AssetType& setSystemID(const uci::type::SystemID_Type& value) = 0;
  ...
  /** Sets the complex content identified by EntityID to the contents of the complex content accessed by the specified
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::AssetType& setEntityID(const uci::type::EntityID_Type& value) = 0;
...
protected:
  ...
  /** The assignment operator. Sets the contents of this AssetType to the contents of the AssetType on the right hand side
    ...
    *      contents of this AssetType.
    * @return A reference to this AssetType.
    */
  AssetType& operator=(const AssetType& rhs) {
    (void)rhs;
