...
#ifndef UCI_TYPE_OPLINETYPE_H
#define UCI_TYPE_OPLINETYPE_H
...
class OpLineType : public virtual LineType {
public:

  /** This method constructs a new OpLineType.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed OpLineType.
    */
  static UCI_EXPORT OpLineType& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new OpLineType initializing the data accessed by the new OpLineType using the data accessed
    * by the specified OpLineType (cloning).
    *
    * @param accessor The OpLineType that provides access to the data that is to be used to initialize the data accessed by
    *      the new created OpLineType.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed OpLineType.
    */
  static UCI_EXPORT OpLineType& create(const OpLineType& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified OpLineType. Use of the specified accessor after it has been destroyed will result
    * in undefined behavior.
    *
    * @param accessor The OpLineType that is to be destroyed.
    */
  static UCI_EXPORT void destroy(OpLineType& accessor);
  ...
  /** Returns the version that was initialized from the uci:version attribute of OpLineType.
    *
    * @return The version that was initialized from the uci:version attribute of OpLineType.
    */
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const OpLineType& accessor) = 0;
  ...
  /** Sets the complex content identified by Velocity to the contents of the complex content accessed by the specified
    ...
    */
  virtual uci::type::OpLineType& setVelocity(const uci::type::Velocity2D_Type& value) = 0;
  ...
  /** Clears (disabled) the Element identified by Velocity.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::OpLineType& clearVelocity() = 0;
...
protected:
  ...
  /** The assignment operator. Sets the contents of this OpLineType to the contents of the OpLineType on the right hand
    ...
    *      contents of this OpLineType.
    * @return A reference to this OpLineType.
    */
  OpLineType& operator=(const OpLineType& rhs) {
    (void)rhs;
