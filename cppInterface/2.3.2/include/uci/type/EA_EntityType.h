...
public:
  ...
  /** This method constructs a new EA_EntityType.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed EA_EntityType.
    */
  static UCI_EXPORT EA_EntityType& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new EA_EntityType initializing the data accessed by the new EA_EntityType using the data
    * accessed by the specified EA_EntityType (cloning).
    *
    * @param accessor The EA_EntityType that provides access to the data that is to be used to initialize the data accessed
    *      by the new created EA_EntityType.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed EA_EntityType.
    */
  static UCI_EXPORT EA_EntityType& create(const EA_EntityType& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified EA_EntityType. Use of the specified accessor after it has been destroyed will
    * result in undefined behavior.
    *
    * @param accessor The EA_EntityType that is to be destroyed.
    */
  static UCI_EXPORT void destroy(EA_EntityType& accessor);
  ...
  /** Returns the version that was initialized from the uci:version attribute of EA_EntityType.
    *
    * @return The version that was initialized from the uci:version attribute of EA_EntityType.
    */
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const EA_EntityType& accessor) = 0;

  /** Indicates a proposed EA technique. See type annotations for further details. [Occurrences: Minimum: 0; Maximum:
    * MAX_LENGTH]
    */
  typedef uci::base::BoundedList<uci::type::EA_TechniqueIdentifierType, uci::type::accessorType::eA_TechniqueIdentifierType> TechniqueIdentifier;
  ...
  /** Sets the complex content identified by EntityID to the contents of the complex content accessed by the specified
    ...
    */
  virtual uci::type::EA_EntityType& setEntityID(const uci::type::EntityID_Type& value) = 0;
  ...
  /** Returns a const reference to the bounded list identified by TechniqueIdentifier.
    *
    * @return A const reference to the bounded list identified by TechniqueIdentifier.
    */
  virtual const uci::type::EA_EntityType::TechniqueIdentifier& getTechniqueIdentifier() const = 0;

  /** Returns a reference to the bounded list identified by TechniqueIdentifier.
    *
    * @return A reference to the bounded list identified by TechniqueIdentifier.
    */
  virtual uci::type::EA_EntityType::TechniqueIdentifier& getTechniqueIdentifier() = 0;

  /** Sets the bounded list identified by TechniqueIdentifier.
    *
    * @param value The bounded list whose contents are to be used to set the value of the bounded list accessed by this
    *      accessor.
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::EA_EntityType& setTechniqueIdentifier(const uci::type::EA_EntityType::TechniqueIdentifier& value) = 0;
  ...
  /** Sets the complex content identified by CapabilityID to the contents of the complex content accessed by the specified
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::EA_EntityType& setCapabilityID(const uci::type::CapabilityID_Type& value) = 0;
  ...
  /** Clears (disabled) the Element identified by CapabilityID.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::EA_EntityType& clearCapabilityID() = 0;
  ...
  /** Returns a const reference to the bounded list identified by ComponentID.
    ...
    */
  virtual const uci::type::EA_EntityType::ComponentID& getComponentID() const = 0;
  ...
  /** Returns a reference to the bounded list identified by ComponentID.
    ...
    */
  virtual uci::type::EA_EntityType::ComponentID& getComponentID() = 0;
  ...
  /** Sets the bounded list identified by ComponentID.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::EA_EntityType& setComponentID(const uci::type::EA_EntityType::ComponentID& value) = 0;
...
protected:
  ...
  /** The assignment operator. Sets the contents of this EA_EntityType to the contents of the EA_EntityType on the right
    ...
    *      the contents of this EA_EntityType.
    * @return A reference to this EA_EntityType.
    */
  EA_EntityType& operator=(const EA_EntityType& rhs) {
    (void)rhs;
...
#endif // UCI_TYPE_EA_ENTITYTYPE_H
