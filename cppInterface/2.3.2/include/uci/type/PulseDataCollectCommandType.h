...
public:
  ...
  /** This method constructs a new PulseDataCollectCommandType.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed PulseDataCollectCommandType.
    */
  static UCI_EXPORT PulseDataCollectCommandType& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new PulseDataCollectCommandType initializing the data accessed by the new
    * PulseDataCollectCommandType using the data accessed by the specified PulseDataCollectCommandType (cloning).
    *
    * @param accessor The PulseDataCollectCommandType that provides access to the data that is to be used to initialize the
    *      data accessed by the new created PulseDataCollectCommandType.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed PulseDataCollectCommandType.
    */
  static UCI_EXPORT PulseDataCollectCommandType& create(const PulseDataCollectCommandType& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified PulseDataCollectCommandType. Use of the specified accessor after it has been
    * destroyed will result in undefined behavior.
    *
    * @param accessor The PulseDataCollectCommandType that is to be destroyed.
    */
  static UCI_EXPORT void destroy(PulseDataCollectCommandType& accessor);
  ...
  /** Returns the version that was initialized from the uci:version attribute of PulseDataCollectCommandType.
    *
    * @return The version that was initialized from the uci:version attribute of PulseDataCollectCommandType.
    */
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const PulseDataCollectCommandType& accessor) = 0;
  ...
  /** Sets the complex content identified by CollectionFrequency to the contents of the complex content accessed by the
    ...
    */
  virtual uci::type::PulseDataCollectCommandType& setCollectionFrequency(const uci::type::CollectionFrequencyType& value) = 0;
  ...
  /** Sets the value of the SimplePrimitive data type identified by StartTime.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::PulseDataCollectCommandType& setStartTime(uci::type::DateTimeTypeValue value) = 0;
  ...
  /** Sets the value of the SimplePrimitive data type identified by DwellDuration.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::PulseDataCollectCommandType& setDwellDuration(uci::type::DurationTypeValue value) = 0;
  ...
  /** Sets the value of the SimplePrimitive data type identified by Dwells.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::PulseDataCollectCommandType& setDwells(xs::UnsignedInt value) = 0;
  ...
  /** Clears (disabled) the Element identified by Dwells.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::PulseDataCollectCommandType& clearDwells() = 0;
  ...
  /** Sets the value of the SimplePrimitive data type identified by RepetitionInterval.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::PulseDataCollectCommandType& setRepetitionInterval(uci::type::DurationTypeValue value) = 0;
  ...
  /** Clears (disabled) the Element identified by RepetitionInterval.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::PulseDataCollectCommandType& clearRepetitionInterval() = 0;
  ...
  /** Sets the value of the SimplePrimitive data type identified by PulseWidth.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::PulseDataCollectCommandType& setPulseWidth(uci::type::DurationTypeValue value) = 0;
  ...
  /** Clears (disabled) the Element identified by PulseWidth.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::PulseDataCollectCommandType& clearPulseWidth() = 0;

  /** Returns the value of the SimplePrimitive data type identified by PRI.
    *
    * @return The value of the simple primitive data type identified by PRI.
    */
  virtual uci::type::DurationTypeValue getPRI() const = 0;

  /** Sets the value of the SimplePrimitive data type identified by PRI.
    *
    * @param value The value to set the SimplePrimitve data type to.
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::PulseDataCollectCommandType& setPRI(uci::type::DurationTypeValue value) = 0;
  ...
  /** Clears (disabled) the Element identified by PRI.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::PulseDataCollectCommandType& clearPRI() = 0;
  ...
  /** Sets the complex content identified by SignalBandwidth to the contents of the complex content accessed by the
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::PulseDataCollectCommandType& setSignalBandwidth(const uci::type::FrequencyRangeType& value) = 0;
  ...
  /** Clears (disabled) the Element identified by SignalBandwidth.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::PulseDataCollectCommandType& clearSignalBandwidth() = 0;
  ...
  /** Sets the value of the enumeration identified by Modulation.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::PulseDataCollectCommandType& setModulation(const uci::type::ModulationEnum& value) = 0;
  ...
  /** Sets the value of the enumeration identified by Modulation.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::PulseDataCollectCommandType& setModulation(uci::type::ModulationEnum::EnumerationItem value) = 0;
  ...
  /** Clears (disabled) the Element identified by Modulation.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::PulseDataCollectCommandType& clearModulation() = 0;
  ...
  /** Sets the value of the enumeration identified by DataCollectType.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::PulseDataCollectCommandType& setDataCollectType(const uci::type::SignalTypeEnum& value) = 0;
  ...
  /** Sets the value of the enumeration identified by DataCollectType.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::PulseDataCollectCommandType& setDataCollectType(uci::type::SignalTypeEnum::EnumerationItem value) = 0;
  ...
  /** Clears (disabled) the Element identified by DataCollectType.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::PulseDataCollectCommandType& clearDataCollectType() = 0;
  ...
  /** Sets the value of the SimplePrimitive data type identified by SampleRate.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::PulseDataCollectCommandType& setSampleRate(xs::Float value) = 0;
  ...
  /** Clears (disabled) the Element identified by SampleRate.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::PulseDataCollectCommandType& clearSampleRate() = 0;
  ...
  /** Sets the value of the SimplePrimitive data type identified by FFT_PointsPerSample.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::PulseDataCollectCommandType& setFFT_PointsPerSample(xs::Int value) = 0;
  ...
  /** Clears (disabled) the Element identified by FFT_PointsPerSample.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::PulseDataCollectCommandType& clearFFT_PointsPerSample() = 0;
...
protected:
  ...
  /** The assignment operator. Sets the contents of this PulseDataCollectCommandType to the contents of the
    * PulseDataCollectCommandType on the right hand side (rhs) of the assignment operator [only available to derived
    * classes].
    *
    * @param rhs The PulseDataCollectCommandType on the right hand side (rhs) of the assignment operator whose contents are
    *      used to set the contents of this PulseDataCollectCommandType.
    * @return A reference to this PulseDataCollectCommandType.
    */
  PulseDataCollectCommandType& operator=(const PulseDataCollectCommandType& rhs) {
    (void)rhs;
...
#endif // UCI_TYPE_PULSEDATACOLLECTCOMMANDTYPE_H
