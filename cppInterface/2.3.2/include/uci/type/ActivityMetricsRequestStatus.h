/** @file ActivityMetricsRequestStatus.h
 *
...
typedef uci::type::ActivityMetricsRequestStatusMT ActivityMetricsRequestStatus;

} // namespace type
} // namespace uci

#endif // UCI_TYPE_ACTIVITYMETRICSREQUESTSTATUS_H
