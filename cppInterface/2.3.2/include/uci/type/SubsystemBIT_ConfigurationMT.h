/** @file SubsystemBIT_ConfigurationMT.h
 *
...
#ifndef UCI_TYPE_SUBSYSTEMBIT_CONFIGURATIONMT_H
#define UCI_TYPE_SUBSYSTEMBIT_CONFIGURATIONMT_H
...
#include "SubsystemBIT_ConfigurationMDT.h"
...
class SubsystemBIT_ConfigurationMT : public virtual MessageType {
public:

  /** This method constructs a new SubsystemBIT_ConfigurationMT.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed SubsystemBIT_ConfigurationMT.
    */
  static UCI_EXPORT SubsystemBIT_ConfigurationMT& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new SubsystemBIT_ConfigurationMT initializing the data accessed by the new
    * SubsystemBIT_ConfigurationMT using the data accessed by the specified SubsystemBIT_ConfigurationMT (cloning).
    *
    * @param accessor The SubsystemBIT_ConfigurationMT that provides access to the data that is to be used to initialize
    *      the data accessed by the new created SubsystemBIT_ConfigurationMT.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed SubsystemBIT_ConfigurationMT.
    */
  static UCI_EXPORT SubsystemBIT_ConfigurationMT& create(const SubsystemBIT_ConfigurationMT& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified SubsystemBIT_ConfigurationMT. Use of the specified accessor after it has been
    * destroyed will result in undefined behavior.
    *
    * @param accessor The SubsystemBIT_ConfigurationMT that is to be destroyed.
    */
  static UCI_EXPORT void destroy(SubsystemBIT_ConfigurationMT& accessor);
  ...
  /** Returns the version that was initialized from the uci:version attribute of SubsystemBIT_ConfigurationMT.
    *
    * @return The version that was initialized from the uci:version attribute of SubsystemBIT_ConfigurationMT.
    */
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const SubsystemBIT_ConfigurationMT& accessor) = 0;
  ...
  /** Sets the value of the enumeration identified by ObjectState.
    ...
    */
  virtual uci::type::SubsystemBIT_ConfigurationMT& setObjectState(const uci::type::ObjectStateEnum& value) = 0;
  ...
  /** Sets the value of the enumeration identified by ObjectState.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::SubsystemBIT_ConfigurationMT& setObjectState(uci::type::ObjectStateEnum::EnumerationItem value) = 0;
  ...
  /** Clears (disabled) the Element identified by ObjectState.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::SubsystemBIT_ConfigurationMT& clearObjectState() = 0;
  ...
  /** Returns a const reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual const uci::type::SubsystemBIT_ConfigurationMDT& getMessageData() const = 0;
  ...
  /** Returns a reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual uci::type::SubsystemBIT_ConfigurationMDT& getMessageData() = 0;
  ...
  /** Sets the complex content identified by MessageData to the contents of the complex content accessed by the specified
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::SubsystemBIT_ConfigurationMT& setMessageData(const uci::type::SubsystemBIT_ConfigurationMDT& value) = 0;

  /** The Listener provides the support to listen and handle incoming messages of the type
    * uci::type::SubsystemBIT_ConfigurationMT.
    */
  ...
  public:
    ...
    /** The method is used to handle incoming messages.
      ...
      */
    virtual void handleMessage(const uci::type::SubsystemBIT_ConfigurationMT& message) = 0;
  ...
  public:
    ...
    /** Adds a listener to this reader to handle incoming messages.
      ...
      */
    virtual void addListener(uci::type::SubsystemBIT_ConfigurationMT::Listener& listener) = 0;

    /** Removes the specified listener from this reader.
      *
      * @param listener The listener that is to be removed from this reader.
      */
    virtual void removeListener(uci::type::SubsystemBIT_ConfigurationMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s). Returns immediately if no messages are available.
      ...
      */
    virtual unsigned long readNoWait(unsigned long maxNumberOfMessages, uci::type::SubsystemBIT_ConfigurationMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s).
      ...
      * @return The number of messages that were handled.
      */
    virtual unsigned long read(unsigned long timeout, unsigned long maxNumberOfMessages, uci::type::SubsystemBIT_ConfigurationMT::Listener& listener) = 0;
  ...
  /** This method creates a new reader that can be used to read a SubsystemBIT_ConfigurationMT.
    *
    * @param topic The specification of the topic the reader is to read from.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A reader that can read a SubsystemBIT_ConfigurationMT.
    */
  static UCI_EXPORT uci::type::SubsystemBIT_ConfigurationMT::Reader& createReader(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a reader. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyReader(uci::type::SubsystemBIT_ConfigurationMT::Reader& reader);
  ...
  public:
    ...
    /** Writes the OMS message to the topic specified when this Writer was created.
      ...
      */
    virtual void write(uci::type::SubsystemBIT_ConfigurationMT& accessor) = 0;
  ...
  /** This method creates a new writer that can be used to write a SubsystemBIT_ConfigurationMT.
    *
    * @param topic The specification of the topic the writer is to write to.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A writer that can write a SubsystemBIT_ConfigurationMT.
    */
  static UCI_EXPORT uci::type::SubsystemBIT_ConfigurationMT::Writer& createWriter(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a writer. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyWriter(uci::type::SubsystemBIT_ConfigurationMT::Writer& writer);
...
protected:
  ...
  /** The assignment operator. Sets the contents of this SubsystemBIT_ConfigurationMT to the contents of the
    * SubsystemBIT_ConfigurationMT on the right hand side (rhs) of the assignment operator [only available to derived
    * classes].
    *
    * @param rhs The SubsystemBIT_ConfigurationMT on the right hand side (rhs) of the assignment operator whose contents
    *      are used to set the contents of this SubsystemBIT_ConfigurationMT.
    * @return A reference to this SubsystemBIT_ConfigurationMT.
    */
  SubsystemBIT_ConfigurationMT& operator=(const SubsystemBIT_ConfigurationMT& rhs) {
    (void)rhs;
...
#endif // UCI_TYPE_SUBSYSTEMBIT_CONFIGURATIONMT_H
