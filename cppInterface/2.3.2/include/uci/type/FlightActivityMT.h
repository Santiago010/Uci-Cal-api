...
#ifndef UCI_TYPE_FLIGHTACTIVITYMT_H
#define UCI_TYPE_FLIGHTACTIVITYMT_H

#include "../base/Listener.h"
#include "../base/Reader.h"
#include "../base/Writer.h"
#include "../base/export.h"
#include "FlightActivityMDT.h"
...
class FlightActivityMT : public virtual MessageType {
public:

  /** This method constructs a new FlightActivityMT.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed FlightActivityMT.
    */
  static UCI_EXPORT FlightActivityMT& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new FlightActivityMT initializing the data accessed by the new FlightActivityMT using the
    * data accessed by the specified FlightActivityMT (cloning).
    *
    * @param accessor The FlightActivityMT that provides access to the data that is to be used to initialize the data
    *      accessed by the new created FlightActivityMT.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed FlightActivityMT.
    */
  static UCI_EXPORT FlightActivityMT& create(const FlightActivityMT& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified FlightActivityMT. Use of the specified accessor after it has been destroyed will
    * result in undefined behavior.
    *
    * @param accessor The FlightActivityMT that is to be destroyed.
    */
  static UCI_EXPORT void destroy(FlightActivityMT& accessor);

  /** Returns this accessor's type constant, i.e. flightActivityMT.
    *
    * @return This accessor's type constant, i.e. flightActivityMT.
    */
  virtual uci::base::accessorType::AccessorType getAccessorType() const noexception {
    return uci::type::accessorType::flightActivityMT;
  }

  /** Returns the version that was initialized from the uci:version attribute of FlightActivityMT.
    *
    * @return The version that was initialized from the uci:version attribute of FlightActivityMT.
    */
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const FlightActivityMT& accessor) = 0;
  ...
  /** Sets the value of the enumeration identified by ObjectState.
    ...
    */
  virtual uci::type::FlightActivityMT& setObjectState(const uci::type::ObjectStateEnum& value) = 0;
  ...
  /** Sets the value of the enumeration identified by ObjectState.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::FlightActivityMT& setObjectState(uci::type::ObjectStateEnum::EnumerationItem value) = 0;
  ...
  /** Clears (disabled) the Element identified by ObjectState.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::FlightActivityMT& clearObjectState() = 0;
  ...
  /** Returns a const reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual const uci::type::FlightActivityMDT& getMessageData() const = 0;
  ...
  /** Returns a reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual uci::type::FlightActivityMDT& getMessageData() = 0;
  ...
  /** Sets the complex content identified by MessageData to the contents of the complex content accessed by the specified
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::FlightActivityMT& setMessageData(const uci::type::FlightActivityMDT& value) = 0;

  /** The Listener provides the support to listen and handle incoming messages of the type uci::type::FlightActivityMT. */
  ...
  public:
    ...
    /** The method is used to handle incoming messages.
      ...
      */
    virtual void handleMessage(const uci::type::FlightActivityMT& message) = 0;
  ...
  public:
    ...
    /** Adds a listener to this reader to handle incoming messages.
      ...
      */
    virtual void addListener(uci::type::FlightActivityMT::Listener& listener) = 0;

    /** Removes the specified listener from this reader.
      *
      * @param listener The listener that is to be removed from this reader.
      */
    virtual void removeListener(uci::type::FlightActivityMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s). Returns immediately if no messages are available.
      ...
      */
    virtual unsigned long readNoWait(unsigned long maxNumberOfMessages, uci::type::FlightActivityMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s).
      ...
      * @return The number of messages that were handled.
      */
    virtual unsigned long read(unsigned long timeout, unsigned long maxNumberOfMessages, uci::type::FlightActivityMT::Listener& listener) = 0;
  ...
  /** This method creates a new reader that can be used to read a FlightActivityMT.
    *
    * @param topic The specification of the topic the reader is to read from.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A reader that can read a FlightActivityMT.
    */
  static UCI_EXPORT uci::type::FlightActivityMT::Reader& createReader(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a reader. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyReader(uci::type::FlightActivityMT::Reader& reader);
  ...
  public:
    ...
    /** Writes the OMS message to the topic specified when this Writer was created.
      ...
      */
    virtual void write(uci::type::FlightActivityMT& accessor) = 0;
  ...
  /** This method creates a new writer that can be used to write a FlightActivityMT.
    *
    * @param topic The specification of the topic the writer is to write to.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A writer that can write a FlightActivityMT.
    */
  static UCI_EXPORT uci::type::FlightActivityMT::Writer& createWriter(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a writer. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyWriter(uci::type::FlightActivityMT::Writer& writer);
...
protected:
  ...
  /** The copy constructor [only available to derived classes].
    *
    * @param rhs The FlightActivityMT to copy from.
    */
  FlightActivityMT(const FlightActivityMT& rhs) {
    (void)rhs;
  }

  /** The assignment operator. Sets the contents of this FlightActivityMT to the contents of the FlightActivityMT on the
    * right hand side (rhs) of the assignment operator [only available to derived classes].
    *
    * @param rhs The FlightActivityMT on the right hand side (rhs) of the assignment operator whose contents are used to
    *      set the contents of this FlightActivityMT.
    * @return A reference to this FlightActivityMT.
    */
  FlightActivityMT& operator=(const FlightActivityMT& rhs) {
    (void)rhs;
...
#endif // UCI_TYPE_FLIGHTACTIVITYMT_H
