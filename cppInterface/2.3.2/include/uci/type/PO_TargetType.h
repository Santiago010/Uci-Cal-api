...
public:
  ...
  /** This method constructs a new PO_TargetType.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed PO_TargetType.
    */
  static UCI_EXPORT PO_TargetType& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new PO_TargetType initializing the data accessed by the new PO_TargetType using the data
    * accessed by the specified PO_TargetType (cloning).
    *
    * @param accessor The PO_TargetType that provides access to the data that is to be used to initialize the data accessed
    *      by the new created PO_TargetType.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed PO_TargetType.
    */
  static UCI_EXPORT PO_TargetType& create(const PO_TargetType& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified PO_TargetType. Use of the specified accessor after it has been destroyed will
    * result in undefined behavior.
    *
    * @param accessor The PO_TargetType that is to be destroyed.
    */
  static UCI_EXPORT void destroy(PO_TargetType& accessor);
  ...
  /** Returns the version that was initialized from the uci:version attribute of PO_TargetType.
    *
    * @return The version that was initialized from the uci:version attribute of PO_TargetType.
    */
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const PO_TargetType& accessor) = 0;
  ...
  enum PO_TargetTypeChoice {
    ...
    PO_TARGETTYPE_CHOICE_LOS_OPTION,
    PO_TARGETTYPE_CHOICE_VOLUME,
    PO_TARGETTYPE_CHOICE_TURRETSLAVED,
    PO_TARGETTYPE_CHOICE_ACTIVITYSLAVEDID,
    PO_TARGETTYPE_CHOICE_FIXEDPOINTING
  };
  ...
  /** This method returns this choice's "selection ordinal." A choice's "selection ordinal" is used to specify which
    ...
    */
  virtual PO_TargetTypeChoice getPO_TargetTypeChoiceOrdinal() const = 0;
  ...
  /** This method is used to set this choice's "selection ordinal." A choice's "selection ordinal" is used to specify which
    ...
    */
  virtual uci::type::PO_TargetType& setPO_TargetTypeChoiceOrdinal(PO_TargetTypeChoice chosenElementOrdinal, uci::base::accessorType::AccessorType type = uci::base::accessorType::null) = 0;
  ...
  /** Returns a const reference to the bounded list identified by Geospatial.
    ...
    */
  virtual const uci::type::PO_TargetType::Geospatial& getGeospatial() const = 0;
  ...
  /** Returns a reference to the bounded list identified by Geospatial.
    ...
    */
  virtual uci::type::PO_TargetType::Geospatial& getGeospatial() = 0;
  ...
  /** Sets the bounded list identified by Geospatial.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::PO_TargetType& setGeospatial(const uci::type::PO_TargetType::Geospatial& value) = 0;
  ...
  /** Sets this choice's "selection ordinal" to the choice identified by Geospatial.
    ...
    */
  virtual uci::type::PO_TargetType::Geospatial& chooseGeospatial() = 0;

  /** Returns a const reference to the accessor that provides access to the complex content identified by Pointed.
    *
    * @return A const reference to the accessor that provides access to the complex content identified by Pointed.
    */
  virtual const uci::type::TurretCommandPositionType& getPointed() const = 0;

  /** Returns a reference to the accessor that provides access to the complex content identified by Pointed.
    *
    * @return A reference to the accessor that provides access to the complex content identified by Pointed.
    */
  virtual uci::type::TurretCommandPositionType& getPointed() = 0;

  /** Sets the complex content identified by Pointed to the contents of the complex content accessed by the specified
    * accessor.
    *
    * @param value The accessor that provides access to the complex content whose contents are to be used to set the
    *      contents of the complex content identified by Pointed.
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::PO_TargetType& setPointed(const uci::type::TurretCommandPositionType& value) = 0;

  /** Returns whether this choice's "selection ordinal" is set to the choice identified by Pointed.
    *
    * @return True if this choice's "selection ordinal" is set to the choice identified by Pointed, false otherwise.
    */
  virtual bool isPointed() const = 0;

  /** Sets this choice's "selection ordinal" to the choice identified by Pointed.
    *
    * @param type = uci::base::accessorType::null The type of data that is to be made available when the ordinal is set.
    *      The use of this parameter provides support for inheritable types. This parameter defaults to
    *      uci::base::accessorType::null that is used to indicate that the access methods associated with the chosen
    ...
    *      the chosen element's base type or a type ID associated with a type that is derived from the chosen element's
    *      base type.
    * @return A reference to the accessor that provides access to the choice identified by Pointed.
    */
  virtual uci::type::TurretCommandPositionType& choosePointed(uci::base::accessorType::AccessorType type = uci::base::accessorType::null) = 0;
  ...
  /** Sets the complex content identified by LOS_Option to the contents of the complex content accessed by the specified
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::PO_TargetType& setLOS_Option(const uci::type::LOS_D_Type& value) = 0;
  ...
  /** Sets the bounded list identified by Volume.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::PO_TargetType& setVolume(const uci::type::PO_TargetType::Volume& value) = 0;
  ...
  /** Sets this choice's "selection ordinal" to the choice identified by Volume.
    ...
    */
  virtual uci::type::PO_TargetType::Volume& chooseVolume() = 0;
  ...
  /** Sets the string identified by TurretSlaved to the contents of the string accessed by the specified accessor.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::PO_TargetType& setTurretSlaved(const uci::type::EmptyType& value) = 0;
  ...
  /** Sets the string identified by TurretSlaved to the contents of the string that is accessed by the specified accessor.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::PO_TargetType& setTurretSlaved(const std::string& value) = 0;
  ...
  /** Sets the string identified by TurretSlaved to the contents of the string that is accessed by the specified accessor.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::PO_TargetType& setTurretSlaved(const char* value) = 0;
  ...
  /** Sets the complex content identified by ActivitySlavedID to the contents of the complex content accessed by the
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::PO_TargetType& setActivitySlavedID(const uci::type::ActivityID_Type& value) = 0;
  ...
  /** Sets the value of the enumeration identified by FixedPointing.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::PO_TargetType& setFixedPointing(const uci::type::FixedPointingEnum& value) = 0;
  ...
  /** Sets the value of the enumeration identified by FixedPointing.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::PO_TargetType& setFixedPointing(uci::type::FixedPointingEnum::EnumerationItem value) = 0;
...
protected:
  ...
  /** The assignment operator. Sets the contents of this PO_TargetType to the contents of the PO_TargetType on the right
    ...
    *      the contents of this PO_TargetType.
    * @return A reference to this PO_TargetType.
    */
  PO_TargetType& operator=(const PO_TargetType& rhs) {
    (void)rhs;
...
#endif // UCI_TYPE_PO_TARGETTYPE_H
