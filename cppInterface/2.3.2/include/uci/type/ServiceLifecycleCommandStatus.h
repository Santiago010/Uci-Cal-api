/** @file ServiceLifecycleCommandStatus.h
 *
...
typedef uci::type::ServiceLifecycleCommandStatusMT ServiceLifecycleCommandStatus;

} // namespace type
} // namespace uci

#endif // UCI_TYPE_SERVICELIFECYCLECOMMANDSTATUS_H
