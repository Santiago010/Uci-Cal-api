...
#ifndef UCI_TYPE_IO_PORTTYPEENUM_H
#define UCI_TYPE_IO_PORTTYPEENUM_H
...
public:
  ...
  /** The assignment operator. Sets the contents of this IO_PortTypeEnum to the contents of the IO_PortTypeEnum on the
    ...
    * @return A reference to this IO_PortTypeEnum.
    */
  IO_PortTypeEnum& operator=(const IO_PortTypeEnum& rhs) {
    setValue(rhs.getValue());
    return *this;
  }

  /** The assignment operator that sets the value of this IO_PortTypeEnum enumeration to the EnumerationItem on the right
    * hand side of the assignment operator.
    *
    * @param rhs The EnumerationItem whose value is to be assigned to this IO_PortTypeEnum enumeration.
    * @return A reference to this IO_PortTypeEnum enumeration.
    */
  IO_PortTypeEnum& operator=(EnumerationItem rhs) {
    setValue(rhs);
    return *this;
  }
  ...
  /** Sets the value of this IO_PortTypeEnum enumeration to the value of the specified enumeration item.
    *
    * @param item The EnumerationItem whose value is to be used to set the value of this IO_PortTypeEnum enumeration.
    */
  ...
  /** Tests whether the value of the specified EnumerationItem is equal to the value of the specified IO_PortTypeEnum
    ...
    *      EnumerationItem.
    * @return True if the value of the EnumerationItem (lhs) is equal to the value of the IO_PortTypeEnum enumeration
    *      (rhs), false otherwise.
    */
  ...
  /** Sets the value of this IO_PortTypeEnum enumeration to the value of the enumeration item having the specified name.
    *
    * @param itemName The name of the enumeration item whose value is to be used to set this IO_PortTypeEnum enumeration
    *      to.
    */
...
#endif // UCI_TYPE_IO_PORTTYPEENUM_H
