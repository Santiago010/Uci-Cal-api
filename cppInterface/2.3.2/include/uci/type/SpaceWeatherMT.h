...
#ifndef UCI_TYPE_SPACEWEATHERMT_H
#define UCI_TYPE_SPACEWEATHERMT_H
...
class SpaceWeatherMT : public virtual MessageType {
public:

  /** This method constructs a new SpaceWeatherMT.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed SpaceWeatherMT.
    */
  static UCI_EXPORT SpaceWeatherMT& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new SpaceWeatherMT initializing the data accessed by the new SpaceWeatherMT using the data
    * accessed by the specified SpaceWeatherMT (cloning).
    *
    * @param accessor The SpaceWeatherMT that provides access to the data that is to be used to initialize the data
    *      accessed by the new created SpaceWeatherMT.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed SpaceWeatherMT.
    */
  static UCI_EXPORT SpaceWeatherMT& create(const SpaceWeatherMT& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified SpaceWeatherMT. Use of the specified accessor after it has been destroyed will
    * result in undefined behavior.
    *
    * @param accessor The SpaceWeatherMT that is to be destroyed.
    */
  static UCI_EXPORT void destroy(SpaceWeatherMT& accessor);

  /** Returns this accessor's type constant, i.e. spaceWeatherMT.
    *
    * @return This accessor's type constant, i.e. spaceWeatherMT.
    */
  virtual uci::base::accessorType::AccessorType getAccessorType() const noexception {
    return uci::type::accessorType::spaceWeatherMT;
  }

  /** Returns the version that was initialized from the uci:version attribute of SpaceWeatherMT.
    *
    * @return The version that was initialized from the uci:version attribute of SpaceWeatherMT.
    */
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const SpaceWeatherMT& accessor) = 0;
  ...
  /** Sets the value of the enumeration identified by ObjectState.
    ...
    */
  virtual uci::type::SpaceWeatherMT& setObjectState(const uci::type::ObjectStateEnum& value) = 0;
  ...
  /** Sets the value of the enumeration identified by ObjectState.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::SpaceWeatherMT& setObjectState(uci::type::ObjectStateEnum::EnumerationItem value) = 0;
  ...
  /** Clears (disabled) the Element identified by ObjectState.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::SpaceWeatherMT& clearObjectState() = 0;
  ...
  /** Returns a const reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual const uci::type::SpaceWeatherMDT& getMessageData() const = 0;
  ...
  /** Returns a reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual uci::type::SpaceWeatherMDT& getMessageData() = 0;
  ...
  /** Sets the complex content identified by MessageData to the contents of the complex content accessed by the specified
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::SpaceWeatherMT& setMessageData(const uci::type::SpaceWeatherMDT& value) = 0;

  /** The Listener provides the support to listen and handle incoming messages of the type uci::type::SpaceWeatherMT. */
  ...
  public:
    ...
    /** The method is used to handle incoming messages.
      ...
      */
    virtual void handleMessage(const uci::type::SpaceWeatherMT& message) = 0;
  ...
  public:
    ...
    /** Adds a listener to this reader to handle incoming messages.
      ...
      */
    virtual void addListener(uci::type::SpaceWeatherMT::Listener& listener) = 0;

    /** Removes the specified listener from this reader.
      *
      * @param listener The listener that is to be removed from this reader.
      */
    virtual void removeListener(uci::type::SpaceWeatherMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s). Returns immediately if no messages are available.
      ...
      */
    virtual unsigned long readNoWait(unsigned long maxNumberOfMessages, uci::type::SpaceWeatherMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s).
      ...
      * @return The number of messages that were handled.
      */
    virtual unsigned long read(unsigned long timeout, unsigned long maxNumberOfMessages, uci::type::SpaceWeatherMT::Listener& listener) = 0;
  ...
  /** This method creates a new reader that can be used to read a SpaceWeatherMT.
    *
    * @param topic The specification of the topic the reader is to read from.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A reader that can read a SpaceWeatherMT.
    */
  static UCI_EXPORT uci::type::SpaceWeatherMT::Reader& createReader(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a reader. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyReader(uci::type::SpaceWeatherMT::Reader& reader);
  ...
  public:
    ...
    /** Writes the OMS message to the topic specified when this Writer was created.
      ...
      */
    virtual void write(uci::type::SpaceWeatherMT& accessor) = 0;
  ...
  /** This method creates a new writer that can be used to write a SpaceWeatherMT.
    *
    * @param topic The specification of the topic the writer is to write to.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A writer that can write a SpaceWeatherMT.
    */
  static UCI_EXPORT uci::type::SpaceWeatherMT::Writer& createWriter(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a writer. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyWriter(uci::type::SpaceWeatherMT::Writer& writer);
...
protected:
  ...
  /** The copy constructor [only available to derived classes].
    *
    * @param rhs The SpaceWeatherMT to copy from.
    */
  SpaceWeatherMT(const SpaceWeatherMT& rhs) {
    (void)rhs;
  }

  /** The assignment operator. Sets the contents of this SpaceWeatherMT to the contents of the SpaceWeatherMT on the right
    * hand side (rhs) of the assignment operator [only available to derived classes].
    *
    * @param rhs The SpaceWeatherMT on the right hand side (rhs) of the assignment operator whose contents are used to set
    *      the contents of this SpaceWeatherMT.
    * @return A reference to this SpaceWeatherMT.
    */
  SpaceWeatherMT& operator=(const SpaceWeatherMT& rhs) {
    (void)rhs;
...
#endif // UCI_TYPE_SPACEWEATHERMT_H
