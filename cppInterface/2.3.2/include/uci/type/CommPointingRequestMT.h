...
#ifndef UCI_TYPE_COMMPOINTINGREQUESTMT_H
#define UCI_TYPE_COMMPOINTINGREQUESTMT_H

#include "../base/Listener.h"
#include "../base/Reader.h"
#include "../base/Writer.h"
#include "../base/export.h"
#include "CommPointingRequestMDT.h"
...
class CommPointingRequestMT : public virtual MessageType {
public:

  /** This method constructs a new CommPointingRequestMT.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed CommPointingRequestMT.
    */
  static UCI_EXPORT CommPointingRequestMT& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new CommPointingRequestMT initializing the data accessed by the new CommPointingRequestMT
    * using the data accessed by the specified CommPointingRequestMT (cloning).
    *
    * @param accessor The CommPointingRequestMT that provides access to the data that is to be used to initialize the data
    *      accessed by the new created CommPointingRequestMT.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed CommPointingRequestMT.
    */
  static UCI_EXPORT CommPointingRequestMT& create(const CommPointingRequestMT& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified CommPointingRequestMT. Use of the specified accessor after it has been destroyed
    * will result in undefined behavior.
    *
    * @param accessor The CommPointingRequestMT that is to be destroyed.
    */
  static UCI_EXPORT void destroy(CommPointingRequestMT& accessor);
  ...
  /** Returns the version that was initialized from the uci:version attribute of CommPointingRequestMT.
    *
    * @return The version that was initialized from the uci:version attribute of CommPointingRequestMT.
    */
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const CommPointingRequestMT& accessor) = 0;
  ...
  /** Returns a const reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual const uci::type::CommPointingRequestMDT& getMessageData() const = 0;
  ...
  /** Returns a reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual uci::type::CommPointingRequestMDT& getMessageData() = 0;
  ...
  /** Sets the complex content identified by MessageData to the contents of the complex content accessed by the specified
    ...
    */
  virtual uci::type::CommPointingRequestMT& setMessageData(const uci::type::CommPointingRequestMDT& value) = 0;

  /** The Listener provides the support to listen and handle incoming messages of the type
    * uci::type::CommPointingRequestMT.
    */
  ...
  public:
    ...
    /** The method is used to handle incoming messages.
      ...
      */
    virtual void handleMessage(const uci::type::CommPointingRequestMT& message) = 0;
  ...
  public:
    ...
    /** Adds a listener to this reader to handle incoming messages.
      ...
      */
    virtual void addListener(uci::type::CommPointingRequestMT::Listener& listener) = 0;

    /** Removes the specified listener from this reader.
      *
      * @param listener The listener that is to be removed from this reader.
      */
    virtual void removeListener(uci::type::CommPointingRequestMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s). Returns immediately if no messages are available.
      ...
      */
    virtual unsigned long readNoWait(unsigned long maxNumberOfMessages, uci::type::CommPointingRequestMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s).
      ...
      * @return The number of messages that were handled.
      */
    virtual unsigned long read(unsigned long timeout, unsigned long maxNumberOfMessages, uci::type::CommPointingRequestMT::Listener& listener) = 0;
  ...
  /** This method creates a new reader that can be used to read a CommPointingRequestMT.
    *
    * @param topic The specification of the topic the reader is to read from.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A reader that can read a CommPointingRequestMT.
    */
  static UCI_EXPORT uci::type::CommPointingRequestMT::Reader& createReader(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a reader. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyReader(uci::type::CommPointingRequestMT::Reader& reader);
  ...
  public:
    ...
    /** Writes the OMS message to the topic specified when this Writer was created.
      ...
      */
    virtual void write(uci::type::CommPointingRequestMT& accessor) = 0;
  ...
  /** This method creates a new writer that can be used to write a CommPointingRequestMT.
    *
    * @param topic The specification of the topic the writer is to write to.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A writer that can write a CommPointingRequestMT.
    */
  static UCI_EXPORT uci::type::CommPointingRequestMT::Writer& createWriter(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a writer. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyWriter(uci::type::CommPointingRequestMT::Writer& writer);
...
protected:
  ...
  /** The assignment operator. Sets the contents of this CommPointingRequestMT to the contents of the CommPointingRequestMT
    ...
    *      to set the contents of this CommPointingRequestMT.
    * @return A reference to this CommPointingRequestMT.
    */
  CommPointingRequestMT& operator=(const CommPointingRequestMT& rhs) {
    (void)rhs;
...
#endif // UCI_TYPE_COMMPOINTINGREQUESTMT_H
