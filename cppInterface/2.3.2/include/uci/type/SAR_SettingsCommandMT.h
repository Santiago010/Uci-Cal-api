...
#ifndef UCI_TYPE_SAR_SETTINGSCOMMANDMT_H
#define UCI_TYPE_SAR_SETTINGSCOMMANDMT_H
...
#include "SAR_SettingsCommandMDT.h"
...
class SAR_SettingsCommandMT : public virtual MessageType {
public:

  /** This method constructs a new SAR_SettingsCommandMT.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed SAR_SettingsCommandMT.
    */
  static UCI_EXPORT SAR_SettingsCommandMT& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new SAR_SettingsCommandMT initializing the data accessed by the new SAR_SettingsCommandMT
    * using the data accessed by the specified SAR_SettingsCommandMT (cloning).
    *
    * @param accessor The SAR_SettingsCommandMT that provides access to the data that is to be used to initialize the data
    *      accessed by the new created SAR_SettingsCommandMT.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed SAR_SettingsCommandMT.
    */
  static UCI_EXPORT SAR_SettingsCommandMT& create(const SAR_SettingsCommandMT& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified SAR_SettingsCommandMT. Use of the specified accessor after it has been destroyed
    * will result in undefined behavior.
    *
    * @param accessor The SAR_SettingsCommandMT that is to be destroyed.
    */
  static UCI_EXPORT void destroy(SAR_SettingsCommandMT& accessor);
  ...
  /** Returns the version that was initialized from the uci:version attribute of SAR_SettingsCommandMT.
    *
    * @return The version that was initialized from the uci:version attribute of SAR_SettingsCommandMT.
    */
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const SAR_SettingsCommandMT& accessor) = 0;
  ...
  /** Returns a const reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual const uci::type::SAR_SettingsCommandMDT& getMessageData() const = 0;
  ...
  /** Returns a reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual uci::type::SAR_SettingsCommandMDT& getMessageData() = 0;
  ...
  /** Sets the complex content identified by MessageData to the contents of the complex content accessed by the specified
    ...
    */
  virtual uci::type::SAR_SettingsCommandMT& setMessageData(const uci::type::SAR_SettingsCommandMDT& value) = 0;

  /** The Listener provides the support to listen and handle incoming messages of the type
    * uci::type::SAR_SettingsCommandMT.
    */
  ...
  public:
    ...
    /** The method is used to handle incoming messages.
      ...
      */
    virtual void handleMessage(const uci::type::SAR_SettingsCommandMT& message) = 0;
  ...
  public:
    ...
    /** Adds a listener to this reader to handle incoming messages.
      ...
      */
    virtual void addListener(uci::type::SAR_SettingsCommandMT::Listener& listener) = 0;

    /** Removes the specified listener from this reader.
      *
      * @param listener The listener that is to be removed from this reader.
      */
    virtual void removeListener(uci::type::SAR_SettingsCommandMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s). Returns immediately if no messages are available.
      ...
      */
    virtual unsigned long readNoWait(unsigned long maxNumberOfMessages, uci::type::SAR_SettingsCommandMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s).
      ...
      * @return The number of messages that were handled.
      */
    virtual unsigned long read(unsigned long timeout, unsigned long maxNumberOfMessages, uci::type::SAR_SettingsCommandMT::Listener& listener) = 0;
  ...
  /** This method creates a new reader that can be used to read a SAR_SettingsCommandMT.
    *
    * @param topic The specification of the topic the reader is to read from.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A reader that can read a SAR_SettingsCommandMT.
    */
  static UCI_EXPORT uci::type::SAR_SettingsCommandMT::Reader& createReader(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a reader. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyReader(uci::type::SAR_SettingsCommandMT::Reader& reader);
  ...
  public:
    ...
    /** Writes the OMS message to the topic specified when this Writer was created.
      ...
      */
    virtual void write(uci::type::SAR_SettingsCommandMT& accessor) = 0;
  ...
  /** This method creates a new writer that can be used to write a SAR_SettingsCommandMT.
    *
    * @param topic The specification of the topic the writer is to write to.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A writer that can write a SAR_SettingsCommandMT.
    */
  static UCI_EXPORT uci::type::SAR_SettingsCommandMT::Writer& createWriter(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a writer. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyWriter(uci::type::SAR_SettingsCommandMT::Writer& writer);
...
protected:
  ...
  /** The assignment operator. Sets the contents of this SAR_SettingsCommandMT to the contents of the SAR_SettingsCommandMT
    ...
    *      to set the contents of this SAR_SettingsCommandMT.
    * @return A reference to this SAR_SettingsCommandMT.
    */
  SAR_SettingsCommandMT& operator=(const SAR_SettingsCommandMT& rhs) {
    (void)rhs;
...
#endif // UCI_TYPE_SAR_SETTINGSCOMMANDMT_H
