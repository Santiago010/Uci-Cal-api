/** @file CommTerminalPlanOverrideRequest.h
 *
...
typedef uci::type::CommTerminalPlanOverrideRequestMT CommTerminalPlanOverrideRequest;

} // namespace type
} // namespace uci

#endif // UCI_TYPE_COMMTERMINALPLANOVERRIDEREQUEST_H
