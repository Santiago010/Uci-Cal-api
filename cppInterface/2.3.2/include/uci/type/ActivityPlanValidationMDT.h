...
#ifndef UCI_TYPE_ACTIVITYPLANVALIDATIONMDT_H
#define UCI_TYPE_ACTIVITYPLANVALIDATIONMDT_H
...
class ActivityPlanValidationMDT : public virtual uci::base::Accessor {
public:

  /** This method constructs a new ActivityPlanValidationMDT.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed ActivityPlanValidationMDT.
    */
  static UCI_EXPORT ActivityPlanValidationMDT& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new ActivityPlanValidationMDT initializing the data accessed by the new
    * ActivityPlanValidationMDT using the data accessed by the specified ActivityPlanValidationMDT (cloning).
    *
    * @param accessor The ActivityPlanValidationMDT that provides access to the data that is to be used to initialize the
    *      data accessed by the new created ActivityPlanValidationMDT.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed ActivityPlanValidationMDT.
    */
  static UCI_EXPORT ActivityPlanValidationMDT& create(const ActivityPlanValidationMDT& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified ActivityPlanValidationMDT. Use of the specified accessor after it has been
    * destroyed will result in undefined behavior.
    *
    * @param accessor The ActivityPlanValidationMDT that is to be destroyed.
    */
  static UCI_EXPORT void destroy(ActivityPlanValidationMDT& accessor);

  /** Returns this accessor's type constant, i.e. activityPlanValidationMDT.
    *
    * @return This accessor's type constant, i.e. activityPlanValidationMDT.
    */
  virtual uci::base::accessorType::AccessorType getAccessorType() const noexception {
    return uci::type::accessorType::activityPlanValidationMDT;
  }

  /** Returns the version that was initialized from the uci:version attribute of ActivityPlanValidationMDT.
    *
    * @return The version that was initialized from the uci:version attribute of ActivityPlanValidationMDT.
    */
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const ActivityPlanValidationMDT& accessor) = 0;
  ...
  /** Sets the complex content identified by ActivityPlanValidationID to the contents of the complex content accessed by
    ...
    */
  virtual uci::type::ActivityPlanValidationMDT& setActivityPlanValidationID(const uci::type::ActivityPlanValidationID_Type& value) = 0;
  ...
  /** Returns a const reference to the accessor that provides access to the complex content identified by PlanID.
    ...
    */
  virtual const uci::type::ActivityPlanID_Type& getPlanID() const = 0;
  ...
  /** Returns a reference to the accessor that provides access to the complex content identified by PlanID.
    ...
    */
  virtual uci::type::ActivityPlanID_Type& getPlanID() = 0;
  ...
  /** Sets the complex content identified by PlanID to the contents of the complex content accessed by the specified
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::ActivityPlanValidationMDT& setPlanID(const uci::type::ActivityPlanID_Type& value) = 0;
  ...
  /** Sets the complex content identified by Validator to the contents of the complex content accessed by the specified
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::ActivityPlanValidationMDT& setValidator(const uci::type::ValidatorType& value) = 0;
  ...
  /** Sets the value of the enumeration identified by ValidationState.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::ActivityPlanValidationMDT& setValidationState(const uci::type::PlanValidationStateEnum& value) = 0;
  ...
  /** Sets the value of the enumeration identified by ValidationState.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::ActivityPlanValidationMDT& setValidationState(uci::type::PlanValidationStateEnum::EnumerationItem value) = 0;
  ...
  /** Sets the complex content identified by CompletionStatus to the contents of the complex content accessed by the
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::ActivityPlanValidationMDT& setCompletionStatus(const uci::type::CompletionStatusType& value) = 0;
  ...
  /** Clears (disabled) the Element identified by CompletionStatus.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::ActivityPlanValidationMDT& clearCompletionStatus() = 0;
  ...
  /** Returns a const reference to the bounded list identified by IncompleteItem.
    ...
    */
  virtual const uci::type::ActivityPlanValidationMDT::IncompleteItem& getIncompleteItem() const = 0;
  ...
  /** Returns a reference to the bounded list identified by IncompleteItem.
    ...
    */
  virtual uci::type::ActivityPlanValidationMDT::IncompleteItem& getIncompleteItem() = 0;
  ...
  /** Sets the bounded list identified by IncompleteItem.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::ActivityPlanValidationMDT& setIncompleteItem(const uci::type::ActivityPlanValidationMDT::IncompleteItem& value) = 0;
  ...
  /** Returns a const reference to the bounded list identified by InvalidActivity.
    ...
    */
  virtual const uci::type::ActivityPlanValidationMDT::InvalidActivity& getInvalidActivity() const = 0;
  ...
  /** Returns a reference to the bounded list identified by InvalidActivity.
    ...
    */
  virtual uci::type::ActivityPlanValidationMDT::InvalidActivity& getInvalidActivity() = 0;
  ...
  /** Sets the bounded list identified by InvalidActivity.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::ActivityPlanValidationMDT& setInvalidActivity(const uci::type::ActivityPlanValidationMDT::InvalidActivity& value) = 0;
  ...
  /** Returns a const reference to the bounded list identified by ActivityPlanningResult.
    ...
    */
  virtual const uci::type::ActivityPlanValidationMDT::ActivityPlanningResult& getActivityPlanningResult() const = 0;
  ...
  /** Returns a reference to the bounded list identified by ActivityPlanningResult.
    ...
    */
  virtual uci::type::ActivityPlanValidationMDT::ActivityPlanningResult& getActivityPlanningResult() = 0;
  ...
  /** Sets the bounded list identified by ActivityPlanningResult.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::ActivityPlanValidationMDT& setActivityPlanningResult(const uci::type::ActivityPlanValidationMDT::ActivityPlanningResult& value) = 0;
  ...
  /** Returns a const reference to the accessor that provides access to the complex content identified by ModifiedPlanID.
    ...
    */
  virtual const uci::type::ActivityPlanID_Type& getModifiedPlanID() const = 0;
  ...
  /** Returns a reference to the accessor that provides access to the complex content identified by ModifiedPlanID.
    ...
    */
  virtual uci::type::ActivityPlanID_Type& getModifiedPlanID() = 0;
  ...
  /** Sets the complex content identified by ModifiedPlanID to the contents of the complex content accessed by the
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::ActivityPlanValidationMDT& setModifiedPlanID(const uci::type::ActivityPlanID_Type& value) = 0;
  ...
  /** Enables the Element identified by ModifiedPlanID.
    ...
    * @return A reference to the accessor that provides access to the complex content identified by ModifiedPlanID.
    */
  virtual uci::type::ActivityPlanID_Type& enableModifiedPlanID(uci::base::accessorType::AccessorType type = uci::base::accessorType::null) = 0;

  /** Clears (disabled) the Element identified by ModifiedPlanID.
    *
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::ActivityPlanValidationMDT& clearModifiedPlanID() = 0;
...
protected:
  ...
  /** The copy constructor [only available to derived classes].
    ...
    */
  ActivityPlanValidationMDT(const ActivityPlanValidationMDT& rhs) {
    (void)rhs;
  }

  /** The assignment operator. Sets the contents of this ActivityPlanValidationMDT to the contents of the
    * ActivityPlanValidationMDT on the right hand side (rhs) of the assignment operator [only available to derived
    * classes].
    *
    * @param rhs The ActivityPlanValidationMDT on the right hand side (rhs) of the assignment operator whose contents are
    *      used to set the contents of this ActivityPlanValidationMDT.
    * @return A reference to this ActivityPlanValidationMDT.
    */
  ActivityPlanValidationMDT& operator=(const ActivityPlanValidationMDT& rhs) {
    (void)rhs;
...
#endif // UCI_TYPE_ACTIVITYPLANVALIDATIONMDT_H
