...
#ifndef UCI_TYPE_RESPONSEPLANCOMMANDMT_H
#define UCI_TYPE_RESPONSEPLANCOMMANDMT_H
...
#include "ResponsePlanCommandMDT.h"
...
class ResponsePlanCommandMT : public virtual MessageType {
public:

  /** This method constructs a new ResponsePlanCommandMT.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed ResponsePlanCommandMT.
    */
  static UCI_EXPORT ResponsePlanCommandMT& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new ResponsePlanCommandMT initializing the data accessed by the new ResponsePlanCommandMT
    * using the data accessed by the specified ResponsePlanCommandMT (cloning).
    *
    * @param accessor The ResponsePlanCommandMT that provides access to the data that is to be used to initialize the data
    *      accessed by the new created ResponsePlanCommandMT.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed ResponsePlanCommandMT.
    */
  static UCI_EXPORT ResponsePlanCommandMT& create(const ResponsePlanCommandMT& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified ResponsePlanCommandMT. Use of the specified accessor after it has been destroyed
    * will result in undefined behavior.
    *
    * @param accessor The ResponsePlanCommandMT that is to be destroyed.
    */
  static UCI_EXPORT void destroy(ResponsePlanCommandMT& accessor);

  /** Returns this accessor's type constant, i.e. responsePlanCommandMT.
    *
    * @return This accessor's type constant, i.e. responsePlanCommandMT.
    */
  virtual uci::base::accessorType::AccessorType getAccessorType() const noexception {
    return uci::type::accessorType::responsePlanCommandMT;
  }

  /** Returns the version that was initialized from the uci:version attribute of ResponsePlanCommandMT.
    *
    * @return The version that was initialized from the uci:version attribute of ResponsePlanCommandMT.
    */
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const ResponsePlanCommandMT& accessor) = 0;
  ...
  /** Returns a const reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual const uci::type::ResponsePlanCommandMDT& getMessageData() const = 0;
  ...
  /** Returns a reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual uci::type::ResponsePlanCommandMDT& getMessageData() = 0;
  ...
  /** Sets the complex content identified by MessageData to the contents of the complex content accessed by the specified
    ...
    */
  virtual uci::type::ResponsePlanCommandMT& setMessageData(const uci::type::ResponsePlanCommandMDT& value) = 0;

  /** The Listener provides the support to listen and handle incoming messages of the type
    * uci::type::ResponsePlanCommandMT.
    */
  ...
  public:
    ...
    /** The method is used to handle incoming messages.
      ...
      */
    virtual void handleMessage(const uci::type::ResponsePlanCommandMT& message) = 0;
  ...
  public:
    ...
    /** Adds a listener to this reader to handle incoming messages.
      ...
      */
    virtual void addListener(uci::type::ResponsePlanCommandMT::Listener& listener) = 0;

    /** Removes the specified listener from this reader.
      *
      * @param listener The listener that is to be removed from this reader.
      */
    virtual void removeListener(uci::type::ResponsePlanCommandMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s). Returns immediately if no messages are available.
      ...
      */
    virtual unsigned long readNoWait(unsigned long maxNumberOfMessages, uci::type::ResponsePlanCommandMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s).
      ...
      * @return The number of messages that were handled.
      */
    virtual unsigned long read(unsigned long timeout, unsigned long maxNumberOfMessages, uci::type::ResponsePlanCommandMT::Listener& listener) = 0;
  ...
  /** This method creates a new reader that can be used to read a ResponsePlanCommandMT.
    *
    * @param topic The specification of the topic the reader is to read from.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A reader that can read a ResponsePlanCommandMT.
    */
  static UCI_EXPORT uci::type::ResponsePlanCommandMT::Reader& createReader(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a reader. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyReader(uci::type::ResponsePlanCommandMT::Reader& reader);
  ...
  public:
    ...
    /** Writes the OMS message to the topic specified when this Writer was created.
      ...
      */
    virtual void write(uci::type::ResponsePlanCommandMT& accessor) = 0;
  ...
  /** This method creates a new writer that can be used to write a ResponsePlanCommandMT.
    *
    * @param topic The specification of the topic the writer is to write to.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A writer that can write a ResponsePlanCommandMT.
    */
  static UCI_EXPORT uci::type::ResponsePlanCommandMT::Writer& createWriter(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a writer. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyWriter(uci::type::ResponsePlanCommandMT::Writer& writer);
...
protected:
  ...
  /** The copy constructor [only available to derived classes].
    *
    * @param rhs The ResponsePlanCommandMT to copy from.
    */
  ResponsePlanCommandMT(const ResponsePlanCommandMT& rhs) {
    (void)rhs;
  }

  /** The assignment operator. Sets the contents of this ResponsePlanCommandMT to the contents of the ResponsePlanCommandMT
    * on the right hand side (rhs) of the assignment operator [only available to derived classes].
    *
    * @param rhs The ResponsePlanCommandMT on the right hand side (rhs) of the assignment operator whose contents are used
    *      to set the contents of this ResponsePlanCommandMT.
    * @return A reference to this ResponsePlanCommandMT.
    */
  ResponsePlanCommandMT& operator=(const ResponsePlanCommandMT& rhs) {
    (void)rhs;
...
#endif // UCI_TYPE_RESPONSEPLANCOMMANDMT_H
