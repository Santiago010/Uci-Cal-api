...
public:
  ...
  /** This method constructs a new Point3D_Type.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed Point3D_Type.
    */
  static UCI_EXPORT Point3D_Type& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new Point3D_Type initializing the data accessed by the new Point3D_Type using the data
    * accessed by the specified Point3D_Type (cloning).
    *
    * @param accessor The Point3D_Type that provides access to the data that is to be used to initialize the data accessed
    *      by the new created Point3D_Type.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed Point3D_Type.
    */
  static UCI_EXPORT Point3D_Type& create(const Point3D_Type& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified Point3D_Type. Use of the specified accessor after it has been destroyed will
    * result in undefined behavior.
    *
    * @param accessor The Point3D_Type that is to be destroyed.
    */
  static UCI_EXPORT void destroy(Point3D_Type& accessor);
  ...
  /** Returns the version that was initialized from the uci:version attribute of Point3D_Type.
    *
    * @return The version that was initialized from the uci:version attribute of Point3D_Type.
    */
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const Point3D_Type& accessor) = 0;
  ...
  /** Sets the value of the SimplePrimitive data type identified by Latitude.
    ...
    */
  virtual uci::type::Point3D_Type& setLatitude(uci::type::AngleHalfTypeValue value) = 0;
  ...
  /** Sets the value of the SimplePrimitive data type identified by Longitude.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::Point3D_Type& setLongitude(uci::type::AngleTypeValue value) = 0;
  ...
  /** Sets the value of the SimplePrimitive data type identified by Altitude.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::Point3D_Type& setAltitude(uci::type::AltitudeTypeValue value) = 0;
  ...
  /** Sets the value of the enumeration identified by AltitudeReference.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::Point3D_Type& setAltitudeReference(const uci::type::AltitudeReferenceEnum& value) = 0;
  ...
  /** Sets the value of the enumeration identified by AltitudeReference.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::Point3D_Type& setAltitudeReference(uci::type::AltitudeReferenceEnum::EnumerationItem value) = 0;
  ...
  /** Clears (disabled) the Element identified by AltitudeReference.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::Point3D_Type& clearAltitudeReference() = 0;
  ...
  /** Sets the value of the SimplePrimitive data type identified by Timestamp.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::Point3D_Type& setTimestamp(uci::type::DateTimeTypeValue value) = 0;
  ...
  /** Clears (disabled) the Element identified by Timestamp.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::Point3D_Type& clearTimestamp() = 0;
...
protected:
  ...
  /** The assignment operator. Sets the contents of this Point3D_Type to the contents of the Point3D_Type on the right hand
    ...
    *      the contents of this Point3D_Type.
    * @return A reference to this Point3D_Type.
    */
  Point3D_Type& operator=(const Point3D_Type& rhs) {
    (void)rhs;
