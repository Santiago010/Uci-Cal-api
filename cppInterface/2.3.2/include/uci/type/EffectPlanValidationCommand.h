/** @file EffectPlanValidationCommand.h
 *
...
typedef uci::type::EffectPlanValidationCommandMT EffectPlanValidationCommand;

} // namespace type
} // namespace uci

#endif // UCI_TYPE_EFFECTPLANVALIDATIONCOMMAND_H
