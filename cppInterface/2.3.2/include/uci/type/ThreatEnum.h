...
#ifndef UCI_TYPE_THREATENUM_H
#define UCI_TYPE_THREATENUM_H
...
/** Indicates the type of threat. Enum members have been sourced largely from MIL-STD-6016 Threat Type. Some members have
  * been added specifically for UCI.
  */
...
public:
  ...
  enum EnumerationItem {
    ...
    /** Missile designed to be launched from the ground or the sea and strike targets on land or at sea. */
    ...
    /** Missile designed for use against ships and large boats. */
    UCI_ANTISHIP_CRUISE_MISSILE,

    /** Missile of undetermined type. */
    UCI_MISSILE,

    /** Weapons designed to attack aircraft that commonly have a high rate of fire and are able to fire shells designed to
      * damage aircraft.
      */
    UCI_ANTIAIRCRAFT_ARTILLERY,

    /** Self-propelled weapon with an explosive warhead, launched above or below the water surface, propelled underwater
      * towards a target.
      */
    UCI_TORPEDO,

    /** Weapon that interferes with the operation of a radar by saturating its receiver with noise or false information. */
    UCI_JAMMER,

    /** Bomb constructed and deployed in ways other than in conventional military action. */
    UCI_IMPROVISED_EXPLOSIVE_DEVICE,

    /** Munition that uses chemical, biological, radioactive, or nuclear means to inflict harm to its target. */
    UCI_CHEMICAL_BIOLOGICAL_RADIOLOGICAL_OR_NUCLEAR,

    /** Aircraft with one or more human pilots aboard. */
    UCI_MANNED_AIRCRAFT,

    /** Ship or boat with one or more human operators aboard. */
    UCI_MANNED_SHIP,

    /** Ground vehicle with one or more human operators aboard. */
    UCI_MANNED_GROUND_VEHICLE,

    /** Aircraft without a human pilot aboard. */
    UCI_UNMANNED_AIRCRAFT,

    /** Ship or boat without a human operator aboard. */
    UCI_UNMANNED_SHIP,

    /** Ground vehicle without a human operator aboard. */
    UCI_UNMANNED_GROUND_VEHICLE,

    /** Artificial object which has been intentionally placed into orbit for the purposes of observation, communication, or
      * navigation.
      */
    UCI_SATELLITE,
    ...
    /** Indicates that no information is being transmitted. (This does not necessarily indicate that the originator does not
      * have the information.)
      */
    UCI_NO_STATEMENT,

    /** Indicates that the threat type has not been determined. */
    UCI_UNKNOWN,
  ...
  /** The assignment operator. Sets the contents of this ThreatEnum to the contents of the ThreatEnum on the right hand
    ...
    * @return A reference to this ThreatEnum.
    */
  ThreatEnum& operator=(const ThreatEnum& rhs) {
    setValue(rhs.getValue());
    return *this;
  }

  /** The assignment operator that sets the value of this ThreatEnum enumeration to the EnumerationItem on the right hand
    * side of the assignment operator.
    *
    * @param rhs The EnumerationItem whose value is to be assigned to this ThreatEnum enumeration.
    * @return A reference to this ThreatEnum enumeration.
    */
  ThreatEnum& operator=(EnumerationItem rhs) {
    setValue(rhs);
    return *this;
  }
  ...
  /** Sets the value of this ThreatEnum enumeration to the value of the specified enumeration item.
    *
    * @param item The EnumerationItem whose value is to be used to set the value of this ThreatEnum enumeration.
    */
  ...
  /** Tests whether the value of this ThreatEnum enumeration is not equal to the value of the specified EnumerationItem.
    *
    * @param rhs The EnumerationItem whose value is to be compared against the value of this ThreatEnum enumeration.
    * @return True if the value of the EnumerationItem (rhs) is not equal to the value of this ThreatEnum enumeration,
    *      false otherwise.
    */
  bool operator!=(EnumerationItem rhs) const {
    testForValidItem(rhs);
  ...
  /** Tests whether the value of this ThreatEnum enumeration is greater than the value of the specified EnumerationItem.
    *
    * @param rhs The EnumerationItem whose value is to be compared against the value of this ThreatEnum enumeration.
    * @return True if the value of the EnumerationItem (rhs) is greater than the value of this ThreatEnum enumeration,
    *      false otherwise.
    */
  bool operator>(EnumerationItem rhs) const {
    testForValidItem(rhs);
