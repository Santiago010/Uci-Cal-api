...
#ifndef UCI_TYPE_TASKCOMMANDMT_H
#define UCI_TYPE_TASKCOMMANDMT_H
...
class TaskCommandMT : public virtual MessageType {
public:

  /** This method constructs a new TaskCommandMT.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed TaskCommandMT.
    */
  static UCI_EXPORT TaskCommandMT& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new TaskCommandMT initializing the data accessed by the new TaskCommandMT using the data
    * accessed by the specified TaskCommandMT (cloning).
    *
    * @param accessor The TaskCommandMT that provides access to the data that is to be used to initialize the data accessed
    *      by the new created TaskCommandMT.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed TaskCommandMT.
    */
  static UCI_EXPORT TaskCommandMT& create(const TaskCommandMT& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified TaskCommandMT. Use of the specified accessor after it has been destroyed will
    * result in undefined behavior.
    *
    * @param accessor The TaskCommandMT that is to be destroyed.
    */
  static UCI_EXPORT void destroy(TaskCommandMT& accessor);

  /** Returns this accessor's type constant, i.e. taskCommandMT.
    *
    * @return This accessor's type constant, i.e. taskCommandMT.
    */
  virtual uci::base::accessorType::AccessorType getAccessorType() const noexception {
    return uci::type::accessorType::taskCommandMT;
  }

  /** Returns the version that was initialized from the uci:version attribute of TaskCommandMT.
    *
    * @return The version that was initialized from the uci:version attribute of TaskCommandMT.
    */
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const TaskCommandMT& accessor) = 0;
  ...
  /** Returns a const reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual const uci::type::TaskCommandMDT& getMessageData() const = 0;
  ...
  /** Returns a reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual uci::type::TaskCommandMDT& getMessageData() = 0;
  ...
  /** Sets the complex content identified by MessageData to the contents of the complex content accessed by the specified
    ...
    */
  virtual uci::type::TaskCommandMT& setMessageData(const uci::type::TaskCommandMDT& value) = 0;

  /** The Listener provides the support to listen and handle incoming messages of the type uci::type::TaskCommandMT. */
  ...
  public:
    ...
    /** The method is used to handle incoming messages.
      ...
      */
    virtual void handleMessage(const uci::type::TaskCommandMT& message) = 0;
  ...
  public:
    ...
    /** Adds a listener to this reader to handle incoming messages.
      ...
      */
    virtual void addListener(uci::type::TaskCommandMT::Listener& listener) = 0;

    /** Removes the specified listener from this reader.
      *
      * @param listener The listener that is to be removed from this reader.
      */
    virtual void removeListener(uci::type::TaskCommandMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s). Returns immediately if no messages are available.
      ...
      */
    virtual unsigned long readNoWait(unsigned long maxNumberOfMessages, uci::type::TaskCommandMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s).
      ...
      * @return The number of messages that were handled.
      */
    virtual unsigned long read(unsigned long timeout, unsigned long maxNumberOfMessages, uci::type::TaskCommandMT::Listener& listener) = 0;
  ...
  /** This method creates a new reader that can be used to read a TaskCommandMT.
    *
    * @param topic The specification of the topic the reader is to read from.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A reader that can read a TaskCommandMT.
    */
  static UCI_EXPORT uci::type::TaskCommandMT::Reader& createReader(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a reader. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyReader(uci::type::TaskCommandMT::Reader& reader);
  ...
  public:
    ...
    /** Writes the OMS message to the topic specified when this Writer was created.
      ...
      */
    virtual void write(uci::type::TaskCommandMT& accessor) = 0;
  ...
  /** This method creates a new writer that can be used to write a TaskCommandMT.
    *
    * @param topic The specification of the topic the writer is to write to.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A writer that can write a TaskCommandMT.
    */
  static UCI_EXPORT uci::type::TaskCommandMT::Writer& createWriter(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a writer. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyWriter(uci::type::TaskCommandMT::Writer& writer);
...
protected:
  ...
  /** The copy constructor [only available to derived classes].
    *
    * @param rhs The TaskCommandMT to copy from.
    */
  TaskCommandMT(const TaskCommandMT& rhs) {
    (void)rhs;
  }

  /** The assignment operator. Sets the contents of this TaskCommandMT to the contents of the TaskCommandMT on the right
    * hand side (rhs) of the assignment operator [only available to derived classes].
    *
    * @param rhs The TaskCommandMT on the right hand side (rhs) of the assignment operator whose contents are used to set
    *      the contents of this TaskCommandMT.
    * @return A reference to this TaskCommandMT.
    */
  TaskCommandMT& operator=(const TaskCommandMT& rhs) {
    (void)rhs;
...
#endif // UCI_TYPE_TASKCOMMANDMT_H
