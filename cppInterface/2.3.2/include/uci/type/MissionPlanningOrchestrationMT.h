/** @file MissionPlanningOrchestrationMT.h
 *
...
#ifndef UCI_TYPE_MISSIONPLANNINGORCHESTRATIONMT_H
#define UCI_TYPE_MISSIONPLANNINGORCHESTRATIONMT_H
...
#include "MissionPlanningOrchestrationMDT.h"
...
class MissionPlanningOrchestrationMT : public virtual MessageType {
public:

  /** This method constructs a new MissionPlanningOrchestrationMT.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed MissionPlanningOrchestrationMT.
    */
  static UCI_EXPORT MissionPlanningOrchestrationMT& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new MissionPlanningOrchestrationMT initializing the data accessed by the new
    * MissionPlanningOrchestrationMT using the data accessed by the specified MissionPlanningOrchestrationMT (cloning).
    *
    * @param accessor The MissionPlanningOrchestrationMT that provides access to the data that is to be used to initialize
    *      the data accessed by the new created MissionPlanningOrchestrationMT.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed MissionPlanningOrchestrationMT.
    */
  static UCI_EXPORT MissionPlanningOrchestrationMT& create(const MissionPlanningOrchestrationMT& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified MissionPlanningOrchestrationMT. Use of the specified accessor after it has been
    * destroyed will result in undefined behavior.
    *
    * @param accessor The MissionPlanningOrchestrationMT that is to be destroyed.
    */
  static UCI_EXPORT void destroy(MissionPlanningOrchestrationMT& accessor);

  /** Returns this accessor's type constant, i.e. missionPlanningOrchestrationMT.
    *
    * @return This accessor's type constant, i.e. missionPlanningOrchestrationMT.
    */
  virtual uci::base::accessorType::AccessorType getAccessorType() const noexception {
    return uci::type::accessorType::missionPlanningOrchestrationMT;
  }

  /** Returns the version that was initialized from the uci:version attribute of MissionPlanningOrchestrationMT.
    *
    * @return The version that was initialized from the uci:version attribute of MissionPlanningOrchestrationMT.
    */
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const MissionPlanningOrchestrationMT& accessor) = 0;
  ...
  /** Sets the value of the enumeration identified by ObjectState.
    ...
    */
  virtual uci::type::MissionPlanningOrchestrationMT& setObjectState(const uci::type::ObjectStateEnum& value) = 0;
  ...
  /** Sets the value of the enumeration identified by ObjectState.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::MissionPlanningOrchestrationMT& setObjectState(uci::type::ObjectStateEnum::EnumerationItem value) = 0;
  ...
  /** Clears (disabled) the Element identified by ObjectState.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::MissionPlanningOrchestrationMT& clearObjectState() = 0;
  ...
  /** Returns a const reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual const uci::type::MissionPlanningOrchestrationMDT& getMessageData() const = 0;
  ...
  /** Returns a reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual uci::type::MissionPlanningOrchestrationMDT& getMessageData() = 0;
  ...
  /** Sets the complex content identified by MessageData to the contents of the complex content accessed by the specified
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::MissionPlanningOrchestrationMT& setMessageData(const uci::type::MissionPlanningOrchestrationMDT& value) = 0;

  /** The Listener provides the support to listen and handle incoming messages of the type
    * uci::type::MissionPlanningOrchestrationMT.
    */
  ...
  public:
    ...
    /** The method is used to handle incoming messages.
      ...
      */
    virtual void handleMessage(const uci::type::MissionPlanningOrchestrationMT& message) = 0;
  ...
  public:
    ...
    /** Adds a listener to this reader to handle incoming messages.
      ...
      */
    virtual void addListener(uci::type::MissionPlanningOrchestrationMT::Listener& listener) = 0;

    /** Removes the specified listener from this reader.
      *
      * @param listener The listener that is to be removed from this reader.
      */
    virtual void removeListener(uci::type::MissionPlanningOrchestrationMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s). Returns immediately if no messages are available.
      ...
      */
    virtual unsigned long readNoWait(unsigned long maxNumberOfMessages, uci::type::MissionPlanningOrchestrationMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s).
      ...
      * @return The number of messages that were handled.
      */
    virtual unsigned long read(unsigned long timeout, unsigned long maxNumberOfMessages, uci::type::MissionPlanningOrchestrationMT::Listener& listener) = 0;
  ...
  /** This method creates a new reader that can be used to read a MissionPlanningOrchestrationMT.
    *
    * @param topic The specification of the topic the reader is to read from.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A reader that can read a MissionPlanningOrchestrationMT.
    */
  static UCI_EXPORT uci::type::MissionPlanningOrchestrationMT::Reader& createReader(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a reader. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyReader(uci::type::MissionPlanningOrchestrationMT::Reader& reader);
  ...
  public:
    ...
    /** Writes the OMS message to the topic specified when this Writer was created.
      ...
      */
    virtual void write(uci::type::MissionPlanningOrchestrationMT& accessor) = 0;
  ...
  /** This method creates a new writer that can be used to write a MissionPlanningOrchestrationMT.
    *
    * @param topic The specification of the topic the writer is to write to.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A writer that can write a MissionPlanningOrchestrationMT.
    */
  static UCI_EXPORT uci::type::MissionPlanningOrchestrationMT::Writer& createWriter(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a writer. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyWriter(uci::type::MissionPlanningOrchestrationMT::Writer& writer);
...
protected:
  ...
  /** The copy constructor [only available to derived classes].
    *
    * @param rhs The MissionPlanningOrchestrationMT to copy from.
    */
  MissionPlanningOrchestrationMT(const MissionPlanningOrchestrationMT& rhs) {
    (void)rhs;
  }

  /** The assignment operator. Sets the contents of this MissionPlanningOrchestrationMT to the contents of the
    * MissionPlanningOrchestrationMT on the right hand side (rhs) of the assignment operator [only available to derived
    * classes].
    *
    * @param rhs The MissionPlanningOrchestrationMT on the right hand side (rhs) of the assignment operator whose contents
    *      are used to set the contents of this MissionPlanningOrchestrationMT.
    * @return A reference to this MissionPlanningOrchestrationMT.
    */
  MissionPlanningOrchestrationMT& operator=(const MissionPlanningOrchestrationMT& rhs) {
    (void)rhs;
...
#endif // UCI_TYPE_MISSIONPLANNINGORCHESTRATIONMT_H
