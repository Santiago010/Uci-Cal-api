/** @file ApprovalManagementCommandStatus.h
 *
...
typedef uci::type::ApprovalManagementCommandStatusMT ApprovalManagementCommandStatus;

} // namespace type
} // namespace uci

#endif // UCI_TYPE_APPROVALMANAGEMENTCOMMANDSTATUS_H
