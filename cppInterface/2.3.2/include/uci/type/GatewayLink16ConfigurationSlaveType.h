...
#ifndef UCI_TYPE_GATEWAYLINK16CONFIGURATIONSLAVETYPE_H
#define UCI_TYPE_GATEWAYLINK16CONFIGURATIONSLAVETYPE_H
...
public:
  ...
  /** This method constructs a new GatewayLink16ConfigurationSlaveType.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed GatewayLink16ConfigurationSlaveType.
    */
  static UCI_EXPORT GatewayLink16ConfigurationSlaveType& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new GatewayLink16ConfigurationSlaveType initializing the data accessed by the new
    * GatewayLink16ConfigurationSlaveType using the data accessed by the specified GatewayLink16ConfigurationSlaveType
    * (cloning).
    *
    * @param accessor The GatewayLink16ConfigurationSlaveType that provides access to the data that is to be used to
    *      initialize the data accessed by the new created GatewayLink16ConfigurationSlaveType.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed GatewayLink16ConfigurationSlaveType.
    */
  static UCI_EXPORT GatewayLink16ConfigurationSlaveType& create(const GatewayLink16ConfigurationSlaveType& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified GatewayLink16ConfigurationSlaveType. Use of the specified accessor after it has
    * been destroyed will result in undefined behavior.
    *
    * @param accessor The GatewayLink16ConfigurationSlaveType that is to be destroyed.
    */
  static UCI_EXPORT void destroy(GatewayLink16ConfigurationSlaveType& accessor);
  ...
  /** Returns the version that was initialized from the uci:version attribute of GatewayLink16ConfigurationSlaveType.
    *
    * @return The version that was initialized from the uci:version attribute of GatewayLink16ConfigurationSlaveType.
    */
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const GatewayLink16ConfigurationSlaveType& accessor) = 0;
  ...
  /** This method returns this choice's "selection ordinal." A choice's "selection ordinal" is used to specify which
    ...
    */
  virtual GatewayLink16ConfigurationSlaveTypeChoice getGatewayLink16ConfigurationSlaveTypeChoiceOrdinal() const = 0;
  ...
  /** This method is used to set this choice's "selection ordinal." A choice's "selection ordinal" is used to specify which
    ...
    */
  virtual uci::type::GatewayLink16ConfigurationSlaveType& setGatewayLink16ConfigurationSlaveTypeChoiceOrdinal(GatewayLink16ConfigurationSlaveTypeChoice chosenElementOrdinal, uci::base::accessorType::AccessorType type = uci::base::accessorType::null) = 0;
  ...
  /** Sets the complex content identified by EntityID to the contents of the complex content accessed by the specified
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::GatewayLink16ConfigurationSlaveType& setEntityID(const uci::type::EntityID_Type& value) = 0;
  ...
  /** Sets the complex content identified by OperatorLocationOfInterestID to the contents of the complex content accessed
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::GatewayLink16ConfigurationSlaveType& setOperatorLocationOfInterestID(const uci::type::OperatorLocationOfInterestID_Type& value) = 0;
  ...
  /** Sets the complex content identified by OpPointID to the contents of the complex content accessed by the specified
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::GatewayLink16ConfigurationSlaveType& setOpPointID(const uci::type::OpPointID_Type& value) = 0;
  ...
  /** Sets the complex content identified by SystemID to the contents of the complex content accessed by the specified
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::GatewayLink16ConfigurationSlaveType& setSystemID(const uci::type::SystemID_Type& value) = 0;
...
protected:
  ...
  /** The assignment operator. Sets the contents of this GatewayLink16ConfigurationSlaveType to the contents of the
    * GatewayLink16ConfigurationSlaveType on the right hand side (rhs) of the assignment operator [only available to
    * derived classes].
    *
    * @param rhs The GatewayLink16ConfigurationSlaveType on the right hand side (rhs) of the assignment operator whose
    *      contents are used to set the contents of this GatewayLink16ConfigurationSlaveType.
    * @return A reference to this GatewayLink16ConfigurationSlaveType.
    */
  GatewayLink16ConfigurationSlaveType& operator=(const GatewayLink16ConfigurationSlaveType& rhs) {
    (void)rhs;
...
#endif // UCI_TYPE_GATEWAYLINK16CONFIGURATIONSLAVETYPE_H
