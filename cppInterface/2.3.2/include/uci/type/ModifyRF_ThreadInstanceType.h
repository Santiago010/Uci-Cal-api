...
#ifndef UCI_TYPE_MODIFYRF_THREADINSTANCETYPE_H
#define UCI_TYPE_MODIFYRF_THREADINSTANCETYPE_H
...
public:
  ...
  /** This method constructs a new ModifyRF_ThreadInstanceType.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed ModifyRF_ThreadInstanceType.
    */
  static UCI_EXPORT ModifyRF_ThreadInstanceType& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new ModifyRF_ThreadInstanceType initializing the data accessed by the new
    * ModifyRF_ThreadInstanceType using the data accessed by the specified ModifyRF_ThreadInstanceType (cloning).
    *
    * @param accessor The ModifyRF_ThreadInstanceType that provides access to the data that is to be used to initialize the
    *      data accessed by the new created ModifyRF_ThreadInstanceType.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed ModifyRF_ThreadInstanceType.
    */
  static UCI_EXPORT ModifyRF_ThreadInstanceType& create(const ModifyRF_ThreadInstanceType& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified ModifyRF_ThreadInstanceType. Use of the specified accessor after it has been
    * destroyed will result in undefined behavior.
    *
    * @param accessor The ModifyRF_ThreadInstanceType that is to be destroyed.
    */
  static UCI_EXPORT void destroy(ModifyRF_ThreadInstanceType& accessor);
  ...
  /** Returns the version that was initialized from the uci:version attribute of ModifyRF_ThreadInstanceType.
    *
    * @return The version that was initialized from the uci:version attribute of ModifyRF_ThreadInstanceType.
    */
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const ModifyRF_ThreadInstanceType& accessor) = 0;
  ...
  /** Sets the value of the SimplePrimitive data type identified by RF_ThreadInstanceIndex.
    ...
    */
  virtual uci::type::ModifyRF_ThreadInstanceType& setRF_ThreadInstanceIndex(xs::UnsignedInt value) = 0;
  ...
  /** Sets the value of the SimplePrimitive data type identified by ActiveBeamInstanceIndex.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::ModifyRF_ThreadInstanceType& setActiveBeamInstanceIndex(xs::UnsignedInt value) = 0;
  ...
  /** Clears (disabled) the Element identified by ActiveBeamInstanceIndex.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::ModifyRF_ThreadInstanceType& clearActiveBeamInstanceIndex() = 0;
  ...
  /** Sets the value of the SimplePrimitive data type identified by ResourceAccessPriority.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::ModifyRF_ThreadInstanceType& setResourceAccessPriority(xs::UnsignedInt value) = 0;
  ...
  /** Clears (disabled) the Element identified by ResourceAccessPriority.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::ModifyRF_ThreadInstanceType& clearResourceAccessPriority() = 0;
  ...
  /** Returns a const reference to the bounded list identified by BeamInstance.
    ...
    */
  virtual const uci::type::ModifyRF_ThreadInstanceType::BeamInstance& getBeamInstance() const = 0;
  ...
  /** Returns a reference to the bounded list identified by BeamInstance.
    ...
    */
  virtual uci::type::ModifyRF_ThreadInstanceType::BeamInstance& getBeamInstance() = 0;
  ...
  /** Sets the bounded list identified by BeamInstance.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::ModifyRF_ThreadInstanceType& setBeamInstance(const uci::type::ModifyRF_ThreadInstanceType::BeamInstance& value) = 0;
  ...
  /** Returns a const reference to the bounded list identified by RF_Gain.
    ...
    */
  virtual const uci::type::ModifyRF_ThreadInstanceType::RF_Gain& getRF_Gain() const = 0;
  ...
  /** Returns a reference to the bounded list identified by RF_Gain.
    ...
    */
  virtual uci::type::ModifyRF_ThreadInstanceType::RF_Gain& getRF_Gain() = 0;
  ...
  /** Sets the bounded list identified by RF_Gain.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::ModifyRF_ThreadInstanceType& setRF_Gain(const uci::type::ModifyRF_ThreadInstanceType::RF_Gain& value) = 0;
...
protected:
  ...
  /** The assignment operator. Sets the contents of this ModifyRF_ThreadInstanceType to the contents of the
    * ModifyRF_ThreadInstanceType on the right hand side (rhs) of the assignment operator [only available to derived
    * classes].
    *
    * @param rhs The ModifyRF_ThreadInstanceType on the right hand side (rhs) of the assignment operator whose contents are
    *      used to set the contents of this ModifyRF_ThreadInstanceType.
    * @return A reference to this ModifyRF_ThreadInstanceType.
    */
  ModifyRF_ThreadInstanceType& operator=(const ModifyRF_ThreadInstanceType& rhs) {
    (void)rhs;
...
#endif // UCI_TYPE_MODIFYRF_THREADINSTANCETYPE_H
