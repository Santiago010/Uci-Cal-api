/** @file OrbitalSurveillanceActivityMT.h
 *
...
#ifndef UCI_TYPE_ORBITALSURVEILLANCEACTIVITYMT_H
#define UCI_TYPE_ORBITALSURVEILLANCEACTIVITYMT_H
...
#include "OrbitalSurveillanceActivityMDT.h"
...
/** This message describes the current activities being executed by an OrbitalSurveillance capability. */
class OrbitalSurveillanceActivityMT : public virtual MessageType {
public:

  /** This method constructs a new OrbitalSurveillanceActivityMT.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed OrbitalSurveillanceActivityMT.
    */
  static UCI_EXPORT OrbitalSurveillanceActivityMT& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new OrbitalSurveillanceActivityMT initializing the data accessed by the new
    * OrbitalSurveillanceActivityMT using the data accessed by the specified OrbitalSurveillanceActivityMT (cloning).
    *
    * @param accessor The OrbitalSurveillanceActivityMT that provides access to the data that is to be used to initialize
    *      the data accessed by the new created OrbitalSurveillanceActivityMT.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed OrbitalSurveillanceActivityMT.
    */
  static UCI_EXPORT OrbitalSurveillanceActivityMT& create(const OrbitalSurveillanceActivityMT& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified OrbitalSurveillanceActivityMT. Use of the specified accessor after it has been
    * destroyed will result in undefined behavior.
    *
    * @param accessor The OrbitalSurveillanceActivityMT that is to be destroyed.
    */
  static UCI_EXPORT void destroy(OrbitalSurveillanceActivityMT& accessor);

  /** Returns this accessor's type constant, i.e. orbitalSurveillanceActivityMT.
    *
    * @return This accessor's type constant, i.e. orbitalSurveillanceActivityMT.
    */
  virtual uci::base::accessorType::AccessorType getAccessorType() const noexception {
    return uci::type::accessorType::orbitalSurveillanceActivityMT;
  }

  /** Returns the version that was initialized from the uci:version attribute of OrbitalSurveillanceActivityMT.
    *
    * @return The version that was initialized from the uci:version attribute of OrbitalSurveillanceActivityMT.
    */
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const OrbitalSurveillanceActivityMT& accessor) = 0;
  ...
  /** Sets the value of the enumeration identified by ObjectState.
    ...
    */
  virtual uci::type::OrbitalSurveillanceActivityMT& setObjectState(const uci::type::ObjectStateEnum& value) = 0;
  ...
  /** Sets the value of the enumeration identified by ObjectState.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::OrbitalSurveillanceActivityMT& setObjectState(uci::type::ObjectStateEnum::EnumerationItem value) = 0;
  ...
  /** Clears (disabled) the Element identified by ObjectState.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::OrbitalSurveillanceActivityMT& clearObjectState() = 0;
  ...
  /** Returns a const reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual const uci::type::OrbitalSurveillanceActivityMDT& getMessageData() const = 0;
  ...
  /** Returns a reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual uci::type::OrbitalSurveillanceActivityMDT& getMessageData() = 0;
  ...
  /** Sets the complex content identified by MessageData to the contents of the complex content accessed by the specified
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::OrbitalSurveillanceActivityMT& setMessageData(const uci::type::OrbitalSurveillanceActivityMDT& value) = 0;

  /** The Listener provides the support to listen and handle incoming messages of the type
    * uci::type::OrbitalSurveillanceActivityMT.
    */
  ...
  public:
    ...
    /** The method is used to handle incoming messages.
      ...
      */
    virtual void handleMessage(const uci::type::OrbitalSurveillanceActivityMT& message) = 0;
  ...
  public:
    ...
    /** Adds a listener to this reader to handle incoming messages.
      ...
      */
    virtual void addListener(uci::type::OrbitalSurveillanceActivityMT::Listener& listener) = 0;

    /** Removes the specified listener from this reader.
      *
      * @param listener The listener that is to be removed from this reader.
      */
    virtual void removeListener(uci::type::OrbitalSurveillanceActivityMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s). Returns immediately if no messages are available.
      ...
      */
    virtual unsigned long readNoWait(unsigned long maxNumberOfMessages, uci::type::OrbitalSurveillanceActivityMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s).
      ...
      * @return The number of messages that were handled.
      */
    virtual unsigned long read(unsigned long timeout, unsigned long maxNumberOfMessages, uci::type::OrbitalSurveillanceActivityMT::Listener& listener) = 0;
  ...
  /** This method creates a new reader that can be used to read a OrbitalSurveillanceActivityMT.
    *
    * @param topic The specification of the topic the reader is to read from.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A reader that can read a OrbitalSurveillanceActivityMT.
    */
  static UCI_EXPORT uci::type::OrbitalSurveillanceActivityMT::Reader& createReader(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a reader. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyReader(uci::type::OrbitalSurveillanceActivityMT::Reader& reader);
  ...
  public:
    ...
    /** Writes the OMS message to the topic specified when this Writer was created.
      ...
      */
    virtual void write(uci::type::OrbitalSurveillanceActivityMT& accessor) = 0;
  ...
  /** This method creates a new writer that can be used to write a OrbitalSurveillanceActivityMT.
    *
    * @param topic The specification of the topic the writer is to write to.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A writer that can write a OrbitalSurveillanceActivityMT.
    */
  static UCI_EXPORT uci::type::OrbitalSurveillanceActivityMT::Writer& createWriter(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a writer. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyWriter(uci::type::OrbitalSurveillanceActivityMT::Writer& writer);
...
protected:
  ...
  /** The copy constructor [only available to derived classes].
    *
    * @param rhs The OrbitalSurveillanceActivityMT to copy from.
    */
  OrbitalSurveillanceActivityMT(const OrbitalSurveillanceActivityMT& rhs) {
    (void)rhs;
  }

  /** The assignment operator. Sets the contents of this OrbitalSurveillanceActivityMT to the contents of the
    * OrbitalSurveillanceActivityMT on the right hand side (rhs) of the assignment operator [only available to derived
    * classes].
    *
    * @param rhs The OrbitalSurveillanceActivityMT on the right hand side (rhs) of the assignment operator whose contents
    *      are used to set the contents of this OrbitalSurveillanceActivityMT.
    * @return A reference to this OrbitalSurveillanceActivityMT.
    */
  OrbitalSurveillanceActivityMT& operator=(const OrbitalSurveillanceActivityMT& rhs) {
    (void)rhs;
...
#endif // UCI_TYPE_ORBITALSURVEILLANCEACTIVITYMT_H
