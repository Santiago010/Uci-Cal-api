...
#ifndef UCI_TYPE_AMTI_CAPABILITYSTATUSMDT_H
#define UCI_TYPE_AMTI_CAPABILITYSTATUSMDT_H
...
class AMTI_CapabilityStatusMDT : public virtual CapabilityStatusBaseType {
public:

  /** This method constructs a new AMTI_CapabilityStatusMDT.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed AMTI_CapabilityStatusMDT.
    */
  static UCI_EXPORT AMTI_CapabilityStatusMDT& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new AMTI_CapabilityStatusMDT initializing the data accessed by the new
    * AMTI_CapabilityStatusMDT using the data accessed by the specified AMTI_CapabilityStatusMDT (cloning).
    *
    * @param accessor The AMTI_CapabilityStatusMDT that provides access to the data that is to be used to initialize the
    *      data accessed by the new created AMTI_CapabilityStatusMDT.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed AMTI_CapabilityStatusMDT.
    */
  static UCI_EXPORT AMTI_CapabilityStatusMDT& create(const AMTI_CapabilityStatusMDT& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified AMTI_CapabilityStatusMDT. Use of the specified accessor after it has been
    * destroyed will result in undefined behavior.
    *
    * @param accessor The AMTI_CapabilityStatusMDT that is to be destroyed.
    */
  static UCI_EXPORT void destroy(AMTI_CapabilityStatusMDT& accessor);
  ...
  /** Returns the version that was initialized from the uci:version attribute of AMTI_CapabilityStatusMDT.
    *
    * @return The version that was initialized from the uci:version attribute of AMTI_CapabilityStatusMDT.
    */
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const AMTI_CapabilityStatusMDT& accessor) = 0;
  ...
  /** Returns a const reference to the bounded list identified by CapabilityStatus.
    ...
    */
  virtual const uci::type::AMTI_CapabilityStatusMDT::CapabilityStatus& getCapabilityStatus() const = 0;
  ...
  /** Returns a reference to the bounded list identified by CapabilityStatus.
    ...
    */
  virtual uci::type::AMTI_CapabilityStatusMDT::CapabilityStatus& getCapabilityStatus() = 0;
  ...
  /** Sets the bounded list identified by CapabilityStatus.
    ...
    */
  virtual uci::type::AMTI_CapabilityStatusMDT& setCapabilityStatus(const uci::type::AMTI_CapabilityStatusMDT::CapabilityStatus& value) = 0;
  ...
  /** Returns a const reference to the bounded list identified by RF_Profile.
    ...
    */
  virtual const uci::type::AMTI_CapabilityStatusMDT::RF_Profile& getRF_Profile() const = 0;
  ...
  /** Returns a reference to the bounded list identified by RF_Profile.
    ...
    */
  virtual uci::type::AMTI_CapabilityStatusMDT::RF_Profile& getRF_Profile() = 0;
  ...
  /** Sets the bounded list identified by RF_Profile.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::AMTI_CapabilityStatusMDT& setRF_Profile(const uci::type::AMTI_CapabilityStatusMDT::RF_Profile& value) = 0;
  ...
  /** Sets the complex content identified by DefaultEmcon to the contents of the complex content accessed by the specified
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::AMTI_CapabilityStatusMDT& setDefaultEmcon(const uci::type::EmconSettingType& value) = 0;
  ...
  /** Clears (disabled) the Element identified by DefaultEmcon.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::AMTI_CapabilityStatusMDT& clearDefaultEmcon() = 0;
  ...
  /** Sets the value of the enumeration identified by EmissionBalanceState.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::AMTI_CapabilityStatusMDT& setEmissionBalanceState(const uci::type::EmissionBalanceEnum& value) = 0;
  ...
  /** Sets the value of the enumeration identified by EmissionBalanceState.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::AMTI_CapabilityStatusMDT& setEmissionBalanceState(uci::type::EmissionBalanceEnum::EnumerationItem value) = 0;
  ...
  /** Clears (disabled) the Element identified by EmissionBalanceState.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::AMTI_CapabilityStatusMDT& clearEmissionBalanceState() = 0;
  ...
  /** Returns a const reference to the bounded list identified by CurrentMessageOutput.
    ...
    */
  virtual const uci::type::AMTI_CapabilityStatusMDT::CurrentMessageOutput& getCurrentMessageOutput() const = 0;
  ...
  /** Returns a reference to the bounded list identified by CurrentMessageOutput.
    ...
    */
  virtual uci::type::AMTI_CapabilityStatusMDT::CurrentMessageOutput& getCurrentMessageOutput() = 0;
  ...
  /** Sets the bounded list identified by CurrentMessageOutput.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::AMTI_CapabilityStatusMDT& setCurrentMessageOutput(const uci::type::AMTI_CapabilityStatusMDT::CurrentMessageOutput& value) = 0;
  ...
  /** Returns a const reference to the bounded list identified by ElectronicProtectionOptionsEnabled.
    ...
    */
  virtual const uci::type::AMTI_CapabilityStatusMDT::ElectronicProtectionOptionsEnabled& getElectronicProtectionOptionsEnabled() const = 0;
  ...
  /** Returns a reference to the bounded list identified by ElectronicProtectionOptionsEnabled.
    ...
    */
  virtual uci::type::AMTI_CapabilityStatusMDT::ElectronicProtectionOptionsEnabled& getElectronicProtectionOptionsEnabled() = 0;
  ...
  /** Sets the bounded list identified by ElectronicProtectionOptionsEnabled.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::AMTI_CapabilityStatusMDT& setElectronicProtectionOptionsEnabled(const uci::type::AMTI_CapabilityStatusMDT::ElectronicProtectionOptionsEnabled& value) = 0;
...
protected:
  ...
  /** The assignment operator. Sets the contents of this AMTI_CapabilityStatusMDT to the contents of the
    * AMTI_CapabilityStatusMDT on the right hand side (rhs) of the assignment operator [only available to derived classes].
    *
    * @param rhs The AMTI_CapabilityStatusMDT on the right hand side (rhs) of the assignment operator whose contents are
    *      used to set the contents of this AMTI_CapabilityStatusMDT.
    * @return A reference to this AMTI_CapabilityStatusMDT.
    */
  AMTI_CapabilityStatusMDT& operator=(const AMTI_CapabilityStatusMDT& rhs) {
    (void)rhs;
...
#endif // UCI_TYPE_AMTI_CAPABILITYSTATUSMDT_H
