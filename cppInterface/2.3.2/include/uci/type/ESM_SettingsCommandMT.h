...
#ifndef UCI_TYPE_ESM_SETTINGSCOMMANDMT_H
#define UCI_TYPE_ESM_SETTINGSCOMMANDMT_H

#include "../base/Listener.h"
#include "../base/Reader.h"
#include "../base/Writer.h"
#include "../base/export.h"
#include "ESM_SettingsCommandMDT.h"
...
class ESM_SettingsCommandMT : public virtual MessageType {
public:

  /** This method constructs a new ESM_SettingsCommandMT.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed ESM_SettingsCommandMT.
    */
  static UCI_EXPORT ESM_SettingsCommandMT& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new ESM_SettingsCommandMT initializing the data accessed by the new ESM_SettingsCommandMT
    * using the data accessed by the specified ESM_SettingsCommandMT (cloning).
    *
    * @param accessor The ESM_SettingsCommandMT that provides access to the data that is to be used to initialize the data
    *      accessed by the new created ESM_SettingsCommandMT.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed ESM_SettingsCommandMT.
    */
  static UCI_EXPORT ESM_SettingsCommandMT& create(const ESM_SettingsCommandMT& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified ESM_SettingsCommandMT. Use of the specified accessor after it has been destroyed
    * will result in undefined behavior.
    *
    * @param accessor The ESM_SettingsCommandMT that is to be destroyed.
    */
  static UCI_EXPORT void destroy(ESM_SettingsCommandMT& accessor);
  ...
  /** Returns the version that was initialized from the uci:version attribute of ESM_SettingsCommandMT.
    *
    * @return The version that was initialized from the uci:version attribute of ESM_SettingsCommandMT.
    */
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const ESM_SettingsCommandMT& accessor) = 0;
  ...
  /** Returns a const reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual const uci::type::ESM_SettingsCommandMDT& getMessageData() const = 0;
  ...
  /** Returns a reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual uci::type::ESM_SettingsCommandMDT& getMessageData() = 0;
  ...
  /** Sets the complex content identified by MessageData to the contents of the complex content accessed by the specified
    ...
    */
  virtual uci::type::ESM_SettingsCommandMT& setMessageData(const uci::type::ESM_SettingsCommandMDT& value) = 0;

  /** The Listener provides the support to listen and handle incoming messages of the type
    * uci::type::ESM_SettingsCommandMT.
    */
  ...
  public:
    ...
    /** The method is used to handle incoming messages.
      ...
      */
    virtual void handleMessage(const uci::type::ESM_SettingsCommandMT& message) = 0;
  ...
  public:
    ...
    /** Adds a listener to this reader to handle incoming messages.
      ...
      */
    virtual void addListener(uci::type::ESM_SettingsCommandMT::Listener& listener) = 0;

    /** Removes the specified listener from this reader.
      *
      * @param listener The listener that is to be removed from this reader.
      */
    virtual void removeListener(uci::type::ESM_SettingsCommandMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s). Returns immediately if no messages are available.
      ...
      */
    virtual unsigned long readNoWait(unsigned long maxNumberOfMessages, uci::type::ESM_SettingsCommandMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s).
      ...
      * @return The number of messages that were handled.
      */
    virtual unsigned long read(unsigned long timeout, unsigned long maxNumberOfMessages, uci::type::ESM_SettingsCommandMT::Listener& listener) = 0;
  ...
  /** This method creates a new reader that can be used to read a ESM_SettingsCommandMT.
    *
    * @param topic The specification of the topic the reader is to read from.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A reader that can read a ESM_SettingsCommandMT.
    */
  static UCI_EXPORT uci::type::ESM_SettingsCommandMT::Reader& createReader(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a reader. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyReader(uci::type::ESM_SettingsCommandMT::Reader& reader);
  ...
  public:
    ...
    /** Writes the OMS message to the topic specified when this Writer was created.
      ...
      */
    virtual void write(uci::type::ESM_SettingsCommandMT& accessor) = 0;
  ...
  /** This method creates a new writer that can be used to write a ESM_SettingsCommandMT.
    *
    * @param topic The specification of the topic the writer is to write to.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A writer that can write a ESM_SettingsCommandMT.
    */
  static UCI_EXPORT uci::type::ESM_SettingsCommandMT::Writer& createWriter(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a writer. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyWriter(uci::type::ESM_SettingsCommandMT::Writer& writer);
...
protected:
  ...
  /** The assignment operator. Sets the contents of this ESM_SettingsCommandMT to the contents of the ESM_SettingsCommandMT
    ...
    *      to set the contents of this ESM_SettingsCommandMT.
    * @return A reference to this ESM_SettingsCommandMT.
    */
  ESM_SettingsCommandMT& operator=(const ESM_SettingsCommandMT& rhs) {
    (void)rhs;
...
#endif // UCI_TYPE_ESM_SETTINGSCOMMANDMT_H
