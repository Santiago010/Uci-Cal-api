...
#ifndef UCI_TYPE_SUBSYSTEMACTIVEBIT_TYPE_H
#define UCI_TYPE_SUBSYSTEMACTIVEBIT_TYPE_H
...
public:
  ...
  /** This method constructs a new SubsystemActiveBIT_Type.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed SubsystemActiveBIT_Type.
    */
  static UCI_EXPORT SubsystemActiveBIT_Type& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new SubsystemActiveBIT_Type initializing the data accessed by the new
    * SubsystemActiveBIT_Type using the data accessed by the specified SubsystemActiveBIT_Type (cloning).
    *
    * @param accessor The SubsystemActiveBIT_Type that provides access to the data that is to be used to initialize the
    *      data accessed by the new created SubsystemActiveBIT_Type.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed SubsystemActiveBIT_Type.
    */
  static UCI_EXPORT SubsystemActiveBIT_Type& create(const SubsystemActiveBIT_Type& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified SubsystemActiveBIT_Type. Use of the specified accessor after it has been destroyed
    * will result in undefined behavior.
    *
    * @param accessor The SubsystemActiveBIT_Type that is to be destroyed.
    */
  static UCI_EXPORT void destroy(SubsystemActiveBIT_Type& accessor);
  ...
  /** Returns the version that was initialized from the uci:version attribute of SubsystemActiveBIT_Type.
    *
    * @return The version that was initialized from the uci:version attribute of SubsystemActiveBIT_Type.
    */
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const SubsystemActiveBIT_Type& accessor) = 0;
  ...
  /** Sets the complex content identified by BIT_ID to the contents of the complex content accessed by the specified
    ...
    */
  virtual uci::type::SubsystemActiveBIT_Type& setBIT_ID(const uci::type::BIT_ID_Type& value) = 0;
  ...
  /** Sets the value of the SimplePrimitive data type identified by EstimatedCompletionTime.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::SubsystemActiveBIT_Type& setEstimatedCompletionTime(uci::type::DateTimeTypeValue value) = 0;
  ...
  /** Clears (disabled) the Element identified by EstimatedCompletionTime.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::SubsystemActiveBIT_Type& clearEstimatedCompletionTime() = 0;
  ...
  /** Sets the value of the SimplePrimitive data type identified by EstimatedPercentComplete.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::SubsystemActiveBIT_Type& setEstimatedPercentComplete(uci::type::PercentTypeValue value) = 0;
  ...
  /** Clears (disabled) the Element identified by EstimatedPercentComplete.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::SubsystemActiveBIT_Type& clearEstimatedPercentComplete() = 0;
...
protected:
  ...
  /** The assignment operator. Sets the contents of this SubsystemActiveBIT_Type to the contents of the
    * SubsystemActiveBIT_Type on the right hand side (rhs) of the assignment operator [only available to derived classes].
    *
    * @param rhs The SubsystemActiveBIT_Type on the right hand side (rhs) of the assignment operator whose contents are
    *      used to set the contents of this SubsystemActiveBIT_Type.
    * @return A reference to this SubsystemActiveBIT_Type.
    */
  SubsystemActiveBIT_Type& operator=(const SubsystemActiveBIT_Type& rhs) {
    (void)rhs;
...
#endif // UCI_TYPE_SUBSYSTEMACTIVEBIT_TYPE_H
