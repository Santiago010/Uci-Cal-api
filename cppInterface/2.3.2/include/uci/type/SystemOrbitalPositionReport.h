/** @file SystemOrbitalPositionReport.h
 *
...
typedef uci::type::SystemOrbitalPositionReportMT SystemOrbitalPositionReport;

} // namespace type
} // namespace uci

#endif // UCI_TYPE_SYSTEMORBITALPOSITIONREPORT_H
