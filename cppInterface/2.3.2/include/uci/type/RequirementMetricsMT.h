...
#ifndef UCI_TYPE_REQUIREMENTMETRICSMT_H
#define UCI_TYPE_REQUIREMENTMETRICSMT_H
...
#include "RequirementMetricsMDT.h"
...
class RequirementMetricsMT : public virtual MessageType {
public:

  /** This method constructs a new RequirementMetricsMT.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed RequirementMetricsMT.
    */
  static UCI_EXPORT RequirementMetricsMT& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new RequirementMetricsMT initializing the data accessed by the new RequirementMetricsMT
    * using the data accessed by the specified RequirementMetricsMT (cloning).
    *
    * @param accessor The RequirementMetricsMT that provides access to the data that is to be used to initialize the data
    *      accessed by the new created RequirementMetricsMT.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed RequirementMetricsMT.
    */
  static UCI_EXPORT RequirementMetricsMT& create(const RequirementMetricsMT& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified RequirementMetricsMT. Use of the specified accessor after it has been destroyed
    * will result in undefined behavior.
    *
    * @param accessor The RequirementMetricsMT that is to be destroyed.
    */
  static UCI_EXPORT void destroy(RequirementMetricsMT& accessor);

  /** Returns this accessor's type constant, i.e. requirementMetricsMT.
    *
    * @return This accessor's type constant, i.e. requirementMetricsMT.
    */
  virtual uci::base::accessorType::AccessorType getAccessorType() const noexception {
    return uci::type::accessorType::requirementMetricsMT;
  }

  /** Returns the version that was initialized from the uci:version attribute of RequirementMetricsMT.
    *
    * @return The version that was initialized from the uci:version attribute of RequirementMetricsMT.
    */
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const RequirementMetricsMT& accessor) = 0;
  ...
  /** Sets the value of the enumeration identified by ObjectState.
    ...
    */
  virtual uci::type::RequirementMetricsMT& setObjectState(const uci::type::ObjectStateEnum& value) = 0;
  ...
  /** Sets the value of the enumeration identified by ObjectState.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::RequirementMetricsMT& setObjectState(uci::type::ObjectStateEnum::EnumerationItem value) = 0;
  ...
  /** Clears (disabled) the Element identified by ObjectState.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::RequirementMetricsMT& clearObjectState() = 0;
  ...
  /** Returns a const reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual const uci::type::RequirementMetricsMDT& getMessageData() const = 0;
  ...
  /** Returns a reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual uci::type::RequirementMetricsMDT& getMessageData() = 0;
  ...
  /** Sets the complex content identified by MessageData to the contents of the complex content accessed by the specified
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::RequirementMetricsMT& setMessageData(const uci::type::RequirementMetricsMDT& value) = 0;

  /** The Listener provides the support to listen and handle incoming messages of the type uci::type::RequirementMetricsMT. */
  ...
  public:
    ...
    /** The method is used to handle incoming messages.
      ...
      */
    virtual void handleMessage(const uci::type::RequirementMetricsMT& message) = 0;
  ...
  public:
    ...
    /** Adds a listener to this reader to handle incoming messages.
      ...
      */
    virtual void addListener(uci::type::RequirementMetricsMT::Listener& listener) = 0;

    /** Removes the specified listener from this reader.
      *
      * @param listener The listener that is to be removed from this reader.
      */
    virtual void removeListener(uci::type::RequirementMetricsMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s). Returns immediately if no messages are available.
      ...
      */
    virtual unsigned long readNoWait(unsigned long maxNumberOfMessages, uci::type::RequirementMetricsMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s).
      ...
      * @return The number of messages that were handled.
      */
    virtual unsigned long read(unsigned long timeout, unsigned long maxNumberOfMessages, uci::type::RequirementMetricsMT::Listener& listener) = 0;
  ...
  /** This method creates a new reader that can be used to read a RequirementMetricsMT.
    *
    * @param topic The specification of the topic the reader is to read from.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A reader that can read a RequirementMetricsMT.
    */
  static UCI_EXPORT uci::type::RequirementMetricsMT::Reader& createReader(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a reader. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyReader(uci::type::RequirementMetricsMT::Reader& reader);
  ...
  public:
    ...
    /** Writes the OMS message to the topic specified when this Writer was created.
      ...
      */
    virtual void write(uci::type::RequirementMetricsMT& accessor) = 0;
  ...
  /** This method creates a new writer that can be used to write a RequirementMetricsMT.
    *
    * @param topic The specification of the topic the writer is to write to.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A writer that can write a RequirementMetricsMT.
    */
  static UCI_EXPORT uci::type::RequirementMetricsMT::Writer& createWriter(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a writer. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyWriter(uci::type::RequirementMetricsMT::Writer& writer);
...
protected:
  ...
  /** The copy constructor [only available to derived classes].
    *
    * @param rhs The RequirementMetricsMT to copy from.
    */
  RequirementMetricsMT(const RequirementMetricsMT& rhs) {
    (void)rhs;
  }

  /** The assignment operator. Sets the contents of this RequirementMetricsMT to the contents of the RequirementMetricsMT
    * on the right hand side (rhs) of the assignment operator [only available to derived classes].
    *
    * @param rhs The RequirementMetricsMT on the right hand side (rhs) of the assignment operator whose contents are used
    *      to set the contents of this RequirementMetricsMT.
    * @return A reference to this RequirementMetricsMT.
    */
  RequirementMetricsMT& operator=(const RequirementMetricsMT& rhs) {
    (void)rhs;
...
#endif // UCI_TYPE_REQUIREMENTMETRICSMT_H
