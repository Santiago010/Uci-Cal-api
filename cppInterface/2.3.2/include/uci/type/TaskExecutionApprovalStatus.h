/** @file TaskExecutionApprovalStatus.h
 *
...
typedef uci::type::TaskExecutionApprovalStatusMT TaskExecutionApprovalStatus;

} // namespace type
} // namespace uci

#endif // UCI_TYPE_TASKEXECUTIONAPPROVALSTATUS_H
