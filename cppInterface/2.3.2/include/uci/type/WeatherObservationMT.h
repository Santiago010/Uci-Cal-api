...
#ifndef UCI_TYPE_WEATHEROBSERVATIONMT_H
#define UCI_TYPE_WEATHEROBSERVATIONMT_H
...
#include "WeatherObservationMDT.h"
...
class WeatherObservationMT : public virtual MessageType {
public:

  /** This method constructs a new WeatherObservationMT.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed WeatherObservationMT.
    */
  static UCI_EXPORT WeatherObservationMT& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new WeatherObservationMT initializing the data accessed by the new WeatherObservationMT
    * using the data accessed by the specified WeatherObservationMT (cloning).
    *
    * @param accessor The WeatherObservationMT that provides access to the data that is to be used to initialize the data
    *      accessed by the new created WeatherObservationMT.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed WeatherObservationMT.
    */
  static UCI_EXPORT WeatherObservationMT& create(const WeatherObservationMT& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified WeatherObservationMT. Use of the specified accessor after it has been destroyed
    * will result in undefined behavior.
    *
    * @param accessor The WeatherObservationMT that is to be destroyed.
    */
  static UCI_EXPORT void destroy(WeatherObservationMT& accessor);
  ...
  /** Returns the version that was initialized from the uci:version attribute of WeatherObservationMT.
    *
    * @return The version that was initialized from the uci:version attribute of WeatherObservationMT.
    */
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const WeatherObservationMT& accessor) = 0;
  ...
  /** Returns a const reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual const uci::type::WeatherObservationMDT& getMessageData() const = 0;
  ...
  /** Returns a reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual uci::type::WeatherObservationMDT& getMessageData() = 0;
  ...
  /** Sets the complex content identified by MessageData to the contents of the complex content accessed by the specified
    ...
    */
  virtual uci::type::WeatherObservationMT& setMessageData(const uci::type::WeatherObservationMDT& value) = 0;

  /** The Listener provides the support to listen and handle incoming messages of the type uci::type::WeatherObservationMT. */
  ...
  public:
    ...
    /** The method is used to handle incoming messages.
      ...
      */
    virtual void handleMessage(const uci::type::WeatherObservationMT& message) = 0;
  ...
  public:
    ...
    /** Adds a listener to this reader to handle incoming messages.
      ...
      */
    virtual void addListener(uci::type::WeatherObservationMT::Listener& listener) = 0;

    /** Removes the specified listener from this reader.
      *
      * @param listener The listener that is to be removed from this reader.
      */
    virtual void removeListener(uci::type::WeatherObservationMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s). Returns immediately if no messages are available.
      ...
      */
    virtual unsigned long readNoWait(unsigned long maxNumberOfMessages, uci::type::WeatherObservationMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s).
      ...
      * @return The number of messages that were handled.
      */
    virtual unsigned long read(unsigned long timeout, unsigned long maxNumberOfMessages, uci::type::WeatherObservationMT::Listener& listener) = 0;
  ...
  /** This method creates a new reader that can be used to read a WeatherObservationMT.
    *
    * @param topic The specification of the topic the reader is to read from.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A reader that can read a WeatherObservationMT.
    */
  static UCI_EXPORT uci::type::WeatherObservationMT::Reader& createReader(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a reader. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyReader(uci::type::WeatherObservationMT::Reader& reader);
  ...
  public:
    ...
    /** Writes the OMS message to the topic specified when this Writer was created.
      ...
      */
    virtual void write(uci::type::WeatherObservationMT& accessor) = 0;
  ...
  /** This method creates a new writer that can be used to write a WeatherObservationMT.
    *
    * @param topic The specification of the topic the writer is to write to.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A writer that can write a WeatherObservationMT.
    */
  static UCI_EXPORT uci::type::WeatherObservationMT::Writer& createWriter(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a writer. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyWriter(uci::type::WeatherObservationMT::Writer& writer);
...
protected:
  ...
  /** The assignment operator. Sets the contents of this WeatherObservationMT to the contents of the WeatherObservationMT
    ...
    *      to set the contents of this WeatherObservationMT.
    * @return A reference to this WeatherObservationMT.
    */
  WeatherObservationMT& operator=(const WeatherObservationMT& rhs) {
    (void)rhs;
...
#endif // UCI_TYPE_WEATHEROBSERVATIONMT_H
