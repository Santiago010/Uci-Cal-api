/** @file SystemOrbitalElementSetMT.h
 *
...
#ifndef UCI_TYPE_SYSTEMORBITALELEMENTSETMT_H
#define UCI_TYPE_SYSTEMORBITALELEMENTSETMT_H
...
#include "SystemOrbitalElementSetMDT.h"
...
/** Indicates the element set's ID, System's ID, the parameters used for creating the element set, the element set data,
  * and the Request's ID (if message is generated in response to a request).
  */
class SystemOrbitalElementSetMT : public virtual MessageType {
public:

  /** This method constructs a new SystemOrbitalElementSetMT.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed SystemOrbitalElementSetMT.
    */
  static UCI_EXPORT SystemOrbitalElementSetMT& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new SystemOrbitalElementSetMT initializing the data accessed by the new
    * SystemOrbitalElementSetMT using the data accessed by the specified SystemOrbitalElementSetMT (cloning).
    *
    * @param accessor The SystemOrbitalElementSetMT that provides access to the data that is to be used to initialize the
    *      data accessed by the new created SystemOrbitalElementSetMT.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed SystemOrbitalElementSetMT.
    */
  static UCI_EXPORT SystemOrbitalElementSetMT& create(const SystemOrbitalElementSetMT& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified SystemOrbitalElementSetMT. Use of the specified accessor after it has been
    * destroyed will result in undefined behavior.
    *
    * @param accessor The SystemOrbitalElementSetMT that is to be destroyed.
    */
  static UCI_EXPORT void destroy(SystemOrbitalElementSetMT& accessor);

  /** Returns this accessor's type constant, i.e. systemOrbitalElementSetMT.
    *
    * @return This accessor's type constant, i.e. systemOrbitalElementSetMT.
    */
  virtual uci::base::accessorType::AccessorType getAccessorType() const noexception {
    return uci::type::accessorType::systemOrbitalElementSetMT;
  }

  /** Returns the version that was initialized from the uci:version attribute of SystemOrbitalElementSetMT.
    *
    * @return The version that was initialized from the uci:version attribute of SystemOrbitalElementSetMT.
    */
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const SystemOrbitalElementSetMT& accessor) = 0;
  ...
  /** Sets the value of the enumeration identified by ObjectState.
    ...
    */
  virtual uci::type::SystemOrbitalElementSetMT& setObjectState(const uci::type::ObjectStateEnum& value) = 0;
  ...
  /** Sets the value of the enumeration identified by ObjectState.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::SystemOrbitalElementSetMT& setObjectState(uci::type::ObjectStateEnum::EnumerationItem value) = 0;
  ...
  /** Clears (disabled) the Element identified by ObjectState.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::SystemOrbitalElementSetMT& clearObjectState() = 0;
  ...
  /** Returns a const reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual const uci::type::SystemOrbitalElementSetMDT& getMessageData() const = 0;
  ...
  /** Returns a reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual uci::type::SystemOrbitalElementSetMDT& getMessageData() = 0;
  ...
  /** Sets the complex content identified by MessageData to the contents of the complex content accessed by the specified
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::SystemOrbitalElementSetMT& setMessageData(const uci::type::SystemOrbitalElementSetMDT& value) = 0;

  /** The Listener provides the support to listen and handle incoming messages of the type
    * uci::type::SystemOrbitalElementSetMT.
    */
  ...
  public:
    ...
    /** The method is used to handle incoming messages.
      ...
      */
    virtual void handleMessage(const uci::type::SystemOrbitalElementSetMT& message) = 0;
  ...
  public:
    ...
    /** Adds a listener to this reader to handle incoming messages.
      ...
      */
    virtual void addListener(uci::type::SystemOrbitalElementSetMT::Listener& listener) = 0;

    /** Removes the specified listener from this reader.
      *
      * @param listener The listener that is to be removed from this reader.
      */
    virtual void removeListener(uci::type::SystemOrbitalElementSetMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s). Returns immediately if no messages are available.
      ...
      */
    virtual unsigned long readNoWait(unsigned long maxNumberOfMessages, uci::type::SystemOrbitalElementSetMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s).
      ...
      * @return The number of messages that were handled.
      */
    virtual unsigned long read(unsigned long timeout, unsigned long maxNumberOfMessages, uci::type::SystemOrbitalElementSetMT::Listener& listener) = 0;
  ...
  /** This method creates a new reader that can be used to read a SystemOrbitalElementSetMT.
    *
    * @param topic The specification of the topic the reader is to read from.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A reader that can read a SystemOrbitalElementSetMT.
    */
  static UCI_EXPORT uci::type::SystemOrbitalElementSetMT::Reader& createReader(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a reader. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyReader(uci::type::SystemOrbitalElementSetMT::Reader& reader);
  ...
  public:
    ...
    /** Writes the OMS message to the topic specified when this Writer was created.
      ...
      */
    virtual void write(uci::type::SystemOrbitalElementSetMT& accessor) = 0;
  ...
  /** This method creates a new writer that can be used to write a SystemOrbitalElementSetMT.
    *
    * @param topic The specification of the topic the writer is to write to.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A writer that can write a SystemOrbitalElementSetMT.
    */
  static UCI_EXPORT uci::type::SystemOrbitalElementSetMT::Writer& createWriter(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a writer. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyWriter(uci::type::SystemOrbitalElementSetMT::Writer& writer);
...
protected:
  ...
  /** The copy constructor [only available to derived classes].
    *
    * @param rhs The SystemOrbitalElementSetMT to copy from.
    */
  SystemOrbitalElementSetMT(const SystemOrbitalElementSetMT& rhs) {
    (void)rhs;
  }

  /** The assignment operator. Sets the contents of this SystemOrbitalElementSetMT to the contents of the
    * SystemOrbitalElementSetMT on the right hand side (rhs) of the assignment operator [only available to derived
    * classes].
    *
    * @param rhs The SystemOrbitalElementSetMT on the right hand side (rhs) of the assignment operator whose contents are
    *      used to set the contents of this SystemOrbitalElementSetMT.
    * @return A reference to this SystemOrbitalElementSetMT.
    */
  SystemOrbitalElementSetMT& operator=(const SystemOrbitalElementSetMT& rhs) {
    (void)rhs;
...
#endif // UCI_TYPE_SYSTEMORBITALELEMENTSETMT_H
