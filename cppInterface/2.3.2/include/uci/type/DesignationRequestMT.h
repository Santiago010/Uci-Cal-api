...
#ifndef UCI_TYPE_DESIGNATIONREQUESTMT_H
#define UCI_TYPE_DESIGNATIONREQUESTMT_H

#include "../base/Listener.h"
#include "../base/Reader.h"
#include "../base/Writer.h"
#include "../base/export.h"
#include "DesignationRequestMDT.h"
...
class DesignationRequestMT : public virtual MessageType {
public:

  /** This method constructs a new DesignationRequestMT.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed DesignationRequestMT.
    */
  static UCI_EXPORT DesignationRequestMT& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new DesignationRequestMT initializing the data accessed by the new DesignationRequestMT
    * using the data accessed by the specified DesignationRequestMT (cloning).
    *
    * @param accessor The DesignationRequestMT that provides access to the data that is to be used to initialize the data
    *      accessed by the new created DesignationRequestMT.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed DesignationRequestMT.
    */
  static UCI_EXPORT DesignationRequestMT& create(const DesignationRequestMT& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified DesignationRequestMT. Use of the specified accessor after it has been destroyed
    * will result in undefined behavior.
    *
    * @param accessor The DesignationRequestMT that is to be destroyed.
    */
  static UCI_EXPORT void destroy(DesignationRequestMT& accessor);

  /** Returns this accessor's type constant, i.e. designationRequestMT.
    *
    * @return This accessor's type constant, i.e. designationRequestMT.
    */
  virtual uci::base::accessorType::AccessorType getAccessorType() const noexception {
    return uci::type::accessorType::designationRequestMT;
  }

  /** Returns the version that was initialized from the uci:version attribute of DesignationRequestMT.
    *
    * @return The version that was initialized from the uci:version attribute of DesignationRequestMT.
    */
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const DesignationRequestMT& accessor) = 0;
  ...
  /** Returns a const reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual const uci::type::DesignationRequestMDT& getMessageData() const = 0;
  ...
  /** Returns a reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual uci::type::DesignationRequestMDT& getMessageData() = 0;
  ...
  /** Sets the complex content identified by MessageData to the contents of the complex content accessed by the specified
    ...
    */
  virtual uci::type::DesignationRequestMT& setMessageData(const uci::type::DesignationRequestMDT& value) = 0;

  /** The Listener provides the support to listen and handle incoming messages of the type uci::type::DesignationRequestMT. */
  ...
  public:
    ...
    /** The method is used to handle incoming messages.
      ...
      */
    virtual void handleMessage(const uci::type::DesignationRequestMT& message) = 0;
  ...
  public:
    ...
    /** Adds a listener to this reader to handle incoming messages.
      ...
      */
    virtual void addListener(uci::type::DesignationRequestMT::Listener& listener) = 0;

    /** Removes the specified listener from this reader.
      *
      * @param listener The listener that is to be removed from this reader.
      */
    virtual void removeListener(uci::type::DesignationRequestMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s). Returns immediately if no messages are available.
      ...
      */
    virtual unsigned long readNoWait(unsigned long maxNumberOfMessages, uci::type::DesignationRequestMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s).
      ...
      * @return The number of messages that were handled.
      */
    virtual unsigned long read(unsigned long timeout, unsigned long maxNumberOfMessages, uci::type::DesignationRequestMT::Listener& listener) = 0;
  ...
  /** This method creates a new reader that can be used to read a DesignationRequestMT.
    *
    * @param topic The specification of the topic the reader is to read from.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A reader that can read a DesignationRequestMT.
    */
  static UCI_EXPORT uci::type::DesignationRequestMT::Reader& createReader(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a reader. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyReader(uci::type::DesignationRequestMT::Reader& reader);
  ...
  public:
    ...
    /** Writes the OMS message to the topic specified when this Writer was created.
      ...
      */
    virtual void write(uci::type::DesignationRequestMT& accessor) = 0;
  ...
  /** This method creates a new writer that can be used to write a DesignationRequestMT.
    *
    * @param topic The specification of the topic the writer is to write to.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A writer that can write a DesignationRequestMT.
    */
  static UCI_EXPORT uci::type::DesignationRequestMT::Writer& createWriter(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a writer. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyWriter(uci::type::DesignationRequestMT::Writer& writer);
...
protected:
  ...
  /** The copy constructor [only available to derived classes].
    ...
    */
  DesignationRequestMT(const DesignationRequestMT& rhs) {
    (void)rhs;
  }

  /** The assignment operator. Sets the contents of this DesignationRequestMT to the contents of the DesignationRequestMT
    * on the right hand side (rhs) of the assignment operator [only available to derived classes].
    *
    * @param rhs The DesignationRequestMT on the right hand side (rhs) of the assignment operator whose contents are used
    *      to set the contents of this DesignationRequestMT.
    * @return A reference to this DesignationRequestMT.
    */
  DesignationRequestMT& operator=(const DesignationRequestMT& rhs) {
    (void)rhs;
...
#endif // UCI_TYPE_DESIGNATIONREQUESTMT_H
