...
#ifndef UCI_TYPE_TASKPLANVALIDATIONMT_H
#define UCI_TYPE_TASKPLANVALIDATIONMT_H
...
#include "TaskPlanValidationMDT.h"
...
class TaskPlanValidationMT : public virtual MessageType {
public:

  /** This method constructs a new TaskPlanValidationMT.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed TaskPlanValidationMT.
    */
  static UCI_EXPORT TaskPlanValidationMT& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new TaskPlanValidationMT initializing the data accessed by the new TaskPlanValidationMT
    * using the data accessed by the specified TaskPlanValidationMT (cloning).
    *
    * @param accessor The TaskPlanValidationMT that provides access to the data that is to be used to initialize the data
    *      accessed by the new created TaskPlanValidationMT.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed TaskPlanValidationMT.
    */
  static UCI_EXPORT TaskPlanValidationMT& create(const TaskPlanValidationMT& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified TaskPlanValidationMT. Use of the specified accessor after it has been destroyed
    * will result in undefined behavior.
    *
    * @param accessor The TaskPlanValidationMT that is to be destroyed.
    */
  static UCI_EXPORT void destroy(TaskPlanValidationMT& accessor);

  /** Returns this accessor's type constant, i.e. taskPlanValidationMT.
    *
    * @return This accessor's type constant, i.e. taskPlanValidationMT.
    */
  virtual uci::base::accessorType::AccessorType getAccessorType() const noexception {
    return uci::type::accessorType::taskPlanValidationMT;
  }

  /** Returns the version that was initialized from the uci:version attribute of TaskPlanValidationMT.
    *
    * @return The version that was initialized from the uci:version attribute of TaskPlanValidationMT.
    */
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const TaskPlanValidationMT& accessor) = 0;
  ...
  /** Sets the value of the enumeration identified by ObjectState.
    ...
    */
  virtual uci::type::TaskPlanValidationMT& setObjectState(const uci::type::ObjectStateEnum& value) = 0;
  ...
  /** Sets the value of the enumeration identified by ObjectState.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::TaskPlanValidationMT& setObjectState(uci::type::ObjectStateEnum::EnumerationItem value) = 0;
  ...
  /** Clears (disabled) the Element identified by ObjectState.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::TaskPlanValidationMT& clearObjectState() = 0;
  ...
  /** Returns a const reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual const uci::type::TaskPlanValidationMDT& getMessageData() const = 0;
  ...
  /** Returns a reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual uci::type::TaskPlanValidationMDT& getMessageData() = 0;
  ...
  /** Sets the complex content identified by MessageData to the contents of the complex content accessed by the specified
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::TaskPlanValidationMT& setMessageData(const uci::type::TaskPlanValidationMDT& value) = 0;

  /** The Listener provides the support to listen and handle incoming messages of the type uci::type::TaskPlanValidationMT. */
  ...
  public:
    ...
    /** The method is used to handle incoming messages.
      ...
      */
    virtual void handleMessage(const uci::type::TaskPlanValidationMT& message) = 0;
  ...
  public:
    ...
    /** Adds a listener to this reader to handle incoming messages.
      ...
      */
    virtual void addListener(uci::type::TaskPlanValidationMT::Listener& listener) = 0;

    /** Removes the specified listener from this reader.
      *
      * @param listener The listener that is to be removed from this reader.
      */
    virtual void removeListener(uci::type::TaskPlanValidationMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s). Returns immediately if no messages are available.
      ...
      */
    virtual unsigned long readNoWait(unsigned long maxNumberOfMessages, uci::type::TaskPlanValidationMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s).
      ...
      * @return The number of messages that were handled.
      */
    virtual unsigned long read(unsigned long timeout, unsigned long maxNumberOfMessages, uci::type::TaskPlanValidationMT::Listener& listener) = 0;
  ...
  /** This method creates a new reader that can be used to read a TaskPlanValidationMT.
    *
    * @param topic The specification of the topic the reader is to read from.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A reader that can read a TaskPlanValidationMT.
    */
  static UCI_EXPORT uci::type::TaskPlanValidationMT::Reader& createReader(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a reader. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyReader(uci::type::TaskPlanValidationMT::Reader& reader);
  ...
  public:
    ...
    /** Writes the OMS message to the topic specified when this Writer was created.
      ...
      */
    virtual void write(uci::type::TaskPlanValidationMT& accessor) = 0;
  ...
  /** This method creates a new writer that can be used to write a TaskPlanValidationMT.
    *
    * @param topic The specification of the topic the writer is to write to.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A writer that can write a TaskPlanValidationMT.
    */
  static UCI_EXPORT uci::type::TaskPlanValidationMT::Writer& createWriter(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a writer. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyWriter(uci::type::TaskPlanValidationMT::Writer& writer);
...
protected:
  ...
  /** The copy constructor [only available to derived classes].
    *
    * @param rhs The TaskPlanValidationMT to copy from.
    */
  TaskPlanValidationMT(const TaskPlanValidationMT& rhs) {
    (void)rhs;
  }

  /** The assignment operator. Sets the contents of this TaskPlanValidationMT to the contents of the TaskPlanValidationMT
    * on the right hand side (rhs) of the assignment operator [only available to derived classes].
    *
    * @param rhs The TaskPlanValidationMT on the right hand side (rhs) of the assignment operator whose contents are used
    *      to set the contents of this TaskPlanValidationMT.
    * @return A reference to this TaskPlanValidationMT.
    */
  TaskPlanValidationMT& operator=(const TaskPlanValidationMT& rhs) {
    (void)rhs;
...
#endif // UCI_TYPE_TASKPLANVALIDATIONMT_H
