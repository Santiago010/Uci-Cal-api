/** @file StrikeCapabilityStatusMT.h
 *
...
#ifndef UCI_TYPE_STRIKECAPABILITYSTATUSMT_H
#define UCI_TYPE_STRIKECAPABILITYSTATUSMT_H
...
#include "StrikeCapabilityStatusMDT.h"
...
class StrikeCapabilityStatusMT : public virtual MessageType {
public:

  /** This method constructs a new StrikeCapabilityStatusMT.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed StrikeCapabilityStatusMT.
    */
  static UCI_EXPORT StrikeCapabilityStatusMT& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new StrikeCapabilityStatusMT initializing the data accessed by the new
    * StrikeCapabilityStatusMT using the data accessed by the specified StrikeCapabilityStatusMT (cloning).
    *
    * @param accessor The StrikeCapabilityStatusMT that provides access to the data that is to be used to initialize the
    *      data accessed by the new created StrikeCapabilityStatusMT.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed StrikeCapabilityStatusMT.
    */
  static UCI_EXPORT StrikeCapabilityStatusMT& create(const StrikeCapabilityStatusMT& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified StrikeCapabilityStatusMT. Use of the specified accessor after it has been
    * destroyed will result in undefined behavior.
    *
    * @param accessor The StrikeCapabilityStatusMT that is to be destroyed.
    */
  static UCI_EXPORT void destroy(StrikeCapabilityStatusMT& accessor);
  ...
  /** Returns the version that was initialized from the uci:version attribute of StrikeCapabilityStatusMT.
    *
    * @return The version that was initialized from the uci:version attribute of StrikeCapabilityStatusMT.
    */
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const StrikeCapabilityStatusMT& accessor) = 0;
  ...
  /** Returns a const reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual const uci::type::StrikeCapabilityStatusMDT& getMessageData() const = 0;
  ...
  /** Returns a reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual uci::type::StrikeCapabilityStatusMDT& getMessageData() = 0;
  ...
  /** Sets the complex content identified by MessageData to the contents of the complex content accessed by the specified
    ...
    */
  virtual uci::type::StrikeCapabilityStatusMT& setMessageData(const uci::type::StrikeCapabilityStatusMDT& value) = 0;

  /** The Listener provides the support to listen and handle incoming messages of the type
    * uci::type::StrikeCapabilityStatusMT.
    */
  ...
  public:
    ...
    /** The method is used to handle incoming messages.
      ...
      */
    virtual void handleMessage(const uci::type::StrikeCapabilityStatusMT& message) = 0;
  ...
  public:
    ...
    /** Adds a listener to this reader to handle incoming messages.
      ...
      */
    virtual void addListener(uci::type::StrikeCapabilityStatusMT::Listener& listener) = 0;

    /** Removes the specified listener from this reader.
      *
      * @param listener The listener that is to be removed from this reader.
      */
    virtual void removeListener(uci::type::StrikeCapabilityStatusMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s). Returns immediately if no messages are available.
      ...
      */
    virtual unsigned long readNoWait(unsigned long maxNumberOfMessages, uci::type::StrikeCapabilityStatusMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s).
      ...
      * @return The number of messages that were handled.
      */
    virtual unsigned long read(unsigned long timeout, unsigned long maxNumberOfMessages, uci::type::StrikeCapabilityStatusMT::Listener& listener) = 0;
  ...
  /** This method creates a new reader that can be used to read a StrikeCapabilityStatusMT.
    *
    * @param topic The specification of the topic the reader is to read from.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A reader that can read a StrikeCapabilityStatusMT.
    */
  static UCI_EXPORT uci::type::StrikeCapabilityStatusMT::Reader& createReader(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a reader. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyReader(uci::type::StrikeCapabilityStatusMT::Reader& reader);
  ...
  public:
    ...
    /** Writes the OMS message to the topic specified when this Writer was created.
      ...
      */
    virtual void write(uci::type::StrikeCapabilityStatusMT& accessor) = 0;
  ...
  /** This method creates a new writer that can be used to write a StrikeCapabilityStatusMT.
    *
    * @param topic The specification of the topic the writer is to write to.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A writer that can write a StrikeCapabilityStatusMT.
    */
  static UCI_EXPORT uci::type::StrikeCapabilityStatusMT::Writer& createWriter(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a writer. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyWriter(uci::type::StrikeCapabilityStatusMT::Writer& writer);
...
protected:
  ...
  /** The assignment operator. Sets the contents of this StrikeCapabilityStatusMT to the contents of the
    * StrikeCapabilityStatusMT on the right hand side (rhs) of the assignment operator [only available to derived classes].
    *
    * @param rhs The StrikeCapabilityStatusMT on the right hand side (rhs) of the assignment operator whose contents are
    *      used to set the contents of this StrikeCapabilityStatusMT.
    * @return A reference to this StrikeCapabilityStatusMT.
    */
  StrikeCapabilityStatusMT& operator=(const StrikeCapabilityStatusMT& rhs) {
    (void)rhs;
...
#endif // UCI_TYPE_STRIKECAPABILITYSTATUSMT_H
