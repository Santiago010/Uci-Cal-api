...
class ProductDisseminationRequestMDT : public virtual RequestBaseType {
public:

  /** This method constructs a new ProductDisseminationRequestMDT.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed ProductDisseminationRequestMDT.
    */
  static UCI_EXPORT ProductDisseminationRequestMDT& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new ProductDisseminationRequestMDT initializing the data accessed by the new
    * ProductDisseminationRequestMDT using the data accessed by the specified ProductDisseminationRequestMDT (cloning).
    *
    * @param accessor The ProductDisseminationRequestMDT that provides access to the data that is to be used to initialize
    *      the data accessed by the new created ProductDisseminationRequestMDT.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed ProductDisseminationRequestMDT.
    */
  static UCI_EXPORT ProductDisseminationRequestMDT& create(const ProductDisseminationRequestMDT& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified ProductDisseminationRequestMDT. Use of the specified accessor after it has been
    * destroyed will result in undefined behavior.
    *
    * @param accessor The ProductDisseminationRequestMDT that is to be destroyed.
    */
  static UCI_EXPORT void destroy(ProductDisseminationRequestMDT& accessor);
  ...
  /** Returns the version that was initialized from the uci:version attribute of ProductDisseminationRequestMDT.
    *
    * @return The version that was initialized from the uci:version attribute of ProductDisseminationRequestMDT.
    */
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const ProductDisseminationRequestMDT& accessor) = 0;
  ...
  /** Sets the complex content identified by SystemID to the contents of the complex content accessed by the specified
    ...
    */
  virtual uci::type::ProductDisseminationRequestMDT& setSystemID(const uci::type::SystemID_Type& value) = 0;
  ...
  /** Sets the complex content identified by Rank to the contents of the complex content accessed by the specified
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::ProductDisseminationRequestMDT& setRank(const uci::type::ComparableRankingType& value) = 0;
  ...
  /** Sets the value of the enumeration identified by PreemptLowerRank.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::ProductDisseminationRequestMDT& setPreemptLowerRank(const uci::type::DownloadPriorityEnum& value) = 0;
  ...
  /** Sets the value of the enumeration identified by PreemptLowerRank.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::ProductDisseminationRequestMDT& setPreemptLowerRank(uci::type::DownloadPriorityEnum::EnumerationItem value) = 0;
  ...
  /** Sets the complex content identified by DisseminationRequirements to the contents of the complex content accessed by
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::ProductDisseminationRequestMDT& setDisseminationRequirements(const uci::type::DisseminationRequirementsType& value) = 0;
...
protected:
  ...
  /** The assignment operator. Sets the contents of this ProductDisseminationRequestMDT to the contents of the
    * ProductDisseminationRequestMDT on the right hand side (rhs) of the assignment operator [only available to derived
    * classes].
    *
    * @param rhs The ProductDisseminationRequestMDT on the right hand side (rhs) of the assignment operator whose contents
    *      are used to set the contents of this ProductDisseminationRequestMDT.
    * @return A reference to this ProductDisseminationRequestMDT.
    */
  ProductDisseminationRequestMDT& operator=(const ProductDisseminationRequestMDT& rhs) {
    (void)rhs;
...
#endif // UCI_TYPE_PRODUCTDISSEMINATIONREQUESTMDT_H
