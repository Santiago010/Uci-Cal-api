/** @file EntityOrbitalElementSetRequestStatus.h
 *
...
typedef uci::type::EntityOrbitalElementSetRequestStatusMT EntityOrbitalElementSetRequestStatus;

} // namespace type
} // namespace uci

#endif // UCI_TYPE_ENTITYORBITALELEMENTSETREQUESTSTATUS_H
