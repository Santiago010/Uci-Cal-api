...
#ifndef UCI_TYPE_STRIKECOMMANDSTATUSMT_H
#define UCI_TYPE_STRIKECOMMANDSTATUSMT_H
...
#include "StrikeCommandStatusMDT.h"
...
class StrikeCommandStatusMT : public virtual MessageType {
public:

  /** This method constructs a new StrikeCommandStatusMT.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed StrikeCommandStatusMT.
    */
  static UCI_EXPORT StrikeCommandStatusMT& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new StrikeCommandStatusMT initializing the data accessed by the new StrikeCommandStatusMT
    * using the data accessed by the specified StrikeCommandStatusMT (cloning).
    *
    * @param accessor The StrikeCommandStatusMT that provides access to the data that is to be used to initialize the data
    *      accessed by the new created StrikeCommandStatusMT.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed StrikeCommandStatusMT.
    */
  static UCI_EXPORT StrikeCommandStatusMT& create(const StrikeCommandStatusMT& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified StrikeCommandStatusMT. Use of the specified accessor after it has been destroyed
    * will result in undefined behavior.
    *
    * @param accessor The StrikeCommandStatusMT that is to be destroyed.
    */
  static UCI_EXPORT void destroy(StrikeCommandStatusMT& accessor);
  ...
  /** Returns the version that was initialized from the uci:version attribute of StrikeCommandStatusMT.
    *
    * @return The version that was initialized from the uci:version attribute of StrikeCommandStatusMT.
    */
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const StrikeCommandStatusMT& accessor) = 0;
  ...
  /** Returns a const reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual const uci::type::StrikeCommandStatusMDT& getMessageData() const = 0;
  ...
  /** Returns a reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual uci::type::StrikeCommandStatusMDT& getMessageData() = 0;
  ...
  /** Sets the complex content identified by MessageData to the contents of the complex content accessed by the specified
    ...
    */
  virtual uci::type::StrikeCommandStatusMT& setMessageData(const uci::type::StrikeCommandStatusMDT& value) = 0;

  /** The Listener provides the support to listen and handle incoming messages of the type
    * uci::type::StrikeCommandStatusMT.
    */
  ...
  public:
    ...
    /** The method is used to handle incoming messages.
      ...
      */
    virtual void handleMessage(const uci::type::StrikeCommandStatusMT& message) = 0;
  ...
  public:
    ...
    /** Adds a listener to this reader to handle incoming messages.
      ...
      */
    virtual void addListener(uci::type::StrikeCommandStatusMT::Listener& listener) = 0;

    /** Removes the specified listener from this reader.
      *
      * @param listener The listener that is to be removed from this reader.
      */
    virtual void removeListener(uci::type::StrikeCommandStatusMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s). Returns immediately if no messages are available.
      ...
      */
    virtual unsigned long readNoWait(unsigned long maxNumberOfMessages, uci::type::StrikeCommandStatusMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s).
      ...
      * @return The number of messages that were handled.
      */
    virtual unsigned long read(unsigned long timeout, unsigned long maxNumberOfMessages, uci::type::StrikeCommandStatusMT::Listener& listener) = 0;
  ...
  /** This method creates a new reader that can be used to read a StrikeCommandStatusMT.
    *
    * @param topic The specification of the topic the reader is to read from.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A reader that can read a StrikeCommandStatusMT.
    */
  static UCI_EXPORT uci::type::StrikeCommandStatusMT::Reader& createReader(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a reader. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyReader(uci::type::StrikeCommandStatusMT::Reader& reader);
  ...
  public:
    ...
    /** Writes the OMS message to the topic specified when this Writer was created.
      ...
      */
    virtual void write(uci::type::StrikeCommandStatusMT& accessor) = 0;
  ...
  /** This method creates a new writer that can be used to write a StrikeCommandStatusMT.
    *
    * @param topic The specification of the topic the writer is to write to.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A writer that can write a StrikeCommandStatusMT.
    */
  static UCI_EXPORT uci::type::StrikeCommandStatusMT::Writer& createWriter(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a writer. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyWriter(uci::type::StrikeCommandStatusMT::Writer& writer);
...
protected:
  ...
  /** The assignment operator. Sets the contents of this StrikeCommandStatusMT to the contents of the StrikeCommandStatusMT
    ...
    *      to set the contents of this StrikeCommandStatusMT.
    * @return A reference to this StrikeCommandStatusMT.
    */
  StrikeCommandStatusMT& operator=(const StrikeCommandStatusMT& rhs) {
    (void)rhs;
...
#endif // UCI_TYPE_STRIKECOMMANDSTATUSMT_H
