...
#ifndef UCI_TYPE_SIGNALREPORTMDT_H
#define UCI_TYPE_SIGNALREPORTMDT_H
...
public:
  ...
  /** This method constructs a new SignalReportMDT.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed SignalReportMDT.
    */
  static UCI_EXPORT SignalReportMDT& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new SignalReportMDT initializing the data accessed by the new SignalReportMDT using the data
    * accessed by the specified SignalReportMDT (cloning).
    *
    * @param accessor The SignalReportMDT that provides access to the data that is to be used to initialize the data
    *      accessed by the new created SignalReportMDT.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed SignalReportMDT.
    */
  static UCI_EXPORT SignalReportMDT& create(const SignalReportMDT& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified SignalReportMDT. Use of the specified accessor after it has been destroyed will
    * result in undefined behavior.
    *
    * @param accessor The SignalReportMDT that is to be destroyed.
    */
  static UCI_EXPORT void destroy(SignalReportMDT& accessor);
  ...
  /** Returns the version that was initialized from the uci:version attribute of SignalReportMDT.
    *
    * @return The version that was initialized from the uci:version attribute of SignalReportMDT.
    */
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const SignalReportMDT& accessor) = 0;
  ...
  /** Sets the complex content identified by SignalReportID to the contents of the complex content accessed by the
    ...
    */
  virtual uci::type::SignalReportMDT& setSignalReportID(const uci::type::SignalReportID_Type& value) = 0;
  ...
  /** Sets the complex content identified by SystemID to the contents of the complex content accessed by the specified
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::SignalReportMDT& setSystemID(const uci::type::SystemID_Type& value) = 0;
  ...
  /** Clears (disabled) the Element identified by SystemID.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::SignalReportMDT& clearSystemID() = 0;
  ...
  /** Sets the complex content identified by SubsystemID to the contents of the complex content accessed by the specified
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::SignalReportMDT& setSubsystemID(const uci::type::SubsystemID_Type& value) = 0;
  ...
  /** Clears (disabled) the Element identified by SubsystemID.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::SignalReportMDT& clearSubsystemID() = 0;

  /** Returns a const reference to the bounded list identified by Signal.
    *
    * @return A const reference to the bounded list identified by Signal.
    */
  virtual const uci::type::SignalReportMDT::Signal& getSignal() const = 0;

  /** Returns a reference to the bounded list identified by Signal.
    *
    * @return A reference to the bounded list identified by Signal.
    */
  virtual uci::type::SignalReportMDT::Signal& getSignal() = 0;

  /** Sets the bounded list identified by Signal.
    *
    * @param value The bounded list whose contents are to be used to set the value of the bounded list accessed by this
    *      accessor.
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::SignalReportMDT& setSignal(const uci::type::SignalReportMDT::Signal& value) = 0;
...
protected:
  ...
  /** The assignment operator. Sets the contents of this SignalReportMDT to the contents of the SignalReportMDT on the
    ...
    *      the contents of this SignalReportMDT.
    * @return A reference to this SignalReportMDT.
    */
  SignalReportMDT& operator=(const SignalReportMDT& rhs) {
    (void)rhs;
...
#endif // UCI_TYPE_SIGNALREPORTMDT_H
