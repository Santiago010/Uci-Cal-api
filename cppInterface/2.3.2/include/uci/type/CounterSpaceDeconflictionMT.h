/** @file CounterSpaceDeconflictionMT.h
 *
...
#ifndef UCI_TYPE_COUNTERSPACEDECONFLICTIONMT_H
#define UCI_TYPE_COUNTERSPACEDECONFLICTIONMT_H

#include "../base/Listener.h"
#include "../base/Reader.h"
#include "../base/Writer.h"
#include "../base/export.h"
#include "CounterSpaceDeconflictionMDT.h"
...
/** Message type for a CounterSpaceDeconfliction order. */
class CounterSpaceDeconflictionMT : public virtual MessageType {
public:

  /** This method constructs a new CounterSpaceDeconflictionMT.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed CounterSpaceDeconflictionMT.
    */
  static UCI_EXPORT CounterSpaceDeconflictionMT& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new CounterSpaceDeconflictionMT initializing the data accessed by the new
    * CounterSpaceDeconflictionMT using the data accessed by the specified CounterSpaceDeconflictionMT (cloning).
    *
    * @param accessor The CounterSpaceDeconflictionMT that provides access to the data that is to be used to initialize the
    *      data accessed by the new created CounterSpaceDeconflictionMT.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed CounterSpaceDeconflictionMT.
    */
  static UCI_EXPORT CounterSpaceDeconflictionMT& create(const CounterSpaceDeconflictionMT& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified CounterSpaceDeconflictionMT. Use of the specified accessor after it has been
    * destroyed will result in undefined behavior.
    *
    * @param accessor The CounterSpaceDeconflictionMT that is to be destroyed.
    */
  static UCI_EXPORT void destroy(CounterSpaceDeconflictionMT& accessor);

  /** Returns this accessor's type constant, i.e. counterSpaceDeconflictionMT.
    *
    * @return This accessor's type constant, i.e. counterSpaceDeconflictionMT.
    */
  virtual uci::base::accessorType::AccessorType getAccessorType() const noexception {
    return uci::type::accessorType::counterSpaceDeconflictionMT;
  }

  /** Returns the version that was initialized from the uci:version attribute of CounterSpaceDeconflictionMT.
    *
    * @return The version that was initialized from the uci:version attribute of CounterSpaceDeconflictionMT.
    */
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const CounterSpaceDeconflictionMT& accessor) = 0;
  ...
  /** Sets the value of the enumeration identified by ObjectState.
    ...
    */
  virtual uci::type::CounterSpaceDeconflictionMT& setObjectState(const uci::type::ObjectStateEnum& value) = 0;
  ...
  /** Sets the value of the enumeration identified by ObjectState.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::CounterSpaceDeconflictionMT& setObjectState(uci::type::ObjectStateEnum::EnumerationItem value) = 0;
  ...
  /** Clears (disabled) the Element identified by ObjectState.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::CounterSpaceDeconflictionMT& clearObjectState() = 0;
  ...
  /** Returns a const reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual const uci::type::CounterSpaceDeconflictionMDT& getMessageData() const = 0;
  ...
  /** Returns a reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual uci::type::CounterSpaceDeconflictionMDT& getMessageData() = 0;
  ...
  /** Sets the complex content identified by MessageData to the contents of the complex content accessed by the specified
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::CounterSpaceDeconflictionMT& setMessageData(const uci::type::CounterSpaceDeconflictionMDT& value) = 0;

  /** The Listener provides the support to listen and handle incoming messages of the type
    * uci::type::CounterSpaceDeconflictionMT.
    */
  ...
  public:
    ...
    /** The method is used to handle incoming messages.
      ...
      */
    virtual void handleMessage(const uci::type::CounterSpaceDeconflictionMT& message) = 0;
  ...
  public:
    ...
    /** Adds a listener to this reader to handle incoming messages.
      ...
      */
    virtual void addListener(uci::type::CounterSpaceDeconflictionMT::Listener& listener) = 0;

    /** Removes the specified listener from this reader.
      *
      * @param listener The listener that is to be removed from this reader.
      */
    virtual void removeListener(uci::type::CounterSpaceDeconflictionMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s). Returns immediately if no messages are available.
      ...
      */
    virtual unsigned long readNoWait(unsigned long maxNumberOfMessages, uci::type::CounterSpaceDeconflictionMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s).
      ...
      * @return The number of messages that were handled.
      */
    virtual unsigned long read(unsigned long timeout, unsigned long maxNumberOfMessages, uci::type::CounterSpaceDeconflictionMT::Listener& listener) = 0;
  ...
  /** This method creates a new reader that can be used to read a CounterSpaceDeconflictionMT.
    *
    * @param topic The specification of the topic the reader is to read from.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A reader that can read a CounterSpaceDeconflictionMT.
    */
  static UCI_EXPORT uci::type::CounterSpaceDeconflictionMT::Reader& createReader(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a reader. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyReader(uci::type::CounterSpaceDeconflictionMT::Reader& reader);
  ...
  public:
    ...
    /** Writes the OMS message to the topic specified when this Writer was created.
      ...
      */
    virtual void write(uci::type::CounterSpaceDeconflictionMT& accessor) = 0;
  ...
  /** This method creates a new writer that can be used to write a CounterSpaceDeconflictionMT.
    *
    * @param topic The specification of the topic the writer is to write to.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A writer that can write a CounterSpaceDeconflictionMT.
    */
  static UCI_EXPORT uci::type::CounterSpaceDeconflictionMT::Writer& createWriter(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a writer. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyWriter(uci::type::CounterSpaceDeconflictionMT::Writer& writer);
...
protected:
  ...
  /** The copy constructor [only available to derived classes].
    *
    * @param rhs The CounterSpaceDeconflictionMT to copy from.
    */
  CounterSpaceDeconflictionMT(const CounterSpaceDeconflictionMT& rhs) {
    (void)rhs;
  }

  /** The assignment operator. Sets the contents of this CounterSpaceDeconflictionMT to the contents of the
    * CounterSpaceDeconflictionMT on the right hand side (rhs) of the assignment operator [only available to derived
    * classes].
    *
    * @param rhs The CounterSpaceDeconflictionMT on the right hand side (rhs) of the assignment operator whose contents are
    *      used to set the contents of this CounterSpaceDeconflictionMT.
    * @return A reference to this CounterSpaceDeconflictionMT.
    */
  CounterSpaceDeconflictionMT& operator=(const CounterSpaceDeconflictionMT& rhs) {
    (void)rhs;
...
#endif // UCI_TYPE_COUNTERSPACEDECONFLICTIONMT_H
