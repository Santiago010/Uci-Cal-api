...
#ifndef UCI_TYPE_SOB_C2_RECORDMT_H
#define UCI_TYPE_SOB_C2_RECORDMT_H
...
/** Indicates the attributes of a C2 node associated with a satellite or satellites. An example of a C2 node would be a
  * ground station for the satellite or satellites.
  */
class SOB_C2_RecordMT : public virtual MessageType {
public:

  /** This method constructs a new SOB_C2_RecordMT.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed SOB_C2_RecordMT.
    */
  static UCI_EXPORT SOB_C2_RecordMT& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new SOB_C2_RecordMT initializing the data accessed by the new SOB_C2_RecordMT using the data
    * accessed by the specified SOB_C2_RecordMT (cloning).
    *
    * @param accessor The SOB_C2_RecordMT that provides access to the data that is to be used to initialize the data
    *      accessed by the new created SOB_C2_RecordMT.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed SOB_C2_RecordMT.
    */
  static UCI_EXPORT SOB_C2_RecordMT& create(const SOB_C2_RecordMT& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified SOB_C2_RecordMT. Use of the specified accessor after it has been destroyed will
    * result in undefined behavior.
    *
    * @param accessor The SOB_C2_RecordMT that is to be destroyed.
    */
  static UCI_EXPORT void destroy(SOB_C2_RecordMT& accessor);

  /** Returns this accessor's type constant, i.e. sOB_C2_RecordMT.
    *
    * @return This accessor's type constant, i.e. sOB_C2_RecordMT.
    */
  virtual uci::base::accessorType::AccessorType getAccessorType() const noexception {
    return uci::type::accessorType::sOB_C2_RecordMT;
  }

  /** Returns the version that was initialized from the uci:version attribute of SOB_C2_RecordMT.
    *
    * @return The version that was initialized from the uci:version attribute of SOB_C2_RecordMT.
    */
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const SOB_C2_RecordMT& accessor) = 0;
  ...
  /** Sets the value of the enumeration identified by ObjectState.
    ...
    */
  virtual uci::type::SOB_C2_RecordMT& setObjectState(const uci::type::ObjectStateEnum& value) = 0;
  ...
  /** Sets the value of the enumeration identified by ObjectState.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::SOB_C2_RecordMT& setObjectState(uci::type::ObjectStateEnum::EnumerationItem value) = 0;
  ...
  /** Clears (disabled) the Element identified by ObjectState.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::SOB_C2_RecordMT& clearObjectState() = 0;
  ...
  /** Returns a const reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual const uci::type::SOB_C2_RecordMDT& getMessageData() const = 0;
  ...
  /** Returns a reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual uci::type::SOB_C2_RecordMDT& getMessageData() = 0;
  ...
  /** Sets the complex content identified by MessageData to the contents of the complex content accessed by the specified
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::SOB_C2_RecordMT& setMessageData(const uci::type::SOB_C2_RecordMDT& value) = 0;

  /** The Listener provides the support to listen and handle incoming messages of the type uci::type::SOB_C2_RecordMT. */
  ...
  public:
    ...
    /** The method is used to handle incoming messages.
      ...
      */
    virtual void handleMessage(const uci::type::SOB_C2_RecordMT& message) = 0;
  ...
  public:
    ...
    /** Adds a listener to this reader to handle incoming messages.
      ...
      */
    virtual void addListener(uci::type::SOB_C2_RecordMT::Listener& listener) = 0;

    /** Removes the specified listener from this reader.
      *
      * @param listener The listener that is to be removed from this reader.
      */
    virtual void removeListener(uci::type::SOB_C2_RecordMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s). Returns immediately if no messages are available.
      ...
      */
    virtual unsigned long readNoWait(unsigned long maxNumberOfMessages, uci::type::SOB_C2_RecordMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s).
      ...
      * @return The number of messages that were handled.
      */
    virtual unsigned long read(unsigned long timeout, unsigned long maxNumberOfMessages, uci::type::SOB_C2_RecordMT::Listener& listener) = 0;
  ...
  /** This method creates a new reader that can be used to read a SOB_C2_RecordMT.
    *
    * @param topic The specification of the topic the reader is to read from.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A reader that can read a SOB_C2_RecordMT.
    */
  static UCI_EXPORT uci::type::SOB_C2_RecordMT::Reader& createReader(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a reader. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyReader(uci::type::SOB_C2_RecordMT::Reader& reader);
  ...
  public:
    ...
    /** Writes the OMS message to the topic specified when this Writer was created.
      ...
      */
    virtual void write(uci::type::SOB_C2_RecordMT& accessor) = 0;
  ...
  /** This method creates a new writer that can be used to write a SOB_C2_RecordMT.
    *
    * @param topic The specification of the topic the writer is to write to.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A writer that can write a SOB_C2_RecordMT.
    */
  static UCI_EXPORT uci::type::SOB_C2_RecordMT::Writer& createWriter(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a writer. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyWriter(uci::type::SOB_C2_RecordMT::Writer& writer);
...
protected:
  ...
  /** The copy constructor [only available to derived classes].
    *
    * @param rhs The SOB_C2_RecordMT to copy from.
    */
  SOB_C2_RecordMT(const SOB_C2_RecordMT& rhs) {
    (void)rhs;
  }

  /** The assignment operator. Sets the contents of this SOB_C2_RecordMT to the contents of the SOB_C2_RecordMT on the
    * right hand side (rhs) of the assignment operator [only available to derived classes].
    *
    * @param rhs The SOB_C2_RecordMT on the right hand side (rhs) of the assignment operator whose contents are used to set
    *      the contents of this SOB_C2_RecordMT.
    * @return A reference to this SOB_C2_RecordMT.
    */
  SOB_C2_RecordMT& operator=(const SOB_C2_RecordMT& rhs) {
    (void)rhs;
...
#endif // UCI_TYPE_SOB_C2_RECORDMT_H
