/** @file EntityManagementSetCapabilityType.h
 *
...
#ifndef UCI_TYPE_ENTITYMANAGEMENTSETCAPABILITYTYPE_H
#define UCI_TYPE_ENTITYMANAGEMENTSETCAPABILITYTYPE_H
...
public:
  ...
  /** This method constructs a new EntityManagementSetCapabilityType.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed EntityManagementSetCapabilityType.
    */
  static UCI_EXPORT EntityManagementSetCapabilityType& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new EntityManagementSetCapabilityType initializing the data accessed by the new
    * EntityManagementSetCapabilityType using the data accessed by the specified EntityManagementSetCapabilityType
    * (cloning).
    *
    * @param accessor The EntityManagementSetCapabilityType that provides access to the data that is to be used to
    *      initialize the data accessed by the new created EntityManagementSetCapabilityType.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed EntityManagementSetCapabilityType.
    */
  static UCI_EXPORT EntityManagementSetCapabilityType& create(const EntityManagementSetCapabilityType& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified EntityManagementSetCapabilityType. Use of the specified accessor after it has been
    * destroyed will result in undefined behavior.
    *
    * @param accessor The EntityManagementSetCapabilityType that is to be destroyed.
    */
  static UCI_EXPORT void destroy(EntityManagementSetCapabilityType& accessor);
  ...
  /** Returns the version that was initialized from the uci:version attribute of EntityManagementSetCapabilityType.
    *
    * @return The version that was initialized from the uci:version attribute of EntityManagementSetCapabilityType.
    */
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const EntityManagementSetCapabilityType& accessor) = 0;

  /** Specifies the new capabilities for the Entity. This list replaces the current capabilities for the Entity.
  ...
  /** Sets the complex content identified by EntityID to the contents of the complex content accessed by the specified
    ...
    */
  virtual uci::type::EntityManagementSetCapabilityType& setEntityID(const uci::type::EntityID_Type& value) = 0;
  ...
  /** Returns a const reference to the bounded list identified by CapabilityID.
    ...
    */
  virtual const uci::type::EntityManagementSetCapabilityType::CapabilityID& getCapabilityID() const = 0;
  ...
  /** Returns a reference to the bounded list identified by CapabilityID.
    ...
    */
  virtual uci::type::EntityManagementSetCapabilityType::CapabilityID& getCapabilityID() = 0;
  ...
  /** Sets the bounded list identified by CapabilityID.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::EntityManagementSetCapabilityType& setCapabilityID(const uci::type::EntityManagementSetCapabilityType::CapabilityID& value) = 0;
...
protected:
  ...
  /** The assignment operator. Sets the contents of this EntityManagementSetCapabilityType to the contents of the
    * EntityManagementSetCapabilityType on the right hand side (rhs) of the assignment operator [only available to derived
    * classes].
    *
    * @param rhs The EntityManagementSetCapabilityType on the right hand side (rhs) of the assignment operator whose
    *      contents are used to set the contents of this EntityManagementSetCapabilityType.
    * @return A reference to this EntityManagementSetCapabilityType.
    */
  EntityManagementSetCapabilityType& operator=(const EntityManagementSetCapabilityType& rhs) {
    (void)rhs;
...
#endif // UCI_TYPE_ENTITYMANAGEMENTSETCAPABILITYTYPE_H
