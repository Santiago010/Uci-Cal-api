...
public:
  ...
  /** This method constructs a new PlannedReleaseConditionsType.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed PlannedReleaseConditionsType.
    */
  static UCI_EXPORT PlannedReleaseConditionsType& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new PlannedReleaseConditionsType initializing the data accessed by the new
    * PlannedReleaseConditionsType using the data accessed by the specified PlannedReleaseConditionsType (cloning).
    *
    * @param accessor The PlannedReleaseConditionsType that provides access to the data that is to be used to initialize
    *      the data accessed by the new created PlannedReleaseConditionsType.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed PlannedReleaseConditionsType.
    */
  static UCI_EXPORT PlannedReleaseConditionsType& create(const PlannedReleaseConditionsType& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified PlannedReleaseConditionsType. Use of the specified accessor after it has been
    * destroyed will result in undefined behavior.
    *
    * @param accessor The PlannedReleaseConditionsType that is to be destroyed.
    */
  static UCI_EXPORT void destroy(PlannedReleaseConditionsType& accessor);
  ...
  /** Returns the version that was initialized from the uci:version attribute of PlannedReleaseConditionsType.
    *
    * @return The version that was initialized from the uci:version attribute of PlannedReleaseConditionsType.
    */
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const PlannedReleaseConditionsType& accessor) = 0;
  ...
  /** Returns a const reference to the accessor that provides access to the complex content identified by Position.
    ...
    */
  virtual const uci::type::Point3D_Type& getPosition() const = 0;
  ...
  /** Returns a reference to the accessor that provides access to the complex content identified by Position.
    ...
    */
  virtual uci::type::Point3D_Type& getPosition() = 0;
  ...
  /** Sets the complex content identified by Position to the contents of the complex content accessed by the specified
    ...
    */
  virtual uci::type::PlannedReleaseConditionsType& setPosition(const uci::type::Point3D_Type& value) = 0;
  ...
  /** Enables the Element identified by Position.
    ...
    * @return A reference to the accessor that provides access to the complex content identified by Position.
    */
  virtual uci::type::Point3D_Type& enablePosition(uci::base::accessorType::AccessorType type = uci::base::accessorType::null) = 0;
  ...
  /** Sets the complex content identified by Velocity to the contents of the complex content accessed by the specified
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::PlannedReleaseConditionsType& setVelocity(const uci::type::Velocity2D_Type& value) = 0;
  ...
  /** Sets the complex content identified by Orientation to the contents of the complex content accessed by the specified
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::PlannedReleaseConditionsType& setOrientation(const uci::type::OrientationType& value) = 0;
  ...
  /** Clears (disabled) the Element identified by Orientation.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::PlannedReleaseConditionsType& clearOrientation() = 0;
  ...
  /** Sets the complex content identified by WindVelocity to the contents of the complex content accessed by the specified
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::PlannedReleaseConditionsType& setWindVelocity(const uci::type::Velocity2D_Type& value) = 0;

  /** Returns whether the Element identified by WindVelocity exists (is enabled) or not.
    *
    * @return A boolean indicating whether the Element identified by WindVelocity is enabled or not.
    */
  virtual bool hasWindVelocity() const = 0;

  /** Enables the Element identified by WindVelocity.
    *
    * @param type = uci::base::accessorType::null This Accessor's accessor type.
    * @return A reference to the accessor that provides access to the complex content identified by WindVelocity.
    */
  virtual uci::type::Velocity2D_Type& enableWindVelocity(uci::base::accessorType::AccessorType type = uci::base::accessorType::null) = 0;

  /** Clears (disabled) the Element identified by WindVelocity.
    *
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::PlannedReleaseConditionsType& clearWindVelocity() = 0;
  ...
  /** Returns a const reference to the accessor that provides access to the complex content identified by
    ...
    *      AssociatedRoutePlan.
    */
  virtual const uci::type::RoutePlanReferenceType& getAssociatedRoutePlan() const = 0;
  ...
  /** Returns a reference to the accessor that provides access to the complex content identified by AssociatedRoutePlan.
    ...
    */
  virtual uci::type::RoutePlanReferenceType& getAssociatedRoutePlan() = 0;
  ...
  /** Sets the complex content identified by AssociatedRoutePlan to the contents of the complex content accessed by the
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::PlannedReleaseConditionsType& setAssociatedRoutePlan(const uci::type::RoutePlanReferenceType& value) = 0;
  ...
  /** Enables the Element identified by AssociatedRoutePlan.
    ...
    * @return A reference to the accessor that provides access to the complex content identified by AssociatedRoutePlan.
    */
  virtual uci::type::RoutePlanReferenceType& enableAssociatedRoutePlan(uci::base::accessorType::AccessorType type = uci::base::accessorType::null) = 0;

  /** Clears (disabled) the Element identified by AssociatedRoutePlan.
    *
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::PlannedReleaseConditionsType& clearAssociatedRoutePlan() = 0;
...
protected:
  ...
  /** The assignment operator. Sets the contents of this PlannedReleaseConditionsType to the contents of the
    * PlannedReleaseConditionsType on the right hand side (rhs) of the assignment operator [only available to derived
    * classes].
    *
    * @param rhs The PlannedReleaseConditionsType on the right hand side (rhs) of the assignment operator whose contents
    *      are used to set the contents of this PlannedReleaseConditionsType.
    * @return A reference to this PlannedReleaseConditionsType.
    */
  PlannedReleaseConditionsType& operator=(const PlannedReleaseConditionsType& rhs) {
    (void)rhs;
...
#endif // UCI_TYPE_PLANNEDRELEASECONDITIONSTYPE_H
