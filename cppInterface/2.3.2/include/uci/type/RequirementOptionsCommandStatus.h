/** @file RequirementOptionsCommandStatus.h
 *
...
typedef uci::type::RequirementOptionsCommandStatusMT RequirementOptionsCommandStatus;

} // namespace type
} // namespace uci

#endif // UCI_TYPE_REQUIREMENTOPTIONSCOMMANDSTATUS_H
