...
class TaskPlanValidationMDT : public virtual uci::base::Accessor {
public:

  /** This method constructs a new TaskPlanValidationMDT.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed TaskPlanValidationMDT.
    */
  static UCI_EXPORT TaskPlanValidationMDT& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new TaskPlanValidationMDT initializing the data accessed by the new TaskPlanValidationMDT
    * using the data accessed by the specified TaskPlanValidationMDT (cloning).
    *
    * @param accessor The TaskPlanValidationMDT that provides access to the data that is to be used to initialize the data
    *      accessed by the new created TaskPlanValidationMDT.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed TaskPlanValidationMDT.
    */
  static UCI_EXPORT TaskPlanValidationMDT& create(const TaskPlanValidationMDT& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified TaskPlanValidationMDT. Use of the specified accessor after it has been destroyed
    * will result in undefined behavior.
    *
    * @param accessor The TaskPlanValidationMDT that is to be destroyed.
    */
  static UCI_EXPORT void destroy(TaskPlanValidationMDT& accessor);

  /** Returns this accessor's type constant, i.e. taskPlanValidationMDT.
    *
    * @return This accessor's type constant, i.e. taskPlanValidationMDT.
    */
  virtual uci::base::accessorType::AccessorType getAccessorType() const noexception {
    return uci::type::accessorType::taskPlanValidationMDT;
  }

  /** Returns the version that was initialized from the uci:version attribute of TaskPlanValidationMDT.
    *
    * @return The version that was initialized from the uci:version attribute of TaskPlanValidationMDT.
    */
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const TaskPlanValidationMDT& accessor) = 0;
  ...
  /** Indicates allocation results per Task. This element is only expected when the TaskPlan was found to be invalid and
    ...
    * Maximum: MAX_LENGTH]
    */
  typedef uci::base::BoundedList<uci::type::TaskPlanningResultType, uci::type::accessorType::taskPlanningResultType> AllocationResult;
  ...
  /** Indicates a modified, valid version of the evaluated TaskPlan. This element should only be given when the evaluated
    ...
    */
  typedef uci::base::BoundedList<uci::type::TaskPlanID_Type, uci::type::accessorType::taskPlanID_Type> ModifiedPlanID;

  /** Returns a const reference to the accessor that provides access to the complex content identified by
    * TaskPlanValidationID.
    *
    * @return A const reference to the accessor that provides access to the complex content identified by
    *      TaskPlanValidationID.
    */
  virtual const uci::type::TaskPlanValidationID_Type& getTaskPlanValidationID() const = 0;

  /** Returns a reference to the accessor that provides access to the complex content identified by TaskPlanValidationID.
    *
    * @return A reference to the accessor that provides access to the complex content identified by TaskPlanValidationID.
    */
  virtual uci::type::TaskPlanValidationID_Type& getTaskPlanValidationID() = 0;

  /** Sets the complex content identified by TaskPlanValidationID to the contents of the complex content accessed by the
    * specified accessor.
    *
    * @param value The accessor that provides access to the complex content whose contents are to be used to set the
    *      contents of the complex content identified by TaskPlanValidationID.
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::TaskPlanValidationMDT& setTaskPlanValidationID(const uci::type::TaskPlanValidationID_Type& value) = 0;
  ...
  /** Sets the complex content identified by PlanID to the contents of the complex content accessed by the specified
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::TaskPlanValidationMDT& setPlanID(const uci::type::TaskPlanID_Type& value) = 0;
  ...
  /** Sets the complex content identified by Validator to the contents of the complex content accessed by the specified
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::TaskPlanValidationMDT& setValidator(const uci::type::ValidatorType& value) = 0;
  ...
  /** Sets the value of the enumeration identified by ValidationState.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::TaskPlanValidationMDT& setValidationState(const uci::type::PlanValidationStateEnum& value) = 0;
  ...
  /** Sets the value of the enumeration identified by ValidationState.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::TaskPlanValidationMDT& setValidationState(uci::type::PlanValidationStateEnum::EnumerationItem value) = 0;
  ...
  /** Sets the complex content identified by CompletionStatus to the contents of the complex content accessed by the
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::TaskPlanValidationMDT& setCompletionStatus(const uci::type::CompletionStatusType& value) = 0;
  ...
  /** Clears (disabled) the Element identified by CompletionStatus.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::TaskPlanValidationMDT& clearCompletionStatus() = 0;
  ...
  /** Returns a const reference to the bounded list identified by IncompleteItem.
    ...
    */
  virtual const uci::type::TaskPlanValidationMDT::IncompleteItem& getIncompleteItem() const = 0;
  ...
  /** Returns a reference to the bounded list identified by IncompleteItem.
    ...
    */
  virtual uci::type::TaskPlanValidationMDT::IncompleteItem& getIncompleteItem() = 0;
  ...
  /** Sets the bounded list identified by IncompleteItem.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::TaskPlanValidationMDT& setIncompleteItem(const uci::type::TaskPlanValidationMDT::IncompleteItem& value) = 0;
  ...
  /** Returns a const reference to the bounded list identified by InvalidAllocation.
    ...
    */
  virtual const uci::type::TaskPlanValidationMDT::InvalidAllocation& getInvalidAllocation() const = 0;
  ...
  /** Returns a reference to the bounded list identified by InvalidAllocation.
    ...
    */
  virtual uci::type::TaskPlanValidationMDT::InvalidAllocation& getInvalidAllocation() = 0;
  ...
  /** Sets the bounded list identified by InvalidAllocation.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::TaskPlanValidationMDT& setInvalidAllocation(const uci::type::TaskPlanValidationMDT::InvalidAllocation& value) = 0;
  ...
  /** Returns a const reference to the bounded list identified by AllocationResult.
    ...
    */
  virtual const uci::type::TaskPlanValidationMDT::AllocationResult& getAllocationResult() const = 0;
  ...
  /** Returns a reference to the bounded list identified by AllocationResult.
    ...
    */
  virtual uci::type::TaskPlanValidationMDT::AllocationResult& getAllocationResult() = 0;
  ...
  /** Sets the bounded list identified by AllocationResult.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::TaskPlanValidationMDT& setAllocationResult(const uci::type::TaskPlanValidationMDT::AllocationResult& value) = 0;
  ...
  /** Returns a const reference to the bounded list identified by ModifiedPlanID.
    ...
    */
  virtual const uci::type::TaskPlanValidationMDT::ModifiedPlanID& getModifiedPlanID() const = 0;
  ...
  /** Returns a reference to the bounded list identified by ModifiedPlanID.
    ...
    */
  virtual uci::type::TaskPlanValidationMDT::ModifiedPlanID& getModifiedPlanID() = 0;
  ...
  /** Sets the bounded list identified by ModifiedPlanID.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::TaskPlanValidationMDT& setModifiedPlanID(const uci::type::TaskPlanValidationMDT::ModifiedPlanID& value) = 0;
...
protected:
  ...
  /** The copy constructor [only available to derived classes].
    ...
    */
  TaskPlanValidationMDT(const TaskPlanValidationMDT& rhs) {
    (void)rhs;
  }

  /** The assignment operator. Sets the contents of this TaskPlanValidationMDT to the contents of the TaskPlanValidationMDT
    * on the right hand side (rhs) of the assignment operator [only available to derived classes].
    *
    * @param rhs The TaskPlanValidationMDT on the right hand side (rhs) of the assignment operator whose contents are used
    *      to set the contents of this TaskPlanValidationMDT.
    * @return A reference to this TaskPlanValidationMDT.
    */
  TaskPlanValidationMDT& operator=(const TaskPlanValidationMDT& rhs) {
    (void)rhs;
...
#endif // UCI_TYPE_TASKPLANVALIDATIONMDT_H
