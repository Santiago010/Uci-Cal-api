...
class ComparableAtomicValueType : public virtual uci::base::Accessor {
public:

  /** This method constructs a new ComparableAtomicValueType.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed ComparableAtomicValueType.
    */
  static UCI_EXPORT ComparableAtomicValueType& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new ComparableAtomicValueType initializing the data accessed by the new
    * ComparableAtomicValueType using the data accessed by the specified ComparableAtomicValueType (cloning).
    *
    * @param accessor The ComparableAtomicValueType that provides access to the data that is to be used to initialize the
    *      data accessed by the new created ComparableAtomicValueType.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed ComparableAtomicValueType.
    */
  static UCI_EXPORT ComparableAtomicValueType& create(const ComparableAtomicValueType& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified ComparableAtomicValueType. Use of the specified accessor after it has been
    * destroyed will result in undefined behavior.
    *
    * @param accessor The ComparableAtomicValueType that is to be destroyed.
    */
  static UCI_EXPORT void destroy(ComparableAtomicValueType& accessor);

  /** Returns this accessor's type constant, i.e. comparableAtomicValueType.
    *
    * @return This accessor's type constant, i.e. comparableAtomicValueType.
    */
  virtual uci::base::accessorType::AccessorType getAccessorType() const noexception {
    return uci::type::accessorType::comparableAtomicValueType;
  }

  /** Returns the version that was initialized from the uci:version attribute of ComparableAtomicValueType.
    *
    * @return The version that was initialized from the uci:version attribute of ComparableAtomicValueType.
    */
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const ComparableAtomicValueType& accessor) = 0;

  /** The following enumeration is used to identify which element of this Choice has been chosen. */
  enum ComparableAtomicValueTypeChoice {
    COMPARABLEATOMICVALUETYPE_CHOICE_NONE,
    COMPARABLEATOMICVALUETYPE_CHOICE_BYTEVALUE,
    COMPARABLEATOMICVALUETYPE_CHOICE_UNSIGNEDBYTEVALUE,
    COMPARABLEATOMICVALUETYPE_CHOICE_SHORTVALUE,
    COMPARABLEATOMICVALUETYPE_CHOICE_UNSIGNEDSHORTVALUE,
    COMPARABLEATOMICVALUETYPE_CHOICE_INTVALUE,
    COMPARABLEATOMICVALUETYPE_CHOICE_UNSIGNEDINTVALUE,
    COMPARABLEATOMICVALUETYPE_CHOICE_LONGVALUE,
    COMPARABLEATOMICVALUETYPE_CHOICE_FLOATVALUE,
    COMPARABLEATOMICVALUETYPE_CHOICE_DOUBLEVALUE,
    COMPARABLEATOMICVALUETYPE_CHOICE_DATETIMEVALUE,
    COMPARABLEATOMICVALUETYPE_CHOICE_DURATIONVALUE,
    COMPARABLEATOMICVALUETYPE_CHOICE_TIMEVALUE,
    COMPARABLEATOMICVALUETYPE_CHOICE_STRINGVALUE
  };
  ...
  /** This method returns this choice's "selection ordinal." A choice's "selection ordinal" is used to specify which
    ...
    */
  virtual ComparableAtomicValueTypeChoice getComparableAtomicValueTypeChoiceOrdinal() const = 0;
  ...
  /** This method is used to set this choice's "selection ordinal." A choice's "selection ordinal" is used to specify which
    ...
    */
  virtual uci::type::ComparableAtomicValueType& setComparableAtomicValueTypeChoiceOrdinal(ComparableAtomicValueTypeChoice chosenElementOrdinal, uci::base::accessorType::AccessorType type = uci::base::accessorType::null) = 0;
  ...
  /** Sets the value of the SimplePrimitive data type identified by ByteValue.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::ComparableAtomicValueType& setByteValue(xs::Byte value) = 0;
  ...
  /** Sets the value of the SimplePrimitive data type identified by UnsignedByteValue.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::ComparableAtomicValueType& setUnsignedByteValue(xs::UnsignedByte value) = 0;
  ...
  /** Sets the value of the SimplePrimitive data type identified by ShortValue.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::ComparableAtomicValueType& setShortValue(xs::Short value) = 0;
  ...
  /** Sets the value of the SimplePrimitive data type identified by UnsignedShortValue.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::ComparableAtomicValueType& setUnsignedShortValue(xs::UnsignedShort value) = 0;
  ...
  /** Sets the value of the SimplePrimitive data type identified by IntValue.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::ComparableAtomicValueType& setIntValue(xs::Int value) = 0;
  ...
  /** Sets the value of the SimplePrimitive data type identified by UnsignedIntValue.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::ComparableAtomicValueType& setUnsignedIntValue(xs::UnsignedInt value) = 0;
  ...
  /** Sets the value of the SimplePrimitive data type identified by LongValue.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::ComparableAtomicValueType& setLongValue(xs::Long value) = 0;
  ...
  /** Sets the value of the SimplePrimitive data type identified by FloatValue.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::ComparableAtomicValueType& setFloatValue(xs::Float value) = 0;
  ...
  /** Sets the value of the SimplePrimitive data type identified by DoubleValue.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::ComparableAtomicValueType& setDoubleValue(xs::Double value) = 0;
  ...
  /** Sets the value of the SimplePrimitive data type identified by DateTimeValue.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::ComparableAtomicValueType& setDateTimeValue(uci::type::DateTimeTypeValue value) = 0;
  ...
  /** Sets the value of the SimplePrimitive data type identified by DurationValue.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::ComparableAtomicValueType& setDurationValue(uci::type::DurationTypeValue value) = 0;
  ...
  /** Sets the value of the SimplePrimitive data type identified by TimeValue.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::ComparableAtomicValueType& setTimeValue(uci::type::TimeTypeValue value) = 0;
  ...
  /** Returns a const reference to the accessor that provides access to the string identified by StringValue.
    ...
    */
  virtual const uci::type::QueryString4096Type& getStringValue() const = 0;
  ...
  /** Returns a reference to the accessor that provides access to the string identified by StringValue.
    ...
    */
  virtual uci::type::QueryString4096Type& getStringValue() = 0;
  ...
  /** Sets the string identified by StringValue to the contents of the string accessed by the specified accessor.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::ComparableAtomicValueType& setStringValue(const uci::type::QueryString4096Type& value) = 0;
  ...
  /** Sets the string identified by StringValue to the contents of the string that is accessed by the specified accessor.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::ComparableAtomicValueType& setStringValue(const std::string& value) = 0;
  ...
  /** Sets the string identified by StringValue to the contents of the string that is accessed by the specified accessor.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::ComparableAtomicValueType& setStringValue(const char* value) = 0;
  ...
  /** Sets this choice's "selection ordinal" to the choice identified by StringValue.
    ...
    * @return A reference to the accessor that provides access to the string identified by StringValue.
    */
  virtual uci::type::QueryString4096Type& chooseStringValue(uci::base::accessorType::AccessorType type = uci::base::accessorType::null) = 0;
...
protected:
  ...
  /** The copy constructor [only available to derived classes].
    ...
    */
  ComparableAtomicValueType(const ComparableAtomicValueType& rhs) {
    (void)rhs;
  }

  /** The assignment operator. Sets the contents of this ComparableAtomicValueType to the contents of the
    * ComparableAtomicValueType on the right hand side (rhs) of the assignment operator [only available to derived
    * classes].
    *
    * @param rhs The ComparableAtomicValueType on the right hand side (rhs) of the assignment operator whose contents are
    *      used to set the contents of this ComparableAtomicValueType.
    * @return A reference to this ComparableAtomicValueType.
    */
  ComparableAtomicValueType& operator=(const ComparableAtomicValueType& rhs) {
    (void)rhs;
...
#endif // UCI_TYPE_COMPARABLEATOMICVALUETYPE_H
