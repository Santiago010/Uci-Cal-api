/** @file CounterSpaceCapabilityStatus.h
 *
...
typedef uci::type::CounterSpaceCapabilityStatusMT CounterSpaceCapabilityStatus;

} // namespace type
} // namespace uci

#endif // UCI_TYPE_COUNTERSPACECAPABILITYSTATUS_H
