/** @file SatelliteCharacteristicsMT.h
 *
...
#ifndef UCI_TYPE_SATELLITECHARACTERISTICSMT_H
#define UCI_TYPE_SATELLITECHARACTERISTICSMT_H
...
#include "SatelliteCharacteristicsMDT.h"
...
class SatelliteCharacteristicsMT : public virtual MessageType {
public:

  /** This method constructs a new SatelliteCharacteristicsMT.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed SatelliteCharacteristicsMT.
    */
  static UCI_EXPORT SatelliteCharacteristicsMT& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new SatelliteCharacteristicsMT initializing the data accessed by the new
    * SatelliteCharacteristicsMT using the data accessed by the specified SatelliteCharacteristicsMT (cloning).
    *
    * @param accessor The SatelliteCharacteristicsMT that provides access to the data that is to be used to initialize the
    *      data accessed by the new created SatelliteCharacteristicsMT.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed SatelliteCharacteristicsMT.
    */
  static UCI_EXPORT SatelliteCharacteristicsMT& create(const SatelliteCharacteristicsMT& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified SatelliteCharacteristicsMT. Use of the specified accessor after it has been
    * destroyed will result in undefined behavior.
    *
    * @param accessor The SatelliteCharacteristicsMT that is to be destroyed.
    */
  static UCI_EXPORT void destroy(SatelliteCharacteristicsMT& accessor);

  /** Returns this accessor's type constant, i.e. satelliteCharacteristicsMT.
    *
    * @return This accessor's type constant, i.e. satelliteCharacteristicsMT.
    */
  virtual uci::base::accessorType::AccessorType getAccessorType() const noexception {
    return uci::type::accessorType::satelliteCharacteristicsMT;
  }

  /** Returns the version that was initialized from the uci:version attribute of SatelliteCharacteristicsMT.
    *
    * @return The version that was initialized from the uci:version attribute of SatelliteCharacteristicsMT.
    */
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const SatelliteCharacteristicsMT& accessor) = 0;
  ...
  /** Sets the value of the enumeration identified by ObjectState.
    ...
    */
  virtual uci::type::SatelliteCharacteristicsMT& setObjectState(const uci::type::ObjectStateEnum& value) = 0;
  ...
  /** Sets the value of the enumeration identified by ObjectState.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::SatelliteCharacteristicsMT& setObjectState(uci::type::ObjectStateEnum::EnumerationItem value) = 0;
  ...
  /** Clears (disabled) the Element identified by ObjectState.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::SatelliteCharacteristicsMT& clearObjectState() = 0;
  ...
  /** Returns a const reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual const uci::type::SatelliteCharacteristicsMDT& getMessageData() const = 0;
  ...
  /** Returns a reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual uci::type::SatelliteCharacteristicsMDT& getMessageData() = 0;
  ...
  /** Sets the complex content identified by MessageData to the contents of the complex content accessed by the specified
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::SatelliteCharacteristicsMT& setMessageData(const uci::type::SatelliteCharacteristicsMDT& value) = 0;

  /** The Listener provides the support to listen and handle incoming messages of the type
    * uci::type::SatelliteCharacteristicsMT.
    */
  ...
  public:
    ...
    /** The method is used to handle incoming messages.
      ...
      */
    virtual void handleMessage(const uci::type::SatelliteCharacteristicsMT& message) = 0;
  ...
  public:
    ...
    /** Adds a listener to this reader to handle incoming messages.
      ...
      */
    virtual void addListener(uci::type::SatelliteCharacteristicsMT::Listener& listener) = 0;

    /** Removes the specified listener from this reader.
      *
      * @param listener The listener that is to be removed from this reader.
      */
    virtual void removeListener(uci::type::SatelliteCharacteristicsMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s). Returns immediately if no messages are available.
      ...
      */
    virtual unsigned long readNoWait(unsigned long maxNumberOfMessages, uci::type::SatelliteCharacteristicsMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s).
      ...
      * @return The number of messages that were handled.
      */
    virtual unsigned long read(unsigned long timeout, unsigned long maxNumberOfMessages, uci::type::SatelliteCharacteristicsMT::Listener& listener) = 0;
  ...
  /** This method creates a new reader that can be used to read a SatelliteCharacteristicsMT.
    *
    * @param topic The specification of the topic the reader is to read from.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A reader that can read a SatelliteCharacteristicsMT.
    */
  static UCI_EXPORT uci::type::SatelliteCharacteristicsMT::Reader& createReader(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a reader. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyReader(uci::type::SatelliteCharacteristicsMT::Reader& reader);
  ...
  public:
    ...
    /** Writes the OMS message to the topic specified when this Writer was created.
      ...
      */
    virtual void write(uci::type::SatelliteCharacteristicsMT& accessor) = 0;
  ...
  /** This method creates a new writer that can be used to write a SatelliteCharacteristicsMT.
    *
    * @param topic The specification of the topic the writer is to write to.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A writer that can write a SatelliteCharacteristicsMT.
    */
  static UCI_EXPORT uci::type::SatelliteCharacteristicsMT::Writer& createWriter(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a writer. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyWriter(uci::type::SatelliteCharacteristicsMT::Writer& writer);

protected:

  /** The constructor [only available to derived classes]. */
  SatelliteCharacteristicsMT() {
  }
  ...
  /** The copy constructor [only available to derived classes].
    *
    * @param rhs The SatelliteCharacteristicsMT to copy from.
    */
  SatelliteCharacteristicsMT(const SatelliteCharacteristicsMT& rhs) {
    (void)rhs;
  }

  /** The assignment operator. Sets the contents of this SatelliteCharacteristicsMT to the contents of the
    * SatelliteCharacteristicsMT on the right hand side (rhs) of the assignment operator [only available to derived
    * classes].
    *
    * @param rhs The SatelliteCharacteristicsMT on the right hand side (rhs) of the assignment operator whose contents are
    *      used to set the contents of this SatelliteCharacteristicsMT.
    * @return A reference to this SatelliteCharacteristicsMT.
    */
  SatelliteCharacteristicsMT& operator=(const SatelliteCharacteristicsMT& rhs) {
    (void)rhs;
...
#endif // UCI_TYPE_SATELLITECHARACTERISTICSMT_H
