/** @file OperatorLocationOfInterestMT.h
 *
...
#ifndef UCI_TYPE_OPERATORLOCATIONOFINTERESTMT_H
#define UCI_TYPE_OPERATORLOCATIONOFINTERESTMT_H
...
#include "OperatorLocationOfInterestMDT.h"
...
class OperatorLocationOfInterestMT : public virtual MessageType {
public:

  /** This method constructs a new OperatorLocationOfInterestMT.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed OperatorLocationOfInterestMT.
    */
  static UCI_EXPORT OperatorLocationOfInterestMT& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new OperatorLocationOfInterestMT initializing the data accessed by the new
    * OperatorLocationOfInterestMT using the data accessed by the specified OperatorLocationOfInterestMT (cloning).
    *
    * @param accessor The OperatorLocationOfInterestMT that provides access to the data that is to be used to initialize
    *      the data accessed by the new created OperatorLocationOfInterestMT.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed OperatorLocationOfInterestMT.
    */
  static UCI_EXPORT OperatorLocationOfInterestMT& create(const OperatorLocationOfInterestMT& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified OperatorLocationOfInterestMT. Use of the specified accessor after it has been
    * destroyed will result in undefined behavior.
    *
    * @param accessor The OperatorLocationOfInterestMT that is to be destroyed.
    */
  static UCI_EXPORT void destroy(OperatorLocationOfInterestMT& accessor);
  ...
  /** Returns the version that was initialized from the uci:version attribute of OperatorLocationOfInterestMT.
    *
    * @return The version that was initialized from the uci:version attribute of OperatorLocationOfInterestMT.
    */
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const OperatorLocationOfInterestMT& accessor) = 0;
  ...
  /** Sets the value of the enumeration identified by ObjectState.
    ...
    */
  virtual uci::type::OperatorLocationOfInterestMT& setObjectState(const uci::type::ObjectStateEnum& value) = 0;
  ...
  /** Sets the value of the enumeration identified by ObjectState.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::OperatorLocationOfInterestMT& setObjectState(uci::type::ObjectStateEnum::EnumerationItem value) = 0;
  ...
  /** Clears (disabled) the Element identified by ObjectState.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::OperatorLocationOfInterestMT& clearObjectState() = 0;
  ...
  /** Returns a const reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual const uci::type::OperatorLocationOfInterestMDT& getMessageData() const = 0;
  ...
  /** Returns a reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual uci::type::OperatorLocationOfInterestMDT& getMessageData() = 0;
  ...
  /** Sets the complex content identified by MessageData to the contents of the complex content accessed by the specified
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::OperatorLocationOfInterestMT& setMessageData(const uci::type::OperatorLocationOfInterestMDT& value) = 0;

  /** The Listener provides the support to listen and handle incoming messages of the type
    * uci::type::OperatorLocationOfInterestMT.
    */
  ...
  public:
    ...
    /** The method is used to handle incoming messages.
      ...
      */
    virtual void handleMessage(const uci::type::OperatorLocationOfInterestMT& message) = 0;
  ...
  public:
    ...
    /** Adds a listener to this reader to handle incoming messages.
      ...
      */
    virtual void addListener(uci::type::OperatorLocationOfInterestMT::Listener& listener) = 0;

    /** Removes the specified listener from this reader.
      *
      * @param listener The listener that is to be removed from this reader.
      */
    virtual void removeListener(uci::type::OperatorLocationOfInterestMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s). Returns immediately if no messages are available.
      ...
      */
    virtual unsigned long readNoWait(unsigned long maxNumberOfMessages, uci::type::OperatorLocationOfInterestMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s).
      ...
      * @return The number of messages that were handled.
      */
    virtual unsigned long read(unsigned long timeout, unsigned long maxNumberOfMessages, uci::type::OperatorLocationOfInterestMT::Listener& listener) = 0;
  ...
  /** This method creates a new reader that can be used to read a OperatorLocationOfInterestMT.
    *
    * @param topic The specification of the topic the reader is to read from.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A reader that can read a OperatorLocationOfInterestMT.
    */
  static UCI_EXPORT uci::type::OperatorLocationOfInterestMT::Reader& createReader(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a reader. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyReader(uci::type::OperatorLocationOfInterestMT::Reader& reader);
  ...
  public:
    ...
    /** Writes the OMS message to the topic specified when this Writer was created.
      ...
      */
    virtual void write(uci::type::OperatorLocationOfInterestMT& accessor) = 0;
  ...
  /** This method creates a new writer that can be used to write a OperatorLocationOfInterestMT.
    *
    * @param topic The specification of the topic the writer is to write to.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A writer that can write a OperatorLocationOfInterestMT.
    */
  static UCI_EXPORT uci::type::OperatorLocationOfInterestMT::Writer& createWriter(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a writer. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyWriter(uci::type::OperatorLocationOfInterestMT::Writer& writer);
...
protected:
  ...
  /** The assignment operator. Sets the contents of this OperatorLocationOfInterestMT to the contents of the
    * OperatorLocationOfInterestMT on the right hand side (rhs) of the assignment operator [only available to derived
    * classes].
    *
    * @param rhs The OperatorLocationOfInterestMT on the right hand side (rhs) of the assignment operator whose contents
    *      are used to set the contents of this OperatorLocationOfInterestMT.
    * @return A reference to this OperatorLocationOfInterestMT.
    */
  OperatorLocationOfInterestMT& operator=(const OperatorLocationOfInterestMT& rhs) {
    (void)rhs;
...
#endif // UCI_TYPE_OPERATORLOCATIONOFINTERESTMT_H
