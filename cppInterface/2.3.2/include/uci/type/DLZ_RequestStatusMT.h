...
#ifndef UCI_TYPE_DLZ_REQUESTSTATUSMT_H
#define UCI_TYPE_DLZ_REQUESTSTATUSMT_H

#include "../base/Listener.h"
#include "../base/Reader.h"
#include "../base/Writer.h"
#include "../base/export.h"
#include "DLZ_RequestStatusMDT.h"
...
class DLZ_RequestStatusMT : public virtual MessageType {
public:

  /** This method constructs a new DLZ_RequestStatusMT.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed DLZ_RequestStatusMT.
    */
  static UCI_EXPORT DLZ_RequestStatusMT& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new DLZ_RequestStatusMT initializing the data accessed by the new DLZ_RequestStatusMT using
    * the data accessed by the specified DLZ_RequestStatusMT (cloning).
    *
    * @param accessor The DLZ_RequestStatusMT that provides access to the data that is to be used to initialize the data
    *      accessed by the new created DLZ_RequestStatusMT.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed DLZ_RequestStatusMT.
    */
  static UCI_EXPORT DLZ_RequestStatusMT& create(const DLZ_RequestStatusMT& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified DLZ_RequestStatusMT. Use of the specified accessor after it has been destroyed
    * will result in undefined behavior.
    *
    * @param accessor The DLZ_RequestStatusMT that is to be destroyed.
    */
  static UCI_EXPORT void destroy(DLZ_RequestStatusMT& accessor);

  /** Returns this accessor's type constant, i.e. dLZ_RequestStatusMT.
    *
    * @return This accessor's type constant, i.e. dLZ_RequestStatusMT.
    */
  virtual uci::base::accessorType::AccessorType getAccessorType() const noexception {
    return uci::type::accessorType::dLZ_RequestStatusMT;
  }

  /** Returns the version that was initialized from the uci:version attribute of DLZ_RequestStatusMT.
    *
    * @return The version that was initialized from the uci:version attribute of DLZ_RequestStatusMT.
    */
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const DLZ_RequestStatusMT& accessor) = 0;
  ...
  /** Returns a const reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual const uci::type::DLZ_RequestStatusMDT& getMessageData() const = 0;
  ...
  /** Returns a reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual uci::type::DLZ_RequestStatusMDT& getMessageData() = 0;
  ...
  /** Sets the complex content identified by MessageData to the contents of the complex content accessed by the specified
    ...
    */
  virtual uci::type::DLZ_RequestStatusMT& setMessageData(const uci::type::DLZ_RequestStatusMDT& value) = 0;

  /** The Listener provides the support to listen and handle incoming messages of the type uci::type::DLZ_RequestStatusMT. */
  ...
  public:
    ...
    /** The method is used to handle incoming messages.
      ...
      */
    virtual void handleMessage(const uci::type::DLZ_RequestStatusMT& message) = 0;
  ...
  public:
    ...
    /** Adds a listener to this reader to handle incoming messages.
      ...
      */
    virtual void addListener(uci::type::DLZ_RequestStatusMT::Listener& listener) = 0;

    /** Removes the specified listener from this reader.
      *
      * @param listener The listener that is to be removed from this reader.
      */
    virtual void removeListener(uci::type::DLZ_RequestStatusMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s). Returns immediately if no messages are available.
      ...
      */
    virtual unsigned long readNoWait(unsigned long maxNumberOfMessages, uci::type::DLZ_RequestStatusMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s).
      ...
      * @return The number of messages that were handled.
      */
    virtual unsigned long read(unsigned long timeout, unsigned long maxNumberOfMessages, uci::type::DLZ_RequestStatusMT::Listener& listener) = 0;
  ...
  /** This method creates a new reader that can be used to read a DLZ_RequestStatusMT.
    *
    * @param topic The specification of the topic the reader is to read from.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A reader that can read a DLZ_RequestStatusMT.
    */
  static UCI_EXPORT uci::type::DLZ_RequestStatusMT::Reader& createReader(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a reader. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyReader(uci::type::DLZ_RequestStatusMT::Reader& reader);
  ...
  public:
    ...
    /** Writes the OMS message to the topic specified when this Writer was created.
      ...
      */
    virtual void write(uci::type::DLZ_RequestStatusMT& accessor) = 0;
  ...
  /** This method creates a new writer that can be used to write a DLZ_RequestStatusMT.
    *
    * @param topic The specification of the topic the writer is to write to.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A writer that can write a DLZ_RequestStatusMT.
    */
  static UCI_EXPORT uci::type::DLZ_RequestStatusMT::Writer& createWriter(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a writer. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyWriter(uci::type::DLZ_RequestStatusMT::Writer& writer);
...
protected:
  ...
  /** The copy constructor [only available to derived classes].
    *
    * @param rhs The DLZ_RequestStatusMT to copy from.
    */
  DLZ_RequestStatusMT(const DLZ_RequestStatusMT& rhs) {
    (void)rhs;
  }

  /** The assignment operator. Sets the contents of this DLZ_RequestStatusMT to the contents of the DLZ_RequestStatusMT on
    * the right hand side (rhs) of the assignment operator [only available to derived classes].
    *
    * @param rhs The DLZ_RequestStatusMT on the right hand side (rhs) of the assignment operator whose contents are used to
    *      set the contents of this DLZ_RequestStatusMT.
    * @return A reference to this DLZ_RequestStatusMT.
    */
  DLZ_RequestStatusMT& operator=(const DLZ_RequestStatusMT& rhs) {
    (void)rhs;
...
#endif // UCI_TYPE_DLZ_REQUESTSTATUSMT_H
