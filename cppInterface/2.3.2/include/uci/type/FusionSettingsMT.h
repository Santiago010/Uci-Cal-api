...
#ifndef UCI_TYPE_FUSIONSETTINGSMT_H
#define UCI_TYPE_FUSIONSETTINGSMT_H

#include "../base/Listener.h"
#include "../base/Reader.h"
#include "../base/Writer.h"
#include "../base/export.h"
#include "FusionSettingsMDT.h"
...
class FusionSettingsMT : public virtual MessageType {
public:

  /** This method constructs a new FusionSettingsMT.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed FusionSettingsMT.
    */
  static UCI_EXPORT FusionSettingsMT& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new FusionSettingsMT initializing the data accessed by the new FusionSettingsMT using the
    * data accessed by the specified FusionSettingsMT (cloning).
    *
    * @param accessor The FusionSettingsMT that provides access to the data that is to be used to initialize the data
    *      accessed by the new created FusionSettingsMT.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed FusionSettingsMT.
    */
  static UCI_EXPORT FusionSettingsMT& create(const FusionSettingsMT& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified FusionSettingsMT. Use of the specified accessor after it has been destroyed will
    * result in undefined behavior.
    *
    * @param accessor The FusionSettingsMT that is to be destroyed.
    */
  static UCI_EXPORT void destroy(FusionSettingsMT& accessor);
  ...
  /** Returns the version that was initialized from the uci:version attribute of FusionSettingsMT.
    *
    * @return The version that was initialized from the uci:version attribute of FusionSettingsMT.
    */
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const FusionSettingsMT& accessor) = 0;
  ...
  /** Returns a const reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual const uci::type::FusionSettingsMDT& getMessageData() const = 0;
  ...
  /** Returns a reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual uci::type::FusionSettingsMDT& getMessageData() = 0;
  ...
  /** Sets the complex content identified by MessageData to the contents of the complex content accessed by the specified
    ...
    */
  virtual uci::type::FusionSettingsMT& setMessageData(const uci::type::FusionSettingsMDT& value) = 0;

  /** The Listener provides the support to listen and handle incoming messages of the type uci::type::FusionSettingsMT. */
  ...
  public:
    ...
    /** The method is used to handle incoming messages.
      ...
      */
    virtual void handleMessage(const uci::type::FusionSettingsMT& message) = 0;
  ...
  public:
    ...
    /** Adds a listener to this reader to handle incoming messages.
      ...
      */
    virtual void addListener(uci::type::FusionSettingsMT::Listener& listener) = 0;

    /** Removes the specified listener from this reader.
      *
      * @param listener The listener that is to be removed from this reader.
      */
    virtual void removeListener(uci::type::FusionSettingsMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s). Returns immediately if no messages are available.
      ...
      */
    virtual unsigned long readNoWait(unsigned long maxNumberOfMessages, uci::type::FusionSettingsMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s).
      ...
      * @return The number of messages that were handled.
      */
    virtual unsigned long read(unsigned long timeout, unsigned long maxNumberOfMessages, uci::type::FusionSettingsMT::Listener& listener) = 0;
  ...
  /** This method creates a new reader that can be used to read a FusionSettingsMT.
    *
    * @param topic The specification of the topic the reader is to read from.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A reader that can read a FusionSettingsMT.
    */
  static UCI_EXPORT uci::type::FusionSettingsMT::Reader& createReader(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a reader. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyReader(uci::type::FusionSettingsMT::Reader& reader);
  ...
  public:
    ...
    /** Writes the OMS message to the topic specified when this Writer was created.
      ...
      */
    virtual void write(uci::type::FusionSettingsMT& accessor) = 0;
  ...
  /** This method creates a new writer that can be used to write a FusionSettingsMT.
    *
    * @param topic The specification of the topic the writer is to write to.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A writer that can write a FusionSettingsMT.
    */
  static UCI_EXPORT uci::type::FusionSettingsMT::Writer& createWriter(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a writer. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyWriter(uci::type::FusionSettingsMT::Writer& writer);
...
protected:
  ...
  /** The assignment operator. Sets the contents of this FusionSettingsMT to the contents of the FusionSettingsMT on the
    ...
    *      set the contents of this FusionSettingsMT.
    * @return A reference to this FusionSettingsMT.
    */
  FusionSettingsMT& operator=(const FusionSettingsMT& rhs) {
    (void)rhs;
...
#endif // UCI_TYPE_FUSIONSETTINGSMT_H
