/** @file EarthOrientationParametersMT.h
 *
...
#ifndef UCI_TYPE_EARTHORIENTATIONPARAMETERSMT_H
#define UCI_TYPE_EARTHORIENTATIONPARAMETERSMT_H

#include "../base/Listener.h"
#include "../base/Reader.h"
#include "../base/Writer.h"
#include "../base/export.h"
#include "EarthOrientationParametersMDT.h"
...
class EarthOrientationParametersMT : public virtual MessageType {
public:

  /** This method constructs a new EarthOrientationParametersMT.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed EarthOrientationParametersMT.
    */
  static UCI_EXPORT EarthOrientationParametersMT& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new EarthOrientationParametersMT initializing the data accessed by the new
    * EarthOrientationParametersMT using the data accessed by the specified EarthOrientationParametersMT (cloning).
    *
    * @param accessor The EarthOrientationParametersMT that provides access to the data that is to be used to initialize
    *      the data accessed by the new created EarthOrientationParametersMT.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed EarthOrientationParametersMT.
    */
  static UCI_EXPORT EarthOrientationParametersMT& create(const EarthOrientationParametersMT& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified EarthOrientationParametersMT. Use of the specified accessor after it has been
    * destroyed will result in undefined behavior.
    *
    * @param accessor The EarthOrientationParametersMT that is to be destroyed.
    */
  static UCI_EXPORT void destroy(EarthOrientationParametersMT& accessor);

  /** Returns this accessor's type constant, i.e. earthOrientationParametersMT.
    *
    * @return This accessor's type constant, i.e. earthOrientationParametersMT.
    */
  virtual uci::base::accessorType::AccessorType getAccessorType() const noexception {
    return uci::type::accessorType::earthOrientationParametersMT;
  }

  /** Returns the version that was initialized from the uci:version attribute of EarthOrientationParametersMT.
    *
    * @return The version that was initialized from the uci:version attribute of EarthOrientationParametersMT.
    */
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const EarthOrientationParametersMT& accessor) = 0;
  ...
  /** Sets the value of the enumeration identified by ObjectState.
    ...
    */
  virtual uci::type::EarthOrientationParametersMT& setObjectState(const uci::type::ObjectStateEnum& value) = 0;
  ...
  /** Sets the value of the enumeration identified by ObjectState.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::EarthOrientationParametersMT& setObjectState(uci::type::ObjectStateEnum::EnumerationItem value) = 0;
  ...
  /** Clears (disabled) the Element identified by ObjectState.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::EarthOrientationParametersMT& clearObjectState() = 0;
  ...
  /** Returns a const reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual const uci::type::EarthOrientationParametersMDT& getMessageData() const = 0;
  ...
  /** Returns a reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual uci::type::EarthOrientationParametersMDT& getMessageData() = 0;
  ...
  /** Sets the complex content identified by MessageData to the contents of the complex content accessed by the specified
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::EarthOrientationParametersMT& setMessageData(const uci::type::EarthOrientationParametersMDT& value) = 0;

  /** The Listener provides the support to listen and handle incoming messages of the type
    * uci::type::EarthOrientationParametersMT.
    */
  ...
  public:
    ...
    /** The method is used to handle incoming messages.
      ...
      */
    virtual void handleMessage(const uci::type::EarthOrientationParametersMT& message) = 0;
  ...
  public:
    ...
    /** Adds a listener to this reader to handle incoming messages.
      ...
      */
    virtual void addListener(uci::type::EarthOrientationParametersMT::Listener& listener) = 0;

    /** Removes the specified listener from this reader.
      *
      * @param listener The listener that is to be removed from this reader.
      */
    virtual void removeListener(uci::type::EarthOrientationParametersMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s). Returns immediately if no messages are available.
      ...
      */
    virtual unsigned long readNoWait(unsigned long maxNumberOfMessages, uci::type::EarthOrientationParametersMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s).
      ...
      * @return The number of messages that were handled.
      */
    virtual unsigned long read(unsigned long timeout, unsigned long maxNumberOfMessages, uci::type::EarthOrientationParametersMT::Listener& listener) = 0;
  ...
  /** This method creates a new reader that can be used to read a EarthOrientationParametersMT.
    *
    * @param topic The specification of the topic the reader is to read from.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A reader that can read a EarthOrientationParametersMT.
    */
  static UCI_EXPORT uci::type::EarthOrientationParametersMT::Reader& createReader(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a reader. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyReader(uci::type::EarthOrientationParametersMT::Reader& reader);
  ...
  public:
    ...
    /** Writes the OMS message to the topic specified when this Writer was created.
      ...
      */
    virtual void write(uci::type::EarthOrientationParametersMT& accessor) = 0;
  ...
  /** This method creates a new writer that can be used to write a EarthOrientationParametersMT.
    *
    * @param topic The specification of the topic the writer is to write to.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A writer that can write a EarthOrientationParametersMT.
    */
  static UCI_EXPORT uci::type::EarthOrientationParametersMT::Writer& createWriter(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a writer. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyWriter(uci::type::EarthOrientationParametersMT::Writer& writer);
...
protected:
  ...
  /** The copy constructor [only available to derived classes].
    *
    * @param rhs The EarthOrientationParametersMT to copy from.
    */
  EarthOrientationParametersMT(const EarthOrientationParametersMT& rhs) {
    (void)rhs;
  }

  /** The assignment operator. Sets the contents of this EarthOrientationParametersMT to the contents of the
    * EarthOrientationParametersMT on the right hand side (rhs) of the assignment operator [only available to derived
    * classes].
    *
    * @param rhs The EarthOrientationParametersMT on the right hand side (rhs) of the assignment operator whose contents
    *      are used to set the contents of this EarthOrientationParametersMT.
    * @return A reference to this EarthOrientationParametersMT.
    */
  EarthOrientationParametersMT& operator=(const EarthOrientationParametersMT& rhs) {
    (void)rhs;
...
#endif // UCI_TYPE_EARTHORIENTATIONPARAMETERSMT_H
