...
#ifndef UCI_TYPE_QUERYDATAREQUESTMT_H
#define UCI_TYPE_QUERYDATAREQUESTMT_H
...
class QueryDataRequestMT : public virtual MessageType {
public:

  /** This method constructs a new QueryDataRequestMT.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed QueryDataRequestMT.
    */
  static UCI_EXPORT QueryDataRequestMT& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new QueryDataRequestMT initializing the data accessed by the new QueryDataRequestMT using
    * the data accessed by the specified QueryDataRequestMT (cloning).
    *
    * @param accessor The QueryDataRequestMT that provides access to the data that is to be used to initialize the data
    *      accessed by the new created QueryDataRequestMT.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed QueryDataRequestMT.
    */
  static UCI_EXPORT QueryDataRequestMT& create(const QueryDataRequestMT& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified QueryDataRequestMT. Use of the specified accessor after it has been destroyed will
    * result in undefined behavior.
    *
    * @param accessor The QueryDataRequestMT that is to be destroyed.
    */
  static UCI_EXPORT void destroy(QueryDataRequestMT& accessor);

  /** Returns this accessor's type constant, i.e. queryDataRequestMT.
    *
    * @return This accessor's type constant, i.e. queryDataRequestMT.
    */
  virtual uci::base::accessorType::AccessorType getAccessorType() const noexception {
    return uci::type::accessorType::queryDataRequestMT;
  }

  /** Returns the version that was initialized from the uci:version attribute of QueryDataRequestMT.
    *
    * @return The version that was initialized from the uci:version attribute of QueryDataRequestMT.
    */
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const QueryDataRequestMT& accessor) = 0;
  ...
  /** Returns a const reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual const uci::type::QueryDataRequestMDT& getMessageData() const = 0;
  ...
  /** Returns a reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual uci::type::QueryDataRequestMDT& getMessageData() = 0;
  ...
  /** Sets the complex content identified by MessageData to the contents of the complex content accessed by the specified
    ...
    */
  virtual uci::type::QueryDataRequestMT& setMessageData(const uci::type::QueryDataRequestMDT& value) = 0;

  /** The Listener provides the support to listen and handle incoming messages of the type uci::type::QueryDataRequestMT. */
  ...
  public:
    ...
    /** The method is used to handle incoming messages.
      ...
      */
    virtual void handleMessage(const uci::type::QueryDataRequestMT& message) = 0;
  ...
  public:
    ...
    /** Adds a listener to this reader to handle incoming messages.
      ...
      */
    virtual void addListener(uci::type::QueryDataRequestMT::Listener& listener) = 0;

    /** Removes the specified listener from this reader.
      *
      * @param listener The listener that is to be removed from this reader.
      */
    virtual void removeListener(uci::type::QueryDataRequestMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s). Returns immediately if no messages are available.
      ...
      */
    virtual unsigned long readNoWait(unsigned long maxNumberOfMessages, uci::type::QueryDataRequestMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s).
      ...
      * @return The number of messages that were handled.
      */
    virtual unsigned long read(unsigned long timeout, unsigned long maxNumberOfMessages, uci::type::QueryDataRequestMT::Listener& listener) = 0;
  ...
  /** This method creates a new reader that can be used to read a QueryDataRequestMT.
    *
    * @param topic The specification of the topic the reader is to read from.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A reader that can read a QueryDataRequestMT.
    */
  static UCI_EXPORT uci::type::QueryDataRequestMT::Reader& createReader(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a reader. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyReader(uci::type::QueryDataRequestMT::Reader& reader);
  ...
  public:
    ...
    /** Writes the OMS message to the topic specified when this Writer was created.
      ...
      */
    virtual void write(uci::type::QueryDataRequestMT& accessor) = 0;
  ...
  /** This method creates a new writer that can be used to write a QueryDataRequestMT.
    *
    * @param topic The specification of the topic the writer is to write to.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A writer that can write a QueryDataRequestMT.
    */
  static UCI_EXPORT uci::type::QueryDataRequestMT::Writer& createWriter(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a writer. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyWriter(uci::type::QueryDataRequestMT::Writer& writer);
...
protected:
  ...
  /** The copy constructor [only available to derived classes].
    *
    * @param rhs The QueryDataRequestMT to copy from.
    */
  QueryDataRequestMT(const QueryDataRequestMT& rhs) {
    (void)rhs;
  }

  /** The assignment operator. Sets the contents of this QueryDataRequestMT to the contents of the QueryDataRequestMT on
    * the right hand side (rhs) of the assignment operator [only available to derived classes].
    *
    * @param rhs The QueryDataRequestMT on the right hand side (rhs) of the assignment operator whose contents are used to
    *      set the contents of this QueryDataRequestMT.
    * @return A reference to this QueryDataRequestMT.
    */
  QueryDataRequestMT& operator=(const QueryDataRequestMT& rhs) {
    (void)rhs;
...
#endif // UCI_TYPE_QUERYDATAREQUESTMT_H
