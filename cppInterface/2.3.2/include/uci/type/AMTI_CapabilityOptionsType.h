/** @file AMTI_CapabilityOptionsType.h
 *
...
#ifndef UCI_TYPE_AMTI_CAPABILITYOPTIONSTYPE_H
#define UCI_TYPE_AMTI_CAPABILITYOPTIONSTYPE_H
...
public:
  ...
  /** This method constructs a new AMTI_CapabilityOptionsType.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed AMTI_CapabilityOptionsType.
    */
  static UCI_EXPORT AMTI_CapabilityOptionsType& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new AMTI_CapabilityOptionsType initializing the data accessed by the new
    * AMTI_CapabilityOptionsType using the data accessed by the specified AMTI_CapabilityOptionsType (cloning).
    *
    * @param accessor The AMTI_CapabilityOptionsType that provides access to the data that is to be used to initialize the
    *      data accessed by the new created AMTI_CapabilityOptionsType.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed AMTI_CapabilityOptionsType.
    */
  static UCI_EXPORT AMTI_CapabilityOptionsType& create(const AMTI_CapabilityOptionsType& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified AMTI_CapabilityOptionsType. Use of the specified accessor after it has been
    * destroyed will result in undefined behavior.
    *
    * @param accessor The AMTI_CapabilityOptionsType that is to be destroyed.
    */
  static UCI_EXPORT void destroy(AMTI_CapabilityOptionsType& accessor);
  ...
  /** Returns the version that was initialized from the uci:version attribute of AMTI_CapabilityOptionsType.
    *
    * @return The version that was initialized from the uci:version attribute of AMTI_CapabilityOptionsType.
    */
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const AMTI_CapabilityOptionsType& accessor) = 0;
  ...
  /** Sets the value of the SimplePrimitive data type identified by InterruptOtherActivities.
    ...
    */
  virtual uci::type::AMTI_CapabilityOptionsType& setInterruptOtherActivities(xs::Boolean value) = 0;
  ...
  /** Sets the value of the SimplePrimitive data type identified by CollectionPolicy.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::AMTI_CapabilityOptionsType& setCollectionPolicy(xs::Boolean value) = 0;
  ...
  /** Sets the value of the SimplePrimitive data type identified by ConcurrentOperationSupported.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::AMTI_CapabilityOptionsType& setConcurrentOperationSupported(xs::Boolean value) = 0;
  ...
  /** Sets the complex content identified by MultistaticOptionsSupported to the contents of the complex content accessed by
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::AMTI_CapabilityOptionsType& setMultistaticOptionsSupported(const uci::type::MultistaticOptionsSupportedType& value) = 0;
  ...
  /** Clears (disabled) the Element identified by MultistaticOptionsSupported.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::AMTI_CapabilityOptionsType& clearMultistaticOptionsSupported() = 0;
  ...
  /** Sets the value of the SimplePrimitive data type identified by FalseAlarmLevelUpperLimit.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::AMTI_CapabilityOptionsType& setFalseAlarmLevelUpperLimit(xs::UnsignedByte value) = 0;
  ...
  /** Clears (disabled) the Element identified by FalseAlarmLevelUpperLimit.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::AMTI_CapabilityOptionsType& clearFalseAlarmLevelUpperLimit() = 0;
  ...
  /** Returns a const reference to the bounded list identified by ElectronicProtectionOptionsSupported.
    ...
    */
  virtual const uci::type::AMTI_CapabilityOptionsType::ElectronicProtectionOptionsSupported& getElectronicProtectionOptionsSupported() const = 0;
  ...
  /** Returns a reference to the bounded list identified by ElectronicProtectionOptionsSupported.
    ...
    */
  virtual uci::type::AMTI_CapabilityOptionsType::ElectronicProtectionOptionsSupported& getElectronicProtectionOptionsSupported() = 0;
  ...
  /** Sets the bounded list identified by ElectronicProtectionOptionsSupported.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::AMTI_CapabilityOptionsType& setElectronicProtectionOptionsSupported(const uci::type::AMTI_CapabilityOptionsType::ElectronicProtectionOptionsSupported& value) = 0;
...
protected:
  ...
  /** The assignment operator. Sets the contents of this AMTI_CapabilityOptionsType to the contents of the
    * AMTI_CapabilityOptionsType on the right hand side (rhs) of the assignment operator [only available to derived
    * classes].
    *
    * @param rhs The AMTI_CapabilityOptionsType on the right hand side (rhs) of the assignment operator whose contents are
    *      used to set the contents of this AMTI_CapabilityOptionsType.
    * @return A reference to this AMTI_CapabilityOptionsType.
    */
  AMTI_CapabilityOptionsType& operator=(const AMTI_CapabilityOptionsType& rhs) {
    (void)rhs;
...
#endif // UCI_TYPE_AMTI_CAPABILITYOPTIONSTYPE_H
