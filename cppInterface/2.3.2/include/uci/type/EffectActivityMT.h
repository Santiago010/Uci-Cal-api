...
#ifndef UCI_TYPE_EFFECTACTIVITYMT_H
#define UCI_TYPE_EFFECTACTIVITYMT_H

#include "../base/Listener.h"
#include "../base/Reader.h"
#include "../base/Writer.h"
#include "../base/export.h"
#include "EffectActivityMDT.h"
...
class EffectActivityMT : public virtual MessageType {
public:

  /** This method constructs a new EffectActivityMT.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed EffectActivityMT.
    */
  static UCI_EXPORT EffectActivityMT& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new EffectActivityMT initializing the data accessed by the new EffectActivityMT using the
    * data accessed by the specified EffectActivityMT (cloning).
    *
    * @param accessor The EffectActivityMT that provides access to the data that is to be used to initialize the data
    *      accessed by the new created EffectActivityMT.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed EffectActivityMT.
    */
  static UCI_EXPORT EffectActivityMT& create(const EffectActivityMT& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified EffectActivityMT. Use of the specified accessor after it has been destroyed will
    * result in undefined behavior.
    *
    * @param accessor The EffectActivityMT that is to be destroyed.
    */
  static UCI_EXPORT void destroy(EffectActivityMT& accessor);

  /** Returns this accessor's type constant, i.e. effectActivityMT.
    *
    * @return This accessor's type constant, i.e. effectActivityMT.
    */
  virtual uci::base::accessorType::AccessorType getAccessorType() const noexception {
    return uci::type::accessorType::effectActivityMT;
  }

  /** Returns the version that was initialized from the uci:version attribute of EffectActivityMT.
    *
    * @return The version that was initialized from the uci:version attribute of EffectActivityMT.
    */
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const EffectActivityMT& accessor) = 0;
  ...
  /** Sets the value of the enumeration identified by ObjectState.
    ...
    */
  virtual uci::type::EffectActivityMT& setObjectState(const uci::type::ObjectStateEnum& value) = 0;
  ...
  /** Sets the value of the enumeration identified by ObjectState.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::EffectActivityMT& setObjectState(uci::type::ObjectStateEnum::EnumerationItem value) = 0;
  ...
  /** Clears (disabled) the Element identified by ObjectState.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::EffectActivityMT& clearObjectState() = 0;
  ...
  /** Returns a const reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual const uci::type::EffectActivityMDT& getMessageData() const = 0;
  ...
  /** Returns a reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual uci::type::EffectActivityMDT& getMessageData() = 0;
  ...
  /** Sets the complex content identified by MessageData to the contents of the complex content accessed by the specified
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::EffectActivityMT& setMessageData(const uci::type::EffectActivityMDT& value) = 0;

  /** The Listener provides the support to listen and handle incoming messages of the type uci::type::EffectActivityMT. */
  ...
  public:
    ...
    /** The method is used to handle incoming messages.
      ...
      */
    virtual void handleMessage(const uci::type::EffectActivityMT& message) = 0;
  ...
  public:
    ...
    /** Adds a listener to this reader to handle incoming messages.
      ...
      */
    virtual void addListener(uci::type::EffectActivityMT::Listener& listener) = 0;

    /** Removes the specified listener from this reader.
      *
      * @param listener The listener that is to be removed from this reader.
      */
    virtual void removeListener(uci::type::EffectActivityMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s). Returns immediately if no messages are available.
      ...
      */
    virtual unsigned long readNoWait(unsigned long maxNumberOfMessages, uci::type::EffectActivityMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s).
      ...
      * @return The number of messages that were handled.
      */
    virtual unsigned long read(unsigned long timeout, unsigned long maxNumberOfMessages, uci::type::EffectActivityMT::Listener& listener) = 0;
  ...
  /** This method creates a new reader that can be used to read a EffectActivityMT.
    *
    * @param topic The specification of the topic the reader is to read from.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A reader that can read a EffectActivityMT.
    */
  static UCI_EXPORT uci::type::EffectActivityMT::Reader& createReader(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a reader. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyReader(uci::type::EffectActivityMT::Reader& reader);
  ...
  public:
    ...
    /** Writes the OMS message to the topic specified when this Writer was created.
      ...
      */
    virtual void write(uci::type::EffectActivityMT& accessor) = 0;
  ...
  /** This method creates a new writer that can be used to write a EffectActivityMT.
    *
    * @param topic The specification of the topic the writer is to write to.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A writer that can write a EffectActivityMT.
    */
  static UCI_EXPORT uci::type::EffectActivityMT::Writer& createWriter(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a writer. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyWriter(uci::type::EffectActivityMT::Writer& writer);
...
protected:
  ...
  /** The copy constructor [only available to derived classes].
    *
    * @param rhs The EffectActivityMT to copy from.
    */
  EffectActivityMT(const EffectActivityMT& rhs) {
    (void)rhs;
  }

  /** The assignment operator. Sets the contents of this EffectActivityMT to the contents of the EffectActivityMT on the
    * right hand side (rhs) of the assignment operator [only available to derived classes].
    *
    * @param rhs The EffectActivityMT on the right hand side (rhs) of the assignment operator whose contents are used to
    *      set the contents of this EffectActivityMT.
    * @return A reference to this EffectActivityMT.
    */
  EffectActivityMT& operator=(const EffectActivityMT& rhs) {
    (void)rhs;
...
#endif // UCI_TYPE_EFFECTACTIVITYMT_H
