...
#ifndef UCI_TYPE_AO_COMMANDMT_H
#define UCI_TYPE_AO_COMMANDMT_H

#include "../base/Listener.h"
#include "../base/Reader.h"
#include "../base/Writer.h"
#include "../base/export.h"
#include "AO_CommandMDT.h"
...
class AO_CommandMT : public virtual MessageType {
public:

  /** This method constructs a new AO_CommandMT.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed AO_CommandMT.
    */
  static UCI_EXPORT AO_CommandMT& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new AO_CommandMT initializing the data accessed by the new AO_CommandMT using the data
    * accessed by the specified AO_CommandMT (cloning).
    *
    * @param accessor The AO_CommandMT that provides access to the data that is to be used to initialize the data accessed
    *      by the new created AO_CommandMT.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed AO_CommandMT.
    */
  static UCI_EXPORT AO_CommandMT& create(const AO_CommandMT& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified AO_CommandMT. Use of the specified accessor after it has been destroyed will
    * result in undefined behavior.
    *
    * @param accessor The AO_CommandMT that is to be destroyed.
    */
  static UCI_EXPORT void destroy(AO_CommandMT& accessor);
  ...
  /** Returns the version that was initialized from the uci:version attribute of AO_CommandMT.
    *
    * @return The version that was initialized from the uci:version attribute of AO_CommandMT.
    */
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const AO_CommandMT& accessor) = 0;
  ...
  /** Returns a const reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual const uci::type::AO_CommandMDT& getMessageData() const = 0;
  ...
  /** Returns a reference to the accessor that provides access to the complex content identified by MessageData.
    ...
    */
  virtual uci::type::AO_CommandMDT& getMessageData() = 0;
  ...
  /** Sets the complex content identified by MessageData to the contents of the complex content accessed by the specified
    ...
    */
  virtual uci::type::AO_CommandMT& setMessageData(const uci::type::AO_CommandMDT& value) = 0;

  /** The Listener provides the support to listen and handle incoming messages of the type uci::type::AO_CommandMT. */
  ...
  public:
    ...
    /** The method is used to handle incoming messages.
      ...
      */
    virtual void handleMessage(const uci::type::AO_CommandMT& message) = 0;
  ...
  public:
    ...
    /** Adds a listener to this reader to handle incoming messages.
      ...
      */
    virtual void addListener(uci::type::AO_CommandMT::Listener& listener) = 0;

    /** Removes the specified listener from this reader.
      *
      * @param listener The listener that is to be removed from this reader.
      */
    virtual void removeListener(uci::type::AO_CommandMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s). Returns immediately if no messages are available.
      ...
      */
    virtual unsigned long readNoWait(unsigned long maxNumberOfMessages, uci::type::AO_CommandMT::Listener& listener) = 0;
    ...
    /** Reads the next incoming message(s).
      ...
      * @return The number of messages that were handled.
      */
    virtual unsigned long read(unsigned long timeout, unsigned long maxNumberOfMessages, uci::type::AO_CommandMT::Listener& listener) = 0;
  ...
  /** This method creates a new reader that can be used to read a AO_CommandMT.
    *
    * @param topic The specification of the topic the reader is to read from.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A reader that can read a AO_CommandMT.
    */
  static UCI_EXPORT uci::type::AO_CommandMT::Reader& createReader(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a reader. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyReader(uci::type::AO_CommandMT::Reader& reader);
  ...
  public:
    ...
    /** Writes the OMS message to the topic specified when this Writer was created.
      ...
      */
    virtual void write(uci::type::AO_CommandMT& accessor) = 0;
  ...
  /** This method creates a new writer that can be used to write a AO_CommandMT.
    *
    * @param topic The specification of the topic the writer is to write to.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return A writer that can write a AO_CommandMT.
    */
  static UCI_EXPORT uci::type::AO_CommandMT::Writer& createWriter(const std::string& topic, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection);
  ...
  /** This method destroys a writer. Use of the specified accessor after it has been destroyed will result in undefined
    ...
    */
  static UCI_EXPORT void destroyWriter(uci::type::AO_CommandMT::Writer& writer);
...
protected:
  ...
  /** The assignment operator. Sets the contents of this AO_CommandMT to the contents of the AO_CommandMT on the right hand
    ...
    *      the contents of this AO_CommandMT.
    * @return A reference to this AO_CommandMT.
    */
  AO_CommandMT& operator=(const AO_CommandMT& rhs) {
    (void)rhs;
