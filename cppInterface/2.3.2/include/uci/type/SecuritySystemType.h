...
#ifndef UCI_TYPE_SECURITYSYSTEMTYPE_H
#define UCI_TYPE_SECURITYSYSTEMTYPE_H

#include "../base/Accessor.h"
#include "../base/export.h"
#include "SecuritySystemEnum.h"
...
public:
  ...
  /** This method constructs a new SecuritySystemType.
    *
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed SecuritySystemType.
    */
  static UCI_EXPORT SecuritySystemType& create(uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method constructs a new SecuritySystemType initializing the data accessed by the new SecuritySystemType using
    * the data accessed by the specified SecuritySystemType (cloning).
    *
    * @param accessor The SecuritySystemType that provides access to the data that is to be used to initialize the data
    *      accessed by the new created SecuritySystemType.
    * @param abstractServiceBusConnection The pointer to the Abstract Service Bus Connection that provides the support
    *      required to create objects.
    * @return The newly contructed SecuritySystemType.
    */
  static UCI_EXPORT SecuritySystemType& create(const SecuritySystemType& accessor, uci::base::AbstractServiceBusConnection* abstractServiceBusConnection = NULL);

  /** This method destroys the specified SecuritySystemType. Use of the specified accessor after it has been destroyed will
    * result in undefined behavior.
    *
    * @param accessor The SecuritySystemType that is to be destroyed.
    */
  static UCI_EXPORT void destroy(SecuritySystemType& accessor);
  ...
  /** Returns the version that was initialized from the uci:version attribute of SecuritySystemType.
    *
    * @return The version that was initialized from the uci:version attribute of SecuritySystemType.
    */
  ...
  /** Initializes the contents of this accessor by copying the contents of the specified accessor.
    ...
    */
  virtual void copy(const SecuritySystemType& accessor) = 0;
  ...
  /** Returns a const reference to the value of the enumeration identified by Category.
    ...
    */
  virtual const uci::type::SecuritySystemEnum& getCategory() const = 0;
  ...
  /** Returns a reference to the value of the enumeration identified by Category.
    ...
    */
  virtual uci::type::SecuritySystemEnum& getCategory() = 0;
  ...
  /** Sets the value of the enumeration identified by Category.
    ...
    */
  virtual uci::type::SecuritySystemType& setCategory(const uci::type::SecuritySystemEnum& value) = 0;
  ...
  /** Sets the value of the enumeration identified by Category.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::SecuritySystemType& setCategory(uci::type::SecuritySystemEnum::EnumerationItem value) = 0;
  ...
  /** Sets the string identified by Details to the contents of the string accessed by the specified accessor.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::SecuritySystemType& setDetails(const uci::type::VisibleString1024Type& value) = 0;
  ...
  /** Sets the string identified by Details to the contents of the string that is accessed by the specified accessor.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::SecuritySystemType& setDetails(const std::string& value) = 0;
  ...
  /** Sets the string identified by Details to the contents of the string that is accessed by the specified accessor.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::SecuritySystemType& setDetails(const char* value) = 0;
  ...
  /** Clears (disabled) the Element identified by Details.
    ...
    * @return A reference to the object on which this method was called.
    */
  virtual uci::type::SecuritySystemType& clearDetails() = 0;
...
protected:
  ...
  /** The assignment operator. Sets the contents of this SecuritySystemType to the contents of the SecuritySystemType on
    ...
    *      set the contents of this SecuritySystemType.
    * @return A reference to this SecuritySystemType.
    */
  SecuritySystemType& operator=(const SecuritySystemType& rhs) {
    (void)rhs;
...
#endif // UCI_TYPE_SECURITYSYSTEMTYPE_H
