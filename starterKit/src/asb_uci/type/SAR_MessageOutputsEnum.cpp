/** @file SAR_MessageOutputsEnum.cpp
 *
...
SAR_MessageOutputsEnum::ToNameTable SAR_MessageOutputsEnum::m_toNameTable {
  {enumNotSet, "notSet"},
...
SAR_MessageOutputsEnum::FromNameTable SAR_MessageOutputsEnum::m_fromNameTable {
  {"notSet", enumNotSet},
