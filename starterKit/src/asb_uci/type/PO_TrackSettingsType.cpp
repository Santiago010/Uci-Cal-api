...
PO_TrackSettingsType::PO_TrackSettingsType()
  : trackOptionID_Accessor{boost::make_unique<TrackOptionsID_Type>()},
    coastSetting_Accessor{boost::make_unique<CoastSetting>(0, 6)} {
}

PO_TrackSettingsType::~PO_TrackSettingsType() = default;

void PO_TrackSettingsType::copy(const uci::type::PO_TrackSettingsType& accessor) {
  copyImpl(accessor, false);
}

void PO_TrackSettingsType::copyImpl(const uci::type::PO_TrackSettingsType& accessor, const bool /*checkIfDerivation*/) {
  if (&accessor != this) {
    const auto& accessorImpl = dynamic_cast<const PO_TrackSettingsType&>(accessor);
...
void PO_TrackSettingsType::reset() noexcept {
...
const uci::type::TrackOptionsID_Type& PO_TrackSettingsType::getTrackOptionID() const {
  return *trackOptionID_Accessor;
}

uci::type::TrackOptionsID_Type& PO_TrackSettingsType::getTrackOptionID() {
  return *trackOptionID_Accessor;
}

uci::type::PO_TrackSettingsType& PO_TrackSettingsType::setTrackOptionID(const uci::type::TrackOptionsID_Type& accessor) {
...
uci::type::PO_TrackCommandEnum& PO_TrackSettingsType::getMode_() const {
  if (mode_Accessor) {
...
const uci::type::PO_TrackCommandEnum& PO_TrackSettingsType::getMode() const {
  return getMode_();
}

uci::type::PO_TrackCommandEnum& PO_TrackSettingsType::getMode() {
  return getMode_();
}

uci::type::PO_TrackSettingsType& PO_TrackSettingsType::setMode(const uci::type::PO_TrackCommandEnum& accessor) {
  enableMode();
...
uci::type::PO_TrackSettingsType& PO_TrackSettingsType::setMode(const uci::type::PO_TrackCommandEnum::EnumerationItem value) {
  enableMode().setValue(value);
  return *this;
}

bool PO_TrackSettingsType::hasMode() const noexcept {
  return static_cast<bool>(mode_Accessor);
}

uci::type::PO_TrackCommandEnum& PO_TrackSettingsType::enableMode(uci::base::accessorType::AccessorType type) {
...
uci::type::PO_TrackSettingsType& PO_TrackSettingsType::clearMode() noexcept {
  mode_Accessor.reset();
  return *this;
}

uci::type::IncreaseDecreaseEnum& PO_TrackSettingsType::getTrackArea_() const {
...
const uci::type::IncreaseDecreaseEnum& PO_TrackSettingsType::getTrackArea() const {
  return getTrackArea_();
}

uci::type::IncreaseDecreaseEnum& PO_TrackSettingsType::getTrackArea() {
  return getTrackArea_();
}

uci::type::PO_TrackSettingsType& PO_TrackSettingsType::setTrackArea(const uci::type::IncreaseDecreaseEnum& accessor) {
  enableTrackArea();
...
uci::type::PO_TrackSettingsType& PO_TrackSettingsType::setTrackArea(const uci::type::IncreaseDecreaseEnum::EnumerationItem value) {
  enableTrackArea().setValue(value);
  return *this;
}

bool PO_TrackSettingsType::hasTrackArea() const noexcept {
  return static_cast<bool>(trackArea_Accessor);
}

uci::type::IncreaseDecreaseEnum& PO_TrackSettingsType::enableTrackArea(uci::base::accessorType::AccessorType type) {
...
uci::type::PO_TrackSettingsType& PO_TrackSettingsType::clearTrackArea() noexcept {
  trackArea_Accessor.reset();
  return *this;
}

uci::type::PO_LockPersistenceEnum& PO_TrackSettingsType::getLockPersistence_() const {
...
const uci::type::PO_LockPersistenceEnum& PO_TrackSettingsType::getLockPersistence() const {
  return getLockPersistence_();
}

uci::type::PO_LockPersistenceEnum& PO_TrackSettingsType::getLockPersistence() {
  return getLockPersistence_();
}

uci::type::PO_TrackSettingsType& PO_TrackSettingsType::setLockPersistence(const uci::type::PO_LockPersistenceEnum& accessor) {
...
uci::type::PO_TrackSettingsType& PO_TrackSettingsType::setLockPersistence(const uci::type::PO_LockPersistenceEnum::EnumerationItem value) {
  enableLockPersistence().setValue(value);
  return *this;
}

bool PO_TrackSettingsType::hasLockPersistence() const noexcept {
  return static_cast<bool>(lockPersistence_Accessor);
}

uci::type::PO_LockPersistenceEnum& PO_TrackSettingsType::enableLockPersistence(uci::base::accessorType::AccessorType type) {
...
uci::type::PO_TrackSettingsType& PO_TrackSettingsType::clearLockPersistence() noexcept {
  lockPersistence_Accessor.reset();
  return *this;
}

uci::type::IdentityBasicType& PO_TrackSettingsType::getATR_Filter_() const {
...
const uci::type::IdentityBasicType& PO_TrackSettingsType::getATR_Filter() const {
  return getATR_Filter_();
}

uci::type::IdentityBasicType& PO_TrackSettingsType::getATR_Filter() {
  return getATR_Filter_();
}

uci::type::PO_TrackSettingsType& PO_TrackSettingsType::setATR_Filter(const uci::type::IdentityBasicType& accessor) {
  enableATR_Filter();
...
bool PO_TrackSettingsType::hasATR_Filter() const noexcept {
  return static_cast<bool>(aTR_Filter_Accessor);
}

uci::type::IdentityBasicType& PO_TrackSettingsType::enableATR_Filter(uci::base::accessorType::AccessorType type) {
...
uci::type::PO_TrackSettingsType& PO_TrackSettingsType::clearATR_Filter() noexcept {
  aTR_Filter_Accessor.reset();
  return *this;
}

uci::type::LOS_VariableB_Type& PO_TrackSettingsType::getOffsetTrackSetting_() const {
...
const uci::type::LOS_VariableB_Type& PO_TrackSettingsType::getOffsetTrackSetting() const {
  return getOffsetTrackSetting_();
}

uci::type::LOS_VariableB_Type& PO_TrackSettingsType::getOffsetTrackSetting() {
  return getOffsetTrackSetting_();
}

uci::type::PO_TrackSettingsType& PO_TrackSettingsType::setOffsetTrackSetting(const uci::type::LOS_VariableB_Type& accessor) {
...
bool PO_TrackSettingsType::hasOffsetTrackSetting() const noexcept {
  return static_cast<bool>(offsetTrackSetting_Accessor);
}

uci::type::LOS_VariableB_Type& PO_TrackSettingsType::enableOffsetTrackSetting(uci::base::accessorType::AccessorType type) {
...
uci::type::PO_TrackSettingsType& PO_TrackSettingsType::clearOffsetTrackSetting() noexcept {
  offsetTrackSetting_Accessor.reset();
  return *this;
}

uci::type::DurationTypeValue PO_TrackSettingsType::getObservedEntityThreshold() const {
...
uci::type::PO_TrackSettingsType& PO_TrackSettingsType::setObservedEntityThreshold(uci::type::DurationTypeValue value) {
  observedEntityThreshold_Accessor = value;
  return *this;
}

bool PO_TrackSettingsType::hasObservedEntityThreshold() const noexcept {
  return observedEntityThreshold_Accessor.has_value();
}

uci::type::PO_TrackSettingsType& PO_TrackSettingsType::clearObservedEntityThreshold() noexcept {
  observedEntityThreshold_Accessor.reset();
  return *this;
}

uci::type::DistanceTypeValue PO_TrackSettingsType::getTrackingRange() const {
...
uci::type::PO_TrackSettingsType& PO_TrackSettingsType::setTrackingRange(uci::type::DistanceTypeValue value) {
  trackingRange_Accessor = value;
  return *this;
}

bool PO_TrackSettingsType::hasTrackingRange() const noexcept {
  return trackingRange_Accessor.has_value();
}

uci::type::PO_TrackSettingsType& PO_TrackSettingsType::clearTrackingRange() noexcept {
  trackingRange_Accessor.reset();
  return *this;
}

const uci::type::PO_TrackSettingsType::CoastSetting& PO_TrackSettingsType::getCoastSetting() const {
  return *coastSetting_Accessor;
}

uci::type::PO_TrackSettingsType::CoastSetting& PO_TrackSettingsType::getCoastSetting() {
  return *coastSetting_Accessor;
}

uci::type::PO_TrackSettingsType& PO_TrackSettingsType::setCoastSetting(const uci::type::PO_TrackSettingsType::CoastSetting& accessor) {
...
uci::type::PO_AirTargetVolumeType& PO_TrackSettingsType::getBlankingVolume_() const {
...
const uci::type::PO_AirTargetVolumeType& PO_TrackSettingsType::getBlankingVolume() const {
  return getBlankingVolume_();
}

uci::type::PO_AirTargetVolumeType& PO_TrackSettingsType::getBlankingVolume() {
  return getBlankingVolume_();
}

uci::type::PO_TrackSettingsType& PO_TrackSettingsType::setBlankingVolume(const uci::type::PO_AirTargetVolumeType& accessor) {
...
bool PO_TrackSettingsType::hasBlankingVolume() const noexcept {
  return static_cast<bool>(blankingVolume_Accessor);
}

uci::type::PO_AirTargetVolumeType& PO_TrackSettingsType::enableBlankingVolume(uci::base::accessorType::AccessorType type) {
...
uci::type::PO_TrackSettingsType& PO_TrackSettingsType::clearBlankingVolume() noexcept {
  blankingVolume_Accessor.reset();
  return *this;
}

std::unique_ptr<PO_TrackSettingsType> PO_TrackSettingsType::create(const uci::base::accessorType::AccessorType type) {
  const uci::base::accessorType::AccessorType requestedType{(type == uci::base::accessorType::null) ? uci::type::accessorType::pO_TrackSettingsType : type};
  return (requestedType == uci::type::accessorType::pO_TrackSettingsType) ? boost::make_unique<PO_TrackSettingsType>() : nullptr;
}
...
void PO_TrackSettingsType::deserialize(const boost::property_tree::ptree& propTree, uci::type::PO_TrackSettingsType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
...
std::string PO_TrackSettingsType::serialize(const uci::type::PO_TrackSettingsType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    asb_uci::util::SerializationHelpers::addTypeAttribute(node, PO_TrackSettingsType_Names::Extern_Type_Name);
  }
  ...
  if (accessor.hasObservedEntityThreshold()) {
    asb_uci::util::SerializationHelpers::serializeDuration(accessor.getObservedEntityThreshold(), node, PO_TrackSettingsType_Names::ObservedEntityThreshold_Name);
  }
  if (accessor.hasTrackingRange()) {
    asb_uci::util::SerializationHelpers::serializeDouble(accessor.getTrackingRange(), node, PO_TrackSettingsType_Names::TrackingRange_Name);
  }
  {
    ...
    for (uci::type::PO_TrackSettingsType::CoastSetting::size_type i = 0, end = boundedList.size(); i < end; ++i) {
      asb_uci::type::PO_CoastSettingValueType::serialize(boundedList.at(i), node, PO_TrackSettingsType_Names::CoastSetting_Name);
    }
  }
...
uci::type::PO_TrackSettingsType& PO_TrackSettingsType::create(uci::base::AbstractServiceBusConnection* /*abstractServiceBusConnection*/) {
  return *(boost::make_unique<asb_uci::type::PO_TrackSettingsType>().release());
}

uci::type::PO_TrackSettingsType& PO_TrackSettingsType::create(const uci::type::PO_TrackSettingsType& accessor, uci::base::AbstractServiceBusConnection* /*abstractServiceBusConnection*/) {
  std::unique_ptr<asb_uci::type::PO_TrackSettingsType> newAccessor{boost::make_unique<asb_uci::type::PO_TrackSettingsType>()};
  newAccessor->copyImpl(accessor, false);
  return *(newAccessor.release());
}

void PO_TrackSettingsType::destroy(uci::type::PO_TrackSettingsType& accessor) {
  delete dynamic_cast<asb_uci::type::PO_TrackSettingsType*>(&accessor);
}
