/** @file PO_MessageOutputsEnum.cpp
 *
...
PO_MessageOutputsEnum::ToNameTable PO_MessageOutputsEnum::m_toNameTable {
  {enumNotSet, "notSet"},
...
PO_MessageOutputsEnum::FromNameTable PO_MessageOutputsEnum::m_fromNameTable {
  {"notSet", enumNotSet},
