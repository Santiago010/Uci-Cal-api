...
void StoreLoadoutItemPET::reset() noexcept {
}

std::unique_ptr<StoreLoadoutItemPET> StoreLoadoutItemPET::create(const uci::base::accessorType::AccessorType type) {
  const uci::base::accessorType::AccessorType requestedType{(type == uci::base::accessorType::null) ? uci::type::accessorType::storeLoadoutItemPET : type};
  return std::unique_ptr<StoreLoadoutItemPET>(dynamic_cast<StoreLoadoutItemPET*>(asb_uci::util::DerivedTypesCreator::create(requestedType)));
}

/**  */
namespace StoreLoadoutItemPET_Names {

constexpr const char* Extern_Type_Name{"StoreLoadoutItemPET"};
