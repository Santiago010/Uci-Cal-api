/** @file AO_MessageOutputsEnum.cpp
 *
...
AO_MessageOutputsEnum::ToNameTable AO_MessageOutputsEnum::m_toNameTable {
  {enumNotSet, "notSet"},
...
AO_MessageOutputsEnum::FromNameTable AO_MessageOutputsEnum::m_fromNameTable {
  {"notSet", enumNotSet},
