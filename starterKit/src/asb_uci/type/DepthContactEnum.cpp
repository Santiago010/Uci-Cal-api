...
DepthContactEnum::ToNameTable DepthContactEnum::m_toNameTable {
  {enumNotSet, "notSet"},
  {UCI_NO_STATEMENT, "NO_STATEMENT"},
  {UCI_ESTIMATED_SHALLOW, "ESTIMATED_SHALLOW"},
  {UCI_ABOVE_LAYER, "ABOVE_LAYER"},
  {UCI_BELOW_LAYER, "BELOW_LAYER"},
...
DepthContactEnum::FromNameTable DepthContactEnum::m_fromNameTable {
  {"notSet", enumNotSet},
  {"NO_STATEMENT", UCI_NO_STATEMENT},
  {"ESTIMATED_SHALLOW", UCI_ESTIMATED_SHALLOW},
  {"ABOVE_LAYER", UCI_ABOVE_LAYER},
  {"BELOW_LAYER", UCI_BELOW_LAYER},
