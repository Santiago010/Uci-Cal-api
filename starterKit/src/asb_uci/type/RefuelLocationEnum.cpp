...
RefuelLocationEnum::ToNameTable RefuelLocationEnum::m_toNameTable {
  {enumNotSet, "notSet"},
  {UCI_CENTER, "CENTER"},
  {UCI_LEFT, "LEFT"},
  {UCI_RIGHT, "RIGHT"},
...
RefuelLocationEnum::FromNameTable RefuelLocationEnum::m_fromNameTable {
  {"notSet", enumNotSet},
  {"CENTER", UCI_CENTER},
  {"LEFT", UCI_LEFT},
  {"RIGHT", UCI_RIGHT},
