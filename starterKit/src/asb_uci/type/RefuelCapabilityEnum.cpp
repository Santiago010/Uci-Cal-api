...
RefuelCapabilityEnum::ToNameTable RefuelCapabilityEnum::m_toNameTable {
  {enumNotSet, "notSet"},
  {UCI_BOOM, "BOOM"},
  {UCI_DROGUE, "DROGUE"},
...
RefuelCapabilityEnum::FromNameTable RefuelCapabilityEnum::m_fromNameTable {
  {"notSet", enumNotSet},
  {"BOOM", UCI_BOOM},
  {"DROGUE", UCI_DROGUE},
