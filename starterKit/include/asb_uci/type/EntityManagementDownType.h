...
#ifndef ASB_UCI_TYPE_ENTITYMANAGEMENTDOWNTYPE_H
#define ASB_UCI_TYPE_ENTITYMANAGEMENTDOWNTYPE_H
...
class EntityManagementDownType : public virtual uci::type::EntityManagementDownType {
public:
  /** The constructor */
  ...
  /** The copy constructor
    ...
    */
  EntityManagementDownType(const EntityManagementDownType& rhs) = delete;

  /** The move constructor
    *
    * @param rhs The EntityManagementDownType to move from
    */
  EntityManagementDownType(EntityManagementDownType&& rhs) = delete;

  /** The assignment operator
    *
    * @param rhs The EntityManagementDownType to copy from
    * @return The EntityManagementDownType that was assigned
    */
  EntityManagementDownType& operator=(const EntityManagementDownType& rhs) = delete;
  ...
  /** The move assignment operator
    ...
    * @return The EntityManagementDownType that was assigned
    */
  EntityManagementDownType& operator=(EntityManagementDownType&& rhs) = delete;
  ...
  /** Performs a deep copy of the message data from the specified accessor into the object being operated on by copy(). Any
    ...
    *
    * @param accessor The uci::type::EntityManagementDownType whose contents are to be used to set this
    *      uci::type::EntityManagementDownType's contents.
    */
  void copy(const uci::type::EntityManagementDownType& accessor) override;
  ...
  /** Performs a deep copy of the message data from the specified accessor into the object being operated on by copy(). Any
    ...
    */
  void copyImpl(const uci::type::EntityManagementDownType& accessor, bool checkIfDerivation);
  ...
  /** Set the contents of the message fragment that this accesssor provides access to to the contents the specified
    ...
    */
  uci::type::EntityManagementDownType& setEntityID(const uci::type::EntityID_Type& accessor) override;
  ...
  /** Sets the contents of the message's Enabled field
    ...
    * @return A reference to the object on which this method was called.
    */
  uci::type::EntityManagementDownType& setEnabled(xs::Boolean value) override;
  ...
  /** Set the contents of the message fragment that this accesssor provides access to to the contents the specified
    ...
    * @return A reference to the object on which this method was called.
    */
  uci::type::EntityManagementDownType& setDownLocation(const uci::type::Point2D_Type& accessor) override;
  ...
  /** Clears the value of the optional field accessed by this accesor
    ...
    * @return A reference to the object on which this method was called.
    */
  uci::type::EntityManagementDownType& clearDownLocation() noexcept override;
  ...
  /** 
    ...
    * @return .
    */
  static std::unique_ptr<EntityManagementDownType> create(uci::base::accessorType::AccessorType type);
  ...
  /** 
    ...
    * @param topLevel .
    */
  static void deserialize(const boost::property_tree::ptree& propTree, uci::type::EntityManagementDownType& accessor, std::string& nodeName, std::string& nsPrefix, bool topLevel = false);
  ...
  /** 
    ...
    * @return .
    */
  static std::string serialize(const uci::type::EntityManagementDownType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, bool createNode = true, bool addTypeAttribute = false, bool checkIfDerivation = true, bool topLevel = false);
...
#endif // ASB_UCI_TYPE_ENTITYMANAGEMENTDOWNTYPE_H
