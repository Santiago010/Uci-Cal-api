...
#ifndef ASB_UCI_TYPE_NOTIFICATIONSOURCETYPE_H
#define ASB_UCI_TYPE_NOTIFICATIONSOURCETYPE_H
...
class NotificationSourceType : public virtual uci::type::NotificationSourceType {
public:
  /** The constructor */
  ...
  /** The copy constructor
    ...
    */
  NotificationSourceType(const NotificationSourceType& rhs) = delete;

  /** The move constructor
    *
    * @param rhs The NotificationSourceType to move from
    */
  NotificationSourceType(NotificationSourceType&& rhs) = delete;

  /** The assignment operator
    *
    * @param rhs The NotificationSourceType to copy from
    * @return The NotificationSourceType that was assigned
    */
  NotificationSourceType& operator=(const NotificationSourceType& rhs) = delete;
  ...
  /** The move assignment operator
    ...
    * @return The NotificationSourceType that was assigned
    */
  NotificationSourceType& operator=(NotificationSourceType&& rhs) = delete;
  ...
  /** Performs a deep copy of the message data from the specified accessor into the object being operated on by copy(). Any
    ...
    *
    * @param accessor The uci::type::NotificationSourceType whose contents are to be used to set this
    *      uci::type::NotificationSourceType's contents.
    */
  void copy(const uci::type::NotificationSourceType& accessor) override;
  ...
  /** Performs a deep copy of the message data from the specified accessor into the object being operated on by copy(). Any
    ...
    */
  void copyImpl(const uci::type::NotificationSourceType& accessor, bool checkIfDerivation);
  ...
  /** Set the contents of the message fragment that this accesssor provides access to to the contents the specified
    ...
    */
  uci::type::NotificationSourceType& setSystemID(const uci::type::SystemID_Type& accessor) override;
  ...
  /** Set the contents of the message fragment that this accesssor provides access to to the contents the specified
    ...
    * @return A reference to the object on which this method was called.
    */
  uci::type::NotificationSourceType& setServiceID(const uci::type::ServiceID_Type& accessor) override;
  ...
  /** Clears the value of the optional field accessed by this accesor
    ...
    * @return A reference to the object on which this method was called.
    */
  uci::type::NotificationSourceType& clearServiceID() noexcept override;
  ...
  /** Set the contents of the message fragment that this accesssor provides access to to the contents the specified
    ...
    * @return A reference to the object on which this method was called.
    */
  uci::type::NotificationSourceType& setSubsystemID(const uci::type::SubsystemID_Type& accessor) override;
  ...
  /** Clears the value of the optional field accessed by this accesor
    ...
    * @return A reference to the object on which this method was called.
    */
  uci::type::NotificationSourceType& clearSubsystemID() noexcept override;
  ...
  /** Set the contents of the message fragment that this accesssor provides access to to the contents the specified
    ...
    * @return A reference to the object on which this method was called.
    */
  uci::type::NotificationSourceType& setCapabilityID(const uci::type::CapabilityID_Type& accessor) override;
  ...
  /** Clears the value of the optional field accessed by this accesor
    ...
    * @return A reference to the object on which this method was called.
    */
  uci::type::NotificationSourceType& clearCapabilityID() noexcept override;
  ...
  /** Set the contents of the message fragment that this accesssor provides access to to the contents the specified
    ...
    * @return A reference to the object on which this method was called.
    */
  uci::type::NotificationSourceType& setOperatorID(const uci::type::OperatorID_Type& accessor) override;
  ...
  /** Clears the value of the optional field accessed by this accesor
    ...
    * @return A reference to the object on which this method was called.
    */
  uci::type::NotificationSourceType& clearOperatorID() noexcept override;
  ...
  /** 
    ...
    * @return .
    */
  static std::unique_ptr<NotificationSourceType> create(uci::base::accessorType::AccessorType type);
  ...
  /** 
    ...
    * @param topLevel .
    */
  static void deserialize(const boost::property_tree::ptree& propTree, uci::type::NotificationSourceType& accessor, std::string& nodeName, std::string& nsPrefix, bool topLevel = false);
  ...
  /** 
    ...
    * @return .
    */
  static std::string serialize(const uci::type::NotificationSourceType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, bool createNode = true, bool addTypeAttribute = false, bool checkIfDerivation = true, bool topLevel = false);
...
#endif // ASB_UCI_TYPE_NOTIFICATIONSOURCETYPE_H
