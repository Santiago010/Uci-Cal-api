...
#ifndef ASB_UCI_TYPE_SUBJECTTYPE_H
#define ASB_UCI_TYPE_SUBJECTTYPE_H
...
class SubjectType : public virtual uci::type::SubjectType {
public:
  /** The constructor */
  SubjectType();
  ...
  /** The copy constructor
    ...
    */
  SubjectType(const SubjectType& rhs) = delete;

  /** The move constructor
    *
    * @param rhs The SubjectType to move from
    */
  SubjectType(SubjectType&& rhs) = delete;

  /** The assignment operator [not supported]
    *
    * @param rhs The SubjectType to copy from
    * @return The SubjectType that was assigned
    */
  SubjectType& operator=(const SubjectType& rhs) = delete;
  ...
  /** The move assignment operator
    ...
    * @return The SubjectType that was assigned
    */
  SubjectType& operator=(SubjectType&& rhs) = delete;
  ...
  /** Performs a deep copy of the message data from the specified accessor into the object being operated on by copy(). Any
    ...
    *
    * @param accessor The uci::type::SubjectType whose contents are to be used to set this uci::type::SubjectType's
    *      contents.
    */
  void copy(const uci::type::SubjectType& accessor) override;
  ...
  /** Performs a deep copy of the message data from the specified accessor into the object being operated on by copy(). Any
    ...
    */
  void copyImpl(const uci::type::SubjectType& accessor, bool checkIfDerivation);
  ...
  /** This method returns this choice's "selection ordinal." A choice's "selection ordinal" is used to specify which
    ...
    */
  uci::type::SubjectType::SubjectTypeChoice getSubjectTypeChoiceOrdinal() const noexcept override;
  ...
  /** This method is used to set this choice's "selection ordinal." A choice's "selection ordinal" is used to specify which
    ...
    */
  uci::type::SubjectType& setSubjectTypeChoiceOrdinal(uci::type::SubjectType::SubjectTypeChoice ordinal, uci::base::accessorType::AccessorType type = uci::base::accessorType::null) override;
  ...
  /** Sets this choice's choice to be systemID and initializes systemID to be the specified value. A deep copy will be used
    ...
    * @return A reference to the object on which this method was called.
    */
  uci::type::SubjectType& setSystemID(const uci::type::SystemID_Type& accessor) override;
  ...
  /** Sets this choice's choice to be entityID and initializes entityID to be the specified value. A deep copy will be used
    ...
    * @return A reference to the object on which this method was called.
    */
  uci::type::SubjectType& setEntityID(const uci::type::EntityID_Type& accessor) override;
  ...
  /** 
    ...
    * @return .
    */
  static std::unique_ptr<SubjectType> create(uci::base::accessorType::AccessorType type);
  ...
  /** 
    ...
    * @param topLevel .
    */
  static void deserialize(const boost::property_tree::ptree& propTree, uci::type::SubjectType& accessor, std::string& nodeName, std::string& nsPrefix, bool topLevel = false);
  ...
  /** 
    ...
    * @return .
    */
  static std::string serialize(const uci::type::SubjectType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, bool createNode = true, bool addTypeAttribute = false, bool checkIfDerivation = true, bool topLevel = false);
...
#endif // ASB_UCI_TYPE_SUBJECTTYPE_H
