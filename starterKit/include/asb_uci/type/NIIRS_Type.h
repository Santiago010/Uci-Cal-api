...
#ifndef ASB_UCI_TYPE_NIIRS_TYPE_H
#define ASB_UCI_TYPE_NIIRS_TYPE_H
...
/** Indicates a desired/observed rating level of an image in the National Imagery Interpretability Rating Scale. Scale
  ...
  * (multispectral) and MT IIRS (moving target radar).; [Length: 3] [Pattern: "[0-9]\.[0-9]"]
  */
using NIIRS_Type = asb_xs::String;

} // namespace type

} // namespace asb_uci

#endif // ASB_UCI_TYPE_NIIRS_TYPE_H
