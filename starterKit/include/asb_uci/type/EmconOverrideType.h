...
#ifndef ASB_UCI_TYPE_EMCONOVERRIDETYPE_H
#define ASB_UCI_TYPE_EMCONOVERRIDETYPE_H
...
class EmconOverrideType : public virtual uci::type::EmconOverrideType {
public:
  /** The constructor */
  EmconOverrideType();
  ...
  /** The copy constructor
    ...
    */
  EmconOverrideType(const EmconOverrideType& rhs) = delete;

  /** The move constructor
    *
    * @param rhs The EmconOverrideType to move from
    */
  EmconOverrideType(EmconOverrideType&& rhs) = delete;

  /** The assignment operator [not supported]
    *
    * @param rhs The EmconOverrideType to copy from
    * @return The EmconOverrideType that was assigned
    */
  EmconOverrideType& operator=(const EmconOverrideType& rhs) = delete;
  ...
  /** The move assignment operator
    ...
    * @return The EmconOverrideType that was assigned
    */
  EmconOverrideType& operator=(EmconOverrideType&& rhs) = delete;
  ...
  /** Performs a deep copy of the message data from the specified accessor into the object being operated on by copy(). Any
    ...
    *
    * @param accessor The uci::type::EmconOverrideType whose contents are to be used to set this
    *      uci::type::EmconOverrideType's contents.
    */
  void copy(const uci::type::EmconOverrideType& accessor) override;
  ...
  /** Performs a deep copy of the message data from the specified accessor into the object being operated on by copy(). Any
    ...
    */
  void copyImpl(const uci::type::EmconOverrideType& accessor, bool checkIfDerivation);
  ...
  /** This method returns this choice's "selection ordinal." A choice's "selection ordinal" is used to specify which
    ...
    */
  uci::type::EmconOverrideType::EmconOverrideTypeChoice getEmconOverrideTypeChoiceOrdinal() const noexcept override;
  ...
  /** This method is used to set this choice's "selection ordinal." A choice's "selection ordinal" is used to specify which
    ...
    */
  uci::type::EmconOverrideType& setEmconOverrideTypeChoiceOrdinal(uci::type::EmconOverrideType::EmconOverrideTypeChoice ordinal, uci::base::accessorType::AccessorType type = uci::base::accessorType::null) override;
  ...
  /** Sets this choice's choice to be EmconLevel and initializes EmconLevel to be the specified value
    ...
    * @return A reference to the object on which this method was called.
    */
  uci::type::EmconOverrideType& setEmconLevel(const uci::type::EmconLevelEnum& accessor) override;
  ...
  /** Sets this choice's choice to be EmconLevel and initializes EmconLevel to be the specified value
    ...
    * @return A reference to the object on which this method was called.
    */
  uci::type::EmconOverrideType& setEmconLevel(uci::type::EmconLevelEnum::EnumerationItem value) override;
  ...
  /** Sets this choice's choice to be foreignLevel and initializes foreignLevel to be the specified value. A deep copy will
    ...
    * @return A reference to the object on which this method was called.
    */
  uci::type::EmconOverrideType& setForeignLevel(const uci::type::ForeignKeyType& accessor) override;
  ...
  /** 
    ...
    * @return .
    */
  static std::unique_ptr<EmconOverrideType> create(uci::base::accessorType::AccessorType type);
  ...
  /** 
    ...
    * @param topLevel .
    */
  static void deserialize(const boost::property_tree::ptree& propTree, uci::type::EmconOverrideType& accessor, std::string& nodeName, std::string& nsPrefix, bool topLevel = false);
  ...
  /** 
    ...
    * @return .
    */
  static std::string serialize(const uci::type::EmconOverrideType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, bool createNode = true, bool addTypeAttribute = false, bool checkIfDerivation = true, bool topLevel = false);
...
#endif // ASB_UCI_TYPE_EMCONOVERRIDETYPE_H
