...
#ifndef ASB_UCI_TYPE_ACTIVITYPLANSID_CHOICETYPE_H
#define ASB_UCI_TYPE_ACTIVITYPLANSID_CHOICETYPE_H
...
class ActivityPlansID_ChoiceType : public virtual uci::type::ActivityPlansID_ChoiceType {
public:
  /** The constructor */
  ...
  /** The copy constructor
    ...
    */
  ActivityPlansID_ChoiceType(const ActivityPlansID_ChoiceType& rhs) = delete;

  /** The move constructor
    *
    * @param rhs The ActivityPlansID_ChoiceType to move from
    */
  ActivityPlansID_ChoiceType(ActivityPlansID_ChoiceType&& rhs) = delete;

  /** The assignment operator [not supported]
    *
    * @param rhs The ActivityPlansID_ChoiceType to copy from
    * @return The ActivityPlansID_ChoiceType that was assigned
    */
  ActivityPlansID_ChoiceType& operator=(const ActivityPlansID_ChoiceType& rhs) = delete;
  ...
  /** The move assignment operator
    ...
    * @return The ActivityPlansID_ChoiceType that was assigned
    */
  ActivityPlansID_ChoiceType& operator=(ActivityPlansID_ChoiceType&& rhs) = delete;

  /** The destructor */
  virtual ~ActivityPlansID_ChoiceType();

  /** Performs a deep copy of the message data from the specified accessor into the object being operated on by copy(). Any
    * message data originally held by this object will be freed prior to the copy
    *
    * @param accessor The uci::type::ActivityPlansID_ChoiceType whose contents are to be used to set this
    *      uci::type::ActivityPlansID_ChoiceType's contents.
    */
  void copy(const uci::type::ActivityPlansID_ChoiceType& accessor) override;
  ...
  /** Performs a deep copy of the message data from the specified accessor into the object being operated on by copy(). Any
    ...
    */
  void copyImpl(const uci::type::ActivityPlansID_ChoiceType& accessor, bool checkIfDerivation);
  ...
  /** This method returns this choice's "selection ordinal." A choice's "selection ordinal" is used to specify which
    ...
    */
  uci::type::ActivityPlansID_ChoiceType::ActivityPlansID_ChoiceTypeChoice getActivityPlansID_ChoiceTypeChoiceOrdinal() const noexcept override;
  ...
  /** This method is used to set this choice's "selection ordinal." A choice's "selection ordinal" is used to specify which
    ...
    */
  uci::type::ActivityPlansID_ChoiceType& setActivityPlansID_ChoiceTypeChoiceOrdinal(uci::type::ActivityPlansID_ChoiceType::ActivityPlansID_ChoiceTypeChoice ordinal, uci::base::accessorType::AccessorType type = uci::base::accessorType::null) override;
  ...
  /** Sets this choice's choice to be routeActivityPlanID and initializes routeActivityPlanID to be the specified value. A
    ...
    * @return A reference to the object on which this method was called.
    */
  uci::type::ActivityPlansID_ChoiceType& setRouteActivityPlanID(const uci::type::RouteActivityPlanID_Type& accessor) override;
  ...
  /** Sets this choice's choice to be orbitActivityPlanID and initializes orbitActivityPlanID to be the specified value. A
    ...
    * @return A reference to the object on which this method was called.
    */
  uci::type::ActivityPlansID_ChoiceType& setOrbitActivityPlanID(const uci::type::OrbitActivityPlanID_Type& accessor) override;
  ...
  /** Sets this choice's choice to be activityPlanID and initializes activityPlanID to be the specified value. A deep copy
    ...
    * @return A reference to the object on which this method was called.
    */
  uci::type::ActivityPlansID_ChoiceType& setActivityPlanID(const uci::type::ActivityPlanID_Type& accessor) override;
  ...
  /** 
    ...
    * @return .
    */
  static std::unique_ptr<ActivityPlansID_ChoiceType> create(uci::base::accessorType::AccessorType type);
  ...
  /** 
    ...
    * @param topLevel .
    */
  static void deserialize(const boost::property_tree::ptree& propTree, uci::type::ActivityPlansID_ChoiceType& accessor, std::string& nodeName, std::string& nsPrefix, bool topLevel = false);
  ...
  /** 
    ...
    * @return .
    */
  static std::string serialize(const uci::type::ActivityPlansID_ChoiceType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, bool createNode = true, bool addTypeAttribute = false, bool checkIfDerivation = true, bool topLevel = false);
...
#endif // ASB_UCI_TYPE_ACTIVITYPLANSID_CHOICETYPE_H
