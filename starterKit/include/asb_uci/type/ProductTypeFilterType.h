...
#ifndef ASB_UCI_TYPE_PRODUCTTYPEFILTERTYPE_H
#define ASB_UCI_TYPE_PRODUCTTYPEFILTERTYPE_H
...
class ProductTypeFilterType : public virtual uci::type::ProductTypeFilterType {
public:
  /** The constructor */
  ...
  /** The copy constructor
    ...
    */
  ProductTypeFilterType(const ProductTypeFilterType& rhs) = delete;

  /** The move constructor
    *
    * @param rhs The ProductTypeFilterType to move from
    */
  ProductTypeFilterType(ProductTypeFilterType&& rhs) = delete;

  /** The assignment operator [not supported]
    *
    * @param rhs The ProductTypeFilterType to copy from
    * @return The ProductTypeFilterType that was assigned
    */
  ProductTypeFilterType& operator=(const ProductTypeFilterType& rhs) = delete;
  ...
  /** The move assignment operator
    ...
    * @return The ProductTypeFilterType that was assigned
    */
  ProductTypeFilterType& operator=(ProductTypeFilterType&& rhs) = delete;
  ...
  /** Performs a deep copy of the message data from the specified accessor into the object being operated on by copy(). Any
    ...
    *
    * @param accessor The uci::type::ProductTypeFilterType whose contents are to be used to set this
    *      uci::type::ProductTypeFilterType's contents.
    */
  void copy(const uci::type::ProductTypeFilterType& accessor) override;
  ...
  /** Performs a deep copy of the message data from the specified accessor into the object being operated on by copy(). Any
    ...
    */
  void copyImpl(const uci::type::ProductTypeFilterType& accessor, bool checkIfDerivation);
  ...
  /** This method returns this choice's "selection ordinal." A choice's "selection ordinal" is used to specify which
    ...
    */
  uci::type::ProductTypeFilterType::ProductTypeFilterTypeChoice getProductTypeFilterTypeChoiceOrdinal() const noexcept override;
  ...
  /** This method is used to set this choice's "selection ordinal." A choice's "selection ordinal" is used to specify which
    ...
    */
  uci::type::ProductTypeFilterType& setProductTypeFilterTypeChoiceOrdinal(uci::type::ProductTypeFilterType::ProductTypeFilterTypeChoice ordinal, uci::base::accessorType::AccessorType type = uci::base::accessorType::null) override;
  ...
  /** Sets this choice's choice to be source and initializes source to be the specified value. A deep copy will be used by
    ...
    * @return A reference to the object on which this method was called.
    */
  uci::type::ProductTypeFilterType& setSource(const uci::type::SourceFilterType& accessor) override;
  ...
  /** Sets this choice's choice to be Geospatial and initializes Geospatial to be the specified value. A deep copy will be
    ...
    * @return A reference to the object on which this method was called.
    */
  uci::type::ProductTypeFilterType& setGeospatial(const uci::type::LocationFilterType& accessor) override;
  ...
  /** Sets this choice's choice to be sourceGeospatial and initializes sourceGeospatial to be the specified value. A deep
    ...
    * @return A reference to the object on which this method was called.
    */
  uci::type::ProductTypeFilterType& setSourceGeospatial(const uci::type::SourceLocationFilterType& accessor) override;
  ...
  /** Sets this choice's choice to be FileFormat and initializes FileFormat to be the specified value. A deep copy will be
    ...
    * @return A reference to the object on which this method was called.
    */
  uci::type::ProductTypeFilterType& setFileFormat(const uci::type::FileFormatType& accessor) override;
  ...
  /** Sets this choice's choice to be securityInformation and initializes securityInformation to be the specified value. A
    ...
    * @return A reference to the object on which this method was called.
    */
  uci::type::ProductTypeFilterType& setSecurityInformation(const uci::type::SecurityInformationType& accessor) override;
  ...
  /** Sets this choice's choice to be dateTimeRange and initializes dateTimeRange to be the specified value. A deep copy
    ...
    * @return A reference to the object on which this method was called.
    */
  uci::type::ProductTypeFilterType& setDateTimeRange(const uci::type::DateTimeRangeType& accessor) override;
  ...
  /** Sets this choice's choice to be X_Path and initializes X_Path to be the specified value
    ...
    * @return A reference to the object on which this method was called.
    */
  uci::type::ProductTypeFilterType& setX_Path(const uci::type::VisibleString1024Type& value) override;
  ...
  /** Sets this choice's choice to be X_Path and initializes X_Path to be the specified value
    ...
    * @return A reference to the object on which this method was called.
    */
  uci::type::ProductTypeFilterType& setX_Path(const std::string& value) override;
  ...
  /** Sets this choice's choice to be X_Path and initializes X_Path to be the specified value
    ...
    * @return A reference to the object on which this method was called.
    */
  uci::type::ProductTypeFilterType& setX_Path(const char * value) override;
  ...
  /** 
    ...
    * @return .
    */
  static std::unique_ptr<ProductTypeFilterType> create(uci::base::accessorType::AccessorType type);
  ...
  /** 
    ...
    * @param topLevel .
    */
  static void deserialize(const boost::property_tree::ptree& propTree, uci::type::ProductTypeFilterType& accessor, std::string& nodeName, std::string& nsPrefix, bool topLevel = false);
  ...
  /** 
    ...
    * @return .
    */
  static std::string serialize(const uci::type::ProductTypeFilterType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, bool createNode = true, bool addTypeAttribute = false, bool checkIfDerivation = true, bool topLevel = false);
...
#endif // ASB_UCI_TYPE_PRODUCTTYPEFILTERTYPE_H
