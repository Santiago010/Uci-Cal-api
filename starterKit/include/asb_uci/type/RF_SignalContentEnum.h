...
using RF_SignalContentEnum = asb_uci::base::EnumAccessor<uci::type::RF_SignalContentEnum, uci::type::accessorType::rF_SignalContentEnum>;

} // namespace type

} // namespace asb_uci

#endif // ASB_UCI_TYPE_RF_SIGNALCONTENTENUM_H
