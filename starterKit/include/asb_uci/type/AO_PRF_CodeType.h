...
#ifndef ASB_UCI_TYPE_AO_PRF_CODETYPE_H
#define ASB_UCI_TYPE_AO_PRF_CODETYPE_H
...
/** Joint Pub 3-09.1 defines the PRF Code to be: "...Depending on the laser equipment, either a three or four-digit code
  ...
  */
using AO_PRF_CodeType = asb_xs::String;

} // namespace type

} // namespace asb_uci

#endif // ASB_UCI_TYPE_AO_PRF_CODETYPE_H
