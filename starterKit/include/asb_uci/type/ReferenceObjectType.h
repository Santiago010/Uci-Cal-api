...
#ifndef ASB_UCI_TYPE_REFERENCEOBJECTTYPE_H
#define ASB_UCI_TYPE_REFERENCEOBJECTTYPE_H
...
class ReferenceObjectType : public virtual uci::type::ReferenceObjectType {
public:
  /** The constructor */
  ReferenceObjectType();
  ...
  /** The copy constructor
    ...
    */
  ReferenceObjectType(const ReferenceObjectType& rhs) = delete;

  /** The move constructor
    *
    * @param rhs The ReferenceObjectType to move from
    */
  ReferenceObjectType(ReferenceObjectType&& rhs) = delete;

  /** The assignment operator [not supported]
    *
    * @param rhs The ReferenceObjectType to copy from
    * @return The ReferenceObjectType that was assigned
    */
  ReferenceObjectType& operator=(const ReferenceObjectType& rhs) = delete;
  ...
  /** The move assignment operator
    ...
    * @return The ReferenceObjectType that was assigned
    */
  ReferenceObjectType& operator=(ReferenceObjectType&& rhs) = delete;
  ...
  /** Performs a deep copy of the message data from the specified accessor into the object being operated on by copy(). Any
    ...
    *
    * @param accessor The uci::type::ReferenceObjectType whose contents are to be used to set this
    *      uci::type::ReferenceObjectType's contents.
    */
  void copy(const uci::type::ReferenceObjectType& accessor) override;
  ...
  /** Performs a deep copy of the message data from the specified accessor into the object being operated on by copy(). Any
    ...
    */
  void copyImpl(const uci::type::ReferenceObjectType& accessor, bool checkIfDerivation);
  ...
  /** This method returns this choice's "selection ordinal." A choice's "selection ordinal" is used to specify which
    ...
    */
  uci::type::ReferenceObjectType::ReferenceObjectTypeChoice getReferenceObjectTypeChoiceOrdinal() const noexcept override;
  ...
  /** This method is used to set this choice's "selection ordinal." A choice's "selection ordinal" is used to specify which
    ...
    */
  uci::type::ReferenceObjectType& setReferenceObjectTypeChoiceOrdinal(uci::type::ReferenceObjectType::ReferenceObjectTypeChoice ordinal, uci::base::accessorType::AccessorType type = uci::base::accessorType::null) override;
  ...
  /** Sets this choice's choice to be entityID and initializes entityID to be the specified value. A deep copy will be used
    ...
    * @return A reference to the object on which this method was called.
    */
  uci::type::ReferenceObjectType& setEntityID(const uci::type::EntityID_Type& accessor) override;
  ...
  /** Sets this choice's choice to be opPointID and initializes opPointID to be the specified value. A deep copy will be
    ...
    * @return A reference to the object on which this method was called.
    */
  uci::type::ReferenceObjectType& setOpPointID(const uci::type::OpPointID_Type& accessor) override;
  ...
  /** Sets this choice's choice to be systemID and initializes systemID to be the specified value. A deep copy will be used
    ...
    * @return A reference to the object on which this method was called.
    */
  uci::type::ReferenceObjectType& setSystemID(const uci::type::SystemID_Type& accessor) override;
  ...
  /** 
    ...
    * @return .
    */
  static std::unique_ptr<ReferenceObjectType> create(uci::base::accessorType::AccessorType type);
  ...
  /** 
    ...
    * @param topLevel .
    */
  static void deserialize(const boost::property_tree::ptree& propTree, uci::type::ReferenceObjectType& accessor, std::string& nodeName, std::string& nsPrefix, bool topLevel = false);
  ...
  /** 
    ...
    * @return .
    */
  static std::string serialize(const uci::type::ReferenceObjectType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, bool createNode = true, bool addTypeAttribute = false, bool checkIfDerivation = true, bool topLevel = false);
...
#endif // ASB_UCI_TYPE_REFERENCEOBJECTTYPE_H
