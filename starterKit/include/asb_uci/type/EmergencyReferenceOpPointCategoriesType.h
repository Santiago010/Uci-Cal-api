...
#ifndef ASB_UCI_TYPE_EMERGENCYREFERENCEOPPOINTCATEGORIESTYPE_H
#define ASB_UCI_TYPE_EMERGENCYREFERENCEOPPOINTCATEGORIESTYPE_H
...
/** Container object for the different types of OpPoint*Enums, excluding Emergency. A separate enum applies to each of
  * the choice types.
  */
class EmergencyReferenceOpPointCategoriesType : public virtual uci::type::EmergencyReferenceOpPointCategoriesType {
public:
  /** The constructor */
  ...
  /** The copy constructor
    ...
    */
  EmergencyReferenceOpPointCategoriesType(const EmergencyReferenceOpPointCategoriesType& rhs) = delete;

  /** The move constructor
    *
    * @param rhs The EmergencyReferenceOpPointCategoriesType to move from
    */
  EmergencyReferenceOpPointCategoriesType(EmergencyReferenceOpPointCategoriesType&& rhs) = delete;

  /** The assignment operator [not supported]
    *
    * @param rhs The EmergencyReferenceOpPointCategoriesType to copy from
    * @return The EmergencyReferenceOpPointCategoriesType that was assigned
    */
  EmergencyReferenceOpPointCategoriesType& operator=(const EmergencyReferenceOpPointCategoriesType& rhs) = delete;
  ...
  /** The move assignment operator
    ...
    * @return The EmergencyReferenceOpPointCategoriesType that was assigned
    */
  EmergencyReferenceOpPointCategoriesType& operator=(EmergencyReferenceOpPointCategoriesType&& rhs) = delete;
  ...
  /** Performs a deep copy of the message data from the specified accessor into the object being operated on by copy(). Any
    ...
    *
    * @param accessor The uci::type::EmergencyReferenceOpPointCategoriesType whose contents are to be used to set this
    *      uci::type::EmergencyReferenceOpPointCategoriesType's contents.
    */
  void copy(const uci::type::EmergencyReferenceOpPointCategoriesType& accessor) override;
  ...
  /** Performs a deep copy of the message data from the specified accessor into the object being operated on by copy(). Any
    ...
    */
  void copyImpl(const uci::type::EmergencyReferenceOpPointCategoriesType& accessor, bool checkIfDerivation);
  ...
  /** This method returns this choice's "selection ordinal." A choice's "selection ordinal" is used to specify which
    ...
    */
  uci::type::EmergencyReferenceOpPointCategoriesType::EmergencyReferenceOpPointCategoriesTypeChoice getEmergencyReferenceOpPointCategoriesTypeChoiceOrdinal() const noexcept override;
  ...
  /** This method is used to set this choice's "selection ordinal." A choice's "selection ordinal" is used to specify which
    ...
    */
  uci::type::EmergencyReferenceOpPointCategoriesType& setEmergencyReferenceOpPointCategoriesTypeChoiceOrdinal(uci::type::EmergencyReferenceOpPointCategoriesType::EmergencyReferenceOpPointCategoriesTypeChoice ordinal, uci::base::accessorType::AccessorType type = uci::base::accessorType::null) override;
  ...
  /** Sets this choice's choice to be General and initializes General to be the specified value
    ...
    * @return A reference to the object on which this method was called.
    */
  uci::type::EmergencyReferenceOpPointCategoriesType& setGeneral(const uci::type::OpPointGeneralEnum& accessor) override;
  ...
  /** Sets this choice's choice to be General and initializes General to be the specified value
    ...
    * @return A reference to the object on which this method was called.
    */
  uci::type::EmergencyReferenceOpPointCategoriesType& setGeneral(uci::type::OpPointGeneralEnum::EnumerationItem value) override;
  ...
  /** Sets this choice's choice to be Hazard and initializes Hazard to be the specified value
    ...
    * @return A reference to the object on which this method was called.
    */
  uci::type::EmergencyReferenceOpPointCategoriesType& setHazard(const uci::type::OpPointHazardEnum& accessor) override;
  ...
  /** Sets this choice's choice to be Hazard and initializes Hazard to be the specified value
    ...
    * @return A reference to the object on which this method was called.
    */
  uci::type::EmergencyReferenceOpPointCategoriesType& setHazard(uci::type::OpPointHazardEnum::EnumerationItem value) override;
  ...
  /** Sets this choice's choice to be Reference and initializes Reference to be the specified value
    ...
    * @return A reference to the object on which this method was called.
    */
  uci::type::EmergencyReferenceOpPointCategoriesType& setReference(const uci::type::OpPointReferenceEnum& accessor) override;
  ...
  /** Sets this choice's choice to be Reference and initializes Reference to be the specified value
    ...
    * @return A reference to the object on which this method was called.
    */
  uci::type::EmergencyReferenceOpPointCategoriesType& setReference(uci::type::OpPointReferenceEnum::EnumerationItem value) override;
  ...
  /** Sets this choice's choice to be Station and initializes Station to be the specified value
    ...
    * @return A reference to the object on which this method was called.
    */
  uci::type::EmergencyReferenceOpPointCategoriesType& setStation(const uci::type::OpPointStationEnum& accessor) override;
  ...
  /** Sets this choice's choice to be Station and initializes Station to be the specified value
    ...
    * @return A reference to the object on which this method was called.
    */
  uci::type::EmergencyReferenceOpPointCategoriesType& setStation(uci::type::OpPointStationEnum::EnumerationItem value) override;
  ...
  /** 
    ...
    * @return .
    */
  static std::unique_ptr<EmergencyReferenceOpPointCategoriesType> create(uci::base::accessorType::AccessorType type);
  ...
  /** 
    ...
    * @param topLevel .
    */
  static void deserialize(const boost::property_tree::ptree& propTree, uci::type::EmergencyReferenceOpPointCategoriesType& accessor, std::string& nodeName, std::string& nsPrefix, bool topLevel = false);
  ...
  /** 
    ...
    * @return .
    */
  static std::string serialize(const uci::type::EmergencyReferenceOpPointCategoriesType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, bool createNode = true, bool addTypeAttribute = false, bool checkIfDerivation = true, bool topLevel = false);
...
#endif // ASB_UCI_TYPE_EMERGENCYREFERENCEOPPOINTCATEGORIESTYPE_H
