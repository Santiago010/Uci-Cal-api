...
#ifndef ASB_UCI_TYPE_ASSETTYPE_H
#define ASB_UCI_TYPE_ASSETTYPE_H
...
/** Provides a choice between a System and an Entity. */
class AssetType : public virtual uci::type::AssetType {
public:
  /** The constructor */
  AssetType();
  ...
  /** The move constructor
    *
    * @param rhs The AssetType to move from
    */
  ...
  /** The assignment operator [not supported]
    *
    * @param rhs The AssetType to copy from
    * @return The AssetType that was assigned
    */
  AssetType& operator=(const AssetType& rhs) = delete;
  ...
  /** The move assignment operator
    ...
    * @return The AssetType that was assigned
    */
  AssetType& operator=(AssetType&& rhs) = delete;
  ...
  /** Performs a deep copy of the message data from the specified accessor into the object being operated on by copy(). Any
    ...
    *
    * @param accessor The uci::type::AssetType whose contents are to be used to set this uci::type::AssetType's contents.
    */
  void copy(const uci::type::AssetType& accessor) override;
  ...
  /** Performs a deep copy of the message data from the specified accessor into the object being operated on by copy(). Any
    ...
    */
  void copyImpl(const uci::type::AssetType& accessor, bool checkIfDerivation);
  ...
  /** This method returns this choice's "selection ordinal." A choice's "selection ordinal" is used to specify which
    ...
    */
  uci::type::AssetType::AssetTypeChoice getAssetTypeChoiceOrdinal() const noexcept override;
  ...
  /** This method is used to set this choice's "selection ordinal." A choice's "selection ordinal" is used to specify which
    ...
    */
  uci::type::AssetType& setAssetTypeChoiceOrdinal(uci::type::AssetType::AssetTypeChoice ordinal, uci::base::accessorType::AccessorType type = uci::base::accessorType::null) override;
  ...
  /** Sets this choice's choice to be systemID and initializes systemID to be the specified value. A deep copy will be used
    ...
    * @return A reference to the object on which this method was called.
    */
  uci::type::AssetType& setSystemID(const uci::type::SystemID_Type& accessor) override;
  ...
  /** Sets this choice's choice to be entityID and initializes entityID to be the specified value. A deep copy will be used
    ...
    * @return A reference to the object on which this method was called.
    */
  uci::type::AssetType& setEntityID(const uci::type::EntityID_Type& accessor) override;
  ...
  /** 
    ...
    * @return .
    */
  static std::unique_ptr<AssetType> create(uci::base::accessorType::AccessorType type);
  ...
  /** 
    ...
    * @param topLevel .
    */
  static void deserialize(const boost::property_tree::ptree& propTree, uci::type::AssetType& accessor, std::string& nodeName, std::string& nsPrefix, bool topLevel = false);
  ...
  /** 
    ...
    * @return .
    */
  static std::string serialize(const uci::type::AssetType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, bool createNode = true, bool addTypeAttribute = false, bool checkIfDerivation = true, bool topLevel = false);
...
#endif // ASB_UCI_TYPE_ASSETTYPE_H
