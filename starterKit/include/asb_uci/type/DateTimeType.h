...
#ifndef ASB_UCI_TYPE_DATETIMETYPE_H
#define ASB_UCI_TYPE_DATETIMETYPE_H

#include "asb_uci/base/DateTimeAccessor.h"
...
/** UCI uses the W3C (www.w3.org) definition of date and time exactly as given in the specification for xs:dateTime with
  ...
  */
using DateTimeType = asb_uci::base::DateTimeAccessor;
using DateTimeTypeValue = asb_xs::DateTime;

} // namespace type

} // namespace asb_uci

#endif // ASB_UCI_TYPE_DATETIMETYPE_H
