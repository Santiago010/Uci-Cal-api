...
#ifndef ASB_UCI_TYPE_PO_TARGETTYPE_H
#define ASB_UCI_TYPE_PO_TARGETTYPE_H
...
/** Indicates the position or location to point the XX Subsystem to do a XX collection, track, or search as part of an XX
  ...
  */
class PO_TargetType : public virtual uci::type::PO_TargetType {
public:
  ...
  /** The copy constructor
    ...
    */
  PO_TargetType(const PO_TargetType& rhs) = delete;

  /** The move constructor
    *
    * @param rhs The PO_TargetType to move from
    */
  PO_TargetType(PO_TargetType&& rhs) = delete;

  /** The assignment operator [not supported]
    *
    * @param rhs The PO_TargetType to copy from
    * @return The PO_TargetType that was assigned
    */
  PO_TargetType& operator=(const PO_TargetType& rhs) = delete;
  ...
  /** The move assignment operator
    ...
    * @return The PO_TargetType that was assigned
    */
  PO_TargetType& operator=(PO_TargetType&& rhs) = delete;
  ...
  /** Performs a deep copy of the message data from the specified accessor into the object being operated on by copy(). Any
    ...
    *
    * @param accessor The uci::type::PO_TargetType whose contents are to be used to set this uci::type::PO_TargetType's
    *      contents.
    */
  void copy(const uci::type::PO_TargetType& accessor) override;
  ...
  /** Performs a deep copy of the message data from the specified accessor into the object being operated on by copy(). Any
    ...
    */
  void copyImpl(const uci::type::PO_TargetType& accessor, bool checkIfDerivation);
  ...
  /** This method returns this choice's "selection ordinal." A choice's "selection ordinal" is used to specify which
    ...
    */
  uci::type::PO_TargetType::PO_TargetTypeChoice getPO_TargetTypeChoiceOrdinal() const noexcept override;
  ...
  /** This method is used to set this choice's "selection ordinal." A choice's "selection ordinal" is used to specify which
    ...
    */
  uci::type::PO_TargetType& setPO_TargetTypeChoiceOrdinal(uci::type::PO_TargetType::PO_TargetTypeChoice ordinal, uci::base::accessorType::AccessorType type = uci::base::accessorType::null) override;
  ...
  /** Returns the accessor to the Geospatial item contained in this message fragment
    ...
    */
  uci::type::PO_TargetType::Geospatial& getGeospatial_() const;

  /** Returns the accessor to the Geospatial item contained in this message fragment
    *
    * @return The const reference to the accessor to the Geospatial item.
    */
  const uci::type::PO_TargetType::Geospatial& getGeospatial() const override;

  /** Returns the accessor to the Geospatial item contained in this message fragment
    *
    * @return The reference to the accessor to the Geospatial item.
    */
  uci::type::PO_TargetType::Geospatial& getGeospatial() override;
  ...
  /** Set the contents of the message fragment that this accesssor provides access to to the contents the specified
    ...
    * @return A reference to the object on which this method was called.
    */
  uci::type::PO_TargetType& setGeospatial(const uci::type::PO_TargetType::Geospatial& accessor) override;
  ...
  /** Sets this choice's "selection ordinal" to the choice identified by Geospatial.
    ...
    */
  uci::type::PO_TargetType::Geospatial& chooseGeospatial() override;

  /** Returns the accessor to the Pointed field contained in this message fragment
    *
    * @return The const reference to the accessor to the Pointed field.
    */
  uci::type::TurretCommandPositionType& getPointed_() const;

  /** Returns the accessor to the Pointed field contained in this message fragment
    *
    * @return The reference to the accessor to the Pointed field.
    */
  const uci::type::TurretCommandPositionType& getPointed() const override;

  /** Returns the accessor to the Pointed field contained in this message fragment
    *
    * @return The reference to the accessor to the Pointed field.
    */
  uci::type::TurretCommandPositionType& getPointed() override;

  /** Sets this choice's choice to be pointed and initializes pointed to be the specified value. A deep copy will be used
    * by this method to set pointed
    *
    * @param accessor The accessor to use to set the contents of the message fragment that this accessor provides access
    *      to.
    * @return A reference to the object on which this method was called.
    */
  uci::type::PO_TargetType& setPointed(const uci::type::TurretCommandPositionType& accessor) override;
  ...
  /** Returns whether this choice's "selection ordinal" is set to the choice identified by Pointed.
    ...
    */
  bool isPointed() const noexcept override;
  ...
  /** Sets this choice's "selection ordinal" to the choice identified by Pointed.
    ...
    */
  uci::type::TurretCommandPositionType& choosePointed(const std::string& method, uci::base::accessorType::AccessorType type = uci::base::accessorType::null);
  ...
  /** Sets this choice's "selection ordinal" to the choice identified by Pointed.
    ...
    * @return A reference to the accessor that provides access to the choice identified by Pointed.
    */
  uci::type::TurretCommandPositionType& choosePointed(uci::base::accessorType::AccessorType type = uci::base::accessorType::null) override;
  ...
  /** Sets this choice's choice to be LOS_Option and initializes LOS_Option to be the specified value. A deep copy will be
    ...
    * @return A reference to the object on which this method was called.
    */
  uci::type::PO_TargetType& setLOS_Option(const uci::type::LOS_D_Type& accessor) override;
  ...
  /** Returns the accessor to the Volume item contained in this message fragment
    ...
    */
  uci::type::PO_TargetType::Volume& getVolume_() const;

  /** Returns the accessor to the Volume item contained in this message fragment
    *
    * @return The const reference to the accessor to the Volume item.
    */
  const uci::type::PO_TargetType::Volume& getVolume() const override;

  /** Returns the accessor to the Volume item contained in this message fragment
    *
    * @return The reference to the accessor to the Volume item.
    */
  uci::type::PO_TargetType::Volume& getVolume() override;
  ...
  /** Set the contents of the message fragment that this accesssor provides access to to the contents the specified
    ...
    * @return A reference to the object on which this method was called.
    */
  uci::type::PO_TargetType& setVolume(const uci::type::PO_TargetType::Volume& accessor) override;
  ...
  /** Sets this choice's "selection ordinal" to the choice identified by Volume.
    ...
    */
  uci::type::PO_TargetType::Volume& chooseVolume() override;
  ...
  /** Sets this choice's choice to be TurretSlaved and initializes TurretSlaved to be the specified value
    ...
    * @return A reference to the object on which this method was called.
    */
  uci::type::PO_TargetType& setTurretSlaved(const uci::type::EmptyType& value) override;
  ...
  /** Sets this choice's choice to be TurretSlaved and initializes TurretSlaved to be the specified value
    ...
    * @return A reference to the object on which this method was called.
    */
  uci::type::PO_TargetType& setTurretSlaved(const std::string& value) override;
  ...
  /** Sets this choice's choice to be TurretSlaved and initializes TurretSlaved to be the specified value
    ...
    * @return A reference to the object on which this method was called.
    */
  uci::type::PO_TargetType& setTurretSlaved(const char * value) override;
  ...
  /** Sets this choice's choice to be activitySlavedID and initializes activitySlavedID to be the specified value. A deep
    ...
    * @return A reference to the object on which this method was called.
    */
  uci::type::PO_TargetType& setActivitySlavedID(const uci::type::ActivityID_Type& accessor) override;
  ...
  /** Sets this choice's choice to be FixedPointing and initializes FixedPointing to be the specified value
    ...
    * @return A reference to the object on which this method was called.
    */
  uci::type::PO_TargetType& setFixedPointing(const uci::type::FixedPointingEnum& accessor) override;
  ...
  /** Sets this choice's choice to be FixedPointing and initializes FixedPointing to be the specified value
    ...
    * @return A reference to the object on which this method was called.
    */
  uci::type::PO_TargetType& setFixedPointing(uci::type::FixedPointingEnum::EnumerationItem value) override;
  ...
  /** 
    ...
    * @return .
    */
  static std::unique_ptr<PO_TargetType> create(uci::base::accessorType::AccessorType type);
  ...
  /** 
    ...
    * @param topLevel .
    */
  static void deserialize(const boost::property_tree::ptree& propTree, uci::type::PO_TargetType& accessor, std::string& nodeName, std::string& nsPrefix, bool topLevel = false);
  ...
  /** 
    ...
    * @return .
    */
  static std::string serialize(const uci::type::PO_TargetType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, bool createNode = true, bool addTypeAttribute = false, bool checkIfDerivation = true, bool topLevel = false);

private:
  std::unique_ptr<Geospatial> geospatial_Accessor;
  std::unique_ptr<TurretCommandPositionType> pointed_Accessor;
...
#endif // ASB_UCI_TYPE_PO_TARGETTYPE_H
