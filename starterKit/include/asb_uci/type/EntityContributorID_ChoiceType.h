...
#ifndef ASB_UCI_TYPE_ENTITYCONTRIBUTORID_CHOICETYPE_H
#define ASB_UCI_TYPE_ENTITYCONTRIBUTORID_CHOICETYPE_H
...
/** Indicates the contributors to the fused entity. This type allows specifying non-Entity contributors if a fusion
  ...
  */
class EntityContributorID_ChoiceType : public virtual uci::type::EntityContributorID_ChoiceType {
public:
  /** The constructor */
  ...
  /** The copy constructor
    ...
    */
  EntityContributorID_ChoiceType(const EntityContributorID_ChoiceType& rhs) = delete;

  /** The move constructor
    *
    * @param rhs The EntityContributorID_ChoiceType to move from
    */
  EntityContributorID_ChoiceType(EntityContributorID_ChoiceType&& rhs) = delete;

  /** The assignment operator [not supported]
    *
    * @param rhs The EntityContributorID_ChoiceType to copy from
    * @return The EntityContributorID_ChoiceType that was assigned
    */
  EntityContributorID_ChoiceType& operator=(const EntityContributorID_ChoiceType& rhs) = delete;
  ...
  /** The move assignment operator
    ...
    * @return The EntityContributorID_ChoiceType that was assigned
    */
  EntityContributorID_ChoiceType& operator=(EntityContributorID_ChoiceType&& rhs) = delete;

  /** The destructor */
  virtual ~EntityContributorID_ChoiceType();

  /** Performs a deep copy of the message data from the specified accessor into the object being operated on by copy(). Any
    * message data originally held by this object will be freed prior to the copy
    *
    * @param accessor The uci::type::EntityContributorID_ChoiceType whose contents are to be used to set this
    *      uci::type::EntityContributorID_ChoiceType's contents.
    */
  void copy(const uci::type::EntityContributorID_ChoiceType& accessor) override;
  ...
  /** Performs a deep copy of the message data from the specified accessor into the object being operated on by copy(). Any
    ...
    */
  void copyImpl(const uci::type::EntityContributorID_ChoiceType& accessor, bool checkIfDerivation);
  ...
  /** This method returns this choice's "selection ordinal." A choice's "selection ordinal" is used to specify which
    ...
    */
  uci::type::EntityContributorID_ChoiceType::EntityContributorID_ChoiceTypeChoice getEntityContributorID_ChoiceTypeChoiceOrdinal() const noexcept override;
  ...
  /** This method is used to set this choice's "selection ordinal." A choice's "selection ordinal" is used to specify which
    ...
    */
  uci::type::EntityContributorID_ChoiceType& setEntityContributorID_ChoiceTypeChoiceOrdinal(uci::type::EntityContributorID_ChoiceType::EntityContributorID_ChoiceTypeChoice ordinal, uci::base::accessorType::AccessorType type = uci::base::accessorType::null) override;
  ...
  /** Sets this choice's choice to be entityID and initializes entityID to be the specified value. A deep copy will be used
    ...
    * @return A reference to the object on which this method was called.
    */
  uci::type::EntityContributorID_ChoiceType& setEntityID(const uci::type::EntityID_Type& accessor) override;
  ...
  /** Returns the accessor to the EOB_EmitterID field contained in this message fragment
    *
    * @return The const reference to the accessor to the EOB_EmitterID field.
    */
  uci::type::EOB_EmitterID_Type& getEOB_EmitterID_() const;

  /** Returns the accessor to the EOB_EmitterID field contained in this message fragment
    *
    * @return The reference to the accessor to the EOB_EmitterID field.
    */
  const uci::type::EOB_EmitterID_Type& getEOB_EmitterID() const override;

  /** Returns the accessor to the EOB_EmitterID field contained in this message fragment
    *
    * @return The reference to the accessor to the EOB_EmitterID field.
    */
  uci::type::EOB_EmitterID_Type& getEOB_EmitterID() override;

  /** Sets this choice's choice to be eOB_EmitterID and initializes eOB_EmitterID to be the specified value. A deep copy
    * will be used by this method to set eOB_EmitterID
    *
    * @param accessor The accessor to use to set the contents of the message fragment that this accessor provides access
    *      to.
    * @return A reference to the object on which this method was called.
    */
  uci::type::EntityContributorID_ChoiceType& setEOB_EmitterID(const uci::type::EOB_EmitterID_Type& accessor) override;
  ...
  /** Returns whether this choice's "selection ordinal" is set to the choice identified by EOB_EmitterID.
    ...
    */
  bool isEOB_EmitterID() const noexcept override;
  ...
  /** Sets this choice's "selection ordinal" to the choice identified by EOB_EmitterID.
    ...
    */
  uci::type::EOB_EmitterID_Type& chooseEOB_EmitterID(const std::string& method, uci::base::accessorType::AccessorType type = uci::base::accessorType::null);
  ...
  /** Sets this choice's "selection ordinal" to the choice identified by EOB_EmitterID.
    ...
    * @return A reference to the accessor that provides access to the choice identified by EOB_EmitterID.
    */
  uci::type::EOB_EmitterID_Type& chooseEOB_EmitterID(uci::base::accessorType::AccessorType type = uci::base::accessorType::null) override;
  ...
  /** Sets this choice's choice to be systemID and initializes systemID to be the specified value. A deep copy will be used
    ...
    * @return A reference to the object on which this method was called.
    */
  uci::type::EntityContributorID_ChoiceType& setSystemID(const uci::type::SystemID_Type& accessor) override;
  ...
  /** Sets this choice's choice to be signalID and initializes signalID to be the specified value. A deep copy will be used
    ...
    * @return A reference to the object on which this method was called.
    */
  uci::type::EntityContributorID_ChoiceType& setSignalID(const uci::type::SignalID_Type& accessor) override;
  ...
  /** Sets this choice's choice to be sOB_C2_RecordID and initializes sOB_C2_RecordID to be the specified value. A deep
    ...
    * @return A reference to the object on which this method was called.
    */
  uci::type::EntityContributorID_ChoiceType& setSOB_C2_RecordID(const uci::type::SOB_C2_RecordID_Type& accessor) override;
  ...
  /** Sets this choice's choice to be sOB_SatelliteRecordID and initializes sOB_SatelliteRecordID to be the specified
    ...
    * @return A reference to the object on which this method was called.
    */
  uci::type::EntityContributorID_ChoiceType& setSOB_SatelliteRecordID(const uci::type::SOB_SatelliteRecordID_Type& accessor) override;
  ...
  /** Returns the accessor to the MeasurementID field contained in this message fragment
    ...
    */
  uci::type::MeasurementID_Type& getMeasurementID_() const;
  ...
  /** Sets this choice's choice to be measurementID and initializes measurementID to be the specified value. A deep copy
    * will be used by this method to set measurementID
    *
    * @param accessor The accessor to use to set the contents of the message fragment that this accessor provides access
    *      to.
    * @return A reference to the object on which this method was called.
    */
  uci::type::EntityContributorID_ChoiceType& setMeasurementID(const uci::type::MeasurementID_Type& accessor) override;
  ...
  /** Returns whether this choice's "selection ordinal" is set to the choice identified by MeasurementID.
    ...
    */
  bool isMeasurementID() const noexcept override;
  ...
  /** Sets this choice's "selection ordinal" to the choice identified by MeasurementID.
    ...
    */
  uci::type::MeasurementID_Type& chooseMeasurementID(const std::string& method, uci::base::accessorType::AccessorType type = uci::base::accessorType::null);
  ...
  /** Sets this choice's "selection ordinal" to the choice identified by MeasurementID.
    ...
    * @return A reference to the accessor that provides access to the choice identified by MeasurementID.
    */
  uci::type::MeasurementID_Type& chooseMeasurementID(uci::base::accessorType::AccessorType type = uci::base::accessorType::null) override;
  ...
  /** 
    ...
    * @return .
    */
  static std::unique_ptr<EntityContributorID_ChoiceType> create(uci::base::accessorType::AccessorType type);
  ...
  /** 
    ...
    * @param topLevel .
    */
  static void deserialize(const boost::property_tree::ptree& propTree, uci::type::EntityContributorID_ChoiceType& accessor, std::string& nodeName, std::string& nsPrefix, bool topLevel = false);
  ...
  /** 
    ...
    * @return .
    */
  static std::string serialize(const uci::type::EntityContributorID_ChoiceType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, bool createNode = true, bool addTypeAttribute = false, bool checkIfDerivation = true, bool topLevel = false);

private:
  std::unique_ptr<EntityID_Type> entityID_Accessor;
  std::unique_ptr<EOB_EmitterID_Type> eOB_EmitterID_Accessor;
...
#endif // ASB_UCI_TYPE_ENTITYCONTRIBUTORID_CHOICETYPE_H
