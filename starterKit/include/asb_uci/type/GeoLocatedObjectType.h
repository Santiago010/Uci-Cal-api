...
#ifndef ASB_UCI_TYPE_GEOLOCATEDOBJECTTYPE_H
#define ASB_UCI_TYPE_GEOLOCATEDOBJECTTYPE_H
...
class GeoLocatedObjectType : public virtual uci::type::GeoLocatedObjectType {
public:
  /** The constructor */
  ...
  /** The copy constructor
    ...
    */
  GeoLocatedObjectType(const GeoLocatedObjectType& rhs) = delete;

  /** The move constructor
    *
    * @param rhs The GeoLocatedObjectType to move from
    */
  GeoLocatedObjectType(GeoLocatedObjectType&& rhs) = delete;

  /** The assignment operator [not supported]
    *
    * @param rhs The GeoLocatedObjectType to copy from
    * @return The GeoLocatedObjectType that was assigned
    */
  GeoLocatedObjectType& operator=(const GeoLocatedObjectType& rhs) = delete;
  ...
  /** The move assignment operator
    ...
    * @return The GeoLocatedObjectType that was assigned
    */
  GeoLocatedObjectType& operator=(GeoLocatedObjectType&& rhs) = delete;
  ...
  /** Performs a deep copy of the message data from the specified accessor into the object being operated on by copy(). Any
    ...
    *
    * @param accessor The uci::type::GeoLocatedObjectType whose contents are to be used to set this
    *      uci::type::GeoLocatedObjectType's contents.
    */
  void copy(const uci::type::GeoLocatedObjectType& accessor) override;
  ...
  /** Performs a deep copy of the message data from the specified accessor into the object being operated on by copy(). Any
    ...
    */
  void copyImpl(const uci::type::GeoLocatedObjectType& accessor, bool checkIfDerivation);
  ...
  /** This method returns this choice's "selection ordinal." A choice's "selection ordinal" is used to specify which
    ...
    */
  uci::type::GeoLocatedObjectType::GeoLocatedObjectTypeChoice getGeoLocatedObjectTypeChoiceOrdinal() const noexcept override;
  ...
  /** This method is used to set this choice's "selection ordinal." A choice's "selection ordinal" is used to specify which
    ...
    */
  uci::type::GeoLocatedObjectType& setGeoLocatedObjectTypeChoiceOrdinal(uci::type::GeoLocatedObjectType::GeoLocatedObjectTypeChoice ordinal, uci::base::accessorType::AccessorType type = uci::base::accessorType::null) override;
  ...
  /** Sets this choice's choice to be entityID and initializes entityID to be the specified value. A deep copy will be used
    ...
    * @return A reference to the object on which this method was called.
    */
  uci::type::GeoLocatedObjectType& setEntityID(const uci::type::EntityID_Type& accessor) override;
  ...
  /** Sets this choice's choice to be systemID and initializes systemID to be the specified value. A deep copy will be used
    ...
    * @return A reference to the object on which this method was called.
    */
  uci::type::GeoLocatedObjectType& setSystemID(const uci::type::SystemID_Type& accessor) override;
  ...
  /** Sets this choice's choice to be opPointID and initializes opPointID to be the specified value. A deep copy will be
    ...
    * @return A reference to the object on which this method was called.
    */
  uci::type::GeoLocatedObjectType& setOpPointID(const uci::type::OpPointID_Type& accessor) override;
  ...
  /** Sets this choice's choice to be opLineID and initializes opLineID to be the specified value. A deep copy will be used
    ...
    * @return A reference to the object on which this method was called.
    */
  uci::type::GeoLocatedObjectType& setOpLineID(const uci::type::OpLineID_Type& accessor) override;
  ...
  /** Sets this choice's choice to be opZoneID and initializes opZoneID to be the specified value. A deep copy will be used
    ...
    * @return A reference to the object on which this method was called.
    */
  uci::type::GeoLocatedObjectType& setOpZoneID(const uci::type::OpZoneID_Type& accessor) override;
  ...
  /** Sets this choice's choice to be opVolumeID and initializes opVolumeID to be the specified value. A deep copy will be
    ...
    * @return A reference to the object on which this method was called.
    */
  uci::type::GeoLocatedObjectType& setOpVolumeID(const uci::type::OpVolumeID_Type& accessor) override;
  ...
  /** Sets this choice's choice to be dMPI_ID and initializes dMPI_ID to be the specified value. A deep copy will be used
    * by this method to set dMPI_ID
    *
    * @param accessor The accessor to use to set the contents of the message fragment that this accessor provides access
    *      to.
    * @return A reference to the object on which this method was called.
    */
  uci::type::GeoLocatedObjectType& setDMPI_ID(const uci::type::DMPI_ID_Type& accessor) override;
  ...
  /** Sets this choice's "selection ordinal" to the choice identified by DMPI_ID.
    ...
    */
  uci::type::DMPI_ID_Type& chooseDMPI_ID(const std::string& method, uci::base::accessorType::AccessorType type = uci::base::accessorType::null);
  ...
  /** Sets this choice's "selection ordinal" to the choice identified by DMPI_ID.
    ...
    * @return A reference to the accessor that provides access to the choice identified by DMPI_ID.
    */
  uci::type::DMPI_ID_Type& chooseDMPI_ID(uci::base::accessorType::AccessorType type = uci::base::accessorType::null) override;
  ...
  /** Returns the accessor to the SignalReportID field contained in this message fragment
    ...
    */
  uci::type::SignalReportID_Type& getSignalReportID_() const;
  ...
  /** Sets this choice's choice to be signalReportID and initializes signalReportID to be the specified value. A deep copy
    * will be used by this method to set signalReportID
    *
    * @param accessor The accessor to use to set the contents of the message fragment that this accessor provides access
    *      to.
    * @return A reference to the object on which this method was called.
    */
  uci::type::GeoLocatedObjectType& setSignalReportID(const uci::type::SignalReportID_Type& accessor) override;
  ...
  /** Sets this choice's "selection ordinal" to the choice identified by SignalReportID.
    ...
    */
  uci::type::SignalReportID_Type& chooseSignalReportID(const std::string& method, uci::base::accessorType::AccessorType type = uci::base::accessorType::null);
  ...
  /** Sets this choice's "selection ordinal" to the choice identified by SignalReportID.
    ...
    * @return A reference to the accessor that provides access to the choice identified by SignalReportID.
    */
  uci::type::SignalReportID_Type& chooseSignalReportID(uci::base::accessorType::AccessorType type = uci::base::accessorType::null) override;
  ...
  /** 
    ...
    * @return .
    */
  static std::unique_ptr<GeoLocatedObjectType> create(uci::base::accessorType::AccessorType type);
  ...
  /** 
    ...
    * @param topLevel .
    */
  static void deserialize(const boost::property_tree::ptree& propTree, uci::type::GeoLocatedObjectType& accessor, std::string& nodeName, std::string& nsPrefix, bool topLevel = false);
  ...
  /** 
    ...
    * @return .
    */
  static std::string serialize(const uci::type::GeoLocatedObjectType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, bool createNode = true, bool addTypeAttribute = false, bool checkIfDerivation = true, bool topLevel = false);
...
#endif // ASB_UCI_TYPE_GEOLOCATEDOBJECTTYPE_H
