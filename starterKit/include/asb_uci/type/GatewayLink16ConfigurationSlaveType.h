/** @file GatewayLink16ConfigurationSlaveType.h
 *
...
#ifndef ASB_UCI_TYPE_GATEWAYLINK16CONFIGURATIONSLAVETYPE_H
#define ASB_UCI_TYPE_GATEWAYLINK16CONFIGURATIONSLAVETYPE_H
...
/** Identifies a geographically-located item to which a Link 16 filter is slaved, meaning that the filter's current
  ...
  */
class GatewayLink16ConfigurationSlaveType : public virtual uci::type::GatewayLink16ConfigurationSlaveType {
public:
  /** The constructor */
  ...
  /** The copy constructor
    ...
    */
  GatewayLink16ConfigurationSlaveType(const GatewayLink16ConfigurationSlaveType& rhs) = delete;

  /** The move constructor
    *
    * @param rhs The GatewayLink16ConfigurationSlaveType to move from
    */
  GatewayLink16ConfigurationSlaveType(GatewayLink16ConfigurationSlaveType&& rhs) = delete;

  /** The assignment operator [not supported]
    *
    * @param rhs The GatewayLink16ConfigurationSlaveType to copy from
    * @return The GatewayLink16ConfigurationSlaveType that was assigned
    */
  GatewayLink16ConfigurationSlaveType& operator=(const GatewayLink16ConfigurationSlaveType& rhs) = delete;
  ...
  /** The move assignment operator
    ...
    * @return The GatewayLink16ConfigurationSlaveType that was assigned
    */
  GatewayLink16ConfigurationSlaveType& operator=(GatewayLink16ConfigurationSlaveType&& rhs) = delete;
  ...
  /** Performs a deep copy of the message data from the specified accessor into the object being operated on by copy(). Any
    ...
    *
    * @param accessor The uci::type::GatewayLink16ConfigurationSlaveType whose contents are to be used to set this
    *      uci::type::GatewayLink16ConfigurationSlaveType's contents.
    */
  void copy(const uci::type::GatewayLink16ConfigurationSlaveType& accessor) override;
  ...
  /** Performs a deep copy of the message data from the specified accessor into the object being operated on by copy(). Any
    ...
    */
  void copyImpl(const uci::type::GatewayLink16ConfigurationSlaveType& accessor, bool checkIfDerivation);
  ...
  /** This method returns this choice's "selection ordinal." A choice's "selection ordinal" is used to specify which
    ...
    */
  uci::type::GatewayLink16ConfigurationSlaveType::GatewayLink16ConfigurationSlaveTypeChoice getGatewayLink16ConfigurationSlaveTypeChoiceOrdinal() const noexcept override;
  ...
  /** This method is used to set this choice's "selection ordinal." A choice's "selection ordinal" is used to specify which
    ...
    */
  uci::type::GatewayLink16ConfigurationSlaveType& setGatewayLink16ConfigurationSlaveTypeChoiceOrdinal(uci::type::GatewayLink16ConfigurationSlaveType::GatewayLink16ConfigurationSlaveTypeChoice ordinal, uci::base::accessorType::AccessorType type = uci::base::accessorType::null) override;
  ...
  /** Sets this choice's choice to be entityID and initializes entityID to be the specified value. A deep copy will be used
    ...
    * @return A reference to the object on which this method was called.
    */
  uci::type::GatewayLink16ConfigurationSlaveType& setEntityID(const uci::type::EntityID_Type& accessor) override;
  ...
  /** Sets this choice's choice to be operatorLocationOfInterestID and initializes operatorLocationOfInterestID to be the
    ...
    * @return A reference to the object on which this method was called.
    */
  uci::type::GatewayLink16ConfigurationSlaveType& setOperatorLocationOfInterestID(const uci::type::OperatorLocationOfInterestID_Type& accessor) override;
  ...
  /** Sets this choice's choice to be opPointID and initializes opPointID to be the specified value. A deep copy will be
    ...
    * @return A reference to the object on which this method was called.
    */
  uci::type::GatewayLink16ConfigurationSlaveType& setOpPointID(const uci::type::OpPointID_Type& accessor) override;
  ...
  /** Sets this choice's choice to be systemID and initializes systemID to be the specified value. A deep copy will be used
    ...
    * @return A reference to the object on which this method was called.
    */
  uci::type::GatewayLink16ConfigurationSlaveType& setSystemID(const uci::type::SystemID_Type& accessor) override;
  ...
  /** 
    ...
    * @return .
    */
  static std::unique_ptr<GatewayLink16ConfigurationSlaveType> create(uci::base::accessorType::AccessorType type);
  ...
  /** 
    ...
    * @param topLevel .
    */
  static void deserialize(const boost::property_tree::ptree& propTree, uci::type::GatewayLink16ConfigurationSlaveType& accessor, std::string& nodeName, std::string& nsPrefix, bool topLevel = false);
  ...
  /** 
    ...
    * @return .
    */
  static std::string serialize(const uci::type::GatewayLink16ConfigurationSlaveType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, bool createNode = true, bool addTypeAttribute = false, bool checkIfDerivation = true, bool topLevel = false);
...
#endif // ASB_UCI_TYPE_GATEWAYLINK16CONFIGURATIONSLAVETYPE_H
