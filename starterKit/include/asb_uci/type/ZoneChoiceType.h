...
#ifndef ASB_UCI_TYPE_ZONECHOICETYPE_H
#define ASB_UCI_TYPE_ZONECHOICETYPE_H
...
class ZoneChoiceType : public virtual uci::type::ZoneChoiceType {
public:
  /** The constructor */
  ZoneChoiceType();
  ...
  /** The copy constructor
    ...
    */
  ZoneChoiceType(const ZoneChoiceType& rhs) = delete;

  /** The move constructor
    *
    * @param rhs The ZoneChoiceType to move from
    */
  ZoneChoiceType(ZoneChoiceType&& rhs) = delete;

  /** The assignment operator [not supported]
    *
    * @param rhs The ZoneChoiceType to copy from
    * @return The ZoneChoiceType that was assigned
    */
  ZoneChoiceType& operator=(const ZoneChoiceType& rhs) = delete;
  ...
  /** The move assignment operator
    ...
    * @return The ZoneChoiceType that was assigned
    */
  ZoneChoiceType& operator=(ZoneChoiceType&& rhs) = delete;
  ...
  /** Performs a deep copy of the message data from the specified accessor into the object being operated on by copy(). Any
    ...
    *
    * @param accessor The uci::type::ZoneChoiceType whose contents are to be used to set this uci::type::ZoneChoiceType's
    *      contents.
    */
  void copy(const uci::type::ZoneChoiceType& accessor) override;
  ...
  /** Performs a deep copy of the message data from the specified accessor into the object being operated on by copy(). Any
    ...
    */
  void copyImpl(const uci::type::ZoneChoiceType& accessor, bool checkIfDerivation);
  ...
  /** This method returns this choice's "selection ordinal." A choice's "selection ordinal" is used to specify which
    ...
    */
  uci::type::ZoneChoiceType::ZoneChoiceTypeChoice getZoneChoiceTypeChoiceOrdinal() const noexcept override;
  ...
  /** This method is used to set this choice's "selection ordinal." A choice's "selection ordinal" is used to specify which
    ...
    */
  uci::type::ZoneChoiceType& setZoneChoiceTypeChoiceOrdinal(uci::type::ZoneChoiceType::ZoneChoiceTypeChoice ordinal, uci::base::accessorType::AccessorType type = uci::base::accessorType::null) override;
  ...
  /** Sets this choice's choice to be opZoneID and initializes opZoneID to be the specified value. A deep copy will be used
    ...
    * @return A reference to the object on which this method was called.
    */
  uci::type::ZoneChoiceType& setOpZoneID(const uci::type::OpZoneID_Type& accessor) override;
  ...
  /** Sets this choice's choice to be zoneTarget and initializes zoneTarget to be the specified value. A deep copy will be
    ...
    * @return A reference to the object on which this method was called.
    */
  uci::type::ZoneChoiceType& setZoneTarget(const uci::type::ZoneExternalType& accessor) override;
  ...
  /** 
    ...
    * @return .
    */
  static std::unique_ptr<ZoneChoiceType> create(uci::base::accessorType::AccessorType type);
  ...
  /** 
    ...
    * @param topLevel .
    */
  static void deserialize(const boost::property_tree::ptree& propTree, uci::type::ZoneChoiceType& accessor, std::string& nodeName, std::string& nsPrefix, bool topLevel = false);
  ...
  /** 
    ...
    * @return .
    */
  static std::string serialize(const uci::type::ZoneChoiceType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, bool createNode = true, bool addTypeAttribute = false, bool checkIfDerivation = true, bool topLevel = false);
...
#endif // ASB_UCI_TYPE_ZONECHOICETYPE_H
