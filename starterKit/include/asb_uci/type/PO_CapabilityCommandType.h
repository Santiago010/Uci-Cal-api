...
#ifndef ASB_UCI_TYPE_PO_CAPABILITYCOMMANDTYPE_H
#define ASB_UCI_TYPE_PO_CAPABILITYCOMMANDTYPE_H
...
class PO_CapabilityCommandType : public virtual uci::type::PO_CapabilityCommandType, public virtual CapabilityCommandBaseType {
public:
  ...
  /** The copy constructor
    ...
    */
  PO_CapabilityCommandType(const PO_CapabilityCommandType& rhs) = delete;

  /** The move constructor
    *
    * @param rhs The PO_CapabilityCommandType to move from
    */
  PO_CapabilityCommandType(PO_CapabilityCommandType&& rhs) = delete;

  /** The assignment operator
    *
    * @param rhs The PO_CapabilityCommandType to copy from
    * @return The PO_CapabilityCommandType that was assigned
    */
  PO_CapabilityCommandType& operator=(const PO_CapabilityCommandType& rhs) = delete;
  ...
  /** The move assignment operator
    ...
    * @return The PO_CapabilityCommandType that was assigned
    */
  PO_CapabilityCommandType& operator=(PO_CapabilityCommandType&& rhs) = delete;

  /** The destructor */
  ~PO_CapabilityCommandType() override;

  /** Performs a deep copy of the message data from the specified accessor into the object being operated on by copy(). Any
    * message data originally held by this object will be freed prior to the copy
    *
    * @param accessor The uci::type::PO_CapabilityCommandType whose contents are to be used to set this
    *      uci::type::PO_CapabilityCommandType's contents.
    */
  void copy(const uci::type::PO_CapabilityCommandType& accessor) override;
  ...
  /** Performs a deep copy of the message data from the specified accessor into the object being operated on by copy(). Any
    ...
    */
  void copyImpl(const uci::type::PO_CapabilityCommandType& accessor, bool checkIfDerivation);
  ...
  /** Set the contents of the message fragment that this accesssor provides access to to the contents the specified
    ...
    */
  uci::type::PO_CapabilityCommandType& setPointing(const uci::type::PO_TargetType& accessor) override;
  ...
  /** Clears the value of the optional field accessed by this accesor
    ...
    * @return A reference to the object on which this method was called.
    */
  uci::type::PO_CapabilityCommandType& clearPointing() noexcept override;
  ...
  /** Returns the accessor to the SubCapability field contained in this message fragment
    ...
    */
  const uci::type::PO_CapabilityCommandType::SubCapability& getSubCapability() const override;

  /** Returns the accessor to the SubCapability field contained in this message fragment
    *
    * @return The reference to the accessor to the SubCapability field.
    */
  uci::type::PO_CapabilityCommandType::SubCapability& getSubCapability() override;
  ...
  /** Set the contents of the message fragment that this accesssor provides access to to the contents the specified
    ...
    * @return A reference to the object on which this method was called.
    */
  uci::type::PO_CapabilityCommandType& setSubCapability(const uci::type::PO_CapabilityCommandType::SubCapability& accessor) override;
  ...
  /** Returns the accessor to the ComponentSettings field contained in this message fragment
    ...
    */
  const uci::type::PO_CapabilityCommandType::ComponentSettings& getComponentSettings() const override;

  /** Returns the accessor to the ComponentSettings field contained in this message fragment
    *
    * @return The reference to the accessor to the ComponentSettings field.
    */
  uci::type::PO_CapabilityCommandType::ComponentSettings& getComponentSettings() override;
  ...
  /** Set the contents of the message fragment that this accesssor provides access to to the contents the specified
    ...
    * @return A reference to the object on which this method was called.
    */
  uci::type::PO_CapabilityCommandType& setComponentSettings(const uci::type::PO_CapabilityCommandType::ComponentSettings& accessor) override;
  ...
  /** Set the contents of the message fragment that this accesssor provides access to to the contents the specified
    ...
    * @return A reference to the object on which this method was called.
    */
  uci::type::PO_CapabilityCommandType& setCollectionConstraints(const uci::type::PO_CollectionConstraintsSettingsType& accessor) override;
  ...
  /** Clears the value of the optional field accessed by this accesor
    ...
    * @return A reference to the object on which this method was called.
    */
  uci::type::PO_CapabilityCommandType& clearCollectionConstraints() noexcept override;

  /** Returns the accessor that provides access to the contents of the optional field accessed by this accesor
    *
    * @return The accessor that provides access to the contents of the optional field accessed by this accesor
    */
  uci::type::PO_TrackDetailsType& getTrackDetails_() const;

  /** Returns the accessor that provides access to the contents of the optional field accessed by this accesor
    *
    * @return The accessor that provides access to the contents of the optional field accessed by this accesor
    */
  const uci::type::PO_TrackDetailsType& getTrackDetails() const override;

  /** Returns the accessor that provides access to the contents of the optional field accessed by this accesor
    *
    * @return The accessor that provides access to the contents of the optional field accessed by this accesor
    */
  uci::type::PO_TrackDetailsType& getTrackDetails() override;
  ...
  /** Set the contents of the message fragment that this accesssor provides access to to the contents the specified
    ...
    * @return A reference to the object on which this method was called.
    */
  uci::type::PO_CapabilityCommandType& setTrackDetails(const uci::type::PO_TrackDetailsType& accessor) override;

  /** Returns whether this optional field TrackDetailsis available
    *
    * @return Whether the optional field is available (true) or not (false).
    */
  bool hasTrackDetails() const noexcept override;

  /** Enables the optional field such that getTrackDetails will return the optional field and not throw an exception when
    * invoked.
    *
    * @param type The value to set the optional field to
    * @return The accessor that provides access to the contents of the optional field accessed by this accesor
    */
  uci::type::PO_TrackDetailsType& enableTrackDetails(uci::base::accessorType::AccessorType type = uci::base::accessorType::null) override;

  /** Clears the value of the optional field accessed by this accesor
    *
    * @return A reference to the object on which this method was called.
    */
  uci::type::PO_CapabilityCommandType& clearTrackDetails() noexcept override;
  ...
  /** Set the contents of the message fragment that this accesssor provides access to to the contents the specified
    ...
    * @return A reference to the object on which this method was called.
    */
  uci::type::PO_CapabilityCommandType& setCollectionPolicy(const uci::type::CollectionPolicyEnum& accessor) override;
  ...
  /** Set the contents of the message fragment that this accesssor provides access to to the contents the specified
    ...
    * @return A reference to the object on which this method was called.
    */
  uci::type::PO_CapabilityCommandType& setCollectionPolicy(uci::type::CollectionPolicyEnum::EnumerationItem value) override;
  ...
  /** Clears the optional item marking it as not being set.
    ...
    * @return A reference to the object on which this method was called.
    */
  uci::type::PO_CapabilityCommandType& clearCollectionPolicy() noexcept override;
  ...
  /** Set the contents of the message fragment that this accesssor provides access to to the contents the specified
    ...
    * @return A reference to the object on which this method was called.
    */
  uci::type::PO_CapabilityCommandType& setPairIdentifier(const uci::type::PairIdentifierEnum& accessor) override;
  ...
  /** Set the contents of the message fragment that this accesssor provides access to to the contents the specified
    ...
    * @return A reference to the object on which this method was called.
    */
  uci::type::PO_CapabilityCommandType& setPairIdentifier(uci::type::PairIdentifierEnum::EnumerationItem value) override;
  ...
  /** Clears the optional item marking it as not being set.
    ...
    * @return A reference to the object on which this method was called.
    */
  uci::type::PO_CapabilityCommandType& clearPairIdentifier() noexcept override;
  ...
  /** Set the contents of the message fragment that this accesssor provides access to to the contents the specified
    ...
    * @return A reference to the object on which this method was called.
    */
  uci::type::PO_CapabilityCommandType& setRepetition(const uci::type::RepetitionType& accessor) override;
  ...
  /** Clears the value of the optional field accessed by this accesor
    ...
    * @return A reference to the object on which this method was called.
    */
  uci::type::PO_CapabilityCommandType& clearRepetition() noexcept override;
  ...
  /** Returns the accessor to the ProductOutput field contained in this message fragment
    ...
    */
  const uci::type::PO_CapabilityCommandType::ProductOutput& getProductOutput() const override;

  /** Returns the accessor to the ProductOutput field contained in this message fragment
    *
    * @return The reference to the accessor to the ProductOutput field.
    */
  uci::type::PO_CapabilityCommandType::ProductOutput& getProductOutput() override;
  ...
  /** Set the contents of the message fragment that this accesssor provides access to to the contents the specified
    ...
    * @return A reference to the object on which this method was called.
    */
  uci::type::PO_CapabilityCommandType& setProductOutput(const uci::type::PO_CapabilityCommandType::ProductOutput& accessor) override;
  ...
  /** 
    ...
    * @return .
    */
  static std::unique_ptr<PO_CapabilityCommandType> create(uci::base::accessorType::AccessorType type);
  ...
  /** 
    ...
    * @param topLevel .
    */
  static void deserialize(const boost::property_tree::ptree& propTree, uci::type::PO_CapabilityCommandType& accessor, std::string& nodeName, std::string& nsPrefix, bool topLevel = false);
  ...
  /** 
    ...
    * @return .
    */
  static std::string serialize(const uci::type::PO_CapabilityCommandType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, bool createNode = true, bool addTypeAttribute = false, bool checkIfDerivation = true, bool topLevel = false);
...
private:
  ...
  std::unique_ptr<PO_TrackDetailsType> trackDetails_Accessor;
...
#endif // ASB_UCI_TYPE_PO_CAPABILITYCOMMANDTYPE_H
