...
#ifndef ASB_UCI_BASE_SIMPLELIST_H
#define ASB_UCI_BASE_SIMPLELIST_H
...
/** The SimpleList is the base class that all bounded lists are derived from. */
template<typename T, uci::base::accessorType::AccessorType V, typename AsbT>
class SimpleList : public virtual uci::base::SimpleList<T,V> {
public:
  ...
  /** The constructor
    *
    * @param min The minimum number of elements in this SimpleList
    * @param max The maximum number of elements in this SimpleList
    */
  SimpleList(size_type min, size_type max)
  ...
  /** The copy constructor
    *
    * @param rhs The SimpleList to copy from
    */
  SimpleList(const SimpleList& rhs) = delete;

  /** The move constructor
    *
    * @param rhs The SimpleList to move from
    */
  SimpleList(SimpleList&& rhs) = delete;

  /** The assignment operator
    *
    * @param rhs The SimpleList to copy from
    * @return The SimpleList that was assigned
    */
  SimpleList& operator=(const SimpleList& rhs) = delete;
  ...
  /** The move assignment operator
    ...
    * @return The SimpleList that was assigned
    */
  SimpleList& operator=(SimpleList&& rhs) = delete;

  /** The destructor */
  virtual ~SimpleList() = default;
  ...
  void resize(size_type newSize, uci::base::accessorType::AccessorType type = V) override {
    ...
    if (actualNewSize > list_accessorData->size()) {
      while (actualNewSize > list_accessorData->size()) {
        ...
        if (!newAccessor) {
          throw uci::base::UCIException("Error in SimpleList::resize(): Specified type is not equal to nor derived from the native type of object");
        }
  ...
  /** The returns this SimpleList's "maxOccurs" as specified in the XML Schema specification.
    *
    * @return The SimpleList's "maxOccurs".
  ...
  /** The returns this SimpleList's "minOccurs" as specified in the XML Schema specification.
    *
    * @return The SimpleList's "minOccurs".
  ...
  /** The returns this SimpleList's length.
    *
    * @return The SimpleList's length.
    */
  ...
  reference at(size_type index) override {
    ...
    throw uci::base::UCIException("Error in SimpleList::at(): Attempted to access an out of bounds index");
  }
  ...
  void push_back(const_reference value) override {
    ...
    throw uci::base::UCIException("Error in SimpleList::push_back(): Addition would exceed maximum size of list (" + std::to_string(list_maximumSize) + ")");
  }

  /** Resets the SimpleList */
  ...
  void copyImpl(const uci::base::SimpleList<T,V>& accessor, const bool /*checkIfDerivation*/) {
    if (&accessor != this) {
      const SimpleList<T,V,AsbT>& accessorImpl(dynamic_cast<const SimpleList<T,V,AsbT>&>(accessor));
  ...
  /** 
    ...
    * @return .
    */
  static std::unique_ptr<SimpleList<T,V,AsbT>> create(const uci::base::accessorType::AccessorType /*type*/) {
    return boost::make_unique<SimpleList<T,V,AsbT>>();
  }
...
#endif // ASB_UCI_BASE_SIMPLELIST_H
