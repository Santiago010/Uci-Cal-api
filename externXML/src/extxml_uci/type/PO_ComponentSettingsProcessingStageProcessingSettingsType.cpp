...
bool PO_ComponentSettingsProcessingStageProcessingSettingsType::deserialize(const boost::property_tree::ptree& propTree, uci::type::PO_ComponentSettingsProcessingStageProcessingSettingsType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setElectronicZoom(extxml_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    }
  }
  return true;
...
std::string PO_ComponentSettingsProcessingStageProcessingSettingsType::serialize(const uci::type::PO_ComponentSettingsProcessingStageProcessingSettingsType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, PO_ComponentSettingsProcessingStageProcessingSettingsType_Names::Extern_Type_Name);
  }
  ...
  if (accessor.hasGammaValue()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getGammaValue(), node, PO_ComponentSettingsProcessingStageProcessingSettingsType_Names::GammaValue_Name);
  }
  if (accessor.hasSharpnessValue()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getSharpnessValue(), node, PO_ComponentSettingsProcessingStageProcessingSettingsType_Names::SharpnessValue_Name);
  }
  if (accessor.hasEdgeEnhancement()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getEdgeEnhancement(), node, PO_ComponentSettingsProcessingStageProcessingSettingsType_Names::EdgeEnhancement_Name);
  }
  if (accessor.hasElectronicZoom()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getElectronicZoom(), node, PO_ComponentSettingsProcessingStageProcessingSettingsType_Names::ElectronicZoom_Name);
  }
  if (createNode) {
