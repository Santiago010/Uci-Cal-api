  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setEvaluationCode(extxml_uci::util::SerializationHelpers::deserializeUnsignedByte(*value));
      }
...
std::string EOB_CodesType::serialize(const uci::type::EOB_CodesType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, EOB_CodesType_Names::Extern_Type_Name);
  }
  if (accessor.hasEvaluationCode()) {
    extxml_uci::util::SerializationHelpers::serializeUnsignedByte(accessor.getEvaluationCode(), node, EOB_CodesType_Names::EvaluationCode_Name);
  }
  ...
  if (accessor.hasActivityCode()) {
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getActivityCode(), node, EOB_CodesType_Names::ActivityCode_Name);
  }
