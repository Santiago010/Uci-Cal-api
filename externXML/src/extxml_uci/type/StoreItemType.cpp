...
bool StoreItemType::deserialize(const boost::property_tree::ptree& propTree, uci::type::StoreItemType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
...
std::string StoreItemType::serialize(const uci::type::StoreItemType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, StoreItemType_Names::Extern_Type_Name);
  }
