  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setTimestampForAnnotation(extxml_uci::util::SerializationHelpers::deserializeDateTime(*value));
      }
...
std::string OperatorAnnotationMDT::serialize(const uci::type::OperatorAnnotationMDT& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, OperatorAnnotationMDT_Names::Extern_Type_Name);
  }
  ...
  if (accessor.hasTimestampForAnnotation()) {
    extxml_uci::util::SerializationHelpers::serializeDateTime(accessor.getTimestampForAnnotation(), node, OperatorAnnotationMDT_Names::TimestampForAnnotation_Name);
  }
  {
  ...
  }
  {
    ...
    for (uci::type::OperatorAnnotationMDT::AnnotationText::size_type i = 0, end = boundedList.size(); i < end; ++i) {
      extxml_uci::util::SerializationHelpers::serializeString(boundedList.at(i), node, OperatorAnnotationMDT_Names::AnnotationText_Name);
    }
  }
  if (createNode) {
