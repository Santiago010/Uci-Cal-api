...
bool MeasurementCharacteristicsType::deserialize(const boost::property_tree::ptree& propTree, uci::type::MeasurementCharacteristicsType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setCenterFrequency(extxml_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setSBR(extxml_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
...
std::string MeasurementCharacteristicsType::serialize(const uci::type::MeasurementCharacteristicsType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, MeasurementCharacteristicsType_Names::Extern_Type_Name);
  }
  ...
  if (accessor.hasCenterFrequency()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getCenterFrequency(), node, MeasurementCharacteristicsType_Names::CenterFrequency_Name);
  }
  ...
  if (accessor.hasTargetIrradiance()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getTargetIrradiance(), node, MeasurementCharacteristicsType_Names::TargetIrradiance_Name);
  }
  if (accessor.hasProbabilityOfDetection()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getProbabilityOfDetection(), node, MeasurementCharacteristicsType_Names::ProbabilityOfDetection_Name);
  }
  if (accessor.hasProbabilityOfFalseAlarm()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getProbabilityOfFalseAlarm(), node, MeasurementCharacteristicsType_Names::ProbabilityOfFalseAlarm_Name);
  }
  if (accessor.hasSNR()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getSNR(), node, MeasurementCharacteristicsType_Names::SNR_Name);
  }
  if (accessor.hasSBR()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getSBR(), node, MeasurementCharacteristicsType_Names::SBR_Name);
  }
  {
