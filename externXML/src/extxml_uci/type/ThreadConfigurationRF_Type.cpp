  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setBeamConfigurationIndex(extxml_uci::util::SerializationHelpers::deserializeUnsignedInt(*value));
      }
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setAntennaAttenuation(extxml_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    } else if (valueType.first == nsPrefix + ThreadConfigurationRF_Type_Names::AntennaPriority_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setAntennaPriority(extxml_uci::util::SerializationHelpers::deserializeUnsignedInt(*value));
      }
...
std::string ThreadConfigurationRF_Type::serialize(const uci::type::ThreadConfigurationRF_Type& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, ThreadConfigurationRF_Type_Names::Extern_Type_Name);
  }
  extxml_uci::util::SerializationHelpers::serializeUnsignedInt(accessor.getBeamConfigurationIndex(), node, ThreadConfigurationRF_Type_Names::BeamConfigurationIndex_Name);
  ...
  if (accessor.hasAntennaAttenuation()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getAntennaAttenuation(), node, ThreadConfigurationRF_Type_Names::AntennaAttenuation_Name);
  }
  if (accessor.hasAntennaPriority()) {
    extxml_uci::util::SerializationHelpers::serializeUnsignedInt(accessor.getAntennaPriority(), node, ThreadConfigurationRF_Type_Names::AntennaPriority_Name);
  }
