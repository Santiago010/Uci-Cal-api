...
std::string DamageEstimateRequestMDT::serialize(const uci::type::DamageEstimateRequestMDT& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, DamageEstimateRequestMDT_Names::Extern_Type_Name);
  }
  ...
  extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getReportingThreshold(), node, DamageEstimateRequestMDT_Names::ReportingThreshold_Name);
  ...
  if (accessor.hasTargetName()) {
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getTargetName(), node, DamageEstimateRequestMDT_Names::TargetName_Name);
  }
  {
  ...
  if (accessor.hasRespondBy()) {
    extxml_uci::util::SerializationHelpers::serializeDateTime(accessor.getRespondBy(), node, DamageEstimateRequestMDT_Names::RespondBy_Name);
  }
