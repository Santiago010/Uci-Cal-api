...
bool PlanningFunctionMDT::deserialize(const boost::property_tree::ptree& propTree, uci::type::PlanningFunctionMDT& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        ...
        PlanningInterfacesType::deserialize(valueType.second, boundedList.at(boundedListSize), nodeName, nsPrefix);
      }
...
std::string PlanningFunctionMDT::serialize(const uci::type::PlanningFunctionMDT& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, PlanningFunctionMDT_Names::Extern_Type_Name);
  }
  ...
  SystemID_Type::serialize(accessor.getSystemID(), node, PlanningFunctionMDT_Names::SystemID_Name);
  {
    ...
    for (uci::type::PlanningFunctionMDT::PlanningInterfaces::size_type i = 0, end = boundedList.size(); i < end; ++i) {
      PlanningInterfacesType::serialize(boundedList.at(i), node, PlanningFunctionMDT_Names::PlanningInterfaces_Name);
    }
  }
