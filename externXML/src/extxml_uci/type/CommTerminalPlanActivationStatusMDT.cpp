...
bool CommTerminalPlanActivationStatusMDT::deserialize(const boost::property_tree::ptree& propTree, uci::type::CommTerminalPlanActivationStatusMDT& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        ...
        CommTerminalPlanEffectivityStateType::deserialize(valueType.second, boundedList.at(boundedListSize), nodeName, nsPrefix);
      }
    }
  }
  return true;
...
std::string CommTerminalPlanActivationStatusMDT::serialize(const uci::type::CommTerminalPlanActivationStatusMDT& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, CommTerminalPlanActivationStatusMDT_Names::Extern_Type_Name);
  }
  ...
  CommTerminalPlanActivationStateEnum::serialize(accessor.getPlanActivationState(), node, CommTerminalPlanActivationStatusMDT_Names::PlanActivationState_Name, false);
  {
    ...
    for (uci::type::CommTerminalPlanActivationStatusMDT::EffectivityState::size_type i = 0, end = boundedList.size(); i < end; ++i) {
      CommTerminalPlanEffectivityStateType::serialize(boundedList.at(i), node, CommTerminalPlanActivationStatusMDT_Names::EffectivityState_Name);
    }
  }
  if (createNode) {
