  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setQuality(extxml_uci::util::SerializationHelpers::deserializeFloat(*value));
      }
    } else if (valueType.first == nsPrefix + StrikeTaskMetricsTargetingType_Names::UncertaintyEllipse_Name) {
      extxml_uci::util::DerivedTypesDeserializer::deserialize(valueType.second, accessor.chooseUncertaintyEllipse(extxml_uci::util::SerializationHelpers::checkForTypeAttribute(valueType.second, nsPrefix)), nodeName, nsPrefix);
    }
  }
  return true;
}
...
std::string StrikeTaskMetricsTargetingType::serialize(const uci::type::StrikeTaskMetricsTargetingType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, StrikeTaskMetricsTargetingType_Names::Extern_Type_Name);
  }
  if (accessor.isQuality()) {
    extxml_uci::util::SerializationHelpers::serializeFloat(accessor.getQuality(), node, StrikeTaskMetricsTargetingType_Names::Quality_Name);
