  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setIdentityStaleness(extxml_uci::util::SerializationHelpers::deserializeDuration(*value));
      }
...
std::string EntityCharacteristicType::serialize(const uci::type::EntityCharacteristicType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, EntityCharacteristicType_Names::Extern_Type_Name);
  }
  if (accessor.isIdentity()) {
    ...
    extxml_uci::util::SerializationHelpers::serializeDuration(accessor.getIdentityStaleness(), node, EntityCharacteristicType_Names::IdentityStaleness_Name);
  } else if (accessor.isPositionUncertainty()) {
    extxml_uci::util::SerializationHelpers::serializeFloat(accessor.getPositionUncertainty(), node, EntityCharacteristicType_Names::PositionUncertainty_Name);
  } else if (accessor.isPositionStaleness()) {
    extxml_uci::util::SerializationHelpers::serializeDuration(accessor.getPositionStaleness(), node, EntityCharacteristicType_Names::PositionStaleness_Name);
