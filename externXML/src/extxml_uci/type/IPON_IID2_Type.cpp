...
std::string IPON_IID2_Type::serialize(const uci::type::IPON_IID2_Type& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, IPON_IID2_Type_Names::Extern_Type_Name);
  }
  extxml_uci::util::SerializationHelpers::serializeString(accessor.getProgramCode(), node, IPON_IID2_Type_Names::ProgramCode_Name);
  extxml_uci::util::SerializationHelpers::serializeString(accessor.getSortieNumber(), node, IPON_IID2_Type_Names::SortieNumber_Name);
  extxml_uci::util::SerializationHelpers::serializeString(accessor.getProjectCode(), node, IPON_IID2_Type_Names::ProjectCode_Name);
  if (createNode) {
