...
bool DamageType::deserialize(const boost::property_tree::ptree& propTree, uci::type::DamageType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      extxml_uci::util::DerivedTypesDeserializer::deserialize(valueType.second, accessor.chooseFunctionalDamage(extxml_uci::util::SerializationHelpers::checkForTypeAttribute(valueType.second, nsPrefix)), nodeName, nsPrefix);
...
std::string DamageType::serialize(const uci::type::DamageType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, DamageType_Names::Extern_Type_Name);
  }
  if (accessor.isFunctionalDamage()) {
    ...
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getHumanCasualty(), node, DamageType_Names::HumanCasualty_Name);
  } else if (accessor.isHumanInjury()) {
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getHumanInjury(), node, DamageType_Names::HumanInjury_Name);
  }
  if (createNode) {
