...
std::string DetailedKinematicsType::serialize(const uci::type::DetailedKinematicsType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, DetailedKinematicsType_Names::Extern_Type_Name);
  }
  ...
  if (accessor.hasWanderAngle()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getWanderAngle(), node, DetailedKinematicsType_Names::WanderAngle_Name);
  }
  if (accessor.hasMagneticHeading()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getMagneticHeading(), node, DetailedKinematicsType_Names::MagneticHeading_Name);
  }
