...
std::string WorkingEOB_MDT::serialize(const uci::type::WorkingEOB_MDT& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, WorkingEOB_MDT_Names::Extern_Type_Name);
  }
  ...
  if (accessor.hasInitialCreationTime()) {
    extxml_uci::util::SerializationHelpers::serializeDateTime(accessor.getInitialCreationTime(), node, WorkingEOB_MDT_Names::InitialCreationTime_Name);
  }
  if (accessor.hasLastUpdateTime()) {
    extxml_uci::util::SerializationHelpers::serializeDateTime(accessor.getLastUpdateTime(), node, WorkingEOB_MDT_Names::LastUpdateTime_Name);
  }
  {
