...
std::string ESM_CapabilityStatusMDT::serialize(const uci::type::ESM_CapabilityStatusMDT& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, ESM_CapabilityStatusMDT_Names::Extern_Type_Name);
  }
  ...
  if (accessor.hasRWR_AudioEnable()) {
    extxml_uci::util::SerializationHelpers::serializeBoolean(accessor.getRWR_AudioEnable(), node, ESM_CapabilityStatusMDT_Names::RWR_AudioEnable_Name);
  }
  if (accessor.hasSpectralDensityReporting()) {
    extxml_uci::util::SerializationHelpers::serializeBoolean(accessor.getSpectralDensityReporting(), node, ESM_CapabilityStatusMDT_Names::SpectralDensityReporting_Name);
  }
  {
