...
bool RelativeNavigationType::deserialize(const boost::property_tree::ptree& propTree, uci::type::RelativeNavigationType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      extxml_uci::util::DerivedTypesDeserializer::deserialize(valueType.second, accessor.enableReferencePoint(extxml_uci::util::SerializationHelpers::checkForTypeAttribute(valueType.second, nsPrefix)), nodeName, nsPrefix);
    } else if (valueType.first == nsPrefix + RelativeNavigationType_Names::OffsetNorth_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setOffsetNorth(extxml_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    } else if (valueType.first == nsPrefix + RelativeNavigationType_Names::OffsetEast_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setOffsetEast(extxml_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    } else if (valueType.first == nsPrefix + RelativeNavigationType_Names::OffsetDown_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setOffsetDown(extxml_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    }
  }
  return true;
...
std::string RelativeNavigationType::serialize(const uci::type::RelativeNavigationType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, RelativeNavigationType_Names::Extern_Type_Name);
  }
  Point3D_Type::serialize(accessor.getReferencePoint(), node, RelativeNavigationType_Names::ReferencePoint_Name);
  extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getOffsetNorth(), node, RelativeNavigationType_Names::OffsetNorth_Name);
  extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getOffsetEast(), node, RelativeNavigationType_Names::OffsetEast_Name);
  extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getOffsetDown(), node, RelativeNavigationType_Names::OffsetDown_Name);
  if (createNode) {
