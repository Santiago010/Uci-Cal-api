...
std::string IPv6_EndpointType::serialize(const uci::type::IPv6_EndpointType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, IPv6_EndpointType_Names::Extern_Type_Name);
  }
  extxml_uci::util::SerializationHelpers::serializeString(accessor.getIP_Address(), node, IPv6_EndpointType_Names::IP_Address_Name);
  if (accessor.hasSubnetMask()) {
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getSubnetMask(), node, IPv6_EndpointType_Names::SubnetMask_Name);
  }
  if (accessor.hasDescription()) {
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getDescription(), node, IPv6_EndpointType_Names::Description_Name);
  }
  if (createNode) {
