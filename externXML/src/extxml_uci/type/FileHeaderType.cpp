...
bool FileHeaderType::deserialize(const boost::property_tree::ptree& propTree, uci::type::FileHeaderType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setCollectionIdentifier(extxml_uci::util::SerializationHelpers::deserializeUnsignedInt(*value));
      }
...
std::string FileHeaderType::serialize(const uci::type::FileHeaderType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, FileHeaderType_Names::Extern_Type_Name);
  }
  ...
  if (accessor.hasOriginatingStationIdentifier()) {
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getOriginatingStationIdentifier(), node, FileHeaderType_Names::OriginatingStationIdentifier_Name);
  }
  if (accessor.hasCollectionIdentifier()) {
    extxml_uci::util::SerializationHelpers::serializeUnsignedInt(accessor.getCollectionIdentifier(), node, FileHeaderType_Names::CollectionIdentifier_Name);
  }
  if (accessor.hasFileTitle()) {
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getFileTitle(), node, FileHeaderType_Names::FileTitle_Name);
  }
  if (accessor.hasOriginatorsName()) {
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getOriginatorsName(), node, FileHeaderType_Names::OriginatorsName_Name);
  }
  if (accessor.hasOriginatorsPhone()) {
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getOriginatorsPhone(), node, FileHeaderType_Names::OriginatorsPhone_Name);
  }
  if (accessor.hasFileClassificationSystem()) {
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getFileClassificationSystem(), node, FileHeaderType_Names::FileClassificationSystem_Name);
  }
  if (accessor.hasFileSecurityControlNumber()) {
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getFileSecurityControlNumber(), node, FileHeaderType_Names::FileSecurityControlNumber_Name);
  }
  if (accessor.hasFileControlAndHandling()) {
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getFileControlAndHandling(), node, FileHeaderType_Names::FileControlAndHandling_Name);
  }
  ...
  if (accessor.hasFileClassificationAuthorityType()) {
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getFileClassificationAuthorityType(), node, FileHeaderType_Names::FileClassificationAuthorityType_Name);
  }
  if (accessor.hasFileDowngrade()) {
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getFileDowngrade(), node, FileHeaderType_Names::FileDowngrade_Name);
  }
  if (accessor.hasFileSecuritySourceDate()) {
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getFileSecuritySourceDate(), node, FileHeaderType_Names::FileSecuritySourceDate_Name);
  }
  if (createNode) {
