...
std::string RemarksType::serialize(const uci::type::RemarksType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, RemarksType_Names::Extern_Type_Name);
  }
  if (accessor.hasDisplayName()) {
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getDisplayName(), node, RemarksType_Names::DisplayName_Name);
  }
  if (accessor.hasDetail()) {
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getDetail(), node, RemarksType_Names::Detail_Name);
  }
  if (createNode) {
