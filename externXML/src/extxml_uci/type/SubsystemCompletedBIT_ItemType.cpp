...
std::string SubsystemCompletedBIT_ItemType::serialize(const uci::type::SubsystemCompletedBIT_ItemType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, SubsystemCompletedBIT_ItemType_Names::Extern_Type_Name);
  }
  extxml_uci::util::SerializationHelpers::serializeString(accessor.getBIT_ItemName(), node, SubsystemCompletedBIT_ItemType_Names::BIT_ItemName_Name);
  ...
  if (accessor.hasFailReason()) {
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getFailReason(), node, SubsystemCompletedBIT_ItemType_Names::FailReason_Name);
  }
  if (createNode) {
