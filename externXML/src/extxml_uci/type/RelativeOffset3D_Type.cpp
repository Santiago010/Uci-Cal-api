...
std::string RelativeOffset3D_Type::serialize(const uci::type::RelativeOffset3D_Type& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, RelativeOffset3D_Type_Names::Extern_Type_Name);
  }
  ...
  extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getX(), node, RelativeOffset3D_Type_Names::X_Name);
  extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getY(), node, RelativeOffset3D_Type_Names::Y_Name);
