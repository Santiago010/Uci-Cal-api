  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setMajorAxis(extxml_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    } else if (valueType.first == nsPrefix + GatewayLink16ConfigurationRectangleType_Names::MinorAxis_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setMinorAxis(extxml_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
...
std::string GatewayLink16ConfigurationRectangleType::serialize(const uci::type::GatewayLink16ConfigurationRectangleType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, GatewayLink16ConfigurationRectangleType_Names::Extern_Type_Name);
  }
  GatewayLink16ConfigurationClosedAreaType::serialize(accessor, node, "", false, false, false);
  extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getMajorAxis(), node, GatewayLink16ConfigurationRectangleType_Names::MajorAxis_Name);
  extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getMinorAxis(), node, GatewayLink16ConfigurationRectangleType_Names::MinorAxis_Name);
  extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getOrientation(), node, GatewayLink16ConfigurationRectangleType_Names::Orientation_Name);
  if (createNode) {
