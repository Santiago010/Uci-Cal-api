...
std::string ApprovalRequestMDT::serialize(const uci::type::ApprovalRequestMDT& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, ApprovalRequestMDT_Names::Extern_Type_Name);
  }
  ...
  extxml_uci::util::SerializationHelpers::serializeDateTime(accessor.getRespondBy(), node, ApprovalRequestMDT_Names::RespondBy_Name);
  if (createNode) {
