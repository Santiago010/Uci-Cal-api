...
bool ExerciseIdentityType::deserialize(const boost::property_tree::ptree& propTree, uci::type::ExerciseIdentityType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
...
std::string ExerciseIdentityType::serialize(const uci::type::ExerciseIdentityType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, ExerciseIdentityType_Names::Extern_Type_Name);
  }
