  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setNominalManeuverProbability(extxml_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
...
std::string ManeuverSummaryType::serialize(const uci::type::ManeuverSummaryType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, ManeuverSummaryType_Names::Extern_Type_Name);
  }
  ...
  if (accessor.hasNominalManeuverProbability()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getNominalManeuverProbability(), node, ManeuverSummaryType_Names::NominalManeuverProbability_Name);
  }
