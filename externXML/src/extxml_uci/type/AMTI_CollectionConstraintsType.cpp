  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setSurfaceMoverVelocityGate(extxml_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
...
std::string AMTI_CollectionConstraintsType::serialize(const uci::type::AMTI_CollectionConstraintsType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, AMTI_CollectionConstraintsType_Names::Extern_Type_Name);
  }
  CollectionConstraintsType::serialize(accessor, node, "", false, false, false);
  if (accessor.hasSurfaceMoverVelocityGate()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getSurfaceMoverVelocityGate(), node, AMTI_CollectionConstraintsType_Names::SurfaceMoverVelocityGate_Name);
  }
  if (accessor.hasTargetRCS()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getTargetRCS(), node, AMTI_CollectionConstraintsType_Names::TargetRCS_Name);
  }
  if (accessor.hasFalseAlarmLevel()) {
    extxml_uci::util::SerializationHelpers::serializeUnsignedByte(accessor.getFalseAlarmLevel(), node, AMTI_CollectionConstraintsType_Names::FalseAlarmLevel_Name);
  }
