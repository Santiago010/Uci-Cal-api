...
bool CommUHF_SATCOM_CommWaveformCapabilityCommandType::deserialize(const boost::property_tree::ptree& propTree, uci::type::CommUHF_SATCOM_CommWaveformCapabilityCommandType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
...
std::string CommUHF_SATCOM_CommWaveformCapabilityCommandType::serialize(const uci::type::CommUHF_SATCOM_CommWaveformCapabilityCommandType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, CommUHF_SATCOM_CommWaveformCapabilityCommandType_Names::Extern_Type_Name);
  }
  ...
  if (accessor.hasOrderwireEncryption()) {
    extxml_uci::util::SerializationHelpers::serializeBoolean(accessor.getOrderwireEncryption(), node, CommUHF_SATCOM_CommWaveformCapabilityCommandType_Names::OrderwireEncryption_Name);
  }
  ...
  }
  {
    ...
    for (uci::type::CommUHF_SATCOM_CommWaveformCapabilityCommandType::GuardSlotKey::size_type i = 0, end = boundedList.size(); i < end; ++i) {
      ForeignKeyType::serialize(boundedList.at(i), node, CommUHF_SATCOM_CommWaveformCapabilityCommandType_Names::GuardSlotKey_Name);
    }
  }
  if (createNode) {
