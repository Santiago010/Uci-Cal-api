  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setSatelliteNumber(extxml_uci::util::SerializationHelpers::deserializeUnsignedInt(*value));
      }
...
std::string SatelliteIdentifierType::serialize(const uci::type::SatelliteIdentifierType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, SatelliteIdentifierType_Names::Extern_Type_Name);
  }
  extxml_uci::util::SerializationHelpers::serializeUnsignedInt(accessor.getSatelliteNumber(), node, SatelliteIdentifierType_Names::SatelliteNumber_Name);
  if (accessor.hasSatelliteName()) {
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getSatelliteName(), node, SatelliteIdentifierType_Names::SatelliteName_Name);
  }
