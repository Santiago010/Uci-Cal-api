  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setResetReferencePressure(extxml_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
    } else if (valueType.first == nsPrefix + RefuelCapabilityDrogueCommandType_Names::ResetDeliveredFuel_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setResetDeliveredFuel(extxml_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
    } else if (valueType.first == nsPrefix + RefuelCapabilityDrogueCommandType_Names::ResetMissionFuel_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setResetMissionFuel(extxml_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
...
std::string RefuelCapabilityDrogueCommandType::serialize(const uci::type::RefuelCapabilityDrogueCommandType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, RefuelCapabilityDrogueCommandType_Names::Extern_Type_Name);
  }
  RefuelCapabilityDrogueCommonType::serialize(accessor, node, "", false, false, false);
  if (accessor.hasResetReferencePressure()) {
    extxml_uci::util::SerializationHelpers::serializeBoolean(accessor.getResetReferencePressure(), node, RefuelCapabilityDrogueCommandType_Names::ResetReferencePressure_Name);
  }
  if (accessor.hasResetDeliveredFuel()) {
    extxml_uci::util::SerializationHelpers::serializeBoolean(accessor.getResetDeliveredFuel(), node, RefuelCapabilityDrogueCommandType_Names::ResetDeliveredFuel_Name);
  }
  if (accessor.hasResetMissionFuel()) {
    extxml_uci::util::SerializationHelpers::serializeBoolean(accessor.getResetMissionFuel(), node, RefuelCapabilityDrogueCommandType_Names::ResetMissionFuel_Name);
  }
