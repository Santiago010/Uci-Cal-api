...
bool SpaceWeatherParameterType::deserialize(const boost::property_tree::ptree& propTree, uci::type::SpaceWeatherParameterType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setSolarFlux(extxml_uci::util::SerializationHelpers::deserializeUnsignedShort(*value));
      }
    } else if (valueType.first == nsPrefix + SpaceWeatherParameterType_Names::AverageSolarFlux_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setAverageSolarFlux(extxml_uci::util::SerializationHelpers::deserializeUnsignedShort(*value));
      }
...
std::string SpaceWeatherParameterType::serialize(const uci::type::SpaceWeatherParameterType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, SpaceWeatherParameterType_Names::Extern_Type_Name);
  }
  extxml_uci::util::SerializationHelpers::serializeUnsignedShort(accessor.getSolarFlux(), node, SpaceWeatherParameterType_Names::SolarFlux_Name);
  extxml_uci::util::SerializationHelpers::serializeUnsignedShort(accessor.getAverageSolarFlux(), node, SpaceWeatherParameterType_Names::AverageSolarFlux_Name);
