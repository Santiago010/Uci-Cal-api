...
bool CommPortSettingsType::deserialize(const boost::property_tree::ptree& propTree, uci::type::CommPortSettingsType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      extxml_uci::util::DerivedTypesDeserializer::deserialize(valueType.second, accessor.enableComPortKey(extxml_uci::util::SerializationHelpers::checkForTypeAttribute(valueType.second, nsPrefix)), nodeName, nsPrefix);
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setBaudRate(extxml_uci::util::SerializationHelpers::deserializeUnsignedInt(*value));
      }
    } else if (valueType.first == nsPrefix + CommPortSettingsType_Names::CharWidth_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setCharWidth(extxml_uci::util::SerializationHelpers::deserializeInt(*value));
      }
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setStopBits(extxml_uci::util::SerializationHelpers::deserializeInt(*value));
      }
    }
  }
  return true;
...
std::string CommPortSettingsType::serialize(const uci::type::CommPortSettingsType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, CommPortSettingsType_Names::Extern_Type_Name);
  }
  ...
  extxml_uci::util::SerializationHelpers::serializeUnsignedInt(accessor.getBaudRate(), node, CommPortSettingsType_Names::BaudRate_Name);
  extxml_uci::util::SerializationHelpers::serializeInt(accessor.getCharWidth(), node, CommPortSettingsType_Names::CharWidth_Name);
  ParityTypeEnum::serialize(accessor.getParity(), node, CommPortSettingsType_Names::Parity_Name, false);
  if (accessor.hasStopBits()) {
    extxml_uci::util::SerializationHelpers::serializeInt(accessor.getStopBits(), node, CommPortSettingsType_Names::StopBits_Name);
  }
  if (createNode) {
