  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setControlTimeSlotInhibit(extxml_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
    } else if (valueType.first == nsPrefix + CommLink16InitialEntryMessageType_Names::PPLIA_TimeSlotInhibit_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setPPLIA_TimeSlotInhibit(extxml_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
    } else if (valueType.first == nsPrefix + CommLink16InitialEntryMessageType_Names::PPLIB_TimeSlotInhibit_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setPPLIB_TimeSlotInhibit(extxml_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
    } else if (valueType.first == nsPrefix + CommLink16InitialEntryMessageType_Names::RTTB_TimeSlotInhibit_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setRTTB_TimeSlotInhibit(extxml_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
    } else if (valueType.first == nsPrefix + CommLink16InitialEntryMessageType_Names::VoiceA_TimeSlotInhibit_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setVoiceA_TimeSlotInhibit(extxml_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
    } else if (valueType.first == nsPrefix + CommLink16InitialEntryMessageType_Names::VoiceBTimeSlotInhibit_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setVoiceBTimeSlotInhibit(extxml_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
    }
  }
  return true;
...
std::string CommLink16InitialEntryMessageType::serialize(const uci::type::CommLink16InitialEntryMessageType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, CommLink16InitialEntryMessageType_Names::Extern_Type_Name);
  }
  if (accessor.hasControlTimeSlotInhibit()) {
    extxml_uci::util::SerializationHelpers::serializeBoolean(accessor.getControlTimeSlotInhibit(), node, CommLink16InitialEntryMessageType_Names::ControlTimeSlotInhibit_Name);
  }
  if (accessor.hasPPLIA_TimeSlotInhibit()) {
    extxml_uci::util::SerializationHelpers::serializeBoolean(accessor.getPPLIA_TimeSlotInhibit(), node, CommLink16InitialEntryMessageType_Names::PPLIA_TimeSlotInhibit_Name);
  }
  if (accessor.hasPPLIB_TimeSlotInhibit()) {
    extxml_uci::util::SerializationHelpers::serializeBoolean(accessor.getPPLIB_TimeSlotInhibit(), node, CommLink16InitialEntryMessageType_Names::PPLIB_TimeSlotInhibit_Name);
  }
  if (accessor.hasRTTB_TimeSlotInhibit()) {
    extxml_uci::util::SerializationHelpers::serializeBoolean(accessor.getRTTB_TimeSlotInhibit(), node, CommLink16InitialEntryMessageType_Names::RTTB_TimeSlotInhibit_Name);
  }
  if (accessor.hasVoiceA_TimeSlotInhibit()) {
    extxml_uci::util::SerializationHelpers::serializeBoolean(accessor.getVoiceA_TimeSlotInhibit(), node, CommLink16InitialEntryMessageType_Names::VoiceA_TimeSlotInhibit_Name);
  }
  if (accessor.hasVoiceBTimeSlotInhibit()) {
    extxml_uci::util::SerializationHelpers::serializeBoolean(accessor.getVoiceBTimeSlotInhibit(), node, CommLink16InitialEntryMessageType_Names::VoiceBTimeSlotInhibit_Name);
  }
  if (createNode) {
