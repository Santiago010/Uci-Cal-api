...
std::string ThreatAssessmentProbabilityType::serialize(const uci::type::ThreatAssessmentProbabilityType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, ThreatAssessmentProbabilityType_Names::Extern_Type_Name);
  }
  if (accessor.hasEffectiveProbability()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getEffectiveProbability(), node, ThreatAssessmentProbabilityType_Names::EffectiveProbability_Name);
  }
  if (accessor.hasExposureTime()) {
    extxml_uci::util::SerializationHelpers::serializeDuration(accessor.getExposureTime(), node, ThreatAssessmentProbabilityType_Names::ExposureTime_Name);
  }
  if (createNode) {
