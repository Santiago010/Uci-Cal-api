...
std::string ResourceAllocationPeriodDigitalType::serialize(const uci::type::ResourceAllocationPeriodDigitalType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, ResourceAllocationPeriodDigitalType_Names::Extern_Type_Name);
  }
  extxml_uci::util::SerializationHelpers::serializeUnsignedInt(accessor.getAccessPeriodIndex(), node, ResourceAllocationPeriodDigitalType_Names::AccessPeriodIndex_Name);
  extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getPercentAccessLimit(), node, ResourceAllocationPeriodDigitalType_Names::PercentAccessLimit_Name);
  if (accessor.hasPeriodPercentAccessExpected()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getPeriodPercentAccessExpected(), node, ResourceAllocationPeriodDigitalType_Names::PeriodPercentAccessExpected_Name);
  }
  if (accessor.hasPeriodMaxAccessDuration()) {
    extxml_uci::util::SerializationHelpers::serializeDuration(accessor.getPeriodMaxAccessDuration(), node, ResourceAllocationPeriodDigitalType_Names::PeriodMaxAccessDuration_Name);
  }
  if (createNode) {
