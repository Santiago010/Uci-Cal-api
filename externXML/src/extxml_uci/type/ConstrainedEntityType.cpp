  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setMissionPlanningWeightingFactor(extxml_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    } else if (valueType.first == nsPrefix + ConstrainedEntityType_Names::MissionPlanningCandidate_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setMissionPlanningCandidate(extxml_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
...
std::string ConstrainedEntityType::serialize(const uci::type::ConstrainedEntityType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, ConstrainedEntityType_Names::Extern_Type_Name);
  }
  ...
  if (accessor.hasMissionPlanningWeightingFactor()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getMissionPlanningWeightingFactor(), node, ConstrainedEntityType_Names::MissionPlanningWeightingFactor_Name);
  }
  if (accessor.hasMissionPlanningCandidate()) {
    extxml_uci::util::SerializationHelpers::serializeBoolean(accessor.getMissionPlanningCandidate(), node, ConstrainedEntityType_Names::MissionPlanningCandidate_Name);
  }
