...
bool DetectionRangeRingType::deserialize(const boost::property_tree::ptree& propTree, uci::type::DetectionRangeRingType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setStartAzimuth(extxml_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    } else if (valueType.first == nsPrefix + DetectionRangeRingType_Names::EndAzimuth_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setEndAzimuth(extxml_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
...
std::string DetectionRangeRingType::serialize(const uci::type::DetectionRangeRingType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, DetectionRangeRingType_Names::Extern_Type_Name);
  }
  extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getAltitudeOffset(), node, DetectionRangeRingType_Names::AltitudeOffset_Name);
  if (accessor.hasStartAzimuth()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getStartAzimuth(), node, DetectionRangeRingType_Names::StartAzimuth_Name);
  }
  if (accessor.hasEndAzimuth()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getEndAzimuth(), node, DetectionRangeRingType_Names::EndAzimuth_Name);
  }
  {
    ...
    for (uci::type::DetectionRangeRingType::DetectionRange::size_type i = 0, end = boundedList.size(); i < end; ++i) {
      extxml_uci::util::SerializationHelpers::serializeDouble(boundedList.at(i), node, DetectionRangeRingType_Names::DetectionRange_Name);
    }
  }
  if (createNode) {
