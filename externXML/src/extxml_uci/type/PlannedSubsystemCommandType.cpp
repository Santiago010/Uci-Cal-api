...
bool PlannedSubsystemCommandType::deserialize(const boost::property_tree::ptree& propTree, uci::type::PlannedSubsystemCommandType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
...
std::string PlannedSubsystemCommandType::serialize(const uci::type::PlannedSubsystemCommandType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, PlannedSubsystemCommandType_Names::Extern_Type_Name);
  }
