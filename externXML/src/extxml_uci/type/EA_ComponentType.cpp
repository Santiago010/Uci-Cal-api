  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setFrequencyChangeTime(extxml_uci::util::SerializationHelpers::deserializeDuration(*value));
      }
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setCommutationsLimit(extxml_uci::util::SerializationHelpers::deserializeUnsignedInt(*value));
      }
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setInstantaneousBand(extxml_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    }
  }
  return true;
...
std::string EA_ComponentType::serialize(const uci::type::EA_ComponentType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, EA_ComponentType_Names::Extern_Type_Name);
  }
  ...
  extxml_uci::util::SerializationHelpers::serializeDuration(accessor.getFrequencyChangeTime(), node, EA_ComponentType_Names::FrequencyChangeTime_Name);
  extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getDutyFactorLimit(), node, EA_ComponentType_Names::DutyFactorLimit_Name);
  extxml_uci::util::SerializationHelpers::serializeUnsignedInt(accessor.getBeamLimit(), node, EA_ComponentType_Names::BeamLimit_Name);
  extxml_uci::util::SerializationHelpers::serializeUnsignedInt(accessor.getCommutationsLimit(), node, EA_ComponentType_Names::CommutationsLimit_Name);
  {
  ...
  if (accessor.hasInstantaneousBand()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getInstantaneousBand(), node, EA_ComponentType_Names::InstantaneousBand_Name);
  }
  if (createNode) {
