  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setEventTime(extxml_uci::util::SerializationHelpers::deserializeDateTime(*value));
      }
...
std::string OrbitalDebrisCloudType::serialize(const uci::type::OrbitalDebrisCloudType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, OrbitalDebrisCloudType_Names::Extern_Type_Name);
  }
  ...
  extxml_uci::util::SerializationHelpers::serializeDateTime(accessor.getEventTime(), node, OrbitalDebrisCloudType_Names::EventTime_Name);
  {
