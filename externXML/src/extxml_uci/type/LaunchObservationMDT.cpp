...
bool LaunchObservationMDT::deserialize(const boost::property_tree::ptree& propTree, uci::type::LaunchObservationMDT& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setInitialCreateTime(extxml_uci::util::SerializationHelpers::deserializeDateTime(*value));
      }
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        ...
        LaunchObjectType::deserialize(valueType.second, boundedList.at(boundedListSize), nodeName, nsPrefix);
      }
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        ...
        boundedList.resize(boundedListSize + 1);
        SourceFiltersType::deserialize(valueType.second, boundedList.at(boundedListSize), nodeName, nsPrefix);
      }
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        ...
        boundedList.resize(boundedListSize + 1);
        LaunchObservationID_Type::deserialize(valueType.second, boundedList.at(boundedListSize), nodeName, nsPrefix);
      }
    }
  }
...
std::string LaunchObservationMDT::serialize(const uci::type::LaunchObservationMDT& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, LaunchObservationMDT_Names::Extern_Type_Name);
  }
  ...
  if (accessor.hasInitialCreateTime()) {
    extxml_uci::util::SerializationHelpers::serializeDateTime(accessor.getInitialCreateTime(), node, LaunchObservationMDT_Names::InitialCreateTime_Name);
  }
  if (accessor.hasLastUpdateTime()) {
    extxml_uci::util::SerializationHelpers::serializeDateTime(accessor.getLastUpdateTime(), node, LaunchObservationMDT_Names::LastUpdateTime_Name);
  }
  ...
  }
  {
    ...
    for (uci::type::LaunchObservationMDT::LaunchObject::size_type i = 0, end = boundedList.size(); i < end; ++i) {
      LaunchObjectType::serialize(boundedList.at(i), node, LaunchObservationMDT_Names::LaunchObject_Name);
    }
  }
  {
    ...
    for (uci::type::LaunchObservationMDT::Source::size_type i = 0, end = boundedList.size(); i < end; ++i) {
      SourceFiltersType::serialize(boundedList.at(i), node, LaunchObservationMDT_Names::Source_Name);
    }
  }
  {
    ...
    for (uci::type::LaunchObservationMDT::RelatedLaunchObservationID::size_type i = 0, end = boundedList.size(); i < end; ++i) {
      LaunchObservationID_Type::serialize(boundedList.at(i), node, LaunchObservationMDT_Names::RelatedLaunchObservationID_Name);
    }
  }
  if (createNode) {
