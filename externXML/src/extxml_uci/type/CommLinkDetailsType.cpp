...
bool CommLinkDetailsType::deserialize(const boost::property_tree::ptree& propTree, uci::type::CommLinkDetailsType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setTxSimplex(extxml_uci::util::SerializationHelpers::deserializeUnsignedInt(*value));
      }
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setRxSimplex(extxml_uci::util::SerializationHelpers::deserializeUnsignedInt(*value));
      }
    }
  }
  return true;
...
std::string CommLinkDetailsType::serialize(const uci::type::CommLinkDetailsType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, CommLinkDetailsType_Names::Extern_Type_Name);
  }
  if (accessor.isFullDuplex()) {
    ...
    extxml_uci::util::SerializationHelpers::serializeUnsignedInt(accessor.getTxSimplex(), node, CommLinkDetailsType_Names::TxSimplex_Name);
    ...
    extxml_uci::util::SerializationHelpers::serializeUnsignedInt(accessor.getRxSimplex(), node, CommLinkDetailsType_Names::RxSimplex_Name);
  }
  if (createNode) {
