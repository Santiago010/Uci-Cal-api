...
std::string PO_ComponentStatusApertureSettingsType::serialize(const uci::type::PO_ComponentStatusApertureSettingsType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, PO_ComponentStatusApertureSettingsType_Names::Extern_Type_Name);
  }
  ...
  if (accessor.hasF_StopSetting()) {
    extxml_uci::util::SerializationHelpers::serializeFloat(accessor.getF_StopSetting(), node, PO_ComponentStatusApertureSettingsType_Names::F_StopSetting_Name);
  }
  if (accessor.hasReset()) {
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getReset(), node, PO_ComponentStatusApertureSettingsType_Names::Reset_Name);
  }
  if (createNode) {
