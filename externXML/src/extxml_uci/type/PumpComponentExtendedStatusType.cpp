...
std::string PumpComponentExtendedStatusType::serialize(const uci::type::PumpComponentExtendedStatusType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, PumpComponentExtendedStatusType_Names::Extern_Type_Name);
  }
  ...
  if (accessor.hasFlowRate()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getFlowRate(), node, PumpComponentExtendedStatusType_Names::FlowRate_Name);
  }
  if (accessor.hasDirection()) {
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getDirection(), node, PumpComponentExtendedStatusType_Names::Direction_Name);
  }
  {
  ...
  if (accessor.hasRecirculating()) {
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getRecirculating(), node, PumpComponentExtendedStatusType_Names::Recirculating_Name);
  }
  if (createNode) {
