...
bool IFF_TransponderModesSelectionType::deserialize(const boost::property_tree::ptree& propTree, uci::type::IFF_TransponderModesSelectionType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setModeC_Enable(extxml_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setADS_B_Enable(extxml_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
    }
  }
  return true;
...
std::string IFF_TransponderModesSelectionType::serialize(const uci::type::IFF_TransponderModesSelectionType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, IFF_TransponderModesSelectionType_Names::Extern_Type_Name);
  }
  if (accessor.hasMode1_Code()) {
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getMode1_Code(), node, IFF_TransponderModesSelectionType_Names::Mode1_Code_Name);
  }
  if (accessor.hasMode2_Code()) {
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getMode2_Code(), node, IFF_TransponderModesSelectionType_Names::Mode2_Code_Name);
  }
  if (accessor.hasMode3A_Code()) {
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getMode3A_Code(), node, IFF_TransponderModesSelectionType_Names::Mode3A_Code_Name);
  }
  extxml_uci::util::SerializationHelpers::serializeBoolean(accessor.getModeC_Enable(), node, IFF_TransponderModesSelectionType_Names::ModeC_Enable_Name);
  ...
  extxml_uci::util::SerializationHelpers::serializeBoolean(accessor.getADS_B_Enable(), node, IFF_TransponderModesSelectionType_Names::ADS_B_Enable_Name);
  if (createNode) {
