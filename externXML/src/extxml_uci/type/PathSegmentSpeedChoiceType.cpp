  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setMachValue(extxml_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    }
  }
  return true;
...
std::string PathSegmentSpeedChoiceType::serialize(const uci::type::PathSegmentSpeedChoiceType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, PathSegmentSpeedChoiceType_Names::Extern_Type_Name);
  }
  if (accessor.isSpeedValue()) {
    ...
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getMachValue(), node, PathSegmentSpeedChoiceType_Names::MachValue_Name);
  }
  if (createNode) {
