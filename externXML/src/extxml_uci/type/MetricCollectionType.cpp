  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setUseAllPasses(extxml_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setCenteredAtMaxPredictedSNR(extxml_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
    } else if (valueType.first == nsPrefix + MetricCollectionType_Names::SpacingOfObservations_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setSpacingOfObservations(extxml_uci::util::SerializationHelpers::deserializeInt(*value));
      }
    } else if (valueType.first == nsPrefix + MetricCollectionType_Names::ReportPointSOI_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setReportPointSOI(extxml_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
...
std::string MetricCollectionType::serialize(const uci::type::MetricCollectionType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, MetricCollectionType_Names::Extern_Type_Name);
  }
  extxml_uci::util::SerializationHelpers::serializeBoolean(accessor.getUseAllPasses(), node, MetricCollectionType_Names::UseAllPasses_Name);
  ...
  if (accessor.hasCenteredAtMaxPredictedSNR()) {
    extxml_uci::util::SerializationHelpers::serializeBoolean(accessor.getCenteredAtMaxPredictedSNR(), node, MetricCollectionType_Names::CenteredAtMaxPredictedSNR_Name);
  }
  if (accessor.hasSpacingOfObservations()) {
    extxml_uci::util::SerializationHelpers::serializeInt(accessor.getSpacingOfObservations(), node, MetricCollectionType_Names::SpacingOfObservations_Name);
  }
  if (accessor.hasReportPointSOI()) {
    extxml_uci::util::SerializationHelpers::serializeBoolean(accessor.getReportPointSOI(), node, MetricCollectionType_Names::ReportPointSOI_Name);
  }
