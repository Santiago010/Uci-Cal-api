...
bool RxBeamType::deserialize(const boost::property_tree::ptree& propTree, uci::type::RxBeamType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
...
std::string RxBeamType::serialize(const uci::type::RxBeamType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, RxBeamType_Names::Extern_Type_Name);
  }
