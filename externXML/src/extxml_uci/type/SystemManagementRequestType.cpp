...
bool SystemManagementRequestType::deserialize(const boost::property_tree::ptree& propTree, uci::type::SystemManagementRequestType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setSetSensorEntityReporting(extxml_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
...
std::string SystemManagementRequestType::serialize(const uci::type::SystemManagementRequestType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, SystemManagementRequestType_Names::Extern_Type_Name);
  }
  if (accessor.isSetMode()) {
    ...
    extxml_uci::util::SerializationHelpers::serializeBoolean(accessor.getSetSensorEntityReporting(), node, SystemManagementRequestType_Names::SetSensorEntityReporting_Name);
