  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setEvaluation(extxml_uci::util::SerializationHelpers::deserializeUnsignedByte(*value));
      }
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setEchelonTier(extxml_uci::util::SerializationHelpers::deserializeUnsignedByte(*value));
      }
      ...
      extxml_uci::util::DerivedTypesDeserializer::deserialize(valueType.second, accessor.enableParentUnitID(extxml_uci::util::SerializationHelpers::checkForTypeAttribute(valueType.second, nsPrefix)), nodeName, nsPrefix);
...
std::string UnitType::serialize(const uci::type::UnitType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, UnitType_Names::Extern_Type_Name);
  }
  ...
  if (accessor.hasEvaluation()) {
    extxml_uci::util::SerializationHelpers::serializeUnsignedByte(accessor.getEvaluation(), node, UnitType_Names::Evaluation_Name);
  }
  ...
  if (accessor.hasPoliticalSubdivision()) {
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getPoliticalSubdivision(), node, UnitType_Names::PoliticalSubdivision_Name);
  }
  ...
  if (accessor.hasDeploymentStatus()) {
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getDeploymentStatus(), node, UnitType_Names::DeploymentStatus_Name);
  }
  if (accessor.hasDivisionCategory()) {
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getDivisionCategory(), node, UnitType_Names::DivisionCategory_Name);
  }
  if (accessor.hasEchelon()) {
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getEchelon(), node, UnitType_Names::Echelon_Name);
  }
  if (accessor.hasEchelonTier()) {
    extxml_uci::util::SerializationHelpers::serializeUnsignedByte(accessor.getEchelonTier(), node, UnitType_Names::EchelonTier_Name);
  }
  ...
  if (accessor.hasFleetAssignment()) {
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getFleetAssignment(), node, UnitType_Names::FleetAssignment_Name);
  }
  if (accessor.hasAirDefenseArea()) {
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getAirDefenseArea(), node, UnitType_Names::AirDefenseArea_Name);
  }
  if (accessor.hasForceAssignment()) {
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getForceAssignment(), node, UnitType_Names::ForceAssignment_Name);
  }
  if (accessor.hasForceName()) {
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getForceName(), node, UnitType_Names::ForceName_Name);
  }
  if (accessor.hasFunctionRole()) {
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getFunctionRole(), node, UnitType_Names::FunctionRole_Name);
  }
  if (accessor.hasMissionPrimary()) {
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getMissionPrimary(), node, UnitType_Names::MissionPrimary_Name);
  }
  if (accessor.hasMissionPrimarySpecialty()) {
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getMissionPrimarySpecialty(), node, UnitType_Names::MissionPrimarySpecialty_Name);
  }
  if (accessor.hasMissionSecondary()) {
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getMissionSecondary(), node, UnitType_Names::MissionSecondary_Name);
  }
  if (accessor.hasMissionSecondarySpecialty()) {
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getMissionSecondarySpecialty(), node, UnitType_Names::MissionSecondarySpecialty_Name);
  }
  if (accessor.hasNuclearCapacity()) {
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getNuclearCapacity(), node, UnitType_Names::NuclearCapacity_Name);
  }
