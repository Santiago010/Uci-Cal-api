...
bool ControlSourcesControlType::deserialize(const boost::property_tree::ptree& propTree, uci::type::ControlSourcesControlType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        ...
        ControlSourcesCapabilityControlType::deserialize(valueType.second, boundedList.at(boundedListSize), nodeName, nsPrefix);
      }
    }
  }
  return true;
...
std::string ControlSourcesControlType::serialize(const uci::type::ControlSourcesControlType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, ControlSourcesControlType_Names::Extern_Type_Name);
  }
  if (accessor.isControllerSystemID()) {
  ...
  } else if (accessor.isCapabilityControl()) {
    {
      ...
      for (uci::type::ControlSourcesControlType::CapabilityControl::size_type i = 0, end = boundedList.size(); i < end; ++i) {
        ControlSourcesCapabilityControlType::serialize(boundedList.at(i), node, ControlSourcesControlType_Names::CapabilityControl_Name);
      }
    }
  }
  if (createNode) {
