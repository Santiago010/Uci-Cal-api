...
std::string SubsystemConfigurationType::serialize(const uci::type::SubsystemConfigurationType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, SubsystemConfigurationType_Names::Extern_Type_Name);
  }
  ...
  if (accessor.hasMass()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getMass(), node, SubsystemConfigurationType_Names::Mass_Name);
  }
