...
std::string RouteValidationErrorType::serialize(const uci::type::RouteValidationErrorType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, RouteValidationErrorType_Names::Extern_Type_Name);
  }
  ...
  if (accessor.hasSpecificReasonCode()) {
    extxml_uci::util::SerializationHelpers::serializeUnsignedInt(accessor.getSpecificReasonCode(), node, RouteValidationErrorType_Names::SpecificReasonCode_Name);
  }
  if (accessor.hasDescription()) {
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getDescription(), node, RouteValidationErrorType_Names::Description_Name);
  }
  if (createNode) {
