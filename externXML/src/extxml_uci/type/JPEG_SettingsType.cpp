...
bool JPEG_SettingsType::deserialize(const boost::property_tree::ptree& propTree, uci::type::JPEG_SettingsType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setPeakSNR(extxml_uci::util::SerializationHelpers::deserializeFloat(*value));
      }
    } else if (valueType.first == nsPrefix + JPEG_SettingsType_Names::RateDistortionSlope_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setRateDistortionSlope(extxml_uci::util::SerializationHelpers::deserializeFloat(*value));
      }
...
std::string JPEG_SettingsType::serialize(const uci::type::JPEG_SettingsType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, JPEG_SettingsType_Names::Extern_Type_Name);
  }
  if (accessor.hasCompressionRatio()) {
    extxml_uci::util::SerializationHelpers::serializeFloat(accessor.getCompressionRatio(), node, JPEG_SettingsType_Names::CompressionRatio_Name);
  }
  if (accessor.hasPeakSNR()) {
    extxml_uci::util::SerializationHelpers::serializeFloat(accessor.getPeakSNR(), node, JPEG_SettingsType_Names::PeakSNR_Name);
  }
  if (accessor.hasRateDistortionSlope()) {
    extxml_uci::util::SerializationHelpers::serializeFloat(accessor.getRateDistortionSlope(), node, JPEG_SettingsType_Names::RateDistortionSlope_Name);
  }
