...
std::string SupportedModeType::serialize(const uci::type::SupportedModeType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, SupportedModeType_Names::Extern_Type_Name);
  }
  ...
  extxml_uci::util::SerializationHelpers::serializeUnsignedInt(accessor.getUplinkDataRate(), node, SupportedModeType_Names::UplinkDataRate_Name);
  FrequencyRangeType::serialize(accessor.getUplinkFrequencyRange(), node, SupportedModeType_Names::UplinkFrequencyRange_Name);
  extxml_uci::util::SerializationHelpers::serializeUnsignedInt(accessor.getDownlinkDataRate(), node, SupportedModeType_Names::DownlinkDataRate_Name);
  FrequencyRangeType::serialize(accessor.getDownlinkFrequencyRange(), node, SupportedModeType_Names::DownlinkFrequencyRange_Name);
  extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getGain(), node, SupportedModeType_Names::Gain_Name);
  extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getBeamwidth(), node, SupportedModeType_Names::Beamwidth_Name);
  if (createNode) {
