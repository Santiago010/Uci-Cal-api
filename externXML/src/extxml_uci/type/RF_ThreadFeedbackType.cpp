  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setRF_ThreadIndex(extxml_uci::util::SerializationHelpers::deserializeUnsignedInt(*value));
      }
...
std::string RF_ThreadFeedbackType::serialize(const uci::type::RF_ThreadFeedbackType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, RF_ThreadFeedbackType_Names::Extern_Type_Name);
  }
  extxml_uci::util::SerializationHelpers::serializeUnsignedInt(accessor.getRF_ThreadIndex(), node, RF_ThreadFeedbackType_Names::RF_ThreadIndex_Name);
  ...
  if (accessor.hasPercentAccess()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getPercentAccess(), node, RF_ThreadFeedbackType_Names::PercentAccess_Name);
  }
  if (createNode) {
