...
bool DamagedObjectNonEntityType::deserialize(const boost::property_tree::ptree& propTree, uci::type::DamagedObjectNonEntityType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
...
std::string DamagedObjectNonEntityType::serialize(const uci::type::DamagedObjectNonEntityType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, DamagedObjectNonEntityType_Names::Extern_Type_Name);
  }
  if (accessor.hasType()) {
