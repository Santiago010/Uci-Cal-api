...
bool PredictedThreatAssessmentRelativeType::deserialize(const boost::property_tree::ptree& propTree, uci::type::PredictedThreatAssessmentRelativeType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      extxml_uci::util::DerivedTypesDeserializer::deserialize(valueType.second, accessor.enableInertialStateRelative(extxml_uci::util::SerializationHelpers::checkForTypeAttribute(valueType.second, nsPrefix)), nodeName, nsPrefix);
...
std::string PredictedThreatAssessmentRelativeType::serialize(const uci::type::PredictedThreatAssessmentRelativeType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, PredictedThreatAssessmentRelativeType_Names::Extern_Type_Name);
  }
  InertialStateRelativeType::serialize(accessor.getInertialStateRelative(), node, PredictedThreatAssessmentRelativeType_Names::InertialStateRelative_Name);
  {
    ...
    for (uci::type::PredictedThreatAssessmentRelativeType::ThreatAssessment::size_type i = 0, end = boundedList.size(); i < end; ++i) {
      ThreatAssessmentSystemType::serialize(boundedList.at(i), node, PredictedThreatAssessmentRelativeType_Names::ThreatAssessment_Name);
    }
  }
  if (createNode) {
