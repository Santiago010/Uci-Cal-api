...
bool PlanningByCaseTriggerType::deserialize(const boost::property_tree::ptree& propTree, uci::type::PlanningByCaseTriggerType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      extxml_uci::util::DerivedTypesDeserializer::deserialize(valueType.second, accessor.chooseRequirementAdded(extxml_uci::util::SerializationHelpers::checkForTypeAttribute(valueType.second, nsPrefix)), nodeName, nsPrefix);
      ...
      extxml_uci::util::DerivedTypesDeserializer::deserialize(valueType.second, accessor.chooseRequirementDropped(extxml_uci::util::SerializationHelpers::checkForTypeAttribute(valueType.second, nsPrefix)), nodeName, nsPrefix);
      ...
      extxml_uci::util::DerivedTypesDeserializer::deserialize(valueType.second, accessor.chooseRequirementChange(extxml_uci::util::SerializationHelpers::checkForTypeAttribute(valueType.second, nsPrefix)), nodeName, nsPrefix);
...
std::string PlanningByCaseTriggerType::serialize(const uci::type::PlanningByCaseTriggerType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, PlanningByCaseTriggerType_Names::Extern_Type_Name);
  }
  if (accessor.isCapabilityAdded()) {
    ...
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getDMPI_OverDesignation(), node, PlanningByCaseTriggerType_Names::DMPI_OverDesignation_Name);
  } else if (accessor.isDMPI_UnderDesignation()) {
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getDMPI_UnderDesignation(), node, PlanningByCaseTriggerType_Names::DMPI_UnderDesignation_Name);
    ...
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getProximityConflict(), node, PlanningByCaseTriggerType_Names::ProximityConflict_Name);
  } else if (accessor.isReleasePointOutsideLAR()) {
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getReleasePointOutsideLAR(), node, PlanningByCaseTriggerType_Names::ReleasePointOutsideLAR_Name);
  } else if (accessor.isRouteConflict()) {
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getRouteConflict(), node, PlanningByCaseTriggerType_Names::RouteConflict_Name);
    ...
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getRequirementDependencyFailed(), node, PlanningByCaseTriggerType_Names::RequirementDependencyFailed_Name);
    ...
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getRequirementTiming(), node, PlanningByCaseTriggerType_Names::RequirementTiming_Name);
    ...
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getOrbitConflict(), node, PlanningByCaseTriggerType_Names::OrbitConflict_Name);
    ...
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getSpacecraftProximityConflict(), node, PlanningByCaseTriggerType_Names::SpacecraftProximityConflict_Name);
