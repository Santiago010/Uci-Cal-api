  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setHotInventory(extxml_uci::util::SerializationHelpers::deserializeUnsignedInt(*value));
      }
    } else if (valueType.first == nsPrefix + PlatformStatusSAM_Type_Names::ColdInventory_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setColdInventory(extxml_uci::util::SerializationHelpers::deserializeUnsignedInt(*value));
      }
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setControlPositions(extxml_uci::util::SerializationHelpers::deserializeUnsignedInt(*value));
      }
...
std::string PlatformStatusSAM_Type::serialize(const uci::type::PlatformStatusSAM_Type& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, PlatformStatusSAM_Type_Names::Extern_Type_Name);
  }
  if (accessor.hasHotInventory()) {
    extxml_uci::util::SerializationHelpers::serializeUnsignedInt(accessor.getHotInventory(), node, PlatformStatusSAM_Type_Names::HotInventory_Name);
  }
  if (accessor.hasColdInventory()) {
    extxml_uci::util::SerializationHelpers::serializeUnsignedInt(accessor.getColdInventory(), node, PlatformStatusSAM_Type_Names::ColdInventory_Name);
  }
  ...
  if (accessor.hasControlPositions()) {
    extxml_uci::util::SerializationHelpers::serializeUnsignedInt(accessor.getControlPositions(), node, PlatformStatusSAM_Type_Names::ControlPositions_Name);
  }
