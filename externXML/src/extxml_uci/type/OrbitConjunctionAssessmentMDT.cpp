...
std::string OrbitConjunctionAssessmentMDT::serialize(const uci::type::OrbitConjunctionAssessmentMDT& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, OrbitConjunctionAssessmentMDT_Names::Extern_Type_Name);
  }
  ...
  extxml_uci::util::SerializationHelpers::serializeDateTime(accessor.getCompletionTime(), node, OrbitConjunctionAssessmentMDT_Names::CompletionTime_Name);
  if (accessor.hasEstimateNarrative()) {
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getEstimateNarrative(), node, OrbitConjunctionAssessmentMDT_Names::EstimateNarrative_Name);
  }
  if (createNode) {
