...
bool OrbitalSurveillanceSensorTaskBaseType::deserialize(const boost::property_tree::ptree& propTree, uci::type::OrbitalSurveillanceSensorTaskBaseType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setSetUpStartTime(extxml_uci::util::SerializationHelpers::deserializeDuration(*value));
      }
    } else if (valueType.first == nsPrefix + OrbitalSurveillanceSensorTaskBaseType_Names::PostCollectionWrapUp_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setPostCollectionWrapUp(extxml_uci::util::SerializationHelpers::deserializeDuration(*value));
      }
...
std::string OrbitalSurveillanceSensorTaskBaseType::serialize(const uci::type::OrbitalSurveillanceSensorTaskBaseType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool checkIfDerivation, const bool /*topLevel*/) {
  ...
  if (!checkIfDerivation || (accessor.getAccessorType() == uci::type::accessorType::orbitalSurveillanceSensorTaskBaseType)) {
    ...
    if (addTypeAttribute) {
      extxml_uci::util::SerializationHelpers::addTypeAttribute(node, OrbitalSurveillanceSensorTaskBaseType_Names::Extern_Type_Name);
    }
    ...
    extxml_uci::util::SerializationHelpers::serializeBoolean(accessor.getConfirmObjectAcquisition(), node, OrbitalSurveillanceSensorTaskBaseType_Names::ConfirmObjectAcquisition_Name);
    {
    ...
    if (accessor.hasSetUpStartTime()) {
      extxml_uci::util::SerializationHelpers::serializeDuration(accessor.getSetUpStartTime(), node, OrbitalSurveillanceSensorTaskBaseType_Names::SetUpStartTime_Name);
    }
    if (accessor.hasPostCollectionWrapUp()) {
      extxml_uci::util::SerializationHelpers::serializeDuration(accessor.getPostCollectionWrapUp(), node, OrbitalSurveillanceSensorTaskBaseType_Names::PostCollectionWrapUp_Name);
    }
