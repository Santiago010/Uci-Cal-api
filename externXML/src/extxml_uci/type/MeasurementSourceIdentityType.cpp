  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setSensorSystemIdentity(extxml_uci::util::SerializationHelpers::deserializeUnsignedShort(*value));
      }
...
std::string MeasurementSourceIdentityType::serialize(const uci::type::MeasurementSourceIdentityType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, MeasurementSourceIdentityType_Names::Extern_Type_Name);
  }
  ...
  if (accessor.hasSensorSystemIdentity()) {
    extxml_uci::util::SerializationHelpers::serializeUnsignedShort(accessor.getSensorSystemIdentity(), node, MeasurementSourceIdentityType_Names::SensorSystemIdentity_Name);
  }
