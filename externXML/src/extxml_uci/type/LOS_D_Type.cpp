...
bool LOS_D_Type::deserialize(const boost::property_tree::ptree& propTree, uci::type::LOS_D_Type& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
...
std::string LOS_D_Type::serialize(const uci::type::LOS_D_Type& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, LOS_D_Type_Names::Extern_Type_Name);
  }
  if (accessor.isLOS()) {
