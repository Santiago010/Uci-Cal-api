  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setWindGust(extxml_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
...
std::string WindDataType::serialize(const uci::type::WindDataType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, WindDataType_Names::Extern_Type_Name);
  }
  ...
  if (accessor.hasWindGust()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getWindGust(), node, WindDataType_Names::WindGust_Name);
  }
  if (accessor.hasWindShear()) {
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getWindShear(), node, WindDataType_Names::WindShear_Name);
  }
  if (accessor.hasVariableWinds()) {
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getVariableWinds(), node, WindDataType_Names::VariableWinds_Name);
  }
  if (createNode) {
