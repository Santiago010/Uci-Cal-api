...
bool SOB_SatelliteRecordBaseType::deserialize(const boost::property_tree::ptree& propTree, uci::type::SOB_SatelliteRecordBaseType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setDecayDate(extxml_uci::util::SerializationHelpers::deserializeDateTime(*value));
      }
...
std::string SOB_SatelliteRecordBaseType::serialize(const uci::type::SOB_SatelliteRecordBaseType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool checkIfDerivation, const bool /*topLevel*/) {
  ...
  if (!checkIfDerivation || (accessor.getAccessorType() == uci::type::accessorType::sOB_SatelliteRecordBaseType)) {
    ...
    if (addTypeAttribute) {
      extxml_uci::util::SerializationHelpers::addTypeAttribute(node, SOB_SatelliteRecordBaseType_Names::Extern_Type_Name);
    }
    ...
    if (accessor.hasDecayDate()) {
      extxml_uci::util::SerializationHelpers::serializeDateTime(accessor.getDecayDate(), node, SOB_SatelliteRecordBaseType_Names::DecayDate_Name);
    }
    ...
    if (accessor.hasMass()) {
      extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getMass(), node, SOB_SatelliteRecordBaseType_Names::Mass_Name);
    }
    ...
    if (accessor.hasPatternOfLife()) {
      extxml_uci::util::SerializationHelpers::serializeString(accessor.getPatternOfLife(), node, SOB_SatelliteRecordBaseType_Names::PatternOfLife_Name);
    }
    {
    ...
    if (accessor.hasRemarksText()) {
      extxml_uci::util::SerializationHelpers::serializeString(accessor.getRemarksText(), node, SOB_SatelliteRecordBaseType_Names::RemarksText_Name);
    }
    if (createNode) {
