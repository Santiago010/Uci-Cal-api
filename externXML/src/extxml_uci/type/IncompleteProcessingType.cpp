...
bool IncompleteProcessingType::deserialize(const boost::property_tree::ptree& propTree, uci::type::IncompleteProcessingType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      extxml_uci::util::DerivedTypesDeserializer::deserialize(valueType.second, accessor.enableIncompleteItemID(extxml_uci::util::SerializationHelpers::checkForTypeAttribute(valueType.second, nsPrefix)), nodeName, nsPrefix);
...
std::string IncompleteProcessingType::serialize(const uci::type::IncompleteProcessingType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, IncompleteProcessingType_Names::Extern_Type_Name);
  }
  ...
  if (accessor.hasDescription()) {
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getDescription(), node, IncompleteProcessingType_Names::Description_Name);
  }
  if (createNode) {
