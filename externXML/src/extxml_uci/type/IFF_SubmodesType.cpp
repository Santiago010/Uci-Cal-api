...
bool IFF_SubmodesType::deserialize(const boost::property_tree::ptree& propTree, uci::type::IFF_SubmodesType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      IFF_ActiveModesType::deserialize(valueType.second, boundedList.at(boundedListSize), nodeName, nsPrefix);
...
std::string IFF_SubmodesType::serialize(const uci::type::IFF_SubmodesType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, IFF_SubmodesType_Names::Extern_Type_Name);
  }
  {
    ...
    for (uci::type::IFF_SubmodesType::IFF_ActiveModes::size_type i = 0, end = boundedList.size(); i < end; ++i) {
      IFF_ActiveModesType::serialize(boundedList.at(i), node, IFF_SubmodesType_Names::IFF_ActiveModes_Name);
    }
  }
  {
    ...
    for (uci::type::IFF_SubmodesType::TargetVolume::size_type i = 0, end = boundedList.size(); i < end; ++i) {
      AirTargetVolumeCommandType::serialize(boundedList.at(i), node, IFF_SubmodesType_Names::TargetVolume_Name);
    }
  }
