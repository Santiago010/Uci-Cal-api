...
bool RelativeAnglesLOS3D_Type::deserialize(const boost::property_tree::ptree& propTree, uci::type::RelativeAnglesLOS3D_Type& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setLOS_ReferenceFrameRoll(extxml_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setLOS_ReferenceFrameRollRate(extxml_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    } else if (valueType.first == nsPrefix + RelativeAnglesLOS3D_Type_Names::LOS_CrossVerticalAngleRate_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setLOS_CrossVerticalAngleRate(extxml_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    } else if (valueType.first == nsPrefix + RelativeAnglesLOS3D_Type_Names::LOS_CrossHorizontalAngleRate_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setLOS_CrossHorizontalAngleRate(extxml_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
...
std::string RelativeAnglesLOS3D_Type::serialize(const uci::type::RelativeAnglesLOS3D_Type& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, RelativeAnglesLOS3D_Type_Names::Extern_Type_Name);
  }
  ...
  if (accessor.hasLOS_ReferenceFrameRoll()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getLOS_ReferenceFrameRoll(), node, RelativeAnglesLOS3D_Type_Names::LOS_ReferenceFrameRoll_Name);
  }
  ...
  if (accessor.hasLOS_ReferenceFrameRollRate()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getLOS_ReferenceFrameRollRate(), node, RelativeAnglesLOS3D_Type_Names::LOS_ReferenceFrameRollRate_Name);
  }
  if (accessor.hasLOS_CrossVerticalAngleRate()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getLOS_CrossVerticalAngleRate(), node, RelativeAnglesLOS3D_Type_Names::LOS_CrossVerticalAngleRate_Name);
  }
  if (accessor.hasLOS_CrossHorizontalAngleRate()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getLOS_CrossHorizontalAngleRate(), node, RelativeAnglesLOS3D_Type_Names::LOS_CrossHorizontalAngleRate_Name);
  }
