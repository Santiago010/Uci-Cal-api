  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setEntityDimension_SA_Spread(extxml_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
...
std::string EntityDimensionEstimateType::serialize(const uci::type::EntityDimensionEstimateType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, EntityDimensionEstimateType_Names::Extern_Type_Name);
  }
  if (accessor.hasEntityDimension_SA_Spread()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getEntityDimension_SA_Spread(), node, EntityDimensionEstimateType_Names::EntityDimension_SA_Spread_Name);
  }
