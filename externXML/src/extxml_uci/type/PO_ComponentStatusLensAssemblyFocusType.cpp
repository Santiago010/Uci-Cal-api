...
std::string PO_ComponentStatusLensAssemblyFocusType::serialize(const uci::type::PO_ComponentStatusLensAssemblyFocusType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, PO_ComponentStatusLensAssemblyFocusType_Names::Extern_Type_Name);
  }
  if (accessor.isFocusSetting()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getFocusSetting(), node, PO_ComponentStatusLensAssemblyFocusType_Names::FocusSetting_Name);
  } else if (accessor.isAutoFocus()) {
    extxml_uci::util::SerializationHelpers::serializeBoolean(accessor.getAutoFocus(), node, PO_ComponentStatusLensAssemblyFocusType_Names::AutoFocus_Name);
  } else if (accessor.isAutoFocusZoom()) {
    extxml_uci::util::SerializationHelpers::serializeBoolean(accessor.getAutoFocusZoom(), node, PO_ComponentStatusLensAssemblyFocusType_Names::AutoFocusZoom_Name);
