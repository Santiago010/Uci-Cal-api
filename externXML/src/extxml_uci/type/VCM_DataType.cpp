  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setWeightedRMS(extxml_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
...
std::string VCM_DataType::serialize(const uci::type::VCM_DataType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, VCM_DataType_Names::Extern_Type_Name);
  }
  ...
  if (accessor.hasWeightedRMS()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getWeightedRMS(), node, VCM_DataType_Names::WeightedRMS_Name);
  }
