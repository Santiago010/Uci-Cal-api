...
bool RF_RadiusToFixType::deserialize(const boost::property_tree::ptree& propTree, uci::type::RF_RadiusToFixType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      extxml_uci::util::DerivedTypesDeserializer::deserialize(valueType.second, accessor.enableRadiusCenterPoint(extxml_uci::util::SerializationHelpers::checkForTypeAttribute(valueType.second, nsPrefix)), nodeName, nsPrefix);
    } else if (valueType.first == nsPrefix + RF_RadiusToFixType_Names::TurnRadius_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setTurnRadius(extxml_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    } else if (valueType.first == nsPrefix + RF_RadiusToFixType_Names::CourseIn_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setCourseIn(extxml_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    } else if (valueType.first == nsPrefix + RF_RadiusToFixType_Names::CourseOut_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setCourseOut(extxml_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    } else if (valueType.first == nsPrefix + RF_RadiusToFixType_Names::ArcInitialPoint_Name) {
      extxml_uci::util::DerivedTypesDeserializer::deserialize(valueType.second, accessor.enableArcInitialPoint(extxml_uci::util::SerializationHelpers::checkForTypeAttribute(valueType.second, nsPrefix)), nodeName, nsPrefix);
    } else if (valueType.first == nsPrefix + RF_RadiusToFixType_Names::ArcEndPoint_Name) {
      extxml_uci::util::DerivedTypesDeserializer::deserialize(valueType.second, accessor.enableArcEndPoint(extxml_uci::util::SerializationHelpers::checkForTypeAttribute(valueType.second, nsPrefix)), nodeName, nsPrefix);
    } else if (valueType.first == nsPrefix + RF_RadiusToFixType_Names::ArcDistance_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setArcDistance(extxml_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    } else if (valueType.first == nsPrefix + RF_RadiusToFixType_Names::ArcDirectDistance_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setArcDirectDistance(extxml_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
...
std::string RF_RadiusToFixType::serialize(const uci::type::RF_RadiusToFixType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, RF_RadiusToFixType_Names::Extern_Type_Name);
  }
  Point2D_Type::serialize(accessor.getRadiusCenterPoint(), node, RF_RadiusToFixType_Names::RadiusCenterPoint_Name);
  extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getTurnRadius(), node, RF_RadiusToFixType_Names::TurnRadius_Name);
  extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getCourseIn(), node, RF_RadiusToFixType_Names::CourseIn_Name);
  extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getCourseOut(), node, RF_RadiusToFixType_Names::CourseOut_Name);
  ...
  extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getArcDistance(), node, RF_RadiusToFixType_Names::ArcDistance_Name);
  extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getArcDirectDistance(), node, RF_RadiusToFixType_Names::ArcDirectDistance_Name);
