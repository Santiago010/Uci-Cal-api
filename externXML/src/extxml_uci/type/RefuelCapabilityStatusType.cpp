...
std::string RefuelCapabilityStatusType::serialize(const uci::type::RefuelCapabilityStatusType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, RefuelCapabilityStatusType_Names::Extern_Type_Name);
  }
  if (accessor.isBoom()) {
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getBoom(), node, RefuelCapabilityStatusType_Names::Boom_Name);
