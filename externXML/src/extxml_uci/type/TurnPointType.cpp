...
bool TurnPointType::deserialize(const boost::property_tree::ptree& propTree, uci::type::TurnPointType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
...
std::string TurnPointType::serialize(const uci::type::TurnPointType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, TurnPointType_Names::Extern_Type_Name);
  }
  ...
  if (accessor.hasCourse()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getCourse(), node, TurnPointType_Names::Course_Name);
  }
