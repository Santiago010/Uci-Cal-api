  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setInstantiationTime(extxml_uci::util::SerializationHelpers::deserializeDateTime(*value));
      }
...
std::string ResponseActivityType::serialize(const uci::type::ResponseActivityType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, ResponseActivityType_Names::Extern_Type_Name);
  }
  ActivityBaseType::serialize(accessor, node, "", false, false, false);
  extxml_uci::util::SerializationHelpers::serializeDateTime(accessor.getInstantiationTime(), node, ResponseActivityType_Names::InstantiationTime_Name);
  if (accessor.hasOptionIndex()) {
    extxml_uci::util::SerializationHelpers::serializeUnsignedInt(accessor.getOptionIndex(), node, ResponseActivityType_Names::OptionIndex_Name);
  }
  {
