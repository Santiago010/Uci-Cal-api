  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setRelativeMeasurementReference(extxml_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
...
std::string ElementDetailsType::serialize(const uci::type::ElementDetailsType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, ElementDetailsType_Names::Extern_Type_Name);
  }
  {
  ...
  if (accessor.hasRelativeMeasurementReference()) {
    extxml_uci::util::SerializationHelpers::serializeBoolean(accessor.getRelativeMeasurementReference(), node, ElementDetailsType_Names::RelativeMeasurementReference_Name);
  }
