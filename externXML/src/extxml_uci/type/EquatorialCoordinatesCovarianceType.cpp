  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setRA_RA(extxml_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    } else if (valueType.first == nsPrefix + EquatorialCoordinatesCovarianceType_Names::RA_Dec_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setRA_Dec(extxml_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    } else if (valueType.first == nsPrefix + EquatorialCoordinatesCovarianceType_Names::RA_Range_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setRA_Range(extxml_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    } else if (valueType.first == nsPrefix + EquatorialCoordinatesCovarianceType_Names::DecDec_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setDecDec(extxml_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    } else if (valueType.first == nsPrefix + EquatorialCoordinatesCovarianceType_Names::DecRange_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setDecRange(extxml_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    } else if (valueType.first == nsPrefix + EquatorialCoordinatesCovarianceType_Names::RangeRange_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setRangeRange(extxml_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    }
  }
  return true;
...
std::string EquatorialCoordinatesCovarianceType::serialize(const uci::type::EquatorialCoordinatesCovarianceType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, EquatorialCoordinatesCovarianceType_Names::Extern_Type_Name);
  }
  if (accessor.hasRA_RA()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getRA_RA(), node, EquatorialCoordinatesCovarianceType_Names::RA_RA_Name);
  }
  if (accessor.hasRA_Dec()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getRA_Dec(), node, EquatorialCoordinatesCovarianceType_Names::RA_Dec_Name);
  }
  if (accessor.hasRA_Range()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getRA_Range(), node, EquatorialCoordinatesCovarianceType_Names::RA_Range_Name);
  }
  if (accessor.hasDecDec()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getDecDec(), node, EquatorialCoordinatesCovarianceType_Names::DecDec_Name);
  }
  if (accessor.hasDecRange()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getDecRange(), node, EquatorialCoordinatesCovarianceType_Names::DecRange_Name);
  }
  if (accessor.hasRangeRange()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getRangeRange(), node, EquatorialCoordinatesCovarianceType_Names::RangeRange_Name);
  }
  if (createNode) {
