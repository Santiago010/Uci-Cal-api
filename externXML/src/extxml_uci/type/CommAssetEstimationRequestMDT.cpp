...
bool CommAssetEstimationRequestMDT::deserialize(const boost::property_tree::ptree& propTree, uci::type::CommAssetEstimationRequestMDT& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setEstimationStart(extxml_uci::util::SerializationHelpers::deserializeDateTime(*value));
      }
    } else if (valueType.first == nsPrefix + CommAssetEstimationRequestMDT_Names::EstimationEnd_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setEstimationEnd(extxml_uci::util::SerializationHelpers::deserializeDateTime(*value));
      }
    }
  }
...
std::string CommAssetEstimationRequestMDT::serialize(const uci::type::CommAssetEstimationRequestMDT& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, CommAssetEstimationRequestMDT_Names::Extern_Type_Name);
  }
  ...
  extxml_uci::util::SerializationHelpers::serializeBoolean(accessor.getResultsInNativeMessage(), node, CommAssetEstimationRequestMDT_Names::ResultsInNativeMessage_Name);
  if (accessor.hasTimeStep()) {
    extxml_uci::util::SerializationHelpers::serializeDuration(accessor.getTimeStep(), node, CommAssetEstimationRequestMDT_Names::TimeStep_Name);
  }
  if (accessor.hasEstimationStart()) {
    extxml_uci::util::SerializationHelpers::serializeDateTime(accessor.getEstimationStart(), node, CommAssetEstimationRequestMDT_Names::EstimationStart_Name);
  }
  if (accessor.hasEstimationEnd()) {
    extxml_uci::util::SerializationHelpers::serializeDateTime(accessor.getEstimationEnd(), node, CommAssetEstimationRequestMDT_Names::EstimationEnd_Name);
  }
  if (createNode) {
