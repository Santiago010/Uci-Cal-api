  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setSemiMajorAxisLength_A(extxml_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    } else if (valueType.first == nsPrefix + EllipsoidType_Names::SemiMinorAxisLength_B_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setSemiMinorAxisLength_B(extxml_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    } else if (valueType.first == nsPrefix + EllipsoidType_Names::SemiMinorAxisLength_C_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setSemiMinorAxisLength_C(extxml_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
...
std::string EllipsoidType::serialize(const uci::type::EllipsoidType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, EllipsoidType_Names::Extern_Type_Name);
  }
  extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getSemiMajorAxisLength_A(), node, EllipsoidType_Names::SemiMajorAxisLength_A_Name);
  extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getSemiMinorAxisLength_B(), node, EllipsoidType_Names::SemiMinorAxisLength_B_Name);
  extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getSemiMinorAxisLength_C(), node, EllipsoidType_Names::SemiMinorAxisLength_C_Name);
