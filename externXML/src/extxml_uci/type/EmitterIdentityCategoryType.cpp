...
bool EmitterIdentityCategoryType::deserialize(const boost::property_tree::ptree& propTree, uci::type::EmitterIdentityCategoryType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
...
std::string EmitterIdentityCategoryType::serialize(const uci::type::EmitterIdentityCategoryType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, EmitterIdentityCategoryType_Names::Extern_Type_Name);
  }
  if (accessor.isRadar()) {
