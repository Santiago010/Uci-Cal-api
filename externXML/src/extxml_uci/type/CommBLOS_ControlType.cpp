...
bool CommBLOS_ControlType::deserialize(const boost::property_tree::ptree& propTree, uci::type::CommBLOS_ControlType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        ...
        CommBLOS_NetworkComsecModeRequestType::deserialize(valueType.second, boundedList.at(boundedListSize), nodeName, nsPrefix);
      }
    }
  }
  return true;
...
std::string CommBLOS_ControlType::serialize(const uci::type::CommBLOS_ControlType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, CommBLOS_ControlType_Names::Extern_Type_Name);
  }
  ...
  }
  {
    ...
    for (uci::type::CommBLOS_ControlType::NetworkComsecModeRequest::size_type i = 0, end = boundedList.size(); i < end; ++i) {
      CommBLOS_NetworkComsecModeRequestType::serialize(boundedList.at(i), node, CommBLOS_ControlType_Names::NetworkComsecModeRequest_Name);
    }
  }
  if (createNode) {
