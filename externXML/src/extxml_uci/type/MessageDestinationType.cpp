  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setValidSystemStatus(extxml_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
...
std::string MessageDestinationType::serialize(const uci::type::MessageDestinationType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, MessageDestinationType_Names::Extern_Type_Name);
  }
  ...
  if (accessor.hasValidSystemStatus()) {
    extxml_uci::util::SerializationHelpers::serializeBoolean(accessor.getValidSystemStatus(), node, MessageDestinationType_Names::ValidSystemStatus_Name);
  }
