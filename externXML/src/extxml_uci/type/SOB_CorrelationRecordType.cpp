...
std::string SOB_CorrelationRecordType::serialize(const uci::type::SOB_CorrelationRecordType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, SOB_CorrelationRecordType_Names::Extern_Type_Name);
  }
  ...
  extxml_uci::util::SerializationHelpers::serializeDateTime(accessor.getCorrelationTimestamp(), node, SOB_CorrelationRecordType_Names::CorrelationTimestamp_Name);
