...
bool OperatorNotificationMDT::deserialize(const boost::property_tree::ptree& propTree, uci::type::OperatorNotificationMDT& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      extxml_uci::util::DerivedTypesDeserializer::deserialize(valueType.second, accessor.enableOperatorNotificationTemplateID(extxml_uci::util::SerializationHelpers::checkForTypeAttribute(valueType.second, nsPrefix)), nodeName, nsPrefix);
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setCount(extxml_uci::util::SerializationHelpers::deserializeUnsignedInt(*value));
      }
    } else if (valueType.first == nsPrefix + OperatorNotificationMDT_Names::OccurrenceTimestamp_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setOccurrenceTimestamp(extxml_uci::util::SerializationHelpers::deserializeDateTime(*value));
      }
    } else if (valueType.first == nsPrefix + OperatorNotificationMDT_Names::Priority_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setPriority(extxml_uci::util::SerializationHelpers::deserializeUnsignedByte(*value));
      }
...
std::string OperatorNotificationMDT::serialize(const uci::type::OperatorNotificationMDT& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, OperatorNotificationMDT_Names::Extern_Type_Name);
  }
  ...
  }
  {
    ...
    for (uci::type::OperatorNotificationMDT::OperatorNotificationTemplateParameters::size_type i = 0, end = boundedList.size(); i < end; ++i) {
      extxml_uci::util::SerializationHelpers::serializeString(boundedList.at(i), node, OperatorNotificationMDT_Names::OperatorNotificationTemplateParameters_Name);
    }
  }
  extxml_uci::util::SerializationHelpers::serializeString(accessor.getTitle(), node, OperatorNotificationMDT_Names::Title_Name);
  if (accessor.hasDetails()) {
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getDetails(), node, OperatorNotificationMDT_Names::Details_Name);
  }
  ...
  if (accessor.hasCount()) {
    extxml_uci::util::SerializationHelpers::serializeUnsignedInt(accessor.getCount(), node, OperatorNotificationMDT_Names::Count_Name);
  }
  if (accessor.hasOccurrenceTimestamp()) {
    extxml_uci::util::SerializationHelpers::serializeDateTime(accessor.getOccurrenceTimestamp(), node, OperatorNotificationMDT_Names::OccurrenceTimestamp_Name);
  }
  if (accessor.hasPriority()) {
    extxml_uci::util::SerializationHelpers::serializeUnsignedByte(accessor.getPriority(), node, OperatorNotificationMDT_Names::Priority_Name);
  }
