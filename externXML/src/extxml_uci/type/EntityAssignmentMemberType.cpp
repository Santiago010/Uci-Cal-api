  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setTrackIndex(extxml_uci::util::SerializationHelpers::deserializeUnsignedByte(*value));
      }
    }
  }
  return true;
...
std::string EntityAssignmentMemberType::serialize(const uci::type::EntityAssignmentMemberType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, EntityAssignmentMemberType_Names::Extern_Type_Name);
  }
  EntityID_Type::serialize(accessor.getEntityID(), node, EntityAssignmentMemberType_Names::EntityID_Name);
  extxml_uci::util::SerializationHelpers::serializeUnsignedByte(accessor.getTrackIndex(), node, EntityAssignmentMemberType_Names::TrackIndex_Name);
  if (createNode) {
