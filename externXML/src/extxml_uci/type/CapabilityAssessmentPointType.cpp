...
bool CapabilityAssessmentPointType::deserialize(const boost::property_tree::ptree& propTree, uci::type::CapabilityAssessmentPointType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      extxml_uci::util::DerivedTypesDeserializer::deserialize(valueType.second, accessor.enableInertialState(extxml_uci::util::SerializationHelpers::checkForTypeAttribute(valueType.second, nsPrefix)), nodeName, nsPrefix);
      ...
      CapabilityAssessmentActionType::deserialize(valueType.second, boundedList.at(boundedListSize), nodeName, nsPrefix);
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        ...
        boundedList.resize(boundedListSize + 1);
        CapabilityAssessmentActivityDetailsType::deserialize(valueType.second, boundedList.at(boundedListSize), nodeName, nsPrefix);
      }
    }
  }
  return true;
...
std::string CapabilityAssessmentPointType::serialize(const uci::type::CapabilityAssessmentPointType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, CapabilityAssessmentPointType_Names::Extern_Type_Name);
  }
  ...
  }
  {
    ...
    for (uci::type::CapabilityAssessmentPointType::Action::size_type i = 0, end = boundedList.size(); i < end; ++i) {
      CapabilityAssessmentActionType::serialize(boundedList.at(i), node, CapabilityAssessmentPointType_Names::Action_Name);
    }
  }
  {
    ...
    for (uci::type::CapabilityAssessmentPointType::ActivityDetails::size_type i = 0, end = boundedList.size(); i < end; ++i) {
      CapabilityAssessmentActivityDetailsType::serialize(boundedList.at(i), node, CapabilityAssessmentPointType_Names::ActivityDetails_Name);
    }
  }
  if (createNode) {
