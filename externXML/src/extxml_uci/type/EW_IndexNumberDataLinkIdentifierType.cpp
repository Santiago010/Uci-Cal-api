  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setIndexNumber(extxml_uci::util::SerializationHelpers::deserializeUnsignedInt(*value));
      }
...
std::string EW_IndexNumberDataLinkIdentifierType::serialize(const uci::type::EW_IndexNumberDataLinkIdentifierType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, EW_IndexNumberDataLinkIdentifierType_Names::Extern_Type_Name);
  }
  DataLinkIdentifierPET::serialize(accessor, node, "", false, false, false);
  extxml_uci::util::SerializationHelpers::serializeUnsignedInt(accessor.getIndexNumber(), node, EW_IndexNumberDataLinkIdentifierType_Names::IndexNumber_Name);
