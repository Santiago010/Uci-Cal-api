  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setSpeedOverride(extxml_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    } else if (valueType.first == nsPrefix + MissionPlanNavigationType_Names::AltitudeOverride_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setAltitudeOverride(extxml_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    }
  }
  return true;
...
std::string MissionPlanNavigationType::serialize(const uci::type::MissionPlanNavigationType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, MissionPlanNavigationType_Names::Extern_Type_Name);
  }
  if (accessor.hasSpeedOverride()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getSpeedOverride(), node, MissionPlanNavigationType_Names::SpeedOverride_Name);
  }
  if (accessor.hasAltitudeOverride()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getAltitudeOverride(), node, MissionPlanNavigationType_Names::AltitudeOverride_Name);
  }
  if (createNode) {
