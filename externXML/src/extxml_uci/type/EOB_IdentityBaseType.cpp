...
bool EOB_IdentityBaseType::deserialize(const boost::property_tree::ptree& propTree, uci::type::EOB_IdentityBaseType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      extxml_uci::util::DerivedTypesDeserializer::deserialize(valueType.second, accessor.enableInternalID(extxml_uci::util::SerializationHelpers::checkForTypeAttribute(valueType.second, nsPrefix)), nodeName, nsPrefix);
    }
  }
  return true;
}
...
std::string EOB_IdentityBaseType::serialize(const uci::type::EOB_IdentityBaseType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool checkIfDerivation, const bool /*topLevel*/) {
  ...
  if (!checkIfDerivation || (accessor.getAccessorType() == uci::type::accessorType::eOB_IdentityBaseType)) {
    ...
    if (addTypeAttribute) {
      extxml_uci::util::SerializationHelpers::addTypeAttribute(node, EOB_IdentityBaseType_Names::Extern_Type_Name);
    }
    ...
    if (accessor.hasSiteName()) {
      extxml_uci::util::SerializationHelpers::serializeString(accessor.getSiteName(), node, EOB_IdentityBaseType_Names::SiteName_Name);
    }
