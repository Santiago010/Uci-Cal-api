...
bool CommMADL_LinkStatusType::deserialize(const boost::property_tree::ptree& propTree, uci::type::CommMADL_LinkStatusType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setVoiceSource(extxml_uci::util::SerializationHelpers::deserializeUnsignedShort(*value));
      }
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setSearchVector(extxml_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setHopOffset(extxml_uci::util::SerializationHelpers::deserializeUnsignedShort(*value));
      }
    }
  }
  return true;
...
std::string CommMADL_LinkStatusType::serialize(const uci::type::CommMADL_LinkStatusType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, CommMADL_LinkStatusType_Names::Extern_Type_Name);
  }
  ...
  if (accessor.hasHigherDataRateCapable()) {
    extxml_uci::util::SerializationHelpers::serializeBoolean(accessor.getHigherDataRateCapable(), node, CommMADL_LinkStatusType_Names::HigherDataRateCapable_Name);
  }
  ...
  if (accessor.hasVoiceSource()) {
    extxml_uci::util::SerializationHelpers::serializeUnsignedShort(accessor.getVoiceSource(), node, CommMADL_LinkStatusType_Names::VoiceSource_Name);
  }
  ...
  if (accessor.hasSearchVector()) {
    extxml_uci::util::SerializationHelpers::serializeBoolean(accessor.getSearchVector(), node, CommMADL_LinkStatusType_Names::SearchVector_Name);
  }
  ...
  if (accessor.hasHopOffset()) {
    extxml_uci::util::SerializationHelpers::serializeUnsignedShort(accessor.getHopOffset(), node, CommMADL_LinkStatusType_Names::HopOffset_Name);
  }
  if (createNode) {
