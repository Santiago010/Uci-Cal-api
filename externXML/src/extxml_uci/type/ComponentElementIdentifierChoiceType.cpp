  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setComponentElementNumericIdentifier(extxml_uci::util::SerializationHelpers::deserializeUnsignedInt(*value));
      }
    } else if (valueType.first == nsPrefix + ComponentElementIdentifierChoiceType_Names::ComponentElementKey_Name) {
      extxml_uci::util::DerivedTypesDeserializer::deserialize(valueType.second, accessor.chooseComponentElementKey(extxml_uci::util::SerializationHelpers::checkForTypeAttribute(valueType.second, nsPrefix)), nodeName, nsPrefix);
    }
  }
  return true;
}
...
std::string ComponentElementIdentifierChoiceType::serialize(const uci::type::ComponentElementIdentifierChoiceType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, ComponentElementIdentifierChoiceType_Names::Extern_Type_Name);
  }
  if (accessor.isComponentElementNumericIdentifier()) {
    extxml_uci::util::SerializationHelpers::serializeUnsignedInt(accessor.getComponentElementNumericIdentifier(), node, ComponentElementIdentifierChoiceType_Names::ComponentElementNumericIdentifier_Name);
