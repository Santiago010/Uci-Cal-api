  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setAzimuthAzimuthRate(extxml_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    } else if (valueType.first == nsPrefix + LOS_CovariancesRatesType_Names::ElevationElevationRate_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setElevationElevationRate(extxml_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    } else if (valueType.first == nsPrefix + LOS_CovariancesRatesType_Names::AzimuthElevationRate_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setAzimuthElevationRate(extxml_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    } else if (valueType.first == nsPrefix + LOS_CovariancesRatesType_Names::ElevationAzimuthRate_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setElevationAzimuthRate(extxml_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    } else if (valueType.first == nsPrefix + LOS_CovariancesRatesType_Names::AzimuthRateElevationRate_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setAzimuthRateElevationRate(extxml_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    }
  }
  return true;
...
std::string LOS_CovariancesRatesType::serialize(const uci::type::LOS_CovariancesRatesType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, LOS_CovariancesRatesType_Names::Extern_Type_Name);
  }
  if (accessor.hasAzimuthAzimuthRate()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getAzimuthAzimuthRate(), node, LOS_CovariancesRatesType_Names::AzimuthAzimuthRate_Name);
  }
  if (accessor.hasElevationElevationRate()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getElevationElevationRate(), node, LOS_CovariancesRatesType_Names::ElevationElevationRate_Name);
  }
  if (accessor.hasAzimuthElevationRate()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getAzimuthElevationRate(), node, LOS_CovariancesRatesType_Names::AzimuthElevationRate_Name);
  }
  if (accessor.hasElevationAzimuthRate()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getElevationAzimuthRate(), node, LOS_CovariancesRatesType_Names::ElevationAzimuthRate_Name);
  }
  if (accessor.hasAzimuthRateElevationRate()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getAzimuthRateElevationRate(), node, LOS_CovariancesRatesType_Names::AzimuthRateElevationRate_Name);
  }
  if (createNode) {
