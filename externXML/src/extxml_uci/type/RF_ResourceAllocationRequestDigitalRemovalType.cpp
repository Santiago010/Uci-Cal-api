  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setStreamIndex(extxml_uci::util::SerializationHelpers::deserializeUnsignedInt(*value));
      }
...
std::string RF_ResourceAllocationRequestDigitalRemovalType::serialize(const uci::type::RF_ResourceAllocationRequestDigitalRemovalType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, RF_ResourceAllocationRequestDigitalRemovalType_Names::Extern_Type_Name);
  }
  if (accessor.hasStreamIndex()) {
    extxml_uci::util::SerializationHelpers::serializeUnsignedInt(accessor.getStreamIndex(), node, RF_ResourceAllocationRequestDigitalRemovalType_Names::StreamIndex_Name);
  }
  {
