...
bool PO_ComponentLensAssemblyFieldOfViewType::deserialize(const boost::property_tree::ptree& propTree, uci::type::PO_ComponentLensAssemblyFieldOfViewType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setFixedFOV(extxml_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
...
std::string PO_ComponentLensAssemblyFieldOfViewType::serialize(const uci::type::PO_ComponentLensAssemblyFieldOfViewType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, PO_ComponentLensAssemblyFieldOfViewType_Names::Extern_Type_Name);
  }
  if (accessor.isFixedFOV()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getFixedFOV(), node, PO_ComponentLensAssemblyFieldOfViewType_Names::FixedFOV_Name);
