...
bool SAR_SubCapabilityType::deserialize(const boost::property_tree::ptree& propTree, uci::type::SAR_SubCapabilityType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setAllowableEllipticityMagnitude(extxml_uci::util::SerializationHelpers::deserializeFloat(*value));
      }
    } else if (valueType.first == nsPrefix + SAR_SubCapabilityType_Names::MaximumBeamRolloffDB_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setMaximumBeamRolloffDB(extxml_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
...
std::string SAR_SubCapabilityType::serialize(const uci::type::SAR_SubCapabilityType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, SAR_SubCapabilityType_Names::Extern_Type_Name);
  }
  ...
  if (accessor.hasMultiLook()) {
    extxml_uci::util::SerializationHelpers::serializeBoolean(accessor.getMultiLook(), node, SAR_SubCapabilityType_Names::MultiLook_Name);
  }
  ...
  if (accessor.hasAllowableEllipticityMagnitude()) {
    extxml_uci::util::SerializationHelpers::serializeFloat(accessor.getAllowableEllipticityMagnitude(), node, SAR_SubCapabilityType_Names::AllowableEllipticityMagnitude_Name);
  }
  if (accessor.hasMaximumBeamRolloffDB()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getMaximumBeamRolloffDB(), node, SAR_SubCapabilityType_Names::MaximumBeamRolloffDB_Name);
  }
