...
std::string AO_CodeType::serialize(const uci::type::AO_CodeType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, AO_CodeType_Names::Extern_Type_Name);
  }
  if (accessor.hasPRF_Code()) {
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getPRF_Code(), node, AO_CodeType_Names::PRF_Code_Name);
  }
  if (accessor.hasPIM_Code()) {
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getPIM_Code(), node, AO_CodeType_Names::PIM_Code_Name);
  }
  if (createNode) {
