...
bool PositionReportDataType::deserialize(const boost::property_tree::ptree& propTree, uci::type::PositionReportDataType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setFigureOfMerit(extxml_uci::util::SerializationHelpers::deserializeUnsignedByte(*value));
      }
...
std::string PositionReportDataType::serialize(const uci::type::PositionReportDataType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, PositionReportDataType_Names::Extern_Type_Name);
  }
  ...
  if (accessor.hasFigureOfMerit()) {
    extxml_uci::util::SerializationHelpers::serializeUnsignedByte(accessor.getFigureOfMerit(), node, PositionReportDataType_Names::FigureOfMerit_Name);
  }
