  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setUseMIDS_DelayReduction(extxml_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setLink16_MessageSubLabelType(extxml_uci::util::SerializationHelpers::deserializeUnsignedByte(*value));
      }
    }
  }
  return true;
...
std::string CommLink16DelayReductionType::serialize(const uci::type::CommLink16DelayReductionType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, CommLink16DelayReductionType_Names::Extern_Type_Name);
  }
  extxml_uci::util::SerializationHelpers::serializeBoolean(accessor.getUseMIDS_DelayReduction(), node, CommLink16DelayReductionType_Names::UseMIDS_DelayReduction_Name);
  extxml_uci::util::SerializationHelpers::serializeUnsignedByte(accessor.getMessageLabel(), node, CommLink16DelayReductionType_Names::MessageLabel_Name);
  extxml_uci::util::SerializationHelpers::serializeUnsignedByte(accessor.getLink16_MessageSubLabelType(), node, CommLink16DelayReductionType_Names::Link16_MessageSubLabelType_Name);
  if (createNode) {
