...
bool CS_ForceType::deserialize(const boost::property_tree::ptree& propTree, uci::type::CS_ForceType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      extxml_uci::util::DerivedTypesDeserializer::deserialize(valueType.second, accessor.enableForceName(extxml_uci::util::SerializationHelpers::checkForTypeAttribute(valueType.second, nsPrefix)), nodeName, nsPrefix);
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setPortable(extxml_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
    } else if (valueType.first == nsPrefix + CS_ForceType_Names::PortableRadius_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setPortableRadius(extxml_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    } else if (valueType.first == nsPrefix + CS_ForceType_Names::UseForceObscura_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setUseForceObscura(extxml_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
...
std::string CS_ForceType::serialize(const uci::type::CS_ForceType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, CS_ForceType_Names::Extern_Type_Name);
  }
  ...
  if (accessor.hasLocationName()) {
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getLocationName(), node, CS_ForceType_Names::LocationName_Name);
  }
  {
  ...
  if (accessor.hasLocked()) {
    extxml_uci::util::SerializationHelpers::serializeBoolean(accessor.getLocked(), node, CS_ForceType_Names::Locked_Name);
  }
  {
  ...
  if (accessor.hasPortable()) {
    extxml_uci::util::SerializationHelpers::serializeBoolean(accessor.getPortable(), node, CS_ForceType_Names::Portable_Name);
  }
  if (accessor.hasPortableRadius()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getPortableRadius(), node, CS_ForceType_Names::PortableRadius_Name);
  }
  if (accessor.hasUseForceObscura()) {
    extxml_uci::util::SerializationHelpers::serializeBoolean(accessor.getUseForceObscura(), node, CS_ForceType_Names::UseForceObscura_Name);
  }
