...
std::string PO_TrackDetailsType::serialize(const uci::type::PO_TrackDetailsType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, PO_TrackDetailsType_Names::Extern_Type_Name);
  }
  ...
  if (accessor.hasObservedEntityThreshold()) {
    extxml_uci::util::SerializationHelpers::serializeDuration(accessor.getObservedEntityThreshold(), node, PO_TrackDetailsType_Names::ObservedEntityThreshold_Name);
  }
  if (accessor.hasTrackingRange()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getTrackingRange(), node, PO_TrackDetailsType_Names::TrackingRange_Name);
  }
  {
