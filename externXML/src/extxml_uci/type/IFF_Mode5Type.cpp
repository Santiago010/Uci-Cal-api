...
std::string IFF_Mode5Type::serialize(const uci::type::IFF_Mode5Type& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, IFF_Mode5Type_Names::Extern_Type_Name);
  }
  extxml_uci::util::SerializationHelpers::serializeInt(accessor.getNationalOrigin(), node, IFF_Mode5Type_Names::NationalOrigin_Name);
  extxml_uci::util::SerializationHelpers::serializeInt(accessor.getPIN(), node, IFF_Mode5Type_Names::PIN_Name);
  ...
  if (accessor.hasMode1Code()) {
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getMode1Code(), node, IFF_Mode5Type_Names::Mode1Code_Name);
  }
  if (createNode) {
