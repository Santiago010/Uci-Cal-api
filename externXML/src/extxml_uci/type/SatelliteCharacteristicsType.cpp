...
std::string SatelliteCharacteristicsType::serialize(const uci::type::SatelliteCharacteristicsType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, SatelliteCharacteristicsType_Names::Extern_Type_Name);
  }
  if (accessor.hasBusType()) {
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getBusType(), node, SatelliteCharacteristicsType_Names::BusType_Name);
  }
  {
  ...
  if (accessor.hasMass()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getMass(), node, SatelliteCharacteristicsType_Names::Mass_Name);
  }
  {
