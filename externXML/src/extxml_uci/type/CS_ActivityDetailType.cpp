...
bool CS_ActivityDetailType::deserialize(const boost::property_tree::ptree& propTree, uci::type::CS_ActivityDetailType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setEIRP(extxml_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    } else if (valueType.first == nsPrefix + CS_ActivityDetailType_Names::SatNo_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setSatNo(extxml_uci::util::SerializationHelpers::deserializeUnsignedInt(*value));
      }
    } else if (valueType.first == nsPrefix + CS_ActivityDetailType_Names::Success_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setSuccess(extxml_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
    } else if (valueType.first == nsPrefix + CS_ActivityDetailType_Names::Content_Name) {
      extxml_uci::util::DerivedTypesDeserializer::deserialize(valueType.second, accessor.enableContent(extxml_uci::util::SerializationHelpers::checkForTypeAttribute(valueType.second, nsPrefix)), nodeName, nsPrefix);
      ...
      extxml_uci::util::DerivedTypesDeserializer::deserialize(valueType.second, accessor.enableTechnique(extxml_uci::util::SerializationHelpers::checkForTypeAttribute(valueType.second, nsPrefix)), nodeName, nsPrefix);
...
std::string CS_ActivityDetailType::serialize(const uci::type::CS_ActivityDetailType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool checkIfDerivation, const bool /*topLevel*/) {
  ...
  if (!checkIfDerivation || (accessor.getAccessorType() == uci::type::accessorType::cS_ActivityDetailType)) {
    ...
    if (addTypeAttribute) {
      extxml_uci::util::SerializationHelpers::addTypeAttribute(node, CS_ActivityDetailType_Names::Extern_Type_Name);
    }
    if (accessor.hasSENO()) {
      extxml_uci::util::SerializationHelpers::serializeString(accessor.getSENO(), node, CS_ActivityDetailType_Names::SENO_Name);
    }
    ...
    if (accessor.hasEIRP()) {
      extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getEIRP(), node, CS_ActivityDetailType_Names::EIRP_Name);
    }
    if (accessor.hasSatNo()) {
      extxml_uci::util::SerializationHelpers::serializeUnsignedInt(accessor.getSatNo(), node, CS_ActivityDetailType_Names::SatNo_Name);
    }
    if (accessor.hasSuccess()) {
      extxml_uci::util::SerializationHelpers::serializeBoolean(accessor.getSuccess(), node, CS_ActivityDetailType_Names::Success_Name);
    }
