  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setDataRateAverage(extxml_uci::util::SerializationHelpers::deserializeUnsignedInt(*value));
      }
    } else if (valueType.first == nsPrefix + DataRateDataType_Names::DataRateMin_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setDataRateMin(extxml_uci::util::SerializationHelpers::deserializeUnsignedInt(*value));
      }
    } else if (valueType.first == nsPrefix + DataRateDataType_Names::DataRateMax_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setDataRateMax(extxml_uci::util::SerializationHelpers::deserializeUnsignedInt(*value));
      }
    } else if (valueType.first == nsPrefix + DataRateDataType_Names::DataRateDeviation_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setDataRateDeviation(extxml_uci::util::SerializationHelpers::deserializeUnsignedInt(*value));
      }
    }
  }
  return true;
...
std::string DataRateDataType::serialize(const uci::type::DataRateDataType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool checkIfDerivation, const bool /*topLevel*/) {
  ...
  if (!checkIfDerivation || (accessor.getAccessorType() == uci::type::accessorType::dataRateDataType)) {
    ...
    if (addTypeAttribute) {
      extxml_uci::util::SerializationHelpers::addTypeAttribute(node, DataRateDataType_Names::Extern_Type_Name);
    }
    if (accessor.hasDataRateAverage()) {
      extxml_uci::util::SerializationHelpers::serializeUnsignedInt(accessor.getDataRateAverage(), node, DataRateDataType_Names::DataRateAverage_Name);
    }
    if (accessor.hasDataRateMin()) {
      extxml_uci::util::SerializationHelpers::serializeUnsignedInt(accessor.getDataRateMin(), node, DataRateDataType_Names::DataRateMin_Name);
    }
    if (accessor.hasDataRateMax()) {
      extxml_uci::util::SerializationHelpers::serializeUnsignedInt(accessor.getDataRateMax(), node, DataRateDataType_Names::DataRateMax_Name);
    }
    if (accessor.hasDataRateDeviation()) {
      extxml_uci::util::SerializationHelpers::serializeUnsignedInt(accessor.getDataRateDeviation(), node, DataRateDataType_Names::DataRateDeviation_Name);
    }
    if (createNode) {
