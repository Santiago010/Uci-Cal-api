  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setWindowSizeX(extxml_uci::util::SerializationHelpers::deserializeUnsignedInt(*value));
      }
    } else if (valueType.first == nsPrefix + PO_ComponentWindowType_Names::WindowSizeY_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setWindowSizeY(extxml_uci::util::SerializationHelpers::deserializeUnsignedInt(*value));
      }
    } else if (valueType.first == nsPrefix + PO_ComponentWindowType_Names::LowerLeftX_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setLowerLeftX(extxml_uci::util::SerializationHelpers::deserializeUnsignedInt(*value));
      }
    } else if (valueType.first == nsPrefix + PO_ComponentWindowType_Names::LowerLeftY_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setLowerLeftY(extxml_uci::util::SerializationHelpers::deserializeUnsignedInt(*value));
      }
...
std::string PO_ComponentWindowType::serialize(const uci::type::PO_ComponentWindowType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, PO_ComponentWindowType_Names::Extern_Type_Name);
  }
  PO_WindowID_Type::serialize(accessor.getPO_WindowID(), node, PO_ComponentWindowType_Names::PO_WindowID_Name);
  extxml_uci::util::SerializationHelpers::serializeUnsignedInt(accessor.getWindowSizeX(), node, PO_ComponentWindowType_Names::WindowSizeX_Name);
  extxml_uci::util::SerializationHelpers::serializeUnsignedInt(accessor.getWindowSizeY(), node, PO_ComponentWindowType_Names::WindowSizeY_Name);
  extxml_uci::util::SerializationHelpers::serializeUnsignedInt(accessor.getLowerLeftX(), node, PO_ComponentWindowType_Names::LowerLeftX_Name);
  extxml_uci::util::SerializationHelpers::serializeUnsignedInt(accessor.getLowerLeftY(), node, PO_ComponentWindowType_Names::LowerLeftY_Name);
  {
    ...
    for (uci::type::PO_ComponentWindowType::ColorDepth::size_type i = 0, end = boundedList.size(); i < end; ++i) {
      extxml_uci::util::SerializationHelpers::serializeUnsignedInt(boundedList.at(i), node, PO_ComponentWindowType_Names::ColorDepth_Name);
    }
  }
  if (createNode) {
