  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setInterrogatorIdentifier(extxml_uci::util::SerializationHelpers::deserializeInt(*value));
      }
    } else if (valueType.first == nsPrefix + ModeS_InterrogatorAddressType_Names::SurveillanceIdentifier_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setSurveillanceIdentifier(extxml_uci::util::SerializationHelpers::deserializeInt(*value));
      }
    }
  }
  return true;
...
std::string ModeS_InterrogatorAddressType::serialize(const uci::type::ModeS_InterrogatorAddressType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, ModeS_InterrogatorAddressType_Names::Extern_Type_Name);
  }
  if (accessor.isInterrogatorIdentifier()) {
    extxml_uci::util::SerializationHelpers::serializeInt(accessor.getInterrogatorIdentifier(), node, ModeS_InterrogatorAddressType_Names::InterrogatorIdentifier_Name);
  } else if (accessor.isSurveillanceIdentifier()) {
    extxml_uci::util::SerializationHelpers::serializeInt(accessor.getSurveillanceIdentifier(), node, ModeS_InterrogatorAddressType_Names::SurveillanceIdentifier_Name);
  }
  if (createNode) {
