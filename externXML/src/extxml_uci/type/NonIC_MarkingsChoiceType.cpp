...
bool NonIC_MarkingsChoiceType::deserialize(const boost::property_tree::ptree& propTree, uci::type::NonIC_MarkingsChoiceType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
...
std::string NonIC_MarkingsChoiceType::serialize(const uci::type::NonIC_MarkingsChoiceType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, NonIC_MarkingsChoiceType_Names::Extern_Type_Name);
  }
  if (accessor.isStandardMarking()) {
    ...
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getAlternateMarking(), node, NonIC_MarkingsChoiceType_Names::AlternateMarking_Name);
  }
  if (createNode) {
