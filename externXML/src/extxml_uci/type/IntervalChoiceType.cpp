...
std::string IntervalChoiceType::serialize(const uci::type::IntervalChoiceType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, IntervalChoiceType_Names::Extern_Type_Name);
  }
  if (accessor.isDistance()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getDistance(), node, IntervalChoiceType_Names::Distance_Name);
  } else if (accessor.isDuration()) {
    extxml_uci::util::SerializationHelpers::serializeDuration(accessor.getDuration(), node, IntervalChoiceType_Names::Duration_Name);
  }
  if (createNode) {
