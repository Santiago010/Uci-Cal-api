...
std::string SMTI_ActivityCommandType::serialize(const uci::type::SMTI_ActivityCommandType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, SMTI_ActivityCommandType_Names::Extern_Type_Name);
  }
  SharedRF_ApertureActivityCommandBaseType::serialize(accessor, node, "", false, false, false);
  if (accessor.hasAttempt()) {
    extxml_uci::util::SerializationHelpers::serializeUnsignedInt(accessor.getAttempt(), node, SMTI_ActivityCommandType_Names::Attempt_Name);
  }
  ...
  if (accessor.hasOverrideRejection()) {
    extxml_uci::util::SerializationHelpers::serializeBoolean(accessor.getOverrideRejection(), node, SMTI_ActivityCommandType_Names::OverrideRejection_Name);
  }
  ...
  if (accessor.hasCoefficientOfTroposphericRefraction()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getCoefficientOfTroposphericRefraction(), node, SMTI_ActivityCommandType_Names::CoefficientOfTroposphericRefraction_Name);
  }
  {
