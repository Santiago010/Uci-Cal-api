...
bool ESM_ChangeDwellType::deserialize(const boost::property_tree::ptree& propTree, uci::type::ESM_ChangeDwellType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setDeleteDwell(extxml_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
    }
  }
  return true;
...
std::string ESM_ChangeDwellType::serialize(const uci::type::ESM_ChangeDwellType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, ESM_ChangeDwellType_Names::Extern_Type_Name);
  }
  ...
  if (accessor.hasUnallocate()) {
    extxml_uci::util::SerializationHelpers::serializeBoolean(accessor.getUnallocate(), node, ESM_ChangeDwellType_Names::Unallocate_Name);
  }
  if (accessor.hasDeleteDwell()) {
    extxml_uci::util::SerializationHelpers::serializeBoolean(accessor.getDeleteDwell(), node, ESM_ChangeDwellType_Names::DeleteDwell_Name);
  }
  if (createNode) {
