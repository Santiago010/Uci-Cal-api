  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setLateralCenterOfGravity(extxml_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    } else if (valueType.first == nsPrefix + CenterOfGravityAeroType_Names::LongitudinalCenterOfGravity_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setLongitudinalCenterOfGravity(extxml_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    } else if (valueType.first == nsPrefix + CenterOfGravityAeroType_Names::VerticalCenterOfGravity_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setVerticalCenterOfGravity(extxml_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    }
  }
  return true;
...
std::string CenterOfGravityAeroType::serialize(const uci::type::CenterOfGravityAeroType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, CenterOfGravityAeroType_Names::Extern_Type_Name);
  }
  if (accessor.hasLateralCenterOfGravity()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getLateralCenterOfGravity(), node, CenterOfGravityAeroType_Names::LateralCenterOfGravity_Name);
  }
  if (accessor.hasLongitudinalCenterOfGravity()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getLongitudinalCenterOfGravity(), node, CenterOfGravityAeroType_Names::LongitudinalCenterOfGravity_Name);
  }
  if (accessor.hasVerticalCenterOfGravity()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getVerticalCenterOfGravity(), node, CenterOfGravityAeroType_Names::VerticalCenterOfGravity_Name);
  }
  if (createNode) {
