...
bool SegmentEstimateType::deserialize(const boost::property_tree::ptree& propTree, uci::type::SegmentEstimateType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setEstimatedCaptureDistance(extxml_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
...
std::string SegmentEstimateType::serialize(const uci::type::SegmentEstimateType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool checkIfDerivation, const bool /*topLevel*/) {
  ...
  if (!checkIfDerivation || (accessor.getAccessorType() == uci::type::accessorType::segmentEstimateType)) {
    ...
    if (addTypeAttribute) {
      extxml_uci::util::SerializationHelpers::addTypeAttribute(node, SegmentEstimateType_Names::Extern_Type_Name);
    }
    ...
    if (accessor.hasEstimatedCaptureTime()) {
      extxml_uci::util::SerializationHelpers::serializeDateTime(accessor.getEstimatedCaptureTime(), node, SegmentEstimateType_Names::EstimatedCaptureTime_Name);
    }
    if (accessor.hasEstimatedCaptureDistance()) {
      extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getEstimatedCaptureDistance(), node, SegmentEstimateType_Names::EstimatedCaptureDistance_Name);
    }
