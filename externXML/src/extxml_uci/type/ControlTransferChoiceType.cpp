...
bool ControlTransferChoiceType::deserialize(const boost::property_tree::ptree& propTree, uci::type::ControlTransferChoiceType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
...
std::string ControlTransferChoiceType::serialize(const uci::type::ControlTransferChoiceType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, ControlTransferChoiceType_Names::Extern_Type_Name);
  }
  if (accessor.isInProgress()) {
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getInProgress(), node, ControlTransferChoiceType_Names::InProgress_Name);
