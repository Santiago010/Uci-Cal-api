...
std::string DamagedHumanType::serialize(const uci::type::DamagedHumanType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, DamagedHumanType_Names::Extern_Type_Name);
  }
  if (accessor.hasCivilianCasualties()) {
    extxml_uci::util::SerializationHelpers::serializeUnsignedInt(accessor.getCivilianCasualties(), node, DamagedHumanType_Names::CivilianCasualties_Name);
  }
  if (accessor.hasCivilianInjuries()) {
    extxml_uci::util::SerializationHelpers::serializeUnsignedInt(accessor.getCivilianInjuries(), node, DamagedHumanType_Names::CivilianInjuries_Name);
  }
  if (accessor.hasMilitaryCasualties()) {
    extxml_uci::util::SerializationHelpers::serializeUnsignedInt(accessor.getMilitaryCasualties(), node, DamagedHumanType_Names::MilitaryCasualties_Name);
  }
  if (accessor.hasMilitaryInjuries()) {
    extxml_uci::util::SerializationHelpers::serializeUnsignedInt(accessor.getMilitaryInjuries(), node, DamagedHumanType_Names::MilitaryInjuries_Name);
  }
  if (createNode) {
