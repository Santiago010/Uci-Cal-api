  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setPrimaryApertureDiameter(extxml_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
...
std::string OB_SensorType::serialize(const uci::type::OB_SensorType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, OB_SensorType_Names::Extern_Type_Name);
  }
  ...
  if (accessor.hasPrimaryApertureDiameter()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getPrimaryApertureDiameter(), node, OB_SensorType_Names::PrimaryApertureDiameter_Name);
  }
  if (accessor.hasResolution()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getResolution(), node, OB_SensorType_Names::Resolution_Name);
  }
