...
bool DMPI_PatternType::deserialize(const boost::property_tree::ptree& propTree, uci::type::DMPI_PatternType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      extxml_uci::util::DerivedTypesDeserializer::deserialize(valueType.second, accessor.enablePatternCenterLocation(extxml_uci::util::SerializationHelpers::checkForTypeAttribute(valueType.second, nsPrefix)), nodeName, nsPrefix);
    } else if (valueType.first == nsPrefix + DMPI_PatternType_Names::PatternOrientation_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setPatternOrientation(extxml_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    } else if (valueType.first == nsPrefix + DMPI_PatternType_Names::IncludeDMPI_AtCenter_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setIncludeDMPI_AtCenter(extxml_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
...
std::string DMPI_PatternType::serialize(const uci::type::DMPI_PatternType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool checkIfDerivation, const bool /*topLevel*/) {
  ...
  if (!checkIfDerivation || (accessor.getAccessorType() == uci::type::accessorType::dMPI_PatternType)) {
    ...
    if (addTypeAttribute) {
      extxml_uci::util::SerializationHelpers::addTypeAttribute(node, DMPI_PatternType_Names::Extern_Type_Name);
    }
    {
    ...
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getPatternOrientation(), node, DMPI_PatternType_Names::PatternOrientation_Name);
    extxml_uci::util::SerializationHelpers::serializeBoolean(accessor.getIncludeDMPI_AtCenter(), node, DMPI_PatternType_Names::IncludeDMPI_AtCenter_Name);
