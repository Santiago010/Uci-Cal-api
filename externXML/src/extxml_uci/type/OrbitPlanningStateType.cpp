...
std::string OrbitPlanningStateType::serialize(const uci::type::OrbitPlanningStateType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, OrbitPlanningStateType_Names::Extern_Type_Name);
  }
  if (accessor.hasTime()) {
    extxml_uci::util::SerializationHelpers::serializeDateTime(accessor.getTime(), node, OrbitPlanningStateType_Names::Time_Name);
  }
