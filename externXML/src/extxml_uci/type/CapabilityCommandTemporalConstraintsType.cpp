...
bool CapabilityCommandTemporalConstraintsType::deserialize(const boost::property_tree::ptree& propTree, uci::type::CapabilityCommandTemporalConstraintsType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setWindowOnFirstOnly(extxml_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
...
std::string CapabilityCommandTemporalConstraintsType::serialize(const uci::type::CapabilityCommandTemporalConstraintsType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, CapabilityCommandTemporalConstraintsType_Names::Extern_Type_Name);
  }
  ...
  if (accessor.hasWindowOnFirstOnly()) {
    extxml_uci::util::SerializationHelpers::serializeBoolean(accessor.getWindowOnFirstOnly(), node, CapabilityCommandTemporalConstraintsType_Names::WindowOnFirstOnly_Name);
  }
