...
bool PO_ComponentSettingsFocalPlaneArrayScanDirectionType::deserialize(const boost::property_tree::ptree& propTree, uci::type::PO_ComponentSettingsFocalPlaneArrayScanDirectionType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
...
std::string PO_ComponentSettingsFocalPlaneArrayScanDirectionType::serialize(const uci::type::PO_ComponentSettingsFocalPlaneArrayScanDirectionType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, PO_ComponentSettingsFocalPlaneArrayScanDirectionType_Names::Extern_Type_Name);
  }
