  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setHRR_PeakScatterers(extxml_uci::util::SerializationHelpers::deserializeUnsignedByte(*value));
      }
...
std::string HRR_OptionsType::serialize(const uci::type::HRR_OptionsType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, HRR_OptionsType_Names::Extern_Type_Name);
  }
  if (accessor.hasHRR_PeakScatterers()) {
    extxml_uci::util::SerializationHelpers::serializeUnsignedByte(accessor.getHRR_PeakScatterers(), node, HRR_OptionsType_Names::HRR_PeakScatterers_Name);
  }
