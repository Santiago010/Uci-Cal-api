...
std::string RequirementAllocationWindowType::serialize(const uci::type::RequirementAllocationWindowType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, RequirementAllocationWindowType_Names::Extern_Type_Name);
  }
  ...
  extxml_uci::util::SerializationHelpers::serializeDateTime(accessor.getBegin(), node, RequirementAllocationWindowType_Names::Begin_Name);
  extxml_uci::util::SerializationHelpers::serializeDateTime(accessor.getEnd(), node, RequirementAllocationWindowType_Names::End_Name);
