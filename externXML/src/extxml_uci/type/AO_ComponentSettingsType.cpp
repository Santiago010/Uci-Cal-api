...
bool AO_ComponentSettingsType::deserialize(const boost::property_tree::ptree& propTree, uci::type::AO_ComponentSettingsType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
...
std::string AO_ComponentSettingsType::serialize(const uci::type::AO_ComponentSettingsType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, AO_ComponentSettingsType_Names::Extern_Type_Name);
  }
  ComponentID_Type::serialize(accessor.getComponentID(), node, AO_ComponentSettingsType_Names::ComponentID_Name);
  extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getPower(), node, AO_ComponentSettingsType_Names::Power_Name);
