...
bool WayPointPointChoiceType::deserialize(const boost::property_tree::ptree& propTree, uci::type::WayPointPointChoiceType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
...
std::string WayPointPointChoiceType::serialize(const uci::type::WayPointPointChoiceType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, WayPointPointChoiceType_Names::Extern_Type_Name);
  }
