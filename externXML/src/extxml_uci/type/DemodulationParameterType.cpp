...
bool DemodulationParameterType::deserialize(const boost::property_tree::ptree& propTree, uci::type::DemodulationParameterType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setAudioAmplitude(extxml_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    } else if (valueType.first == nsPrefix + DemodulationParameterType_Names::ChannelBandwidth_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setChannelBandwidth(extxml_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
...
std::string DemodulationParameterType::serialize(const uci::type::DemodulationParameterType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, DemodulationParameterType_Names::Extern_Type_Name);
  }
  ...
  if (accessor.hasAudioAmplitude()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getAudioAmplitude(), node, DemodulationParameterType_Names::AudioAmplitude_Name);
  }
  if (accessor.hasChannelBandwidth()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getChannelBandwidth(), node, DemodulationParameterType_Names::ChannelBandwidth_Name);
  }
