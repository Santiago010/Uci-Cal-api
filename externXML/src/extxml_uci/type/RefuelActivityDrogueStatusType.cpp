  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setTransfer(extxml_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
...
std::string RefuelActivityDrogueStatusType::serialize(const uci::type::RefuelActivityDrogueStatusType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, RefuelActivityDrogueStatusType_Names::Extern_Type_Name);
  }
  if (accessor.hasTransfer()) {
    extxml_uci::util::SerializationHelpers::serializeBoolean(accessor.getTransfer(), node, RefuelActivityDrogueStatusType_Names::Transfer_Name);
  }
  ...
  if (accessor.hasScheduledFuelToBeDelivered()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getScheduledFuelToBeDelivered(), node, RefuelActivityDrogueStatusType_Names::ScheduledFuelToBeDelivered_Name);
  }
  if (createNode) {
