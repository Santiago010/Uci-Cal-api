...
bool SubsystemBIT_Type::deserialize(const boost::property_tree::ptree& propTree, uci::type::SubsystemBIT_Type& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setExpectedTestDuration(extxml_uci::util::SerializationHelpers::deserializeDuration(*value));
      }
    }
  }
  return true;
...
std::string SubsystemBIT_Type::serialize(const uci::type::SubsystemBIT_Type& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, SubsystemBIT_Type_Names::Extern_Type_Name);
  }
  ...
  SubsystemBIT_ControlInterfacesEnum::serialize(accessor.getAcceptedInterface(), node, SubsystemBIT_Type_Names::AcceptedInterface_Name, false);
  {
    ...
    for (uci::type::SubsystemBIT_Type::BIT_ItemName::size_type i = 0, end = boundedList.size(); i < end; ++i) {
      extxml_uci::util::SerializationHelpers::serializeString(boundedList.at(i), node, SubsystemBIT_Type_Names::BIT_ItemName_Name);
    }
  }
  {
  ...
  if (accessor.hasExpectedTestDuration()) {
    extxml_uci::util::SerializationHelpers::serializeDuration(accessor.getExpectedTestDuration(), node, SubsystemBIT_Type_Names::ExpectedTestDuration_Name);
  }
  if (createNode) {
