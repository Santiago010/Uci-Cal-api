...
std::string Link16InterfaceDataLinkNativeInfoType::serialize(const uci::type::Link16InterfaceDataLinkNativeInfoType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, Link16InterfaceDataLinkNativeInfoType_Names::Extern_Type_Name);
  }
  DataLinkNativeInfoPET::serialize(accessor, node, "", false, false, false);
  if (accessor.hasVoiceCallSign()) {
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getVoiceCallSign(), node, Link16InterfaceDataLinkNativeInfoType_Names::VoiceCallSign_Name);
  }
  if (accessor.hasControlChannel()) {
    extxml_uci::util::SerializationHelpers::serializeUnsignedByte(accessor.getControlChannel(), node, Link16InterfaceDataLinkNativeInfoType_Names::ControlChannel_Name);
  }
  if (accessor.hasForceTellIndicator()) {
    extxml_uci::util::SerializationHelpers::serializeBoolean(accessor.getForceTellIndicator(), node, Link16InterfaceDataLinkNativeInfoType_Names::ForceTellIndicator_Name);
  }
  if (accessor.hasEmergencyIndicator()) {
    extxml_uci::util::SerializationHelpers::serializeBoolean(accessor.getEmergencyIndicator(), node, Link16InterfaceDataLinkNativeInfoType_Names::EmergencyIndicator_Name);
  }
