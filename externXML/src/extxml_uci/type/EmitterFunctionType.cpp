  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setEmitterFunction(extxml_uci::util::SerializationHelpers::deserializeUnsignedInt(*value));
      }
    } else if (valueType.first == nsPrefix + EmitterFunctionType_Names::CustomEmitterFunction_Name) {
      extxml_uci::util::DerivedTypesDeserializer::deserialize(valueType.second, accessor.enableCustomEmitterFunction(extxml_uci::util::SerializationHelpers::checkForTypeAttribute(valueType.second, nsPrefix)), nodeName, nsPrefix);
...
std::string EmitterFunctionType::serialize(const uci::type::EmitterFunctionType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, EmitterFunctionType_Names::Extern_Type_Name);
  }
  extxml_uci::util::SerializationHelpers::serializeUnsignedInt(accessor.getEmitterFunction(), node, EmitterFunctionType_Names::EmitterFunction_Name);
  ...
  if (accessor.hasCustomEmitterFunctionDescription()) {
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getCustomEmitterFunctionDescription(), node, EmitterFunctionType_Names::CustomEmitterFunctionDescription_Name);
  }
  if (createNode) {
