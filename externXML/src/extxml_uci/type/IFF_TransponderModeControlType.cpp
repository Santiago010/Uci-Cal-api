  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setInitiateIdentificationOfPosition(extxml_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
    }
  }
  return true;
...
std::string IFF_TransponderModeControlType::serialize(const uci::type::IFF_TransponderModeControlType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool checkIfDerivation, const bool /*topLevel*/) {
  ...
  if (!checkIfDerivation || (accessor.getAccessorType() == uci::type::accessorType::iFF_TransponderModeControlType)) {
    ...
    if (addTypeAttribute) {
      extxml_uci::util::SerializationHelpers::addTypeAttribute(node, IFF_TransponderModeControlType_Names::Extern_Type_Name);
    }
    ...
    extxml_uci::util::SerializationHelpers::serializeBoolean(accessor.getInitiateIdentificationOfPosition(), node, IFF_TransponderModeControlType_Names::InitiateIdentificationOfPosition_Name);
    if (createNode) {
