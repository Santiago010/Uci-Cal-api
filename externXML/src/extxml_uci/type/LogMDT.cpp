...
bool LogMDT::deserialize(const boost::property_tree::ptree& propTree, uci::type::LogMDT& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setServiceUpTime(extxml_uci::util::SerializationHelpers::deserializeDuration(*value));
      }
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        extxml_uci::util::SerializationHelpers::deserializeHexBinary(*value, accessor.enableData());
      }
    }
  }
  return true;
...
std::string LogMDT::serialize(const uci::type::LogMDT& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, LogMDT_Names::Extern_Type_Name);
  }
  extxml_uci::util::SerializationHelpers::serializeDateTime(accessor.getTimestamp(), node, LogMDT_Names::Timestamp_Name);
  if (accessor.hasServiceUpTime()) {
    extxml_uci::util::SerializationHelpers::serializeDuration(accessor.getServiceUpTime(), node, LogMDT_Names::ServiceUpTime_Name);
  }
  ...
  extxml_uci::util::SerializationHelpers::serializeString(accessor.getLabel(), node, LogMDT_Names::Label_Name);
  extxml_uci::util::SerializationHelpers::serializeString(accessor.getDetails(), node, LogMDT_Names::Details_Name);
  if (accessor.hasData()) {
    extxml_uci::util::SerializationHelpers::serializeHexBinary(accessor.getData(), node, LogMDT_Names::Data_Name);
  }
  if (createNode) {
