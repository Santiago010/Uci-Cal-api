  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setTimeOffset(extxml_uci::util::SerializationHelpers::deserializeDuration(*value));
      }
    }
  }
  return true;
...
std::string PlanWindowModificationTypeChoiceType::serialize(const uci::type::PlanWindowModificationTypeChoiceType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, PlanWindowModificationTypeChoiceType_Names::Extern_Type_Name);
  }
  if (accessor.isWindow()) {
    ...
    extxml_uci::util::SerializationHelpers::serializeDuration(accessor.getTimeOffset(), node, PlanWindowModificationTypeChoiceType_Names::TimeOffset_Name);
  }
  if (createNode) {
