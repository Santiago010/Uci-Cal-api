  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setMADL_UniqueIdentifier(extxml_uci::util::SerializationHelpers::deserializeUnsignedShort(*value));
      }
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setMADL_DayOfYearApplied(extxml_uci::util::SerializationHelpers::deserializeUnsignedShort(*value));
      }
...
std::string CommMADL_CommWaveformActivityType::serialize(const uci::type::CommMADL_CommWaveformActivityType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, CommMADL_CommWaveformActivityType_Names::Extern_Type_Name);
  }
  ...
  extxml_uci::util::SerializationHelpers::serializeUnsignedShort(accessor.getMADL_UniqueIdentifier(), node, CommMADL_CommWaveformActivityType_Names::MADL_UniqueIdentifier_Name);
  ...
  extxml_uci::util::SerializationHelpers::serializeUnsignedShort(accessor.getMADL_DayOfYearApplied(), node, CommMADL_CommWaveformActivityType_Names::MADL_DayOfYearApplied_Name);
  extxml_uci::util::SerializationHelpers::serializeBoolean(accessor.getVoiceCapable(), node, CommMADL_CommWaveformActivityType_Names::VoiceCapable_Name);
