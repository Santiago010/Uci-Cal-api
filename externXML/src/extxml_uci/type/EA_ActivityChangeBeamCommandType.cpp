...
bool EA_ActivityChangeBeamCommandType::deserialize(const boost::property_tree::ptree& propTree, uci::type::EA_ActivityChangeBeamCommandType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setUnassignBeam(extxml_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
    } else if (valueType.first == nsPrefix + EA_ActivityChangeBeamCommandType_Names::DeleteBeam_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setDeleteBeam(extxml_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
...
std::string EA_ActivityChangeBeamCommandType::serialize(const uci::type::EA_ActivityChangeBeamCommandType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, EA_ActivityChangeBeamCommandType_Names::Extern_Type_Name);
  }
  ...
  if (accessor.hasUnassignBeam()) {
    extxml_uci::util::SerializationHelpers::serializeBoolean(accessor.getUnassignBeam(), node, EA_ActivityChangeBeamCommandType_Names::UnassignBeam_Name);
  }
  if (accessor.hasDeleteBeam()) {
    extxml_uci::util::SerializationHelpers::serializeBoolean(accessor.getDeleteBeam(), node, EA_ActivityChangeBeamCommandType_Names::DeleteBeam_Name);
  }
