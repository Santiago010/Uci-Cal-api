...
std::string ServiceConfigurationParamsDataRequestMDT::serialize(const uci::type::ServiceConfigurationParamsDataRequestMDT& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, ServiceConfigurationParamsDataRequestMDT_Names::Extern_Type_Name);
  }
  RequestBaseType::serialize(accessor, node, "", false, false, false);
  extxml_uci::util::SerializationHelpers::serializeBoolean(accessor.getResultsInNativeMessage(), node, ServiceConfigurationParamsDataRequestMDT_Names::ResultsInNativeMessage_Name);
  ...
  if (accessor.hasCategory()) {
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getCategory(), node, ServiceConfigurationParamsDataRequestMDT_Names::Category_Name);
  }
  if (createNode) {
