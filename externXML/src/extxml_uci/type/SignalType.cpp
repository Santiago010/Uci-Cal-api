...
bool SignalType::deserialize(const boost::property_tree::ptree& propTree, uci::type::SignalType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setInitialDetectionTimestamp(extxml_uci::util::SerializationHelpers::deserializeDateTime(*value));
      }
    } else if (valueType.first == nsPrefix + SignalType_Names::LatestDetectionTimestamp_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setLatestDetectionTimestamp(extxml_uci::util::SerializationHelpers::deserializeDateTime(*value));
      }
...
std::string SignalType::serialize(const uci::type::SignalType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, SignalType_Names::Extern_Type_Name);
  }
  ...
  if (accessor.hasInitialDetectionTimestamp()) {
    extxml_uci::util::SerializationHelpers::serializeDateTime(accessor.getInitialDetectionTimestamp(), node, SignalType_Names::InitialDetectionTimestamp_Name);
  }
  if (accessor.hasLatestDetectionTimestamp()) {
    extxml_uci::util::SerializationHelpers::serializeDateTime(accessor.getLatestDetectionTimestamp(), node, SignalType_Names::LatestDetectionTimestamp_Name);
  }
  ...
  if (accessor.hasWartimeReserveMode()) {
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getWartimeReserveMode(), node, SignalType_Names::WartimeReserveMode_Name);
  }
