...
bool WeatherAreaDataType::deserialize(const boost::property_tree::ptree& propTree, uci::type::WeatherAreaDataType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setPrecipitationPotential(extxml_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    } else if (valueType.first == nsPrefix + WeatherAreaDataType_Names::PrecipitationAmount_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setPrecipitationAmount(extxml_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setVisibility(extxml_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setDewPoint(extxml_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setBarometricPressure(extxml_uci::util::SerializationHelpers::deserializeFloat(*value));
      }
    } else if (valueType.first == nsPrefix + WeatherAreaDataType_Names::KollsmanSetting_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setKollsmanSetting(extxml_uci::util::SerializationHelpers::deserializeFloat(*value));
      }
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setThunderstormPotential(extxml_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setRelativeHumidity(extxml_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    }
  }
  return true;
...
std::string WeatherAreaDataType::serialize(const uci::type::WeatherAreaDataType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, WeatherAreaDataType_Names::Extern_Type_Name);
  }
  ...
  if (accessor.hasStationCode()) {
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getStationCode(), node, WeatherAreaDataType_Names::StationCode_Name);
  }
  if (accessor.hasTemperature()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getTemperature(), node, WeatherAreaDataType_Names::Temperature_Name);
  }
  if (accessor.hasPrecipitationPotential()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getPrecipitationPotential(), node, WeatherAreaDataType_Names::PrecipitationPotential_Name);
  }
  if (accessor.hasPrecipitationAmount()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getPrecipitationAmount(), node, WeatherAreaDataType_Names::PrecipitationAmount_Name);
  }
  ...
  if (accessor.hasVisibility()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getVisibility(), node, WeatherAreaDataType_Names::Visibility_Name);
  }
  ...
  if (accessor.hasDewPoint()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getDewPoint(), node, WeatherAreaDataType_Names::DewPoint_Name);
  }
  {
  ...
  if (accessor.hasBarometricPressure()) {
    extxml_uci::util::SerializationHelpers::serializeFloat(accessor.getBarometricPressure(), node, WeatherAreaDataType_Names::BarometricPressure_Name);
  }
  if (accessor.hasKollsmanSetting()) {
    extxml_uci::util::SerializationHelpers::serializeFloat(accessor.getKollsmanSetting(), node, WeatherAreaDataType_Names::KollsmanSetting_Name);
  }
  ...
  if (accessor.hasThunderstormPotential()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getThunderstormPotential(), node, WeatherAreaDataType_Names::ThunderstormPotential_Name);
  }
  if (accessor.hasRemarks()) {
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getRemarks(), node, WeatherAreaDataType_Names::Remarks_Name);
  }
  if (accessor.hasKind()) {
  ...
  if (accessor.hasRelativeHumidity()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getRelativeHumidity(), node, WeatherAreaDataType_Names::RelativeHumidity_Name);
  }
  if (createNode) {
