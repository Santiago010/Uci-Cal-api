...
std::string MTI_ActivityStatusDetailType::serialize(const uci::type::MTI_ActivityStatusDetailType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, MTI_ActivityStatusDetailType_Names::Extern_Type_Name);
  }
  MTI_ActivityStatusBaseType::serialize(accessor, node, "", false, false, false);
  if (accessor.hasEstimatedERP()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getEstimatedERP(), node, MTI_ActivityStatusDetailType_Names::EstimatedERP_Name);
  }
  if (accessor.hasProductsProduced()) {
    extxml_uci::util::SerializationHelpers::serializeUnsignedInt(accessor.getProductsProduced(), node, MTI_ActivityStatusDetailType_Names::ProductsProduced_Name);
  }
  if (accessor.hasHitsReported()) {
    extxml_uci::util::SerializationHelpers::serializeUnsignedInt(accessor.getHitsReported(), node, MTI_ActivityStatusDetailType_Names::HitsReported_Name);
  }
  {
  ...
  if (accessor.hasTimeToService()) {
    extxml_uci::util::SerializationHelpers::serializeDuration(accessor.getTimeToService(), node, MTI_ActivityStatusDetailType_Names::TimeToService_Name);
  }
  if (accessor.hasAverageTimeToService()) {
    extxml_uci::util::SerializationHelpers::serializeDuration(accessor.getAverageTimeToService(), node, MTI_ActivityStatusDetailType_Names::AverageTimeToService_Name);
  }
  if (createNode) {
