...
bool SlantRangeAreaType::deserialize(const boost::property_tree::ptree& propTree, uci::type::SlantRangeAreaType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
...
std::string SlantRangeAreaType::serialize(const uci::type::SlantRangeAreaType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, SlantRangeAreaType_Names::Extern_Type_Name);
  }
  ...
  extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getOrientation(), node, SlantRangeAreaType_Names::Orientation_Name);
