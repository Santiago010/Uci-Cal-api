  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setTimeUp(extxml_uci::util::SerializationHelpers::deserializeDuration(*value));
      }
...
std::string ServiceStatusMDT::serialize(const uci::type::ServiceStatusMDT& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, ServiceStatusMDT_Names::Extern_Type_Name);
  }
  ServiceID_Type::serialize(accessor.getServiceID(), node, ServiceStatusMDT_Names::ServiceID_Name);
  extxml_uci::util::SerializationHelpers::serializeDuration(accessor.getTimeUp(), node, ServiceStatusMDT_Names::TimeUp_Name);
  ...
  if (accessor.hasStatusDetail()) {
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getStatusDetail(), node, ServiceStatusMDT_Names::StatusDetail_Name);
  }
  {
