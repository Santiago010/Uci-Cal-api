...
bool Link16ReferencePointDataStoreActionType::deserialize(const boost::property_tree::ptree& propTree, uci::type::Link16ReferencePointDataStoreActionType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
...
std::string Link16ReferencePointDataStoreActionType::serialize(const uci::type::Link16ReferencePointDataStoreActionType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, Link16ReferencePointDataStoreActionType_Names::Extern_Type_Name);
  }
