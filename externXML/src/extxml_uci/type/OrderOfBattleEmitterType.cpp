...
std::string OrderOfBattleEmitterType::serialize(const uci::type::OrderOfBattleEmitterType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool checkIfDerivation, const bool /*topLevel*/) {
  ...
  if (!checkIfDerivation || (accessor.getAccessorType() == uci::type::accessorType::orderOfBattleEmitterType)) {
    ...
    if (addTypeAttribute) {
      extxml_uci::util::SerializationHelpers::addTypeAttribute(node, OrderOfBattleEmitterType_Names::Extern_Type_Name);
    }
    ...
    if (accessor.hasLastCollector()) {
      extxml_uci::util::SerializationHelpers::serializeString(accessor.getLastCollector(), node, OrderOfBattleEmitterType_Names::LastCollector_Name);
    }
    if (accessor.hasRecordOwner()) {
      extxml_uci::util::SerializationHelpers::serializeString(accessor.getRecordOwner(), node, OrderOfBattleEmitterType_Names::RecordOwner_Name);
    }
    if (accessor.hasRemarksText()) {
      extxml_uci::util::SerializationHelpers::serializeString(accessor.getRemarksText(), node, OrderOfBattleEmitterType_Names::RemarksText_Name);
    }
    {
