...
std::string FileMetadataMDT::serialize(const uci::type::FileMetadataMDT& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, FileMetadataMDT_Names::Extern_Type_Name);
  }
  ...
  extxml_uci::util::SerializationHelpers::serializeString(accessor.getFileName(), node, FileMetadataMDT_Names::FileName_Name);
  ...
  extxml_uci::util::SerializationHelpers::serializeBoolean(accessor.getUntrustedModification(), node, FileMetadataMDT_Names::UntrustedModification_Name);
  extxml_uci::util::SerializationHelpers::serializeDateTime(accessor.getTimestamp(), node, FileMetadataMDT_Names::Timestamp_Name);
  ...
  if (accessor.hasSHA_2_Hash()) {
    extxml_uci::util::SerializationHelpers::serializeHexBinary(accessor.getSHA_2_Hash(), node, FileMetadataMDT_Names::SHA_2_Hash_Name);
  }
  {
