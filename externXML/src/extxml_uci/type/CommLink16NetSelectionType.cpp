  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setNetSelectionStatusNet(extxml_uci::util::SerializationHelpers::deserializeUnsignedByte(*value));
      }
    } else if (valueType.first == nsPrefix + CommLink16NetSelectionType_Names::NetSelectionStatusPG_Index_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setNetSelectionStatusPG_Index(extxml_uci::util::SerializationHelpers::deserializeUnsignedShort(*value));
      }
    }
  }
  return true;
...
std::string CommLink16NetSelectionType::serialize(const uci::type::CommLink16NetSelectionType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, CommLink16NetSelectionType_Names::Extern_Type_Name);
  }
  extxml_uci::util::SerializationHelpers::serializeUnsignedByte(accessor.getNetSelectionStatusNet(), node, CommLink16NetSelectionType_Names::NetSelectionStatusNet_Name);
  extxml_uci::util::SerializationHelpers::serializeUnsignedShort(accessor.getNetSelectionStatusPG_Index(), node, CommLink16NetSelectionType_Names::NetSelectionStatusPG_Index_Name);
  if (createNode) {
