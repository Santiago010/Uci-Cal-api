  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setFreqStart(extxml_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    } else if (valueType.first == nsPrefix + CS_SatBandDeconType_Names::FreqStop_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setFreqStop(extxml_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setMaxEIRP(extxml_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    } else if (valueType.first == nsPrefix + CS_SatBandDeconType_Names::DeconName_Name) {
      extxml_uci::util::DerivedTypesDeserializer::deserialize(valueType.second, accessor.enableDeconName(extxml_uci::util::SerializationHelpers::checkForTypeAttribute(valueType.second, nsPrefix)), nodeName, nsPrefix);
...
std::string CS_SatBandDeconType::serialize(const uci::type::CS_SatBandDeconType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, CS_SatBandDeconType_Names::Extern_Type_Name);
  }
  SatelliteIdentifierType::serialize(accessor.getSatellite(), node, CS_SatBandDeconType_Names::Satellite_Name);
  extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getFreqStart(), node, CS_SatBandDeconType_Names::FreqStart_Name);
  extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getFreqStop(), node, CS_SatBandDeconType_Names::FreqStop_Name);
  IEEE_FrequencyBandEnum::serialize(accessor.getFreqBand(), node, CS_SatBandDeconType_Names::FreqBand_Name, false);
  extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getMaxEIRP(), node, CS_SatBandDeconType_Names::MaxEIRP_Name);
