  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setThreshold(extxml_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setAudioEnable(extxml_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
    } else if (valueType.first == nsPrefix + COMINT_InteractiveType_Names::IQ_Enable_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setIQ_Enable(extxml_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
    }
  }
  return true;
...
std::string COMINT_InteractiveType::serialize(const uci::type::COMINT_InteractiveType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, COMINT_InteractiveType_Names::Extern_Type_Name);
  }
  if (accessor.hasThreshold()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getThreshold(), node, COMINT_InteractiveType_Names::Threshold_Name);
  }
  ...
  if (accessor.hasGain()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getGain(), node, COMINT_InteractiveType_Names::Gain_Name);
  }
  {
    ...
    for (uci::type::COMINT_InteractiveType::CenterFrequency::size_type i = 0, end = boundedList.size(); i < end; ++i) {
      extxml_uci::util::SerializationHelpers::serializeDouble(boundedList.at(i), node, COMINT_InteractiveType_Names::CenterFrequency_Name);
    }
  }
  {
  ...
  if (accessor.hasAudioEnable()) {
    extxml_uci::util::SerializationHelpers::serializeBoolean(accessor.getAudioEnable(), node, COMINT_InteractiveType_Names::AudioEnable_Name);
  }
  if (accessor.hasIQ_Enable()) {
    extxml_uci::util::SerializationHelpers::serializeBoolean(accessor.getIQ_Enable(), node, COMINT_InteractiveType_Names::IQ_Enable_Name);
  }
  if (createNode) {
