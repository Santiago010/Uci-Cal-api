...
bool WeatherEffectsType::deserialize(const boost::property_tree::ptree& propTree, uci::type::WeatherEffectsType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setSystemIcingState(extxml_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
    }
  }
  return true;
...
std::string WeatherEffectsType::serialize(const uci::type::WeatherEffectsType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, WeatherEffectsType_Names::Extern_Type_Name);
  }
  ...
  if (accessor.hasSystemIcingState()) {
    extxml_uci::util::SerializationHelpers::serializeBoolean(accessor.getSystemIcingState(), node, WeatherEffectsType_Names::SystemIcingState_Name);
  }
  if (createNode) {
