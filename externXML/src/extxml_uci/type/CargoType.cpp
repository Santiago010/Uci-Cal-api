...
bool CargoType::deserialize(const boost::property_tree::ptree& propTree, uci::type::CargoType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setCargoWeight(extxml_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    }
  }
  return true;
...
std::string CargoType::serialize(const uci::type::CargoType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, CargoType_Names::Extern_Type_Name);
  }
  ...
  if (accessor.hasCargoWeight()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getCargoWeight(), node, CargoType_Names::CargoWeight_Name);
  }
  if (createNode) {
