...
bool AntennaResourceInstanceStatusType::deserialize(const boost::property_tree::ptree& propTree, uci::type::AntennaResourceInstanceStatusType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setPercentAccess(extxml_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    }
  }
  return true;
...
std::string AntennaResourceInstanceStatusType::serialize(const uci::type::AntennaResourceInstanceStatusType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, AntennaResourceInstanceStatusType_Names::Extern_Type_Name);
  }
  ...
  if (accessor.hasDeltaInputPowerConsumption()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getDeltaInputPowerConsumption(), node, AntennaResourceInstanceStatusType_Names::DeltaInputPowerConsumption_Name);
  }
  if (accessor.hasPercentAccess()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getPercentAccess(), node, AntennaResourceInstanceStatusType_Names::PercentAccess_Name);
  }
  if (createNode) {
