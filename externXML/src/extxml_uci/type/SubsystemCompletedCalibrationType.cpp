  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setTimetag(extxml_uci::util::SerializationHelpers::deserializeDateTime(*value));
      }
...
std::string SubsystemCompletedCalibrationType::serialize(const uci::type::SubsystemCompletedCalibrationType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, SubsystemCompletedCalibrationType_Names::Extern_Type_Name);
  }
  CalibrationID_Type::serialize(accessor.getCalibrationID(), node, SubsystemCompletedCalibrationType_Names::CalibrationID_Name);
  extxml_uci::util::SerializationHelpers::serializeDateTime(accessor.getTimetag(), node, SubsystemCompletedCalibrationType_Names::Timetag_Name);
  ...
  if (accessor.hasFailReason()) {
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getFailReason(), node, SubsystemCompletedCalibrationType_Names::FailReason_Name);
  }
  {
