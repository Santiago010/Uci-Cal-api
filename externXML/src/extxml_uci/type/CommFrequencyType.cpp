...
bool CommFrequencyType::deserialize(const boost::property_tree::ptree& propTree, uci::type::CommFrequencyType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
...
std::string CommFrequencyType::serialize(const uci::type::CommFrequencyType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, CommFrequencyType_Names::Extern_Type_Name);
  }
