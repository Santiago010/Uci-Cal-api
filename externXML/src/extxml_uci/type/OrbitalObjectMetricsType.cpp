  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setApogee(extxml_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    } else if (valueType.first == nsPrefix + OrbitalObjectMetricsType_Names::Perigee_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setPerigee(extxml_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
...
std::string OrbitalObjectMetricsType::serialize(const uci::type::OrbitalObjectMetricsType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, OrbitalObjectMetricsType_Names::Extern_Type_Name);
  }
  if (accessor.hasApogee()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getApogee(), node, OrbitalObjectMetricsType_Names::Apogee_Name);
  }
  if (accessor.hasPerigee()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getPerigee(), node, OrbitalObjectMetricsType_Names::Perigee_Name);
  }
  if (accessor.hasInclination()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getInclination(), node, OrbitalObjectMetricsType_Names::Inclination_Name);
  }
  if (accessor.hasLongitude()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getLongitude(), node, OrbitalObjectMetricsType_Names::Longitude_Name);
  }
  if (createNode) {
