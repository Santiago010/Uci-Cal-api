...
std::string AirfieldContaminationType::serialize(const uci::type::AirfieldContaminationType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, AirfieldContaminationType_Names::Extern_Type_Name);
  }
  if (accessor.hasNuclear()) {
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getNuclear(), node, AirfieldContaminationType_Names::Nuclear_Name);
  }
  if (accessor.hasBiological()) {
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getBiological(), node, AirfieldContaminationType_Names::Biological_Name);
  }
  if (accessor.hasChemical()) {
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getChemical(), node, AirfieldContaminationType_Names::Chemical_Name);
  }
  if (createNode) {
