...
bool FusionSourceType::deserialize(const boost::property_tree::ptree& propTree, uci::type::FusionSourceType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setInitiateAllowed(extxml_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
    }
  }
  return true;
...
std::string FusionSourceType::serialize(const uci::type::FusionSourceType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, FusionSourceType_Names::Extern_Type_Name);
  }
  ...
  extxml_uci::util::SerializationHelpers::serializeBoolean(accessor.getEnabled(), node, FusionSourceType_Names::Enabled_Name);
  FusionUpdatesEnum::serialize(accessor.getAllowedUpdates(), node, FusionSourceType_Names::AllowedUpdates_Name, false);
  extxml_uci::util::SerializationHelpers::serializeBoolean(accessor.getInitiateAllowed(), node, FusionSourceType_Names::InitiateAllowed_Name);
  if (createNode) {
