  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setContinuousSpotAngle(extxml_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setMaximumMappingTime(extxml_uci::util::SerializationHelpers::deserializeDuration(*value));
      }
    } else if (valueType.first == nsPrefix + SAR_CollectionConstraintsType_Names::AzSubsetFraction_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setAzSubsetFraction(extxml_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    } else if (valueType.first == nsPrefix + SAR_CollectionConstraintsType_Names::LOS_BufferAngle_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setLOS_BufferAngle(extxml_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    } else if (valueType.first == nsPrefix + SAR_CollectionConstraintsType_Names::NumImagesAzimuth_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setNumImagesAzimuth(extxml_uci::util::SerializationHelpers::deserializeUnsignedInt(*value));
      }
    } else if (valueType.first == nsPrefix + SAR_CollectionConstraintsType_Names::NumImagesRange_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setNumImagesRange(extxml_uci::util::SerializationHelpers::deserializeUnsignedInt(*value));
      }
    } else if (valueType.first == nsPrefix + SAR_CollectionConstraintsType_Names::PercentAzimuthCollection_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setPercentAzimuthCollection(extxml_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    } else if (valueType.first == nsPrefix + SAR_CollectionConstraintsType_Names::HeadingDeviationTolerance_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setHeadingDeviationTolerance(extxml_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    } else if (valueType.first == nsPrefix + SAR_CollectionConstraintsType_Names::CrossTrackDeviationTolerance_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setCrossTrackDeviationTolerance(extxml_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setMapGainAdjustment(extxml_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
...
std::string SAR_CollectionConstraintsType::serialize(const uci::type::SAR_CollectionConstraintsType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, SAR_CollectionConstraintsType_Names::Extern_Type_Name);
  }
  ...
  if (accessor.hasContinuousSpotAngle()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getContinuousSpotAngle(), node, SAR_CollectionConstraintsType_Names::ContinuousSpotAngle_Name);
  }
  ...
  if (accessor.hasMaximumMappingTime()) {
    extxml_uci::util::SerializationHelpers::serializeDuration(accessor.getMaximumMappingTime(), node, SAR_CollectionConstraintsType_Names::MaximumMappingTime_Name);
  }
  if (accessor.hasAzSubsetFraction()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getAzSubsetFraction(), node, SAR_CollectionConstraintsType_Names::AzSubsetFraction_Name);
  }
  if (accessor.hasLOS_BufferAngle()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getLOS_BufferAngle(), node, SAR_CollectionConstraintsType_Names::LOS_BufferAngle_Name);
  }
  if (accessor.hasNumImagesAzimuth()) {
    extxml_uci::util::SerializationHelpers::serializeUnsignedInt(accessor.getNumImagesAzimuth(), node, SAR_CollectionConstraintsType_Names::NumImagesAzimuth_Name);
  }
  if (accessor.hasNumImagesRange()) {
    extxml_uci::util::SerializationHelpers::serializeUnsignedInt(accessor.getNumImagesRange(), node, SAR_CollectionConstraintsType_Names::NumImagesRange_Name);
  }
  if (accessor.hasPercentAzimuthCollection()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getPercentAzimuthCollection(), node, SAR_CollectionConstraintsType_Names::PercentAzimuthCollection_Name);
  }
  if (accessor.hasHeadingDeviationTolerance()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getHeadingDeviationTolerance(), node, SAR_CollectionConstraintsType_Names::HeadingDeviationTolerance_Name);
  }
  if (accessor.hasCrossTrackDeviationTolerance()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getCrossTrackDeviationTolerance(), node, SAR_CollectionConstraintsType_Names::CrossTrackDeviationTolerance_Name);
  }
  ...
  if (accessor.hasMapGainAdjustment()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getMapGainAdjustment(), node, SAR_CollectionConstraintsType_Names::MapGainAdjustment_Name);
  }
