...
bool FocalPlaneArrayOperationNonUniformityCorrectionType::deserialize(const boost::property_tree::ptree& propTree, uci::type::FocalPlaneArrayOperationNonUniformityCorrectionType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      extxml_uci::util::DerivedTypesDeserializer::deserialize(valueType.second, accessor.enableNUC_TablesSettings(extxml_uci::util::SerializationHelpers::checkForTypeAttribute(valueType.second, nsPrefix)), nodeName, nsPrefix);
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        ...
        FocalPlaneArrayNonUniformityCorrectionReferenceType::deserialize(valueType.second, boundedList.at(boundedListSize), nodeName, nsPrefix);
      }
    }
  }
  return true;
...
std::string FocalPlaneArrayOperationNonUniformityCorrectionType::serialize(const uci::type::FocalPlaneArrayOperationNonUniformityCorrectionType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, FocalPlaneArrayOperationNonUniformityCorrectionType_Names::Extern_Type_Name);
  }
  ...
  }
  {
    ...
    for (uci::type::FocalPlaneArrayOperationNonUniformityCorrectionType::NUC_ReferenceOffsetSettings::size_type i = 0, end = boundedList.size(); i < end; ++i) {
      FocalPlaneArrayNonUniformityCorrectionReferenceType::serialize(boundedList.at(i), node, FocalPlaneArrayOperationNonUniformityCorrectionType_Names::NUC_ReferenceOffsetSettings_Name);
    }
  }
  if (createNode) {
