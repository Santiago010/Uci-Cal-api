...
bool OrbitalSurveillanceSensorMinimumSizeType::deserialize(const boost::property_tree::ptree& propTree, uci::type::OrbitalSurveillanceSensorMinimumSizeType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setIntensity(extxml_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    }
  }
  return true;
...
std::string OrbitalSurveillanceSensorMinimumSizeType::serialize(const uci::type::OrbitalSurveillanceSensorMinimumSizeType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, OrbitalSurveillanceSensorMinimumSizeType_Names::Extern_Type_Name);
  }
  if (accessor.isRadarCrossSection()) {
    ...
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getVisualMagnitude(), node, OrbitalSurveillanceSensorMinimumSizeType_Names::VisualMagnitude_Name);
  } else if (accessor.isArea()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getArea(), node, OrbitalSurveillanceSensorMinimumSizeType_Names::Area_Name);
  } else if (accessor.isIntensity()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getIntensity(), node, OrbitalSurveillanceSensorMinimumSizeType_Names::Intensity_Name);
  }
  if (createNode) {
