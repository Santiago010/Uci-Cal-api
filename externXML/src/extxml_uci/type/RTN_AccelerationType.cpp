...
std::string RTN_AccelerationType::serialize(const uci::type::RTN_AccelerationType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, RTN_AccelerationType_Names::Extern_Type_Name);
  }
  extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getRadial(), node, RTN_AccelerationType_Names::Radial_Name);
  extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getTransverse(), node, RTN_AccelerationType_Names::Transverse_Name);
  extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getNormal(), node, RTN_AccelerationType_Names::Normal_Name);
  if (createNode) {
