...
std::string ProductOutputCapabilityStatusImageryType::serialize(const uci::type::ProductOutputCapabilityStatusImageryType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool checkIfDerivation, const bool /*topLevel*/) {
  ...
  if (!checkIfDerivation || (accessor.getAccessorType() == uci::type::accessorType::productOutputCapabilityStatusImageryType)) {
    ...
    if (addTypeAttribute) {
      extxml_uci::util::SerializationHelpers::addTypeAttribute(node, ProductOutputCapabilityStatusImageryType_Names::Extern_Type_Name);
    }
    ...
    if (accessor.hasCompressionRatio()) {
      extxml_uci::util::SerializationHelpers::serializeFloat(accessor.getCompressionRatio(), node, ProductOutputCapabilityStatusImageryType_Names::CompressionRatio_Name);
    }
    if (accessor.hasProductRate()) {
      extxml_uci::util::SerializationHelpers::serializeUnsignedInt(accessor.getProductRate(), node, ProductOutputCapabilityStatusImageryType_Names::ProductRate_Name);
    }
    if (accessor.hasInterlaced()) {
      extxml_uci::util::SerializationHelpers::serializeBoolean(accessor.getInterlaced(), node, ProductOutputCapabilityStatusImageryType_Names::Interlaced_Name);
    }
    if (accessor.hasProductSize()) {
      extxml_uci::util::SerializationHelpers::serializeUnsignedInt(accessor.getProductSize(), node, ProductOutputCapabilityStatusImageryType_Names::ProductSize_Name);
    }
