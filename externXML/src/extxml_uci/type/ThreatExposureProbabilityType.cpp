...
bool ThreatExposureProbabilityType::deserialize(const boost::property_tree::ptree& propTree, uci::type::ThreatExposureProbabilityType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setTimeIndex(extxml_uci::util::SerializationHelpers::deserializeDateTime(*value));
      }
...
std::string ThreatExposureProbabilityType::serialize(const uci::type::ThreatExposureProbabilityType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, ThreatExposureProbabilityType_Names::Extern_Type_Name);
  }
  extxml_uci::util::SerializationHelpers::serializeDateTime(accessor.getTimeIndex(), node, ThreatExposureProbabilityType_Names::TimeIndex_Name);
  extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getProbabilityOfDetection(), node, ThreatExposureProbabilityType_Names::ProbabilityOfDetection_Name);
  if (createNode) {
