...
std::string FaultDataType::serialize(const uci::type::FaultDataType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, FaultDataType_Names::Extern_Type_Name);
  }
  extxml_uci::util::SerializationHelpers::serializeString(accessor.getKey(), node, FaultDataType_Names::Key_Name);
  extxml_uci::util::SerializationHelpers::serializeString(accessor.getValue(), node, FaultDataType_Names::Value_Name);
  extxml_uci::util::SerializationHelpers::serializeString(accessor.getFormat(), node, FaultDataType_Names::Format_Name);
  if (accessor.hasUnits()) {
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getUnits(), node, FaultDataType_Names::Units_Name);
  }
  if (createNode) {
