  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setRangeDelay(extxml_uci::util::SerializationHelpers::deserializeDuration(*value));
      }
...
std::string CommUHF_SATCOM_CommWaveformActivityType::serialize(const uci::type::CommUHF_SATCOM_CommWaveformActivityType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, CommUHF_SATCOM_CommWaveformActivityType_Names::Extern_Type_Name);
  }
  CommWaveformActivityPET::serialize(accessor, node, "", false, false, false);
  extxml_uci::util::SerializationHelpers::serializeDuration(accessor.getRangeDelay(), node, CommUHF_SATCOM_CommWaveformActivityType_Names::RangeDelay_Name);
  ...
  if (accessor.hasOrderwireEncryption()) {
    extxml_uci::util::SerializationHelpers::serializeBoolean(accessor.getOrderwireEncryption(), node, CommUHF_SATCOM_CommWaveformActivityType_Names::OrderwireEncryption_Name);
  }
