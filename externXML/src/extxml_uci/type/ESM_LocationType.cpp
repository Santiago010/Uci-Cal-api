...
bool ESM_LocationType::deserialize(const boost::property_tree::ptree& propTree, uci::type::ESM_LocationType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
...
std::string ESM_LocationType::serialize(const uci::type::ESM_LocationType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, ESM_LocationType_Names::Extern_Type_Name);
  }
