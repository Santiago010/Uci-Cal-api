  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setChangeWeight(extxml_uci::util::SerializationHelpers::deserializeInt(*value));
      }
...
std::string IncrementalChangeType::serialize(const uci::type::IncrementalChangeType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, IncrementalChangeType_Names::Extern_Type_Name);
  }
  if (accessor.hasChangeWeight()) {
    extxml_uci::util::SerializationHelpers::serializeInt(accessor.getChangeWeight(), node, IncrementalChangeType_Names::ChangeWeight_Name);
  }
