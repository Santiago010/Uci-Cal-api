  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setPeerNodeIdentifier(extxml_uci::util::SerializationHelpers::deserializeUnsignedByte(*value));
      }
    } else if (valueType.first == nsPrefix + CommMADL_PeerNodeDataType_Names::PeerMADL_UniqueIdentifier_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setPeerMADL_UniqueIdentifier(extxml_uci::util::SerializationHelpers::deserializeUnsignedShort(*value));
      }
...
std::string CommMADL_PeerNodeDataType::serialize(const uci::type::CommMADL_PeerNodeDataType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, CommMADL_PeerNodeDataType_Names::Extern_Type_Name);
  }
  extxml_uci::util::SerializationHelpers::serializeUnsignedByte(accessor.getPeerNodeIdentifier(), node, CommMADL_PeerNodeDataType_Names::PeerNodeIdentifier_Name);
  extxml_uci::util::SerializationHelpers::serializeUnsignedShort(accessor.getPeerMADL_UniqueIdentifier(), node, CommMADL_PeerNodeDataType_Names::PeerMADL_UniqueIdentifier_Name);
  ...
  extxml_uci::util::SerializationHelpers::serializeBoolean(accessor.getDataCapable(), node, CommMADL_PeerNodeDataType_Names::DataCapable_Name);
  extxml_uci::util::SerializationHelpers::serializeBoolean(accessor.getVoiceCapable(), node, CommMADL_PeerNodeDataType_Names::VoiceCapable_Name);
  if (createNode) {
