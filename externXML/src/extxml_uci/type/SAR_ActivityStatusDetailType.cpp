...
bool SAR_ActivityStatusDetailType::deserialize(const boost::property_tree::ptree& propTree, uci::type::SAR_ActivityStatusDetailType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setPercentCoverage(extxml_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setMinimumCNR(extxml_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    } else if (valueType.first == nsPrefix + SAR_ActivityStatusDetailType_Names::AchievableEllipticity_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setAchievableEllipticity(extxml_uci::util::SerializationHelpers::deserializeFloat(*value));
      }
    } else if (valueType.first == nsPrefix + SAR_ActivityStatusDetailType_Names::AchievableResolution_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setAchievableResolution(extxml_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
...
std::string SAR_ActivityStatusDetailType::serialize(const uci::type::SAR_ActivityStatusDetailType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, SAR_ActivityStatusDetailType_Names::Extern_Type_Name);
  }
  if (accessor.hasPercentageInFOR()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getPercentageInFOR(), node, SAR_ActivityStatusDetailType_Names::PercentageInFOR_Name);
  }
  if (accessor.hasActualStartTime()) {
    extxml_uci::util::SerializationHelpers::serializeDateTime(accessor.getActualStartTime(), node, SAR_ActivityStatusDetailType_Names::ActualStartTime_Name);
  }
  if (accessor.hasActualStopTime()) {
    extxml_uci::util::SerializationHelpers::serializeDateTime(accessor.getActualStopTime(), node, SAR_ActivityStatusDetailType_Names::ActualStopTime_Name);
  }
  if (accessor.hasPercentCoverage()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getPercentCoverage(), node, SAR_ActivityStatusDetailType_Names::PercentCoverage_Name);
  }
  if (accessor.hasEntitiesReported()) {
    extxml_uci::util::SerializationHelpers::serializeUnsignedInt(accessor.getEntitiesReported(), node, SAR_ActivityStatusDetailType_Names::EntitiesReported_Name);
  }
  if (accessor.hasProductsProduced()) {
    extxml_uci::util::SerializationHelpers::serializeUnsignedInt(accessor.getProductsProduced(), node, SAR_ActivityStatusDetailType_Names::ProductsProduced_Name);
  }
  if (accessor.hasEstimatedERP()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getEstimatedERP(), node, SAR_ActivityStatusDetailType_Names::EstimatedERP_Name);
  }
  if (accessor.hasMinimumCNR()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getMinimumCNR(), node, SAR_ActivityStatusDetailType_Names::MinimumCNR_Name);
  }
  if (accessor.hasAchievableEllipticity()) {
    extxml_uci::util::SerializationHelpers::serializeFloat(accessor.getAchievableEllipticity(), node, SAR_ActivityStatusDetailType_Names::AchievableEllipticity_Name);
  }
  if (accessor.hasAchievableResolution()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getAchievableResolution(), node, SAR_ActivityStatusDetailType_Names::AchievableResolution_Name);
  }
  {
  ...
  if (accessor.hasPercentOccluded()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getPercentOccluded(), node, SAR_ActivityStatusDetailType_Names::PercentOccluded_Name);
  }
  if (accessor.hasTimeToService()) {
    extxml_uci::util::SerializationHelpers::serializeDuration(accessor.getTimeToService(), node, SAR_ActivityStatusDetailType_Names::TimeToService_Name);
  }
  if (accessor.hasPercentRadarTimeline()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getPercentRadarTimeline(), node, SAR_ActivityStatusDetailType_Names::PercentRadarTimeline_Name);
  }
  if (accessor.hasPercentageInFOV()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getPercentageInFOV(), node, SAR_ActivityStatusDetailType_Names::PercentageInFOV_Name);
  }
