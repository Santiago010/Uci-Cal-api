...
std::string MissionInformationType::serialize(const uci::type::MissionInformationType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, MissionInformationType_Names::Extern_Type_Name);
  }
  extxml_uci::util::SerializationHelpers::serializeString(accessor.getMissionName(), node, MissionInformationType_Names::MissionName_Name);
  if (accessor.hasMissionDescription()) {
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getMissionDescription(), node, MissionInformationType_Names::MissionDescription_Name);
  }
  if (createNode) {
