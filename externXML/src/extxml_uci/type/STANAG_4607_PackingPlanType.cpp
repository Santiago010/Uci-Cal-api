  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setExerciseIdentifier(extxml_uci::util::SerializationHelpers::deserializeUnsignedInt(*value));
      }
...
std::string STANAG_4607_PackingPlanType::serialize(const uci::type::STANAG_4607_PackingPlanType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, STANAG_4607_PackingPlanType_Names::Extern_Type_Name);
  }
  STANAG_4607_PackingPlanPET::serialize(accessor, node, "", false, false, false);
  if (accessor.hasExerciseIdentifier()) {
    extxml_uci::util::SerializationHelpers::serializeUnsignedInt(accessor.getExerciseIdentifier(), node, STANAG_4607_PackingPlanType_Names::ExerciseIdentifier_Name);
  }
  if (accessor.hasClassificationSystem()) {
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getClassificationSystem(), node, STANAG_4607_PackingPlanType_Names::ClassificationSystem_Name);
  }
  if (accessor.hasOriginatorIdentifier()) {
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getOriginatorIdentifier(), node, STANAG_4607_PackingPlanType_Names::OriginatorIdentifier_Name);
  }
  if (accessor.hasMissionPlan()) {
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getMissionPlan(), node, STANAG_4607_PackingPlanType_Names::MissionPlan_Name);
  }
  if (accessor.hasRecipient()) {
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getRecipient(), node, STANAG_4607_PackingPlanType_Names::Recipient_Name);
  }
  if (accessor.hasFreeText()) {
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getFreeText(), node, STANAG_4607_PackingPlanType_Names::FreeText_Name);
  }
  if (createNode) {
