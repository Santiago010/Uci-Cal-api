...
bool OrbitDurationType::deserialize(const boost::property_tree::ptree& propTree, uci::type::OrbitDurationType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setNumberOfOrbits(extxml_uci::util::SerializationHelpers::deserializeUnsignedInt(*value));
      }
    }
  }
  return true;
...
std::string OrbitDurationType::serialize(const uci::type::OrbitDurationType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, OrbitDurationType_Names::Extern_Type_Name);
  }
  if (accessor.isTime()) {
    extxml_uci::util::SerializationHelpers::serializeDuration(accessor.getTime(), node, OrbitDurationType_Names::Time_Name);
  } else if (accessor.isNumberOfOrbits()) {
    extxml_uci::util::SerializationHelpers::serializeUnsignedInt(accessor.getNumberOfOrbits(), node, OrbitDurationType_Names::NumberOfOrbits_Name);
  }
  if (createNode) {
