...
bool SubsystemFaultType::deserialize(const boost::property_tree::ptree& propTree, uci::type::SubsystemFaultType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setDetectionTime(extxml_uci::util::SerializationHelpers::deserializeDateTime(*value));
      }
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setFaultCodeCount(extxml_uci::util::SerializationHelpers::deserializeInt(*value));
      }
...
std::string SubsystemFaultType::serialize(const uci::type::SubsystemFaultType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, SubsystemFaultType_Names::Extern_Type_Name);
  }
  ...
  if (accessor.hasDetectionTime()) {
    extxml_uci::util::SerializationHelpers::serializeDateTime(accessor.getDetectionTime(), node, SubsystemFaultType_Names::DetectionTime_Name);
  }
  extxml_uci::util::SerializationHelpers::serializeString(accessor.getFaultCode(), node, SubsystemFaultType_Names::FaultCode_Name);
  if (accessor.hasFaultCodeCount()) {
    extxml_uci::util::SerializationHelpers::serializeInt(accessor.getFaultCodeCount(), node, SubsystemFaultType_Names::FaultCodeCount_Name);
  }
  if (accessor.hasFaultDescription()) {
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getFaultDescription(), node, SubsystemFaultType_Names::FaultDescription_Name);
  }
