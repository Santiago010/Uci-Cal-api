...
bool ObservationMeasurementSourceType::deserialize(const boost::property_tree::ptree& propTree, uci::type::ObservationMeasurementSourceType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setNumberOfLocalTracksReported(extxml_uci::util::SerializationHelpers::deserializeInt(*value));
      }
    } else if (valueType.first == nsPrefix + ObservationMeasurementSourceType_Names::NumberOfIndependentMeasurements_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setNumberOfIndependentMeasurements(extxml_uci::util::SerializationHelpers::deserializeInt(*value));
      }
...
std::string ObservationMeasurementSourceType::serialize(const uci::type::ObservationMeasurementSourceType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, ObservationMeasurementSourceType_Names::Extern_Type_Name);
  }
  {
  ...
  if (accessor.hasNumberOfLocalTracksReported()) {
    extxml_uci::util::SerializationHelpers::serializeInt(accessor.getNumberOfLocalTracksReported(), node, ObservationMeasurementSourceType_Names::NumberOfLocalTracksReported_Name);
  }
  if (accessor.hasNumberOfIndependentMeasurements()) {
    extxml_uci::util::SerializationHelpers::serializeInt(accessor.getNumberOfIndependentMeasurements(), node, ObservationMeasurementSourceType_Names::NumberOfIndependentMeasurements_Name);
  }
  {
