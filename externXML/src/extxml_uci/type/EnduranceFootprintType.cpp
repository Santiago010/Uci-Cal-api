  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setReferenceAltitude(extxml_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
...
std::string EnduranceFootprintType::serialize(const uci::type::EnduranceFootprintType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, EnduranceFootprintType_Names::Extern_Type_Name);
  }
  ...
  if (accessor.hasReferenceAltitude()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getReferenceAltitude(), node, EnduranceFootprintType_Names::ReferenceAltitude_Name);
  }
  if (accessor.hasDuration()) {
    extxml_uci::util::SerializationHelpers::serializeDuration(accessor.getDuration(), node, EnduranceFootprintType_Names::Duration_Name);
  }
  if (createNode) {
