...
std::string ESM_BinType::serialize(const uci::type::ESM_BinType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, ESM_BinType_Names::Extern_Type_Name);
  }
  extxml_uci::util::SerializationHelpers::serializeUnsignedInt(accessor.getEmitterPriorityBin(), node, ESM_BinType_Names::EmitterPriorityBin_Name);
  {
  ...
  }
  {
    ...
    for (uci::type::ESM_BinType::EmitterELNOT_Identifier::size_type i = 0, end = boundedList.size(); i < end; ++i) {
      extxml_uci::util::SerializationHelpers::serializeString(boundedList.at(i), node, ESM_BinType_Names::EmitterELNOT_Identifier_Name);
    }
  }
  if (createNode) {
