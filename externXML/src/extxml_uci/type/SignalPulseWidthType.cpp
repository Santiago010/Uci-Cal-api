...
std::string SignalPulseWidthType::serialize(const uci::type::SignalPulseWidthType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, SignalPulseWidthType_Names::Extern_Type_Name);
  }
  ...
  if (accessor.hasPulseWidthChopped()) {
    extxml_uci::util::SerializationHelpers::serializeBoolean(accessor.getPulseWidthChopped(), node, SignalPulseWidthType_Names::PulseWidthChopped_Name);
  }
  if (accessor.hasPulseOnPulse()) {
    extxml_uci::util::SerializationHelpers::serializeBoolean(accessor.getPulseOnPulse(), node, SignalPulseWidthType_Names::PulseOnPulse_Name);
  }
  if (createNode) {
