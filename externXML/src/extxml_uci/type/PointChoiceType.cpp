...
bool PointChoiceType::deserialize(const boost::property_tree::ptree& propTree, uci::type::PointChoiceType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
...
std::string PointChoiceType::serialize(const uci::type::PointChoiceType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, PointChoiceType_Names::Extern_Type_Name);
  }
