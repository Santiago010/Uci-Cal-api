  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setMinSignalStrength(extxml_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    } else if (valueType.first == nsPrefix + FrequencyParamsType_Names::RF_FrequencyResolution_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setRF_FrequencyResolution(extxml_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
...
std::string FrequencyParamsType::serialize(const uci::type::FrequencyParamsType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, FrequencyParamsType_Names::Extern_Type_Name);
  }
  ...
  if (accessor.hasMinSignalStrength()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getMinSignalStrength(), node, FrequencyParamsType_Names::MinSignalStrength_Name);
  }
  if (accessor.hasRF_FrequencyResolution()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getRF_FrequencyResolution(), node, FrequencyParamsType_Names::RF_FrequencyResolution_Name);
  }
  if (accessor.hasProductResolutionTime()) {
    extxml_uci::util::SerializationHelpers::serializeDuration(accessor.getProductResolutionTime(), node, FrequencyParamsType_Names::ProductResolutionTime_Name);
  }
  if (createNode) {
