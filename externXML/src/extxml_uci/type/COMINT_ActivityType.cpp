...
std::string COMINT_ActivityType::serialize(const uci::type::COMINT_ActivityType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, COMINT_ActivityType_Names::Extern_Type_Name);
  }
  ...
  if (accessor.hasConsentRequired()) {
    extxml_uci::util::SerializationHelpers::serializeBoolean(accessor.getConsentRequired(), node, COMINT_ActivityType_Names::ConsentRequired_Name);
  }
  ...
  if (accessor.hasActualStartTime()) {
    extxml_uci::util::SerializationHelpers::serializeDateTime(accessor.getActualStartTime(), node, COMINT_ActivityType_Names::ActualStartTime_Name);
  }
  if (accessor.hasActualEndTime()) {
    extxml_uci::util::SerializationHelpers::serializeDateTime(accessor.getActualEndTime(), node, COMINT_ActivityType_Names::ActualEndTime_Name);
  }
  if (accessor.hasSpectralDensityReporting()) {
    extxml_uci::util::SerializationHelpers::serializeBoolean(accessor.getSpectralDensityReporting(), node, COMINT_ActivityType_Names::SpectralDensityReporting_Name);
  }
  if (createNode) {
