  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setExposureTime(extxml_uci::util::SerializationHelpers::deserializeDuration(*value));
      }
...
std::string ThreatExposureType::serialize(const uci::type::ThreatExposureType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, ThreatExposureType_Names::Extern_Type_Name);
  }
  EntityID_Type::serialize(accessor.getEntityID(), node, ThreatExposureType_Names::EntityID_Name);
  extxml_uci::util::SerializationHelpers::serializeDuration(accessor.getExposureTime(), node, ThreatExposureType_Names::ExposureTime_Name);
  {
