...
bool GatewayLink16ConfigurationEnvironmentType::deserialize(const boost::property_tree::ptree& propTree, uci::type::GatewayLink16ConfigurationEnvironmentType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setSpace(extxml_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
    } else if (valueType.first == nsPrefix + GatewayLink16ConfigurationEnvironmentType_Names::Air_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setAir(extxml_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
    } else if (valueType.first == nsPrefix + GatewayLink16ConfigurationEnvironmentType_Names::Surface_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setSurface(extxml_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
    } else if (valueType.first == nsPrefix + GatewayLink16ConfigurationEnvironmentType_Names::Subsurface_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setSubsurface(extxml_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
    } else if (valueType.first == nsPrefix + GatewayLink16ConfigurationEnvironmentType_Names::Land_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setLand(extxml_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
    }
  }
  return true;
...
std::string GatewayLink16ConfigurationEnvironmentType::serialize(const uci::type::GatewayLink16ConfigurationEnvironmentType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, GatewayLink16ConfigurationEnvironmentType_Names::Extern_Type_Name);
  }
  extxml_uci::util::SerializationHelpers::serializeBoolean(accessor.getUnknown(), node, GatewayLink16ConfigurationEnvironmentType_Names::Unknown_Name);
  extxml_uci::util::SerializationHelpers::serializeBoolean(accessor.getSpace(), node, GatewayLink16ConfigurationEnvironmentType_Names::Space_Name);
  extxml_uci::util::SerializationHelpers::serializeBoolean(accessor.getAir(), node, GatewayLink16ConfigurationEnvironmentType_Names::Air_Name);
  extxml_uci::util::SerializationHelpers::serializeBoolean(accessor.getSurface(), node, GatewayLink16ConfigurationEnvironmentType_Names::Surface_Name);
  extxml_uci::util::SerializationHelpers::serializeBoolean(accessor.getSubsurface(), node, GatewayLink16ConfigurationEnvironmentType_Names::Subsurface_Name);
  extxml_uci::util::SerializationHelpers::serializeBoolean(accessor.getLand(), node, GatewayLink16ConfigurationEnvironmentType_Names::Land_Name);
  if (createNode) {
