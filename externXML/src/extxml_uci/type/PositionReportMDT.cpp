...
std::string PositionReportMDT::serialize(const uci::type::PositionReportMDT& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, PositionReportMDT_Names::Extern_Type_Name);
  }
  SystemID_Type::serialize(accessor.getSystemID(), node, PositionReportMDT_Names::SystemID_Name);
  if (accessor.hasDisplayName()) {
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getDisplayName(), node, PositionReportMDT_Names::DisplayName_Name);
  }
  ...
  if (accessor.hasWanderAngle()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getWanderAngle(), node, PositionReportMDT_Names::WanderAngle_Name);
  }
  if (accessor.hasMagneticHeading()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getMagneticHeading(), node, PositionReportMDT_Names::MagneticHeading_Name);
  }
  if (createNode) {
