...
bool AnalysisRoutePathType::deserialize(const boost::property_tree::ptree& propTree, uci::type::AnalysisRoutePathType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        ...
        AnalysisRouteSegmentType::deserialize(valueType.second, boundedList.at(boundedListSize), nodeName, nsPrefix);
      }
    }
  }
  return true;
...
std::string AnalysisRoutePathType::serialize(const uci::type::AnalysisRoutePathType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, AnalysisRoutePathType_Names::Extern_Type_Name);
  }
  ...
  }
  {
    ...
    for (uci::type::AnalysisRoutePathType::SegmentAnalysisData::size_type i = 0, end = boundedList.size(); i < end; ++i) {
      AnalysisRouteSegmentType::serialize(boundedList.at(i), node, AnalysisRoutePathType_Names::SegmentAnalysisData_Name);
    }
  }
  if (createNode) {
