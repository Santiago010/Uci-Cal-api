...
bool CommTerminalActivityCommandType::deserialize(const boost::property_tree::ptree& propTree, uci::type::CommTerminalActivityCommandType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      extxml_uci::util::DerivedTypesDeserializer::deserialize(valueType.second, accessor.enableWaveformSpecificSettingsChange(extxml_uci::util::SerializationHelpers::checkForTypeAttribute(valueType.second, nsPrefix)), nodeName, nsPrefix);
...
std::string CommTerminalActivityCommandType::serialize(const uci::type::CommTerminalActivityCommandType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, CommTerminalActivityCommandType_Names::Extern_Type_Name);
  }
  ...
  }
  {
    ...
    for (uci::type::CommTerminalActivityCommandType::ResourceSelection::size_type i = 0, end = boundedList.size(); i < end; ++i) {
      ResourceSelectionType::serialize(boundedList.at(i), node, CommTerminalActivityCommandType_Names::ResourceSelection_Name);
    }
  }
  ...
  }
  {
    ...
    for (uci::type::CommTerminalActivityCommandType::LinkConnectionRequest::size_type i = 0, end = boundedList.size(); i < end; ++i) {
      LinkConnectionRequestType::serialize(boundedList.at(i), node, CommTerminalActivityCommandType_Names::LinkConnectionRequest_Name);
    }
  }
