...
bool ImpactDetailsType::deserialize(const boost::property_tree::ptree& propTree, uci::type::ImpactDetailsType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setImpactSpeed(extxml_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    } else if (valueType.first == nsPrefix + ImpactDetailsType_Names::ImpactPointDistanceFromDMPI_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setImpactPointDistanceFromDMPI(extxml_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    } else if (valueType.first == nsPrefix + ImpactDetailsType_Names::AccelerometerRecordedImpact_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setAccelerometerRecordedImpact(extxml_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
...
std::string ImpactDetailsType::serialize(const uci::type::ImpactDetailsType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, ImpactDetailsType_Names::Extern_Type_Name);
  }
  ...
  if (accessor.hasImpactSpeed()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getImpactSpeed(), node, ImpactDetailsType_Names::ImpactSpeed_Name);
  }
  if (accessor.hasImpactPointDistanceFromDMPI()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getImpactPointDistanceFromDMPI(), node, ImpactDetailsType_Names::ImpactPointDistanceFromDMPI_Name);
  }
  if (accessor.hasAccelerometerRecordedImpact()) {
    extxml_uci::util::SerializationHelpers::serializeBoolean(accessor.getAccelerometerRecordedImpact(), node, ImpactDetailsType_Names::AccelerometerRecordedImpact_Name);
  }
