  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setSpecificType(extxml_uci::util::SerializationHelpers::deserializeUnsignedInt(*value));
      }
...
std::string SpecificIdentityType::serialize(const uci::type::SpecificIdentityType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool checkIfDerivation, const bool /*topLevel*/) {
  ...
  if (!checkIfDerivation || (accessor.getAccessorType() == uci::type::accessorType::specificIdentityType)) {
    ...
    if (addTypeAttribute) {
      extxml_uci::util::SerializationHelpers::addTypeAttribute(node, SpecificIdentityType_Names::Extern_Type_Name);
    }
    extxml_uci::util::SerializationHelpers::serializeUnsignedInt(accessor.getSpecificType(), node, SpecificIdentityType_Names::SpecificType_Name);
    ...
    if (accessor.hasSpecificTypeModel()) {
      extxml_uci::util::SerializationHelpers::serializeString(accessor.getSpecificTypeModel(), node, SpecificIdentityType_Names::SpecificTypeModel_Name);
    }
    if (createNode) {
