...
bool MvObservationType::deserialize(const boost::property_tree::ptree& propTree, uci::type::MvObservationType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setVisualMagnitude(extxml_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
...
std::string MvObservationType::serialize(const uci::type::MvObservationType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, MvObservationType_Names::Extern_Type_Name);
  }
  EntityID_Type::serialize(accessor.getEntityID(), node, MvObservationType_Names::EntityID_Name);
  extxml_uci::util::SerializationHelpers::serializeDateTime(accessor.getObservationTime(), node, MvObservationType_Names::ObservationTime_Name);
  {
  ...
  if (accessor.hasVisualMagnitude()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getVisualMagnitude(), node, MvObservationType_Names::VisualMagnitude_Name);
  }
  if (accessor.hasRightAscension()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getRightAscension(), node, MvObservationType_Names::RightAscension_Name);
  }
  if (accessor.hasDeclination()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getDeclination(), node, MvObservationType_Names::Declination_Name);
  }
  if (accessor.hasProbability()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getProbability(), node, MvObservationType_Names::Probability_Name);
  }
  if (createNode) {
