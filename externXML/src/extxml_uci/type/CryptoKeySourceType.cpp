...
bool CryptoKeySourceType::deserialize(const boost::property_tree::ptree& propTree, uci::type::CryptoKeySourceType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
...
std::string CryptoKeySourceType::serialize(const uci::type::CryptoKeySourceType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, CryptoKeySourceType_Names::Extern_Type_Name);
  }
