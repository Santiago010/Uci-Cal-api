...
bool CryptoRolloverCommandType::deserialize(const boost::property_tree::ptree& propTree, uci::type::CryptoRolloverCommandType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setRolloverScheduleTime(extxml_uci::util::SerializationHelpers::deserializeDateTime(*value));
      }
    } else if (valueType.first == nsPrefix + CryptoRolloverCommandType_Names::ZeroizePreviousSlot_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setZeroizePreviousSlot(extxml_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
    }
  }
  return true;
...
std::string CryptoRolloverCommandType::serialize(const uci::type::CryptoRolloverCommandType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, CryptoRolloverCommandType_Names::Extern_Type_Name);
  }
  ...
  if (accessor.hasRolloverScheduleTime()) {
    extxml_uci::util::SerializationHelpers::serializeDateTime(accessor.getRolloverScheduleTime(), node, CryptoRolloverCommandType_Names::RolloverScheduleTime_Name);
  }
  if (accessor.hasZeroizePreviousSlot()) {
    extxml_uci::util::SerializationHelpers::serializeBoolean(accessor.getZeroizePreviousSlot(), node, CryptoRolloverCommandType_Names::ZeroizePreviousSlot_Name);
  }
  if (createNode) {
