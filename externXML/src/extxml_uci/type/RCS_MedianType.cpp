  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setRCS_Value(extxml_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    } else if (valueType.first == nsPrefix + RCS_MedianType_Names::RCS_Variance_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setRCS_Variance(extxml_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    } else if (valueType.first == nsPrefix + RCS_MedianType_Names::SpectralWidth_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setSpectralWidth(extxml_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
...
std::string RCS_MedianType::serialize(const uci::type::RCS_MedianType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, RCS_MedianType_Names::Extern_Type_Name);
  }
  extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getRCS_Value(), node, RCS_MedianType_Names::RCS_Value_Name);
  extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getRCS_Variance(), node, RCS_MedianType_Names::RCS_Variance_Name);
  if (accessor.hasSpectralWidth()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getSpectralWidth(), node, RCS_MedianType_Names::SpectralWidth_Name);
  }
