...
bool ArchiveRequestType::deserialize(const boost::property_tree::ptree& propTree, uci::type::ArchiveRequestType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setNumberOfDays(extxml_uci::util::SerializationHelpers::deserializeUnsignedInt(*value));
      }
    } else if (valueType.first == nsPrefix + ArchiveRequestType_Names::SpaceNeeded_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setSpaceNeeded(extxml_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
    } else if (valueType.first == nsPrefix + ArchiveRequestType_Names::ManuallyDeleted_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setManuallyDeleted(extxml_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
    } else if (valueType.first == nsPrefix + ArchiveRequestType_Names::NumberOfMissions_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setNumberOfMissions(extxml_uci::util::SerializationHelpers::deserializeUnsignedInt(*value));
      }
    }
  }
  return true;
...
std::string ArchiveRequestType::serialize(const uci::type::ArchiveRequestType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, ArchiveRequestType_Names::Extern_Type_Name);
  }
  if (accessor.isTime()) {
    extxml_uci::util::SerializationHelpers::serializeDateTime(accessor.getTime(), node, ArchiveRequestType_Names::Time_Name);
  } else if (accessor.isNumberOfDays()) {
    extxml_uci::util::SerializationHelpers::serializeUnsignedInt(accessor.getNumberOfDays(), node, ArchiveRequestType_Names::NumberOfDays_Name);
  } else if (accessor.isSpaceNeeded()) {
    extxml_uci::util::SerializationHelpers::serializeBoolean(accessor.getSpaceNeeded(), node, ArchiveRequestType_Names::SpaceNeeded_Name);
  } else if (accessor.isManuallyDeleted()) {
    extxml_uci::util::SerializationHelpers::serializeBoolean(accessor.getManuallyDeleted(), node, ArchiveRequestType_Names::ManuallyDeleted_Name);
  } else if (accessor.isNumberOfMissions()) {
    extxml_uci::util::SerializationHelpers::serializeUnsignedInt(accessor.getNumberOfMissions(), node, ArchiveRequestType_Names::NumberOfMissions_Name);
  }
  if (createNode) {
