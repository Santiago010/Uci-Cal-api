...
std::string SMTI_ActivityType::serialize(const uci::type::SMTI_ActivityType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, SMTI_ActivityType_Names::Extern_Type_Name);
  }
  ...
  if (accessor.hasPolicyApplied()) {
    extxml_uci::util::SerializationHelpers::serializeBoolean(accessor.getPolicyApplied(), node, SMTI_ActivityType_Names::PolicyApplied_Name);
  }
  extxml_uci::util::SerializationHelpers::serializeBoolean(accessor.getAllProductsAndMessagesProduced(), node, SMTI_ActivityType_Names::AllProductsAndMessagesProduced_Name);
  {
