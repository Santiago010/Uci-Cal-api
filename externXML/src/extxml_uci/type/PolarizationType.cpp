  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setPolarizationTiltAngle(extxml_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    } else if (valueType.first == nsPrefix + PolarizationType_Names::PolarizationAxialRatio_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setPolarizationAxialRatio(extxml_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
...
std::string PolarizationType::serialize(const uci::type::PolarizationType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, PolarizationType_Names::Extern_Type_Name);
  }
  if (accessor.hasPolarizationTiltAngle()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getPolarizationTiltAngle(), node, PolarizationType_Names::PolarizationTiltAngle_Name);
  }
  if (accessor.hasPolarizationAxialRatio()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getPolarizationAxialRatio(), node, PolarizationType_Names::PolarizationAxialRatio_Name);
  }
