...
bool DMPI_DamageEstimateType::deserialize(const boost::property_tree::ptree& propTree, uci::type::DMPI_DamageEstimateType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      extxml_uci::util::DerivedTypesDeserializer::deserialize(valueType.second, accessor.enableWeaponeering(extxml_uci::util::SerializationHelpers::checkForTypeAttribute(valueType.second, nsPrefix)), nodeName, nsPrefix);
...
std::string DMPI_DamageEstimateType::serialize(const uci::type::DMPI_DamageEstimateType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, DMPI_DamageEstimateType_Names::Extern_Type_Name);
  }
  ...
  if (accessor.hasEstimatedBlastRadius()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getEstimatedBlastRadius(), node, DMPI_DamageEstimateType_Names::EstimatedBlastRadius_Name);
  }
  if (createNode) {
