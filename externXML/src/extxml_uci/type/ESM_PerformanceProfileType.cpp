...
std::string ESM_PerformanceProfileType::serialize(const uci::type::ESM_PerformanceProfileType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, ESM_PerformanceProfileType_Names::Extern_Type_Name);
  }
  {
  ...
  if (accessor.hasBeamLimit()) {
    extxml_uci::util::SerializationHelpers::serializeUnsignedInt(accessor.getBeamLimit(), node, ESM_PerformanceProfileType_Names::BeamLimit_Name);
  }
  if (accessor.hasFrequencyChangeTime()) {
    extxml_uci::util::SerializationHelpers::serializeDuration(accessor.getFrequencyChangeTime(), node, ESM_PerformanceProfileType_Names::FrequencyChangeTime_Name);
  }
  if (createNode) {
