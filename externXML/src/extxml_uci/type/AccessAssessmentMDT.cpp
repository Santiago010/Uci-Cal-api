...
std::string AccessAssessmentMDT::serialize(const uci::type::AccessAssessmentMDT& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, AccessAssessmentMDT_Names::Extern_Type_Name);
  }
  ...
  if (accessor.hasAssessmentName()) {
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getAssessmentName(), node, AccessAssessmentMDT_Names::AssessmentName_Name);
  }
  ...
  extxml_uci::util::SerializationHelpers::serializeDateTime(accessor.getCompletionTime(), node, AccessAssessmentMDT_Names::CompletionTime_Name);
  if (accessor.hasAssessmentNarrative()) {
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getAssessmentNarrative(), node, AccessAssessmentMDT_Names::AssessmentNarrative_Name);
  }
  if (createNode) {
