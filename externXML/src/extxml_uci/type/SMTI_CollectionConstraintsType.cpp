...
std::string SMTI_CollectionConstraintsType::serialize(const uci::type::SMTI_CollectionConstraintsType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, SMTI_CollectionConstraintsType_Names::Extern_Type_Name);
  }
  ...
  if (accessor.hasTargetRCS()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getTargetRCS(), node, SMTI_CollectionConstraintsType_Names::TargetRCS_Name);
  }
  ...
  if (accessor.hasProbabilityOfDetection()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getProbabilityOfDetection(), node, SMTI_CollectionConstraintsType_Names::ProbabilityOfDetection_Name);
  }
