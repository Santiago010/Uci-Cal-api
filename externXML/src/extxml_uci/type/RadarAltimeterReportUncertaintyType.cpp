...
bool RadarAltimeterReportUncertaintyType::deserialize(const boost::property_tree::ptree& propTree, uci::type::RadarAltimeterReportUncertaintyType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setVerticalClosingVelocityUncertainty(extxml_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    } else if (valueType.first == nsPrefix + RadarAltimeterReportUncertaintyType_Names::UncertaintyTimeWindow_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setUncertaintyTimeWindow(extxml_uci::util::SerializationHelpers::deserializeTime(*value));
      }
...
std::string RadarAltimeterReportUncertaintyType::serialize(const uci::type::RadarAltimeterReportUncertaintyType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, RadarAltimeterReportUncertaintyType_Names::Extern_Type_Name);
  }
  if (accessor.hasHeightUncertainty()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getHeightUncertainty(), node, RadarAltimeterReportUncertaintyType_Names::HeightUncertainty_Name);
  }
  if (accessor.hasVerticalClosingVelocityUncertainty()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getVerticalClosingVelocityUncertainty(), node, RadarAltimeterReportUncertaintyType_Names::VerticalClosingVelocityUncertainty_Name);
  }
  if (accessor.hasUncertaintyTimeWindow()) {
    extxml_uci::util::SerializationHelpers::serializeTime(accessor.getUncertaintyTimeWindow(), node, RadarAltimeterReportUncertaintyType_Names::UncertaintyTimeWindow_Name);
  }
