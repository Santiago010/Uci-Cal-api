...
bool ThresholdOffRouteTriggerDataType::deserialize(const boost::property_tree::ptree& propTree, uci::type::ThresholdOffRouteTriggerDataType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
...
std::string ThresholdOffRouteTriggerDataType::serialize(const uci::type::ThresholdOffRouteTriggerDataType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, ThresholdOffRouteTriggerDataType_Names::Extern_Type_Name);
  }
  if (accessor.hasTrackError()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getTrackError(), node, ThresholdOffRouteTriggerDataType_Names::TrackError_Name);
  }
  if (accessor.hasAltitudeError()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getAltitudeError(), node, ThresholdOffRouteTriggerDataType_Names::AltitudeError_Name);
  }
