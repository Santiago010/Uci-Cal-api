...
std::string EOB_SiteIdentityType::serialize(const uci::type::EOB_SiteIdentityType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, EOB_SiteIdentityType_Names::Extern_Type_Name);
  }
  ...
  if (accessor.hasO_Suffix()) {
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getO_Suffix(), node, EOB_SiteIdentityType_Names::O_Suffix_Name);
  }
  if (accessor.hasCategory()) {
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getCategory(), node, EOB_SiteIdentityType_Names::Category_Name);
  }
  if (createNode) {
