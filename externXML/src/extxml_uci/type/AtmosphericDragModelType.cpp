...
bool AtmosphericDragModelType::deserialize(const boost::property_tree::ptree& propTree, uci::type::AtmosphericDragModelType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setEnergyDissipationRate(extxml_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    }
  }
  return true;
...
std::string AtmosphericDragModelType::serialize(const uci::type::AtmosphericDragModelType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, AtmosphericDragModelType_Names::Extern_Type_Name);
  }
  ...
  if (accessor.hasEnergyDissipationRate()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getEnergyDissipationRate(), node, AtmosphericDragModelType_Names::EnergyDissipationRate_Name);
  }
  if (createNode) {
