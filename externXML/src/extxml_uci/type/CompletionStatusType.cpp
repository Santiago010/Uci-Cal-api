  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setEstimatedTimeComplete(extxml_uci::util::SerializationHelpers::deserializeDateTime(*value));
      }
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setActualTimeStarted(extxml_uci::util::SerializationHelpers::deserializeDateTime(*value));
      }
    } else if (valueType.first == nsPrefix + CompletionStatusType_Names::ActualTimeComplete_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setActualTimeComplete(extxml_uci::util::SerializationHelpers::deserializeDateTime(*value));
      }
...
std::string CompletionStatusType::serialize(const uci::type::CompletionStatusType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, CompletionStatusType_Names::Extern_Type_Name);
  }
  if (accessor.hasEstimatedTimeComplete()) {
    extxml_uci::util::SerializationHelpers::serializeDateTime(accessor.getEstimatedTimeComplete(), node, CompletionStatusType_Names::EstimatedTimeComplete_Name);
  }
  if (accessor.hasEstimatedPercentComplete()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getEstimatedPercentComplete(), node, CompletionStatusType_Names::EstimatedPercentComplete_Name);
  }
  if (accessor.hasActualTimeStarted()) {
    extxml_uci::util::SerializationHelpers::serializeDateTime(accessor.getActualTimeStarted(), node, CompletionStatusType_Names::ActualTimeStarted_Name);
  }
  if (accessor.hasActualTimeComplete()) {
    extxml_uci::util::SerializationHelpers::serializeDateTime(accessor.getActualTimeComplete(), node, CompletionStatusType_Names::ActualTimeComplete_Name);
  }
  if (accessor.hasDescription()) {
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getDescription(), node, CompletionStatusType_Names::Description_Name);
  }
  if (createNode) {
