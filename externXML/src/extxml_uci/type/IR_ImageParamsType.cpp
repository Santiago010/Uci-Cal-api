  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setSpectralFrequencyResolution(extxml_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    } else if (valueType.first == nsPrefix + IR_ImageParamsType_Names::TemperatureResolution_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setTemperatureResolution(extxml_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
...
std::string IR_ImageParamsType::serialize(const uci::type::IR_ImageParamsType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, IR_ImageParamsType_Names::Extern_Type_Name);
  }
  if (accessor.hasSpectralFrequencyResolution()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getSpectralFrequencyResolution(), node, IR_ImageParamsType_Names::SpectralFrequencyResolution_Name);
  }
  if (accessor.hasTemperatureResolution()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getTemperatureResolution(), node, IR_ImageParamsType_Names::TemperatureResolution_Name);
  }
  ...
  if (accessor.hasProductResolutionTime()) {
    extxml_uci::util::SerializationHelpers::serializeDuration(accessor.getProductResolutionTime(), node, IR_ImageParamsType_Names::ProductResolutionTime_Name);
  }
  if (createNode) {
