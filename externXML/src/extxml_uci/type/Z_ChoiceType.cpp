...
bool Z_ChoiceType::deserialize(const boost::property_tree::ptree& propTree, uci::type::Z_ChoiceType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
...
std::string Z_ChoiceType::serialize(const uci::type::Z_ChoiceType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, Z_ChoiceType_Names::Extern_Type_Name);
  }
  if (accessor.isZ()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getZ(), node, Z_ChoiceType_Names::Z_Name);
