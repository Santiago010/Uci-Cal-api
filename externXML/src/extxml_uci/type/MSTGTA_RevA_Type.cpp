  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setTGT_NUM(extxml_uci::util::SerializationHelpers::deserializeUnsignedInt(*value));
      }
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setTGT_PRI(extxml_uci::util::SerializationHelpers::deserializeUnsignedShort(*value));
      }
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setTGT_CAT(extxml_uci::util::SerializationHelpers::deserializeInt(*value));
      }
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setTGT_ELEV(extxml_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
...
std::string MSTGTA_RevA_Type::serialize(const uci::type::MSTGTA_RevA_Type& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, MSTGTA_RevA_Type_Names::Extern_Type_Name);
  }
  if (accessor.hasTGT_NUM()) {
    extxml_uci::util::SerializationHelpers::serializeUnsignedInt(accessor.getTGT_NUM(), node, MSTGTA_RevA_Type_Names::TGT_NUM_Name);
  }
  if (accessor.hasTGT_Identifier()) {
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getTGT_Identifier(), node, MSTGTA_RevA_Type_Names::TGT_Identifier_Name);
  }
  if (accessor.hasTGT_BE()) {
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getTGT_BE(), node, MSTGTA_RevA_Type_Names::TGT_BE_Name);
  }
  if (accessor.hasTGT_PRI()) {
    extxml_uci::util::SerializationHelpers::serializeUnsignedShort(accessor.getTGT_PRI(), node, MSTGTA_RevA_Type_Names::TGT_PRI_Name);
  }
  if (accessor.hasTGT_REQ()) {
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getTGT_REQ(), node, MSTGTA_RevA_Type_Names::TGT_REQ_Name);
  }
  if (accessor.hasTGT_LTIOV()) {
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getTGT_LTIOV(), node, MSTGTA_RevA_Type_Names::TGT_LTIOV_Name);
  }
  if (accessor.hasTGT_TYPE()) {
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getTGT_TYPE(), node, MSTGTA_RevA_Type_Names::TGT_TYPE_Name);
  }
  if (accessor.hasTGT_COLL()) {
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getTGT_COLL(), node, MSTGTA_RevA_Type_Names::TGT_COLL_Name);
  }
  if (accessor.hasTGT_CAT()) {
    extxml_uci::util::SerializationHelpers::serializeInt(accessor.getTGT_CAT(), node, MSTGTA_RevA_Type_Names::TGT_CAT_Name);
  }
  if (accessor.hasTGT_UTC()) {
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getTGT_UTC(), node, MSTGTA_RevA_Type_Names::TGT_UTC_Name);
  }
  if (accessor.hasTGT_ELEV()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getTGT_ELEV(), node, MSTGTA_RevA_Type_Names::TGT_ELEV_Name);
  }
  if (accessor.hasTGT_ELEV_UNIT()) {
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getTGT_ELEV_UNIT(), node, MSTGTA_RevA_Type_Names::TGT_ELEV_UNIT_Name);
  }
  extxml_uci::util::SerializationHelpers::serializeString(accessor.getTGT_LOC(), node, MSTGTA_RevA_Type_Names::TGT_LOC_Name);
  if (createNode) {
