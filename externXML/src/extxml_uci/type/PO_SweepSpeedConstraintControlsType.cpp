  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setSetting(extxml_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    }
  }
  return true;
...
std::string PO_SweepSpeedConstraintControlsType::serialize(const uci::type::PO_SweepSpeedConstraintControlsType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, PO_SweepSpeedConstraintControlsType_Names::Extern_Type_Name);
  }
  if (accessor.isControls()) {
    ...
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getSetting(), node, PO_SweepSpeedConstraintControlsType_Names::Setting_Name);
  }
  if (createNode) {
