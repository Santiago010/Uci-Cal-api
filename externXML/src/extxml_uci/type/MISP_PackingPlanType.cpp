...
bool MISP_PackingPlanType::deserialize(const boost::property_tree::ptree& propTree, uci::type::MISP_PackingPlanType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setAirfieldBarometricPressure(extxml_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    } else if (valueType.first == nsPrefix + MISP_PackingPlanType_Names::AirFieldElevation_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setAirFieldElevation(extxml_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
...
std::string MISP_PackingPlanType::serialize(const uci::type::MISP_PackingPlanType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, MISP_PackingPlanType_Names::Extern_Type_Name);
  }
  MissionID_Type::serialize(accessor.getMissionID(), node, MISP_PackingPlanType_Names::MissionID_Name);
  extxml_uci::util::SerializationHelpers::serializeString(accessor.getPlatformDesignation(), node, MISP_PackingPlanType_Names::PlatformDesignation_Name);
  extxml_uci::util::SerializationHelpers::serializeString(accessor.getImageSourceSensor(), node, MISP_PackingPlanType_Names::ImageSourceSensor_Name);
  if (accessor.hasPlatformTailNumber()) {
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getPlatformTailNumber(), node, MISP_PackingPlanType_Names::PlatformTailNumber_Name);
  }
  if (accessor.hasAirfieldBarometricPressure()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getAirfieldBarometricPressure(), node, MISP_PackingPlanType_Names::AirfieldBarometricPressure_Name);
  }
  if (accessor.hasAirFieldElevation()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getAirFieldElevation(), node, MISP_PackingPlanType_Names::AirFieldElevation_Name);
  }
  if (accessor.hasPlatformCallSign()) {
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getPlatformCallSign(), node, MISP_PackingPlanType_Names::PlatformCallSign_Name);
  }
  ...
  if (accessor.hasClassificationOrMarkingSystem()) {
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getClassificationOrMarkingSystem(), node, MISP_PackingPlanType_Names::ClassificationOrMarkingSystem_Name);
  }
  if (accessor.hasClassificationComment()) {
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getClassificationComment(), node, MISP_PackingPlanType_Names::ClassificationComment_Name);
  }
  ...
  if (accessor.hasItemDesignator()) {
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getItemDesignator(), node, MISP_PackingPlanType_Names::ItemDesignator_Name);
  }
  if (createNode) {
