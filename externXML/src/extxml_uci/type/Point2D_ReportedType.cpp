...
bool Point2D_ReportedType::deserialize(const boost::property_tree::ptree& propTree, uci::type::Point2D_ReportedType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
...
std::string Point2D_ReportedType::serialize(const uci::type::Point2D_ReportedType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, Point2D_ReportedType_Names::Extern_Type_Name);
  }
  Point2D_Type::serialize(accessor, node, "", false, false, false);
  if (accessor.hasHAE_Adjustment()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getHAE_Adjustment(), node, Point2D_ReportedType_Names::HAE_Adjustment_Name);
  }
