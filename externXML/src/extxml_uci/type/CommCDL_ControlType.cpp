  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setLinkChannelPriority(extxml_uci::util::SerializationHelpers::deserializeUnsignedByte(*value));
      }
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setUDP_MonitorPeriod(extxml_uci::util::SerializationHelpers::deserializeUnsignedByte(*value));
      }
...
std::string CommCDL_ControlType::serialize(const uci::type::CommCDL_ControlType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, CommCDL_ControlType_Names::Extern_Type_Name);
  }
  if (accessor.hasLinkChannelPriority()) {
    extxml_uci::util::SerializationHelpers::serializeUnsignedByte(accessor.getLinkChannelPriority(), node, CommCDL_ControlType_Names::LinkChannelPriority_Name);
  }
  ...
  if (accessor.hasUDP_MonitorPeriod()) {
    extxml_uci::util::SerializationHelpers::serializeUnsignedByte(accessor.getUDP_MonitorPeriod(), node, CommCDL_ControlType_Names::UDP_MonitorPeriod_Name);
  }
