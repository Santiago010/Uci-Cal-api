...
bool COMINT_ProcessingParametersType::deserialize(const boost::property_tree::ptree& propTree, uci::type::COMINT_ProcessingParametersType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setMaxLOB_TimeOffset(extxml_uci::util::SerializationHelpers::deserializeDuration(*value));
      }
    }
  }
...
std::string COMINT_ProcessingParametersType::serialize(const uci::type::COMINT_ProcessingParametersType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, COMINT_ProcessingParametersType_Names::Extern_Type_Name);
  }
  ProcessingParametersPET::serialize(accessor, node, "", false, false, false);
  if (accessor.hasCenterFrequency()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getCenterFrequency(), node, COMINT_ProcessingParametersType_Names::CenterFrequency_Name);
  }
  ...
  if (accessor.hasMaxLOB_TimeOffset()) {
    extxml_uci::util::SerializationHelpers::serializeDuration(accessor.getMaxLOB_TimeOffset(), node, COMINT_ProcessingParametersType_Names::MaxLOB_TimeOffset_Name);
  }
  if (createNode) {
