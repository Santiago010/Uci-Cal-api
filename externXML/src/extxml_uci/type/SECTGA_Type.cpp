...
std::string SECTGA_Type::serialize(const uci::type::SECTGA_Type& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, SECTGA_Type_Names::Extern_Type_Name);
  }
  if (accessor.hasSEC_Identifier()) {
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getSEC_Identifier(), node, SECTGA_Type_Names::SEC_Identifier_Name);
  }
  if (accessor.hasSEC_BE()) {
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getSEC_BE(), node, SECTGA_Type_Names::SEC_BE_Name);
  }
  if (createNode) {
