  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setZX_Resolution(extxml_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    } else if (valueType.first == nsPrefix + RadarAltimeterReportResolutionType_Names::YZ_Resolution_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setYZ_Resolution(extxml_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    } else if (valueType.first == nsPrefix + RadarAltimeterReportResolutionType_Names::HeightResolution_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setHeightResolution(extxml_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    } else if (valueType.first == nsPrefix + RadarAltimeterReportResolutionType_Names::VerticalClosingVelocityResolution_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setVerticalClosingVelocityResolution(extxml_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    }
  }
  return true;
...
std::string RadarAltimeterReportResolutionType::serialize(const uci::type::RadarAltimeterReportResolutionType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, RadarAltimeterReportResolutionType_Names::Extern_Type_Name);
  }
  if (accessor.hasZX_Resolution()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getZX_Resolution(), node, RadarAltimeterReportResolutionType_Names::ZX_Resolution_Name);
  }
  if (accessor.hasYZ_Resolution()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getYZ_Resolution(), node, RadarAltimeterReportResolutionType_Names::YZ_Resolution_Name);
  }
  if (accessor.hasHeightResolution()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getHeightResolution(), node, RadarAltimeterReportResolutionType_Names::HeightResolution_Name);
  }
  if (accessor.hasVerticalClosingVelocityResolution()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getVerticalClosingVelocityResolution(), node, RadarAltimeterReportResolutionType_Names::VerticalClosingVelocityResolution_Name);
  }
  if (createNode) {
