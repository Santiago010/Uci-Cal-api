...
std::string ResourceStatusSelectedType::serialize(const uci::type::ResourceStatusSelectedType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, ResourceStatusSelectedType_Names::Extern_Type_Name);
  }
  if (accessor.hasSystemThreadIndex()) {
    extxml_uci::util::SerializationHelpers::serializeUnsignedInt(accessor.getSystemThreadIndex(), node, ResourceStatusSelectedType_Names::SystemThreadIndex_Name);
  }
  {
  ...
  extxml_uci::util::SerializationHelpers::serializeUnsignedInt(accessor.getResourceAccessPriority(), node, ResourceStatusSelectedType_Names::ResourceAccessPriority_Name);
  {
