...
std::string PO_ComponentSettingsFocusSweepSettingsStepIncrementType::serialize(const uci::type::PO_ComponentSettingsFocusSweepSettingsStepIncrementType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, PO_ComponentSettingsFocusSweepSettingsStepIncrementType_Names::Extern_Type_Name);
  }
  if (accessor.isPercentage()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getPercentage(), node, PO_ComponentSettingsFocusSweepSettingsStepIncrementType_Names::Percentage_Name);
  } else if (accessor.isNumberOfSteps()) {
    extxml_uci::util::SerializationHelpers::serializeUnsignedInt(accessor.getNumberOfSteps(), node, PO_ComponentSettingsFocusSweepSettingsStepIncrementType_Names::NumberOfSteps_Name);
  }
  if (createNode) {
