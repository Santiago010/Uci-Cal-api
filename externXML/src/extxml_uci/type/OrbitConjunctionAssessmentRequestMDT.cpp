...
std::string OrbitConjunctionAssessmentRequestMDT::serialize(const uci::type::OrbitConjunctionAssessmentRequestMDT& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, OrbitConjunctionAssessmentRequestMDT_Names::Extern_Type_Name);
  }
  ...
  if (accessor.hasRangeThreshold()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getRangeThreshold(), node, OrbitConjunctionAssessmentRequestMDT_Names::RangeThreshold_Name);
  }
  {
  ...
  if (accessor.hasRespondBy()) {
    extxml_uci::util::SerializationHelpers::serializeDateTime(accessor.getRespondBy(), node, OrbitConjunctionAssessmentRequestMDT_Names::RespondBy_Name);
  }
  if (createNode) {
