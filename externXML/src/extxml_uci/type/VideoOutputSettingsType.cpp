...
std::string VideoOutputSettingsType::serialize(const uci::type::VideoOutputSettingsType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, VideoOutputSettingsType_Names::Extern_Type_Name);
  }
  extxml_uci::util::SerializationHelpers::serializeBoolean(accessor.getEnable(), node, VideoOutputSettingsType_Names::Enable_Name);
  {
    ...
    for (uci::type::VideoOutputSettingsType::SourceChannel::size_type i = 0, end = boundedList.size(); i < end; ++i) {
      extxml_uci::util::SerializationHelpers::serializeUnsignedShort(boundedList.at(i), node, VideoOutputSettingsType_Names::SourceChannel_Name);
    }
  }
  {
