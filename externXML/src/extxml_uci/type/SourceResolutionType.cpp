  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setRangeResolution(extxml_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    } else if (valueType.first == nsPrefix + SourceResolutionType_Names::RangeRateResolution_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setRangeRateResolution(extxml_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    } else if (valueType.first == nsPrefix + SourceResolutionType_Names::AzimuthResolution_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setAzimuthResolution(extxml_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    } else if (valueType.first == nsPrefix + SourceResolutionType_Names::ElevationResolution_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setElevationResolution(extxml_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    } else if (valueType.first == nsPrefix + SourceResolutionType_Names::AzimuthRateResolution_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setAzimuthRateResolution(extxml_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    } else if (valueType.first == nsPrefix + SourceResolutionType_Names::ElevationRateResolution_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setElevationRateResolution(extxml_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    } else if (valueType.first == nsPrefix + SourceResolutionType_Names::CosconeY_Resolution_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setCosconeY_Resolution(extxml_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    } else if (valueType.first == nsPrefix + SourceResolutionType_Names::CosconeZ_Resolution_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setCosconeZ_Resolution(extxml_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    } else if (valueType.first == nsPrefix + SourceResolutionType_Names::CosconeY_RateResolution_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setCosconeY_RateResolution(extxml_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    } else if (valueType.first == nsPrefix + SourceResolutionType_Names::CosconeZ_RateResolution_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setCosconeZ_RateResolution(extxml_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    }
  }
  return true;
...
std::string SourceResolutionType::serialize(const uci::type::SourceResolutionType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, SourceResolutionType_Names::Extern_Type_Name);
  }
  if (accessor.hasRangeResolution()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getRangeResolution(), node, SourceResolutionType_Names::RangeResolution_Name);
  }
  if (accessor.hasRangeRateResolution()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getRangeRateResolution(), node, SourceResolutionType_Names::RangeRateResolution_Name);
  }
  if (accessor.hasAzimuthResolution()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getAzimuthResolution(), node, SourceResolutionType_Names::AzimuthResolution_Name);
  }
  if (accessor.hasElevationResolution()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getElevationResolution(), node, SourceResolutionType_Names::ElevationResolution_Name);
  }
  if (accessor.hasAzimuthRateResolution()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getAzimuthRateResolution(), node, SourceResolutionType_Names::AzimuthRateResolution_Name);
  }
  if (accessor.hasElevationRateResolution()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getElevationRateResolution(), node, SourceResolutionType_Names::ElevationRateResolution_Name);
  }
  if (accessor.hasCosconeY_Resolution()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getCosconeY_Resolution(), node, SourceResolutionType_Names::CosconeY_Resolution_Name);
  }
  if (accessor.hasCosconeZ_Resolution()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getCosconeZ_Resolution(), node, SourceResolutionType_Names::CosconeZ_Resolution_Name);
  }
  if (accessor.hasCosconeY_RateResolution()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getCosconeY_RateResolution(), node, SourceResolutionType_Names::CosconeY_RateResolution_Name);
  }
  if (accessor.hasCosconeZ_RateResolution()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getCosconeZ_RateResolution(), node, SourceResolutionType_Names::CosconeZ_RateResolution_Name);
  }
  if (createNode) {
