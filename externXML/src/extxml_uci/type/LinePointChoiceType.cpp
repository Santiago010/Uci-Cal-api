...
bool LinePointChoiceType::deserialize(const boost::property_tree::ptree& propTree, uci::type::LinePointChoiceType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        ...
        LinePoint2D_Type::deserialize(valueType.second, boundedList.at(boundedListSize), nodeName, nsPrefix);
      }
...
std::string LinePointChoiceType::serialize(const uci::type::LinePointChoiceType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, LinePointChoiceType_Names::Extern_Type_Name);
  }
  if (accessor.isPoint()) {
    {
      ...
      for (uci::type::LinePointChoiceType::Point::size_type i = 0, end = boundedList.size(); i < end; ++i) {
        LinePoint2D_Type::serialize(boundedList.at(i), node, LinePointChoiceType_Names::Point_Name);
      }
    }
