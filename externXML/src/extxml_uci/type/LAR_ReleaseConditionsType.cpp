  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setValidAltitude(extxml_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
    } else if (valueType.first == nsPrefix + LAR_ReleaseConditionsType_Names::ValidVelocity_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setValidVelocity(extxml_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
    } else if (valueType.first == nsPrefix + LAR_ReleaseConditionsType_Names::ValidHeading_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setValidHeading(extxml_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
    } else if (valueType.first == nsPrefix + LAR_ReleaseConditionsType_Names::AltitudeDelta_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setAltitudeDelta(extxml_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    } else if (valueType.first == nsPrefix + LAR_ReleaseConditionsType_Names::VelocityDelta_Name) {
      extxml_uci::util::DerivedTypesDeserializer::deserialize(valueType.second, accessor.enableVelocityDelta(extxml_uci::util::SerializationHelpers::checkForTypeAttribute(valueType.second, nsPrefix)), nodeName, nsPrefix);
    } else if (valueType.first == nsPrefix + LAR_ReleaseConditionsType_Names::HeadingDelta_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setHeadingDelta(extxml_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    }
  }
  return true;
...
std::string LAR_ReleaseConditionsType::serialize(const uci::type::LAR_ReleaseConditionsType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, LAR_ReleaseConditionsType_Names::Extern_Type_Name);
  }
  extxml_uci::util::SerializationHelpers::serializeBoolean(accessor.getValidAltitude(), node, LAR_ReleaseConditionsType_Names::ValidAltitude_Name);
  extxml_uci::util::SerializationHelpers::serializeBoolean(accessor.getValidVelocity(), node, LAR_ReleaseConditionsType_Names::ValidVelocity_Name);
  extxml_uci::util::SerializationHelpers::serializeBoolean(accessor.getValidHeading(), node, LAR_ReleaseConditionsType_Names::ValidHeading_Name);
  if (accessor.hasAltitudeDelta()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getAltitudeDelta(), node, LAR_ReleaseConditionsType_Names::AltitudeDelta_Name);
  }
  ...
  if (accessor.hasHeadingDelta()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getHeadingDelta(), node, LAR_ReleaseConditionsType_Names::HeadingDelta_Name);
  }
  if (createNode) {
