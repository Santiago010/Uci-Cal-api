...
bool PO_ComponentF_StopType::deserialize(const boost::property_tree::ptree& propTree, uci::type::PO_ComponentF_StopType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setFixedAperture(extxml_uci::util::SerializationHelpers::deserializeFloat(*value));
      }
...
std::string PO_ComponentF_StopType::serialize(const uci::type::PO_ComponentF_StopType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, PO_ComponentF_StopType_Names::Extern_Type_Name);
  }
  if (accessor.isFixedAperture()) {
    extxml_uci::util::SerializationHelpers::serializeFloat(accessor.getFixedAperture(), node, PO_ComponentF_StopType_Names::FixedAperture_Name);
