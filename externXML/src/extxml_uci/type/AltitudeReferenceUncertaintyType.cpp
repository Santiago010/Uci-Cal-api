...
bool AltitudeReferenceUncertaintyType::deserialize(const boost::property_tree::ptree& propTree, uci::type::AltitudeReferenceUncertaintyType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setVarAltitude(extxml_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    }
  }
  return true;
...
std::string AltitudeReferenceUncertaintyType::serialize(const uci::type::AltitudeReferenceUncertaintyType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, AltitudeReferenceUncertaintyType_Names::Extern_Type_Name);
  }
  ...
  extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getAltitude(), node, AltitudeReferenceUncertaintyType_Names::Altitude_Name);
  if (accessor.hasVarAltitude()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getVarAltitude(), node, AltitudeReferenceUncertaintyType_Names::VarAltitude_Name);
  }
  if (createNode) {
