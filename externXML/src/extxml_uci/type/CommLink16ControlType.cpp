...
bool CommLink16ControlType::deserialize(const boost::property_tree::ptree& propTree, uci::type::CommLink16ControlType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setDataReductionPG_Index(extxml_uci::util::SerializationHelpers::deserializeUnsignedShort(*value));
      }
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setInitializationActivityIndicator(extxml_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
    } else if (valueType.first == nsPrefix + CommLink16ControlType_Names::InitializationIndexNumber_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setInitializationIndexNumber(extxml_uci::util::SerializationHelpers::deserializeUnsignedByte(*value));
      }
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setNetEntryTxEnable(extxml_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
    } else if (valueType.first == nsPrefix + CommLink16ControlType_Names::PlatformStrength_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setPlatformStrength(extxml_uci::util::SerializationHelpers::deserializeUnsignedByte(*value));
      }
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setRouteEstPG_Index(extxml_uci::util::SerializationHelpers::deserializeUnsignedShort(*value));
      }
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setVoiceGroupRate(extxml_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    } else if (valueType.first == nsPrefix + CommLink16ControlType_Names::VoiceGroupCoding_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setVoiceGroupCoding(extxml_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
    } else if (valueType.first == nsPrefix + CommLink16ControlType_Names::ForceTellIndicator_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setForceTellIndicator(extxml_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
    } else if (valueType.first == nsPrefix + CommLink16ControlType_Names::ResetNavKalmanFilter_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setResetNavKalmanFilter(extxml_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
    } else if (valueType.first == nsPrefix + CommLink16ControlType_Names::IPF_Reset_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setIPF_Reset(extxml_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
...
std::string CommLink16ControlType::serialize(const uci::type::CommLink16ControlType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, CommLink16ControlType_Names::Extern_Type_Name);
  }
  {
  ...
  if (accessor.hasDataReductionPG_Index()) {
    extxml_uci::util::SerializationHelpers::serializeUnsignedShort(accessor.getDataReductionPG_Index(), node, CommLink16ControlType_Names::DataReductionPG_Index_Name);
  }
  {
  ...
  }
  {
    ...
    for (uci::type::CommLink16ControlType::InitialEntryWords::size_type i = 0, end = boundedList.size(); i < end; ++i) {
      extxml_uci::util::SerializationHelpers::serializeInt(boundedList.at(i), node, CommLink16ControlType_Names::InitialEntryWords_Name);
    }
  }
  if (accessor.hasInitializationActivityIndicator()) {
    extxml_uci::util::SerializationHelpers::serializeBoolean(accessor.getInitializationActivityIndicator(), node, CommLink16ControlType_Names::InitializationActivityIndicator_Name);
  }
  if (accessor.hasInitializationIndexNumber()) {
    extxml_uci::util::SerializationHelpers::serializeUnsignedByte(accessor.getInitializationIndexNumber(), node, CommLink16ControlType_Names::InitializationIndexNumber_Name);
  }
  ...
  if (accessor.hasNetEntryTxEnable()) {
    extxml_uci::util::SerializationHelpers::serializeBoolean(accessor.getNetEntryTxEnable(), node, CommLink16ControlType_Names::NetEntryTxEnable_Name);
  }
  if (accessor.hasPlatformStrength()) {
    extxml_uci::util::SerializationHelpers::serializeUnsignedByte(accessor.getPlatformStrength(), node, CommLink16ControlType_Names::PlatformStrength_Name);
  }
  ...
  if (accessor.hasRouteEstPG_Index()) {
    extxml_uci::util::SerializationHelpers::serializeUnsignedShort(accessor.getRouteEstPG_Index(), node, CommLink16ControlType_Names::RouteEstPG_Index_Name);
  }
  {
    ...
    for (uci::type::CommLink16ControlType::SecondarySourceTrackNumber::size_type i = 0, end = boundedList.size(); i < end; ++i) {
      extxml_uci::util::SerializationHelpers::serializeUnsignedShort(boundedList.at(i), node, CommLink16ControlType_Names::SecondarySourceTrackNumber_Name);
    }
  }
  {
  ...
  if (accessor.hasVoiceGroupRate()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getVoiceGroupRate(), node, CommLink16ControlType_Names::VoiceGroupRate_Name);
  }
  if (accessor.hasVoiceGroupCoding()) {
    extxml_uci::util::SerializationHelpers::serializeBoolean(accessor.getVoiceGroupCoding(), node, CommLink16ControlType_Names::VoiceGroupCoding_Name);
  }
  if (accessor.hasForceTellIndicator()) {
    extxml_uci::util::SerializationHelpers::serializeBoolean(accessor.getForceTellIndicator(), node, CommLink16ControlType_Names::ForceTellIndicator_Name);
  }
  if (accessor.hasResetNavKalmanFilter()) {
    extxml_uci::util::SerializationHelpers::serializeBoolean(accessor.getResetNavKalmanFilter(), node, CommLink16ControlType_Names::ResetNavKalmanFilter_Name);
  }
  if (accessor.hasIPF_Reset()) {
    extxml_uci::util::SerializationHelpers::serializeBoolean(accessor.getIPF_Reset(), node, CommLink16ControlType_Names::IPF_Reset_Name);
  }
  if (accessor.hasVoiceCallSign()) {
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getVoiceCallSign(), node, CommLink16ControlType_Names::VoiceCallSign_Name);
  }
  if (createNode) {
