  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setDragCoefficientValue(extxml_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    }
  }
  return true;
...
std::string DragCoefficientChoiceType::serialize(const uci::type::DragCoefficientChoiceType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, DragCoefficientChoiceType_Names::Extern_Type_Name);
  }
  if (accessor.isVCM_DragParameters()) {
    ...
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getDragCoefficientValue(), node, DragCoefficientChoiceType_Names::DragCoefficientValue_Name);
  }
  if (createNode) {
