...
std::string RouteActivityPlanCommandMDT::serialize(const uci::type::RouteActivityPlanCommandMDT& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, RouteActivityPlanCommandMDT_Names::Extern_Type_Name);
  }
  ...
  extxml_uci::util::SerializationHelpers::serializeBoolean(accessor.getForPlanningUseOnly(), node, RouteActivityPlanCommandMDT_Names::ForPlanningUseOnly_Name);
  if (createNode) {
