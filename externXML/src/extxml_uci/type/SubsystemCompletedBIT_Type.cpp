...
std::string SubsystemCompletedBIT_Type::serialize(const uci::type::SubsystemCompletedBIT_Type& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, SubsystemCompletedBIT_Type_Names::Extern_Type_Name);
  }
  BIT_ID_Type::serialize(accessor.getBIT_ID(), node, SubsystemCompletedBIT_Type_Names::BIT_ID_Name);
  extxml_uci::util::SerializationHelpers::serializeDateTime(accessor.getTimetag(), node, SubsystemCompletedBIT_Type_Names::Timetag_Name);
  ...
  if (accessor.hasFailReason()) {
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getFailReason(), node, SubsystemCompletedBIT_Type_Names::FailReason_Name);
  }
  {
