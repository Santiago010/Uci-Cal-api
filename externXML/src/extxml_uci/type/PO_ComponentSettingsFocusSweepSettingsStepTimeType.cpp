  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setNumberOfLines(extxml_uci::util::SerializationHelpers::deserializeUnsignedInt(*value));
      }
    } else if (valueType.first == nsPrefix + PO_ComponentSettingsFocusSweepSettingsStepTimeType_Names::CollectionTime_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setCollectionTime(extxml_uci::util::SerializationHelpers::deserializeDuration(*value));
      }
    }
  }
  return true;
...
std::string PO_ComponentSettingsFocusSweepSettingsStepTimeType::serialize(const uci::type::PO_ComponentSettingsFocusSweepSettingsStepTimeType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, PO_ComponentSettingsFocusSweepSettingsStepTimeType_Names::Extern_Type_Name);
  }
  if (accessor.isNumberOfLines()) {
    extxml_uci::util::SerializationHelpers::serializeUnsignedInt(accessor.getNumberOfLines(), node, PO_ComponentSettingsFocusSweepSettingsStepTimeType_Names::NumberOfLines_Name);
  } else if (accessor.isCollectionTime()) {
    extxml_uci::util::SerializationHelpers::serializeDuration(accessor.getCollectionTime(), node, PO_ComponentSettingsFocusSweepSettingsStepTimeType_Names::CollectionTime_Name);
  }
  if (createNode) {
