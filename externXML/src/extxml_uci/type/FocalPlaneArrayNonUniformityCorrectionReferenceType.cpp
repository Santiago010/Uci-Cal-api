...
bool FocalPlaneArrayNonUniformityCorrectionReferenceType::deserialize(const boost::property_tree::ptree& propTree, uci::type::FocalPlaneArrayNonUniformityCorrectionReferenceType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
...
std::string FocalPlaneArrayNonUniformityCorrectionReferenceType::serialize(const uci::type::FocalPlaneArrayNonUniformityCorrectionReferenceType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, FocalPlaneArrayNonUniformityCorrectionReferenceType_Names::Extern_Type_Name);
  }
