...
std::string Point3D_Type::serialize(const uci::type::Point3D_Type& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool checkIfDerivation, const bool /*topLevel*/) {
  ...
  if (!checkIfDerivation || (accessor.getAccessorType() == uci::type::accessorType::point3D_Type)) {
    ...
    if (addTypeAttribute) {
      extxml_uci::util::SerializationHelpers::addTypeAttribute(node, Point3D_Type_Names::Extern_Type_Name);
    }
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getLatitude(), node, Point3D_Type_Names::Latitude_Name);
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getLongitude(), node, Point3D_Type_Names::Longitude_Name);
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getAltitude(), node, Point3D_Type_Names::Altitude_Name);
    ...
    if (accessor.hasTimestamp()) {
      extxml_uci::util::SerializationHelpers::serializeDateTime(accessor.getTimestamp(), node, Point3D_Type_Names::Timestamp_Name);
    }
    if (createNode) {
