...
std::string PO_ComponentSettingsOutputProductSettingsType::serialize(const uci::type::PO_ComponentSettingsOutputProductSettingsType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, PO_ComponentSettingsOutputProductSettingsType_Names::Extern_Type_Name);
  }
  if (accessor.isProductSettings()) {
    ...
    extxml_uci::util::SerializationHelpers::serializeBoolean(accessor.getAutoOutputProductSettings(), node, PO_ComponentSettingsOutputProductSettingsType_Names::AutoOutputProductSettings_Name);
  }
  if (createNode) {
