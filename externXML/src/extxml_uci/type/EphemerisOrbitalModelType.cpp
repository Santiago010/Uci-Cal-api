...
bool EphemerisOrbitalModelType::deserialize(const boost::property_tree::ptree& propTree, uci::type::EphemerisOrbitalModelType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setSolarRadiationPressureCoefficient(extxml_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
...
std::string EphemerisOrbitalModelType::serialize(const uci::type::EphemerisOrbitalModelType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, EphemerisOrbitalModelType_Names::Extern_Type_Name);
  }
  ...
  if (accessor.hasStepSize()) {
    extxml_uci::util::SerializationHelpers::serializeDuration(accessor.getStepSize(), node, EphemerisOrbitalModelType_Names::StepSize_Name);
  }
  if (accessor.hasSolarRadiationPressureCoefficient()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getSolarRadiationPressureCoefficient(), node, EphemerisOrbitalModelType_Names::SolarRadiationPressureCoefficient_Name);
  }
  if (accessor.hasBallisticCoefficient()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getBallisticCoefficient(), node, EphemerisOrbitalModelType_Names::BallisticCoefficient_Name);
  }
  if (createNode) {
