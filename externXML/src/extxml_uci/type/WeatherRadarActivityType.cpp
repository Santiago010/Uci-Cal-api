...
std::string WeatherRadarActivityType::serialize(const uci::type::WeatherRadarActivityType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, WeatherRadarActivityType_Names::Extern_Type_Name);
  }
  ...
  if (accessor.hasPolicyApplied()) {
    extxml_uci::util::SerializationHelpers::serializeBoolean(accessor.getPolicyApplied(), node, WeatherRadarActivityType_Names::PolicyApplied_Name);
  }
  extxml_uci::util::SerializationHelpers::serializeBoolean(accessor.getAllProductsAndMessagesProduced(), node, WeatherRadarActivityType_Names::AllProductsAndMessagesProduced_Name);
  {
