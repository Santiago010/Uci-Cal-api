  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setQualifiedSpecial(extxml_uci::util::SerializationHelpers::deserializeUnsignedShort(*value));
      }
...
std::string QualifyingTagsType::serialize(const uci::type::QualifyingTagsType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, QualifyingTagsType_Names::Extern_Type_Name);
  }
  if (accessor.hasQualifiedSpecial()) {
    extxml_uci::util::SerializationHelpers::serializeUnsignedShort(accessor.getQualifiedSpecial(), node, QualifyingTagsType_Names::QualifiedSpecial_Name);
  }
  if (accessor.hasProcessSpecial()) {
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getProcessSpecial(), node, QualifyingTagsType_Names::ProcessSpecial_Name);
  }
  if (accessor.hasFilterOverride()) {
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getFilterOverride(), node, QualifyingTagsType_Names::FilterOverride_Name);
  }
  if (accessor.hasHighInterest()) {
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getHighInterest(), node, QualifyingTagsType_Names::HighInterest_Name);
  }
  if (accessor.hasRetain()) {
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getRetain(), node, QualifyingTagsType_Names::Retain_Name);
  }
