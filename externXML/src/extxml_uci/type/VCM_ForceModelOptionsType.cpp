  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setIsLunarSolarOn(extxml_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
    } else if (valueType.first == nsPrefix + VCM_ForceModelOptionsType_Names::IsSolarRadiationPressureOn_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setIsSolarRadiationPressureOn(extxml_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
    } else if (valueType.first == nsPrefix + VCM_ForceModelOptionsType_Names::IsInTrackThrustOn_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setIsInTrackThrustOn(extxml_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
    } else if (valueType.first == nsPrefix + VCM_ForceModelOptionsType_Names::InTrackThrustAcceleration_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setInTrackThrustAcceleration(extxml_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    } else if (valueType.first == nsPrefix + VCM_ForceModelOptionsType_Names::CenterOfMassOffset_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setCenterOfMassOffset(extxml_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    }
  }
  return true;
...
std::string VCM_ForceModelOptionsType::serialize(const uci::type::VCM_ForceModelOptionsType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, VCM_ForceModelOptionsType_Names::Extern_Type_Name);
  }
  extxml_uci::util::SerializationHelpers::serializeBoolean(accessor.getIsLunarSolarOn(), node, VCM_ForceModelOptionsType_Names::IsLunarSolarOn_Name);
  extxml_uci::util::SerializationHelpers::serializeBoolean(accessor.getIsSolarRadiationPressureOn(), node, VCM_ForceModelOptionsType_Names::IsSolarRadiationPressureOn_Name);
  extxml_uci::util::SerializationHelpers::serializeBoolean(accessor.getIsInTrackThrustOn(), node, VCM_ForceModelOptionsType_Names::IsInTrackThrustOn_Name);
  if (accessor.hasInTrackThrustAcceleration()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getInTrackThrustAcceleration(), node, VCM_ForceModelOptionsType_Names::InTrackThrustAcceleration_Name);
  }
  if (accessor.hasCenterOfMassOffset()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getCenterOfMassOffset(), node, VCM_ForceModelOptionsType_Names::CenterOfMassOffset_Name);
  }
  if (createNode) {
