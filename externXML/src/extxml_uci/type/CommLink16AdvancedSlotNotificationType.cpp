...
bool CommLink16AdvancedSlotNotificationType::deserialize(const boost::property_tree::ptree& propTree, uci::type::CommLink16AdvancedSlotNotificationType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setASN_SlotModeEnabled(extxml_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
    } else if (valueType.first == nsPrefix + CommLink16AdvancedSlotNotificationType_Names::ASN_SlotSelection_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setASN_SlotSelection(extxml_uci::util::SerializationHelpers::deserializeUnsignedByte(*value));
      }
    }
  }
  return true;
...
std::string CommLink16AdvancedSlotNotificationType::serialize(const uci::type::CommLink16AdvancedSlotNotificationType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, CommLink16AdvancedSlotNotificationType_Names::Extern_Type_Name);
  }
  ...
  extxml_uci::util::SerializationHelpers::serializeBoolean(accessor.getASN_SlotModeEnabled(), node, CommLink16AdvancedSlotNotificationType_Names::ASN_SlotModeEnabled_Name);
  extxml_uci::util::SerializationHelpers::serializeUnsignedByte(accessor.getASN_SlotSelection(), node, CommLink16AdvancedSlotNotificationType_Names::ASN_SlotSelection_Name);
  if (createNode) {
