  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setNearRealTimeProduct(extxml_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
    }
  }
  return true;
...
std::string AllowableSensorsType::serialize(const uci::type::AllowableSensorsType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, AllowableSensorsType_Names::Extern_Type_Name);
  }
  ...
  if (accessor.hasNearRealTimeProduct()) {
    extxml_uci::util::SerializationHelpers::serializeBoolean(accessor.getNearRealTimeProduct(), node, AllowableSensorsType_Names::NearRealTimeProduct_Name);
  }
  if (createNode) {
