...
bool FusionSettingsMDT::deserialize(const boost::property_tree::ptree& propTree, uci::type::FusionSettingsMDT& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        ...
        EntityStalenessThresholdsType::deserialize(valueType.second, boundedList.at(boundedListSize), nodeName, nsPrefix);
      }
...
std::string FusionSettingsMDT::serialize(const uci::type::FusionSettingsMDT& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, FusionSettingsMDT_Names::Extern_Type_Name);
  }
  ...
  ServiceID_Type::serialize(accessor.getServiceID(), node, FusionSettingsMDT_Names::ServiceID_Name);
  {
    ...
    for (uci::type::FusionSettingsMDT::StalenessThresholds::size_type i = 0, end = boundedList.size(); i < end; ++i) {
      EntityStalenessThresholdsType::serialize(boundedList.at(i), node, FusionSettingsMDT_Names::StalenessThresholds_Name);
    }
  }
  ...
  }
  {
    ...
    for (uci::type::FusionSettingsMDT::InputSource::size_type i = 0, end = boundedList.size(); i < end; ++i) {
      FusionSourceType::serialize(boundedList.at(i), node, FusionSettingsMDT_Names::InputSource_Name);
    }
  }
  if (createNode) {
