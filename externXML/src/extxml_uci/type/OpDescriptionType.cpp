...
std::string OpDescriptionType::serialize(const uci::type::OpDescriptionType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, OpDescriptionType_Names::Extern_Type_Name);
  }
  if (accessor.hasName()) {
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getName(), node, OpDescriptionType_Names::Name_Name);
  }
  if (accessor.hasRemarks()) {
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getRemarks(), node, OpDescriptionType_Names::Remarks_Name);
  }
  if (createNode) {
