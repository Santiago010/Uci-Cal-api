...
std::string VehicleUniqueIdentifierType::serialize(const uci::type::VehicleUniqueIdentifierType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, VehicleUniqueIdentifierType_Names::Extern_Type_Name);
  }
  if (accessor.isAIS()) {
    AIS_Type::serialize(accessor.getAIS(), node, VehicleUniqueIdentifierType_Names::AIS_Name);
  } else if (accessor.isTailNumber()) {
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getTailNumber(), node, VehicleUniqueIdentifierType_Names::TailNumber_Name);
    ...
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getAlternateIdentifier(), node, VehicleUniqueIdentifierType_Names::AlternateIdentifier_Name);
  }
  if (createNode) {
