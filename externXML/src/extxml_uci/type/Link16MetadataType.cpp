...
bool Link16MetadataType::deserialize(const boost::property_tree::ptree& propTree, uci::type::Link16MetadataType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setAirborne(extxml_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
    } else if (valueType.first == nsPrefix + Link16MetadataType_Names::ControlChannel_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setControlChannel(extxml_uci::util::SerializationHelpers::deserializeUnsignedByte(*value));
      }
    } else if (valueType.first == nsPrefix + Link16MetadataType_Names::FlightLeadIndicator_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setFlightLeadIndicator(extxml_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setMissionCommanderIndicator(extxml_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
    } else if (valueType.first == nsPrefix + Link16MetadataType_Names::PrecisionTime_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setPrecisionTime(extxml_uci::util::SerializationHelpers::deserializeDateTime(*value));
      }
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setRadarChannel(extxml_uci::util::SerializationHelpers::deserializeUnsignedByte(*value));
      }
    } else if (valueType.first == nsPrefix + Link16MetadataType_Names::MissileChannel_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setMissileChannel(extxml_uci::util::SerializationHelpers::deserializeUnsignedByte(*value));
      }
...
std::string Link16MetadataType::serialize(const uci::type::Link16MetadataType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, Link16MetadataType_Names::Extern_Type_Name);
  }
  ...
  if (accessor.hasSourceTrack()) {
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getSourceTrack(), node, Link16MetadataType_Names::SourceTrack_Name);
  }
  ...
  if (accessor.hasAirborne()) {
    extxml_uci::util::SerializationHelpers::serializeBoolean(accessor.getAirborne(), node, Link16MetadataType_Names::Airborne_Name);
  }
  if (accessor.hasControlChannel()) {
    extxml_uci::util::SerializationHelpers::serializeUnsignedByte(accessor.getControlChannel(), node, Link16MetadataType_Names::ControlChannel_Name);
  }
  if (accessor.hasFlightLeadIndicator()) {
    extxml_uci::util::SerializationHelpers::serializeBoolean(accessor.getFlightLeadIndicator(), node, Link16MetadataType_Names::FlightLeadIndicator_Name);
  }
  ...
  if (accessor.hasMissionCommanderIndicator()) {
    extxml_uci::util::SerializationHelpers::serializeBoolean(accessor.getMissionCommanderIndicator(), node, Link16MetadataType_Names::MissionCommanderIndicator_Name);
  }
  if (accessor.hasPrecisionTime()) {
    extxml_uci::util::SerializationHelpers::serializeDateTime(accessor.getPrecisionTime(), node, Link16MetadataType_Names::PrecisionTime_Name);
  }
  ...
  if (accessor.hasRadarChannel()) {
    extxml_uci::util::SerializationHelpers::serializeUnsignedByte(accessor.getRadarChannel(), node, Link16MetadataType_Names::RadarChannel_Name);
  }
  if (accessor.hasMissileChannel()) {
    extxml_uci::util::SerializationHelpers::serializeUnsignedByte(accessor.getMissileChannel(), node, Link16MetadataType_Names::MissileChannel_Name);
  }
  {
