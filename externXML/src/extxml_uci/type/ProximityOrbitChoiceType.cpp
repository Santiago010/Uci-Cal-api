...
std::string ProximityOrbitChoiceType::serialize(const uci::type::ProximityOrbitChoiceType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, ProximityOrbitChoiceType_Names::Extern_Type_Name);
  }
  if (accessor.isNaturalMotion()) {
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getNaturalMotion(), node, ProximityOrbitChoiceType_Names::NaturalMotion_Name);
  } else if (accessor.isForcedMotion()) {
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getForcedMotion(), node, ProximityOrbitChoiceType_Names::ForcedMotion_Name);
