  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setPercentageOfFragmentation(extxml_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    } else if (valueType.first == nsPrefix + OrbitObjectBreakupType_Names::TotalEnergy_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setTotalEnergy(extxml_uci::util::SerializationHelpers::deserializeFloat(*value));
      }
...
std::string OrbitObjectBreakupType::serialize(const uci::type::OrbitObjectBreakupType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, OrbitObjectBreakupType_Names::Extern_Type_Name);
  }
  ...
  if (accessor.hasPercentageOfFragmentation()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getPercentageOfFragmentation(), node, OrbitObjectBreakupType_Names::PercentageOfFragmentation_Name);
  }
  if (accessor.hasTotalEnergy()) {
    extxml_uci::util::SerializationHelpers::serializeFloat(accessor.getTotalEnergy(), node, OrbitObjectBreakupType_Names::TotalEnergy_Name);
  }
  if (accessor.hasPercentileCloudBoundary()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getPercentileCloudBoundary(), node, OrbitObjectBreakupType_Names::PercentileCloudBoundary_Name);
  }
  if (createNode) {
