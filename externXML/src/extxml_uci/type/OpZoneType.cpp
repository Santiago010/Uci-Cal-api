...
bool OpZoneType::deserialize(const boost::property_tree::ptree& propTree, uci::type::OpZoneType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
...
std::string OpZoneType::serialize(const uci::type::OpZoneType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, OpZoneType_Names::Extern_Type_Name);
  }
