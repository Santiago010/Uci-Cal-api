  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setTargetRotationalPeriods(extxml_uci::util::SerializationHelpers::deserializeInt(*value));
      }
...
std::string OrbitalSurveillanceSensorMinimumCollectionRequirementsType::serialize(const uci::type::OrbitalSurveillanceSensorMinimumCollectionRequirementsType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, OrbitalSurveillanceSensorMinimumCollectionRequirementsType_Names::Extern_Type_Name);
  }
  if (accessor.isTargetRotationalPeriods()) {
    extxml_uci::util::SerializationHelpers::serializeInt(accessor.getTargetRotationalPeriods(), node, OrbitalSurveillanceSensorMinimumCollectionRequirementsType_Names::TargetRotationalPeriods_Name);
  } else if (accessor.isTime()) {
    extxml_uci::util::SerializationHelpers::serializeDuration(accessor.getTime(), node, OrbitalSurveillanceSensorMinimumCollectionRequirementsType_Names::Time_Name);
  }
  if (createNode) {
