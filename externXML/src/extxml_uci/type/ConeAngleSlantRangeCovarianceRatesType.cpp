  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setCosconeY_SlantRangeRate(extxml_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    } else if (valueType.first == nsPrefix + ConeAngleSlantRangeCovarianceRatesType_Names::CosconeZ_SlantRangeRate_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setCosconeZ_SlantRangeRate(extxml_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    } else if (valueType.first == nsPrefix + ConeAngleSlantRangeCovarianceRatesType_Names::SlantRangeCosconeY_Rate_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setSlantRangeCosconeY_Rate(extxml_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    } else if (valueType.first == nsPrefix + ConeAngleSlantRangeCovarianceRatesType_Names::SlantRangeCosconeZ_Rate_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setSlantRangeCosconeZ_Rate(extxml_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    }
  }
  return true;
...
std::string ConeAngleSlantRangeCovarianceRatesType::serialize(const uci::type::ConeAngleSlantRangeCovarianceRatesType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, ConeAngleSlantRangeCovarianceRatesType_Names::Extern_Type_Name);
  }
  if (accessor.hasCosconeY_SlantRangeRate()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getCosconeY_SlantRangeRate(), node, ConeAngleSlantRangeCovarianceRatesType_Names::CosconeY_SlantRangeRate_Name);
  }
  if (accessor.hasCosconeZ_SlantRangeRate()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getCosconeZ_SlantRangeRate(), node, ConeAngleSlantRangeCovarianceRatesType_Names::CosconeZ_SlantRangeRate_Name);
  }
  if (accessor.hasSlantRangeCosconeY_Rate()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getSlantRangeCosconeY_Rate(), node, ConeAngleSlantRangeCovarianceRatesType_Names::SlantRangeCosconeY_Rate_Name);
  }
  if (accessor.hasSlantRangeCosconeZ_Rate()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getSlantRangeCosconeZ_Rate(), node, ConeAngleSlantRangeCovarianceRatesType_Names::SlantRangeCosconeZ_Rate_Name);
  }
  if (createNode) {
