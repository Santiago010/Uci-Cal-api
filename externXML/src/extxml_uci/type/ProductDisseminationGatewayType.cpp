...
bool ProductDisseminationGatewayType::deserialize(const boost::property_tree::ptree& propTree, uci::type::ProductDisseminationGatewayType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      extxml_uci::util::DerivedTypesDeserializer::deserialize(valueType.second, accessor.enableDataLinkNativeInfo(extxml_uci::util::SerializationHelpers::checkForTypeAttribute(valueType.second, nsPrefix)), nodeName, nsPrefix);
    }
  }
  return true;
}
...
std::string ProductDisseminationGatewayType::serialize(const uci::type::ProductDisseminationGatewayType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, ProductDisseminationGatewayType_Names::Extern_Type_Name);
  }
  if (accessor.hasAddress()) {
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getAddress(), node, ProductDisseminationGatewayType_Names::Address_Name);
  }
