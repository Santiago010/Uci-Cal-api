...
bool SlantRangeVarianceType::deserialize(const boost::property_tree::ptree& propTree, uci::type::SlantRangeVarianceType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
...
std::string SlantRangeVarianceType::serialize(const uci::type::SlantRangeVarianceType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, SlantRangeVarianceType_Names::Extern_Type_Name);
  }
  if (accessor.hasSlantRange()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getSlantRange(), node, SlantRangeVarianceType_Names::SlantRange_Name);
  }
