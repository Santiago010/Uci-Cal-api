...
bool EthernetSettingsType::deserialize(const boost::property_tree::ptree& propTree, uci::type::EthernetSettingsType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
...
std::string EthernetSettingsType::serialize(const uci::type::EthernetSettingsType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, EthernetSettingsType_Names::Extern_Type_Name);
  }
  if (accessor.isIPv4()) {
