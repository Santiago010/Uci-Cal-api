...
bool AtomicEnergyMarkingsChoiceType::deserialize(const boost::property_tree::ptree& propTree, uci::type::AtomicEnergyMarkingsChoiceType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
...
std::string AtomicEnergyMarkingsChoiceType::serialize(const uci::type::AtomicEnergyMarkingsChoiceType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, AtomicEnergyMarkingsChoiceType_Names::Extern_Type_Name);
  }
