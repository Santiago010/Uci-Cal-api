...
bool MetricValueType::deserialize(const boost::property_tree::ptree& propTree, uci::type::MetricValueType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      extxml_uci::util::DerivedTypesDeserializer::deserialize(valueType.second, accessor.enableMetricIdentifier(extxml_uci::util::SerializationHelpers::checkForTypeAttribute(valueType.second, nsPrefix)), nodeName, nsPrefix);
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setWeight(extxml_uci::util::SerializationHelpers::deserializeFloat(*value));
      }
    } else if (valueType.first == nsPrefix + MetricValueType_Names::Value_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setValue(extxml_uci::util::SerializationHelpers::deserializeFloat(*value));
      }
    }
  }
  return true;
...
std::string MetricValueType::serialize(const uci::type::MetricValueType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, MetricValueType_Names::Extern_Type_Name);
  }
  ...
  if (accessor.hasDescriptionOfMetric()) {
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getDescriptionOfMetric(), node, MetricValueType_Names::DescriptionOfMetric_Name);
  }
  ...
  extxml_uci::util::SerializationHelpers::serializeFloat(accessor.getWeight(), node, MetricValueType_Names::Weight_Name);
  extxml_uci::util::SerializationHelpers::serializeFloat(accessor.getValue(), node, MetricValueType_Names::Value_Name);
  if (createNode) {
