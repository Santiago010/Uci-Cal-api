...
std::string ParameterValueType::serialize(const uci::type::ParameterValueType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, ParameterValueType_Names::Extern_Type_Name);
  }
  if (accessor.isValue()) {
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getValue(), node, ParameterValueType_Names::Value_Name);
  } else if (accessor.isReturnToDefault()) {
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getReturnToDefault(), node, ParameterValueType_Names::ReturnToDefault_Name);
  }
  if (createNode) {
