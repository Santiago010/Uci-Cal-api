...
bool StoreCommandType::deserialize(const boost::property_tree::ptree& propTree, uci::type::StoreCommandType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      extxml_uci::util::DerivedTypesDeserializer::deserialize(valueType.second, accessor.chooseNextStoreStation(extxml_uci::util::SerializationHelpers::checkForTypeAttribute(valueType.second, nsPrefix)), nodeName, nsPrefix);
    } else if (valueType.first == nsPrefix + StoreCommandType_Names::NextStoreType_Name) {
      extxml_uci::util::DerivedTypesDeserializer::deserialize(valueType.second, accessor.chooseNextStoreType(extxml_uci::util::SerializationHelpers::checkForTypeAttribute(valueType.second, nsPrefix)), nodeName, nsPrefix);
    } else if (valueType.first == nsPrefix + StoreCommandType_Names::OverrideLAR_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setOverrideLAR(extxml_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
    } else if (valueType.first == nsPrefix + StoreCommandType_Names::OverrideAttitudeConstraints_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setOverrideAttitudeConstraints(extxml_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setLAR_CalculationWindHold(extxml_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
    } else if (valueType.first == nsPrefix + StoreCommandType_Names::LAR_CalculationWindOverride_Name) {
      extxml_uci::util::DerivedTypesDeserializer::deserialize(valueType.second, accessor.chooseLAR_CalculationWindOverride(extxml_uci::util::SerializationHelpers::checkForTypeAttribute(valueType.second, nsPrefix)), nodeName, nsPrefix);
...
std::string StoreCommandType::serialize(const uci::type::StoreCommandType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, StoreCommandType_Names::Extern_Type_Name);
  }
  if (accessor.isNextStoreStation()) {
    ...
    extxml_uci::util::SerializationHelpers::serializeBoolean(accessor.getOverrideLAR(), node, StoreCommandType_Names::OverrideLAR_Name);
  } else if (accessor.isOverrideAttitudeConstraints()) {
    extxml_uci::util::SerializationHelpers::serializeBoolean(accessor.getOverrideAttitudeConstraints(), node, StoreCommandType_Names::OverrideAttitudeConstraints_Name);
  } else if (accessor.isMasterArm()) {
    extxml_uci::util::SerializationHelpers::serializeBoolean(accessor.getMasterArm(), node, StoreCommandType_Names::MasterArm_Name);
    ...
    extxml_uci::util::SerializationHelpers::serializeBoolean(accessor.getLAR_CalculationWindHold(), node, StoreCommandType_Names::LAR_CalculationWindHold_Name);
    ...
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getVerifyInventory(), node, StoreCommandType_Names::VerifyInventory_Name);
  }
  if (createNode) {
