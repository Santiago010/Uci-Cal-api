...
std::string CivilPathTerminatorType::serialize(const uci::type::CivilPathTerminatorType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, CivilPathTerminatorType_Names::Extern_Type_Name);
  }
  if (accessor.isAF_ArcToFix()) {
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getAF_ArcToFix(), node, CivilPathTerminatorType_Names::AF_ArcToFix_Name);
  } else if (accessor.isCA_CourseToAltitude()) {
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getCA_CourseToAltitude(), node, CivilPathTerminatorType_Names::CA_CourseToAltitude_Name);
  } else if (accessor.isCD_CourseToDMEDistance()) {
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getCD_CourseToDMEDistance(), node, CivilPathTerminatorType_Names::CD_CourseToDMEDistance_Name);
    ...
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getCI_CourseToIntercept(), node, CivilPathTerminatorType_Names::CI_CourseToIntercept_Name);
  } else if (accessor.isCR_CourseToRadial()) {
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getCR_CourseToRadial(), node, CivilPathTerminatorType_Names::CR_CourseToRadial_Name);
  } else if (accessor.isDF_DirectToFix()) {
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getDF_DirectToFix(), node, CivilPathTerminatorType_Names::DF_DirectToFix_Name);
  } else if (accessor.isFA_TrackToAltitude()) {
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getFA_TrackToAltitude(), node, CivilPathTerminatorType_Names::FA_TrackToAltitude_Name);
  } else if (accessor.isFC_TrackFromFixToDistanceAlongTrack()) {
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getFC_TrackFromFixToDistanceAlongTrack(), node, CivilPathTerminatorType_Names::FC_TrackFromFixToDistanceAlongTrack_Name);
  } else if (accessor.isFD_TrackFromFixToDMEDistance()) {
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getFD_TrackFromFixToDMEDistance(), node, CivilPathTerminatorType_Names::FD_TrackFromFixToDMEDistance_Name);
  } else if (accessor.isFM_FixToManualTermination()) {
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getFM_FixToManualTermination(), node, CivilPathTerminatorType_Names::FM_FixToManualTermination_Name);
  } else if (accessor.isHA_HoldingWithAltitudeTermination()) {
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getHA_HoldingWithAltitudeTermination(), node, CivilPathTerminatorType_Names::HA_HoldingWithAltitudeTermination_Name);
  } else if (accessor.isHF_HoldingWithFixTermination()) {
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getHF_HoldingWithFixTermination(), node, CivilPathTerminatorType_Names::HF_HoldingWithFixTermination_Name);
  } else if (accessor.isHM_HoldingWithManualTermination()) {
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getHM_HoldingWithManualTermination(), node, CivilPathTerminatorType_Names::HM_HoldingWithManualTermination_Name);
  } else if (accessor.isIF_InitialFix()) {
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getIF_InitialFix(), node, CivilPathTerminatorType_Names::IF_InitialFix_Name);
  } else if (accessor.isPI_ProcedureTurnToIntercept()) {
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getPI_ProcedureTurnToIntercept(), node, CivilPathTerminatorType_Names::PI_ProcedureTurnToIntercept_Name);
    ...
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getTF_TrackToFix(), node, CivilPathTerminatorType_Names::TF_TrackToFix_Name);
  } else if (accessor.isVA_HeadingToAltitude()) {
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getVA_HeadingToAltitude(), node, CivilPathTerminatorType_Names::VA_HeadingToAltitude_Name);
  } else if (accessor.isVD_HeadingToDMEDistanceTermination()) {
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getVD_HeadingToDMEDistanceTermination(), node, CivilPathTerminatorType_Names::VD_HeadingToDMEDistanceTermination_Name);
  } else if (accessor.isVI_HeadingToIntercept()) {
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getVI_HeadingToIntercept(), node, CivilPathTerminatorType_Names::VI_HeadingToIntercept_Name);
  } else if (accessor.isVM_HeadingToManual()) {
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getVM_HeadingToManual(), node, CivilPathTerminatorType_Names::VM_HeadingToManual_Name);
  } else if (accessor.isVR_HeadingToRadialTermination()) {
    extxml_uci::util::SerializationHelpers::serializeString(accessor.getVR_HeadingToRadialTermination(), node, CivilPathTerminatorType_Names::VR_HeadingToRadialTermination_Name);
  }
  if (createNode) {
