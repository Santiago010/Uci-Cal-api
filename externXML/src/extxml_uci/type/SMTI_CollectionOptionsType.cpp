  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setTracking(extxml_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
...
std::string SMTI_CollectionOptionsType::serialize(const uci::type::SMTI_CollectionOptionsType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, SMTI_CollectionOptionsType_Names::Extern_Type_Name);
  }
  RadarCollectionOptionsType::serialize(accessor, node, "", false, false, false);
  if (accessor.hasTracking()) {
    extxml_uci::util::SerializationHelpers::serializeBoolean(accessor.getTracking(), node, SMTI_CollectionOptionsType_Names::Tracking_Name);
  }
  if (accessor.hasFTI()) {
    extxml_uci::util::SerializationHelpers::serializeBoolean(accessor.getFTI(), node, SMTI_CollectionOptionsType_Names::FTI_Name);
  }
  ...
  if (accessor.hasSignalToNoiseRatio()) {
    extxml_uci::util::SerializationHelpers::serializeDouble(accessor.getSignalToNoiseRatio(), node, SMTI_CollectionOptionsType_Names::SignalToNoiseRatio_Name);
  }
