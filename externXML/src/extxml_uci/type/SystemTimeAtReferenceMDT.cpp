  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if ((valueType.first == "<xmlattr>") && topLevel) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setSystemTimeAtLastReference(extxml_uci::util::SerializationHelpers::deserializeDateTime(*value));
      }
    } else if (valueType.first == nsPrefix + SystemTimeAtReferenceMDT_Names::CurrentSystemTime_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setCurrentSystemTime(extxml_uci::util::SerializationHelpers::deserializeDateTime(*value));
      }
    } else if (valueType.first == nsPrefix + SystemTimeAtReferenceMDT_Names::CurrentZuluTime_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setCurrentZuluTime(extxml_uci::util::SerializationHelpers::deserializeDateTime(*value));
      }
    }
  }
  return true;
...
std::string SystemTimeAtReferenceMDT::serialize(const uci::type::SystemTimeAtReferenceMDT& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extxml_uci::util::SerializationHelpers::addTypeAttribute(node, SystemTimeAtReferenceMDT_Names::Extern_Type_Name);
  }
  extxml_uci::util::SerializationHelpers::serializeDateTime(accessor.getSystemTimeAtLastReference(), node, SystemTimeAtReferenceMDT_Names::SystemTimeAtLastReference_Name);
  if (accessor.hasCurrentSystemTime()) {
    extxml_uci::util::SerializationHelpers::serializeDateTime(accessor.getCurrentSystemTime(), node, SystemTimeAtReferenceMDT_Names::CurrentSystemTime_Name);
  }
  if (accessor.hasCurrentZuluTime()) {
    extxml_uci::util::SerializationHelpers::serializeDateTime(accessor.getCurrentZuluTime(), node, SystemTimeAtReferenceMDT_Names::CurrentZuluTime_Name);
  }
  if (createNode) {
