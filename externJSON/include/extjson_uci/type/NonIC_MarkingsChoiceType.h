...
#ifndef EXTJSON_UCI_TYPE_NONIC_MARKINGSCHOICETYPE_H
#define EXTJSON_UCI_TYPE_NONIC_MARKINGSCHOICETYPE_H
...
public:
  /** 
    ...
    * @return .
    */
  static bool deserialize(const boost::property_tree::ptree& propTree, uci::type::NonIC_MarkingsChoiceType& accessor, std::string& nodeName, std::string& nsPrefix, bool topLevel = false);
...
#endif // EXTJSON_UCI_TYPE_NONIC_MARKINGSCHOICETYPE_H
