...
#ifndef EXTJSON_UCI_TYPE_TASKTYPE_H
#define EXTJSON_UCI_TYPE_TASKTYPE_H
...
public:
  /** 
    ...
    * @return .
    */
  static bool deserialize(const boost::property_tree::ptree& propTree, uci::type::TaskType& accessor, std::string& nodeName, std::string& nsPrefix, bool topLevel = false);
...
#endif // EXTJSON_UCI_TYPE_TASKTYPE_H
