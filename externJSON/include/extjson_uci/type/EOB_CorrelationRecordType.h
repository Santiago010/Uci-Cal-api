...
#ifndef EXTJSON_UCI_TYPE_EOB_CORRELATIONRECORDTYPE_H
#define EXTJSON_UCI_TYPE_EOB_CORRELATIONRECORDTYPE_H
...
public:
  /** 
    ...
    * @return .
    */
  static bool deserialize(const boost::property_tree::ptree& propTree, uci::type::EOB_CorrelationRecordType& accessor, std::string& nodeName, std::string& nsPrefix, bool topLevel = false);
...
#endif // EXTJSON_UCI_TYPE_EOB_CORRELATIONRECORDTYPE_H
