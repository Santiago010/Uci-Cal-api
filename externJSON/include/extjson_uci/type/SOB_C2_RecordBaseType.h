...
#ifndef EXTJSON_UCI_TYPE_SOB_C2_RECORDBASETYPE_H
#define EXTJSON_UCI_TYPE_SOB_C2_RECORDBASETYPE_H
...
public:
  /** 
    ...
    * @return .
    */
  static bool deserialize(const boost::property_tree::ptree& propTree, uci::type::SOB_C2_RecordBaseType& accessor, std::string& nodeName, std::string& nsPrefix, bool topLevel = false);
...
#endif // EXTJSON_UCI_TYPE_SOB_C2_RECORDBASETYPE_H
