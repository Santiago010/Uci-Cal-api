...
#ifndef EXTJSON_UCI_TYPE_PO_COLLECTIONCONSTRAINTSSTATUSTYPE_H
#define EXTJSON_UCI_TYPE_PO_COLLECTIONCONSTRAINTSSTATUSTYPE_H
...
public:
  /** 
    ...
    * @return .
    */
  static bool deserialize(const boost::property_tree::ptree& propTree, uci::type::PO_CollectionConstraintsStatusType& accessor, std::string& nodeName, std::string& nsPrefix, bool topLevel = false);
...
#endif // EXTJSON_UCI_TYPE_PO_COLLECTIONCONSTRAINTSSTATUSTYPE_H
