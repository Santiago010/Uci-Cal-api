...
#ifndef EXTJSON_UCI_TYPE_CS_SENSORDATATYPE_H
#define EXTJSON_UCI_TYPE_CS_SENSORDATATYPE_H
...
public:
  /** 
    ...
    * @return .
    */
  static bool deserialize(const boost::property_tree::ptree& propTree, uci::type::CS_SensorDataType& accessor, std::string& nodeName, std::string& nsPrefix, bool topLevel = false);
...
#endif // EXTJSON_UCI_TYPE_CS_SENSORDATATYPE_H
