...
#ifndef EXTJSON_UCI_TYPE_CS_SIGNALTYPE_H
#define EXTJSON_UCI_TYPE_CS_SIGNALTYPE_H
...
public:
  /** 
    ...
    * @return .
    */
  static bool deserialize(const boost::property_tree::ptree& propTree, uci::type::CS_SignalType& accessor, std::string& nodeName, std::string& nsPrefix, bool topLevel = false);
...
#endif // EXTJSON_UCI_TYPE_CS_SIGNALTYPE_H
