...
#ifndef EXTJSON_UCI_TYPE_LINK16ENTITYDATALINKNATIVEFILTERTYPE_H
#define EXTJSON_UCI_TYPE_LINK16ENTITYDATALINKNATIVEFILTERTYPE_H
...
class Link16EntityDataLinkNativeFilterType;
...
public:
  /** 
    ...
    * @return .
    */
  static bool deserialize(const boost::property_tree::ptree& propTree, uci::type::Link16EntityDataLinkNativeFilterType& accessor, std::string& nodeName, std::string& nsPrefix, bool topLevel = false);
...
#endif // EXTJSON_UCI_TYPE_LINK16ENTITYDATALINKNATIVEFILTERTYPE_H
