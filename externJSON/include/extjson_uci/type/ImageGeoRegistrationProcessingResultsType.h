...
#ifndef EXTJSON_UCI_TYPE_IMAGEGEOREGISTRATIONPROCESSINGRESULTSTYPE_H
#define EXTJSON_UCI_TYPE_IMAGEGEOREGISTRATIONPROCESSINGRESULTSTYPE_H
...
class ImageGeoRegistrationProcessingResultsType;
...
public:
  /** 
    ...
    * @return .
    */
  static bool deserialize(const boost::property_tree::ptree& propTree, uci::type::ImageGeoRegistrationProcessingResultsType& accessor, std::string& nodeName, std::string& nsPrefix, bool topLevel = false);
...
#endif // EXTJSON_UCI_TYPE_IMAGEGEOREGISTRATIONPROCESSINGRESULTSTYPE_H
