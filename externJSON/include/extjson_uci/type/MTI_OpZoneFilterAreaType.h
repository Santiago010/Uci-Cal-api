...
#ifndef EXTJSON_UCI_TYPE_MTI_OPZONEFILTERAREATYPE_H
#define EXTJSON_UCI_TYPE_MTI_OPZONEFILTERAREATYPE_H
...
class MTI_OpZoneFilterAreaType;
...
public:
  /** 
    ...
    * @return .
    */
  static bool deserialize(const boost::property_tree::ptree& propTree, uci::type::MTI_OpZoneFilterAreaType& accessor, std::string& nodeName, std::string& nsPrefix, bool topLevel = false);
...
#endif // EXTJSON_UCI_TYPE_MTI_OPZONEFILTERAREATYPE_H
