...
#ifndef EXTJSON_UCI_TYPE_COMMMADL_COMMWAVEFORMACTIVITYTYPE_H
#define EXTJSON_UCI_TYPE_COMMMADL_COMMWAVEFORMACTIVITYTYPE_H
...
class CommMADL_CommWaveformActivityType;
...
public:
  /** 
    ...
    * @return .
    */
  static bool deserialize(const boost::property_tree::ptree& propTree, uci::type::CommMADL_CommWaveformActivityType& accessor, std::string& nodeName, std::string& nsPrefix, bool topLevel = false);
...
#endif // EXTJSON_UCI_TYPE_COMMMADL_COMMWAVEFORMACTIVITYTYPE_H
