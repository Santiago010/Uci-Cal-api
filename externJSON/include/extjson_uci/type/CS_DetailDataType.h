...
#ifndef EXTJSON_UCI_TYPE_CS_DETAILDATATYPE_H
#define EXTJSON_UCI_TYPE_CS_DETAILDATATYPE_H
...
public:
  /** 
    ...
    * @return .
    */
  static bool deserialize(const boost::property_tree::ptree& propTree, uci::type::CS_DetailDataType& accessor, std::string& nodeName, std::string& nsPrefix, bool topLevel = false);
...
#endif // EXTJSON_UCI_TYPE_CS_DETAILDATATYPE_H
