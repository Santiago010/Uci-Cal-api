...
#ifndef EXTJSON_UCI_TYPE_IPV4_DATALINKNATIVEINFOTYPE_H
#define EXTJSON_UCI_TYPE_IPV4_DATALINKNATIVEINFOTYPE_H
...
class IPv4_DataLinkNativeInfoType;
...
public:
  /** 
    ...
    * @return .
    */
  static bool deserialize(const boost::property_tree::ptree& propTree, uci::type::IPv4_DataLinkNativeInfoType& accessor, std::string& nodeName, std::string& nsPrefix, bool topLevel = false);
...
#endif // EXTJSON_UCI_TYPE_IPV4_DATALINKNATIVEINFOTYPE_H
