...
#ifndef EXTJSON_UCI_TYPE_RECTANGULARCONETYPE_H
#define EXTJSON_UCI_TYPE_RECTANGULARCONETYPE_H
...
public:
  /** 
    ...
    * @return .
    */
  static bool deserialize(const boost::property_tree::ptree& propTree, uci::type::RectangularConeType& accessor, std::string& nodeName, std::string& nsPrefix, bool topLevel = false);
...
#endif // EXTJSON_UCI_TYPE_RECTANGULARCONETYPE_H
