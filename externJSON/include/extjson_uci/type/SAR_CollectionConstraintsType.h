...
#ifndef EXTJSON_UCI_TYPE_SAR_COLLECTIONCONSTRAINTSTYPE_H
#define EXTJSON_UCI_TYPE_SAR_COLLECTIONCONSTRAINTSTYPE_H
...
public:
  /** 
    ...
    * @return .
    */
  static bool deserialize(const boost::property_tree::ptree& propTree, uci::type::SAR_CollectionConstraintsType& accessor, std::string& nodeName, std::string& nsPrefix, bool topLevel = false);
...
#endif // EXTJSON_UCI_TYPE_SAR_COLLECTIONCONSTRAINTSTYPE_H
