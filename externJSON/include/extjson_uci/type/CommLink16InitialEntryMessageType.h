...
#ifndef EXTJSON_UCI_TYPE_COMMLINK16INITIALENTRYMESSAGETYPE_H
#define EXTJSON_UCI_TYPE_COMMLINK16INITIALENTRYMESSAGETYPE_H
...
public:
  /** 
    ...
    * @return .
    */
  static bool deserialize(const boost::property_tree::ptree& propTree, uci::type::CommLink16InitialEntryMessageType& accessor, std::string& nodeName, std::string& nsPrefix, bool topLevel = false);
...
#endif // EXTJSON_UCI_TYPE_COMMLINK16INITIALENTRYMESSAGETYPE_H
