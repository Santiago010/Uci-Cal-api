...
#ifndef EXTJSON_UCI_TYPE_RF_TASKPERFORMANCETYPE_H
#define EXTJSON_UCI_TYPE_RF_TASKPERFORMANCETYPE_H
...
public:
  /** 
    ...
    * @return .
    */
  static bool deserialize(const boost::property_tree::ptree& propTree, uci::type::RF_TaskPerformanceType& accessor, std::string& nodeName, std::string& nsPrefix, bool topLevel = false);
...
#endif // EXTJSON_UCI_TYPE_RF_TASKPERFORMANCETYPE_H
