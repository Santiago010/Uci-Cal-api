...
#ifndef EXTJSON_UCI_TYPE_DLZ_DATATYPE_H
#define EXTJSON_UCI_TYPE_DLZ_DATATYPE_H
...
public:
  /** 
    ...
    * @return .
    */
  static bool deserialize(const boost::property_tree::ptree& propTree, uci::type::DLZ_DataType& accessor, std::string& nodeName, std::string& nsPrefix, bool topLevel = false);
...
#endif // EXTJSON_UCI_TYPE_DLZ_DATATYPE_H
