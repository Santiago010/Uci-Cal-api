...
bool MTI_ActivityStatusBaseType::deserialize(const boost::property_tree::ptree& propTree, uci::type::MTI_ActivityStatusBaseType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + MTI_ActivityStatusBaseType_Names::NumberOfTimesSearched_Name) {
...
std::string MTI_ActivityStatusBaseType::serialize(const uci::type::MTI_ActivityStatusBaseType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool checkIfDerivation, const bool /*topLevel*/) {
  ...
  if (!checkIfDerivation || (accessor.getAccessorType() == uci::type::accessorType::mTI_ActivityStatusBaseType)) {
    ...
    if (addTypeAttribute) {
      extjson_uci::util::SerializationHelpers::addTypeAttribute(node, MTI_ActivityStatusBaseType_Names::Extern_Type_Name);
    }
    if (accessor.hasNumberOfTimesSearched()) {
      extjson_uci::util::SerializationHelpers::serializeUnsignedInt(accessor.getNumberOfTimesSearched(), node, MTI_ActivityStatusBaseType_Names::NumberOfTimesSearched_Name);
    }
    if (accessor.hasTimeLastSearched()) {
      extjson_uci::util::SerializationHelpers::serializeDateTime(accessor.getTimeLastSearched(), node, MTI_ActivityStatusBaseType_Names::TimeLastSearched_Name);
    }
    if (accessor.hasAttempts()) {
      extjson_uci::util::SerializationHelpers::serializeUnsignedInt(accessor.getAttempts(), node, MTI_ActivityStatusBaseType_Names::Attempts_Name);
    }
    if (accessor.hasActualRevisitPeriod()) {
      extjson_uci::util::SerializationHelpers::serializeDuration(accessor.getActualRevisitPeriod(), node, MTI_ActivityStatusBaseType_Names::ActualRevisitPeriod_Name);
    }
    if (accessor.hasPercentageInFOR()) {
      extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getPercentageInFOR(), node, MTI_ActivityStatusBaseType_Names::PercentageInFOR_Name);
    }
    if (accessor.hasActualStartTime()) {
      extjson_uci::util::SerializationHelpers::serializeDateTime(accessor.getActualStartTime(), node, MTI_ActivityStatusBaseType_Names::ActualStartTime_Name);
    }
    if (accessor.hasActualStopTime()) {
      extjson_uci::util::SerializationHelpers::serializeDateTime(accessor.getActualStopTime(), node, MTI_ActivityStatusBaseType_Names::ActualStopTime_Name);
    }
    if (accessor.hasPercentSearched()) {
      extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getPercentSearched(), node, MTI_ActivityStatusBaseType_Names::PercentSearched_Name);
    }
    if (accessor.hasEntitiesReported()) {
      extjson_uci::util::SerializationHelpers::serializeUnsignedInt(accessor.getEntitiesReported(), node, MTI_ActivityStatusBaseType_Names::EntitiesReported_Name);
    }
    if (accessor.hasCueAcquired()) {
      extjson_uci::util::SerializationHelpers::serializeBoolean(accessor.getCueAcquired(), node, MTI_ActivityStatusBaseType_Names::CueAcquired_Name);
    }
    {
    ...
    if (accessor.hasPercentOccluded()) {
      extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getPercentOccluded(), node, MTI_ActivityStatusBaseType_Names::PercentOccluded_Name);
    }
    if (accessor.hasPercentRadarTimeline()) {
      extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getPercentRadarTimeline(), node, MTI_ActivityStatusBaseType_Names::PercentRadarTimeline_Name);
    }
    if (accessor.hasPercentageInFOV()) {
      extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getPercentageInFOV(), node, MTI_ActivityStatusBaseType_Names::PercentageInFOV_Name);
    }
