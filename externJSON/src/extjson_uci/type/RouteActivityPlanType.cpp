...
bool RouteActivityPlanType::deserialize(const boost::property_tree::ptree& propTree, uci::type::RouteActivityPlanType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = RouteActivityPlanType_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + RouteActivityPlanType_Names::Applicability_Name) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        ...
        RouteActivityType::deserialize(valueType.second, boundedList.at(boundedListSize), nodeName, nsPrefix);
      }
    }
  }
  return true;
...
std::string RouteActivityPlanType::serialize(const uci::type::RouteActivityPlanType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, RouteActivityPlanType_Names::Extern_Type_Name);
  }
  ...
  ActivityPlanPartsType::serialize(accessor.getParts(), node, RouteActivityPlanType_Names::Parts_Name);
  {
    ...
    for (uci::type::RouteActivityPlanType::PlannedActivity::size_type i = 0, end = boundedList.size(); i < end; ++i) {
      RouteActivityType::serialize(boundedList.at(i), node, RouteActivityPlanType_Names::PlannedActivity_Name);
    }
  }
  if (createNode) {
