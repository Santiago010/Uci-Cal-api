...
bool CommLink16CommWaveformActivityType::deserialize(const boost::property_tree::ptree& propTree, uci::type::CommLink16CommWaveformActivityType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + CommLink16CommWaveformActivityType_Names::SettingsStatus_Name) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setPPLI_MsgGenPPLI_PG(extjson_uci::util::SerializationHelpers::deserializeUnsignedShort(*value));
      }
    } else if (valueType.first == nsPrefix + CommLink16CommWaveformActivityType_Names::PPLI_MsgGenTxRate_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setPPLI_MsgGenTxRate(extjson_uci::util::SerializationHelpers::deserializeUnsignedByte(*value));
      }
    }
  }
...
std::string CommLink16CommWaveformActivityType::serialize(const uci::type::CommLink16CommWaveformActivityType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, CommLink16CommWaveformActivityType_Names::Extern_Type_Name);
  }
  ...
  if (accessor.hasPPLI_MsgGenPPLI_PG()) {
    extjson_uci::util::SerializationHelpers::serializeUnsignedShort(accessor.getPPLI_MsgGenPPLI_PG(), node, CommLink16CommWaveformActivityType_Names::PPLI_MsgGenPPLI_PG_Name);
  }
  if (accessor.hasPPLI_MsgGenTxRate()) {
    extjson_uci::util::SerializationHelpers::serializeUnsignedByte(accessor.getPPLI_MsgGenTxRate(), node, CommLink16CommWaveformActivityType_Names::PPLI_MsgGenTxRate_Name);
  }
  if (createNode) {
