...
bool DamageAssessmentMDT::deserialize(const boost::property_tree::ptree& propTree, uci::type::DamageAssessmentMDT& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + DamageAssessmentMDT_Names::DamageAssessmentID_Name) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setReAttackRequired(extjson_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
...
std::string DamageAssessmentMDT::serialize(const uci::type::DamageAssessmentMDT& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, DamageAssessmentMDT_Names::Extern_Type_Name);
  }
  ...
  extjson_uci::util::SerializationHelpers::serializeDateTime(accessor.getCompletionTime(), node, DamageAssessmentMDT_Names::CompletionTime_Name);
  ...
  if (accessor.hasAssessmentNarrative()) {
    extjson_uci::util::SerializationHelpers::serializeString(accessor.getAssessmentNarrative(), node, DamageAssessmentMDT_Names::AssessmentNarrative_Name);
  }
  extjson_uci::util::SerializationHelpers::serializeBoolean(accessor.getReAttackRequired(), node, DamageAssessmentMDT_Names::ReAttackRequired_Name);
  if (accessor.hasReAttackNarrative()) {
    extjson_uci::util::SerializationHelpers::serializeString(accessor.getReAttackNarrative(), node, DamageAssessmentMDT_Names::ReAttackNarrative_Name);
  }
  {
