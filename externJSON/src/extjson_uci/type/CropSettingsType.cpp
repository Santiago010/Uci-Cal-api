...
bool CropSettingsType::deserialize(const boost::property_tree::ptree& propTree, uci::type::CropSettingsType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + CropSettingsType_Names::Origin_Name) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setX_Position(extjson_uci::util::SerializationHelpers::deserializeUnsignedInt(*value));
      }
    } else if (valueType.first == nsPrefix + CropSettingsType_Names::Y_Position_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setY_Position(extjson_uci::util::SerializationHelpers::deserializeUnsignedInt(*value));
      }
...
std::string CropSettingsType::serialize(const uci::type::CropSettingsType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, CropSettingsType_Names::Extern_Type_Name);
  }
  if (accessor.hasOrigin()) {
    FrameOriginEnum::serialize(accessor.getOrigin(), node, CropSettingsType_Names::Origin_Name, false);
  }
  extjson_uci::util::SerializationHelpers::serializeUnsignedInt(accessor.getX_Position(), node, CropSettingsType_Names::X_Position_Name);
  extjson_uci::util::SerializationHelpers::serializeUnsignedInt(accessor.getY_Position(), node, CropSettingsType_Names::Y_Position_Name);
  extjson_uci::util::SerializationHelpers::serializeUnsignedInt(accessor.getWidth(), node, CropSettingsType_Names::Width_Name);
  extjson_uci::util::SerializationHelpers::serializeUnsignedInt(accessor.getHeight(), node, CropSettingsType_Names::Height_Name);
  if (createNode) {
