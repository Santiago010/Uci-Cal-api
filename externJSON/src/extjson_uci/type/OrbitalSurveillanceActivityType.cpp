...
bool OrbitalSurveillanceActivityType::deserialize(const boost::property_tree::ptree& propTree, uci::type::OrbitalSurveillanceActivityType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = OrbitalSurveillanceActivityType_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + OrbitalSurveillanceActivityType_Names::Target_Name) {
...
std::string OrbitalSurveillanceActivityType::serialize(const uci::type::OrbitalSurveillanceActivityType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, OrbitalSurveillanceActivityType_Names::Extern_Type_Name);
  }
  ...
  if (accessor.hasAllProductsAndMessagesProduced()) {
    extjson_uci::util::SerializationHelpers::serializeBoolean(accessor.getAllProductsAndMessagesProduced(), node, OrbitalSurveillanceActivityType_Names::AllProductsAndMessagesProduced_Name);
  }
  {
    ...
    for (uci::type::OrbitalSurveillanceActivityType::Metrics::size_type i = 0, end = boundedList.size(); i < end; ++i) {
      OrbitalSurveillanceActivityDetailType::serialize(boundedList.at(i), node, OrbitalSurveillanceActivityType_Names::Metrics_Name);
    }
  }
