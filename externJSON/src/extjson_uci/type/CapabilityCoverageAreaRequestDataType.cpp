...
bool CapabilityCoverageAreaRequestDataType::deserialize(const boost::property_tree::ptree& propTree, uci::type::CapabilityCoverageAreaRequestDataType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = CapabilityCoverageAreaRequestDataType_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + CapabilityCoverageAreaRequestDataType_Names::CapabilityID_Name) {
...
std::string CapabilityCoverageAreaRequestDataType::serialize(const uci::type::CapabilityCoverageAreaRequestDataType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, CapabilityCoverageAreaRequestDataType_Names::Extern_Type_Name);
  }
  {
    ...
    for (uci::type::CapabilityCoverageAreaRequestDataType::CapabilityID::size_type i = 0, end = boundedList.size(); i < end; ++i) {
      CapabilityID_Type::serialize(boundedList.at(i), node, CapabilityCoverageAreaRequestDataType_Names::CapabilityID_Name);
    }
  }
  {
    CapabilityCoverageAreaFactorEnum::serializeList(accessor.getCapabilityCoverageAreaFactor(), node, CapabilityCoverageAreaRequestDataType_Names::CapabilityCoverageAreaFactor_Name);
  }
