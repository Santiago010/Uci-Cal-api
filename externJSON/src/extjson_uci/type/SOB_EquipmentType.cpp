...
bool SOB_EquipmentType::deserialize(const boost::property_tree::ptree& propTree, uci::type::SOB_EquipmentType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + SOB_EquipmentType_Names::EquipmentCode_Name) {
...
std::string SOB_EquipmentType::serialize(const uci::type::SOB_EquipmentType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, SOB_EquipmentType_Names::Extern_Type_Name);
  }
  if (accessor.hasEquipmentCode()) {
    extjson_uci::util::SerializationHelpers::serializeString(accessor.getEquipmentCode(), node, SOB_EquipmentType_Names::EquipmentCode_Name);
  }
  if (accessor.hasManufacturer()) {
    extjson_uci::util::SerializationHelpers::serializeString(accessor.getManufacturer(), node, SOB_EquipmentType_Names::Manufacturer_Name);
  }
  if (accessor.hasDescription()) {
    extjson_uci::util::SerializationHelpers::serializeString(accessor.getDescription(), node, SOB_EquipmentType_Names::Description_Name);
  }
  ...
  if (accessor.hasWSSIC_Designator()) {
    extjson_uci::util::SerializationHelpers::serializeString(accessor.getWSSIC_Designator(), node, SOB_EquipmentType_Names::WSSIC_Designator_Name);
  }
