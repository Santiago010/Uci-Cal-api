...
bool COE_OrbitType::deserialize(const boost::property_tree::ptree& propTree, uci::type::COE_OrbitType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = COE_OrbitType_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + COE_OrbitType_Names::SemimajorAxis_Name) {
...
std::string COE_OrbitType::serialize(const uci::type::COE_OrbitType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, COE_OrbitType_Names::Extern_Type_Name);
  }
  COE_OrbitBaseType::serialize(accessor, node, "", false, false, false);
  extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getSemimajorAxis(), node, COE_OrbitType_Names::SemimajorAxis_Name);
  if (createNode) {
