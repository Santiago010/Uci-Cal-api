...
bool PlanningAllowedEscalationType::deserialize(const boost::property_tree::ptree& propTree, uci::type::PlanningAllowedEscalationType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = PlanningAllowedEscalationType_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + PlanningAllowedEscalationType_Names::AutonomousPlanningActionID_Name) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        ...
        MissionPlanningAutonomySettingByResultType::deserialize(valueType.second, boundedList.at(boundedListSize), nodeName, nsPrefix);
      }
...
std::string PlanningAllowedEscalationType::serialize(const uci::type::PlanningAllowedEscalationType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, PlanningAllowedEscalationType_Names::Extern_Type_Name);
  }
  AutonomousPlanningActionID_Type::serialize(accessor.getAutonomousPlanningActionID(), node, PlanningAllowedEscalationType_Names::AutonomousPlanningActionID_Name);
  {
    ...
    for (uci::type::PlanningAllowedEscalationType::ByResultSetting::size_type i = 0, end = boundedList.size(); i < end; ++i) {
      MissionPlanningAutonomySettingByResultType::serialize(boundedList.at(i), node, PlanningAllowedEscalationType_Names::ByResultSetting_Name);
    }
  }
