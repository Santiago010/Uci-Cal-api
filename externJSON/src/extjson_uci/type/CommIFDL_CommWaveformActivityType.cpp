...
bool CommIFDL_CommWaveformActivityType::deserialize(const boost::property_tree::ptree& propTree, uci::type::CommIFDL_CommWaveformActivityType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + CommIFDL_CommWaveformActivityType_Names::SettingsStatus_Name) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setChannelA_Number(extjson_uci::util::SerializationHelpers::deserializeUnsignedByte(*value));
      }
    } else if (valueType.first == nsPrefix + CommIFDL_CommWaveformActivityType_Names::ChannelB_Number_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setChannelB_Number(extjson_uci::util::SerializationHelpers::deserializeUnsignedByte(*value));
      }
    } else if (valueType.first == nsPrefix + CommIFDL_CommWaveformActivityType_Names::AcquisitionActive_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setAcquisitionActive(extjson_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
    } else if (valueType.first == nsPrefix + CommIFDL_CommWaveformActivityType_Names::VoiceTransmit_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setVoiceTransmit(extjson_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
    } else if (valueType.first == nsPrefix + CommIFDL_CommWaveformActivityType_Names::VoiceReceive_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setVoiceReceive(extjson_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
    } else if (valueType.first == nsPrefix + CommIFDL_CommWaveformActivityType_Names::WideNetIdentifier1_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setWideNetIdentifier1(extjson_uci::util::SerializationHelpers::deserializeUnsignedShort(*value));
      }
    } else if (valueType.first == nsPrefix + CommIFDL_CommWaveformActivityType_Names::WideNetIdentifier2_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setWideNetIdentifier2(extjson_uci::util::SerializationHelpers::deserializeUnsignedShort(*value));
      }
    } else if (valueType.first == nsPrefix + CommIFDL_CommWaveformActivityType_Names::WideNetIdentifier3_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setWideNetIdentifier3(extjson_uci::util::SerializationHelpers::deserializeUnsignedShort(*value));
      }
...
std::string CommIFDL_CommWaveformActivityType::serialize(const uci::type::CommIFDL_CommWaveformActivityType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, CommIFDL_CommWaveformActivityType_Names::Extern_Type_Name);
  }
  ...
  extjson_uci::util::SerializationHelpers::serializeUnsignedByte(accessor.getChannelA_Number(), node, CommIFDL_CommWaveformActivityType_Names::ChannelA_Number_Name);
  extjson_uci::util::SerializationHelpers::serializeUnsignedByte(accessor.getChannelB_Number(), node, CommIFDL_CommWaveformActivityType_Names::ChannelB_Number_Name);
  if (accessor.hasAcquisitionActive()) {
    extjson_uci::util::SerializationHelpers::serializeBoolean(accessor.getAcquisitionActive(), node, CommIFDL_CommWaveformActivityType_Names::AcquisitionActive_Name);
  }
  if (accessor.hasVoiceTransmit()) {
    extjson_uci::util::SerializationHelpers::serializeBoolean(accessor.getVoiceTransmit(), node, CommIFDL_CommWaveformActivityType_Names::VoiceTransmit_Name);
  }
  if (accessor.hasVoiceReceive()) {
    extjson_uci::util::SerializationHelpers::serializeBoolean(accessor.getVoiceReceive(), node, CommIFDL_CommWaveformActivityType_Names::VoiceReceive_Name);
  }
  if (accessor.hasWideNetIdentifier1()) {
    extjson_uci::util::SerializationHelpers::serializeUnsignedShort(accessor.getWideNetIdentifier1(), node, CommIFDL_CommWaveformActivityType_Names::WideNetIdentifier1_Name);
  }
  if (accessor.hasWideNetIdentifier2()) {
    extjson_uci::util::SerializationHelpers::serializeUnsignedShort(accessor.getWideNetIdentifier2(), node, CommIFDL_CommWaveformActivityType_Names::WideNetIdentifier2_Name);
  }
  if (accessor.hasWideNetIdentifier3()) {
    extjson_uci::util::SerializationHelpers::serializeUnsignedShort(accessor.getWideNetIdentifier3(), node, CommIFDL_CommWaveformActivityType_Names::WideNetIdentifier3_Name);
  }
  {
