...
bool OrbitalKinematicsRelativeEphemerisType::deserialize(const boost::property_tree::ptree& propTree, uci::type::OrbitalKinematicsRelativeEphemerisType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = OrbitalKinematicsRelativeEphemerisType_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + OrbitalKinematicsRelativeEphemerisType_Names::RelativeStateVector_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        ...
        OrbitalKinematicsRelativeStateVectorType::deserialize(valueType.second, boundedList.at(boundedListSize), nodeName, nsPrefix);
      }
...
std::string OrbitalKinematicsRelativeEphemerisType::serialize(const uci::type::OrbitalKinematicsRelativeEphemerisType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, OrbitalKinematicsRelativeEphemerisType_Names::Extern_Type_Name);
  }
  {
    ...
    for (uci::type::OrbitalKinematicsRelativeEphemerisType::RelativeStateVector::size_type i = 0, end = boundedList.size(); i < end; ++i) {
      OrbitalKinematicsRelativeStateVectorType::serialize(boundedList.at(i), node, OrbitalKinematicsRelativeEphemerisType_Names::RelativeStateVector_Name);
    }
  }
