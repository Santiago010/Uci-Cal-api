...
bool ResourceAllocationPeriodRF_Type::deserialize(const boost::property_tree::ptree& propTree, uci::type::ResourceAllocationPeriodRF_Type& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + ResourceAllocationPeriodRF_Type_Names::AccessPeriodIndex_Name) {
...
std::string ResourceAllocationPeriodRF_Type::serialize(const uci::type::ResourceAllocationPeriodRF_Type& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, ResourceAllocationPeriodRF_Type_Names::Extern_Type_Name);
  }
  extjson_uci::util::SerializationHelpers::serializeUnsignedInt(accessor.getAccessPeriodIndex(), node, ResourceAllocationPeriodRF_Type_Names::AccessPeriodIndex_Name);
  extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getPercentAccessLimit(), node, ResourceAllocationPeriodRF_Type_Names::PercentAccessLimit_Name);
  ...
  if (accessor.hasPeriodPercentAccessExpected()) {
    extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getPeriodPercentAccessExpected(), node, ResourceAllocationPeriodRF_Type_Names::PeriodPercentAccessExpected_Name);
  }
  if (accessor.hasPeriodMaxAccessDuration()) {
    extjson_uci::util::SerializationHelpers::serializeDuration(accessor.getPeriodMaxAccessDuration(), node, ResourceAllocationPeriodRF_Type_Names::PeriodMaxAccessDuration_Name);
  }
  if (createNode) {
