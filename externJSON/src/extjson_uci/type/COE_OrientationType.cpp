...
bool COE_OrientationType::deserialize(const boost::property_tree::ptree& propTree, uci::type::COE_OrientationType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + COE_OrientationType_Names::NonEquatorialOrbit_Name) {
...
std::string COE_OrientationType::serialize(const uci::type::COE_OrientationType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, COE_OrientationType_Names::Extern_Type_Name);
  }
