...
bool LOS_VariableA_Type::deserialize(const boost::property_tree::ptree& propTree, uci::type::LOS_VariableA_Type& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = LOS_VariableA_Type_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + LOS_VariableA_Type_Names::Reference_Name) {
...
std::string LOS_VariableA_Type::serialize(const uci::type::LOS_VariableA_Type& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool checkIfDerivation, const bool /*topLevel*/) {
  ...
  if (!checkIfDerivation || (accessor.getAccessorType() == uci::type::accessorType::lOS_VariableA_Type)) {
    ...
    if (addTypeAttribute) {
      extjson_uci::util::SerializationHelpers::addTypeAttribute(node, LOS_VariableA_Type_Names::Extern_Type_Name);
    }
    LOS_ReferenceEnum::serialize(accessor.getReference(), node, LOS_VariableA_Type_Names::Reference_Name, false);
    extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getAzimuth(), node, LOS_VariableA_Type_Names::Azimuth_Name);
    extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getElevation(), node, LOS_VariableA_Type_Names::Elevation_Name);
    if (createNode) {
