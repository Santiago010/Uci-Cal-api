...
bool OperatorNotificationActionType::deserialize(const boost::property_tree::ptree& propTree, uci::type::OperatorNotificationActionType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = OperatorNotificationActionType_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + OperatorNotificationActionType_Names::AutonomousActions_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        ...
        OperatorActionAutonomousType::deserialize(valueType.second, boundedList.at(boundedListSize), nodeName, nsPrefix);
      }
...
std::string OperatorNotificationActionType::serialize(const uci::type::OperatorNotificationActionType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, OperatorNotificationActionType_Names::Extern_Type_Name);
  }
  if (accessor.isAutonomousActions()) {
    {
      ...
      for (uci::type::OperatorNotificationActionType::AutonomousActions::size_type i = 0, end = boundedList.size(); i < end; ++i) {
        OperatorActionAutonomousType::serialize(boundedList.at(i), node, OperatorNotificationActionType_Names::AutonomousActions_Name);
      }
    }
