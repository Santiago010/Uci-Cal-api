...
bool MissionPlanningAutonomyResponseChoiceType::deserialize(const boost::property_tree::ptree& propTree, uci::type::MissionPlanningAutonomyResponseChoiceType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = MissionPlanningAutonomyResponseChoiceType_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + MissionPlanningAutonomyResponseChoiceType_Names::AutonomousPlanningAction_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        ...
        PlanningAllowedEscalationType::deserialize(valueType.second, boundedList.at(boundedListSize), nodeName, nsPrefix);
      }
...
std::string MissionPlanningAutonomyResponseChoiceType::serialize(const uci::type::MissionPlanningAutonomyResponseChoiceType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, MissionPlanningAutonomyResponseChoiceType_Names::Extern_Type_Name);
  }
  if (accessor.isAutonomousPlanningAction()) {
    {
      ...
      for (uci::type::MissionPlanningAutonomyResponseChoiceType::AutonomousPlanningAction::size_type i = 0, end = boundedList.size(); i < end; ++i) {
        PlanningAllowedEscalationType::serialize(boundedList.at(i), node, MissionPlanningAutonomyResponseChoiceType_Names::AutonomousPlanningAction_Name);
      }
    }
  } else if (accessor.isAlertOnly()) {
    extjson_uci::util::SerializationHelpers::serializeString(accessor.getAlertOnly(), node, MissionPlanningAutonomyResponseChoiceType_Names::AlertOnly_Name);
  }
  if (createNode) {
