...
bool OrbitConjunctionAssessmentRequestMDT::deserialize(const boost::property_tree::ptree& propTree, uci::type::OrbitConjunctionAssessmentRequestMDT& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = OrbitConjunctionAssessmentRequestMDT_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + OrbitConjunctionAssessmentRequestMDT_Names::AssessmentType_Name) {
      ...
      OrbitalAnalysisObjectType::deserialize(valueType.second, boundedList.at(boundedListSize), nodeName, nsPrefix);
...
std::string OrbitConjunctionAssessmentRequestMDT::serialize(const uci::type::OrbitConjunctionAssessmentRequestMDT& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, OrbitConjunctionAssessmentRequestMDT_Names::Extern_Type_Name);
  }
  ...
  if (accessor.hasRangeThreshold()) {
    extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getRangeThreshold(), node, OrbitConjunctionAssessmentRequestMDT_Names::RangeThreshold_Name);
  }
  {
    ...
    for (uci::type::OrbitConjunctionAssessmentRequestMDT::AssessmentObject::size_type i = 0, end = boundedList.size(); i < end; ++i) {
      OrbitalAnalysisObjectType::serialize(boundedList.at(i), node, OrbitConjunctionAssessmentRequestMDT_Names::AssessmentObject_Name);
    }
  }
  ...
  if (accessor.hasRespondBy()) {
    extjson_uci::util::SerializationHelpers::serializeDateTime(accessor.getRespondBy(), node, OrbitConjunctionAssessmentRequestMDT_Names::RespondBy_Name);
  }
  if (createNode) {
