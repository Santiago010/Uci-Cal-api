...
bool RadarSpoilTaperType::deserialize(const boost::property_tree::ptree& propTree, uci::type::RadarSpoilTaperType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + RadarSpoilTaperType_Names::Taper_Name) {
...
std::string RadarSpoilTaperType::serialize(const uci::type::RadarSpoilTaperType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, RadarSpoilTaperType_Names::Extern_Type_Name);
  }
  if (accessor.isTaper()) {
