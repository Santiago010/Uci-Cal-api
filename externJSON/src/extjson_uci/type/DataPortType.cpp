...
bool DataPortType::deserialize(const boost::property_tree::ptree& propTree, uci::type::DataPortType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + DataPortType_Names::UserIO_ID_Name) {
...
std::string DataPortType::serialize(const uci::type::DataPortType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, DataPortType_Names::Extern_Type_Name);
  }
