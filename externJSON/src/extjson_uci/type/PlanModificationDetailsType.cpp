...
bool PlanModificationDetailsType::deserialize(const boost::property_tree::ptree& propTree, uci::type::PlanModificationDetailsType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + PlanModificationDetailsType_Names::ForPlanningUseOnly_Name) {
...
std::string PlanModificationDetailsType::serialize(const uci::type::PlanModificationDetailsType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, PlanModificationDetailsType_Names::Extern_Type_Name);
  }
  if (accessor.hasForPlanningUseOnly()) {
    extjson_uci::util::SerializationHelpers::serializeBoolean(accessor.getForPlanningUseOnly(), node, PlanModificationDetailsType_Names::ForPlanningUseOnly_Name);
  }
