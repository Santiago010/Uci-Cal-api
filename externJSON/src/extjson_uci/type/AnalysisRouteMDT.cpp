...
bool AnalysisRouteMDT::deserialize(const boost::property_tree::ptree& propTree, uci::type::AnalysisRouteMDT& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + AnalysisRouteMDT_Names::AnalysisRouteID_Name) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setTimeAnalysisPerformed(extjson_uci::util::SerializationHelpers::deserializeDateTime(*value));
      }
...
std::string AnalysisRouteMDT::serialize(const uci::type::AnalysisRouteMDT& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, AnalysisRouteMDT_Names::Extern_Type_Name);
  }
  ...
  extjson_uci::util::SerializationHelpers::serializeDateTime(accessor.getTimeAnalysisPerformed(), node, AnalysisRouteMDT_Names::TimeAnalysisPerformed_Name);
