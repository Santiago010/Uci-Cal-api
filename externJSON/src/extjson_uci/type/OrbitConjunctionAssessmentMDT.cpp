...
bool OrbitConjunctionAssessmentMDT::deserialize(const boost::property_tree::ptree& propTree, uci::type::OrbitConjunctionAssessmentMDT& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = OrbitConjunctionAssessmentMDT_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + OrbitConjunctionAssessmentMDT_Names::OrbitConjunctionAssessmentID_Name) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        ...
        OrbitalConjunctionType::deserialize(valueType.second, boundedList.at(boundedListSize), nodeName, nsPrefix);
      }
...
std::string OrbitConjunctionAssessmentMDT::serialize(const uci::type::OrbitConjunctionAssessmentMDT& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, OrbitConjunctionAssessmentMDT_Names::Extern_Type_Name);
  }
  ...
  }
  {
    ...
    for (uci::type::OrbitConjunctionAssessmentMDT::Conjunction::size_type i = 0, end = boundedList.size(); i < end; ++i) {
      OrbitalConjunctionType::serialize(boundedList.at(i), node, OrbitConjunctionAssessmentMDT_Names::Conjunction_Name);
    }
  }
  extjson_uci::util::SerializationHelpers::serializeDateTime(accessor.getCompletionTime(), node, OrbitConjunctionAssessmentMDT_Names::CompletionTime_Name);
  if (accessor.hasEstimateNarrative()) {
    extjson_uci::util::SerializationHelpers::serializeString(accessor.getEstimateNarrative(), node, OrbitConjunctionAssessmentMDT_Names::EstimateNarrative_Name);
  }
  if (createNode) {
