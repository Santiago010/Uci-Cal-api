...
bool DMPI_DesignationMDT::deserialize(const boost::property_tree::ptree& propTree, uci::type::DMPI_DesignationMDT& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + DMPI_DesignationMDT_Names::DMPI_DesignationID_Name) {
...
std::string DMPI_DesignationMDT::serialize(const uci::type::DMPI_DesignationMDT& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, DMPI_DesignationMDT_Names::Extern_Type_Name);
  }
  ...
  if (accessor.hasRemarks()) {
    extjson_uci::util::SerializationHelpers::serializeString(accessor.getRemarks(), node, DMPI_DesignationMDT_Names::Remarks_Name);
  }
  {
