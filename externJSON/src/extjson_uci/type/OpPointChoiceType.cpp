...
bool OpPointChoiceType::deserialize(const boost::property_tree::ptree& propTree, uci::type::OpPointChoiceType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = OpPointChoiceType_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + OpPointChoiceType_Names::Point_Name) {
...
std::string OpPointChoiceType::serialize(const uci::type::OpPointChoiceType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, OpPointChoiceType_Names::Extern_Type_Name);
  }
  if (accessor.isPoint()) {
