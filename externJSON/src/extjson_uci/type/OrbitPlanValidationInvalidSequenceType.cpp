...
bool OrbitPlanValidationInvalidSequenceType::deserialize(const boost::property_tree::ptree& propTree, uci::type::OrbitPlanValidationInvalidSequenceType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = OrbitPlanValidationInvalidSequenceType_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + OrbitPlanValidationInvalidSequenceType_Names::SequenceID_Name) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        ...
        OrbitPlanValidationInvalidManeuverSegmentType::deserialize(valueType.second, boundedList.at(boundedListSize), nodeName, nsPrefix);
      }
    } else if (valueType.first == nsPrefix + OrbitPlanValidationInvalidSequenceType_Names::OtherInvalidReason_Name) {
      extjson_uci::util::DerivedTypesDeserializer::deserialize(valueType.second, accessor.enableOtherInvalidReason(extjson_uci::util::SerializationHelpers::checkForTypeAttribute(valueType.second, nsPrefix)), nodeName, nsPrefix);
    }
  }
  return true;
}
...
std::string OrbitPlanValidationInvalidSequenceType::serialize(const uci::type::OrbitPlanValidationInvalidSequenceType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, OrbitPlanValidationInvalidSequenceType_Names::Extern_Type_Name);
  }
  ...
  }
  {
    ...
    for (uci::type::OrbitPlanValidationInvalidSequenceType::InvalidManeuverSegment::size_type i = 0, end = boundedList.size(); i < end; ++i) {
      OrbitPlanValidationInvalidManeuverSegmentType::serialize(boundedList.at(i), node, OrbitPlanValidationInvalidSequenceType_Names::InvalidManeuverSegment_Name);
    }
  }
