...
bool PO_CapabilityMDT::deserialize(const boost::property_tree::ptree& propTree, uci::type::PO_CapabilityMDT& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + PO_CapabilityMDT_Names::Capability_Name) {
      ...
      PointingTypeEnum::deserializeList(valueType.second, accessor.getPointingCapability());
...
std::string PO_CapabilityMDT::serialize(const uci::type::PO_CapabilityMDT& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, PO_CapabilityMDT_Names::Extern_Type_Name);
  }
  ...
  {
    PointingTypeEnum::serializeList(accessor.getPointingCapability(), node, PO_CapabilityMDT_Names::PointingCapability_Name);
  }
  {
