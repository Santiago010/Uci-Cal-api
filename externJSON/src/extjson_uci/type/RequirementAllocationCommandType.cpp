...
bool RequirementAllocationCommandType::deserialize(const boost::property_tree::ptree& propTree, uci::type::RequirementAllocationCommandType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + RequirementAllocationCommandType_Names::ProposedEffect_Name) {
...
std::string RequirementAllocationCommandType::serialize(const uci::type::RequirementAllocationCommandType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, RequirementAllocationCommandType_Names::Extern_Type_Name);
  }
  {
