...
bool SpaceWeatherDataChoiceType::deserialize(const boost::property_tree::ptree& propTree, uci::type::SpaceWeatherDataChoiceType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + SpaceWeatherDataChoiceType_Names::SpaceWeatherValuesID_Name) {
...
std::string SpaceWeatherDataChoiceType::serialize(const uci::type::SpaceWeatherDataChoiceType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, SpaceWeatherDataChoiceType_Names::Extern_Type_Name);
  }
