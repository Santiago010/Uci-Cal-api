...
bool ComponentType::deserialize(const boost::property_tree::ptree& propTree, uci::type::ComponentType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + ComponentType_Names::ComponentID_Name) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setDataTimestamp(extjson_uci::util::SerializationHelpers::deserializeDateTime(*value));
      }
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setSubsystemCritical(extjson_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
...
std::string ComponentType::serialize(const uci::type::ComponentType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, ComponentType_Names::Extern_Type_Name);
  }
  ...
  if (accessor.hasDataTimestamp()) {
    extjson_uci::util::SerializationHelpers::serializeDateTime(accessor.getDataTimestamp(), node, ComponentType_Names::DataTimestamp_Name);
  }
  {
  ...
  if (accessor.hasSubsystemCritical()) {
    extjson_uci::util::SerializationHelpers::serializeBoolean(accessor.getSubsystemCritical(), node, ComponentType_Names::SubsystemCritical_Name);
  }
  {
