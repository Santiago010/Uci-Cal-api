...
bool DataManagementCategoryType::deserialize(const boost::property_tree::ptree& propTree, uci::type::DataManagementCategoryType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + DataManagementCategoryType_Names::SaveMissionID_Name) {
...
std::string DataManagementCategoryType::serialize(const uci::type::DataManagementCategoryType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, DataManagementCategoryType_Names::Extern_Type_Name);
  }
