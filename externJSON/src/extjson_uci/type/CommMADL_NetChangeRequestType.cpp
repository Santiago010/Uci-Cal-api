...
bool CommMADL_NetChangeRequestType::deserialize(const boost::property_tree::ptree& propTree, uci::type::CommMADL_NetChangeRequestType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + CommMADL_NetChangeRequestType_Names::ChangeOperator_Name) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setNumSelections(extjson_uci::util::SerializationHelpers::deserializeUnsignedByte(*value));
      }
...
std::string CommMADL_NetChangeRequestType::serialize(const uci::type::CommMADL_NetChangeRequestType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, CommMADL_NetChangeRequestType_Names::Extern_Type_Name);
  }
  ...
  extjson_uci::util::SerializationHelpers::serializeUnsignedByte(accessor.getNumSelections(), node, CommMADL_NetChangeRequestType_Names::NumSelections_Name);
