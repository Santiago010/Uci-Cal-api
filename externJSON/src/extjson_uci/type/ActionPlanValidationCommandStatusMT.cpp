...
bool ActionPlanValidationCommandStatusMT::deserialize(const boost::property_tree::ptree& propTree, uci::type::ActionPlanValidationCommandStatusMT& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + ActionPlanValidationCommandStatusMT_Names::MessageData_Name) {
...
std::string ActionPlanValidationCommandStatusMT::serialize(const uci::type::ActionPlanValidationCommandStatusMT& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool topLevel) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, (topLevel ? ActionPlanValidationCommandStatusMT_Names::Extern_Top_Type_Name : ActionPlanValidationCommandStatusMT_Names::Extern_Type_Name));
  }
