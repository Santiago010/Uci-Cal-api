...
bool RDMA_InitializeMDT::deserialize(const boost::property_tree::ptree& propTree, uci::type::RDMA_InitializeMDT& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + RDMA_InitializeMDT_Names::RDMA_InitializeID_Name) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setMemoryRegionSize(extjson_uci::util::SerializationHelpers::deserializeUnsignedInt(*value));
      }
    } else if (valueType.first == nsPrefix + RDMA_InitializeMDT_Names::MaximumMessageSize_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setMaximumMessageSize(extjson_uci::util::SerializationHelpers::deserializeUnsignedInt(*value));
      }
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setRDMA_MemoryProtectionLocalRead(extjson_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
    } else if (valueType.first == nsPrefix + RDMA_InitializeMDT_Names::RDMA_MemoryProtectionLocalWrite_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setRDMA_MemoryProtectionLocalWrite(extjson_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
    } else if (valueType.first == nsPrefix + RDMA_InitializeMDT_Names::RDMA_MemoryProtectionRemoteRead_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setRDMA_MemoryProtectionRemoteRead(extjson_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
    } else if (valueType.first == nsPrefix + RDMA_InitializeMDT_Names::RDMA_MemoryProtectionRemoteWrite_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setRDMA_MemoryProtectionRemoteWrite(extjson_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
    }
  }
  return true;
...
std::string RDMA_InitializeMDT::serialize(const uci::type::RDMA_InitializeMDT& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, RDMA_InitializeMDT_Names::Extern_Type_Name);
  }
  ...
  extjson_uci::util::SerializationHelpers::serializeUnsignedInt(accessor.getMemoryRegionSize(), node, RDMA_InitializeMDT_Names::MemoryRegionSize_Name);
  if (accessor.hasMaximumMessageSize()) {
    extjson_uci::util::SerializationHelpers::serializeUnsignedInt(accessor.getMaximumMessageSize(), node, RDMA_InitializeMDT_Names::MaximumMessageSize_Name);
  }
  {
  ...
  if (accessor.hasEndpointName()) {
    extjson_uci::util::SerializationHelpers::serializeString(accessor.getEndpointName(), node, RDMA_InitializeMDT_Names::EndpointName_Name);
  }
  ...
  extjson_uci::util::SerializationHelpers::serializeBoolean(accessor.getRDMA_MemoryProtectionLocalRead(), node, RDMA_InitializeMDT_Names::RDMA_MemoryProtectionLocalRead_Name);
  extjson_uci::util::SerializationHelpers::serializeBoolean(accessor.getRDMA_MemoryProtectionLocalWrite(), node, RDMA_InitializeMDT_Names::RDMA_MemoryProtectionLocalWrite_Name);
  extjson_uci::util::SerializationHelpers::serializeBoolean(accessor.getRDMA_MemoryProtectionRemoteRead(), node, RDMA_InitializeMDT_Names::RDMA_MemoryProtectionRemoteRead_Name);
  extjson_uci::util::SerializationHelpers::serializeBoolean(accessor.getRDMA_MemoryProtectionRemoteWrite(), node, RDMA_InitializeMDT_Names::RDMA_MemoryProtectionRemoteWrite_Name);
  if (createNode) {
