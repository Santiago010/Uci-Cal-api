...
bool ApproachConditionsType::deserialize(const boost::property_tree::ptree& propTree, uci::type::ApproachConditionsType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + ApproachConditionsType_Names::FlightMode_Name) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setRangeOnHeading(extjson_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
...
std::string ApproachConditionsType::serialize(const uci::type::ApproachConditionsType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, ApproachConditionsType_Names::Extern_Type_Name);
  }
  ...
  if (accessor.hasRangeOnHeading()) {
    extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getRangeOnHeading(), node, ApproachConditionsType_Names::RangeOnHeading_Name);
  }
