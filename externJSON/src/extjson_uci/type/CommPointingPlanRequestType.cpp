...
bool CommPointingPlanRequestType::deserialize(const boost::property_tree::ptree& propTree, uci::type::CommPointingPlanRequestType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + CommPointingPlanRequestType_Names::RoutePlan_Name) {
...
std::string CommPointingPlanRequestType::serialize(const uci::type::CommPointingPlanRequestType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, CommPointingPlanRequestType_Names::Extern_Type_Name);
  }
  {
