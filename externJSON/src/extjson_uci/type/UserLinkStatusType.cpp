...
bool UserLinkStatusType::deserialize(const boost::property_tree::ptree& propTree, uci::type::UserLinkStatusType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + UserLinkStatusType_Names::NetworkLinkID_Name) {
...
std::string UserLinkStatusType::serialize(const uci::type::UserLinkStatusType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, UserLinkStatusType_Names::Extern_Type_Name);
  }
