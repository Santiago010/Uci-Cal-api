...
bool PO_ComponentProcessingStageType::deserialize(const boost::property_tree::ptree& propTree, uci::type::PO_ComponentProcessingStageType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + PO_ComponentProcessingStageType_Names::StageID_Name) {
...
std::string PO_ComponentProcessingStageType::serialize(const uci::type::PO_ComponentProcessingStageType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, PO_ComponentProcessingStageType_Names::Extern_Type_Name);
  }
