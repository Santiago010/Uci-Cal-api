...
bool StrikeCapabilityType::deserialize(const boost::property_tree::ptree& propTree, uci::type::StrikeCapabilityType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = StrikeCapabilityType_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + StrikeCapabilityType_Names::CapabilityType_Name) {
      extjson_uci::util::DerivedTypesDeserializer::deserialize(valueType.second, accessor.enableCapabilityType(extjson_uci::util::SerializationHelpers::checkForTypeAttribute(valueType.second, nsPrefix)), nodeName, nsPrefix);
...
std::string StrikeCapabilityType::serialize(const uci::type::StrikeCapabilityType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, StrikeCapabilityType_Names::Extern_Type_Name);
  }
  ...
  StrikeCapabilityOptionsType::serialize(accessor.getCapabilityOptions(), node, StrikeCapabilityType_Names::CapabilityOptions_Name);
  {
    ...
    for (uci::type::StrikeCapabilityType::SupportedCode::size_type i = 0, end = boundedList.size(); i < end; ++i) {
      AO_CodeType::serialize(boundedList.at(i), node, StrikeCapabilityType_Names::SupportedCode_Name);
    }
  }
