...
bool RefuelCapabilityDrogueStatusType::deserialize(const boost::property_tree::ptree& propTree, uci::type::RefuelCapabilityDrogueStatusType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + RefuelCapabilityDrogueStatusType_Names::DrogueStowed_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setDrogueStowed(extjson_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
    } else if (valueType.first == nsPrefix + RefuelCapabilityDrogueStatusType_Names::ScheduledMissionFuelToBeDelivered_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setScheduledMissionFuelToBeDelivered(extjson_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
...
std::string RefuelCapabilityDrogueStatusType::serialize(const uci::type::RefuelCapabilityDrogueStatusType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, RefuelCapabilityDrogueStatusType_Names::Extern_Type_Name);
  }
  RefuelCapabilityDrogueCommonType::serialize(accessor, node, "", false, false, false);
  if (accessor.hasDrogueStowed()) {
    extjson_uci::util::SerializationHelpers::serializeBoolean(accessor.getDrogueStowed(), node, RefuelCapabilityDrogueStatusType_Names::DrogueStowed_Name);
  }
  if (accessor.hasScheduledMissionFuelToBeDelivered()) {
    extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getScheduledMissionFuelToBeDelivered(), node, RefuelCapabilityDrogueStatusType_Names::ScheduledMissionFuelToBeDelivered_Name);
  }
