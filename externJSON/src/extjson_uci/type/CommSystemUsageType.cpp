...
bool CommSystemUsageType::deserialize(const boost::property_tree::ptree& propTree, uci::type::CommSystemUsageType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = CommSystemUsageType_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + CommSystemUsageType_Names::CommSystemID_Name) {
      ...
      extjson_uci::util::SerializationHelpers::deserializeStringList(valueType.second, accessor.getUserIdentifier());
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        ...
        CommModeUsageType::deserialize(valueType.second, boundedList.at(boundedListSize), nodeName, nsPrefix);
      }
    }
  }
  return true;
...
std::string CommSystemUsageType::serialize(const uci::type::CommSystemUsageType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, CommSystemUsageType_Names::Extern_Type_Name);
  }
  CommSystemID_Type::serialize(accessor.getCommSystemID(), node, CommSystemUsageType_Names::CommSystemID_Name);
  {
    extjson_uci::util::SerializationHelpers::serializeStringList(accessor.getUserIdentifier(), node, CommSystemUsageType_Names::UserIdentifier_Name);
  }
  {
    ...
    for (uci::type::CommSystemUsageType::Usage::size_type i = 0, end = boundedList.size(); i < end; ++i) {
      CommModeUsageType::serialize(boundedList.at(i), node, CommSystemUsageType_Names::Usage_Name);
    }
  }
  if (createNode) {
