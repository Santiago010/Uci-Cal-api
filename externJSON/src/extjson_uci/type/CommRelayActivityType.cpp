...
bool CommRelayActivityType::deserialize(const boost::property_tree::ptree& propTree, uci::type::CommRelayActivityType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + CommRelayActivityType_Names::FrequencySet_Name) {
...
std::string CommRelayActivityType::serialize(const uci::type::CommRelayActivityType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, CommRelayActivityType_Names::Extern_Type_Name);
  }
  ...
  if (accessor.hasActualStartTime()) {
    extjson_uci::util::SerializationHelpers::serializeDateTime(accessor.getActualStartTime(), node, CommRelayActivityType_Names::ActualStartTime_Name);
  }
  if (accessor.hasActualEndTime()) {
    extjson_uci::util::SerializationHelpers::serializeDateTime(accessor.getActualEndTime(), node, CommRelayActivityType_Names::ActualEndTime_Name);
  }
  if (createNode) {
