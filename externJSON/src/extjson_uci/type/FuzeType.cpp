...
bool FuzeType::deserialize(const boost::property_tree::ptree& propTree, uci::type::FuzeType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + FuzeType_Names::FuzeTrigger_Name) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setFuzeSeparationArmTime(extjson_uci::util::SerializationHelpers::deserializeDuration(*value));
      }
    }
  }
  return true;
...
std::string FuzeType::serialize(const uci::type::FuzeType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, FuzeType_Names::Extern_Type_Name);
  }
  ...
  if (accessor.hasMnemonic()) {
    extjson_uci::util::SerializationHelpers::serializeString(accessor.getMnemonic(), node, FuzeType_Names::Mnemonic_Name);
  }
  if (accessor.hasFuzeSeparationArmTime()) {
    extjson_uci::util::SerializationHelpers::serializeDuration(accessor.getFuzeSeparationArmTime(), node, FuzeType_Names::FuzeSeparationArmTime_Name);
  }
  if (createNode) {
