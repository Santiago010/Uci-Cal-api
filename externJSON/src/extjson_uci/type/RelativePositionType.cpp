...
bool RelativePositionType::deserialize(const boost::property_tree::ptree& propTree, uci::type::RelativePositionType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + RelativePositionType_Names::ReferencePoint_Name) {
...
std::string RelativePositionType::serialize(const uci::type::RelativePositionType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, RelativePositionType_Names::Extern_Type_Name);
  }
