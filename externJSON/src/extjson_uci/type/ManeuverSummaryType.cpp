...
bool ManeuverSummaryType::deserialize(const boost::property_tree::ptree& propTree, uci::type::ManeuverSummaryType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = ManeuverSummaryType_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + ManeuverSummaryType_Names::ExpectedManeuver_Name) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setNominalManeuverProbability(extjson_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
...
std::string ManeuverSummaryType::serialize(const uci::type::ManeuverSummaryType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, ManeuverSummaryType_Names::Extern_Type_Name);
  }
  ...
  if (accessor.hasNominalManeuverProbability()) {
    extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getNominalManeuverProbability(), node, ManeuverSummaryType_Names::NominalManeuverProbability_Name);
  }
