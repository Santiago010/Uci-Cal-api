...
bool CommMADL_PeerNodeDataType::deserialize(const boost::property_tree::ptree& propTree, uci::type::CommMADL_PeerNodeDataType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = CommMADL_PeerNodeDataType_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + CommMADL_PeerNodeDataType_Names::PeerNodeIdentifier_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setPeerNodeIdentifier(extjson_uci::util::SerializationHelpers::deserializeUnsignedByte(*value));
      }
    } else if (valueType.first == nsPrefix + CommMADL_PeerNodeDataType_Names::PeerMADL_UniqueIdentifier_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setPeerMADL_UniqueIdentifier(extjson_uci::util::SerializationHelpers::deserializeUnsignedShort(*value));
      }
...
std::string CommMADL_PeerNodeDataType::serialize(const uci::type::CommMADL_PeerNodeDataType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, CommMADL_PeerNodeDataType_Names::Extern_Type_Name);
  }
  extjson_uci::util::SerializationHelpers::serializeUnsignedByte(accessor.getPeerNodeIdentifier(), node, CommMADL_PeerNodeDataType_Names::PeerNodeIdentifier_Name);
  extjson_uci::util::SerializationHelpers::serializeUnsignedShort(accessor.getPeerMADL_UniqueIdentifier(), node, CommMADL_PeerNodeDataType_Names::PeerMADL_UniqueIdentifier_Name);
  ...
  extjson_uci::util::SerializationHelpers::serializeBoolean(accessor.getDataCapable(), node, CommMADL_PeerNodeDataType_Names::DataCapable_Name);
  extjson_uci::util::SerializationHelpers::serializeBoolean(accessor.getVoiceCapable(), node, CommMADL_PeerNodeDataType_Names::VoiceCapable_Name);
  if (createNode) {
