...
bool ImpactDetailsType::deserialize(const boost::property_tree::ptree& propTree, uci::type::ImpactDetailsType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + ImpactDetailsType_Names::ApproachAngle_Name) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setImpactSpeed(extjson_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    } else if (valueType.first == nsPrefix + ImpactDetailsType_Names::ImpactPointDistanceFromDMPI_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setImpactPointDistanceFromDMPI(extjson_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    } else if (valueType.first == nsPrefix + ImpactDetailsType_Names::AccelerometerRecordedImpact_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setAccelerometerRecordedImpact(extjson_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
...
std::string ImpactDetailsType::serialize(const uci::type::ImpactDetailsType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, ImpactDetailsType_Names::Extern_Type_Name);
  }
  ...
  if (accessor.hasImpactSpeed()) {
    extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getImpactSpeed(), node, ImpactDetailsType_Names::ImpactSpeed_Name);
  }
  if (accessor.hasImpactPointDistanceFromDMPI()) {
    extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getImpactPointDistanceFromDMPI(), node, ImpactDetailsType_Names::ImpactPointDistanceFromDMPI_Name);
  }
  if (accessor.hasAccelerometerRecordedImpact()) {
    extjson_uci::util::SerializationHelpers::serializeBoolean(accessor.getAccelerometerRecordedImpact(), node, ImpactDetailsType_Names::AccelerometerRecordedImpact_Name);
  }
