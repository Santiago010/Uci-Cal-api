...
bool SubsystemConfigurationMT::deserialize(const boost::property_tree::ptree& propTree, uci::type::SubsystemConfigurationMT& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + SubsystemConfigurationMT_Names::ObjectState_Name) {
...
std::string SubsystemConfigurationMT::serialize(const uci::type::SubsystemConfigurationMT& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool topLevel) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, (topLevel ? SubsystemConfigurationMT_Names::Extern_Top_Type_Name : SubsystemConfigurationMT_Names::Extern_Type_Name));
  }
