...
bool PO_ComponentSettingsProductSettingsType::deserialize(const boost::property_tree::ptree& propTree, uci::type::PO_ComponentSettingsProductSettingsType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + PO_ComponentSettingsProductSettingsType_Names::GeneratorOutputID_Name) {
...
std::string PO_ComponentSettingsProductSettingsType::serialize(const uci::type::PO_ComponentSettingsProductSettingsType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, PO_ComponentSettingsProductSettingsType_Names::Extern_Type_Name);
  }
  ...
  if (accessor.hasProductRate()) {
    extjson_uci::util::SerializationHelpers::serializeUnsignedInt(accessor.getProductRate(), node, PO_ComponentSettingsProductSettingsType_Names::ProductRate_Name);
  }
  ...
  if (accessor.hasCompressionRatio()) {
    extjson_uci::util::SerializationHelpers::serializeFloat(accessor.getCompressionRatio(), node, PO_ComponentSettingsProductSettingsType_Names::CompressionRatio_Name);
  }
  if (accessor.hasProductSize()) {
    extjson_uci::util::SerializationHelpers::serializeUnsignedInt(accessor.getProductSize(), node, PO_ComponentSettingsProductSettingsType_Names::ProductSize_Name);
  }
  if (accessor.hasInterlaced()) {
    extjson_uci::util::SerializationHelpers::serializeBoolean(accessor.getInterlaced(), node, PO_ComponentSettingsProductSettingsType_Names::Interlaced_Name);
  }
