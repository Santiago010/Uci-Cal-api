...
bool SystemNotificationMDT::deserialize(const boost::property_tree::ptree& propTree, uci::type::SystemNotificationMDT& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + SystemNotificationMDT_Names::SystemSubjectID_Name) {
      ...
      NotificationPerspectiveEnum::deserializeList(valueType.second, accessor.getSystemPerspective());
...
std::string SystemNotificationMDT::serialize(const uci::type::SystemNotificationMDT& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, SystemNotificationMDT_Names::Extern_Type_Name);
  }
  ...
  {
    NotificationPerspectiveEnum::serializeList(accessor.getSystemPerspective(), node, SystemNotificationMDT_Names::SystemPerspective_Name);
  }
  {
