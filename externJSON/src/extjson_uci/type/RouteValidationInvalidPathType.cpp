...
bool RouteValidationInvalidPathType::deserialize(const boost::property_tree::ptree& propTree, uci::type::RouteValidationInvalidPathType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + RouteValidationInvalidPathType_Names::PathID_Name) {
...
std::string RouteValidationInvalidPathType::serialize(const uci::type::RouteValidationInvalidPathType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, RouteValidationInvalidPathType_Names::Extern_Type_Name);
  }
