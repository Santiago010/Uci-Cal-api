...
bool DesignationDataType::deserialize(const boost::property_tree::ptree& propTree, uci::type::DesignationDataType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = DesignationDataType_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + DesignationDataType_Names::DesignationID_Name) {
...
std::string DesignationDataType::serialize(const uci::type::DesignationDataType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, DesignationDataType_Names::Extern_Type_Name);
  }
  ...
  }
  {
    ...
    for (uci::type::DesignationDataType::ApplicableSystemID::size_type i = 0, end = boundedList.size(); i < end; ++i) {
      SystemID_Type::serialize(boundedList.at(i), node, DesignationDataType_Names::ApplicableSystemID_Name);
    }
  }
  if (createNode) {
