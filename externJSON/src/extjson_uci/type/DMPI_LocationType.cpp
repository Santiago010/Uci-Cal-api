...
bool DMPI_LocationType::deserialize(const boost::property_tree::ptree& propTree, uci::type::DMPI_LocationType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + DMPI_LocationType_Names::DMPI_Coordinates_Name) {
      extjson_uci::util::DerivedTypesDeserializer::deserialize(valueType.second, accessor.enableDMPI_Coordinates(extjson_uci::util::SerializationHelpers::checkForTypeAttribute(valueType.second, nsPrefix)), nodeName, nsPrefix);
    } else if (valueType.first == nsPrefix + DMPI_LocationType_Names::LinearErrorProbable_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setLinearErrorProbable(extjson_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    } else if (valueType.first == nsPrefix + DMPI_LocationType_Names::CircularErrorProbable_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setCircularErrorProbable(extjson_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
...
std::string DMPI_LocationType::serialize(const uci::type::DMPI_LocationType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, DMPI_LocationType_Names::Extern_Type_Name);
  }
  ...
  if (accessor.hasLinearErrorProbable()) {
    extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getLinearErrorProbable(), node, DMPI_LocationType_Names::LinearErrorProbable_Name);
  }
  if (accessor.hasCircularErrorProbable()) {
    extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getCircularErrorProbable(), node, DMPI_LocationType_Names::CircularErrorProbable_Name);
  }
  if (accessor.hasConfidence()) {
    extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getConfidence(), node, DMPI_LocationType_Names::Confidence_Name);
  }
  if (createNode) {
