...
bool ModeS_InterrogatorAddressType::deserialize(const boost::property_tree::ptree& propTree, uci::type::ModeS_InterrogatorAddressType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = ModeS_InterrogatorAddressType_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + ModeS_InterrogatorAddressType_Names::InterrogatorIdentifier_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setInterrogatorIdentifier(extjson_uci::util::SerializationHelpers::deserializeInt(*value));
      }
    } else if (valueType.first == nsPrefix + ModeS_InterrogatorAddressType_Names::SurveillanceIdentifier_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setSurveillanceIdentifier(extjson_uci::util::SerializationHelpers::deserializeInt(*value));
      }
    }
  }
  return true;
...
std::string ModeS_InterrogatorAddressType::serialize(const uci::type::ModeS_InterrogatorAddressType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, ModeS_InterrogatorAddressType_Names::Extern_Type_Name);
  }
  if (accessor.isInterrogatorIdentifier()) {
    extjson_uci::util::SerializationHelpers::serializeInt(accessor.getInterrogatorIdentifier(), node, ModeS_InterrogatorAddressType_Names::InterrogatorIdentifier_Name);
  } else if (accessor.isSurveillanceIdentifier()) {
    extjson_uci::util::SerializationHelpers::serializeInt(accessor.getSurveillanceIdentifier(), node, ModeS_InterrogatorAddressType_Names::SurveillanceIdentifier_Name);
  }
  if (createNode) {
