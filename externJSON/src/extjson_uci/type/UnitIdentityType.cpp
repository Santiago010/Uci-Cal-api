...
bool UnitIdentityType::deserialize(const boost::property_tree::ptree& propTree, uci::type::UnitIdentityType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + UnitIdentityType_Names::UnitUUID_Name) {
      ...
      OrderOfBattleEnum::deserializeList(valueType.second, accessor.getOB_Type());
...
std::string UnitIdentityType::serialize(const uci::type::UnitIdentityType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, UnitIdentityType_Names::Extern_Type_Name);
  }
  UnitID_Type::serialize(accessor.getUnitUUID(), node, UnitIdentityType_Names::UnitUUID_Name);
  extjson_uci::util::SerializationHelpers::serializeString(accessor.getIdentifier(), node, UnitIdentityType_Names::Identifier_Name);
  extjson_uci::util::SerializationHelpers::serializeString(accessor.getName(), node, UnitIdentityType_Names::Name_Name);
  extjson_uci::util::SerializationHelpers::serializeString(accessor.getSurrogateKey(), node, UnitIdentityType_Names::SurrogateKey_Name);
  {
    OrderOfBattleEnum::serializeList(accessor.getOB_Type(), node, UnitIdentityType_Names::OB_Type_Name);
  }
  if (accessor.hasSymbolCode()) {
    extjson_uci::util::SerializationHelpers::serializeString(accessor.getSymbolCode(), node, UnitIdentityType_Names::SymbolCode_Name);
  }
  if (createNode) {
