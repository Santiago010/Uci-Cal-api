...
bool MessageDestinationType::deserialize(const boost::property_tree::ptree& propTree, uci::type::MessageDestinationType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = MessageDestinationType_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + MessageDestinationType_Names::SystemID_Name) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setValidSystemStatus(extjson_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
...
std::string MessageDestinationType::serialize(const uci::type::MessageDestinationType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, MessageDestinationType_Names::Extern_Type_Name);
  }
  ...
  if (accessor.hasValidSystemStatus()) {
    extjson_uci::util::SerializationHelpers::serializeBoolean(accessor.getValidSystemStatus(), node, MessageDestinationType_Names::ValidSystemStatus_Name);
  }
  ...
  }
  {
    ...
    for (uci::type::MessageDestinationType::DataLinkNativeInfo::size_type i = 0, end = boundedList.size(); i < end; ++i) {
      DataLinkNativeInfoPET::serialize(boundedList.at(i), node, MessageDestinationType_Names::DataLinkNativeInfo_Name);
    }
  }
  if (createNode) {
