...
bool IFF_ActivityMT::deserialize(const boost::property_tree::ptree& propTree, uci::type::IFF_ActivityMT& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + IFF_ActivityMT_Names::ObjectState_Name) {
...
std::string IFF_ActivityMT::serialize(const uci::type::IFF_ActivityMT& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool topLevel) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, (topLevel ? IFF_ActivityMT_Names::Extern_Top_Type_Name : IFF_ActivityMT_Names::Extern_Type_Name));
  }
