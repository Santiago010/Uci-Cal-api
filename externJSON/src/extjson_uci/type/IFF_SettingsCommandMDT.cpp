...
bool IFF_SettingsCommandMDT::deserialize(const boost::property_tree::ptree& propTree, uci::type::IFF_SettingsCommandMDT& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + IFF_SettingsCommandMDT_Names::IFF_InterrogatorReceiverModesAvailable_Name) {
...
std::string IFF_SettingsCommandMDT::serialize(const uci::type::IFF_SettingsCommandMDT& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, IFF_SettingsCommandMDT_Names::Extern_Type_Name);
  }
  ...
  {
    IFF_MessageOutputsEnum::serializeList(accessor.getMessageOutput(), node, IFF_SettingsCommandMDT_Names::MessageOutput_Name);
  }
  if (accessor.hasUnassignAll()) {
    extjson_uci::util::SerializationHelpers::serializeBoolean(accessor.getUnassignAll(), node, IFF_SettingsCommandMDT_Names::UnassignAll_Name);
  }
