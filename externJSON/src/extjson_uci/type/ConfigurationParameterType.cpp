...
bool ConfigurationParameterType::deserialize(const boost::property_tree::ptree& propTree, uci::type::ConfigurationParameterType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + ConfigurationParameterType_Names::ParameterID_Name) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setUserModifiable(extjson_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
...
std::string ConfigurationParameterType::serialize(const uci::type::ConfigurationParameterType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, ConfigurationParameterType_Names::Extern_Type_Name);
  }
  ParameterID_Type::serialize(accessor.getParameterID(), node, ConfigurationParameterType_Names::ParameterID_Name);
  extjson_uci::util::SerializationHelpers::serializeString(accessor.getName(), node, ConfigurationParameterType_Names::Name_Name);
  extjson_uci::util::SerializationHelpers::serializeString(accessor.getValue(), node, ConfigurationParameterType_Names::Value_Name);
  extjson_uci::util::SerializationHelpers::serializeString(accessor.getDefaultValue(), node, ConfigurationParameterType_Names::DefaultValue_Name);
  extjson_uci::util::SerializationHelpers::serializeBoolean(accessor.getUserModifiable(), node, ConfigurationParameterType_Names::UserModifiable_Name);
  ...
  if (accessor.hasUnits()) {
    extjson_uci::util::SerializationHelpers::serializeString(accessor.getUnits(), node, ConfigurationParameterType_Names::Units_Name);
  }
  ...
  if (accessor.hasMissionEnvironment()) {
    extjson_uci::util::SerializationHelpers::serializeString(accessor.getMissionEnvironment(), node, ConfigurationParameterType_Names::MissionEnvironment_Name);
  }
  if (createNode) {
