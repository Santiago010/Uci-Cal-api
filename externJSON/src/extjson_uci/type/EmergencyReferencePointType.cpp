...
bool EmergencyReferencePointType::deserialize(const boost::property_tree::ptree& propTree, uci::type::EmergencyReferencePointType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + EmergencyReferencePointType_Names::Reference_Name) {
...
std::string EmergencyReferencePointType::serialize(const uci::type::EmergencyReferencePointType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, EmergencyReferencePointType_Names::Extern_Type_Name);
  }
  ...
  if (accessor.hasLastKnownPosition()) {
    extjson_uci::util::SerializationHelpers::serializeString(accessor.getLastKnownPosition(), node, EmergencyReferencePointType_Names::LastKnownPosition_Name);
  }
  if (createNode) {
