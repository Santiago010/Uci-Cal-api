...
bool PulseType::deserialize(const boost::property_tree::ptree& propTree, uci::type::PulseType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + PulseType_Names::ComponentID_Name) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setFrequency(extjson_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setAmplitude(extjson_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setPulseWidth(extjson_uci::util::SerializationHelpers::deserializeDuration(*value));
      }
    } else if (valueType.first == nsPrefix + PulseType_Names::PulseWidthDeviation_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setPulseWidthDeviation(extjson_uci::util::SerializationHelpers::deserializeDuration(*value));
      }
    } else if (valueType.first == nsPrefix + PulseType_Names::PulseWidthChopped_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setPulseWidthChopped(extjson_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
    } else if (valueType.first == nsPrefix + PulseType_Names::PulseOnPulse_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setPulseOnPulse(extjson_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setDynamicRangeExceeded(extjson_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
    } else if (valueType.first == nsPrefix + PulseType_Names::ThresholdDetection_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setThresholdDetection(extjson_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
    } else if (valueType.first == nsPrefix + PulseType_Names::HighPowerCorruption_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setHighPowerCorruption(extjson_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
    } else if (valueType.first == nsPrefix + PulseType_Names::OnboardInterference_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setOnboardInterference(extjson_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
    }
  }
  return true;
...
std::string PulseType::serialize(const uci::type::PulseType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, PulseType_Names::Extern_Type_Name);
  }
  ...
  extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getFrequency(), node, PulseType_Names::Frequency_Name);
  if (accessor.hasFrequencyDeviation()) {
    extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getFrequencyDeviation(), node, PulseType_Names::FrequencyDeviation_Name);
  }
  if (accessor.hasAmplitude()) {
    extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getAmplitude(), node, PulseType_Names::Amplitude_Name);
  }
  if (accessor.hasRelativeAmplitude()) {
    extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getRelativeAmplitude(), node, PulseType_Names::RelativeAmplitude_Name);
  }
  if (accessor.hasPulseWidth()) {
    extjson_uci::util::SerializationHelpers::serializeDuration(accessor.getPulseWidth(), node, PulseType_Names::PulseWidth_Name);
  }
  if (accessor.hasPulseWidthDeviation()) {
    extjson_uci::util::SerializationHelpers::serializeDuration(accessor.getPulseWidthDeviation(), node, PulseType_Names::PulseWidthDeviation_Name);
  }
  if (accessor.hasPulseWidthChopped()) {
    extjson_uci::util::SerializationHelpers::serializeBoolean(accessor.getPulseWidthChopped(), node, PulseType_Names::PulseWidthChopped_Name);
  }
  if (accessor.hasPulseOnPulse()) {
    extjson_uci::util::SerializationHelpers::serializeBoolean(accessor.getPulseOnPulse(), node, PulseType_Names::PulseOnPulse_Name);
  }
  if (accessor.hasSNR()) {
    extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getSNR(), node, PulseType_Names::SNR_Name);
  }
  {
  ...
  if (accessor.hasDynamicRangeExceeded()) {
    extjson_uci::util::SerializationHelpers::serializeBoolean(accessor.getDynamicRangeExceeded(), node, PulseType_Names::DynamicRangeExceeded_Name);
  }
  if (accessor.hasThresholdDetection()) {
    extjson_uci::util::SerializationHelpers::serializeBoolean(accessor.getThresholdDetection(), node, PulseType_Names::ThresholdDetection_Name);
  }
  if (accessor.hasHighPowerCorruption()) {
    extjson_uci::util::SerializationHelpers::serializeBoolean(accessor.getHighPowerCorruption(), node, PulseType_Names::HighPowerCorruption_Name);
  }
  if (accessor.hasOnboardInterference()) {
    extjson_uci::util::SerializationHelpers::serializeBoolean(accessor.getOnboardInterference(), node, PulseType_Names::OnboardInterference_Name);
  }
  if (createNode) {
