...
bool RuleResponseType::deserialize(const boost::property_tree::ptree& propTree, uci::type::RuleResponseType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = RuleResponseType_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + RuleResponseType_Names::RequirementsTemplate_Name) {
...
std::string RuleResponseType::serialize(const uci::type::RuleResponseType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, RuleResponseType_Names::Extern_Type_Name);
  }
  if (accessor.isRequirementsTemplate()) {
    ...
    extjson_uci::util::SerializationHelpers::serializeString(accessor.getDoNothing(), node, RuleResponseType_Names::DoNothing_Name);
  }
  if (createNode) {
