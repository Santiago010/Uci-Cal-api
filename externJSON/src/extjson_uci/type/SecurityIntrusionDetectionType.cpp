...
bool SecurityIntrusionDetectionType::deserialize(const boost::property_tree::ptree& propTree, uci::type::SecurityIntrusionDetectionType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = SecurityIntrusionDetectionType_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + SecurityIntrusionDetectionType_Names::Category_Name) {
...
std::string SecurityIntrusionDetectionType::serialize(const uci::type::SecurityIntrusionDetectionType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, SecurityIntrusionDetectionType_Names::Extern_Type_Name);
  }
  ...
  if (accessor.hasDetails()) {
    extjson_uci::util::SerializationHelpers::serializeString(accessor.getDetails(), node, SecurityIntrusionDetectionType_Names::Details_Name);
  }
  if (createNode) {
