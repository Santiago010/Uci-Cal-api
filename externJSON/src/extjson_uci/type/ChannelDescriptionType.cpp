...
bool ChannelDescriptionType::deserialize(const boost::property_tree::ptree& propTree, uci::type::ChannelDescriptionType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = ChannelDescriptionType_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + ChannelDescriptionType_Names::ComponentID_Name) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setGainStepSize(extjson_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    } else if (valueType.first == nsPrefix + ChannelDescriptionType_Names::BandsSupported_Name) {
      extjson_uci::util::SerializationHelpers::deserializeIntList(valueType.second, accessor.getBandsSupported());
    }
  }
  return true;
}
...
std::string ChannelDescriptionType::serialize(const uci::type::ChannelDescriptionType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, ChannelDescriptionType_Names::Extern_Type_Name);
  }
  ...
  if (accessor.hasGainStepSize()) {
    extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getGainStepSize(), node, ChannelDescriptionType_Names::GainStepSize_Name);
  }
  {
    extjson_uci::util::SerializationHelpers::serializeIntList(accessor.getBandsSupported(), node, ChannelDescriptionType_Names::BandsSupported_Name);
  }
  if (createNode) {
