...
bool OpaqueCapabilityStatusMT::deserialize(const boost::property_tree::ptree& propTree, uci::type::OpaqueCapabilityStatusMT& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + OpaqueCapabilityStatusMT_Names::MessageData_Name) {
...
std::string OpaqueCapabilityStatusMT::serialize(const uci::type::OpaqueCapabilityStatusMT& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool topLevel) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, (topLevel ? OpaqueCapabilityStatusMT_Names::Extern_Top_Type_Name : OpaqueCapabilityStatusMT_Names::Extern_Type_Name));
  }
