...
bool OrbitalDebrisEstimateMDT::deserialize(const boost::property_tree::ptree& propTree, uci::type::OrbitalDebrisEstimateMDT& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + OrbitalDebrisEstimateMDT_Names::OrbitalDebrisEstimateID_Name) {
...
std::string OrbitalDebrisEstimateMDT::serialize(const uci::type::OrbitalDebrisEstimateMDT& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, OrbitalDebrisEstimateMDT_Names::Extern_Type_Name);
  }
