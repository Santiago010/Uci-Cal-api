...
bool ESM_CommandStatusMT::deserialize(const boost::property_tree::ptree& propTree, uci::type::ESM_CommandStatusMT& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + ESM_CommandStatusMT_Names::MessageData_Name) {
...
std::string ESM_CommandStatusMT::serialize(const uci::type::ESM_CommandStatusMT& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool topLevel) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, (topLevel ? ESM_CommandStatusMT_Names::Extern_Top_Type_Name : ESM_CommandStatusMT_Names::Extern_Type_Name));
  }
