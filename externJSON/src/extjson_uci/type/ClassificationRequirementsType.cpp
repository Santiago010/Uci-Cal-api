...
bool ClassificationRequirementsType::deserialize(const boost::property_tree::ptree& propTree, uci::type::ClassificationRequirementsType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + ClassificationRequirementsType_Names::InputProduct_Name) {
...
std::string ClassificationRequirementsType::serialize(const uci::type::ClassificationRequirementsType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, ClassificationRequirementsType_Names::Extern_Type_Name);
  }
  {
