...
bool SystemsNeededRequestMT::deserialize(const boost::property_tree::ptree& propTree, uci::type::SystemsNeededRequestMT& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + SystemsNeededRequestMT_Names::MessageData_Name) {
...
std::string SystemsNeededRequestMT::serialize(const uci::type::SystemsNeededRequestMT& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool topLevel) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, (topLevel ? SystemsNeededRequestMT_Names::Extern_Top_Type_Name : SystemsNeededRequestMT_Names::Extern_Type_Name));
  }
