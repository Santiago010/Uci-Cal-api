...
bool SensorCharacterizationChoiceType::deserialize(const boost::property_tree::ptree& propTree, uci::type::SensorCharacterizationChoiceType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + SensorCharacterizationChoiceType_Names::PhemonemologySpecific_Name) {
...
std::string SensorCharacterizationChoiceType::serialize(const uci::type::SensorCharacterizationChoiceType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, SensorCharacterizationChoiceType_Names::Extern_Type_Name);
  }
