...
bool PMOP_SequenceType::deserialize(const boost::property_tree::ptree& propTree, uci::type::PMOP_SequenceType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = PMOP_SequenceType_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + PMOP_SequenceType_Names::PMOP_SequencePhase_Name) {
      PMOP_SequenceEnum::deserializeList(valueType.second, accessor.getPMOP_SequencePhase());
    } else if (valueType.first == nsPrefix + PMOP_SequenceType_Names::PMOP_SequenceLength_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setPMOP_SequenceLength(extjson_uci::util::SerializationHelpers::deserializeUnsignedInt(*value));
      }
    }
  }
  return true;
...
std::string PMOP_SequenceType::serialize(const uci::type::PMOP_SequenceType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, PMOP_SequenceType_Names::Extern_Type_Name);
  }
  if (accessor.isPMOP_SequencePhase()) {
    {
      PMOP_SequenceEnum::serializeList(accessor.getPMOP_SequencePhase(), node, PMOP_SequenceType_Names::PMOP_SequencePhase_Name);
    }
  } else if (accessor.isPMOP_SequenceLength()) {
    extjson_uci::util::SerializationHelpers::serializeUnsignedInt(accessor.getPMOP_SequenceLength(), node, PMOP_SequenceType_Names::PMOP_SequenceLength_Name);
  }
  if (createNode) {
