...
bool CounterSpaceDeconflictionMDT::deserialize(const boost::property_tree::ptree& propTree, uci::type::CounterSpaceDeconflictionMDT& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + CounterSpaceDeconflictionMDT_Names::CounterSpaceDeconflictionID_Name) {
...
std::string CounterSpaceDeconflictionMDT::serialize(const uci::type::CounterSpaceDeconflictionMDT& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, CounterSpaceDeconflictionMDT_Names::Extern_Type_Name);
  }
