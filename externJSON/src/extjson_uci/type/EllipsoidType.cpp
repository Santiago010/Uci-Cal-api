...
bool EllipsoidType::deserialize(const boost::property_tree::ptree& propTree, uci::type::EllipsoidType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = EllipsoidType_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + EllipsoidType_Names::SemiMajorAxisLength_A_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setSemiMajorAxisLength_A(extjson_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    } else if (valueType.first == nsPrefix + EllipsoidType_Names::SemiMinorAxisLength_B_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setSemiMinorAxisLength_B(extjson_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    } else if (valueType.first == nsPrefix + EllipsoidType_Names::SemiMinorAxisLength_C_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setSemiMinorAxisLength_C(extjson_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
...
std::string EllipsoidType::serialize(const uci::type::EllipsoidType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, EllipsoidType_Names::Extern_Type_Name);
  }
  extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getSemiMajorAxisLength_A(), node, EllipsoidType_Names::SemiMajorAxisLength_A_Name);
  extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getSemiMinorAxisLength_B(), node, EllipsoidType_Names::SemiMinorAxisLength_B_Name);
  extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getSemiMinorAxisLength_C(), node, EllipsoidType_Names::SemiMinorAxisLength_C_Name);
