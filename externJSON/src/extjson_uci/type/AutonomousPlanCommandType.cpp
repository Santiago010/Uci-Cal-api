...
bool AutonomousPlanCommandType::deserialize(const boost::property_tree::ptree& propTree, uci::type::AutonomousPlanCommandType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = AutonomousPlanCommandType_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + AutonomousPlanCommandType_Names::PlanningProcessID_Name) {
      ...
      extjson_uci::util::DerivedTypesDeserializer::deserialize(valueType.second, accessor.enableConstrainingPlans(extjson_uci::util::SerializationHelpers::checkForTypeAttribute(valueType.second, nsPrefix)), nodeName, nsPrefix);
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        ...
        AutonomousPlanningOtherSystemConstrainingPlansType::deserialize(valueType.second, boundedList.at(boundedListSize), nodeName, nsPrefix);
      }
    } else if (valueType.first == nsPrefix + AutonomousPlanCommandType_Names::OutputPlanParts_Name) {
      extjson_uci::util::DerivedTypesDeserializer::deserialize(valueType.second, accessor.enableOutputPlanParts(extjson_uci::util::SerializationHelpers::checkForTypeAttribute(valueType.second, nsPrefix)), nodeName, nsPrefix);
...
std::string AutonomousPlanCommandType::serialize(const uci::type::AutonomousPlanCommandType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool checkIfDerivation, const bool /*topLevel*/) {
  ...
  if (!checkIfDerivation || (accessor.getAccessorType() == uci::type::accessorType::autonomousPlanCommandType)) {
    ...
    if (addTypeAttribute) {
      extjson_uci::util::SerializationHelpers::addTypeAttribute(node, AutonomousPlanCommandType_Names::Extern_Type_Name);
    }
    ...
    }
    {
      ...
      for (uci::type::AutonomousPlanCommandType::OtherSystemConstrainingPlans::size_type i = 0, end = boundedList.size(); i < end; ++i) {
        AutonomousPlanningOtherSystemConstrainingPlansType::serialize(boundedList.at(i), node, AutonomousPlanCommandType_Names::OtherSystemConstrainingPlans_Name);
      }
    }
    ...
    extjson_uci::util::SerializationHelpers::serializeBoolean(accessor.getResultsInMissionPlan(), node, AutonomousPlanCommandType_Names::ResultsInMissionPlan_Name);
    extjson_uci::util::SerializationHelpers::serializeBoolean(accessor.getForPlanningUseOnly(), node, AutonomousPlanCommandType_Names::ForPlanningUseOnly_Name);
    if (createNode) {
