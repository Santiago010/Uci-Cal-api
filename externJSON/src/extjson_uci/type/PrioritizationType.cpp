...
bool PrioritizationType::deserialize(const boost::property_tree::ptree& propTree, uci::type::PrioritizationType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = PrioritizationType_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + PrioritizationType_Names::PriorityValue_Name) {
...
std::string PrioritizationType::serialize(const uci::type::PrioritizationType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, PrioritizationType_Names::Extern_Type_Name);
  }
