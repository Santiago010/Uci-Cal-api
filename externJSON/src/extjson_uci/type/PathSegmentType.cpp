...
bool PathSegmentType::deserialize(const boost::property_tree::ptree& propTree, uci::type::PathSegmentType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + PathSegmentType_Names::PathSegmentID_Name) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setMaximumRoll(extjson_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    } else if (valueType.first == nsPrefix + PathSegmentType_Names::Acceleration_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setAcceleration(extjson_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setRequiredNavigationPerformanceInMeters(extjson_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    } else if (valueType.first == nsPrefix + PathSegmentType_Names::Fix_Identifier_Name) {
      extjson_uci::util::DerivedTypesDeserializer::deserialize(valueType.second, accessor.enableFix_Identifier(extjson_uci::util::SerializationHelpers::checkForTypeAttribute(valueType.second, nsPrefix)), nodeName, nsPrefix);
    }
  }
  return true;
}
...
std::string PathSegmentType::serialize(const uci::type::PathSegmentType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, PathSegmentType_Names::Extern_Type_Name);
  }
  ...
  if (accessor.hasLocked()) {
    extjson_uci::util::SerializationHelpers::serializeBoolean(accessor.getLocked(), node, PathSegmentType_Names::Locked_Name);
  }
  if (accessor.hasModified()) {
    extjson_uci::util::SerializationHelpers::serializeBoolean(accessor.getModified(), node, PathSegmentType_Names::Modified_Name);
  }
  ...
  if (accessor.hasMaximumRoll()) {
    extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getMaximumRoll(), node, PathSegmentType_Names::MaximumRoll_Name);
  }
  if (accessor.hasAcceleration()) {
    extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getAcceleration(), node, PathSegmentType_Names::Acceleration_Name);
  }
  ...
  if (accessor.hasRequiredNavigationPerformanceInMeters()) {
    extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getRequiredNavigationPerformanceInMeters(), node, PathSegmentType_Names::RequiredNavigationPerformanceInMeters_Name);
  }
