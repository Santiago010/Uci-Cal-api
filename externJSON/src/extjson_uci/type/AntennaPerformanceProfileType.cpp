...
bool AntennaPerformanceProfileType::deserialize(const boost::property_tree::ptree& propTree, uci::type::AntennaPerformanceProfileType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + AntennaPerformanceProfileType_Names::DeltaInputPowerConsumption_Name) {
      ...
      extjson_uci::util::DerivedTypesDeserializer::deserialize(valueType.second, accessor.enableElevationFieldOfRegard(extjson_uci::util::SerializationHelpers::checkForTypeAttribute(valueType.second, nsPrefix)), nodeName, nsPrefix);
    } else if (valueType.first == nsPrefix + AntennaPerformanceProfileType_Names::AzimuthFieldOfRegard_Name) {
      extjson_uci::util::DerivedTypesDeserializer::deserialize(valueType.second, accessor.enableAzimuthFieldOfRegard(extjson_uci::util::SerializationHelpers::checkForTypeAttribute(valueType.second, nsPrefix)), nodeName, nsPrefix);
...
std::string AntennaPerformanceProfileType::serialize(const uci::type::AntennaPerformanceProfileType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, AntennaPerformanceProfileType_Names::Extern_Type_Name);
  }
  if (accessor.hasDeltaInputPowerConsumption()) {
    extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getDeltaInputPowerConsumption(), node, AntennaPerformanceProfileType_Names::DeltaInputPowerConsumption_Name);
  }
  ...
  extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getDutyFactorLimit(), node, AntennaPerformanceProfileType_Names::DutyFactorLimit_Name);
  extjson_uci::util::SerializationHelpers::serializeUnsignedInt(accessor.getBeamLimit(), node, AntennaPerformanceProfileType_Names::BeamLimit_Name);
