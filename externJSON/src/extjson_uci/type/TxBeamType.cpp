...
bool TxBeamType::deserialize(const boost::property_tree::ptree& propTree, uci::type::TxBeamType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + TxBeamType_Names::BeamID_Name) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setDutyCycle(extjson_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    } else if (valueType.first == nsPrefix + TxBeamType_Names::EffectiveRadiatedPower_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setEffectiveRadiatedPower(extjson_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
      ...
      extjson_uci::util::DerivedTypesDeserializer::deserialize(valueType.second, accessor.enableStartPosition(extjson_uci::util::SerializationHelpers::checkForTypeAttribute(valueType.second, nsPrefix)), nodeName, nsPrefix);
...
std::string TxBeamType::serialize(const uci::type::TxBeamType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, TxBeamType_Names::Extern_Type_Name);
  }
  BeamID_Type::serialize(accessor.getBeamID(), node, TxBeamType_Names::BeamID_Name);
  if (accessor.hasDutyCycle()) {
    extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getDutyCycle(), node, TxBeamType_Names::DutyCycle_Name);
  }
  if (accessor.hasEffectiveRadiatedPower()) {
    extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getEffectiveRadiatedPower(), node, TxBeamType_Names::EffectiveRadiatedPower_Name);
  }
  extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getAzimuthWidth(), node, TxBeamType_Names::AzimuthWidth_Name);
  extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getElevationWidth(), node, TxBeamType_Names::ElevationWidth_Name);
