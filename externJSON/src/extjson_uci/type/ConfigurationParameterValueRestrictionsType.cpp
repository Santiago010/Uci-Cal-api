...
bool ConfigurationParameterValueRestrictionsType::deserialize(const boost::property_tree::ptree& propTree, uci::type::ConfigurationParameterValueRestrictionsType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = ConfigurationParameterValueRestrictionsType_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + ConfigurationParameterValueRestrictionsType_Names::Enumeration_Name) {
      extjson_uci::util::SerializationHelpers::deserializeStringList(valueType.second, accessor.getEnumeration());
...
std::string ConfigurationParameterValueRestrictionsType::serialize(const uci::type::ConfigurationParameterValueRestrictionsType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, ConfigurationParameterValueRestrictionsType_Names::Extern_Type_Name);
  }
  if (accessor.isEnumeration()) {
    {
      extjson_uci::util::SerializationHelpers::serializeStringList(accessor.getEnumeration(), node, ConfigurationParameterValueRestrictionsType_Names::Enumeration_Name);
    }
