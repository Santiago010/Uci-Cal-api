...
bool EmconOverrideType::deserialize(const boost::property_tree::ptree& propTree, uci::type::EmconOverrideType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = EmconOverrideType_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + EmconOverrideType_Names::EmconLevel_Name) {
...
std::string EmconOverrideType::serialize(const uci::type::EmconOverrideType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, EmconOverrideType_Names::Extern_Type_Name);
  }
