...
bool ExecutionSequenceModificationDetailsType::deserialize(const boost::property_tree::ptree& propTree, uci::type::ExecutionSequenceModificationDetailsType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + ExecutionSequenceModificationDetailsType_Names::InsertExecutionSequence_Name) {
...
std::string ExecutionSequenceModificationDetailsType::serialize(const uci::type::ExecutionSequenceModificationDetailsType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, ExecutionSequenceModificationDetailsType_Names::Extern_Type_Name);
  }
