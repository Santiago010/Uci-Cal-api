...
bool EntityManagementSetFusionEligibilityType::deserialize(const boost::property_tree::ptree& propTree, uci::type::EntityManagementSetFusionEligibilityType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = EntityManagementSetFusionEligibilityType_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + EntityManagementSetFusionEligibilityType_Names::EntityID_Name) {
...
std::string EntityManagementSetFusionEligibilityType::serialize(const uci::type::EntityManagementSetFusionEligibilityType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, EntityManagementSetFusionEligibilityType_Names::Extern_Type_Name);
  }
  {
    ...
    for (uci::type::EntityManagementSetFusionEligibilityType::EntityID::size_type i = 0, end = boundedList.size(); i < end; ++i) {
      EntityID_Type::serialize(boundedList.at(i), node, EntityManagementSetFusionEligibilityType_Names::EntityID_Name);
    }
  }
  ...
  }
  {
    ...
    for (uci::type::EntityManagementSetFusionEligibilityType::CorrelatedEntityID::size_type i = 0, end = boundedList.size(); i < end; ++i) {
      EntityID_Type::serialize(boundedList.at(i), node, EntityManagementSetFusionEligibilityType_Names::CorrelatedEntityID_Name);
    }
  }
  if (createNode) {
