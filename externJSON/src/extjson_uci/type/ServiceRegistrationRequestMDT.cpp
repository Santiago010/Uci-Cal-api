...
bool ServiceRegistrationRequestMDT::deserialize(const boost::property_tree::ptree& propTree, uci::type::ServiceRegistrationRequestMDT& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + ServiceRegistrationRequestMDT_Names::ServiceID_Name) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setUnregisterFlag(extjson_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
...
std::string ServiceRegistrationRequestMDT::serialize(const uci::type::ServiceRegistrationRequestMDT& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, ServiceRegistrationRequestMDT_Names::Extern_Type_Name);
  }
  ...
  if (accessor.hasUnregisterFlag()) {
    extjson_uci::util::SerializationHelpers::serializeBoolean(accessor.getUnregisterFlag(), node, ServiceRegistrationRequestMDT_Names::UnregisterFlag_Name);
  }
