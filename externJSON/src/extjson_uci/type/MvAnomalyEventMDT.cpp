...
bool MvAnomalyEventMDT::deserialize(const boost::property_tree::ptree& propTree, uci::type::MvAnomalyEventMDT& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + MvAnomalyEventMDT_Names::MvAnomalyEventID_Name) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setMvExpected(extjson_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    } else if (valueType.first == nsPrefix + MvAnomalyEventMDT_Names::MvVariance_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setMvVariance(extjson_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    }
  }
...
std::string MvAnomalyEventMDT::serialize(const uci::type::MvAnomalyEventMDT& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, MvAnomalyEventMDT_Names::Extern_Type_Name);
  }
  ...
  if (accessor.hasMvExpected()) {
    extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getMvExpected(), node, MvAnomalyEventMDT_Names::MvExpected_Name);
  }
  if (accessor.hasMvVariance()) {
    extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getMvVariance(), node, MvAnomalyEventMDT_Names::MvVariance_Name);
  }
  if (createNode) {
