...
bool SeparationParametersType::deserialize(const boost::property_tree::ptree& propTree, uci::type::SeparationParametersType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = SeparationParametersType_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + SeparationParametersType_Names::AltitudeDistance_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setAltitudeDistance(extjson_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    } else if (valueType.first == nsPrefix + SeparationParametersType_Names::HorizontalDistance_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setHorizontalDistance(extjson_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    } else if (valueType.first == nsPrefix + SeparationParametersType_Names::ForwardDistance_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setForwardDistance(extjson_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    } else if (valueType.first == nsPrefix + SeparationParametersType_Names::TrailingDistance_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setTrailingDistance(extjson_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    }
  }
  return true;
...
std::string SeparationParametersType::serialize(const uci::type::SeparationParametersType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool checkIfDerivation, const bool /*topLevel*/) {
  ...
  if (!checkIfDerivation || (accessor.getAccessorType() == uci::type::accessorType::separationParametersType)) {
    ...
    if (addTypeAttribute) {
      extjson_uci::util::SerializationHelpers::addTypeAttribute(node, SeparationParametersType_Names::Extern_Type_Name);
    }
    extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getAltitudeDistance(), node, SeparationParametersType_Names::AltitudeDistance_Name);
    extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getHorizontalDistance(), node, SeparationParametersType_Names::HorizontalDistance_Name);
    extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getForwardDistance(), node, SeparationParametersType_Names::ForwardDistance_Name);
    extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getTrailingDistance(), node, SeparationParametersType_Names::TrailingDistance_Name);
    if (createNode) {
