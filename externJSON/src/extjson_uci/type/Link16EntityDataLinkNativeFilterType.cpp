...
bool Link16EntityDataLinkNativeFilterType::deserialize(const boost::property_tree::ptree& propTree, uci::type::Link16EntityDataLinkNativeFilterType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + Link16EntityDataLinkNativeFilterType_Names::GatewayClass_Name) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setSpecialProcessingIndicator(extjson_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
    } else if (valueType.first == nsPrefix + Link16EntityDataLinkNativeFilterType_Names::SimulationIndicator_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setSimulationIndicator(extjson_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
    } else if (valueType.first == nsPrefix + Link16EntityDataLinkNativeFilterType_Names::TargetSorting12_6_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setTargetSorting12_6(extjson_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
    } else if (valueType.first == nsPrefix + Link16EntityDataLinkNativeFilterType_Names::Track3X_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setTrack3X(extjson_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
    } else if (valueType.first == nsPrefix + Link16EntityDataLinkNativeFilterType_Names::Link16NPG_Name) {
      extjson_uci::util::SerializationHelpers::deserializeUnsignedShortList(valueType.second, accessor.getLink16NPG());
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setNumber(extjson_uci::util::SerializationHelpers::deserializeUnsignedInt(*value));
      }
...
std::string Link16EntityDataLinkNativeFilterType::serialize(const uci::type::Link16EntityDataLinkNativeFilterType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, Link16EntityDataLinkNativeFilterType_Names::Extern_Type_Name);
  }
  ...
  extjson_uci::util::SerializationHelpers::serializeBoolean(accessor.getSpecialProcessingIndicator(), node, Link16EntityDataLinkNativeFilterType_Names::SpecialProcessingIndicator_Name);
  extjson_uci::util::SerializationHelpers::serializeBoolean(accessor.getSimulationIndicator(), node, Link16EntityDataLinkNativeFilterType_Names::SimulationIndicator_Name);
  extjson_uci::util::SerializationHelpers::serializeBoolean(accessor.getTargetSorting12_6(), node, Link16EntityDataLinkNativeFilterType_Names::TargetSorting12_6_Name);
  extjson_uci::util::SerializationHelpers::serializeBoolean(accessor.getTrack3X(), node, Link16EntityDataLinkNativeFilterType_Names::Track3X_Name);
  {
    extjson_uci::util::SerializationHelpers::serializeUnsignedShortList(accessor.getLink16NPG(), node, Link16EntityDataLinkNativeFilterType_Names::Link16NPG_Name);
  }
  ...
  if (accessor.hasNumber()) {
    extjson_uci::util::SerializationHelpers::serializeUnsignedInt(accessor.getNumber(), node, Link16EntityDataLinkNativeFilterType_Names::Number_Name);
  }
