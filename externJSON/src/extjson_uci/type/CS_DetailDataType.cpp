...
bool CS_DetailDataType::deserialize(const boost::property_tree::ptree& propTree, uci::type::CS_DetailDataType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + CS_DetailDataType_Names::Name_Name) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setUplinkFrequency(extjson_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setDownlinkFrequency(extjson_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setBandwidth(extjson_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
...
std::string CS_DetailDataType::serialize(const uci::type::CS_DetailDataType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, CS_DetailDataType_Names::Extern_Type_Name);
  }
  extjson_uci::util::SerializationHelpers::serializeString(accessor.getName(), node, CS_DetailDataType_Names::Name_Name);
  ...
  if (accessor.hasUplinkFrequency()) {
    extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getUplinkFrequency(), node, CS_DetailDataType_Names::UplinkFrequency_Name);
  }
  ...
  if (accessor.hasDownlinkFrequency()) {
    extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getDownlinkFrequency(), node, CS_DetailDataType_Names::DownlinkFrequency_Name);
  }
  ...
  if (accessor.hasBandwidth()) {
    extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getBandwidth(), node, CS_DetailDataType_Names::Bandwidth_Name);
  }
