...
bool SAR_DesiredWaveformType::deserialize(const boost::property_tree::ptree& propTree, uci::type::SAR_DesiredWaveformType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = SAR_DesiredWaveformType_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + SAR_DesiredWaveformType_Names::WaveformType_Name) {
...
std::string SAR_DesiredWaveformType::serialize(const uci::type::SAR_DesiredWaveformType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, SAR_DesiredWaveformType_Names::Extern_Type_Name);
  }
