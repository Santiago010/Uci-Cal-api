...
bool RequirementOptionsInputsType::deserialize(const boost::property_tree::ptree& propTree, uci::type::RequirementOptionsInputsType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + RequirementOptionsInputsType_Names::OptionsCandidate_Name) {
...
std::string RequirementOptionsInputsType::serialize(const uci::type::RequirementOptionsInputsType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, RequirementOptionsInputsType_Names::Extern_Type_Name);
  }
  {
