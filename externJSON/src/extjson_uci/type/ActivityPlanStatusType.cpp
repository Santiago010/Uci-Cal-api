...
bool ActivityPlanStatusType::deserialize(const boost::property_tree::ptree& propTree, uci::type::ActivityPlanStatusType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = ActivityPlanStatusType_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + ActivityPlanStatusType_Names::PlanPart_Name) {
...
std::string ActivityPlanStatusType::serialize(const uci::type::ActivityPlanStatusType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, ActivityPlanStatusType_Names::Extern_Type_Name);
  }
  PlanStatusType::serialize(accessor, node, "", false, false, false);
  {
    ActivityPlanPartsEnum::serializeList(accessor.getPlanPart(), node, ActivityPlanStatusType_Names::PlanPart_Name);
  }
  if (createNode) {
