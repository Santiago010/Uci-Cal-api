...
bool SubsystemMaintenanceTestPET::deserialize(const boost::property_tree::ptree& propTree, uci::type::SubsystemMaintenanceTestPET& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + SubsystemMaintenanceTestPET_Names::TestID_Name) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setMaintenanceTestType(extjson_uci::util::SerializationHelpers::deserializeUnsignedInt(*value));
      }
...
std::string SubsystemMaintenanceTestPET::serialize(const uci::type::SubsystemMaintenanceTestPET& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool checkIfDerivation, const bool /*topLevel*/) {
  ...
  if (!checkIfDerivation || (accessor.getAccessorType() == uci::type::accessorType::subsystemMaintenanceTestPET)) {
    ...
    if (addTypeAttribute) {
      extjson_uci::util::SerializationHelpers::addTypeAttribute(node, SubsystemMaintenanceTestPET_Names::Extern_Type_Name);
    }
    ...
    if (accessor.hasDescription()) {
      extjson_uci::util::SerializationHelpers::serializeString(accessor.getDescription(), node, SubsystemMaintenanceTestPET_Names::Description_Name);
    }
    {
    ...
    if (accessor.hasMaintenanceTestType()) {
      extjson_uci::util::SerializationHelpers::serializeUnsignedInt(accessor.getMaintenanceTestType(), node, SubsystemMaintenanceTestPET_Names::MaintenanceTestType_Name);
    }
    {
    ...
    if (accessor.hasSubsystemMaintenanceItemName()) {
      extjson_uci::util::SerializationHelpers::serializeString(accessor.getSubsystemMaintenanceItemName(), node, SubsystemMaintenanceTestPET_Names::SubsystemMaintenanceItemName_Name);
    }
    if (createNode) {
