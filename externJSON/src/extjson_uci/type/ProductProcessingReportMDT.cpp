...
bool ProductProcessingReportMDT::deserialize(const boost::property_tree::ptree& propTree, uci::type::ProductProcessingReportMDT& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + ProductProcessingReportMDT_Names::ProductProcessingReportID_Name) {
...
std::string ProductProcessingReportMDT::serialize(const uci::type::ProductProcessingReportMDT& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, ProductProcessingReportMDT_Names::Extern_Type_Name);
  }
