...
bool DigitalFunctionType::deserialize(const boost::property_tree::ptree& propTree, uci::type::DigitalFunctionType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = DigitalFunctionType_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + DigitalFunctionType_Names::DigitalPayloadCapabilityID_Name) {
...
std::string DigitalFunctionType::serialize(const uci::type::DigitalFunctionType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, DigitalFunctionType_Names::Extern_Type_Name);
  }
