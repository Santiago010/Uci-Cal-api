...
bool PO_ComponentStatusProductGeneratorSettingsType::deserialize(const boost::property_tree::ptree& propTree, uci::type::PO_ComponentStatusProductGeneratorSettingsType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + PO_ComponentStatusProductGeneratorSettingsType_Names::GeneratorSettings_Name) {
...
std::string PO_ComponentStatusProductGeneratorSettingsType::serialize(const uci::type::PO_ComponentStatusProductGeneratorSettingsType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, PO_ComponentStatusProductGeneratorSettingsType_Names::Extern_Type_Name);
  }
  ...
  extjson_uci::util::SerializationHelpers::serializeBoolean(accessor.getAutoGeneratorSettings(), node, PO_ComponentStatusProductGeneratorSettingsType_Names::AutoGeneratorSettings_Name);
  if (createNode) {
