...
bool CargoStatusMDT::deserialize(const boost::property_tree::ptree& propTree, uci::type::CargoStatusMDT& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + CargoStatusMDT_Names::CargoID_Name) {
...
std::string CargoStatusMDT::serialize(const uci::type::CargoStatusMDT& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, CargoStatusMDT_Names::Extern_Type_Name);
  }
