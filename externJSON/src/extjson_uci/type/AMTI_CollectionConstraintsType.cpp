...
bool AMTI_CollectionConstraintsType::deserialize(const boost::property_tree::ptree& propTree, uci::type::AMTI_CollectionConstraintsType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = AMTI_CollectionConstraintsType_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + AMTI_CollectionConstraintsType_Names::SurfaceMoverVelocityGate_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setSurfaceMoverVelocityGate(extjson_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
...
std::string AMTI_CollectionConstraintsType::serialize(const uci::type::AMTI_CollectionConstraintsType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, AMTI_CollectionConstraintsType_Names::Extern_Type_Name);
  }
  CollectionConstraintsType::serialize(accessor, node, "", false, false, false);
  if (accessor.hasSurfaceMoverVelocityGate()) {
    extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getSurfaceMoverVelocityGate(), node, AMTI_CollectionConstraintsType_Names::SurfaceMoverVelocityGate_Name);
  }
  if (accessor.hasTargetRCS()) {
    extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getTargetRCS(), node, AMTI_CollectionConstraintsType_Names::TargetRCS_Name);
  }
  if (accessor.hasFalseAlarmLevel()) {
    extjson_uci::util::SerializationHelpers::serializeUnsignedByte(accessor.getFalseAlarmLevel(), node, AMTI_CollectionConstraintsType_Names::FalseAlarmLevel_Name);
  }
  ...
  }
  {
    ...
    for (uci::type::AMTI_CollectionConstraintsType::TargetRadialVelocity::size_type i = 0, end = boundedList.size(); i < end; ++i) {
      SpeedRangeType::serialize(boundedList.at(i), node, AMTI_CollectionConstraintsType_Names::TargetRadialVelocity_Name);
    }
  }
  if (createNode) {
