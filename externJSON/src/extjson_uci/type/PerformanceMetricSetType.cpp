...
bool PerformanceMetricSetType::deserialize(const boost::property_tree::ptree& propTree, uci::type::PerformanceMetricSetType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + PerformanceMetricSetType_Names::PerformanceConstraintIndex_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setPerformanceConstraintIndex(extjson_uci::util::SerializationHelpers::deserializeUnsignedInt(*value));
      }
    } else if (valueType.first == nsPrefix + PerformanceMetricSetType_Names::Merit_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setMerit(extjson_uci::util::SerializationHelpers::deserializeInt(*value));
      }
...
std::string PerformanceMetricSetType::serialize(const uci::type::PerformanceMetricSetType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, PerformanceMetricSetType_Names::Extern_Type_Name);
  }
  extjson_uci::util::SerializationHelpers::serializeUnsignedInt(accessor.getPerformanceConstraintIndex(), node, PerformanceMetricSetType_Names::PerformanceConstraintIndex_Name);
  extjson_uci::util::SerializationHelpers::serializeInt(accessor.getMerit(), node, PerformanceMetricSetType_Names::Merit_Name);
