...
bool RouteModificationRequestMDT::deserialize(const boost::property_tree::ptree& propTree, uci::type::RouteModificationRequestMDT& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + RouteModificationRequestMDT_Names::Source_Name) {
...
std::string RouteModificationRequestMDT::serialize(const uci::type::RouteModificationRequestMDT& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, RouteModificationRequestMDT_Names::Extern_Type_Name);
  }
  ...
  if (accessor.hasDetailed()) {
    extjson_uci::util::SerializationHelpers::serializeBoolean(accessor.getDetailed(), node, RouteModificationRequestMDT_Names::Detailed_Name);
  }
