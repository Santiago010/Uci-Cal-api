...
bool RefuelCapabilityDrogueCommonType::deserialize(const boost::property_tree::ptree& propTree, uci::type::RefuelCapabilityDrogueCommonType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + RefuelCapabilityDrogueCommonType_Names::Power_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setPower(extjson_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setScheduledFuelToBeDelivered(extjson_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
...
std::string RefuelCapabilityDrogueCommonType::serialize(const uci::type::RefuelCapabilityDrogueCommonType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool checkIfDerivation, const bool /*topLevel*/) {
  ...
  if (!checkIfDerivation || (accessor.getAccessorType() == uci::type::accessorType::refuelCapabilityDrogueCommonType)) {
    ...
    if (addTypeAttribute) {
      extjson_uci::util::SerializationHelpers::addTypeAttribute(node, RefuelCapabilityDrogueCommonType_Names::Extern_Type_Name);
    }
    if (accessor.hasPower()) {
      extjson_uci::util::SerializationHelpers::serializeBoolean(accessor.getPower(), node, RefuelCapabilityDrogueCommonType_Names::Power_Name);
    }
    if (accessor.hasHose()) {
    ...
    if (accessor.hasSelectForJettison()) {
      extjson_uci::util::SerializationHelpers::serializeBoolean(accessor.getSelectForJettison(), node, RefuelCapabilityDrogueCommonType_Names::SelectForJettison_Name);
    }
    if (accessor.hasScheduledFuelToBeDelivered()) {
      extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getScheduledFuelToBeDelivered(), node, RefuelCapabilityDrogueCommonType_Names::ScheduledFuelToBeDelivered_Name);
    }
