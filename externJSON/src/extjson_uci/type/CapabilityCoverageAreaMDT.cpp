...
bool CapabilityCoverageAreaMDT::deserialize(const boost::property_tree::ptree& propTree, uci::type::CapabilityCoverageAreaMDT& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + CapabilityCoverageAreaMDT_Names::CapabilityCoverageAreaID_Name) {
...
std::string CapabilityCoverageAreaMDT::serialize(const uci::type::CapabilityCoverageAreaMDT& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, CapabilityCoverageAreaMDT_Names::Extern_Type_Name);
  }
