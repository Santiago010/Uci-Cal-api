...
bool ResponseOptionTriggerType::deserialize(const boost::property_tree::ptree& propTree, uci::type::ResponseOptionTriggerType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + ResponseOptionTriggerType_Names::Entity_Name) {
...
std::string ResponseOptionTriggerType::serialize(const uci::type::ResponseOptionTriggerType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, ResponseOptionTriggerType_Names::Extern_Type_Name);
  }
  if (accessor.isEntity()) {
    ...
    extjson_uci::util::SerializationHelpers::serializeString(accessor.getResponseCommand(), node, ResponseOptionTriggerType_Names::ResponseCommand_Name);
