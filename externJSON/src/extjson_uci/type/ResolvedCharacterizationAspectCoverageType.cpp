...
bool ResolvedCharacterizationAspectCoverageType::deserialize(const boost::property_tree::ptree& propTree, uci::type::ResolvedCharacterizationAspectCoverageType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + ResolvedCharacterizationAspectCoverageType_Names::BodyReference_Name) {
      BodyReferenceEnum::deserializeList(valueType.second, accessor.getBodyReference());
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setAspectSpan(extjson_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    }
  }
  return true;
...
std::string ResolvedCharacterizationAspectCoverageType::serialize(const uci::type::ResolvedCharacterizationAspectCoverageType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, ResolvedCharacterizationAspectCoverageType_Names::Extern_Type_Name);
  }
  if (accessor.isBodyReference()) {
    {
      BodyReferenceEnum::serializeList(accessor.getBodyReference(), node, ResolvedCharacterizationAspectCoverageType_Names::BodyReference_Name);
    }
    ...
    extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getAspectSpan(), node, ResolvedCharacterizationAspectCoverageType_Names::AspectSpan_Name);
  }
  if (createNode) {
