...
bool IdentityKindAssetType::deserialize(const boost::property_tree::ptree& propTree, uci::type::IdentityKindAssetType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = IdentityKindAssetType_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + IdentityKindAssetType_Names::ByInstance_Name) {
...
std::string IdentityKindAssetType::serialize(const uci::type::IdentityKindAssetType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, IdentityKindAssetType_Names::Extern_Type_Name);
  }
