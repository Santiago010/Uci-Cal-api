...
bool PO_TrackStatusType::deserialize(const boost::property_tree::ptree& propTree, uci::type::PO_TrackStatusType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = PO_TrackStatusType_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + PO_TrackStatusType_Names::TrackOptionID_Name) {
...
std::string PO_TrackStatusType::serialize(const uci::type::PO_TrackStatusType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, PO_TrackStatusType_Names::Extern_Type_Name);
  }
  ...
  if (accessor.hasObservedEntityThreshold()) {
    extjson_uci::util::SerializationHelpers::serializeDuration(accessor.getObservedEntityThreshold(), node, PO_TrackStatusType_Names::ObservedEntityThreshold_Name);
  }
  if (accessor.hasTrackingRange()) {
    extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getTrackingRange(), node, PO_TrackStatusType_Names::TrackingRange_Name);
  }
  {
    ...
    for (uci::type::PO_TrackStatusType::CoastSetting::size_type i = 0, end = boundedList.size(); i < end; ++i) {
      PO_CoastSettingValueType::serialize(boundedList.at(i), node, PO_TrackStatusType_Names::CoastSetting_Name);
    }
  }
