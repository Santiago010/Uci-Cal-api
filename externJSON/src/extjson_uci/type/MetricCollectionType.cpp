...
bool MetricCollectionType::deserialize(const boost::property_tree::ptree& propTree, uci::type::MetricCollectionType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = MetricCollectionType_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + MetricCollectionType_Names::UseAllPasses_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setUseAllPasses(extjson_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setCenteredAtMaxPredictedSNR(extjson_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
    } else if (valueType.first == nsPrefix + MetricCollectionType_Names::SpacingOfObservations_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setSpacingOfObservations(extjson_uci::util::SerializationHelpers::deserializeInt(*value));
      }
    } else if (valueType.first == nsPrefix + MetricCollectionType_Names::ReportPointSOI_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setReportPointSOI(extjson_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
...
std::string MetricCollectionType::serialize(const uci::type::MetricCollectionType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, MetricCollectionType_Names::Extern_Type_Name);
  }
  extjson_uci::util::SerializationHelpers::serializeBoolean(accessor.getUseAllPasses(), node, MetricCollectionType_Names::UseAllPasses_Name);
  ...
  if (accessor.hasCenteredAtMaxPredictedSNR()) {
    extjson_uci::util::SerializationHelpers::serializeBoolean(accessor.getCenteredAtMaxPredictedSNR(), node, MetricCollectionType_Names::CenteredAtMaxPredictedSNR_Name);
  }
  if (accessor.hasSpacingOfObservations()) {
    extjson_uci::util::SerializationHelpers::serializeInt(accessor.getSpacingOfObservations(), node, MetricCollectionType_Names::SpacingOfObservations_Name);
  }
  if (accessor.hasReportPointSOI()) {
    extjson_uci::util::SerializationHelpers::serializeBoolean(accessor.getReportPointSOI(), node, MetricCollectionType_Names::ReportPointSOI_Name);
  }
