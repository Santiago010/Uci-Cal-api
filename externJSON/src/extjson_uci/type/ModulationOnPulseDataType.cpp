...
bool ModulationOnPulseDataType::deserialize(const boost::property_tree::ptree& propTree, uci::type::ModulationOnPulseDataType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + ModulationOnPulseDataType_Names::FMOP_Span_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setFMOP_Span(extjson_uci::util::SerializationHelpers::deserializeDuration(*value));
      }
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setPMOP_BitDuration(extjson_uci::util::SerializationHelpers::deserializeDuration(*value));
      }
...
std::string ModulationOnPulseDataType::serialize(const uci::type::ModulationOnPulseDataType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, ModulationOnPulseDataType_Names::Extern_Type_Name);
  }
  ModulationOnPulseDataBaseType::serialize(accessor, node, "", false, false, false);
  if (accessor.hasFMOP_Span()) {
    extjson_uci::util::SerializationHelpers::serializeDuration(accessor.getFMOP_Span(), node, ModulationOnPulseDataType_Names::FMOP_Span_Name);
  }
  ...
  if (accessor.hasPMOP_BitDuration()) {
    extjson_uci::util::SerializationHelpers::serializeDuration(accessor.getPMOP_BitDuration(), node, ModulationOnPulseDataType_Names::PMOP_BitDuration_Name);
  }
