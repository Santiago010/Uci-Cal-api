...
bool PO_ComponentSettingsFocalPlaneArrayCollectionType::deserialize(const boost::property_tree::ptree& propTree, uci::type::PO_ComponentSettingsFocalPlaneArrayCollectionType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + PO_ComponentSettingsFocalPlaneArrayCollectionType_Names::CollectionTimeSetting_Name) {
...
std::string PO_ComponentSettingsFocalPlaneArrayCollectionType::serialize(const uci::type::PO_ComponentSettingsFocalPlaneArrayCollectionType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, PO_ComponentSettingsFocalPlaneArrayCollectionType_Names::Extern_Type_Name);
  }
  if (accessor.isCollectionTimeSetting()) {
    extjson_uci::util::SerializationHelpers::serializeDuration(accessor.getCollectionTimeSetting(), node, PO_ComponentSettingsFocalPlaneArrayCollectionType_Names::CollectionTimeSetting_Name);
