...
bool EmitterIdentityConfidenceType::deserialize(const boost::property_tree::ptree& propTree, uci::type::EmitterIdentityConfidenceType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = EmitterIdentityConfidenceType_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + EmitterIdentityConfidenceType_Names::EmitterCategory_Name) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setMatchingParameterCount(extjson_uci::util::SerializationHelpers::deserializeUnsignedInt(*value));
      }
...
std::string EmitterIdentityConfidenceType::serialize(const uci::type::EmitterIdentityConfidenceType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, EmitterIdentityConfidenceType_Names::Extern_Type_Name);
  }
  EmitterIdentityType::serialize(accessor.getEmitterCategory(), node, EmitterIdentityConfidenceType_Names::EmitterCategory_Name);
  extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getConfidence(), node, EmitterIdentityConfidenceType_Names::Confidence_Name);
  if (accessor.hasMatchingParameterCount()) {
    extjson_uci::util::SerializationHelpers::serializeUnsignedInt(accessor.getMatchingParameterCount(), node, EmitterIdentityConfidenceType_Names::MatchingParameterCount_Name);
  }
  if (accessor.hasOperatorEvaluated()) {
    extjson_uci::util::SerializationHelpers::serializeString(accessor.getOperatorEvaluated(), node, EmitterIdentityConfidenceType_Names::OperatorEvaluated_Name);
  }
  if (createNode) {
