...
bool CS_EngagementDataType::deserialize(const boost::property_tree::ptree& propTree, uci::type::CS_EngagementDataType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + CS_EngagementDataType_Names::SENO_Name) {
      ...
      extjson_uci::util::DerivedTypesDeserializer::deserialize(valueType.second, accessor.enableTransponder(extjson_uci::util::SerializationHelpers::checkForTypeAttribute(valueType.second, nsPrefix)), nodeName, nsPrefix);
...
std::string CS_EngagementDataType::serialize(const uci::type::CS_EngagementDataType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, CS_EngagementDataType_Names::Extern_Type_Name);
  }
  if (accessor.hasSENO()) {
    extjson_uci::util::SerializationHelpers::serializeString(accessor.getSENO(), node, CS_EngagementDataType_Names::SENO_Name);
  }
