...
bool PO_AirVolumeSensorReferencedType::deserialize(const boost::property_tree::ptree& propTree, uci::type::PO_AirVolumeSensorReferencedType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + PO_AirVolumeSensorReferencedType_Names::AzimuthScanWidth_Name) {
...
std::string PO_AirVolumeSensorReferencedType::serialize(const uci::type::PO_AirVolumeSensorReferencedType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, PO_AirVolumeSensorReferencedType_Names::Extern_Type_Name);
  }
  extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getAzimuthScanWidth(), node, PO_AirVolumeSensorReferencedType_Names::AzimuthScanWidth_Name);
  extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getAzimuthScanCenter(), node, PO_AirVolumeSensorReferencedType_Names::AzimuthScanCenter_Name);
  extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getElevationScanWidth(), node, PO_AirVolumeSensorReferencedType_Names::ElevationScanWidth_Name);
  extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getElevationScanCenter(), node, PO_AirVolumeSensorReferencedType_Names::ElevationScanCenter_Name);
  extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getMaxRangeOfInterest(), node, PO_AirVolumeSensorReferencedType_Names::MaxRangeOfInterest_Name);
  extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getMinRangeOfInterest(), node, PO_AirVolumeSensorReferencedType_Names::MinRangeOfInterest_Name);
  ...
  extjson_uci::util::SerializationHelpers::serializeBoolean(accessor.getRollStabilized(), node, PO_AirVolumeSensorReferencedType_Names::RollStabilized_Name);
  if (createNode) {
