...
bool StoreInformationBaseType::deserialize(const boost::property_tree::ptree& propTree, uci::type::StoreInformationBaseType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + StoreInformationBaseType_Names::Mnemonic_Name) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setSimulated(extjson_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
    } else if (valueType.first == nsPrefix + StoreInformationBaseType_Names::StoreLocation_Name) {
      extjson_uci::util::SerializationHelpers::deserializeIntList(valueType.second, accessor.getStoreLocation());
    } else if (valueType.first == nsPrefix + StoreInformationBaseType_Names::JettisonableOption_Name) {
      StoreJettisonOptionsEnum::deserializeList(valueType.second, accessor.getJettisonableOption());
    } else if (valueType.first == nsPrefix + StoreInformationBaseType_Names::Powerable_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setPowerable(extjson_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
    }
  }
  return true;
...
std::string StoreInformationBaseType::serialize(const uci::type::StoreInformationBaseType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool checkIfDerivation, const bool /*topLevel*/) {
  ...
  if (!checkIfDerivation || (accessor.getAccessorType() == uci::type::accessorType::storeInformationBaseType)) {
    ...
    if (addTypeAttribute) {
      extjson_uci::util::SerializationHelpers::addTypeAttribute(node, StoreInformationBaseType_Names::Extern_Type_Name);
    }
    if (accessor.hasMnemonic()) {
      extjson_uci::util::SerializationHelpers::serializeString(accessor.getMnemonic(), node, StoreInformationBaseType_Names::Mnemonic_Name);
    }
    extjson_uci::util::SerializationHelpers::serializeBoolean(accessor.getSimulated(), node, StoreInformationBaseType_Names::Simulated_Name);
    {
      extjson_uci::util::SerializationHelpers::serializeIntList(accessor.getStoreLocation(), node, StoreInformationBaseType_Names::StoreLocation_Name);
    }
    {
      StoreJettisonOptionsEnum::serializeList(accessor.getJettisonableOption(), node, StoreInformationBaseType_Names::JettisonableOption_Name);
    }
    if (accessor.hasPowerable()) {
      extjson_uci::util::SerializationHelpers::serializeBoolean(accessor.getPowerable(), node, StoreInformationBaseType_Names::Powerable_Name);
    }
    if (createNode) {
