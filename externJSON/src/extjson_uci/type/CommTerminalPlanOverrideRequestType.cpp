...
bool CommTerminalPlanOverrideRequestType::deserialize(const boost::property_tree::ptree& propTree, uci::type::CommTerminalPlanOverrideRequestType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = CommTerminalPlanOverrideRequestType_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + CommTerminalPlanOverrideRequestType_Names::PlanActivation_Name) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        ...
        CommActionExtendedType::deserialize(valueType.second, boundedList.at(boundedListSize), nodeName, nsPrefix);
      }
    }
  }
...
std::string CommTerminalPlanOverrideRequestType::serialize(const uci::type::CommTerminalPlanOverrideRequestType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, CommTerminalPlanOverrideRequestType_Names::Extern_Type_Name);
  }
  ...
  }
  {
    ...
    for (uci::type::CommTerminalPlanOverrideRequestType::OperatorModification::size_type i = 0, end = boundedList.size(); i < end; ++i) {
      CommActionExtendedType::serialize(boundedList.at(i), node, CommTerminalPlanOverrideRequestType_Names::OperatorModification_Name);
    }
  }
  if (createNode) {
