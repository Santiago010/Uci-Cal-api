...
bool CommProfileID_Type::deserialize(const boost::property_tree::ptree& propTree, uci::type::CommProfileID_Type& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
...
std::string CommProfileID_Type::serialize(const uci::type::CommProfileID_Type& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, CommProfileID_Type_Names::Extern_Type_Name);
  }
