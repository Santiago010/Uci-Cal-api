...
bool OrbitalSurveillanceSensorMinimumSizeType::deserialize(const boost::property_tree::ptree& propTree, uci::type::OrbitalSurveillanceSensorMinimumSizeType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = OrbitalSurveillanceSensorMinimumSizeType_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + OrbitalSurveillanceSensorMinimumSizeType_Names::RadarCrossSection_Name) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setIntensity(extjson_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    }
  }
  return true;
...
std::string OrbitalSurveillanceSensorMinimumSizeType::serialize(const uci::type::OrbitalSurveillanceSensorMinimumSizeType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, OrbitalSurveillanceSensorMinimumSizeType_Names::Extern_Type_Name);
  }
  if (accessor.isRadarCrossSection()) {
    ...
    extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getVisualMagnitude(), node, OrbitalSurveillanceSensorMinimumSizeType_Names::VisualMagnitude_Name);
  } else if (accessor.isArea()) {
    extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getArea(), node, OrbitalSurveillanceSensorMinimumSizeType_Names::Area_Name);
  } else if (accessor.isIntensity()) {
    extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getIntensity(), node, OrbitalSurveillanceSensorMinimumSizeType_Names::Intensity_Name);
  }
  if (createNode) {
