...
bool FocalPlaneArrayOperationNonUniformityCorrectionType::deserialize(const boost::property_tree::ptree& propTree, uci::type::FocalPlaneArrayOperationNonUniformityCorrectionType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + FocalPlaneArrayOperationNonUniformityCorrectionType_Names::NUC_TablesSettings_Name) {
      extjson_uci::util::DerivedTypesDeserializer::deserialize(valueType.second, accessor.enableNUC_TablesSettings(extjson_uci::util::SerializationHelpers::checkForTypeAttribute(valueType.second, nsPrefix)), nodeName, nsPrefix);
...
std::string FocalPlaneArrayOperationNonUniformityCorrectionType::serialize(const uci::type::FocalPlaneArrayOperationNonUniformityCorrectionType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, FocalPlaneArrayOperationNonUniformityCorrectionType_Names::Extern_Type_Name);
  }
