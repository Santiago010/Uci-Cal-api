...
bool ReadinessTimeSpanType::deserialize(const boost::property_tree::ptree& propTree, uci::type::ReadinessTimeSpanType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = ReadinessTimeSpanType_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + ReadinessTimeSpanType_Names::ByMission_Name) {
...
std::string ReadinessTimeSpanType::serialize(const uci::type::ReadinessTimeSpanType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, ReadinessTimeSpanType_Names::Extern_Type_Name);
  }
  if (accessor.isByMission()) {
    extjson_uci::util::SerializationHelpers::serializeString(accessor.getByMission(), node, ReadinessTimeSpanType_Names::ByMission_Name);
