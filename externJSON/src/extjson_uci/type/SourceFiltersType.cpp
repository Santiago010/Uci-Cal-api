...
bool SourceFiltersType::deserialize(const boost::property_tree::ptree& propTree, uci::type::SourceFiltersType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + SourceFiltersType_Names::SystemID_Name) {
...
std::string SourceFiltersType::serialize(const uci::type::SourceFiltersType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, SourceFiltersType_Names::Extern_Type_Name);
  }
  {
