...
bool FuelCenterOfGravityType::deserialize(const boost::property_tree::ptree& propTree, uci::type::FuelCenterOfGravityType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + FuelCenterOfGravityType_Names::ActualCoG_Name) {
...
std::string FuelCenterOfGravityType::serialize(const uci::type::FuelCenterOfGravityType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, FuelCenterOfGravityType_Names::Extern_Type_Name);
  }
