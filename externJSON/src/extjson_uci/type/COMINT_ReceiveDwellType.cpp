...
bool COMINT_ReceiveDwellType::deserialize(const boost::property_tree::ptree& propTree, uci::type::COMINT_ReceiveDwellType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + COMINT_ReceiveDwellType_Names::DwellID_Name) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setStopTime(extjson_uci::util::SerializationHelpers::deserializeDateTime(*value));
      }
...
std::string COMINT_ReceiveDwellType::serialize(const uci::type::COMINT_ReceiveDwellType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, COMINT_ReceiveDwellType_Names::Extern_Type_Name);
  }
  ...
  if (accessor.hasStartTime()) {
    extjson_uci::util::SerializationHelpers::serializeDateTime(accessor.getStartTime(), node, COMINT_ReceiveDwellType_Names::StartTime_Name);
  }
  if (accessor.hasCumulativeDwellTime()) {
    extjson_uci::util::SerializationHelpers::serializeDuration(accessor.getCumulativeDwellTime(), node, COMINT_ReceiveDwellType_Names::CumulativeDwellTime_Name);
  }
  {
  ...
  if (accessor.hasDwellRevisitInterval()) {
    extjson_uci::util::SerializationHelpers::serializeDuration(accessor.getDwellRevisitInterval(), node, COMINT_ReceiveDwellType_Names::DwellRevisitInterval_Name);
  }
  if (accessor.hasPulseWidthLow()) {
    extjson_uci::util::SerializationHelpers::serializeDuration(accessor.getPulseWidthLow(), node, COMINT_ReceiveDwellType_Names::PulseWidthLow_Name);
  }
  if (accessor.hasPulseWidthHigh()) {
    extjson_uci::util::SerializationHelpers::serializeDuration(accessor.getPulseWidthHigh(), node, COMINT_ReceiveDwellType_Names::PulseWidthHigh_Name);
  }
  if (accessor.hasPRI_High()) {
    extjson_uci::util::SerializationHelpers::serializeDuration(accessor.getPRI_High(), node, COMINT_ReceiveDwellType_Names::PRI_High_Name);
  }
  if (accessor.hasNativeSensitivity()) {
    extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getNativeSensitivity(), node, COMINT_ReceiveDwellType_Names::NativeSensitivity_Name);
  }
  if (accessor.hasDesensitization()) {
    extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getDesensitization(), node, COMINT_ReceiveDwellType_Names::Desensitization_Name);
  }
  if (accessor.hasVideoBandwidth()) {
    extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getVideoBandwidth(), node, COMINT_ReceiveDwellType_Names::VideoBandwidth_Name);
  }
  ...
  if (accessor.hasStopTime()) {
    extjson_uci::util::SerializationHelpers::serializeDateTime(accessor.getStopTime(), node, COMINT_ReceiveDwellType_Names::StopTime_Name);
  }
  if (accessor.hasSampleRate()) {
    extjson_uci::util::SerializationHelpers::serializeFloat(accessor.getSampleRate(), node, COMINT_ReceiveDwellType_Names::SampleRate_Name);
  }
  if (accessor.hasFFT_PointsPerSample()) {
    extjson_uci::util::SerializationHelpers::serializeInt(accessor.getFFT_PointsPerSample(), node, COMINT_ReceiveDwellType_Names::FFT_PointsPerSample_Name);
  }
  if (createNode) {
