...
bool ThreatAssessmentSystemType::deserialize(const boost::property_tree::ptree& propTree, uci::type::ThreatAssessmentSystemType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + ThreatAssessmentSystemType_Names::EntityID_Name) {
...
std::string ThreatAssessmentSystemType::serialize(const uci::type::ThreatAssessmentSystemType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, ThreatAssessmentSystemType_Names::Extern_Type_Name);
  }
