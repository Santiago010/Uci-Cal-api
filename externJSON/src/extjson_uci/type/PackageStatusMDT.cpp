...
bool PackageStatusMDT::deserialize(const boost::property_tree::ptree& propTree, uci::type::PackageStatusMDT& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + PackageStatusMDT_Names::PackageID_Name) {
...
std::string PackageStatusMDT::serialize(const uci::type::PackageStatusMDT& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, PackageStatusMDT_Names::Extern_Type_Name);
  }
