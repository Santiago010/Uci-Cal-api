...
bool RF_ThreadInstanceSetupCommandStatusMDT::deserialize(const boost::property_tree::ptree& propTree, uci::type::RF_ThreadInstanceSetupCommandStatusMDT& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
...
std::string RF_ThreadInstanceSetupCommandStatusMDT::serialize(const uci::type::RF_ThreadInstanceSetupCommandStatusMDT& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, RF_ThreadInstanceSetupCommandStatusMDT_Names::Extern_Type_Name);
  }
