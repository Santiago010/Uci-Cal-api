...
bool ValidatorType::deserialize(const boost::property_tree::ptree& propTree, uci::type::ValidatorType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = ValidatorType_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + ValidatorType_Names::OperatorID_Name) {
...
std::string ValidatorType::serialize(const uci::type::ValidatorType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, ValidatorType_Names::Extern_Type_Name);
  }
