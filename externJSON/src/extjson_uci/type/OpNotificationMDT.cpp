...
bool OpNotificationMDT::deserialize(const boost::property_tree::ptree& propTree, uci::type::OpNotificationMDT& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + OpNotificationMDT_Names::OpSubject_Name) {
...
std::string OpNotificationMDT::serialize(const uci::type::OpNotificationMDT& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, OpNotificationMDT_Names::Extern_Type_Name);
  }
  ...
  extjson_uci::util::SerializationHelpers::serializeBoolean(accessor.getScheduleActive(), node, OpNotificationMDT_Names::ScheduleActive_Name);
  {
