...
bool MultistaticModeOptionsEmployedType::deserialize(const boost::property_tree::ptree& propTree, uci::type::MultistaticModeOptionsEmployedType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + MultistaticModeOptionsEmployedType_Names::MultistaticModeStatus_Name) {
...
std::string MultistaticModeOptionsEmployedType::serialize(const uci::type::MultistaticModeOptionsEmployedType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, MultistaticModeOptionsEmployedType_Names::Extern_Type_Name);
  }
