...
bool AirfieldContaminationType::deserialize(const boost::property_tree::ptree& propTree, uci::type::AirfieldContaminationType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = AirfieldContaminationType_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + AirfieldContaminationType_Names::Nuclear_Name) {
...
std::string AirfieldContaminationType::serialize(const uci::type::AirfieldContaminationType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, AirfieldContaminationType_Names::Extern_Type_Name);
  }
  if (accessor.hasNuclear()) {
    extjson_uci::util::SerializationHelpers::serializeString(accessor.getNuclear(), node, AirfieldContaminationType_Names::Nuclear_Name);
  }
  if (accessor.hasBiological()) {
    extjson_uci::util::SerializationHelpers::serializeString(accessor.getBiological(), node, AirfieldContaminationType_Names::Biological_Name);
  }
  if (accessor.hasChemical()) {
    extjson_uci::util::SerializationHelpers::serializeString(accessor.getChemical(), node, AirfieldContaminationType_Names::Chemical_Name);
  }
  if (createNode) {
