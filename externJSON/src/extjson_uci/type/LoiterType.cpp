...
bool LoiterType::deserialize(const boost::property_tree::ptree& propTree, uci::type::LoiterType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = LoiterType_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + LoiterType_Names::Orbit_Name) {
...
std::string LoiterType::serialize(const uci::type::LoiterType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, LoiterType_Names::Extern_Type_Name);
  }
  if (accessor.isOrbit()) {
