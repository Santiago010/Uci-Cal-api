...
bool AssociatedMessageSourceType::deserialize(const boost::property_tree::ptree& propTree, uci::type::AssociatedMessageSourceType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + AssociatedMessageSourceType_Names::SettingsCommandID_Name) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setActiveScanScheduleProfileIndex(extjson_uci::util::SerializationHelpers::deserializeUnsignedInt(*value));
      }
...
std::string AssociatedMessageSourceType::serialize(const uci::type::AssociatedMessageSourceType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, AssociatedMessageSourceType_Names::Extern_Type_Name);
  }
  if (accessor.isSettingsCommandID()) {
    ...
    extjson_uci::util::SerializationHelpers::serializeUnsignedInt(accessor.getActiveScanScheduleProfileIndex(), node, AssociatedMessageSourceType_Names::ActiveScanScheduleProfileIndex_Name);
