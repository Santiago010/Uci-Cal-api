...
bool VCM_IntegratorSettingsType::deserialize(const boost::property_tree::ptree& propTree, uci::type::VCM_IntegratorSettingsType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + VCM_IntegratorSettingsType_Names::IntegratorMode_Name) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setErrorControl(extjson_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    }
  }
  return true;
...
std::string VCM_IntegratorSettingsType::serialize(const uci::type::VCM_IntegratorSettingsType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, VCM_IntegratorSettingsType_Names::Extern_Type_Name);
  }
  ...
  extjson_uci::util::SerializationHelpers::serializeBoolean(accessor.getIsFixedStepSize(), node, VCM_IntegratorSettingsType_Names::IsFixedStepSize_Name);
  ...
  if (accessor.hasInitialStepSize()) {
    extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getInitialStepSize(), node, VCM_IntegratorSettingsType_Names::InitialStepSize_Name);
  }
  if (accessor.hasErrorControl()) {
    extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getErrorControl(), node, VCM_IntegratorSettingsType_Names::ErrorControl_Name);
  }
  if (createNode) {
