...
bool SMTI_PredictedCollectionsType::deserialize(const boost::property_tree::ptree& propTree, uci::type::SMTI_PredictedCollectionsType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = SMTI_PredictedCollectionsType_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + SMTI_PredictedCollectionsType_Names::OwnshipLocation_Name) {
...
std::string SMTI_PredictedCollectionsType::serialize(const uci::type::SMTI_PredictedCollectionsType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, SMTI_PredictedCollectionsType_Names::Extern_Type_Name);
  }
