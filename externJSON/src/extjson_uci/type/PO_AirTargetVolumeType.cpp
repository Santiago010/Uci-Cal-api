...
bool PO_AirTargetVolumeType::deserialize(const boost::property_tree::ptree& propTree, uci::type::PO_AirTargetVolumeType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = PO_AirTargetVolumeType_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + PO_AirTargetVolumeType_Names::AirVolumeSensorReferenced_Name) {
...
std::string PO_AirTargetVolumeType::serialize(const uci::type::PO_AirTargetVolumeType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, PO_AirTargetVolumeType_Names::Extern_Type_Name);
  }
