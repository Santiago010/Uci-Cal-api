...
bool QueryTopicPairType::deserialize(const boost::property_tree::ptree& propTree, uci::type::QueryTopicPairType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = QueryTopicPairType_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + QueryTopicPairType_Names::MessageType_Name) {
...
std::string QueryTopicPairType::serialize(const uci::type::QueryTopicPairType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, QueryTopicPairType_Names::Extern_Type_Name);
  }
  MessageTypeEnum::serialize(accessor.getMessageType(), node, QueryTopicPairType_Names::MessageType_Name, false);
  extjson_uci::util::SerializationHelpers::serializeString(accessor.getReceiverAddress(), node, QueryTopicPairType_Names::ReceiverAddress_Name);
  if (createNode) {
