...
bool MissionInformationType::deserialize(const boost::property_tree::ptree& propTree, uci::type::MissionInformationType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = MissionInformationType_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + MissionInformationType_Names::MissionName_Name) {
...
std::string MissionInformationType::serialize(const uci::type::MissionInformationType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, MissionInformationType_Names::Extern_Type_Name);
  }
  extjson_uci::util::SerializationHelpers::serializeString(accessor.getMissionName(), node, MissionInformationType_Names::MissionName_Name);
  if (accessor.hasMissionDescription()) {
    extjson_uci::util::SerializationHelpers::serializeString(accessor.getMissionDescription(), node, MissionInformationType_Names::MissionDescription_Name);
  }
  if (createNode) {
