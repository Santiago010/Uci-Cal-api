...
bool SystemOrbitalEphemerisMT::deserialize(const boost::property_tree::ptree& propTree, uci::type::SystemOrbitalEphemerisMT& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + SystemOrbitalEphemerisMT_Names::ObjectState_Name) {
...
std::string SystemOrbitalEphemerisMT::serialize(const uci::type::SystemOrbitalEphemerisMT& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool topLevel) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, (topLevel ? SystemOrbitalEphemerisMT_Names::Extern_Top_Type_Name : SystemOrbitalEphemerisMT_Names::Extern_Type_Name));
  }
