...
bool IFF_Mode5DetailsType::deserialize(const boost::property_tree::ptree& propTree, uci::type::IFF_Mode5DetailsType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + IFF_Mode5DetailsType_Names::NationalOrigin_Name) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setLevel2_B_Squitter(extjson_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
    } else if (valueType.first == nsPrefix + IFF_Mode5DetailsType_Names::InitiateEmergencyFeature_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setInitiateEmergencyFeature(extjson_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
    }
  }
  return true;
...
std::string IFF_Mode5DetailsType::serialize(const uci::type::IFF_Mode5DetailsType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, IFF_Mode5DetailsType_Names::Extern_Type_Name);
  }
  extjson_uci::util::SerializationHelpers::serializeInt(accessor.getNationalOrigin(), node, IFF_Mode5DetailsType_Names::NationalOrigin_Name);
  extjson_uci::util::SerializationHelpers::serializeInt(accessor.getPIN(), node, IFF_Mode5DetailsType_Names::PIN_Name);
  ...
  extjson_uci::util::SerializationHelpers::serializeBoolean(accessor.getLevel2_B_Squitter(), node, IFF_Mode5DetailsType_Names::Level2_B_Squitter_Name);
  extjson_uci::util::SerializationHelpers::serializeBoolean(accessor.getInitiateEmergencyFeature(), node, IFF_Mode5DetailsType_Names::InitiateEmergencyFeature_Name);
  if (createNode) {
