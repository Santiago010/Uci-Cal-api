...
bool ESM_CommandMT::deserialize(const boost::property_tree::ptree& propTree, uci::type::ESM_CommandMT& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + ESM_CommandMT_Names::MessageData_Name) {
...
std::string ESM_CommandMT::serialize(const uci::type::ESM_CommandMT& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool topLevel) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, (topLevel ? ESM_CommandMT_Names::Extern_Top_Type_Name : ESM_CommandMT_Names::Extern_Type_Name));
  }
