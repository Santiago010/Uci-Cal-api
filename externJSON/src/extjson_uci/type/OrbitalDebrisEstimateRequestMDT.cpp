...
bool OrbitalDebrisEstimateRequestMDT::deserialize(const boost::property_tree::ptree& propTree, uci::type::OrbitalDebrisEstimateRequestMDT& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = OrbitalDebrisEstimateRequestMDT_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + OrbitalDebrisEstimateRequestMDT_Names::EstimateType_Name) {
...
std::string OrbitalDebrisEstimateRequestMDT::serialize(const uci::type::OrbitalDebrisEstimateRequestMDT& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, OrbitalDebrisEstimateRequestMDT_Names::Extern_Type_Name);
  }
  ...
  if (accessor.hasRespondBy()) {
    extjson_uci::util::SerializationHelpers::serializeDateTime(accessor.getRespondBy(), node, OrbitalDebrisEstimateRequestMDT_Names::RespondBy_Name);
  }
