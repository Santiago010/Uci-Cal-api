...
bool PlatformStatusType::deserialize(const boost::property_tree::ptree& propTree, uci::type::PlatformStatusType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + PlatformStatusType_Names::BailoutIndicator_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setBailoutIndicator(extjson_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
    } else if (valueType.first == nsPrefix + PlatformStatusType_Names::CommandAndControlIndicator_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setCommandAndControlIndicator(extjson_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
...
std::string PlatformStatusType::serialize(const uci::type::PlatformStatusType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, PlatformStatusType_Names::Extern_Type_Name);
  }
  if (accessor.hasBailoutIndicator()) {
    extjson_uci::util::SerializationHelpers::serializeBoolean(accessor.getBailoutIndicator(), node, PlatformStatusType_Names::BailoutIndicator_Name);
  }
  if (accessor.hasCommandAndControlIndicator()) {
    extjson_uci::util::SerializationHelpers::serializeBoolean(accessor.getCommandAndControlIndicator(), node, PlatformStatusType_Names::CommandAndControlIndicator_Name);
  }
  if (accessor.hasEmergencyIndicator()) {
    extjson_uci::util::SerializationHelpers::serializeBoolean(accessor.getEmergencyIndicator(), node, PlatformStatusType_Names::EmergencyIndicator_Name);
  }
  {
