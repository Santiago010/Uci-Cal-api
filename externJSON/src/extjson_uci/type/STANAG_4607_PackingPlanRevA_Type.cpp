...
bool STANAG_4607_PackingPlanRevA_Type::deserialize(const boost::property_tree::ptree& propTree, uci::type::STANAG_4607_PackingPlanRevA_Type& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + STANAG_4607_PackingPlanRevA_Type_Names::Nationality_Name) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setPacketSecurityCode(extjson_uci::util::SerializationHelpers::deserializeUnsignedShort(*value));
      }
    } else if (valueType.first == nsPrefix + STANAG_4607_PackingPlanRevA_Type_Names::ExerciseIndicator_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setExerciseIndicator(extjson_uci::util::SerializationHelpers::deserializeUnsignedByte(*value));
      }
...
std::string STANAG_4607_PackingPlanRevA_Type::serialize(const uci::type::STANAG_4607_PackingPlanRevA_Type& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, STANAG_4607_PackingPlanRevA_Type_Names::Extern_Type_Name);
  }
  STANAG_4607_PackingPlanPET::serialize(accessor, node, "", false, false, false);
  extjson_uci::util::SerializationHelpers::serializeString(accessor.getNationality(), node, STANAG_4607_PackingPlanRevA_Type_Names::Nationality_Name);
  extjson_uci::util::SerializationHelpers::serializeString(accessor.getPacketSecurityClassification(), node, STANAG_4607_PackingPlanRevA_Type_Names::PacketSecurityClassification_Name);
  extjson_uci::util::SerializationHelpers::serializeString(accessor.getPacketSecurityClassificationSystem(), node, STANAG_4607_PackingPlanRevA_Type_Names::PacketSecurityClassificationSystem_Name);
  extjson_uci::util::SerializationHelpers::serializeUnsignedShort(accessor.getPacketSecurityCode(), node, STANAG_4607_PackingPlanRevA_Type_Names::PacketSecurityCode_Name);
  extjson_uci::util::SerializationHelpers::serializeUnsignedByte(accessor.getExerciseIndicator(), node, STANAG_4607_PackingPlanRevA_Type_Names::ExerciseIndicator_Name);
  if (accessor.hasPlatformIdentifier()) {
    extjson_uci::util::SerializationHelpers::serializeString(accessor.getPlatformIdentifier(), node, STANAG_4607_PackingPlanRevA_Type_Names::PlatformIdentifier_Name);
  }
  extjson_uci::util::SerializationHelpers::serializeString(accessor.getMissionPlan(), node, STANAG_4607_PackingPlanRevA_Type_Names::MissionPlan_Name);
  extjson_uci::util::SerializationHelpers::serializeString(accessor.getFlightPlan(), node, STANAG_4607_PackingPlanRevA_Type_Names::FlightPlan_Name);
  if (createNode) {
