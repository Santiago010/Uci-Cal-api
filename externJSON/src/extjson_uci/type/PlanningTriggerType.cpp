...
bool PlanningTriggerType::deserialize(const boost::property_tree::ptree& propTree, uci::type::PlanningTriggerType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + PlanningTriggerType_Names::Source_Name) {
...
std::string PlanningTriggerType::serialize(const uci::type::PlanningTriggerType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, PlanningTriggerType_Names::Extern_Type_Name);
  }
