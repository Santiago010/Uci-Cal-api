...
bool DragCoefficientChoiceType::deserialize(const boost::property_tree::ptree& propTree, uci::type::DragCoefficientChoiceType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = DragCoefficientChoiceType_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + DragCoefficientChoiceType_Names::VCM_DragParameters_Name) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setDragCoefficientValue(extjson_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    }
  }
  return true;
...
std::string DragCoefficientChoiceType::serialize(const uci::type::DragCoefficientChoiceType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, DragCoefficientChoiceType_Names::Extern_Type_Name);
  }
  if (accessor.isVCM_DragParameters()) {
    ...
    extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getDragCoefficientValue(), node, DragCoefficientChoiceType_Names::DragCoefficientValue_Name);
  }
  if (createNode) {
