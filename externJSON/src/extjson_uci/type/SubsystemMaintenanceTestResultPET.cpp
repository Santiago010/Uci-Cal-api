...
bool SubsystemMaintenanceTestResultPET::deserialize(const boost::property_tree::ptree& propTree, uci::type::SubsystemMaintenanceTestResultPET& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + SubsystemMaintenanceTestResultPET_Names::CommandID_Name) {
...
std::string SubsystemMaintenanceTestResultPET::serialize(const uci::type::SubsystemMaintenanceTestResultPET& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool checkIfDerivation, const bool /*topLevel*/) {
  ...
  if (!checkIfDerivation || (accessor.getAccessorType() == uci::type::accessorType::subsystemMaintenanceTestResultPET)) {
    ...
    if (addTypeAttribute) {
      extjson_uci::util::SerializationHelpers::addTypeAttribute(node, SubsystemMaintenanceTestResultPET_Names::Extern_Type_Name);
    }
