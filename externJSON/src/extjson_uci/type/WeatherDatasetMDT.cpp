...
bool WeatherDatasetMDT::deserialize(const boost::property_tree::ptree& propTree, uci::type::WeatherDatasetMDT& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + WeatherDatasetMDT_Names::WeatherDatasetID_Name) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setUpdated(extjson_uci::util::SerializationHelpers::deserializeDateTime(*value));
      }
    } else if (valueType.first == nsPrefix + WeatherDatasetMDT_Names::DatasetArea_Name) {
      extjson_uci::util::DerivedTypesDeserializer::deserialize(valueType.second, accessor.enableDatasetArea(extjson_uci::util::SerializationHelpers::checkForTypeAttribute(valueType.second, nsPrefix)), nodeName, nsPrefix);
    } else if (valueType.first == nsPrefix + WeatherDatasetMDT_Names::DegreeStep_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setDegreeStep(extjson_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    } else if (valueType.first == nsPrefix + WeatherDatasetMDT_Names::AltitudeStep_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setAltitudeStep(extjson_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
...
std::string WeatherDatasetMDT::serialize(const uci::type::WeatherDatasetMDT& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, WeatherDatasetMDT_Names::Extern_Type_Name);
  }
  ...
  extjson_uci::util::SerializationHelpers::serializeDateTime(accessor.getCreated(), node, WeatherDatasetMDT_Names::Created_Name);
  extjson_uci::util::SerializationHelpers::serializeDateTime(accessor.getUpdated(), node, WeatherDatasetMDT_Names::Updated_Name);
  ZoneType::serialize(accessor.getDatasetArea(), node, WeatherDatasetMDT_Names::DatasetArea_Name);
  if (accessor.hasDegreeStep()) {
    extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getDegreeStep(), node, WeatherDatasetMDT_Names::DegreeStep_Name);
  }
  if (accessor.hasAltitudeStep()) {
    extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getAltitudeStep(), node, WeatherDatasetMDT_Names::AltitudeStep_Name);
  }
  {
