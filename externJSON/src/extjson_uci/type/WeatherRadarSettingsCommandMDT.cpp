...
bool WeatherRadarSettingsCommandMDT::deserialize(const boost::property_tree::ptree& propTree, uci::type::WeatherRadarSettingsCommandMDT& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + WeatherRadarSettingsCommandMDT_Names::ElectronicProtectionState_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setElectronicProtectionState(extjson_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
...
std::string WeatherRadarSettingsCommandMDT::serialize(const uci::type::WeatherRadarSettingsCommandMDT& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, WeatherRadarSettingsCommandMDT_Names::Extern_Type_Name);
  }
  CapabilitySettingsCommandBaseType::serialize(accessor, node, "", false, false, false);
  if (accessor.hasElectronicProtectionState()) {
    extjson_uci::util::SerializationHelpers::serializeBoolean(accessor.getElectronicProtectionState(), node, WeatherRadarSettingsCommandMDT_Names::ElectronicProtectionState_Name);
  }
  ...
  {
    WeatherRadarMessageOutputsEnum::serializeList(accessor.getMessageOutput(), node, WeatherRadarSettingsCommandMDT_Names::MessageOutput_Name);
  }
  if (accessor.hasUnassignAll()) {
    extjson_uci::util::SerializationHelpers::serializeBoolean(accessor.getUnassignAll(), node, WeatherRadarSettingsCommandMDT_Names::UnassignAll_Name);
  }
