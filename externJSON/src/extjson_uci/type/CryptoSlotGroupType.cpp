...
bool CryptoSlotGroupType::deserialize(const boost::property_tree::ptree& propTree, uci::type::CryptoSlotGroupType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + CryptoSlotGroupType_Names::CryptoSlotGroupID_Name) {
      ...
      CryptoRolloverMethodEnum::deserializeList(valueType.second, accessor.getRolloverMethod());
...
std::string CryptoSlotGroupType::serialize(const uci::type::CryptoSlotGroupType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, CryptoSlotGroupType_Names::Extern_Type_Name);
  }
  ...
  extjson_uci::util::SerializationHelpers::serializeString(accessor.getCurrentSlotIdentifier(), node, CryptoSlotGroupType_Names::CurrentSlotIdentifier_Name);
  {
    CryptoRolloverMethodEnum::serializeList(accessor.getRolloverMethod(), node, CryptoSlotGroupType_Names::RolloverMethod_Name);
  }
  {
