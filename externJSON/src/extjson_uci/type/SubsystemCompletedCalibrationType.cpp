...
bool SubsystemCompletedCalibrationType::deserialize(const boost::property_tree::ptree& propTree, uci::type::SubsystemCompletedCalibrationType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = SubsystemCompletedCalibrationType_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + SubsystemCompletedCalibrationType_Names::CalibrationID_Name) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setTimetag(extjson_uci::util::SerializationHelpers::deserializeDateTime(*value));
      }
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        ...
        SubsystemCompletedCalibrationItemType::deserialize(valueType.second, boundedList.at(boundedListSize), nodeName, nsPrefix);
      }
    }
  }
  return true;
...
std::string SubsystemCompletedCalibrationType::serialize(const uci::type::SubsystemCompletedCalibrationType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, SubsystemCompletedCalibrationType_Names::Extern_Type_Name);
  }
  CalibrationID_Type::serialize(accessor.getCalibrationID(), node, SubsystemCompletedCalibrationType_Names::CalibrationID_Name);
  extjson_uci::util::SerializationHelpers::serializeDateTime(accessor.getTimetag(), node, SubsystemCompletedCalibrationType_Names::Timetag_Name);
  ...
  if (accessor.hasFailReason()) {
    extjson_uci::util::SerializationHelpers::serializeString(accessor.getFailReason(), node, SubsystemCompletedCalibrationType_Names::FailReason_Name);
  }
  {
    ...
    for (uci::type::SubsystemCompletedCalibrationType::CalibrationItem::size_type i = 0, end = boundedList.size(); i < end; ++i) {
      SubsystemCompletedCalibrationItemType::serialize(boundedList.at(i), node, SubsystemCompletedCalibrationType_Names::CalibrationItem_Name);
    }
  }
  if (createNode) {
