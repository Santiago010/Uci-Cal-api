...
bool DamageReportDetailType::deserialize(const boost::property_tree::ptree& propTree, uci::type::DamageReportDetailType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + DamageReportDetailType_Names::DamageType_Name) {
...
std::string DamageReportDetailType::serialize(const uci::type::DamageReportDetailType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, DamageReportDetailType_Names::Extern_Type_Name);
  }
