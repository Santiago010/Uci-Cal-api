...
bool RelativeOffset3D_Type::deserialize(const boost::property_tree::ptree& propTree, uci::type::RelativeOffset3D_Type& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = RelativeOffset3D_Type_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + RelativeOffset3D_Type_Names::Rotation_Name) {
...
std::string RelativeOffset3D_Type::serialize(const uci::type::RelativeOffset3D_Type& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, RelativeOffset3D_Type_Names::Extern_Type_Name);
  }
  ...
  extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getX(), node, RelativeOffset3D_Type_Names::X_Name);
  extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getY(), node, RelativeOffset3D_Type_Names::Y_Name);
