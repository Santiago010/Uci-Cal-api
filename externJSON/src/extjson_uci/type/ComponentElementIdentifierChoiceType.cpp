...
bool ComponentElementIdentifierChoiceType::deserialize(const boost::property_tree::ptree& propTree, uci::type::ComponentElementIdentifierChoiceType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = ComponentElementIdentifierChoiceType_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + ComponentElementIdentifierChoiceType_Names::ComponentElementNumericIdentifier_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setComponentElementNumericIdentifier(extjson_uci::util::SerializationHelpers::deserializeUnsignedInt(*value));
      }
    } else if (valueType.first == nsPrefix + ComponentElementIdentifierChoiceType_Names::ComponentElementKey_Name) {
      extjson_uci::util::DerivedTypesDeserializer::deserialize(valueType.second, accessor.chooseComponentElementKey(extjson_uci::util::SerializationHelpers::checkForTypeAttribute(valueType.second, nsPrefix)), nodeName, nsPrefix);
    }
  }
  return true;
}
...
std::string ComponentElementIdentifierChoiceType::serialize(const uci::type::ComponentElementIdentifierChoiceType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, ComponentElementIdentifierChoiceType_Names::Extern_Type_Name);
  }
  if (accessor.isComponentElementNumericIdentifier()) {
    extjson_uci::util::SerializationHelpers::serializeUnsignedInt(accessor.getComponentElementNumericIdentifier(), node, ComponentElementIdentifierChoiceType_Names::ComponentElementNumericIdentifier_Name);
