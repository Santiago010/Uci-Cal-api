...
bool PlannedActivityBaseType::deserialize(const boost::property_tree::ptree& propTree, uci::type::PlannedActivityBaseType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + PlannedActivityBaseType_Names::PlannedActivityID_Name) {
...
std::string PlannedActivityBaseType::serialize(const uci::type::PlannedActivityBaseType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool checkIfDerivation, const bool /*topLevel*/) {
  ...
  if (!checkIfDerivation || (accessor.getAccessorType() == uci::type::accessorType::plannedActivityBaseType)) {
    ...
    if (addTypeAttribute) {
      extjson_uci::util::SerializationHelpers::addTypeAttribute(node, PlannedActivityBaseType_Names::Extern_Type_Name);
    }
    ...
    if (accessor.hasLocked()) {
      extjson_uci::util::SerializationHelpers::serializeBoolean(accessor.getLocked(), node, PlannedActivityBaseType_Names::Locked_Name);
    }
