...
bool PixelReferenceCoordinateType::deserialize(const boost::property_tree::ptree& propTree, uci::type::PixelReferenceCoordinateType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = PixelReferenceCoordinateType_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + PixelReferenceCoordinateType_Names::PixelCoordinate_Name) {
      extjson_uci::util::DerivedTypesDeserializer::deserialize(valueType.second, accessor.enablePixelCoordinate(extjson_uci::util::SerializationHelpers::checkForTypeAttribute(valueType.second, nsPrefix)), nodeName, nsPrefix);
...
std::string PixelReferenceCoordinateType::serialize(const uci::type::PixelReferenceCoordinateType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, PixelReferenceCoordinateType_Names::Extern_Type_Name);
  }
  PixelDataType::serialize(accessor.getPixelCoordinate(), node, PixelReferenceCoordinateType_Names::PixelCoordinate_Name);
  if (accessor.hasFile()) {
    extjson_uci::util::SerializationHelpers::serializeString(accessor.getFile(), node, PixelReferenceCoordinateType_Names::File_Name);
  }
