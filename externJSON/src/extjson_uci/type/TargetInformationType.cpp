...
bool TargetInformationType::deserialize(const boost::property_tree::ptree& propTree, uci::type::TargetInformationType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = TargetInformationType_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + TargetInformationType_Names::NumberOfDMPIs_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setNumberOfDMPIs(extjson_uci::util::SerializationHelpers::deserializeUnsignedInt(*value));
      }
...
std::string TargetInformationType::serialize(const uci::type::TargetInformationType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, TargetInformationType_Names::Extern_Type_Name);
  }
  if (accessor.hasNumberOfDMPIs()) {
    extjson_uci::util::SerializationHelpers::serializeUnsignedInt(accessor.getNumberOfDMPIs(), node, TargetInformationType_Names::NumberOfDMPIs_Name);
  }
