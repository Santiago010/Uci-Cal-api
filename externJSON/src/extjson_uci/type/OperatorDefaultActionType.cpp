...
bool OperatorDefaultActionType::deserialize(const boost::property_tree::ptree& propTree, uci::type::OperatorDefaultActionType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = OperatorDefaultActionType_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + OperatorDefaultActionType_Names::OperatorActionID_Name) {
...
std::string OperatorDefaultActionType::serialize(const uci::type::OperatorDefaultActionType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, OperatorDefaultActionType_Names::Extern_Type_Name);
  }
  OperatorActionID_Type::serialize(accessor.getOperatorActionID(), node, OperatorDefaultActionType_Names::OperatorActionID_Name);
  extjson_uci::util::SerializationHelpers::serializeDuration(accessor.getTimeout(), node, OperatorDefaultActionType_Names::Timeout_Name);
  if (createNode) {
