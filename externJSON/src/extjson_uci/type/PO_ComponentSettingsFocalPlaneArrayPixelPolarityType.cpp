...
bool PO_ComponentSettingsFocalPlaneArrayPixelPolarityType::deserialize(const boost::property_tree::ptree& propTree, uci::type::PO_ComponentSettingsFocalPlaneArrayPixelPolarityType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + PO_ComponentSettingsFocalPlaneArrayPixelPolarityType_Names::PolaritySetting_Name) {
...
std::string PO_ComponentSettingsFocalPlaneArrayPixelPolarityType::serialize(const uci::type::PO_ComponentSettingsFocalPlaneArrayPixelPolarityType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, PO_ComponentSettingsFocalPlaneArrayPixelPolarityType_Names::Extern_Type_Name);
  }
  if (accessor.isPolaritySetting()) {
    extjson_uci::util::SerializationHelpers::serializeBoolean(accessor.getPolaritySetting(), node, PO_ComponentSettingsFocalPlaneArrayPixelPolarityType_Names::PolaritySetting_Name);
