...
bool OB_SensorIdentityType::deserialize(const boost::property_tree::ptree& propTree, uci::type::OB_SensorIdentityType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = OB_SensorIdentityType_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + OB_SensorIdentityType_Names::Mobility_Name) {
...
std::string OB_SensorIdentityType::serialize(const uci::type::OB_SensorIdentityType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, OB_SensorIdentityType_Names::Extern_Type_Name);
  }
