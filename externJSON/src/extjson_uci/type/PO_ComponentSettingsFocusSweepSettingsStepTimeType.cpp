...
bool PO_ComponentSettingsFocusSweepSettingsStepTimeType::deserialize(const boost::property_tree::ptree& propTree, uci::type::PO_ComponentSettingsFocusSweepSettingsStepTimeType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = PO_ComponentSettingsFocusSweepSettingsStepTimeType_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + PO_ComponentSettingsFocusSweepSettingsStepTimeType_Names::NumberOfLines_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setNumberOfLines(extjson_uci::util::SerializationHelpers::deserializeUnsignedInt(*value));
      }
    } else if (valueType.first == nsPrefix + PO_ComponentSettingsFocusSweepSettingsStepTimeType_Names::CollectionTime_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setCollectionTime(extjson_uci::util::SerializationHelpers::deserializeDuration(*value));
      }
    }
  }
  return true;
...
std::string PO_ComponentSettingsFocusSweepSettingsStepTimeType::serialize(const uci::type::PO_ComponentSettingsFocusSweepSettingsStepTimeType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, PO_ComponentSettingsFocusSweepSettingsStepTimeType_Names::Extern_Type_Name);
  }
  if (accessor.isNumberOfLines()) {
    extjson_uci::util::SerializationHelpers::serializeUnsignedInt(accessor.getNumberOfLines(), node, PO_ComponentSettingsFocusSweepSettingsStepTimeType_Names::NumberOfLines_Name);
  } else if (accessor.isCollectionTime()) {
    extjson_uci::util::SerializationHelpers::serializeDuration(accessor.getCollectionTime(), node, PO_ComponentSettingsFocusSweepSettingsStepTimeType_Names::CollectionTime_Name);
  }
  if (createNode) {
