...
bool COMINT_SubCapabilityDetailsType::deserialize(const boost::property_tree::ptree& propTree, uci::type::COMINT_SubCapabilityDetailsType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + COMINT_SubCapabilityDetailsType_Names::Acquisition_Name) {
...
std::string COMINT_SubCapabilityDetailsType::serialize(const uci::type::COMINT_SubCapabilityDetailsType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, COMINT_SubCapabilityDetailsType_Names::Extern_Type_Name);
  }
