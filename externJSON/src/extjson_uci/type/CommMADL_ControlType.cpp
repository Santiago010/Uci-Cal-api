...
bool CommMADL_ControlType::deserialize(const boost::property_tree::ptree& propTree, uci::type::CommMADL_ControlType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + CommMADL_ControlType_Names::Node_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setNode(extjson_uci::util::SerializationHelpers::deserializeUnsignedByte(*value));
      }
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setMADL_DayOfYear(extjson_uci::util::SerializationHelpers::deserializeUnsignedShort(*value));
      }
    } else if (valueType.first == nsPrefix + CommMADL_ControlType_Names::VoiceTxExtent_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setVoiceTxExtent(extjson_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
...
std::string CommMADL_ControlType::serialize(const uci::type::CommMADL_ControlType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, CommMADL_ControlType_Names::Extern_Type_Name);
  }
  extjson_uci::util::SerializationHelpers::serializeUnsignedByte(accessor.getNode(), node, CommMADL_ControlType_Names::Node_Name);
  if (accessor.hasFlightGroupIdentifier()) {
    extjson_uci::util::SerializationHelpers::serializeString(accessor.getFlightGroupIdentifier(), node, CommMADL_ControlType_Names::FlightGroupIdentifier_Name);
  }
  ...
  if (accessor.hasMADL_DayOfYear()) {
    extjson_uci::util::SerializationHelpers::serializeUnsignedShort(accessor.getMADL_DayOfYear(), node, CommMADL_ControlType_Names::MADL_DayOfYear_Name);
  }
  if (accessor.hasVoiceTxExtent()) {
    extjson_uci::util::SerializationHelpers::serializeBoolean(accessor.getVoiceTxExtent(), node, CommMADL_ControlType_Names::VoiceTxExtent_Name);
  }
