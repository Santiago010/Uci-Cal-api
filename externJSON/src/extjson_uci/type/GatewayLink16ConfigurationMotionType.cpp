...
bool GatewayLink16ConfigurationMotionType::deserialize(const boost::property_tree::ptree& propTree, uci::type::GatewayLink16ConfigurationMotionType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + GatewayLink16ConfigurationMotionType_Names::Moving_Name) {
...
std::string GatewayLink16ConfigurationMotionType::serialize(const uci::type::GatewayLink16ConfigurationMotionType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, GatewayLink16ConfigurationMotionType_Names::Extern_Type_Name);
  }
