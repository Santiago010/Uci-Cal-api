...
bool ACFTB_Type::deserialize(const boost::property_tree::ptree& propTree, uci::type::ACFTB_Type& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + ACFTB_Type_Names::AC_MSN_Identifier_Name) {
...
std::string ACFTB_Type::serialize(const uci::type::ACFTB_Type& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, ACFTB_Type_Names::Extern_Type_Name);
  }
  if (accessor.hasAC_MSN_Identifier()) {
    extjson_uci::util::SerializationHelpers::serializeString(accessor.getAC_MSN_Identifier(), node, ACFTB_Type_Names::AC_MSN_Identifier_Name);
  }
  if (accessor.hasAC_TAIL_NO()) {
    extjson_uci::util::SerializationHelpers::serializeString(accessor.getAC_TAIL_NO(), node, ACFTB_Type_Names::AC_TAIL_NO_Name);
  }
  if (accessor.hasAC_TO()) {
    extjson_uci::util::SerializationHelpers::serializeString(accessor.getAC_TO(), node, ACFTB_Type_Names::AC_TO_Name);
  }
  if (accessor.hasSENSOR_Identifier()) {
    extjson_uci::util::SerializationHelpers::serializeString(accessor.getSENSOR_Identifier(), node, ACFTB_Type_Names::SENSOR_Identifier_Name);
  }
  if (accessor.hasSCENE_SOURCE()) {
    extjson_uci::util::SerializationHelpers::serializeString(accessor.getSCENE_SOURCE(), node, ACFTB_Type_Names::SCENE_SOURCE_Name);
  }
  if (accessor.hasSCNUM()) {
    extjson_uci::util::SerializationHelpers::serializeString(accessor.getSCNUM(), node, ACFTB_Type_Names::SCNUM_Name);
  }
  if (accessor.hasIMHOSTNO()) {
    extjson_uci::util::SerializationHelpers::serializeString(accessor.getIMHOSTNO(), node, ACFTB_Type_Names::IMHOSTNO_Name);
  }
  if (accessor.hasIMREQ_Identifier()) {
    extjson_uci::util::SerializationHelpers::serializeString(accessor.getIMREQ_Identifier(), node, ACFTB_Type_Names::IMREQ_Identifier_Name);
  }
  if (createNode) {
