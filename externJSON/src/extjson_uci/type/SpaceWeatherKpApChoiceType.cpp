...
bool SpaceWeatherKpApChoiceType::deserialize(const boost::property_tree::ptree& propTree, uci::type::SpaceWeatherKpApChoiceType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = SpaceWeatherKpApChoiceType_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + SpaceWeatherKpApChoiceType_Names::Kp_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setKp(extjson_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    } else if (valueType.first == nsPrefix + SpaceWeatherKpApChoiceType_Names::Ap_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setAp(extjson_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    }
  }
  return true;
...
std::string SpaceWeatherKpApChoiceType::serialize(const uci::type::SpaceWeatherKpApChoiceType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, SpaceWeatherKpApChoiceType_Names::Extern_Type_Name);
  }
  if (accessor.isKp()) {
    extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getKp(), node, SpaceWeatherKpApChoiceType_Names::Kp_Name);
  } else if (accessor.isAp()) {
    extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getAp(), node, SpaceWeatherKpApChoiceType_Names::Ap_Name);
  }
  if (createNode) {
