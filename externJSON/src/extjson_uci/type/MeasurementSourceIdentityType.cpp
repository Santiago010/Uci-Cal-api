...
bool MeasurementSourceIdentityType::deserialize(const boost::property_tree::ptree& propTree, uci::type::MeasurementSourceIdentityType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = MeasurementSourceIdentityType_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + MeasurementSourceIdentityType_Names::CapabilityID_Name) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setSensorSystemIdentity(extjson_uci::util::SerializationHelpers::deserializeUnsignedShort(*value));
      }
...
std::string MeasurementSourceIdentityType::serialize(const uci::type::MeasurementSourceIdentityType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, MeasurementSourceIdentityType_Names::Extern_Type_Name);
  }
  ...
  if (accessor.hasSensorSystemIdentity()) {
    extjson_uci::util::SerializationHelpers::serializeUnsignedShort(accessor.getSensorSystemIdentity(), node, MeasurementSourceIdentityType_Names::SensorSystemIdentity_Name);
  }
