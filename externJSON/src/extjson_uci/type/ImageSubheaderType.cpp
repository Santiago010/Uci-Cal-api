...
bool ImageSubheaderType::deserialize(const boost::property_tree::ptree& propTree, uci::type::ImageSubheaderType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + ImageSubheaderType_Names::ImageSource_Name) {
...
std::string ImageSubheaderType::serialize(const uci::type::ImageSubheaderType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, ImageSubheaderType_Names::Extern_Type_Name);
  }
  if (accessor.hasImageSource()) {
    extjson_uci::util::SerializationHelpers::serializeString(accessor.getImageSource(), node, ImageSubheaderType_Names::ImageSource_Name);
  }
  if (accessor.hasPrimaryTargetIdentifier()) {
    extjson_uci::util::SerializationHelpers::serializeString(accessor.getPrimaryTargetIdentifier(), node, ImageSubheaderType_Names::PrimaryTargetIdentifier_Name);
  }
  if (accessor.hasImageIdentifier1()) {
    extjson_uci::util::SerializationHelpers::serializeString(accessor.getImageIdentifier1(), node, ImageSubheaderType_Names::ImageIdentifier1_Name);
  }
  if (accessor.hasImageIdentifier2()) {
    extjson_uci::util::SerializationHelpers::serializeString(accessor.getImageIdentifier2(), node, ImageSubheaderType_Names::ImageIdentifier2_Name);
  }
  if (accessor.hasICOM_N()) {
    extjson_uci::util::SerializationHelpers::serializeString(accessor.getICOM_N(), node, ImageSubheaderType_Names::ICOM_N_Name);
  }
  if (createNode) {
