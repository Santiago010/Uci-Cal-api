...
bool ProductOutputCapabilityImageryType::deserialize(const boost::property_tree::ptree& propTree, uci::type::ProductOutputCapabilityImageryType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + ProductOutputCapabilityImageryType_Names::GeneratorOutputID_Name) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setInterlaceability(extjson_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
...
std::string ProductOutputCapabilityImageryType::serialize(const uci::type::ProductOutputCapabilityImageryType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, ProductOutputCapabilityImageryType_Names::Extern_Type_Name);
  }
  ...
  if (accessor.hasInterlaceability()) {
    extjson_uci::util::SerializationHelpers::serializeBoolean(accessor.getInterlaceability(), node, ProductOutputCapabilityImageryType_Names::Interlaceability_Name);
  }
