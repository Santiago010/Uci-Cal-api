...
bool OrbitalKinematicsStandardFrameChoiceType::deserialize(const boost::property_tree::ptree& propTree, uci::type::OrbitalKinematicsStandardFrameChoiceType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + OrbitalKinematicsStandardFrameChoiceType_Names::J2K_Name) {
...
std::string OrbitalKinematicsStandardFrameChoiceType::serialize(const uci::type::OrbitalKinematicsStandardFrameChoiceType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, OrbitalKinematicsStandardFrameChoiceType_Names::Extern_Type_Name);
  }
  if (accessor.isJ2K()) {
