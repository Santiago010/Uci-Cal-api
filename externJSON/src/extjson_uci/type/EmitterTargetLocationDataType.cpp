...
bool EmitterTargetLocationDataType::deserialize(const boost::property_tree::ptree& propTree, uci::type::EmitterTargetLocationDataType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = EmitterTargetLocationDataType_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + EmitterTargetLocationDataType_Names::EmitterSourceID_Name) {
...
std::string EmitterTargetLocationDataType::serialize(const uci::type::EmitterTargetLocationDataType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, EmitterTargetLocationDataType_Names::Extern_Type_Name);
  }
