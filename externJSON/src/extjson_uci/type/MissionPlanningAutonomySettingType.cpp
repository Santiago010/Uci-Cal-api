...
bool MissionPlanningAutonomySettingType::deserialize(const boost::property_tree::ptree& propTree, uci::type::MissionPlanningAutonomySettingType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + MissionPlanningAutonomySettingType_Names::Trigger_Name) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setMinimumResponseInterval(extjson_uci::util::SerializationHelpers::deserializeDuration(*value));
      }
    }
  }
  return true;
...
std::string MissionPlanningAutonomySettingType::serialize(const uci::type::MissionPlanningAutonomySettingType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, MissionPlanningAutonomySettingType_Names::Extern_Type_Name);
  }
  ...
  if (accessor.hasMinimumResponseInterval()) {
    extjson_uci::util::SerializationHelpers::serializeDuration(accessor.getMinimumResponseInterval(), node, MissionPlanningAutonomySettingType_Names::MinimumResponseInterval_Name);
  }
  if (createNode) {
