...
bool OperatorRoleMDT::deserialize(const boost::property_tree::ptree& propTree, uci::type::OperatorRoleMDT& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + OperatorRoleMDT_Names::OperatorRoleID_Name) {
      ...
      extjson_uci::util::DerivedTypesDeserializer::deserialize(valueType.second, accessor.enableRole(extjson_uci::util::SerializationHelpers::checkForTypeAttribute(valueType.second, nsPrefix)), nodeName, nsPrefix);
...
std::string OperatorRoleMDT::serialize(const uci::type::OperatorRoleMDT& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, OperatorRoleMDT_Names::Extern_Type_Name);
  }
  ...
  if (accessor.hasRoleDescription()) {
    extjson_uci::util::SerializationHelpers::serializeString(accessor.getRoleDescription(), node, OperatorRoleMDT_Names::RoleDescription_Name);
  }
  if (createNode) {
