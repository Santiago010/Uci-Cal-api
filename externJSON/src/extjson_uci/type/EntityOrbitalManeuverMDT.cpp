...
bool EntityOrbitalManeuverMDT::deserialize(const boost::property_tree::ptree& propTree, uci::type::EntityOrbitalManeuverMDT& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + EntityOrbitalManeuverMDT_Names::ManeuverID_Name) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setStateObservations(extjson_uci::util::SerializationHelpers::deserializeUnsignedInt(*value));
      }
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setManeuverSolutionIteration(extjson_uci::util::SerializationHelpers::deserializeUnsignedInt(*value));
      }
    }
  }
  return true;
...
std::string EntityOrbitalManeuverMDT::serialize(const uci::type::EntityOrbitalManeuverMDT& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, EntityOrbitalManeuverMDT_Names::Extern_Type_Name);
  }
  ...
  if (accessor.hasStateObservations()) {
    extjson_uci::util::SerializationHelpers::serializeUnsignedInt(accessor.getStateObservations(), node, EntityOrbitalManeuverMDT_Names::StateObservations_Name);
  }
  {
  ...
  if (accessor.hasManeuverSolutionIteration()) {
    extjson_uci::util::SerializationHelpers::serializeUnsignedInt(accessor.getManeuverSolutionIteration(), node, EntityOrbitalManeuverMDT_Names::ManeuverSolutionIteration_Name);
  }
  if (createNode) {
