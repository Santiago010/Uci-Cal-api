...
bool OpDescriptionType::deserialize(const boost::property_tree::ptree& propTree, uci::type::OpDescriptionType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = OpDescriptionType_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + OpDescriptionType_Names::Name_Name) {
...
std::string OpDescriptionType::serialize(const uci::type::OpDescriptionType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, OpDescriptionType_Names::Extern_Type_Name);
  }
  if (accessor.hasName()) {
    extjson_uci::util::SerializationHelpers::serializeString(accessor.getName(), node, OpDescriptionType_Names::Name_Name);
  }
  if (accessor.hasRemarks()) {
    extjson_uci::util::SerializationHelpers::serializeString(accessor.getRemarks(), node, OpDescriptionType_Names::Remarks_Name);
  }
  if (createNode) {
