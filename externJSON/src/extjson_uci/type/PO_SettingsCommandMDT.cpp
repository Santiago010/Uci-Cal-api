...
bool PO_SettingsCommandMDT::deserialize(const boost::property_tree::ptree& propTree, uci::type::PO_SettingsCommandMDT& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + PO_SettingsCommandMDT_Names::SubCapability_Name) {
...
std::string PO_SettingsCommandMDT::serialize(const uci::type::PO_SettingsCommandMDT& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, PO_SettingsCommandMDT_Names::Extern_Type_Name);
  }
  ...
  {
    PO_MessageOutputsEnum::serializeList(accessor.getMessageOutput(), node, PO_SettingsCommandMDT_Names::MessageOutput_Name);
  }
