...
bool GeoLocatedObjectType::deserialize(const boost::property_tree::ptree& propTree, uci::type::GeoLocatedObjectType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + GeoLocatedObjectType_Names::EntityID_Name) {
...
std::string GeoLocatedObjectType::serialize(const uci::type::GeoLocatedObjectType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, GeoLocatedObjectType_Names::Extern_Type_Name);
  }
