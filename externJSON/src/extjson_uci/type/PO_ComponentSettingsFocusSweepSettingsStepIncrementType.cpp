...
bool PO_ComponentSettingsFocusSweepSettingsStepIncrementType::deserialize(const boost::property_tree::ptree& propTree, uci::type::PO_ComponentSettingsFocusSweepSettingsStepIncrementType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = PO_ComponentSettingsFocusSweepSettingsStepIncrementType_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + PO_ComponentSettingsFocusSweepSettingsStepIncrementType_Names::Percentage_Name) {
...
std::string PO_ComponentSettingsFocusSweepSettingsStepIncrementType::serialize(const uci::type::PO_ComponentSettingsFocusSweepSettingsStepIncrementType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, PO_ComponentSettingsFocusSweepSettingsStepIncrementType_Names::Extern_Type_Name);
  }
  if (accessor.isPercentage()) {
    extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getPercentage(), node, PO_ComponentSettingsFocusSweepSettingsStepIncrementType_Names::Percentage_Name);
  } else if (accessor.isNumberOfSteps()) {
    extjson_uci::util::SerializationHelpers::serializeUnsignedInt(accessor.getNumberOfSteps(), node, PO_ComponentSettingsFocusSweepSettingsStepIncrementType_Names::NumberOfSteps_Name);
  }
  if (createNode) {
