...
bool ActionPlanStatusMT::deserialize(const boost::property_tree::ptree& propTree, uci::type::ActionPlanStatusMT& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + ActionPlanStatusMT_Names::MessageData_Name) {
...
std::string ActionPlanStatusMT::serialize(const uci::type::ActionPlanStatusMT& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool topLevel) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, (topLevel ? ActionPlanStatusMT_Names::Extern_Top_Type_Name : ActionPlanStatusMT_Names::Extern_Type_Name));
  }
