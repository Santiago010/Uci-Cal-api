...
bool EndPointType::deserialize(const boost::property_tree::ptree& propTree, uci::type::EndPointType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + EndPointType_Names::WayPoint_Name) {
...
std::string EndPointType::serialize(const uci::type::EndPointType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, EndPointType_Names::Extern_Type_Name);
  }
