...
bool EnvironmentIdentityType::deserialize(const boost::property_tree::ptree& propTree, uci::type::EnvironmentIdentityType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = EnvironmentIdentityType_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + EnvironmentIdentityType_Names::Environment_Name) {
...
std::string EnvironmentIdentityType::serialize(const uci::type::EnvironmentIdentityType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, EnvironmentIdentityType_Names::Extern_Type_Name);
  }
