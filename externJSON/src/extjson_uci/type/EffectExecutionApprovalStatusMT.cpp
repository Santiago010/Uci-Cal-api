...
bool EffectExecutionApprovalStatusMT::deserialize(const boost::property_tree::ptree& propTree, uci::type::EffectExecutionApprovalStatusMT& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + EffectExecutionApprovalStatusMT_Names::MessageData_Name) {
...
std::string EffectExecutionApprovalStatusMT::serialize(const uci::type::EffectExecutionApprovalStatusMT& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool topLevel) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, (topLevel ? EffectExecutionApprovalStatusMT_Names::Extern_Top_Type_Name : EffectExecutionApprovalStatusMT_Names::Extern_Type_Name));
  }
