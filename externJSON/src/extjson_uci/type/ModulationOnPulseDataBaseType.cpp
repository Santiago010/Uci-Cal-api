...
bool ModulationOnPulseDataBaseType::deserialize(const boost::property_tree::ptree& propTree, uci::type::ModulationOnPulseDataBaseType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + ModulationOnPulseDataBaseType_Names::MOP_Name) {
...
std::string ModulationOnPulseDataBaseType::serialize(const uci::type::ModulationOnPulseDataBaseType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool checkIfDerivation, const bool /*topLevel*/) {
  ...
  if (!checkIfDerivation || (accessor.getAccessorType() == uci::type::accessorType::modulationOnPulseDataBaseType)) {
    ...
    if (addTypeAttribute) {
      extjson_uci::util::SerializationHelpers::addTypeAttribute(node, ModulationOnPulseDataBaseType_Names::Extern_Type_Name);
    }
