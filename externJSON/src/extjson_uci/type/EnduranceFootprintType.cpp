...
bool EnduranceFootprintType::deserialize(const boost::property_tree::ptree& propTree, uci::type::EnduranceFootprintType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = EnduranceFootprintType_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + EnduranceFootprintType_Names::Boundary_Name) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setReferenceAltitude(extjson_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
...
std::string EnduranceFootprintType::serialize(const uci::type::EnduranceFootprintType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, EnduranceFootprintType_Names::Extern_Type_Name);
  }
  ...
  if (accessor.hasReferenceAltitude()) {
    extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getReferenceAltitude(), node, EnduranceFootprintType_Names::ReferenceAltitude_Name);
  }
  if (accessor.hasDuration()) {
    extjson_uci::util::SerializationHelpers::serializeDuration(accessor.getDuration(), node, EnduranceFootprintType_Names::Duration_Name);
  }
  if (createNode) {
