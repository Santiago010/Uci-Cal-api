...
bool ThreatAssessmentProbabilityType::deserialize(const boost::property_tree::ptree& propTree, uci::type::ThreatAssessmentProbabilityType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = ThreatAssessmentProbabilityType_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + ThreatAssessmentProbabilityType_Names::EffectiveProbability_Name) {
...
std::string ThreatAssessmentProbabilityType::serialize(const uci::type::ThreatAssessmentProbabilityType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, ThreatAssessmentProbabilityType_Names::Extern_Type_Name);
  }
  if (accessor.hasEffectiveProbability()) {
    extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getEffectiveProbability(), node, ThreatAssessmentProbabilityType_Names::EffectiveProbability_Name);
  }
  if (accessor.hasExposureTime()) {
    extjson_uci::util::SerializationHelpers::serializeDuration(accessor.getExposureTime(), node, ThreatAssessmentProbabilityType_Names::ExposureTime_Name);
  }
  if (createNode) {
