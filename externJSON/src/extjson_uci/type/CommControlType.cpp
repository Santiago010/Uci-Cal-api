...
bool CommControlType::deserialize(const boost::property_tree::ptree& propTree, uci::type::CommControlType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + CommControlType_Names::InhibitTransmit_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setInhibitTransmit(extjson_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
    } else if (valueType.first == nsPrefix + CommControlType_Names::InhibitReceive_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setInhibitReceive(extjson_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
    } else if (valueType.first == nsPrefix + CommControlType_Names::InhibitRelay_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setInhibitRelay(extjson_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setRxPowerLevel(extjson_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    } else if (valueType.first == nsPrefix + CommControlType_Names::SquelchLevel_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setSquelchLevel(extjson_uci::util::SerializationHelpers::deserializeUnsignedByte(*value));
      }
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setTxPowerLevel(extjson_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    } else if (valueType.first == nsPrefix + CommControlType_Names::VolumeLevel_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setVolumeLevel(extjson_uci::util::SerializationHelpers::deserializeUnsignedByte(*value));
      }
    } else if (valueType.first == nsPrefix + CommControlType_Names::RF_DataRate_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setRF_DataRate(extjson_uci::util::SerializationHelpers::deserializeUnsignedInt(*value));
      }
...
std::string CommControlType::serialize(const uci::type::CommControlType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, CommControlType_Names::Extern_Type_Name);
  }
  if (accessor.hasInhibitTransmit()) {
    extjson_uci::util::SerializationHelpers::serializeBoolean(accessor.getInhibitTransmit(), node, CommControlType_Names::InhibitTransmit_Name);
  }
  if (accessor.hasInhibitReceive()) {
    extjson_uci::util::SerializationHelpers::serializeBoolean(accessor.getInhibitReceive(), node, CommControlType_Names::InhibitReceive_Name);
  }
  if (accessor.hasInhibitRelay()) {
    extjson_uci::util::SerializationHelpers::serializeBoolean(accessor.getInhibitRelay(), node, CommControlType_Names::InhibitRelay_Name);
  }
  ...
  if (accessor.hasRxPowerLevel()) {
    extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getRxPowerLevel(), node, CommControlType_Names::RxPowerLevel_Name);
  }
  if (accessor.hasSquelchLevel()) {
    extjson_uci::util::SerializationHelpers::serializeUnsignedByte(accessor.getSquelchLevel(), node, CommControlType_Names::SquelchLevel_Name);
  }
  ...
  if (accessor.hasTxPowerLevel()) {
    extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getTxPowerLevel(), node, CommControlType_Names::TxPowerLevel_Name);
  }
  if (accessor.hasVolumeLevel()) {
    extjson_uci::util::SerializationHelpers::serializeUnsignedByte(accessor.getVolumeLevel(), node, CommControlType_Names::VolumeLevel_Name);
  }
  if (accessor.hasRF_DataRate()) {
    extjson_uci::util::SerializationHelpers::serializeUnsignedInt(accessor.getRF_DataRate(), node, CommControlType_Names::RF_DataRate_Name);
  }
  {
