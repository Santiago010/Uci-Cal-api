...
bool PointingVectorParameterType::deserialize(const boost::property_tree::ptree& propTree, uci::type::PointingVectorParameterType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + PointingVectorParameterType_Names::DataRate_Name) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setLossParameter(extjson_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    } else if (valueType.first == nsPrefix + PointingVectorParameterType_Names::Ellipse_Name) {
      extjson_uci::util::DerivedTypesDeserializer::deserialize(valueType.second, accessor.enableEllipse(extjson_uci::util::SerializationHelpers::checkForTypeAttribute(valueType.second, nsPrefix)), nodeName, nsPrefix);
    }
  }
  return true;
}
...
std::string PointingVectorParameterType::serialize(const uci::type::PointingVectorParameterType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, PointingVectorParameterType_Names::Extern_Type_Name);
  }
  if (accessor.hasDataRate()) {
    extjson_uci::util::SerializationHelpers::serializeUnsignedInt(accessor.getDataRate(), node, PointingVectorParameterType_Names::DataRate_Name);
  }
  if (accessor.hasLossParameter()) {
    extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getLossParameter(), node, PointingVectorParameterType_Names::LossParameter_Name);
  }
