...
bool RoutePlanReferencesType::deserialize(const boost::property_tree::ptree& propTree, uci::type::RoutePlanReferencesType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = RoutePlanReferencesType_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + RoutePlanReferencesType_Names::RoutePlanID_Name) {
      ...
      boundedList.resize(boundedListSize + 1);
      PathConstraintsType::deserialize(valueType.second, boundedList.at(boundedListSize), nodeName, nsPrefix);
    }
  }
  return true;
}
...
std::string RoutePlanReferencesType::serialize(const uci::type::RoutePlanReferencesType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, RoutePlanReferencesType_Names::Extern_Type_Name);
  }
  ...
  }
  {
    ...
    for (uci::type::RoutePlanReferencesType::PathID::size_type i = 0, end = boundedList.size(); i < end; ++i) {
      PathID_Type::serialize(boundedList.at(i), node, RoutePlanReferencesType_Names::PathID_Name);
    }
  }
  {
    ...
    for (uci::type::RoutePlanReferencesType::SegmentID::size_type i = 0, end = boundedList.size(); i < end; ++i) {
      SegmentID_Type::serialize(boundedList.at(i), node, RoutePlanReferencesType_Names::SegmentID_Name);
    }
  }
  {
    ...
    for (uci::type::RoutePlanReferencesType::Constraints::size_type i = 0, end = boundedList.size(); i < end; ++i) {
      PathConstraintsType::serialize(boundedList.at(i), node, RoutePlanReferencesType_Names::Constraints_Name);
    }
  }
  if (createNode) {
