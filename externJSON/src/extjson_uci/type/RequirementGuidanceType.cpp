...
bool RequirementGuidanceType::deserialize(const boost::property_tree::ptree& propTree, uci::type::RequirementGuidanceType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = RequirementGuidanceType_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + RequirementGuidanceType_Names::Usage_Name) {
      RequirementUsageEnum::deserializeList(valueType.second, accessor.getUsage());
...
std::string RequirementGuidanceType::serialize(const uci::type::RequirementGuidanceType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, RequirementGuidanceType_Names::Extern_Type_Name);
  }
  {
    RequirementUsageEnum::serializeList(accessor.getUsage(), node, RequirementGuidanceType_Names::Usage_Name);
  }
