...
bool ScanDataType::deserialize(const boost::property_tree::ptree& propTree, uci::type::ScanDataType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + ScanDataType_Names::ScanTimestamp_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setScanTimestamp(extjson_uci::util::SerializationHelpers::deserializeDateTime(*value));
      }
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setSectorWidth(extjson_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
      ...
      extjson_uci::util::SerializationHelpers::deserializeDurationList(valueType.second, accessor.getScanPeriod());
    } else if (valueType.first == nsPrefix + ScanDataType_Names::OOK_Present_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setOOK_Present(extjson_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
...
std::string ScanDataType::serialize(const uci::type::ScanDataType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, ScanDataType_Names::Extern_Type_Name);
  }
  ScanDataBaseType::serialize(accessor, node, "", false, false, false);
  extjson_uci::util::SerializationHelpers::serializeDateTime(accessor.getScanTimestamp(), node, ScanDataType_Names::ScanTimestamp_Name);
  ...
  if (accessor.hasSectorWidth()) {
    extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getSectorWidth(), node, ScanDataType_Names::SectorWidth_Name);
  }
  ...
  {
    extjson_uci::util::SerializationHelpers::serializeDurationList(accessor.getScanPeriod(), node, ScanDataType_Names::ScanPeriod_Name);
  }
  if (accessor.hasOOK_Present()) {
    extjson_uci::util::SerializationHelpers::serializeBoolean(accessor.getOOK_Present(), node, ScanDataType_Names::OOK_Present_Name);
  }
  {
