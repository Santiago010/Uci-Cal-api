...
bool FileHeaderRevA_Type::deserialize(const boost::property_tree::ptree& propTree, uci::type::FileHeaderRevA_Type& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + FileHeaderRevA_Type_Names::FileSecurityClassification_Name) {
...
std::string FileHeaderRevA_Type::serialize(const uci::type::FileHeaderRevA_Type& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, FileHeaderRevA_Type_Names::Extern_Type_Name);
  }
  extjson_uci::util::SerializationHelpers::serializeString(accessor.getFileSecurityClassification(), node, FileHeaderRevA_Type_Names::FileSecurityClassification_Name);
  if (accessor.hasFileClassificationSystem()) {
    extjson_uci::util::SerializationHelpers::serializeString(accessor.getFileClassificationSystem(), node, FileHeaderRevA_Type_Names::FileClassificationSystem_Name);
  }
  if (accessor.hasFileCodewords()) {
    extjson_uci::util::SerializationHelpers::serializeString(accessor.getFileCodewords(), node, FileHeaderRevA_Type_Names::FileCodewords_Name);
  }
  if (accessor.hasFileControlAndHandling()) {
    extjson_uci::util::SerializationHelpers::serializeString(accessor.getFileControlAndHandling(), node, FileHeaderRevA_Type_Names::FileControlAndHandling_Name);
  }
  if (accessor.hasFileReleasingInstructions()) {
    extjson_uci::util::SerializationHelpers::serializeString(accessor.getFileReleasingInstructions(), node, FileHeaderRevA_Type_Names::FileReleasingInstructions_Name);
  }
  if (accessor.hasFileDeclassificationType()) {
    extjson_uci::util::SerializationHelpers::serializeString(accessor.getFileDeclassificationType(), node, FileHeaderRevA_Type_Names::FileDeclassificationType_Name);
  }
  if (accessor.hasFileDeclassificationDate()) {
    extjson_uci::util::SerializationHelpers::serializeString(accessor.getFileDeclassificationDate(), node, FileHeaderRevA_Type_Names::FileDeclassificationDate_Name);
  }
  if (accessor.hasFileDeclassificationExemption()) {
    extjson_uci::util::SerializationHelpers::serializeString(accessor.getFileDeclassificationExemption(), node, FileHeaderRevA_Type_Names::FileDeclassificationExemption_Name);
  }
  if (accessor.hasFileDowngrade()) {
    extjson_uci::util::SerializationHelpers::serializeString(accessor.getFileDowngrade(), node, FileHeaderRevA_Type_Names::FileDowngrade_Name);
  }
  if (accessor.hasFileDowngradeDate()) {
    extjson_uci::util::SerializationHelpers::serializeString(accessor.getFileDowngradeDate(), node, FileHeaderRevA_Type_Names::FileDowngradeDate_Name);
  }
  if (accessor.hasFileClassificationText()) {
    extjson_uci::util::SerializationHelpers::serializeString(accessor.getFileClassificationText(), node, FileHeaderRevA_Type_Names::FileClassificationText_Name);
  }
  if (accessor.hasFileClassificationAuthorityType()) {
    extjson_uci::util::SerializationHelpers::serializeString(accessor.getFileClassificationAuthorityType(), node, FileHeaderRevA_Type_Names::FileClassificationAuthorityType_Name);
  }
  if (accessor.hasFileClassificationAuthority()) {
    extjson_uci::util::SerializationHelpers::serializeString(accessor.getFileClassificationAuthority(), node, FileHeaderRevA_Type_Names::FileClassificationAuthority_Name);
  }
  if (accessor.hasFileClassificationReason()) {
    extjson_uci::util::SerializationHelpers::serializeString(accessor.getFileClassificationReason(), node, FileHeaderRevA_Type_Names::FileClassificationReason_Name);
  }
  if (accessor.hasFileSecuritySourceDate()) {
    extjson_uci::util::SerializationHelpers::serializeString(accessor.getFileSecuritySourceDate(), node, FileHeaderRevA_Type_Names::FileSecuritySourceDate_Name);
  }
  if (accessor.hasFileSecurityControlNumber()) {
    extjson_uci::util::SerializationHelpers::serializeString(accessor.getFileSecurityControlNumber(), node, FileHeaderRevA_Type_Names::FileSecurityControlNumber_Name);
  }
  if (accessor.hasOriginatorsName()) {
    extjson_uci::util::SerializationHelpers::serializeString(accessor.getOriginatorsName(), node, FileHeaderRevA_Type_Names::OriginatorsName_Name);
  }
  if (accessor.hasOriginatorsPhone()) {
    extjson_uci::util::SerializationHelpers::serializeString(accessor.getOriginatorsPhone(), node, FileHeaderRevA_Type_Names::OriginatorsPhone_Name);
  }
  if (createNode) {
