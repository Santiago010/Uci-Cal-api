...
bool ReadinessRecordType::deserialize(const boost::property_tree::ptree& propTree, uci::type::ReadinessRecordType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = ReadinessRecordType_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + ReadinessRecordType_Names::Item_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        ...
        ReadinessItemStatusType::deserialize(valueType.second, boundedList.at(boundedListSize), nodeName, nsPrefix);
      }
      ...
      extjson_uci::util::DerivedTypesDeserializer::deserialize(valueType.second, accessor.enableGeoZone(extjson_uci::util::SerializationHelpers::checkForTypeAttribute(valueType.second, nsPrefix)), nodeName, nsPrefix);
...
std::string ReadinessRecordType::serialize(const uci::type::ReadinessRecordType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, ReadinessRecordType_Names::Extern_Type_Name);
  }
  {
    ...
    for (uci::type::ReadinessRecordType::Item::size_type i = 0, end = boundedList.size(); i < end; ++i) {
      ReadinessItemStatusType::serialize(boundedList.at(i), node, ReadinessRecordType_Names::Item_Name);
    }
  }
