...
bool PO_ComponentSettingsLensAssemblyFocusType::deserialize(const boost::property_tree::ptree& propTree, uci::type::PO_ComponentSettingsLensAssemblyFocusType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + PO_ComponentSettingsLensAssemblyFocusType_Names::FocusSetting_Name) {
...
std::string PO_ComponentSettingsLensAssemblyFocusType::serialize(const uci::type::PO_ComponentSettingsLensAssemblyFocusType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, PO_ComponentSettingsLensAssemblyFocusType_Names::Extern_Type_Name);
  }
  if (accessor.isFocusSetting()) {
    extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getFocusSetting(), node, PO_ComponentSettingsLensAssemblyFocusType_Names::FocusSetting_Name);
  } else if (accessor.isAutoFocus()) {
    extjson_uci::util::SerializationHelpers::serializeBoolean(accessor.getAutoFocus(), node, PO_ComponentSettingsLensAssemblyFocusType_Names::AutoFocus_Name);
  } else if (accessor.isAutoFocusZoom()) {
    extjson_uci::util::SerializationHelpers::serializeBoolean(accessor.getAutoFocusZoom(), node, PO_ComponentSettingsLensAssemblyFocusType_Names::AutoFocusZoom_Name);
