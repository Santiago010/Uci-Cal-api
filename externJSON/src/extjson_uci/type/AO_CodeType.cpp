...
bool AO_CodeType::deserialize(const boost::property_tree::ptree& propTree, uci::type::AO_CodeType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = AO_CodeType_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + AO_CodeType_Names::PRF_Code_Name) {
...
std::string AO_CodeType::serialize(const uci::type::AO_CodeType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, AO_CodeType_Names::Extern_Type_Name);
  }
  if (accessor.hasPRF_Code()) {
    extjson_uci::util::SerializationHelpers::serializeString(accessor.getPRF_Code(), node, AO_CodeType_Names::PRF_Code_Name);
  }
  if (accessor.hasPIM_Code()) {
    extjson_uci::util::SerializationHelpers::serializeString(accessor.getPIM_Code(), node, AO_CodeType_Names::PIM_Code_Name);
  }
  if (createNode) {
