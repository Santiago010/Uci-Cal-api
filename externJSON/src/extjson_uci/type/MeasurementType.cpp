...
bool MeasurementType::deserialize(const boost::property_tree::ptree& propTree, uci::type::MeasurementType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + MeasurementType_Names::MeasurementID_Name) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setIndependentMeasurement(extjson_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
    } else if (valueType.first == nsPrefix + MeasurementType_Names::UncorrelatedMeasurement_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setUncorrelatedMeasurement(extjson_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
      ...
      extjson_uci::util::DerivedTypesDeserializer::deserialize(valueType.second, accessor.enableObjectIdentity(extjson_uci::util::SerializationHelpers::checkForTypeAttribute(valueType.second, nsPrefix)), nodeName, nsPrefix);
...
std::string MeasurementType::serialize(const uci::type::MeasurementType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, MeasurementType_Names::Extern_Type_Name);
  }
  MeasurementID_Type::serialize(accessor.getMeasurementID(), node, MeasurementType_Names::MeasurementID_Name);
  extjson_uci::util::SerializationHelpers::serializeBoolean(accessor.getIndependentMeasurement(), node, MeasurementType_Names::IndependentMeasurement_Name);
  if (accessor.hasUncorrelatedMeasurement()) {
    extjson_uci::util::SerializationHelpers::serializeBoolean(accessor.getUncorrelatedMeasurement(), node, MeasurementType_Names::UncorrelatedMeasurement_Name);
  }
  extjson_uci::util::SerializationHelpers::serializeDateTime(accessor.getTimestamp(), node, MeasurementType_Names::Timestamp_Name);
  {
