...
bool RF_ResourceAllocationRequestDigitalRemovalType::deserialize(const boost::property_tree::ptree& propTree, uci::type::RF_ResourceAllocationRequestDigitalRemovalType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = RF_ResourceAllocationRequestDigitalRemovalType_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + RF_ResourceAllocationRequestDigitalRemovalType_Names::StreamIndex_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setStreamIndex(extjson_uci::util::SerializationHelpers::deserializeUnsignedInt(*value));
      }
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        ...
        MFA_AddressType::deserialize(valueType.second, boundedList.at(boundedListSize), nodeName, nsPrefix);
      }
    }
  }
  return true;
...
std::string RF_ResourceAllocationRequestDigitalRemovalType::serialize(const uci::type::RF_ResourceAllocationRequestDigitalRemovalType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, RF_ResourceAllocationRequestDigitalRemovalType_Names::Extern_Type_Name);
  }
  if (accessor.hasStreamIndex()) {
    extjson_uci::util::SerializationHelpers::serializeUnsignedInt(accessor.getStreamIndex(), node, RF_ResourceAllocationRequestDigitalRemovalType_Names::StreamIndex_Name);
  }
  {
    ...
    for (uci::type::RF_ResourceAllocationRequestDigitalRemovalType::MFA_Address::size_type i = 0, end = boundedList.size(); i < end; ++i) {
      MFA_AddressType::serialize(boundedList.at(i), node, RF_ResourceAllocationRequestDigitalRemovalType_Names::MFA_Address_Name);
    }
  }
  if (createNode) {
