...
bool WorkingEOB_RequestMDT::deserialize(const boost::property_tree::ptree& propTree, uci::type::WorkingEOB_RequestMDT& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + WorkingEOB_RequestMDT_Names::Source_Name) {
...
std::string WorkingEOB_RequestMDT::serialize(const uci::type::WorkingEOB_RequestMDT& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, WorkingEOB_RequestMDT_Names::Extern_Type_Name);
  }
  ...
  extjson_uci::util::SerializationHelpers::serializeBoolean(accessor.getTemporary(), node, WorkingEOB_RequestMDT_Names::Temporary_Name);
  if (createNode) {
