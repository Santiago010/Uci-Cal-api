...
bool ProductDisseminationTaskStatusMDT::deserialize(const boost::property_tree::ptree& propTree, uci::type::ProductDisseminationTaskStatusMDT& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = ProductDisseminationTaskStatusMDT_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + ProductDisseminationTaskStatusMDT_Names::ProductDisseminationStatus_Name) {
...
std::string ProductDisseminationTaskStatusMDT::serialize(const uci::type::ProductDisseminationTaskStatusMDT& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, ProductDisseminationTaskStatusMDT_Names::Extern_Type_Name);
  }
  ProductManagementTaskStatusDataType::serialize(accessor, node, "", false, false, false);
  {
    ...
    for (uci::type::ProductDisseminationTaskStatusMDT::ProductDisseminationStatus::size_type i = 0, end = boundedList.size(); i < end; ++i) {
      ProductDisseminationStatusType::serialize(boundedList.at(i), node, ProductDisseminationTaskStatusMDT_Names::ProductDisseminationStatus_Name);
    }
  }
  if (createNode) {
