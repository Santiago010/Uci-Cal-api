...
bool PO_ComponentF_StopVariableType::deserialize(const boost::property_tree::ptree& propTree, uci::type::PO_ComponentF_StopVariableType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + PO_ComponentF_StopVariableType_Names::Min_Name) {
...
std::string PO_ComponentF_StopVariableType::serialize(const uci::type::PO_ComponentF_StopVariableType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, PO_ComponentF_StopVariableType_Names::Extern_Type_Name);
  }
  extjson_uci::util::SerializationHelpers::serializeFloat(accessor.getMin(), node, PO_ComponentF_StopVariableType_Names::Min_Name);
  extjson_uci::util::SerializationHelpers::serializeFloat(accessor.getMax(), node, PO_ComponentF_StopVariableType_Names::Max_Name);
