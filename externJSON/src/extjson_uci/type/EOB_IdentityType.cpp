...
bool EOB_IdentityType::deserialize(const boost::property_tree::ptree& propTree, uci::type::EOB_IdentityType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = EOB_IdentityType_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + EOB_IdentityType_Names::Site_Name) {
...
std::string EOB_IdentityType::serialize(const uci::type::EOB_IdentityType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, EOB_IdentityType_Names::Extern_Type_Name);
  }
  if (accessor.isSite()) {
