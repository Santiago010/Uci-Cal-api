...
bool SAR_CollectionConstraintsQualityType::deserialize(const boost::property_tree::ptree& propTree, uci::type::SAR_CollectionConstraintsQualityType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = SAR_CollectionConstraintsQualityType_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + SAR_CollectionConstraintsQualityType_Names::DesiredNIIRS_Name) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setMinimumResolution(extjson_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    }
  }
  return true;
...
std::string SAR_CollectionConstraintsQualityType::serialize(const uci::type::SAR_CollectionConstraintsQualityType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, SAR_CollectionConstraintsQualityType_Names::Extern_Type_Name);
  }
  if (accessor.hasDesiredNIIRS()) {
    extjson_uci::util::SerializationHelpers::serializeString(accessor.getDesiredNIIRS(), node, SAR_CollectionConstraintsQualityType_Names::DesiredNIIRS_Name);
  }
  if (accessor.hasMinimumNIIRS()) {
    extjson_uci::util::SerializationHelpers::serializeString(accessor.getMinimumNIIRS(), node, SAR_CollectionConstraintsQualityType_Names::MinimumNIIRS_Name);
  }
  if (accessor.hasMinimumResolution()) {
    extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getMinimumResolution(), node, SAR_CollectionConstraintsQualityType_Names::MinimumResolution_Name);
  }
  if (createNode) {
