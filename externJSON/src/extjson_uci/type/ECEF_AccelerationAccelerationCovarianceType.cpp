...
bool ECEF_AccelerationAccelerationCovarianceType::deserialize(const boost::property_tree::ptree& propTree, uci::type::ECEF_AccelerationAccelerationCovarianceType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + ECEF_AccelerationAccelerationCovarianceType_Names::AxAx_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setAxAx(extjson_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    } else if (valueType.first == nsPrefix + ECEF_AccelerationAccelerationCovarianceType_Names::AxAy_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setAxAy(extjson_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    } else if (valueType.first == nsPrefix + ECEF_AccelerationAccelerationCovarianceType_Names::AxAz_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setAxAz(extjson_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    } else if (valueType.first == nsPrefix + ECEF_AccelerationAccelerationCovarianceType_Names::AyAy_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setAyAy(extjson_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    } else if (valueType.first == nsPrefix + ECEF_AccelerationAccelerationCovarianceType_Names::AyAz_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setAyAz(extjson_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    } else if (valueType.first == nsPrefix + ECEF_AccelerationAccelerationCovarianceType_Names::AzAz_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setAzAz(extjson_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    }
  }
  return true;
...
std::string ECEF_AccelerationAccelerationCovarianceType::serialize(const uci::type::ECEF_AccelerationAccelerationCovarianceType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, ECEF_AccelerationAccelerationCovarianceType_Names::Extern_Type_Name);
  }
  extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getAxAx(), node, ECEF_AccelerationAccelerationCovarianceType_Names::AxAx_Name);
  extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getAxAy(), node, ECEF_AccelerationAccelerationCovarianceType_Names::AxAy_Name);
  extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getAxAz(), node, ECEF_AccelerationAccelerationCovarianceType_Names::AxAz_Name);
  extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getAyAy(), node, ECEF_AccelerationAccelerationCovarianceType_Names::AyAy_Name);
  extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getAyAz(), node, ECEF_AccelerationAccelerationCovarianceType_Names::AyAz_Name);
  extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getAzAz(), node, ECEF_AccelerationAccelerationCovarianceType_Names::AzAz_Name);
  if (createNode) {
