...
bool StoreConfidenceType::deserialize(const boost::property_tree::ptree& propTree, uci::type::StoreConfidenceType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + StoreConfidenceType_Names::WeaponType_Name) {
      extjson_uci::util::DerivedTypesDeserializer::deserialize(valueType.second, accessor.enableWeaponType(extjson_uci::util::SerializationHelpers::checkForTypeAttribute(valueType.second, nsPrefix)), nodeName, nsPrefix);
...
std::string StoreConfidenceType::serialize(const uci::type::StoreConfidenceType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, StoreConfidenceType_Names::Extern_Type_Name);
  }
  StoreType::serialize(accessor.getWeaponType(), node, StoreConfidenceType_Names::WeaponType_Name);
  extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getConfidence(), node, StoreConfidenceType_Names::Confidence_Name);
  if (createNode) {
