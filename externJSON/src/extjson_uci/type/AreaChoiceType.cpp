...
bool AreaChoiceType::deserialize(const boost::property_tree::ptree& propTree, uci::type::AreaChoiceType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + AreaChoiceType_Names::Polygon_Name) {
...
std::string AreaChoiceType::serialize(const uci::type::AreaChoiceType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, AreaChoiceType_Names::Extern_Type_Name);
  }
