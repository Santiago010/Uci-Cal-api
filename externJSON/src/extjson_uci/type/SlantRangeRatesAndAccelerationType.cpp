...
bool SlantRangeRatesAndAccelerationType::deserialize(const boost::property_tree::ptree& propTree, uci::type::SlantRangeRatesAndAccelerationType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = SlantRangeRatesAndAccelerationType_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + SlantRangeRatesAndAccelerationType_Names::SlantRangeRate_Name) {
...
std::string SlantRangeRatesAndAccelerationType::serialize(const uci::type::SlantRangeRatesAndAccelerationType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, SlantRangeRatesAndAccelerationType_Names::Extern_Type_Name);
  }
  if (accessor.hasSlantRangeRate()) {
    extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getSlantRangeRate(), node, SlantRangeRatesAndAccelerationType_Names::SlantRangeRate_Name);
  }
  if (accessor.hasDeltaSlantRangeRate()) {
    extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getDeltaSlantRangeRate(), node, SlantRangeRatesAndAccelerationType_Names::DeltaSlantRangeRate_Name);
  }
  if (accessor.hasSlantRangeAcceleration()) {
    extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getSlantRangeAcceleration(), node, SlantRangeRatesAndAccelerationType_Names::SlantRangeAcceleration_Name);
  }
  if (createNode) {
