...
bool AccessEventType::deserialize(const boost::property_tree::ptree& propTree, uci::type::AccessEventType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + AccessEventType_Names::Effort_Name) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setProbabilityOfAccessAttempt(extjson_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    } else if (valueType.first == nsPrefix + AccessEventType_Names::ProbabilityOfSuccessfulAccess_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setProbabilityOfSuccessfulAccess(extjson_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setObjectSeparation(extjson_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    } else if (valueType.first == nsPrefix + AccessEventType_Names::UnambiguousTime_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setUnambiguousTime(extjson_uci::util::SerializationHelpers::deserializeDateTime(*value));
      }
...
std::string AccessEventType::serialize(const uci::type::AccessEventType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, AccessEventType_Names::Extern_Type_Name);
  }
  AccessEffortEnum::serialize(accessor.getEffort(), node, AccessEventType_Names::Effort_Name, false);
  extjson_uci::util::SerializationHelpers::serializeDateTime(accessor.getTime(), node, AccessEventType_Names::Time_Name);
  if (accessor.hasDuration()) {
    extjson_uci::util::SerializationHelpers::serializeDuration(accessor.getDuration(), node, AccessEventType_Names::Duration_Name);
  }
  if (accessor.hasProbabilityOfAccessAttempt()) {
    extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getProbabilityOfAccessAttempt(), node, AccessEventType_Names::ProbabilityOfAccessAttempt_Name);
  }
  if (accessor.hasProbabilityOfSuccessfulAccess()) {
    extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getProbabilityOfSuccessfulAccess(), node, AccessEventType_Names::ProbabilityOfSuccessfulAccess_Name);
  }
  ...
  if (accessor.hasObjectSeparation()) {
    extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getObjectSeparation(), node, AccessEventType_Names::ObjectSeparation_Name);
  }
  if (accessor.hasUnambiguousTime()) {
    extjson_uci::util::SerializationHelpers::serializeDateTime(accessor.getUnambiguousTime(), node, AccessEventType_Names::UnambiguousTime_Name);
  }
