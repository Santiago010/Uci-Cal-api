...
bool SAR_CoherentChangeDetectionParametersType::deserialize(const boost::property_tree::ptree& propTree, uci::type::SAR_CoherentChangeDetectionParametersType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = SAR_CoherentChangeDetectionParametersType_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + SAR_CoherentChangeDetectionParametersType_Names::PercentResample_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setPercentResample(extjson_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
...
std::string SAR_CoherentChangeDetectionParametersType::serialize(const uci::type::SAR_CoherentChangeDetectionParametersType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, SAR_CoherentChangeDetectionParametersType_Names::Extern_Type_Name);
  }
  SAR_ProcessingParametersType::serialize(accessor, node, "", false, false, false);
  extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getPercentResample(), node, SAR_CoherentChangeDetectionParametersType_Names::PercentResample_Name);
