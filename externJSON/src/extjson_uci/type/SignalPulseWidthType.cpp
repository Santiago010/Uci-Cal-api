...
bool SignalPulseWidthType::deserialize(const boost::property_tree::ptree& propTree, uci::type::SignalPulseWidthType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = SignalPulseWidthType_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + SignalPulseWidthType_Names::PulseWidthQuality_Name) {
...
std::string SignalPulseWidthType::serialize(const uci::type::SignalPulseWidthType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, SignalPulseWidthType_Names::Extern_Type_Name);
  }
  ...
  if (accessor.hasPulseWidthChopped()) {
    extjson_uci::util::SerializationHelpers::serializeBoolean(accessor.getPulseWidthChopped(), node, SignalPulseWidthType_Names::PulseWidthChopped_Name);
  }
  if (accessor.hasPulseOnPulse()) {
    extjson_uci::util::SerializationHelpers::serializeBoolean(accessor.getPulseOnPulse(), node, SignalPulseWidthType_Names::PulseOnPulse_Name);
  }
  if (createNode) {
