...
bool ParameterValueType::deserialize(const boost::property_tree::ptree& propTree, uci::type::ParameterValueType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = ParameterValueType_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + ParameterValueType_Names::Value_Name) {
...
std::string ParameterValueType::serialize(const uci::type::ParameterValueType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, ParameterValueType_Names::Extern_Type_Name);
  }
  if (accessor.isValue()) {
    extjson_uci::util::SerializationHelpers::serializeString(accessor.getValue(), node, ParameterValueType_Names::Value_Name);
  } else if (accessor.isReturnToDefault()) {
    extjson_uci::util::SerializationHelpers::serializeString(accessor.getReturnToDefault(), node, ParameterValueType_Names::ReturnToDefault_Name);
  }
  if (createNode) {
