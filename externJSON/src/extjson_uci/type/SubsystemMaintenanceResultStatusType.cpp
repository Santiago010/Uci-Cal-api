...
bool SubsystemMaintenanceResultStatusType::deserialize(const boost::property_tree::ptree& propTree, uci::type::SubsystemMaintenanceResultStatusType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + SubsystemMaintenanceResultStatusType_Names::CompletionStatus_Name) {
...
std::string SubsystemMaintenanceResultStatusType::serialize(const uci::type::SubsystemMaintenanceResultStatusType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, SubsystemMaintenanceResultStatusType_Names::Extern_Type_Name);
  }
