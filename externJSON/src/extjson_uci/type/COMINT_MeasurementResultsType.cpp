...
bool COMINT_MeasurementResultsType::deserialize(const boost::property_tree::ptree& propTree, uci::type::COMINT_MeasurementResultsType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = COMINT_MeasurementResultsType_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + COMINT_MeasurementResultsType_Names::Frequency_Name) {
...
std::string COMINT_MeasurementResultsType::serialize(const uci::type::COMINT_MeasurementResultsType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, COMINT_MeasurementResultsType_Names::Extern_Type_Name);
  }
