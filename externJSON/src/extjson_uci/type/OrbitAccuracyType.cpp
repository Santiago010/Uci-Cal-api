...
bool OrbitAccuracyType::deserialize(const boost::property_tree::ptree& propTree, uci::type::OrbitAccuracyType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + OrbitAccuracyType_Names::PositionSigma_Name) {
...
std::string OrbitAccuracyType::serialize(const uci::type::OrbitAccuracyType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, OrbitAccuracyType_Names::Extern_Type_Name);
  }
