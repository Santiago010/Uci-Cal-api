...
bool StoreManagementReportMDT::deserialize(const boost::property_tree::ptree& propTree, uci::type::StoreManagementReportMDT& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + StoreManagementReportMDT_Names::StoreManagementReportID_Name) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setReleaseConsent(extjson_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
    } else if (valueType.first == nsPrefix + StoreManagementReportMDT_Names::LAR_ConstraintsEnforced_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setLAR_ConstraintsEnforced(extjson_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
    } else if (valueType.first == nsPrefix + StoreManagementReportMDT_Names::AttitudeConstraintsEnforced_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setAttitudeConstraintsEnforced(extjson_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
    } else if (valueType.first == nsPrefix + StoreManagementReportMDT_Names::CurrentStoreStation_Name) {
      extjson_uci::util::DerivedTypesDeserializer::deserialize(valueType.second, accessor.enableCurrentStoreStation(extjson_uci::util::SerializationHelpers::checkForTypeAttribute(valueType.second, nsPrefix)), nodeName, nsPrefix);
    } else if (valueType.first == nsPrefix + StoreManagementReportMDT_Names::SelectedStoreType_Name) {
      extjson_uci::util::DerivedTypesDeserializer::deserialize(valueType.second, accessor.enableSelectedStoreType(extjson_uci::util::SerializationHelpers::checkForTypeAttribute(valueType.second, nsPrefix)), nodeName, nsPrefix);
...
std::string StoreManagementReportMDT::serialize(const uci::type::StoreManagementReportMDT& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, StoreManagementReportMDT_Names::Extern_Type_Name);
  }
  ...
  extjson_uci::util::SerializationHelpers::serializeBoolean(accessor.getMasterArm(), node, StoreManagementReportMDT_Names::MasterArm_Name);
  extjson_uci::util::SerializationHelpers::serializeBoolean(accessor.getReleaseConsent(), node, StoreManagementReportMDT_Names::ReleaseConsent_Name);
  extjson_uci::util::SerializationHelpers::serializeBoolean(accessor.getLAR_ConstraintsEnforced(), node, StoreManagementReportMDT_Names::LAR_ConstraintsEnforced_Name);
  extjson_uci::util::SerializationHelpers::serializeBoolean(accessor.getAttitudeConstraintsEnforced(), node, StoreManagementReportMDT_Names::AttitudeConstraintsEnforced_Name);
