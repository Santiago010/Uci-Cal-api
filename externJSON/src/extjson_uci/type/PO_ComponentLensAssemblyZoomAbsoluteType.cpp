...
bool PO_ComponentLensAssemblyZoomAbsoluteType::deserialize(const boost::property_tree::ptree& propTree, uci::type::PO_ComponentLensAssemblyZoomAbsoluteType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + PO_ComponentLensAssemblyZoomAbsoluteType_Names::ZoomControl_Name) {
      ComponentControlInterfacesEnum::deserializeList(valueType.second, accessor.getZoomControl());
...
std::string PO_ComponentLensAssemblyZoomAbsoluteType::serialize(const uci::type::PO_ComponentLensAssemblyZoomAbsoluteType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, PO_ComponentLensAssemblyZoomAbsoluteType_Names::Extern_Type_Name);
  }
  {
    ComponentControlInterfacesEnum::serializeList(accessor.getZoomControl(), node, PO_ComponentLensAssemblyZoomAbsoluteType_Names::ZoomControl_Name);
  }
  extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getMin(), node, PO_ComponentLensAssemblyZoomAbsoluteType_Names::Min_Name);
  extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getMax(), node, PO_ComponentLensAssemblyZoomAbsoluteType_Names::Max_Name);
  if (createNode) {
