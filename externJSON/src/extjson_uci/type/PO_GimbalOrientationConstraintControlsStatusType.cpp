...
bool PO_GimbalOrientationConstraintControlsStatusType::deserialize(const boost::property_tree::ptree& propTree, uci::type::PO_GimbalOrientationConstraintControlsStatusType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + PO_GimbalOrientationConstraintControlsStatusType_Names::ReferenceFrame_Name) {
...
std::string PO_GimbalOrientationConstraintControlsStatusType::serialize(const uci::type::PO_GimbalOrientationConstraintControlsStatusType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, PO_GimbalOrientationConstraintControlsStatusType_Names::Extern_Type_Name);
  }
