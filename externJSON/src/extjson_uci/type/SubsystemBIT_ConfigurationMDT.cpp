...
bool SubsystemBIT_ConfigurationMDT::deserialize(const boost::property_tree::ptree& propTree, uci::type::SubsystemBIT_ConfigurationMDT& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = SubsystemBIT_ConfigurationMDT_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + SubsystemBIT_ConfigurationMDT_Names::SubsystemBIT_ConfigurationID_Name) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        ...
        SubsystemBIT_Type::deserialize(valueType.second, boundedList.at(boundedListSize), nodeName, nsPrefix);
      }
    }
  }
  return true;
...
std::string SubsystemBIT_ConfigurationMDT::serialize(const uci::type::SubsystemBIT_ConfigurationMDT& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, SubsystemBIT_ConfigurationMDT_Names::Extern_Type_Name);
  }
  ...
  SubsystemID_Type::serialize(accessor.getSubsystemID(), node, SubsystemBIT_ConfigurationMDT_Names::SubsystemID_Name);
  {
    ...
    for (uci::type::SubsystemBIT_ConfigurationMDT::BIT::size_type i = 0, end = boundedList.size(); i < end; ++i) {
      SubsystemBIT_Type::serialize(boundedList.at(i), node, SubsystemBIT_ConfigurationMDT_Names::BIT_Name);
    }
  }
  if (createNode) {
