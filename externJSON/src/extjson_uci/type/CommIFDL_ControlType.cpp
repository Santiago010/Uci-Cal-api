...
bool CommIFDL_ControlType::deserialize(const boost::property_tree::ptree& propTree, uci::type::CommIFDL_ControlType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + CommIFDL_ControlType_Names::FlightIdentifier_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setFlightIdentifier(extjson_uci::util::SerializationHelpers::deserializeUnsignedShort(*value));
      }
    } else if (valueType.first == nsPrefix + CommIFDL_ControlType_Names::FlightPosition_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setFlightPosition(extjson_uci::util::SerializationHelpers::deserializeUnsignedByte(*value));
      }
    } else if (valueType.first == nsPrefix + CommIFDL_ControlType_Names::NetNumber_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setNetNumber(extjson_uci::util::SerializationHelpers::deserializeUnsignedByte(*value));
      }
    } else if (valueType.first == nsPrefix + CommIFDL_ControlType_Names::WideNet1Enable_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setWideNet1Enable(extjson_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
    } else if (valueType.first == nsPrefix + CommIFDL_ControlType_Names::WideNet2Enable_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setWideNet2Enable(extjson_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
    } else if (valueType.first == nsPrefix + CommIFDL_ControlType_Names::WideNet3Enable_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setWideNet3Enable(extjson_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
...
std::string CommIFDL_ControlType::serialize(const uci::type::CommIFDL_ControlType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, CommIFDL_ControlType_Names::Extern_Type_Name);
  }
  extjson_uci::util::SerializationHelpers::serializeUnsignedShort(accessor.getFlightIdentifier(), node, CommIFDL_ControlType_Names::FlightIdentifier_Name);
  extjson_uci::util::SerializationHelpers::serializeUnsignedByte(accessor.getFlightPosition(), node, CommIFDL_ControlType_Names::FlightPosition_Name);
  extjson_uci::util::SerializationHelpers::serializeUnsignedByte(accessor.getNetNumber(), node, CommIFDL_ControlType_Names::NetNumber_Name);
  if (accessor.hasWideNet1Enable()) {
    extjson_uci::util::SerializationHelpers::serializeBoolean(accessor.getWideNet1Enable(), node, CommIFDL_ControlType_Names::WideNet1Enable_Name);
  }
  if (accessor.hasWideNet2Enable()) {
    extjson_uci::util::SerializationHelpers::serializeBoolean(accessor.getWideNet2Enable(), node, CommIFDL_ControlType_Names::WideNet2Enable_Name);
  }
  if (accessor.hasWideNet3Enable()) {
    extjson_uci::util::SerializationHelpers::serializeBoolean(accessor.getWideNet3Enable(), node, CommIFDL_ControlType_Names::WideNet3Enable_Name);
  }
