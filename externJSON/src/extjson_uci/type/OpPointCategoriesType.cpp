...
bool OpPointCategoriesType::deserialize(const boost::property_tree::ptree& propTree, uci::type::OpPointCategoriesType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = OpPointCategoriesType_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + OpPointCategoriesType_Names::General_Name) {
...
std::string OpPointCategoriesType::serialize(const uci::type::OpPointCategoriesType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, OpPointCategoriesType_Names::Extern_Type_Name);
  }
