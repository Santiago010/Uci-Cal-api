...
bool ActivityAgainstType::deserialize(const boost::property_tree::ptree& propTree, uci::type::ActivityAgainstType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + ActivityAgainstType_Names::Actor_Name) {
...
std::string ActivityAgainstType::serialize(const uci::type::ActivityAgainstType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, ActivityAgainstType_Names::Extern_Type_Name);
  }
  ActivityActorID_ChoiceType::serialize(accessor.getActor(), node, ActivityAgainstType_Names::Actor_Name);
  extjson_uci::util::SerializationHelpers::serializeUnsignedInt(accessor.getActivity(), node, ActivityAgainstType_Names::Activity_Name);
