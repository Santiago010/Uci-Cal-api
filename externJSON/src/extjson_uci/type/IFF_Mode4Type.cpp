...
bool IFF_Mode4Type::deserialize(const boost::property_tree::ptree& propTree, uci::type::IFF_Mode4Type& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = IFF_Mode4Type_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + IFF_Mode4Type_Names::Mode4Indicator_Name) {
...
std::string IFF_Mode4Type::serialize(const uci::type::IFF_Mode4Type& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, IFF_Mode4Type_Names::Extern_Type_Name);
  }
