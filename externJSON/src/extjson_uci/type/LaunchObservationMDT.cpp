...
bool LaunchObservationMDT::deserialize(const boost::property_tree::ptree& propTree, uci::type::LaunchObservationMDT& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + LaunchObservationMDT_Names::LaunchObservationID_Name) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setInitialCreateTime(extjson_uci::util::SerializationHelpers::deserializeDateTime(*value));
      }
...
std::string LaunchObservationMDT::serialize(const uci::type::LaunchObservationMDT& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, LaunchObservationMDT_Names::Extern_Type_Name);
  }
  ...
  if (accessor.hasInitialCreateTime()) {
    extjson_uci::util::SerializationHelpers::serializeDateTime(accessor.getInitialCreateTime(), node, LaunchObservationMDT_Names::InitialCreateTime_Name);
  }
  if (accessor.hasLastUpdateTime()) {
    extjson_uci::util::SerializationHelpers::serializeDateTime(accessor.getLastUpdateTime(), node, LaunchObservationMDT_Names::LastUpdateTime_Name);
  }
