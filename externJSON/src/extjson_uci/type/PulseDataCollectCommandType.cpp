...
bool PulseDataCollectCommandType::deserialize(const boost::property_tree::ptree& propTree, uci::type::PulseDataCollectCommandType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + PulseDataCollectCommandType_Names::CollectionFrequency_Name) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setPRI(extjson_uci::util::SerializationHelpers::deserializeDuration(*value));
      }
...
std::string PulseDataCollectCommandType::serialize(const uci::type::PulseDataCollectCommandType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, PulseDataCollectCommandType_Names::Extern_Type_Name);
  }
  ...
  extjson_uci::util::SerializationHelpers::serializeDateTime(accessor.getStartTime(), node, PulseDataCollectCommandType_Names::StartTime_Name);
  extjson_uci::util::SerializationHelpers::serializeDuration(accessor.getDwellDuration(), node, PulseDataCollectCommandType_Names::DwellDuration_Name);
  if (accessor.hasDwells()) {
    extjson_uci::util::SerializationHelpers::serializeUnsignedInt(accessor.getDwells(), node, PulseDataCollectCommandType_Names::Dwells_Name);
  }
  if (accessor.hasRepetitionInterval()) {
    extjson_uci::util::SerializationHelpers::serializeDuration(accessor.getRepetitionInterval(), node, PulseDataCollectCommandType_Names::RepetitionInterval_Name);
  }
  if (accessor.hasPulseWidth()) {
    extjson_uci::util::SerializationHelpers::serializeDuration(accessor.getPulseWidth(), node, PulseDataCollectCommandType_Names::PulseWidth_Name);
  }
  if (accessor.hasPRI()) {
    extjson_uci::util::SerializationHelpers::serializeDuration(accessor.getPRI(), node, PulseDataCollectCommandType_Names::PRI_Name);
  }
  ...
  if (accessor.hasSampleRate()) {
    extjson_uci::util::SerializationHelpers::serializeFloat(accessor.getSampleRate(), node, PulseDataCollectCommandType_Names::SampleRate_Name);
  }
  if (accessor.hasFFT_PointsPerSample()) {
    extjson_uci::util::SerializationHelpers::serializeInt(accessor.getFFT_PointsPerSample(), node, PulseDataCollectCommandType_Names::FFT_PointsPerSample_Name);
  }
  if (createNode) {
