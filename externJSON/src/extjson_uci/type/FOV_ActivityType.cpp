...
bool FOV_ActivityType::deserialize(const boost::property_tree::ptree& propTree, uci::type::FOV_ActivityType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = FOV_ActivityType_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + FOV_ActivityType_Names::GroundFOV_Name) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setFOV_Timestamp(extjson_uci::util::SerializationHelpers::deserializeDateTime(*value));
      }
    } else if (valueType.first == nsPrefix + FOV_ActivityType_Names::MaximumEffectiveRange_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setMaximumEffectiveRange(extjson_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    }
  }
...
std::string FOV_ActivityType::serialize(const uci::type::FOV_ActivityType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, FOV_ActivityType_Names::Extern_Type_Name);
  }
  ...
  if (accessor.hasFOV_Timestamp()) {
    extjson_uci::util::SerializationHelpers::serializeDateTime(accessor.getFOV_Timestamp(), node, FOV_ActivityType_Names::FOV_Timestamp_Name);
  }
  if (accessor.hasMaximumEffectiveRange()) {
    extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getMaximumEffectiveRange(), node, FOV_ActivityType_Names::MaximumEffectiveRange_Name);
  }
  if (createNode) {
