...
bool SpaceWeatherRecordType::deserialize(const boost::property_tree::ptree& propTree, uci::type::SpaceWeatherRecordType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + SpaceWeatherRecordType_Names::SolarFlux_Name) {
...
std::string SpaceWeatherRecordType::serialize(const uci::type::SpaceWeatherRecordType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, SpaceWeatherRecordType_Names::Extern_Type_Name);
  }
  {
