...
bool LineDataStatusType::deserialize(const boost::property_tree::ptree& propTree, uci::type::LineDataStatusType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + LineDataStatusType_Names::PressureData_Name) {
...
std::string LineDataStatusType::serialize(const uci::type::LineDataStatusType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, LineDataStatusType_Names::Extern_Type_Name);
  }
  ...
  if (accessor.hasFlowRate()) {
    extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getFlowRate(), node, LineDataStatusType_Names::FlowRate_Name);
  }
  if (accessor.hasDirection()) {
    extjson_uci::util::SerializationHelpers::serializeString(accessor.getDirection(), node, LineDataStatusType_Names::Direction_Name);
  }
  if (accessor.hasIsGravityFeed()) {
    extjson_uci::util::SerializationHelpers::serializeString(accessor.getIsGravityFeed(), node, LineDataStatusType_Names::IsGravityFeed_Name);
  }
  if (createNode) {
