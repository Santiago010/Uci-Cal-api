...
bool MissileEmitterIdentityType::deserialize(const boost::property_tree::ptree& propTree, uci::type::MissileEmitterIdentityType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = MissileEmitterIdentityType_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + MissileEmitterIdentityType_Names::ELNOT_Identifier_Name) {
...
std::string MissileEmitterIdentityType::serialize(const uci::type::MissileEmitterIdentityType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, MissileEmitterIdentityType_Names::Extern_Type_Name);
  }
  if (accessor.hasELNOT_Identifier()) {
    extjson_uci::util::SerializationHelpers::serializeString(accessor.getELNOT_Identifier(), node, MissileEmitterIdentityType_Names::ELNOT_Identifier_Name);
  }
