...
bool CenterOfGravityAeroType::deserialize(const boost::property_tree::ptree& propTree, uci::type::CenterOfGravityAeroType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = CenterOfGravityAeroType_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + CenterOfGravityAeroType_Names::LateralCenterOfGravity_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setLateralCenterOfGravity(extjson_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    } else if (valueType.first == nsPrefix + CenterOfGravityAeroType_Names::LongitudinalCenterOfGravity_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setLongitudinalCenterOfGravity(extjson_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    } else if (valueType.first == nsPrefix + CenterOfGravityAeroType_Names::VerticalCenterOfGravity_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setVerticalCenterOfGravity(extjson_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    }
  }
  return true;
...
std::string CenterOfGravityAeroType::serialize(const uci::type::CenterOfGravityAeroType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, CenterOfGravityAeroType_Names::Extern_Type_Name);
  }
  if (accessor.hasLateralCenterOfGravity()) {
    extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getLateralCenterOfGravity(), node, CenterOfGravityAeroType_Names::LateralCenterOfGravity_Name);
  }
  if (accessor.hasLongitudinalCenterOfGravity()) {
    extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getLongitudinalCenterOfGravity(), node, CenterOfGravityAeroType_Names::LongitudinalCenterOfGravity_Name);
  }
  if (accessor.hasVerticalCenterOfGravity()) {
    extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getVerticalCenterOfGravity(), node, CenterOfGravityAeroType_Names::VerticalCenterOfGravity_Name);
  }
  if (createNode) {
