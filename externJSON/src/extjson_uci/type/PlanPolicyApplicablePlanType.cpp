...
bool PlanPolicyApplicablePlanType::deserialize(const boost::property_tree::ptree& propTree, uci::type::PlanPolicyApplicablePlanType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = PlanPolicyApplicablePlanType_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + PlanPolicyApplicablePlanType_Names::PlanType_Name) {
      ...
      extjson_uci::util::DerivedTypesDeserializer::deserialize(valueType.second, accessor.enablePlanParts(extjson_uci::util::SerializationHelpers::checkForTypeAttribute(valueType.second, nsPrefix)), nodeName, nsPrefix);
...
std::string PlanPolicyApplicablePlanType::serialize(const uci::type::PlanPolicyApplicablePlanType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, PlanPolicyApplicablePlanType_Names::Extern_Type_Name);
  }
  ...
  }
  {
    ...
    for (uci::type::PlanPolicyApplicablePlanType::OtherSystemConstrainingPlans::size_type i = 0, end = boundedList.size(); i < end; ++i) {
      AutonomousPlanningOtherSystemConstrainingPlansType::serialize(boundedList.at(i), node, PlanPolicyApplicablePlanType_Names::OtherSystemConstrainingPlans_Name);
    }
  }
  if (createNode) {
