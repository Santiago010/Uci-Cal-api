...
bool WorkingEOB_RequestStatusMT::deserialize(const boost::property_tree::ptree& propTree, uci::type::WorkingEOB_RequestStatusMT& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + WorkingEOB_RequestStatusMT_Names::MessageData_Name) {
...
std::string WorkingEOB_RequestStatusMT::serialize(const uci::type::WorkingEOB_RequestStatusMT& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool topLevel) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, (topLevel ? WorkingEOB_RequestStatusMT_Names::Extern_Top_Type_Name : WorkingEOB_RequestStatusMT_Names::Extern_Type_Name));
  }
