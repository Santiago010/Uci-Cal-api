...
bool EntityDimensionEstimateUncertaintyType::deserialize(const boost::property_tree::ptree& propTree, uci::type::EntityDimensionEstimateUncertaintyType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + EntityDimensionEstimateUncertaintyType_Names::EntityDimension_SA_SpreadUncertainty_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setEntityDimension_SA_SpreadUncertainty(extjson_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
...
std::string EntityDimensionEstimateUncertaintyType::serialize(const uci::type::EntityDimensionEstimateUncertaintyType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, EntityDimensionEstimateUncertaintyType_Names::Extern_Type_Name);
  }
  if (accessor.hasEntityDimension_SA_SpreadUncertainty()) {
    extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getEntityDimension_SA_SpreadUncertainty(), node, EntityDimensionEstimateUncertaintyType_Names::EntityDimension_SA_SpreadUncertainty_Name);
  }
