...
bool DamageSummaryMDT::deserialize(const boost::property_tree::ptree& propTree, uci::type::DamageSummaryMDT& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + DamageSummaryMDT_Names::DamageSummaryID_Name) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setSummaryCompletionTime(extjson_uci::util::SerializationHelpers::deserializeDateTime(*value));
      }
      ...
      extjson_uci::util::DerivedTypesDeserializer::deserialize(valueType.second, accessor.enableSummaryZone(extjson_uci::util::SerializationHelpers::checkForTypeAttribute(valueType.second, nsPrefix)), nodeName, nsPrefix);
...
std::string DamageSummaryMDT::serialize(const uci::type::DamageSummaryMDT& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, DamageSummaryMDT_Names::Extern_Type_Name);
  }
  DamageSummaryID_Type::serialize(accessor.getDamageSummaryID(), node, DamageSummaryMDT_Names::DamageSummaryID_Name);
  extjson_uci::util::SerializationHelpers::serializeDateTime(accessor.getSummaryCompletionTime(), node, DamageSummaryMDT_Names::SummaryCompletionTime_Name);
