...
bool CryptoPortStatusType::deserialize(const boost::property_tree::ptree& propTree, uci::type::CryptoPortStatusType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + CryptoPortStatusType_Names::CryptoPortID_Name) {
      ...
      CryptoTypeEnum::deserializeList(valueType.second, accessor.getAvailableCryptoType());
    }
  }
  return true;
}
...
std::string CryptoPortStatusType::serialize(const uci::type::CryptoPortStatusType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, CryptoPortStatusType_Names::Extern_Type_Name);
  }
  ...
  {
    CryptoTypeEnum::serializeList(accessor.getAvailableCryptoType(), node, CryptoPortStatusType_Names::AvailableCryptoType_Name);
  }
  if (createNode) {
