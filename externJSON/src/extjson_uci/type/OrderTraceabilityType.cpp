...
bool OrderTraceabilityType::deserialize(const boost::property_tree::ptree& propTree, uci::type::OrderTraceabilityType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + OrderTraceabilityType_Names::OrderSourceID_Name) {
      ...
      extjson_uci::util::SerializationHelpers::deserializeStringList(valueType.second, accessor.getROME_Identifier());
...
std::string OrderTraceabilityType::serialize(const uci::type::OrderTraceabilityType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, OrderTraceabilityType_Names::Extern_Type_Name);
  }
  ...
  {
    extjson_uci::util::SerializationHelpers::serializeStringList(accessor.getROME_Identifier(), node, OrderTraceabilityType_Names::ROME_Identifier_Name);
  }
  {
