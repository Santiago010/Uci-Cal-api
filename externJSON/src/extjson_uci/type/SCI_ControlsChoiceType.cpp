...
bool SCI_ControlsChoiceType::deserialize(const boost::property_tree::ptree& propTree, uci::type::SCI_ControlsChoiceType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + SCI_ControlsChoiceType_Names::StandardCompartment_Name) {
...
std::string SCI_ControlsChoiceType::serialize(const uci::type::SCI_ControlsChoiceType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, SCI_ControlsChoiceType_Names::Extern_Type_Name);
  }
  if (accessor.isStandardCompartment()) {
    ...
    extjson_uci::util::SerializationHelpers::serializeString(accessor.getSubCompartment(), node, SCI_ControlsChoiceType_Names::SubCompartment_Name);
  }
  if (createNode) {
