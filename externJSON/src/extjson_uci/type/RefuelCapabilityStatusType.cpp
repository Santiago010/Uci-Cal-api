...
bool RefuelCapabilityStatusType::deserialize(const boost::property_tree::ptree& propTree, uci::type::RefuelCapabilityStatusType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = RefuelCapabilityStatusType_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + RefuelCapabilityStatusType_Names::Boom_Name) {
...
std::string RefuelCapabilityStatusType::serialize(const uci::type::RefuelCapabilityStatusType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, RefuelCapabilityStatusType_Names::Extern_Type_Name);
  }
  if (accessor.isBoom()) {
    extjson_uci::util::SerializationHelpers::serializeString(accessor.getBoom(), node, RefuelCapabilityStatusType_Names::Boom_Name);
