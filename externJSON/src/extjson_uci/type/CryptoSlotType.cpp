...
bool CryptoSlotType::deserialize(const boost::property_tree::ptree& propTree, uci::type::CryptoSlotType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + CryptoSlotType_Names::SlotIdentifier_Name) {
...
std::string CryptoSlotType::serialize(const uci::type::CryptoSlotType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, CryptoSlotType_Names::Extern_Type_Name);
  }
  extjson_uci::util::SerializationHelpers::serializeString(accessor.getSlotIdentifier(), node, CryptoSlotType_Names::SlotIdentifier_Name);
  ...
  if (accessor.hasNextSlotIdentifier()) {
    extjson_uci::util::SerializationHelpers::serializeString(accessor.getNextSlotIdentifier(), node, CryptoSlotType_Names::NextSlotIdentifier_Name);
  }
  if (createNode) {
