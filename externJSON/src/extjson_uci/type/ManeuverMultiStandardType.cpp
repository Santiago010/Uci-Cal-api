...
bool ManeuverMultiStandardType::deserialize(const boost::property_tree::ptree& propTree, uci::type::ManeuverMultiStandardType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + ManeuverMultiStandardType_Names::OrbitManeuver_Name) {
...
std::string ManeuverMultiStandardType::serialize(const uci::type::ManeuverMultiStandardType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, ManeuverMultiStandardType_Names::Extern_Type_Name);
  }
