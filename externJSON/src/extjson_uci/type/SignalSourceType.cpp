...
bool SignalSourceType::deserialize(const boost::property_tree::ptree& propTree, uci::type::SignalSourceType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + SignalSourceType_Names::CapabilityID_Name) {
...
std::string SignalSourceType::serialize(const uci::type::SignalSourceType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, SignalSourceType_Names::Extern_Type_Name);
  }
