...
bool RequirementExecutionPolicyType::deserialize(const boost::property_tree::ptree& propTree, uci::type::RequirementExecutionPolicyType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = RequirementExecutionPolicyType_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + RequirementExecutionPolicyType_Names::DefaultResponse_Name) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        ...
        ByRequirementPolicyType::deserialize(valueType.second, boundedList.at(boundedListSize), nodeName, nsPrefix);
      }
    }
  }
  return true;
...
std::string RequirementExecutionPolicyType::serialize(const uci::type::RequirementExecutionPolicyType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, RequirementExecutionPolicyType_Names::Extern_Type_Name);
  }
  ...
  }
  {
    ...
    for (uci::type::RequirementExecutionPolicyType::ByRequirementPolicy::size_type i = 0, end = boundedList.size(); i < end; ++i) {
      ByRequirementPolicyType::serialize(boundedList.at(i), node, RequirementExecutionPolicyType_Names::ByRequirementPolicy_Name);
    }
  }
  if (createNode) {
