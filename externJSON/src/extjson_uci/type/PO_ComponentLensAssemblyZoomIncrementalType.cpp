...
bool PO_ComponentLensAssemblyZoomIncrementalType::deserialize(const boost::property_tree::ptree& propTree, uci::type::PO_ComponentLensAssemblyZoomIncrementalType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = PO_ComponentLensAssemblyZoomIncrementalType_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + PO_ComponentLensAssemblyZoomIncrementalType_Names::ZoomControl_Name) {
...
std::string PO_ComponentLensAssemblyZoomIncrementalType::serialize(const uci::type::PO_ComponentLensAssemblyZoomIncrementalType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, PO_ComponentLensAssemblyZoomIncrementalType_Names::Extern_Type_Name);
  }
  {
    ComponentControlInterfacesEnum::serializeList(accessor.getZoomControl(), node, PO_ComponentLensAssemblyZoomIncrementalType_Names::ZoomControl_Name);
  }
  if (createNode) {
