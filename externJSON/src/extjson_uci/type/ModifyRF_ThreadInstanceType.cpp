...
bool ModifyRF_ThreadInstanceType::deserialize(const boost::property_tree::ptree& propTree, uci::type::ModifyRF_ThreadInstanceType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + ModifyRF_ThreadInstanceType_Names::RF_ThreadInstanceIndex_Name) {
...
std::string ModifyRF_ThreadInstanceType::serialize(const uci::type::ModifyRF_ThreadInstanceType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, ModifyRF_ThreadInstanceType_Names::Extern_Type_Name);
  }
  extjson_uci::util::SerializationHelpers::serializeUnsignedInt(accessor.getRF_ThreadInstanceIndex(), node, ModifyRF_ThreadInstanceType_Names::RF_ThreadInstanceIndex_Name);
  if (accessor.hasActiveBeamInstanceIndex()) {
    extjson_uci::util::SerializationHelpers::serializeUnsignedInt(accessor.getActiveBeamInstanceIndex(), node, ModifyRF_ThreadInstanceType_Names::ActiveBeamInstanceIndex_Name);
  }
  if (accessor.hasResourceAccessPriority()) {
    extjson_uci::util::SerializationHelpers::serializeUnsignedInt(accessor.getResourceAccessPriority(), node, ModifyRF_ThreadInstanceType_Names::ResourceAccessPriority_Name);
  }
  {
