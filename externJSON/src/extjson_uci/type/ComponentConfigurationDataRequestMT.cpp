...
bool ComponentConfigurationDataRequestMT::deserialize(const boost::property_tree::ptree& propTree, uci::type::ComponentConfigurationDataRequestMT& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + ComponentConfigurationDataRequestMT_Names::MessageData_Name) {
...
std::string ComponentConfigurationDataRequestMT::serialize(const uci::type::ComponentConfigurationDataRequestMT& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool topLevel) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, (topLevel ? ComponentConfigurationDataRequestMT_Names::Extern_Top_Type_Name : ComponentConfigurationDataRequestMT_Names::Extern_Type_Name));
  }
