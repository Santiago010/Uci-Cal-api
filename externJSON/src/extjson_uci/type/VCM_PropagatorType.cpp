...
bool VCM_PropagatorType::deserialize(const boost::property_tree::ptree& propTree, uci::type::VCM_PropagatorType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + VCM_PropagatorType_Names::ForceModel_Name) {
...
std::string VCM_PropagatorType::serialize(const uci::type::VCM_PropagatorType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, VCM_PropagatorType_Names::Extern_Type_Name);
  }
