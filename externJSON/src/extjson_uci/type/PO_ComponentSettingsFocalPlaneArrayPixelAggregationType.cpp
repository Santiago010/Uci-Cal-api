...
bool PO_ComponentSettingsFocalPlaneArrayPixelAggregationType::deserialize(const boost::property_tree::ptree& propTree, uci::type::PO_ComponentSettingsFocalPlaneArrayPixelAggregationType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + PO_ComponentSettingsFocalPlaneArrayPixelAggregationType_Names::AggregationSetting_Name) {
...
std::string PO_ComponentSettingsFocalPlaneArrayPixelAggregationType::serialize(const uci::type::PO_ComponentSettingsFocalPlaneArrayPixelAggregationType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, PO_ComponentSettingsFocalPlaneArrayPixelAggregationType_Names::Extern_Type_Name);
  }
  if (accessor.isAggregationSetting()) {
    extjson_uci::util::SerializationHelpers::serializeUnsignedInt(accessor.getAggregationSetting(), node, PO_ComponentSettingsFocalPlaneArrayPixelAggregationType_Names::AggregationSetting_Name);
