...
bool ServiceErrorReportMDT::deserialize(const boost::property_tree::ptree& propTree, uci::type::ServiceErrorReportMDT& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + ServiceErrorReportMDT_Names::ServiceErrorReportID_Name) {
...
std::string ServiceErrorReportMDT::serialize(const uci::type::ServiceErrorReportMDT& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, ServiceErrorReportMDT_Names::Extern_Type_Name);
  }
  ...
  extjson_uci::util::SerializationHelpers::serializeString(accessor.getErrorDetail(), node, ServiceErrorReportMDT_Names::ErrorDetail_Name);
  if (accessor.hasSoftwareExceptionDetail()) {
    extjson_uci::util::SerializationHelpers::serializeString(accessor.getSoftwareExceptionDetail(), node, ServiceErrorReportMDT_Names::SoftwareExceptionDetail_Name);
  }
  {
