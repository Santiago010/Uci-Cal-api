...
bool SignalRelativeType::deserialize(const boost::property_tree::ptree& propTree, uci::type::SignalRelativeType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + SignalRelativeType_Names::ReferenceIdentifier_Name) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setFringeDetection(extjson_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
...
std::string SignalRelativeType::serialize(const uci::type::SignalRelativeType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, SignalRelativeType_Names::Extern_Type_Name);
  }
  ...
  if (accessor.hasSuspect()) {
    extjson_uci::util::SerializationHelpers::serializeBoolean(accessor.getSuspect(), node, SignalRelativeType_Names::Suspect_Name);
  }
  if (accessor.hasExcessiveAttitude()) {
    extjson_uci::util::SerializationHelpers::serializeBoolean(accessor.getExcessiveAttitude(), node, SignalRelativeType_Names::ExcessiveAttitude_Name);
  }
  if (accessor.hasFringeDetection()) {
    extjson_uci::util::SerializationHelpers::serializeBoolean(accessor.getFringeDetection(), node, SignalRelativeType_Names::FringeDetection_Name);
  }
