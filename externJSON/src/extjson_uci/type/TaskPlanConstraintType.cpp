...
bool TaskPlanConstraintType::deserialize(const boost::property_tree::ptree& propTree, uci::type::TaskPlanConstraintType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = TaskPlanConstraintType_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + TaskPlanConstraintType_Names::AllocationPlanID_Name) {
...
std::string TaskPlanConstraintType::serialize(const uci::type::TaskPlanConstraintType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, TaskPlanConstraintType_Names::Extern_Type_Name);
  }
  ...
  {
    TaskTypeEnum::serializeList(accessor.getTaskType(), node, TaskPlanConstraintType_Names::TaskType_Name);
  }
  if (createNode) {
