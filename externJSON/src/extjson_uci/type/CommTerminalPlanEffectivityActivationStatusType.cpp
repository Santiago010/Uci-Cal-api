...
bool CommTerminalPlanEffectivityActivationStatusType::deserialize(const boost::property_tree::ptree& propTree, uci::type::CommTerminalPlanEffectivityActivationStatusType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = CommTerminalPlanEffectivityActivationStatusType_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + CommTerminalPlanEffectivityActivationStatusType_Names::StateReason_Name) {
...
std::string CommTerminalPlanEffectivityActivationStatusType::serialize(const uci::type::CommTerminalPlanEffectivityActivationStatusType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, CommTerminalPlanEffectivityActivationStatusType_Names::Extern_Type_Name);
  }
