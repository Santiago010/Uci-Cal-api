...
bool CommResourceType::deserialize(const boost::property_tree::ptree& propTree, uci::type::CommResourceType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + CommResourceType_Names::CommSystemID_Name) {
...
std::string CommResourceType::serialize(const uci::type::CommResourceType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, CommResourceType_Names::Extern_Type_Name);
  }
