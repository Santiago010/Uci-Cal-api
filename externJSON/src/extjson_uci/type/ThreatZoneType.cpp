...
bool ThreatZoneType::deserialize(const boost::property_tree::ptree& propTree, uci::type::ThreatZoneType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + ThreatZoneType_Names::ThreatZoneArea_Name) {
...
std::string ThreatZoneType::serialize(const uci::type::ThreatZoneType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, ThreatZoneType_Names::Extern_Type_Name);
  }
  ...
  if (accessor.hasEffectiveProbability()) {
    extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getEffectiveProbability(), node, ThreatZoneType_Names::EffectiveProbability_Name);
  }
  if (createNode) {
