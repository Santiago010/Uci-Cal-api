...
bool RF_ResourceAllocationType::deserialize(const boost::property_tree::ptree& propTree, uci::type::RF_ResourceAllocationType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + RF_ResourceAllocationType_Names::ResourceRequestID_Name) {
...
std::string RF_ResourceAllocationType::serialize(const uci::type::RF_ResourceAllocationType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, RF_ResourceAllocationType_Names::Extern_Type_Name);
  }
  ...
  if (accessor.hasConfigureInteroperabilityReportIndex()) {
    extjson_uci::util::SerializationHelpers::serializeUnsignedInt(accessor.getConfigureInteroperabilityReportIndex(), node, RF_ResourceAllocationType_Names::ConfigureInteroperabilityReportIndex_Name);
  }
  {
