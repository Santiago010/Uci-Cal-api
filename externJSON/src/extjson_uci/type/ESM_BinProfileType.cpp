...
bool ESM_BinProfileType::deserialize(const boost::property_tree::ptree& propTree, uci::type::ESM_BinProfileType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + ESM_BinProfileType_Names::RequestedSubsystemID_Name) {
...
std::string ESM_BinProfileType::serialize(const uci::type::ESM_BinProfileType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, ESM_BinProfileType_Names::Extern_Type_Name);
  }
  ...
  extjson_uci::util::SerializationHelpers::serializeUnsignedInt(accessor.getScanScheduleProfileIndex(), node, ESM_BinProfileType_Names::ScanScheduleProfileIndex_Name);
