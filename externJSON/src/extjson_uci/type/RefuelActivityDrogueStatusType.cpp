...
bool RefuelActivityDrogueStatusType::deserialize(const boost::property_tree::ptree& propTree, uci::type::RefuelActivityDrogueStatusType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = RefuelActivityDrogueStatusType_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + RefuelActivityDrogueStatusType_Names::Transfer_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setTransfer(extjson_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
...
std::string RefuelActivityDrogueStatusType::serialize(const uci::type::RefuelActivityDrogueStatusType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, RefuelActivityDrogueStatusType_Names::Extern_Type_Name);
  }
  if (accessor.hasTransfer()) {
    extjson_uci::util::SerializationHelpers::serializeBoolean(accessor.getTransfer(), node, RefuelActivityDrogueStatusType_Names::Transfer_Name);
  }
  ...
  if (accessor.hasScheduledFuelToBeDelivered()) {
    extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getScheduledFuelToBeDelivered(), node, RefuelActivityDrogueStatusType_Names::ScheduledFuelToBeDelivered_Name);
  }
  if (createNode) {
