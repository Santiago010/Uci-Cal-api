...
bool CommCoverageUserDataType::deserialize(const boost::property_tree::ptree& propTree, uci::type::CommCoverageUserDataType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = CommCoverageUserDataType_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + CommCoverageUserDataType_Names::CommUserIdentifier_Name) {
...
std::string CommCoverageUserDataType::serialize(const uci::type::CommCoverageUserDataType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, CommCoverageUserDataType_Names::Extern_Type_Name);
  }
  CommCoverageDataType::serialize(accessor, node, "", false, false, false);
  if (accessor.hasCommUserIdentifier()) {
    extjson_uci::util::SerializationHelpers::serializeString(accessor.getCommUserIdentifier(), node, CommCoverageUserDataType_Names::CommUserIdentifier_Name);
  }
  if (createNode) {
