...
bool Link16ReferencePointDataStoreID_ChoiceType::deserialize(const boost::property_tree::ptree& propTree, uci::type::Link16ReferencePointDataStoreID_ChoiceType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + Link16ReferencePointDataStoreID_ChoiceType_Names::OpLineID_Name) {
...
std::string Link16ReferencePointDataStoreID_ChoiceType::serialize(const uci::type::Link16ReferencePointDataStoreID_ChoiceType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, Link16ReferencePointDataStoreID_ChoiceType_Names::Extern_Type_Name);
  }
