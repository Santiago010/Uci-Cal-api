...
bool DamageProbabilityZoneType::deserialize(const boost::property_tree::ptree& propTree, uci::type::DamageProbabilityZoneType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + DamageProbabilityZoneType_Names::MinimumDamageProbability_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setMinimumDamageProbability(extjson_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    } else if (valueType.first == nsPrefix + DamageProbabilityZoneType_Names::MaximumDamageProbability_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setMaximumDamageProbability(extjson_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    } else if (valueType.first == nsPrefix + DamageProbabilityZoneType_Names::DamageZone_Name) {
      extjson_uci::util::DerivedTypesDeserializer::deserialize(valueType.second, accessor.enableDamageZone(extjson_uci::util::SerializationHelpers::checkForTypeAttribute(valueType.second, nsPrefix)), nodeName, nsPrefix);
...
std::string DamageProbabilityZoneType::serialize(const uci::type::DamageProbabilityZoneType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, DamageProbabilityZoneType_Names::Extern_Type_Name);
  }
  extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getMinimumDamageProbability(), node, DamageProbabilityZoneType_Names::MinimumDamageProbability_Name);
  extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getMaximumDamageProbability(), node, DamageProbabilityZoneType_Names::MaximumDamageProbability_Name);
