...
bool LOS_SlantRangeCovarianceRatesType::deserialize(const boost::property_tree::ptree& propTree, uci::type::LOS_SlantRangeCovarianceRatesType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + LOS_SlantRangeCovarianceRatesType_Names::SlantRangeAzimuthRate_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setSlantRangeAzimuthRate(extjson_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    } else if (valueType.first == nsPrefix + LOS_SlantRangeCovarianceRatesType_Names::SlantRangeElevationRate_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setSlantRangeElevationRate(extjson_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    } else if (valueType.first == nsPrefix + LOS_SlantRangeCovarianceRatesType_Names::AzimuthSlantRangeRate_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setAzimuthSlantRangeRate(extjson_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    } else if (valueType.first == nsPrefix + LOS_SlantRangeCovarianceRatesType_Names::ElevationSlantRangeRate_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setElevationSlantRangeRate(extjson_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    }
  }
  return true;
...
std::string LOS_SlantRangeCovarianceRatesType::serialize(const uci::type::LOS_SlantRangeCovarianceRatesType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, LOS_SlantRangeCovarianceRatesType_Names::Extern_Type_Name);
  }
  if (accessor.hasSlantRangeAzimuthRate()) {
    extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getSlantRangeAzimuthRate(), node, LOS_SlantRangeCovarianceRatesType_Names::SlantRangeAzimuthRate_Name);
  }
  if (accessor.hasSlantRangeElevationRate()) {
    extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getSlantRangeElevationRate(), node, LOS_SlantRangeCovarianceRatesType_Names::SlantRangeElevationRate_Name);
  }
  if (accessor.hasAzimuthSlantRangeRate()) {
    extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getAzimuthSlantRangeRate(), node, LOS_SlantRangeCovarianceRatesType_Names::AzimuthSlantRangeRate_Name);
  }
  if (accessor.hasElevationSlantRangeRate()) {
    extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getElevationSlantRangeRate(), node, LOS_SlantRangeCovarianceRatesType_Names::ElevationSlantRangeRate_Name);
  }
  if (createNode) {
