...
bool TaskPlanCommandStatusMT::deserialize(const boost::property_tree::ptree& propTree, uci::type::TaskPlanCommandStatusMT& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + TaskPlanCommandStatusMT_Names::MessageData_Name) {
...
std::string TaskPlanCommandStatusMT::serialize(const uci::type::TaskPlanCommandStatusMT& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool topLevel) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, (topLevel ? TaskPlanCommandStatusMT_Names::Extern_Top_Type_Name : TaskPlanCommandStatusMT_Names::Extern_Type_Name));
  }
