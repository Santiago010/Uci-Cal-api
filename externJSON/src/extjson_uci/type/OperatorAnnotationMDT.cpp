...
bool OperatorAnnotationMDT::deserialize(const boost::property_tree::ptree& propTree, uci::type::OperatorAnnotationMDT& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = OperatorAnnotationMDT_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + OperatorAnnotationMDT_Names::OperatorAnnotationID_Name) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setTimestampForAnnotation(extjson_uci::util::SerializationHelpers::deserializeDateTime(*value));
      }
      ...
      extjson_uci::util::SerializationHelpers::deserializeStringList(valueType.second, accessor.getAnnotationText());
    }
  }
...
std::string OperatorAnnotationMDT::serialize(const uci::type::OperatorAnnotationMDT& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, OperatorAnnotationMDT_Names::Extern_Type_Name);
  }
  ...
  if (accessor.hasTimestampForAnnotation()) {
    extjson_uci::util::SerializationHelpers::serializeDateTime(accessor.getTimestampForAnnotation(), node, OperatorAnnotationMDT_Names::TimestampForAnnotation_Name);
  }
  {
    ...
    for (uci::type::OperatorAnnotationMDT::ObjectID::size_type i = 0, end = boundedList.size(); i < end; ++i) {
      ID_Type::serialize(boundedList.at(i), node, OperatorAnnotationMDT_Names::ObjectID_Name);
    }
  }
  {
    extjson_uci::util::SerializationHelpers::serializeStringList(accessor.getAnnotationText(), node, OperatorAnnotationMDT_Names::AnnotationText_Name);
  }
  if (createNode) {
