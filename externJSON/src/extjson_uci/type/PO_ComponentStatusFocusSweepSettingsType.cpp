...
bool PO_ComponentStatusFocusSweepSettingsType::deserialize(const boost::property_tree::ptree& propTree, uci::type::PO_ComponentStatusFocusSweepSettingsType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + PO_ComponentStatusFocusSweepSettingsType_Names::NumberOfStages_Name) {
...
std::string PO_ComponentStatusFocusSweepSettingsType::serialize(const uci::type::PO_ComponentStatusFocusSweepSettingsType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, PO_ComponentStatusFocusSweepSettingsType_Names::Extern_Type_Name);
  }
  extjson_uci::util::SerializationHelpers::serializeUnsignedInt(accessor.getNumberOfStages(), node, PO_ComponentStatusFocusSweepSettingsType_Names::NumberOfStages_Name);
