...
bool AO_CapabilityStatusMDT::deserialize(const boost::property_tree::ptree& propTree, uci::type::AO_CapabilityStatusMDT& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = AO_CapabilityStatusMDT_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + AO_CapabilityStatusMDT_Names::CapabilityStatus_Name) {
      ...
      AO_MessageOutputsEnum::deserializeList(valueType.second, accessor.getCurrentMessageOutput());
...
std::string AO_CapabilityStatusMDT::serialize(const uci::type::AO_CapabilityStatusMDT& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, AO_CapabilityStatusMDT_Names::Extern_Type_Name);
  }
  CapabilityStatusBaseType::serialize(accessor, node, "", false, false, false);
  {
    ...
    for (uci::type::AO_CapabilityStatusMDT::CapabilityStatus::size_type i = 0, end = boundedList.size(); i < end; ++i) {
      CapabilityStatusType::serialize(boundedList.at(i), node, AO_CapabilityStatusMDT_Names::CapabilityStatus_Name);
    }
  }
  {
    ...
    for (uci::type::AO_CapabilityStatusMDT::ComponentSetting::size_type i = 0, end = boundedList.size(); i < end; ++i) {
      AO_ComponentSettingsType::serialize(boundedList.at(i), node, AO_CapabilityStatusMDT_Names::ComponentSetting_Name);
    }
  }
  {
    AO_MessageOutputsEnum::serializeList(accessor.getCurrentMessageOutput(), node, AO_CapabilityStatusMDT_Names::CurrentMessageOutput_Name);
  }
