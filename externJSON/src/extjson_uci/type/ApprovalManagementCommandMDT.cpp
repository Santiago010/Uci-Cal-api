...
bool ApprovalManagementCommandMDT::deserialize(const boost::property_tree::ptree& propTree, uci::type::ApprovalManagementCommandMDT& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = ApprovalManagementCommandMDT_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + ApprovalManagementCommandMDT_Names::ApprovalPolicyID_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        ...
        ApprovalPolicyID_Type::deserialize(valueType.second, boundedList.at(boundedListSize), nodeName, nsPrefix);
      }
...
std::string ApprovalManagementCommandMDT::serialize(const uci::type::ApprovalManagementCommandMDT& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, ApprovalManagementCommandMDT_Names::Extern_Type_Name);
  }
  CommandBaseType::serialize(accessor, node, "", false, false, false);
  {
    ...
    for (uci::type::ApprovalManagementCommandMDT::ApprovalPolicyID::size_type i = 0, end = boundedList.size(); i < end; ++i) {
      ApprovalPolicyID_Type::serialize(boundedList.at(i), node, ApprovalManagementCommandMDT_Names::ApprovalPolicyID_Name);
    }
  }
