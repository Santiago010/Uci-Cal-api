...
bool QualifyingTagsType::deserialize(const boost::property_tree::ptree& propTree, uci::type::QualifyingTagsType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = QualifyingTagsType_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + QualifyingTagsType_Names::QualifiedSpecial_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setQualifiedSpecial(extjson_uci::util::SerializationHelpers::deserializeUnsignedShort(*value));
      }
...
std::string QualifyingTagsType::serialize(const uci::type::QualifyingTagsType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, QualifyingTagsType_Names::Extern_Type_Name);
  }
  if (accessor.hasQualifiedSpecial()) {
    extjson_uci::util::SerializationHelpers::serializeUnsignedShort(accessor.getQualifiedSpecial(), node, QualifyingTagsType_Names::QualifiedSpecial_Name);
  }
  if (accessor.hasProcessSpecial()) {
    extjson_uci::util::SerializationHelpers::serializeString(accessor.getProcessSpecial(), node, QualifyingTagsType_Names::ProcessSpecial_Name);
  }
  if (accessor.hasFilterOverride()) {
    extjson_uci::util::SerializationHelpers::serializeString(accessor.getFilterOverride(), node, QualifyingTagsType_Names::FilterOverride_Name);
  }
  if (accessor.hasHighInterest()) {
    extjson_uci::util::SerializationHelpers::serializeString(accessor.getHighInterest(), node, QualifyingTagsType_Names::HighInterest_Name);
  }
  if (accessor.hasRetain()) {
    extjson_uci::util::SerializationHelpers::serializeString(accessor.getRetain(), node, QualifyingTagsType_Names::Retain_Name);
  }
