...
bool CommRelayCapabilityType::deserialize(const boost::property_tree::ptree& propTree, uci::type::CommRelayCapabilityType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = CommRelayCapabilityType_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + CommRelayCapabilityType_Names::CapabilityType_Name) {
      ...
      CommRelayMessageOutputsEnum::deserializeList(valueType.second, accessor.getMessageOutput());
    }
  }
...
std::string CommRelayCapabilityType::serialize(const uci::type::CommRelayCapabilityType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, CommRelayCapabilityType_Names::Extern_Type_Name);
  }
  ...
  {
    CommRelayMessageOutputsEnum::serializeList(accessor.getMessageOutput(), node, CommRelayCapabilityType_Names::MessageOutput_Name);
  }
  if (createNode) {
