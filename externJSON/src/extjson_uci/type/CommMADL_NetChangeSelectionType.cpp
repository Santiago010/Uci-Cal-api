...
bool CommMADL_NetChangeSelectionType::deserialize(const boost::property_tree::ptree& propTree, uci::type::CommMADL_NetChangeSelectionType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + CommMADL_NetChangeSelectionType_Names::SelectionStartNode_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setSelectionStartNode(extjson_uci::util::SerializationHelpers::deserializeUnsignedByte(*value));
      }
    } else if (valueType.first == nsPrefix + CommMADL_NetChangeSelectionType_Names::SelectionLength_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setSelectionLength(extjson_uci::util::SerializationHelpers::deserializeUnsignedByte(*value));
      }
    } else if (valueType.first == nsPrefix + CommMADL_NetChangeSelectionType_Names::SelectionShiftValue_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setSelectionShiftValue(extjson_uci::util::SerializationHelpers::deserializeByte(*value));
      }
...
std::string CommMADL_NetChangeSelectionType::serialize(const uci::type::CommMADL_NetChangeSelectionType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, CommMADL_NetChangeSelectionType_Names::Extern_Type_Name);
  }
  extjson_uci::util::SerializationHelpers::serializeUnsignedByte(accessor.getSelectionStartNode(), node, CommMADL_NetChangeSelectionType_Names::SelectionStartNode_Name);
  extjson_uci::util::SerializationHelpers::serializeUnsignedByte(accessor.getSelectionLength(), node, CommMADL_NetChangeSelectionType_Names::SelectionLength_Name);
  if (accessor.hasSelectionShiftValue()) {
    extjson_uci::util::SerializationHelpers::serializeByte(accessor.getSelectionShiftValue(), node, CommMADL_NetChangeSelectionType_Names::SelectionShiftValue_Name);
  }
  if (accessor.hasSelectionFlightGroupIdentifier()) {
    extjson_uci::util::SerializationHelpers::serializeString(accessor.getSelectionFlightGroupIdentifier(), node, CommMADL_NetChangeSelectionType_Names::SelectionFlightGroupIdentifier_Name);
  }
