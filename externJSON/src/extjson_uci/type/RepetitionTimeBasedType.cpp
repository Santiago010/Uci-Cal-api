...
bool RepetitionTimeBasedType::deserialize(const boost::property_tree::ptree& propTree, uci::type::RepetitionTimeBasedType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = RepetitionTimeBasedType_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + RepetitionTimeBasedType_Names::Continuous_Name) {
...
std::string RepetitionTimeBasedType::serialize(const uci::type::RepetitionTimeBasedType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, RepetitionTimeBasedType_Names::Extern_Type_Name);
  }
