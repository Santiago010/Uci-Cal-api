...
bool LAR_CalculationWindType::deserialize(const boost::property_tree::ptree& propTree, uci::type::LAR_CalculationWindType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = LAR_CalculationWindType_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + LAR_CalculationWindType_Names::WindSource_Name) {
...
std::string LAR_CalculationWindType::serialize(const uci::type::LAR_CalculationWindType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, LAR_CalculationWindType_Names::Extern_Type_Name);
  }
