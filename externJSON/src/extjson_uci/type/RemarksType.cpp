...
bool RemarksType::deserialize(const boost::property_tree::ptree& propTree, uci::type::RemarksType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = RemarksType_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + RemarksType_Names::DisplayName_Name) {
...
std::string RemarksType::serialize(const uci::type::RemarksType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, RemarksType_Names::Extern_Type_Name);
  }
  if (accessor.hasDisplayName()) {
    extjson_uci::util::SerializationHelpers::serializeString(accessor.getDisplayName(), node, RemarksType_Names::DisplayName_Name);
  }
  if (accessor.hasDetail()) {
    extjson_uci::util::SerializationHelpers::serializeString(accessor.getDetail(), node, RemarksType_Names::Detail_Name);
  }
  if (createNode) {
