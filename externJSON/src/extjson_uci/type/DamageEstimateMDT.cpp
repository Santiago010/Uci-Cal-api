...
bool DamageEstimateMDT::deserialize(const boost::property_tree::ptree& propTree, uci::type::DamageEstimateMDT& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + DamageEstimateMDT_Names::DamageEstimateID_Name) {
...
std::string DamageEstimateMDT::serialize(const uci::type::DamageEstimateMDT& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, DamageEstimateMDT_Names::Extern_Type_Name);
  }
  ...
  extjson_uci::util::SerializationHelpers::serializeDateTime(accessor.getCompletionTime(), node, DamageEstimateMDT_Names::CompletionTime_Name);
  if (accessor.hasEstimateZone()) {
    ZoneType::serialize(accessor.getEstimateZone(), node, DamageEstimateMDT_Names::EstimateZone_Name);
  }
  extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getReportingThreshold(), node, DamageEstimateMDT_Names::ReportingThreshold_Name);
  ...
  if (accessor.hasEstimateNarrative()) {
    extjson_uci::util::SerializationHelpers::serializeString(accessor.getEstimateNarrative(), node, DamageEstimateMDT_Names::EstimateNarrative_Name);
  }
