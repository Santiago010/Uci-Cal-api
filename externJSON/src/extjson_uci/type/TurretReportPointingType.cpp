...
bool TurretReportPointingType::deserialize(const boost::property_tree::ptree& propTree, uci::type::TurretReportPointingType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + TurretReportPointingType_Names::FixedPointing_Name) {
...
std::string TurretReportPointingType::serialize(const uci::type::TurretReportPointingType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, TurretReportPointingType_Names::Extern_Type_Name);
  }
