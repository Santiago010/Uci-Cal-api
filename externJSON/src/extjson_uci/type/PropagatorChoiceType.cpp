...
bool PropagatorChoiceType::deserialize(const boost::property_tree::ptree& propTree, uci::type::PropagatorChoiceType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + PropagatorChoiceType_Names::GeneralPropagator_Name) {
...
std::string PropagatorChoiceType::serialize(const uci::type::PropagatorChoiceType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, PropagatorChoiceType_Names::Extern_Type_Name);
  }
