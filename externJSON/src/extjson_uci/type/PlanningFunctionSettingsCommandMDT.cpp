...
bool PlanningFunctionSettingsCommandMDT::deserialize(const boost::property_tree::ptree& propTree, uci::type::PlanningFunctionSettingsCommandMDT& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + PlanningFunctionSettingsCommandMDT_Names::SystemID_Name) {
...
std::string PlanningFunctionSettingsCommandMDT::serialize(const uci::type::PlanningFunctionSettingsCommandMDT& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, PlanningFunctionSettingsCommandMDT_Names::Extern_Type_Name);
  }
  ...
  extjson_uci::util::SerializationHelpers::serializeBoolean(accessor.getTransitionDroppedToFailed(), node, PlanningFunctionSettingsCommandMDT_Names::TransitionDroppedToFailed_Name);
  {
