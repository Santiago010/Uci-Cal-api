...
bool EA_ActivityType::deserialize(const boost::property_tree::ptree& propTree, uci::type::EA_ActivityType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + EA_ActivityType_Names::EA_Details_Name) {
...
std::string EA_ActivityType::serialize(const uci::type::EA_ActivityType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, EA_ActivityType_Names::Extern_Type_Name);
  }
  ...
  if (accessor.hasConsentRequired()) {
    extjson_uci::util::SerializationHelpers::serializeBoolean(accessor.getConsentRequired(), node, EA_ActivityType_Names::ConsentRequired_Name);
  }
