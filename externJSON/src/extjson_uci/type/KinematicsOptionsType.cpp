...
bool KinematicsOptionsType::deserialize(const boost::property_tree::ptree& propTree, uci::type::KinematicsOptionsType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = KinematicsOptionsType_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + KinematicsOptionsType_Names::ReferenceAsset_Name) {
...
std::string KinematicsOptionsType::serialize(const uci::type::KinematicsOptionsType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, KinematicsOptionsType_Names::Extern_Type_Name);
  }
