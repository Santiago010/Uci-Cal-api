...
bool RadarAltimeterActivityMetricsType::deserialize(const boost::property_tree::ptree& propTree, uci::type::RadarAltimeterActivityMetricsType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + RadarAltimeterActivityMetricsType_Names::Attempts_Name) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setLastTimeToService(extjson_uci::util::SerializationHelpers::deserializeDuration(*value));
      }
...
std::string RadarAltimeterActivityMetricsType::serialize(const uci::type::RadarAltimeterActivityMetricsType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, RadarAltimeterActivityMetricsType_Names::Extern_Type_Name);
  }
  if (accessor.hasAttempts()) {
    extjson_uci::util::SerializationHelpers::serializeUnsignedInt(accessor.getAttempts(), node, RadarAltimeterActivityMetricsType_Names::Attempts_Name);
  }
  if (accessor.hasActualRevisitPeriod()) {
    extjson_uci::util::SerializationHelpers::serializeDuration(accessor.getActualRevisitPeriod(), node, RadarAltimeterActivityMetricsType_Names::ActualRevisitPeriod_Name);
  }
  if (accessor.hasActualStartTime()) {
    extjson_uci::util::SerializationHelpers::serializeDateTime(accessor.getActualStartTime(), node, RadarAltimeterActivityMetricsType_Names::ActualStartTime_Name);
  }
  if (accessor.hasActualStopTime()) {
    extjson_uci::util::SerializationHelpers::serializeDateTime(accessor.getActualStopTime(), node, RadarAltimeterActivityMetricsType_Names::ActualStopTime_Name);
  }
  {
  ...
  if (accessor.hasPercentRadarTimeline()) {
    extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getPercentRadarTimeline(), node, RadarAltimeterActivityMetricsType_Names::PercentRadarTimeline_Name);
  }
  if (accessor.hasPercentageInFOV()) {
    extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getPercentageInFOV(), node, RadarAltimeterActivityMetricsType_Names::PercentageInFOV_Name);
  }
  if (accessor.hasEstimatedERP()) {
    extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getEstimatedERP(), node, RadarAltimeterActivityMetricsType_Names::EstimatedERP_Name);
  }
  {
  ...
  if (accessor.hasTimeToService()) {
    extjson_uci::util::SerializationHelpers::serializeDuration(accessor.getTimeToService(), node, RadarAltimeterActivityMetricsType_Names::TimeToService_Name);
  }
  if (accessor.hasLastTimeToService()) {
    extjson_uci::util::SerializationHelpers::serializeDuration(accessor.getLastTimeToService(), node, RadarAltimeterActivityMetricsType_Names::LastTimeToService_Name);
  }
  if (accessor.hasAverageTimeToService()) {
    extjson_uci::util::SerializationHelpers::serializeDuration(accessor.getAverageTimeToService(), node, RadarAltimeterActivityMetricsType_Names::AverageTimeToService_Name);
  }
  if (createNode) {
