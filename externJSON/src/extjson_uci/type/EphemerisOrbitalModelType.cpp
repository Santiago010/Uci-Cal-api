...
bool EphemerisOrbitalModelType::deserialize(const boost::property_tree::ptree& propTree, uci::type::EphemerisOrbitalModelType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = EphemerisOrbitalModelType_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + EphemerisOrbitalModelType_Names::OrbitalModel_Name) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setSolarRadiationPressureCoefficient(extjson_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
...
std::string EphemerisOrbitalModelType::serialize(const uci::type::EphemerisOrbitalModelType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, EphemerisOrbitalModelType_Names::Extern_Type_Name);
  }
  ...
  if (accessor.hasStepSize()) {
    extjson_uci::util::SerializationHelpers::serializeDuration(accessor.getStepSize(), node, EphemerisOrbitalModelType_Names::StepSize_Name);
  }
  if (accessor.hasSolarRadiationPressureCoefficient()) {
    extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getSolarRadiationPressureCoefficient(), node, EphemerisOrbitalModelType_Names::SolarRadiationPressureCoefficient_Name);
  }
  if (accessor.hasBallisticCoefficient()) {
    extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getBallisticCoefficient(), node, EphemerisOrbitalModelType_Names::BallisticCoefficient_Name);
  }
  if (createNode) {
