...
bool SAR_SubCapabilityNparDetailsType::deserialize(const boost::property_tree::ptree& propTree, uci::type::SAR_SubCapabilityNparDetailsType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + SAR_SubCapabilityNparDetailsType_Names::NPAR_ProcessApodization_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setNPAR_ProcessApodization(extjson_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
    } else if (valueType.first == nsPrefix + SAR_SubCapabilityNparDetailsType_Names::NPAR_ProcessNoiseSubtraction_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setNPAR_ProcessNoiseSubtraction(extjson_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
    } else if (valueType.first == nsPrefix + SAR_SubCapabilityNparDetailsType_Names::NPAR_ProcessSpectralShaping_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setNPAR_ProcessSpectralShaping(extjson_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
    } else if (valueType.first == nsPrefix + SAR_SubCapabilityNparDetailsType_Names::NPAR_ProcessRemap_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setNPAR_ProcessRemap(extjson_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
...
std::string SAR_SubCapabilityNparDetailsType::serialize(const uci::type::SAR_SubCapabilityNparDetailsType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, SAR_SubCapabilityNparDetailsType_Names::Extern_Type_Name);
  }
  if (accessor.hasNPAR_ProcessApodization()) {
    extjson_uci::util::SerializationHelpers::serializeBoolean(accessor.getNPAR_ProcessApodization(), node, SAR_SubCapabilityNparDetailsType_Names::NPAR_ProcessApodization_Name);
  }
  if (accessor.hasNPAR_ProcessNoiseSubtraction()) {
    extjson_uci::util::SerializationHelpers::serializeBoolean(accessor.getNPAR_ProcessNoiseSubtraction(), node, SAR_SubCapabilityNparDetailsType_Names::NPAR_ProcessNoiseSubtraction_Name);
  }
  if (accessor.hasNPAR_ProcessSpectralShaping()) {
    extjson_uci::util::SerializationHelpers::serializeBoolean(accessor.getNPAR_ProcessSpectralShaping(), node, SAR_SubCapabilityNparDetailsType_Names::NPAR_ProcessSpectralShaping_Name);
  }
  if (accessor.hasNPAR_ProcessRemap()) {
    extjson_uci::util::SerializationHelpers::serializeBoolean(accessor.getNPAR_ProcessRemap(), node, SAR_SubCapabilityNparDetailsType_Names::NPAR_ProcessRemap_Name);
  }
