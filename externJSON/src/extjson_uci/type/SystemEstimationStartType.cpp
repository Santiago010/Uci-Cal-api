...
bool SystemEstimationStartType::deserialize(const boost::property_tree::ptree& propTree, uci::type::SystemEstimationStartType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = SystemEstimationStartType_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + SystemEstimationStartType_Names::StartTime_Name) {
...
std::string SystemEstimationStartType::serialize(const uci::type::SystemEstimationStartType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, SystemEstimationStartType_Names::Extern_Type_Name);
  }
  if (accessor.isStartTime()) {
    extjson_uci::util::SerializationHelpers::serializeDateTime(accessor.getStartTime(), node, SystemEstimationStartType_Names::StartTime_Name);
