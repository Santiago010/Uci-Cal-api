...
bool CountryCodeType::deserialize(const boost::property_tree::ptree& propTree, uci::type::CountryCodeType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = CountryCodeType_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + CountryCodeType_Names::CountryName_Name) {
...
std::string CountryCodeType::serialize(const uci::type::CountryCodeType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, CountryCodeType_Names::Extern_Type_Name);
  }
