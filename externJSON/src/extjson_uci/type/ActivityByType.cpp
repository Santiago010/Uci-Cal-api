...
bool ActivityByType::deserialize(const boost::property_tree::ptree& propTree, uci::type::ActivityByType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + ActivityByType_Names::Activity_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setActivity(extjson_uci::util::SerializationHelpers::deserializeUnsignedInt(*value));
      }
    } else if (valueType.first == nsPrefix + ActivityByType_Names::ActivityAmplification_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setActivityAmplification(extjson_uci::util::SerializationHelpers::deserializeUnsignedInt(*value));
      }
      ...
      extjson_uci::util::DerivedTypesDeserializer::deserialize(valueType.second, accessor.enableCustomActivity(extjson_uci::util::SerializationHelpers::checkForTypeAttribute(valueType.second, nsPrefix)), nodeName, nsPrefix);
...
std::string ActivityByType::serialize(const uci::type::ActivityByType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, ActivityByType_Names::Extern_Type_Name);
  }
  extjson_uci::util::SerializationHelpers::serializeUnsignedInt(accessor.getActivity(), node, ActivityByType_Names::Activity_Name);
  if (accessor.hasActivityAmplification()) {
    extjson_uci::util::SerializationHelpers::serializeUnsignedInt(accessor.getActivityAmplification(), node, ActivityByType_Names::ActivityAmplification_Name);
  }
