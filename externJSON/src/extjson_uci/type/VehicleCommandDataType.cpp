...
bool VehicleCommandDataType::deserialize(const boost::property_tree::ptree& propTree, uci::type::VehicleCommandDataType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + VehicleCommandDataType_Names::VehicleAction_Name) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setLostCommTimeout(extjson_uci::util::SerializationHelpers::deserializeDuration(*value));
      }
    } else if (valueType.first == nsPrefix + VehicleCommandDataType_Names::LOS_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setLOS(extjson_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
...
std::string VehicleCommandDataType::serialize(const uci::type::VehicleCommandDataType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, VehicleCommandDataType_Names::Extern_Type_Name);
  }
  ...
  if (accessor.hasLostCommTimeout()) {
    extjson_uci::util::SerializationHelpers::serializeDuration(accessor.getLostCommTimeout(), node, VehicleCommandDataType_Names::LostCommTimeout_Name);
  }
  if (accessor.hasLOS()) {
    extjson_uci::util::SerializationHelpers::serializeBoolean(accessor.getLOS(), node, VehicleCommandDataType_Names::LOS_Name);
  }
