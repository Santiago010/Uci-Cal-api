...
bool CS_HeaderType::deserialize(const boost::property_tree::ptree& propTree, uci::type::CS_HeaderType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + CS_HeaderType_Names::TaskID_Name) {
...
std::string CS_HeaderType::serialize(const uci::type::CS_HeaderType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, CS_HeaderType_Names::Extern_Type_Name);
  }
  ...
  extjson_uci::util::SerializationHelpers::serializeString(accessor.getReportingLocation(), node, CS_HeaderType_Names::ReportingLocation_Name);
