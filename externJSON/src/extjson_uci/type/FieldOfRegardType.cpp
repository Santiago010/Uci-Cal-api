...
bool FieldOfRegardType::deserialize(const boost::property_tree::ptree& propTree, uci::type::FieldOfRegardType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + FieldOfRegardType_Names::Field_Name) {
...
std::string FieldOfRegardType::serialize(const uci::type::FieldOfRegardType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, FieldOfRegardType_Names::Extern_Type_Name);
  }
  ...
  if (accessor.hasMnemonic()) {
    extjson_uci::util::SerializationHelpers::serializeString(accessor.getMnemonic(), node, FieldOfRegardType_Names::Mnemonic_Name);
  }
