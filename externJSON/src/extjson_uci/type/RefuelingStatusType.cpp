...
bool RefuelingStatusType::deserialize(const boost::property_tree::ptree& propTree, uci::type::RefuelingStatusType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + RefuelingStatusType_Names::RefuelingLatched_Name) {
...
std::string RefuelingStatusType::serialize(const uci::type::RefuelingStatusType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, RefuelingStatusType_Names::Extern_Type_Name);
  }
  if (accessor.hasRefuelingLatched()) {
    extjson_uci::util::SerializationHelpers::serializeString(accessor.getRefuelingLatched(), node, RefuelingStatusType_Names::RefuelingLatched_Name);
  }
  if (accessor.hasRefuelingFuelLinePresent()) {
    extjson_uci::util::SerializationHelpers::serializeString(accessor.getRefuelingFuelLinePresent(), node, RefuelingStatusType_Names::RefuelingFuelLinePresent_Name);
  }
