...
bool ESM_ActivityMDT::deserialize(const boost::property_tree::ptree& propTree, uci::type::ESM_ActivityMDT& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + ESM_ActivityMDT_Names::SubsystemID_Name) {
...
std::string ESM_ActivityMDT::serialize(const uci::type::ESM_ActivityMDT& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, ESM_ActivityMDT_Names::Extern_Type_Name);
  }
  ...
  if (accessor.hasEntityListCleared()) {
    extjson_uci::util::SerializationHelpers::serializeDateTime(accessor.getEntityListCleared(), node, ESM_ActivityMDT_Names::EntityListCleared_Name);
  }
  if (accessor.hasEntityOverload()) {
    extjson_uci::util::SerializationHelpers::serializeBoolean(accessor.getEntityOverload(), node, ESM_ActivityMDT_Names::EntityOverload_Name);
  }
  if (accessor.hasExcessiveAttitude()) {
    extjson_uci::util::SerializationHelpers::serializeBoolean(accessor.getExcessiveAttitude(), node, ESM_ActivityMDT_Names::ExcessiveAttitude_Name);
  }
  if (accessor.hasPulseDensityOverload()) {
    extjson_uci::util::SerializationHelpers::serializeBoolean(accessor.getPulseDensityOverload(), node, ESM_ActivityMDT_Names::PulseDensityOverload_Name);
  }
  if (accessor.hasLookThroughLimited()) {
    extjson_uci::util::SerializationHelpers::serializeBoolean(accessor.getLookThroughLimited(), node, ESM_ActivityMDT_Names::LookThroughLimited_Name);
  }
  if (accessor.hasReceiverUtilization()) {
    extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getReceiverUtilization(), node, ESM_ActivityMDT_Names::ReceiverUtilization_Name);
  }
  {
