...
bool WeatherRadarActivityStatusDetailType::deserialize(const boost::property_tree::ptree& propTree, uci::type::WeatherRadarActivityStatusDetailType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + WeatherRadarActivityStatusDetailType_Names::NumberOfTimesSearched_Name) {
...
std::string WeatherRadarActivityStatusDetailType::serialize(const uci::type::WeatherRadarActivityStatusDetailType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, WeatherRadarActivityStatusDetailType_Names::Extern_Type_Name);
  }
  if (accessor.hasNumberOfTimesSearched()) {
    extjson_uci::util::SerializationHelpers::serializeUnsignedInt(accessor.getNumberOfTimesSearched(), node, WeatherRadarActivityStatusDetailType_Names::NumberOfTimesSearched_Name);
  }
  if (accessor.hasTimeLastSearched()) {
    extjson_uci::util::SerializationHelpers::serializeDateTime(accessor.getTimeLastSearched(), node, WeatherRadarActivityStatusDetailType_Names::TimeLastSearched_Name);
  }
  if (accessor.hasAttempts()) {
    extjson_uci::util::SerializationHelpers::serializeUnsignedInt(accessor.getAttempts(), node, WeatherRadarActivityStatusDetailType_Names::Attempts_Name);
  }
  if (accessor.hasActualRevisitPeriod()) {
    extjson_uci::util::SerializationHelpers::serializeDuration(accessor.getActualRevisitPeriod(), node, WeatherRadarActivityStatusDetailType_Names::ActualRevisitPeriod_Name);
  }
  if (accessor.hasPercentageInFOR()) {
    extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getPercentageInFOR(), node, WeatherRadarActivityStatusDetailType_Names::PercentageInFOR_Name);
  }
  if (accessor.hasActualStartTime()) {
    extjson_uci::util::SerializationHelpers::serializeDateTime(accessor.getActualStartTime(), node, WeatherRadarActivityStatusDetailType_Names::ActualStartTime_Name);
  }
  if (accessor.hasActualStopTime()) {
    extjson_uci::util::SerializationHelpers::serializeDateTime(accessor.getActualStopTime(), node, WeatherRadarActivityStatusDetailType_Names::ActualStopTime_Name);
  }
  if (accessor.hasPercentSearched()) {
    extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getPercentSearched(), node, WeatherRadarActivityStatusDetailType_Names::PercentSearched_Name);
  }
  if (accessor.hasProductsProduced()) {
    extjson_uci::util::SerializationHelpers::serializeUnsignedInt(accessor.getProductsProduced(), node, WeatherRadarActivityStatusDetailType_Names::ProductsProduced_Name);
  }
  if (accessor.hasEstimatedERP()) {
    extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getEstimatedERP(), node, WeatherRadarActivityStatusDetailType_Names::EstimatedERP_Name);
  }
  if (createNode) {
