...
bool TimingConstraintsType::deserialize(const boost::property_tree::ptree& propTree, uci::type::TimingConstraintsType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + TimingConstraintsType_Names::AsSoonAsPossible_Name) {
...
std::string TimingConstraintsType::serialize(const uci::type::TimingConstraintsType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, TimingConstraintsType_Names::Extern_Type_Name);
  }
  if (accessor.isAsSoonAsPossible()) {
    extjson_uci::util::SerializationHelpers::serializeString(accessor.getAsSoonAsPossible(), node, TimingConstraintsType_Names::AsSoonAsPossible_Name);
