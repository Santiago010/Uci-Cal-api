...
bool PlannedCommActionType::deserialize(const boost::property_tree::ptree& propTree, uci::type::PlannedCommActionType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + PlannedCommActionType_Names::ConfigurationID_Name) {
...
std::string PlannedCommActionType::serialize(const uci::type::PlannedCommActionType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool checkIfDerivation, const bool /*topLevel*/) {
  ...
  if (!checkIfDerivation || (accessor.getAccessorType() == uci::type::accessorType::plannedCommActionType)) {
    ...
    if (addTypeAttribute) {
      extjson_uci::util::SerializationHelpers::addTypeAttribute(node, PlannedCommActionType_Names::Extern_Type_Name);
    }
