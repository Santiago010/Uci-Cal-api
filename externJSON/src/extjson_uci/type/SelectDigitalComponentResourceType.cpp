...
bool SelectDigitalComponentResourceType::deserialize(const boost::property_tree::ptree& propTree, uci::type::SelectDigitalComponentResourceType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = SelectDigitalComponentResourceType_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + SelectDigitalComponentResourceType_Names::MFA_Address_Name) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        ...
        MFP_AddressType::deserialize(valueType.second, boundedList.at(boundedListSize), nodeName, nsPrefix);
      }
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        ...
        boundedList.resize(boundedListSize + 1);
        BeamBandWidthAndSampleRateType::deserialize(valueType.second, boundedList.at(boundedListSize), nodeName, nsPrefix);
      }
...
std::string SelectDigitalComponentResourceType::serialize(const uci::type::SelectDigitalComponentResourceType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, SelectDigitalComponentResourceType_Names::Extern_Type_Name);
  }
  ...
  }
  {
    ...
    for (uci::type::SelectDigitalComponentResourceType::MFP_Address::size_type i = 0, end = boundedList.size(); i < end; ++i) {
      MFP_AddressType::serialize(boundedList.at(i), node, SelectDigitalComponentResourceType_Names::MFP_Address_Name);
    }
  }
  {
    ...
    for (uci::type::SelectDigitalComponentResourceType::BeamBandWidthAndSampleRate::size_type i = 0, end = boundedList.size(); i < end; ++i) {
      BeamBandWidthAndSampleRateType::serialize(boundedList.at(i), node, SelectDigitalComponentResourceType_Names::BeamBandWidthAndSampleRate_Name);
    }
  }
