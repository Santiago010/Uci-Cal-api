...
bool QuaternionAttitudeType::deserialize(const boost::property_tree::ptree& propTree, uci::type::QuaternionAttitudeType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = QuaternionAttitudeType_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + QuaternionAttitudeType_Names::Attitude_Name) {
...
std::string QuaternionAttitudeType::serialize(const uci::type::QuaternionAttitudeType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, QuaternionAttitudeType_Names::Extern_Type_Name);
  }
