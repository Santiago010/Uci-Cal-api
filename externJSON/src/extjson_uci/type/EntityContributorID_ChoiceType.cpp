...
bool EntityContributorID_ChoiceType::deserialize(const boost::property_tree::ptree& propTree, uci::type::EntityContributorID_ChoiceType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + EntityContributorID_ChoiceType_Names::EntityID_Name) {
...
std::string EntityContributorID_ChoiceType::serialize(const uci::type::EntityContributorID_ChoiceType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, EntityContributorID_ChoiceType_Names::Extern_Type_Name);
  }
