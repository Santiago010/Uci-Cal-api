...
bool VehicleThreatAssessmentRequestType::deserialize(const boost::property_tree::ptree& propTree, uci::type::VehicleThreatAssessmentRequestType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + VehicleThreatAssessmentRequestType_Names::AssessmentSuppression_Name) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setGenerateThreatZone(extjson_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
    }
  }
  return true;
...
std::string VehicleThreatAssessmentRequestType::serialize(const uci::type::VehicleThreatAssessmentRequestType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, VehicleThreatAssessmentRequestType_Names::Extern_Type_Name);
  }
  ...
  if (accessor.hasGenerateThreatZone()) {
    extjson_uci::util::SerializationHelpers::serializeBoolean(accessor.getGenerateThreatZone(), node, VehicleThreatAssessmentRequestType_Names::GenerateThreatZone_Name);
  }
  if (createNode) {
