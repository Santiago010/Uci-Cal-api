...
bool CapabilityTaxonomyUniversalBaseType::deserialize(const boost::property_tree::ptree& propTree, uci::type::CapabilityTaxonomyUniversalBaseType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + CapabilityTaxonomyUniversalBaseType_Names::Capability_Name) {
      CapabilityTypeEnum::deserializeList(valueType.second, accessor.getCapability());
      ...
      ThreatCapabilityEnum::deserializeList(valueType.second, accessor.getThreatCapability());
...
std::string CapabilityTaxonomyUniversalBaseType::serialize(const uci::type::CapabilityTaxonomyUniversalBaseType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool checkIfDerivation, const bool /*topLevel*/) {
  ...
  if (!checkIfDerivation || (accessor.getAccessorType() == uci::type::accessorType::capabilityTaxonomyUniversalBaseType)) {
    ...
    if (addTypeAttribute) {
      extjson_uci::util::SerializationHelpers::addTypeAttribute(node, CapabilityTaxonomyUniversalBaseType_Names::Extern_Type_Name);
    }
    {
      CapabilityTypeEnum::serializeList(accessor.getCapability(), node, CapabilityTaxonomyUniversalBaseType_Names::Capability_Name);
    }
    ...
    {
      ThreatCapabilityEnum::serializeList(accessor.getThreatCapability(), node, CapabilityTaxonomyUniversalBaseType_Names::ThreatCapability_Name);
    }
    {
