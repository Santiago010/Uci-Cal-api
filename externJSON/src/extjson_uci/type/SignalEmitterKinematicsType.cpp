...
bool SignalEmitterKinematicsType::deserialize(const boost::property_tree::ptree& propTree, uci::type::SignalEmitterKinematicsType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + SignalEmitterKinematicsType_Names::KinematicsStatus_Name) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setVelocityDeviation(extjson_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    } else if (valueType.first == nsPrefix + SignalEmitterKinematicsType_Names::HeadingDeviation_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setHeadingDeviation(extjson_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    }
  }
  return true;
...
std::string SignalEmitterKinematicsType::serialize(const uci::type::SignalEmitterKinematicsType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, SignalEmitterKinematicsType_Names::Extern_Type_Name);
  }
  ...
  if (accessor.hasVelocityDeviation()) {
    extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getVelocityDeviation(), node, SignalEmitterKinematicsType_Names::VelocityDeviation_Name);
  }
  if (accessor.hasHeadingDeviation()) {
    extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getHeadingDeviation(), node, SignalEmitterKinematicsType_Names::HeadingDeviation_Name);
  }
  if (createNode) {
