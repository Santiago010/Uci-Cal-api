...
bool VideoEncoderOutputType::deserialize(const boost::property_tree::ptree& propTree, uci::type::VideoEncoderOutputType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + VideoEncoderOutputType_Names::SocketAddress_Name) {
...
std::string VideoEncoderOutputType::serialize(const uci::type::VideoEncoderOutputType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, VideoEncoderOutputType_Names::Extern_Type_Name);
  }
