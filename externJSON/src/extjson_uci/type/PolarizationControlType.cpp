...
bool PolarizationControlType::deserialize(const boost::property_tree::ptree& propTree, uci::type::PolarizationControlType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + PolarizationControlType_Names::PortPolarization_Name) {
...
std::string PolarizationControlType::serialize(const uci::type::PolarizationControlType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, PolarizationControlType_Names::Extern_Type_Name);
  }
  ...
  if (accessor.hasDuration()) {
    extjson_uci::util::SerializationHelpers::serializeDuration(accessor.getDuration(), node, PolarizationControlType_Names::Duration_Name);
  }
