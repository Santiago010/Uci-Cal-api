...
bool EntityIdentityType::deserialize(const boost::property_tree::ptree& propTree, uci::type::EntityIdentityType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + EntityIdentityType_Names::SelfReportedIdentity_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setSelfReportedIdentity(extjson_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
    } else if (valueType.first == nsPrefix + EntityIdentityType_Names::DifferenceIndicator_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setDifferenceIndicator(extjson_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
    } else if (valueType.first == nsPrefix + EntityIdentityType_Names::IdentityTimestamp_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setIdentityTimestamp(extjson_uci::util::SerializationHelpers::deserializeDateTime(*value));
      }
...
std::string EntityIdentityType::serialize(const uci::type::EntityIdentityType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, EntityIdentityType_Names::Extern_Type_Name);
  }
  IdentityConfidenceType::serialize(accessor, node, "", false, false, false);
  if (accessor.hasSelfReportedIdentity()) {
    extjson_uci::util::SerializationHelpers::serializeBoolean(accessor.getSelfReportedIdentity(), node, EntityIdentityType_Names::SelfReportedIdentity_Name);
  }
  if (accessor.hasDifferenceIndicator()) {
    extjson_uci::util::SerializationHelpers::serializeBoolean(accessor.getDifferenceIndicator(), node, EntityIdentityType_Names::DifferenceIndicator_Name);
  }
  extjson_uci::util::SerializationHelpers::serializeDateTime(accessor.getIdentityTimestamp(), node, EntityIdentityType_Names::IdentityTimestamp_Name);
  {
