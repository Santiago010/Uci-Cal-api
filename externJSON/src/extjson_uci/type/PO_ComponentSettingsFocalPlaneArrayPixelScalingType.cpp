...
bool PO_ComponentSettingsFocalPlaneArrayPixelScalingType::deserialize(const boost::property_tree::ptree& propTree, uci::type::PO_ComponentSettingsFocalPlaneArrayPixelScalingType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + PO_ComponentSettingsFocalPlaneArrayPixelScalingType_Names::ScalingSettings_Name) {
...
std::string PO_ComponentSettingsFocalPlaneArrayPixelScalingType::serialize(const uci::type::PO_ComponentSettingsFocalPlaneArrayPixelScalingType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, PO_ComponentSettingsFocalPlaneArrayPixelScalingType_Names::Extern_Type_Name);
  }
