...
bool DMPI_DesignationRequestMDT::deserialize(const boost::property_tree::ptree& propTree, uci::type::DMPI_DesignationRequestMDT& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = DMPI_DesignationRequestMDT_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + DMPI_DesignationRequestMDT_Names::TaskID_Name) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        ...
        boundedList.resize(boundedListSize + 1);
        RecommendedWeaponsType::deserialize(valueType.second, boundedList.at(boundedListSize), nodeName, nsPrefix);
      }
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        ...
        boundedList.resize(boundedListSize + 1);
        AvailableWeaponsType::deserialize(valueType.second, boundedList.at(boundedListSize), nodeName, nsPrefix);
      }
      ...
      extjson_uci::util::DerivedTypesDeserializer::deserialize(valueType.second, accessor.enableProposedDMPI_Coordinates(extjson_uci::util::SerializationHelpers::checkForTypeAttribute(valueType.second, nsPrefix)), nodeName, nsPrefix);
...
std::string DMPI_DesignationRequestMDT::serialize(const uci::type::DMPI_DesignationRequestMDT& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, DMPI_DesignationRequestMDT_Names::Extern_Type_Name);
  }
  ...
  TaskID_Type::serialize(accessor.getTaskID(), node, DMPI_DesignationRequestMDT_Names::TaskID_Name);
  {
    ...
    for (uci::type::DMPI_DesignationRequestMDT::ProductMetadataID::size_type i = 0, end = boundedList.size(); i < end; ++i) {
      ProductMetadataID_Type::serialize(boundedList.at(i), node, DMPI_DesignationRequestMDT_Names::ProductMetadataID_Name);
    }
  }
  {
    ...
    for (uci::type::DMPI_DesignationRequestMDT::RecommendedWeapons::size_type i = 0, end = boundedList.size(); i < end; ++i) {
      RecommendedWeaponsType::serialize(boundedList.at(i), node, DMPI_DesignationRequestMDT_Names::RecommendedWeapons_Name);
    }
  }
  {
    ...
    for (uci::type::DMPI_DesignationRequestMDT::AvailableWeapons::size_type i = 0, end = boundedList.size(); i < end; ++i) {
      AvailableWeaponsType::serialize(boundedList.at(i), node, DMPI_DesignationRequestMDT_Names::AvailableWeapons_Name);
    }
  }
  if (accessor.hasRespondBy()) {
    extjson_uci::util::SerializationHelpers::serializeDateTime(accessor.getRespondBy(), node, DMPI_DesignationRequestMDT_Names::RespondBy_Name);
  }
