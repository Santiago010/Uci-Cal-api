...
bool ATR_ProcessingParametersType::deserialize(const boost::property_tree::ptree& propTree, uci::type::ATR_ProcessingParametersType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = ATR_ProcessingParametersType_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + ATR_ProcessingParametersType_Names::FindTarget_Name) {
...
std::string ATR_ProcessingParametersType::serialize(const uci::type::ATR_ProcessingParametersType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, ATR_ProcessingParametersType_Names::Extern_Type_Name);
  }
  ProcessingParametersPET::serialize(accessor, node, "", false, false, false);
  {
    ...
    for (uci::type::ATR_ProcessingParametersType::FindTarget::size_type i = 0, end = boundedList.size(); i < end; ++i) {
      EntityIdentityType::serialize(boundedList.at(i), node, ATR_ProcessingParametersType_Names::FindTarget_Name);
    }
  }
  {
    ...
    for (uci::type::ATR_ProcessingParametersType::ProductOutput::size_type i = 0, end = boundedList.size(); i < end; ++i) {
      ProductOutputType::serialize(boundedList.at(i), node, ATR_ProcessingParametersType_Names::ProductOutput_Name);
    }
  }
