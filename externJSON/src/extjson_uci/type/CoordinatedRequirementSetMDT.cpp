...
bool CoordinatedRequirementSetMDT::deserialize(const boost::property_tree::ptree& propTree, uci::type::CoordinatedRequirementSetMDT& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + CoordinatedRequirementSetMDT_Names::CoordinatedRequirementSetID_Name) {
...
std::string CoordinatedRequirementSetMDT::serialize(const uci::type::CoordinatedRequirementSetMDT& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, CoordinatedRequirementSetMDT_Names::Extern_Type_Name);
  }
  ...
  if (accessor.hasSpecialInstructions()) {
    extjson_uci::util::SerializationHelpers::serializeString(accessor.getSpecialInstructions(), node, CoordinatedRequirementSetMDT_Names::SpecialInstructions_Name);
  }
  ...
  if (accessor.hasCoordinationParameter()) {
    extjson_uci::util::SerializationHelpers::serializeString(accessor.getCoordinationParameter(), node, CoordinatedRequirementSetMDT_Names::CoordinationParameter_Name);
  }
  {
  ...
  if (accessor.hasVOIP_Number()) {
    extjson_uci::util::SerializationHelpers::serializeString(accessor.getVOIP_Number(), node, CoordinatedRequirementSetMDT_Names::VOIP_Number_Name);
  }
  if (accessor.hasChatRoom()) {
    extjson_uci::util::SerializationHelpers::serializeString(accessor.getChatRoom(), node, CoordinatedRequirementSetMDT_Names::ChatRoom_Name);
  }
  if (accessor.hasFrequency()) {
    extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getFrequency(), node, CoordinatedRequirementSetMDT_Names::Frequency_Name);
  }
  {
