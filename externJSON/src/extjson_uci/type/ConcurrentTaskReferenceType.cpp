...
bool ConcurrentTaskReferenceType::deserialize(const boost::property_tree::ptree& propTree, uci::type::ConcurrentTaskReferenceType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + ConcurrentTaskReferenceType_Names::ConcurrentTaskID_Name) {
...
std::string ConcurrentTaskReferenceType::serialize(const uci::type::ConcurrentTaskReferenceType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, ConcurrentTaskReferenceType_Names::Extern_Type_Name);
  }
  ...
  extjson_uci::util::SerializationHelpers::serializeBoolean(accessor.getTaskRequired(), node, ConcurrentTaskReferenceType_Names::TaskRequired_Name);
  if (createNode) {
