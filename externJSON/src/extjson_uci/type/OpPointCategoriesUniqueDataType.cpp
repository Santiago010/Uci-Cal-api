...
bool OpPointCategoriesUniqueDataType::deserialize(const boost::property_tree::ptree& propTree, uci::type::OpPointCategoriesUniqueDataType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = OpPointCategoriesUniqueDataType_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + OpPointCategoriesUniqueDataType_Names::Emergency_Name) {
...
std::string OpPointCategoriesUniqueDataType::serialize(const uci::type::OpPointCategoriesUniqueDataType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, OpPointCategoriesUniqueDataType_Names::Extern_Type_Name);
  }
