...
bool RouteActivityPlanValidationInputsType::deserialize(const boost::property_tree::ptree& propTree, uci::type::RouteActivityPlanValidationInputsType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = RouteActivityPlanValidationInputsType_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + RouteActivityPlanValidationInputsType_Names::PlanID_Name) {
...
std::string RouteActivityPlanValidationInputsType::serialize(const uci::type::RouteActivityPlanValidationInputsType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, RouteActivityPlanValidationInputsType_Names::Extern_Type_Name);
  }
  ...
  {
    ActivityPlanPartsEnum::serializeList(accessor.getPlanPart(), node, RouteActivityPlanValidationInputsType_Names::PlanPart_Name);
  }
