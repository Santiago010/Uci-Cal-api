...
bool RouteValidationErrorType::deserialize(const boost::property_tree::ptree& propTree, uci::type::RouteValidationErrorType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = RouteValidationErrorType_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + RouteValidationErrorType_Names::InvalidReason_Name) {
...
std::string RouteValidationErrorType::serialize(const uci::type::RouteValidationErrorType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, RouteValidationErrorType_Names::Extern_Type_Name);
  }
  ...
  if (accessor.hasSpecificReasonCode()) {
    extjson_uci::util::SerializationHelpers::serializeUnsignedInt(accessor.getSpecificReasonCode(), node, RouteValidationErrorType_Names::SpecificReasonCode_Name);
  }
  if (accessor.hasDescription()) {
    extjson_uci::util::SerializationHelpers::serializeString(accessor.getDescription(), node, RouteValidationErrorType_Names::Description_Name);
  }
  if (createNode) {
