...
bool LOS_MeasurementUncertaintyErrorSourcesType::deserialize(const boost::property_tree::ptree& propTree, uci::type::LOS_MeasurementUncertaintyErrorSourcesType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + LOS_MeasurementUncertaintyErrorSourcesType_Names::RootMeanSquare_Name) {
...
std::string LOS_MeasurementUncertaintyErrorSourcesType::serialize(const uci::type::LOS_MeasurementUncertaintyErrorSourcesType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, LOS_MeasurementUncertaintyErrorSourcesType_Names::Extern_Type_Name);
  }
