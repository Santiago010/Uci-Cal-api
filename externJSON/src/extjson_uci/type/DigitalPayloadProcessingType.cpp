...
bool DigitalPayloadProcessingType::deserialize(const boost::property_tree::ptree& propTree, uci::type::DigitalPayloadProcessingType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = DigitalPayloadProcessingType_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + DigitalPayloadProcessingType_Names::DigitalPayloadProcessorID_Name) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        ...
        DigitalPayloadProcessorPortAndDataType::deserialize(valueType.second, boundedList.at(boundedListSize), nodeName, nsPrefix);
      }
    }
  }
  return true;
...
std::string DigitalPayloadProcessingType::serialize(const uci::type::DigitalPayloadProcessingType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, DigitalPayloadProcessingType_Names::Extern_Type_Name);
  }
  ComponentID_Type::serialize(accessor.getDigitalPayloadProcessorID(), node, DigitalPayloadProcessingType_Names::DigitalPayloadProcessorID_Name);
  {
    ...
    for (uci::type::DigitalPayloadProcessingType::DigitalPayloadProcessorPortAndData::size_type i = 0, end = boundedList.size(); i < end; ++i) {
      DigitalPayloadProcessorPortAndDataType::serialize(boundedList.at(i), node, DigitalPayloadProcessingType_Names::DigitalPayloadProcessorPortAndData_Name);
    }
  }
  if (createNode) {
