...
bool PO_ComponentSettingsFocalPlaneArrayNonUniformityCorrectionDataType::deserialize(const boost::property_tree::ptree& propTree, uci::type::PO_ComponentSettingsFocalPlaneArrayNonUniformityCorrectionDataType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + PO_ComponentSettingsFocalPlaneArrayNonUniformityCorrectionDataType_Names::NUC_TableNumber_Name) {
...
std::string PO_ComponentSettingsFocalPlaneArrayNonUniformityCorrectionDataType::serialize(const uci::type::PO_ComponentSettingsFocalPlaneArrayNonUniformityCorrectionDataType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, PO_ComponentSettingsFocalPlaneArrayNonUniformityCorrectionDataType_Names::Extern_Type_Name);
  }
  if (accessor.isNUC_TableNumber()) {
    extjson_uci::util::SerializationHelpers::serializeUnsignedInt(accessor.getNUC_TableNumber(), node, PO_ComponentSettingsFocalPlaneArrayNonUniformityCorrectionDataType_Names::NUC_TableNumber_Name);
