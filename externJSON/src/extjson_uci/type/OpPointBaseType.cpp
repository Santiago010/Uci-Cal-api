...
bool OpPointBaseType::deserialize(const boost::property_tree::ptree& propTree, uci::type::OpPointBaseType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + OpPointBaseType_Names::OpPointID_Name) {
...
std::string OpPointBaseType::serialize(const uci::type::OpPointBaseType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool checkIfDerivation, const bool /*topLevel*/) {
  ...
  if (!checkIfDerivation || (accessor.getAccessorType() == uci::type::accessorType::opPointBaseType)) {
    ...
    if (addTypeAttribute) {
      extjson_uci::util::SerializationHelpers::addTypeAttribute(node, OpPointBaseType_Names::Extern_Type_Name);
    }
