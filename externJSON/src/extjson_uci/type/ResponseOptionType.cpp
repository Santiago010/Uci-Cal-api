...
bool ResponseOptionType::deserialize(const boost::property_tree::ptree& propTree, uci::type::ResponseOptionType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + ResponseOptionType_Names::Effect_Name) {
...
std::string ResponseOptionType::serialize(const uci::type::ResponseOptionType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, ResponseOptionType_Names::Extern_Type_Name);
  }
