...
bool RF_OperationType::deserialize(const boost::property_tree::ptree& propTree, uci::type::RF_OperationType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + RF_OperationType_Names::CapabilityID_Name) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setReceive(extjson_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
    } else if (valueType.first == nsPrefix + RF_OperationType_Names::Transmit_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setTransmit(extjson_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
...
std::string RF_OperationType::serialize(const uci::type::RF_OperationType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, RF_OperationType_Names::Extern_Type_Name);
  }
  ...
  extjson_uci::util::SerializationHelpers::serializeBoolean(accessor.getReceive(), node, RF_OperationType_Names::Receive_Name);
  extjson_uci::util::SerializationHelpers::serializeBoolean(accessor.getTransmit(), node, RF_OperationType_Names::Transmit_Name);
  ...
  if (accessor.hasPulseWidthMax()) {
    extjson_uci::util::SerializationHelpers::serializeDuration(accessor.getPulseWidthMax(), node, RF_OperationType_Names::PulseWidthMax_Name);
  }
