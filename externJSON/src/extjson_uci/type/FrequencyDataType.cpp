...
bool FrequencyDataType::deserialize(const boost::property_tree::ptree& propTree, uci::type::FrequencyDataType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + FrequencyDataType_Names::AgilityPattern_Name) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setModulationPatternPeriod(extjson_uci::util::SerializationHelpers::deserializeDuration(*value));
      }
    } else if (valueType.first == nsPrefix + FrequencyDataType_Names::FrequencyBins_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setFrequencyBins(extjson_uci::util::SerializationHelpers::deserializeUnsignedInt(*value));
      }
    }
  }
...
std::string FrequencyDataType::serialize(const uci::type::FrequencyDataType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, FrequencyDataType_Names::Extern_Type_Name);
  }
  ...
  if (accessor.hasAgileEmitter()) {
    extjson_uci::util::SerializationHelpers::serializeString(accessor.getAgileEmitter(), node, FrequencyDataType_Names::AgileEmitter_Name);
  }
  ...
  if (accessor.hasModulationPatternPeriod()) {
    extjson_uci::util::SerializationHelpers::serializeDuration(accessor.getModulationPatternPeriod(), node, FrequencyDataType_Names::ModulationPatternPeriod_Name);
  }
  if (accessor.hasFrequencyBins()) {
    extjson_uci::util::SerializationHelpers::serializeUnsignedInt(accessor.getFrequencyBins(), node, FrequencyDataType_Names::FrequencyBins_Name);
  }
  if (createNode) {
