...
bool CapabilityRF_ProfileStatusType::deserialize(const boost::property_tree::ptree& propTree, uci::type::CapabilityRF_ProfileStatusType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = CapabilityRF_ProfileStatusType_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + CapabilityRF_ProfileStatusType_Names::RF_ProfileID_Name) {
...
std::string CapabilityRF_ProfileStatusType::serialize(const uci::type::CapabilityRF_ProfileStatusType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, CapabilityRF_ProfileStatusType_Names::Extern_Type_Name);
  }
  ...
  if (accessor.hasExpires()) {
    extjson_uci::util::SerializationHelpers::serializeDateTime(accessor.getExpires(), node, CapabilityRF_ProfileStatusType_Names::Expires_Name);
  }
  if (createNode) {
