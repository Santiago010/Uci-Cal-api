...
bool PO_ComponentSettingsLensAssemblyFieldOfViewType::deserialize(const boost::property_tree::ptree& propTree, uci::type::PO_ComponentSettingsLensAssemblyFieldOfViewType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + PO_ComponentSettingsLensAssemblyFieldOfViewType_Names::FOV_Setting_Name) {
...
std::string PO_ComponentSettingsLensAssemblyFieldOfViewType::serialize(const uci::type::PO_ComponentSettingsLensAssemblyFieldOfViewType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, PO_ComponentSettingsLensAssemblyFieldOfViewType_Names::Extern_Type_Name);
  }
  if (accessor.isFOV_Setting()) {
    extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getFOV_Setting(), node, PO_ComponentSettingsLensAssemblyFieldOfViewType_Names::FOV_Setting_Name);
  } else if (accessor.isAutoZoom()) {
    extjson_uci::util::SerializationHelpers::serializeBoolean(accessor.getAutoZoom(), node, PO_ComponentSettingsLensAssemblyFieldOfViewType_Names::AutoZoom_Name);
