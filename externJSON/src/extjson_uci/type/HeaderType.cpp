...
bool HeaderType::deserialize(const boost::property_tree::ptree& propTree, uci::type::HeaderType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + HeaderType_Names::SystemID_Name) {
...
std::string HeaderType::serialize(const uci::type::HeaderType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, HeaderType_Names::Extern_Type_Name);
  }
  SystemID_Type::serialize(accessor.getSystemID(), node, HeaderType_Names::SystemID_Name);
  extjson_uci::util::SerializationHelpers::serializeDateTime(accessor.getTimestamp(), node, HeaderType_Names::Timestamp_Name);
  extjson_uci::util::SerializationHelpers::serializeString(accessor.getSchemaVersion(), node, HeaderType_Names::SchemaVersion_Name);
