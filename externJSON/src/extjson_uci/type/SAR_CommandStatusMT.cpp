...
bool SAR_CommandStatusMT::deserialize(const boost::property_tree::ptree& propTree, uci::type::SAR_CommandStatusMT& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + SAR_CommandStatusMT_Names::MessageData_Name) {
...
std::string SAR_CommandStatusMT::serialize(const uci::type::SAR_CommandStatusMT& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool topLevel) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, (topLevel ? SAR_CommandStatusMT_Names::Extern_Top_Type_Name : SAR_CommandStatusMT_Names::Extern_Type_Name));
  }
