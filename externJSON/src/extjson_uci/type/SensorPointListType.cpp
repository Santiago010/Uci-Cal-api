...
bool SensorPointListType::deserialize(const boost::property_tree::ptree& propTree, uci::type::SensorPointListType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + SensorPointListType_Names::AzimuthElevationRangePointList_Name) {
...
std::string SensorPointListType::serialize(const uci::type::SensorPointListType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, SensorPointListType_Names::Extern_Type_Name);
  }
