...
bool CannotComplyType::deserialize(const boost::property_tree::ptree& propTree, uci::type::CannotComplyType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + CannotComplyType_Names::Reason_Name) {
...
std::string CannotComplyType::serialize(const uci::type::CannotComplyType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool checkIfDerivation, const bool /*topLevel*/) {
  ...
  if (!checkIfDerivation || (accessor.getAccessorType() == uci::type::accessorType::cannotComplyType)) {
    ...
    if (addTypeAttribute) {
      extjson_uci::util::SerializationHelpers::addTypeAttribute(node, CannotComplyType_Names::Extern_Type_Name);
    }
    CannotComplyEnum::serialize(accessor.getReason(), node, CannotComplyType_Names::Reason_Name, false);
    if (accessor.hasDescription()) {
      extjson_uci::util::SerializationHelpers::serializeString(accessor.getDescription(), node, CannotComplyType_Names::Description_Name);
    }
