...
bool ActionPlanConstraintType::deserialize(const boost::property_tree::ptree& propTree, uci::type::ActionPlanConstraintType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = ActionPlanConstraintType_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + ActionPlanConstraintType_Names::ActionPlanID_Name) {
...
std::string ActionPlanConstraintType::serialize(const uci::type::ActionPlanConstraintType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, ActionPlanConstraintType_Names::Extern_Type_Name);
  }
  ...
  {
    ActionTypeEnum::serializeList(accessor.getActionType(), node, ActionPlanConstraintType_Names::ActionType_Name);
  }
  if (createNode) {
