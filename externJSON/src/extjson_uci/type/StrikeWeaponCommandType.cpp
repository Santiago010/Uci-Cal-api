...
bool StrikeWeaponCommandType::deserialize(const boost::property_tree::ptree& propTree, uci::type::StrikeWeaponCommandType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + StrikeWeaponCommandType_Names::SelectForKeyLoad_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setSelectForKeyLoad(extjson_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setWeaponArm(extjson_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
    } else if (valueType.first == nsPrefix + StrikeWeaponCommandType_Names::SelectForJettison_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setSelectForJettison(extjson_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
    } else if (valueType.first == nsPrefix + StrikeWeaponCommandType_Names::GenerateDynamicLAR_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setGenerateDynamicLAR(extjson_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
    } else if (valueType.first == nsPrefix + StrikeWeaponCommandType_Names::SelectForRelease_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setSelectForRelease(extjson_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
...
std::string StrikeWeaponCommandType::serialize(const uci::type::StrikeWeaponCommandType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, StrikeWeaponCommandType_Names::Extern_Type_Name);
  }
  if (accessor.isSelectForKeyLoad()) {
    extjson_uci::util::SerializationHelpers::serializeBoolean(accessor.getSelectForKeyLoad(), node, StrikeWeaponCommandType_Names::SelectForKeyLoad_Name);
    ...
    extjson_uci::util::SerializationHelpers::serializeBoolean(accessor.getWeaponArm(), node, StrikeWeaponCommandType_Names::WeaponArm_Name);
  } else if (accessor.isSelectForJettison()) {
    extjson_uci::util::SerializationHelpers::serializeBoolean(accessor.getSelectForJettison(), node, StrikeWeaponCommandType_Names::SelectForJettison_Name);
  } else if (accessor.isGenerateDynamicLAR()) {
    extjson_uci::util::SerializationHelpers::serializeBoolean(accessor.getGenerateDynamicLAR(), node, StrikeWeaponCommandType_Names::GenerateDynamicLAR_Name);
  } else if (accessor.isSelectForRelease()) {
    extjson_uci::util::SerializationHelpers::serializeBoolean(accessor.getSelectForRelease(), node, StrikeWeaponCommandType_Names::SelectForRelease_Name);
