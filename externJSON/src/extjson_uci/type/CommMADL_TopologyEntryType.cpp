...
bool CommMADL_TopologyEntryType::deserialize(const boost::property_tree::ptree& propTree, uci::type::CommMADL_TopologyEntryType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + CommMADL_TopologyEntryType_Names::MemberNodeIdentifier_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setMemberNodeIdentifier(extjson_uci::util::SerializationHelpers::deserializeUnsignedByte(*value));
      }
    } else if (valueType.first == nsPrefix + CommMADL_TopologyEntryType_Names::MemberMADL_UniqueIdentifier_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setMemberMADL_UniqueIdentifier(extjson_uci::util::SerializationHelpers::deserializeUnsignedShort(*value));
      }
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setDataCapable(extjson_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setNetTimeFineSyncAchieved(extjson_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
    } else if (valueType.first == nsPrefix + CommMADL_TopologyEntryType_Names::PathLatencyRelay_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setPathLatencyRelay(extjson_uci::util::SerializationHelpers::deserializeUnsignedByte(*value));
      }
...
std::string CommMADL_TopologyEntryType::serialize(const uci::type::CommMADL_TopologyEntryType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, CommMADL_TopologyEntryType_Names::Extern_Type_Name);
  }
  extjson_uci::util::SerializationHelpers::serializeUnsignedByte(accessor.getMemberNodeIdentifier(), node, CommMADL_TopologyEntryType_Names::MemberNodeIdentifier_Name);
  if (accessor.hasMemberMADL_UniqueIdentifier()) {
    extjson_uci::util::SerializationHelpers::serializeUnsignedShort(accessor.getMemberMADL_UniqueIdentifier(), node, CommMADL_TopologyEntryType_Names::MemberMADL_UniqueIdentifier_Name);
  }
  if (accessor.hasMemberFlightGroupIdentifier()) {
    extjson_uci::util::SerializationHelpers::serializeString(accessor.getMemberFlightGroupIdentifier(), node, CommMADL_TopologyEntryType_Names::MemberFlightGroupIdentifier_Name);
  }
  if (accessor.hasDataCapable()) {
    extjson_uci::util::SerializationHelpers::serializeBoolean(accessor.getDataCapable(), node, CommMADL_TopologyEntryType_Names::DataCapable_Name);
  }
  if (accessor.hasVoiceCapable()) {
    extjson_uci::util::SerializationHelpers::serializeBoolean(accessor.getVoiceCapable(), node, CommMADL_TopologyEntryType_Names::VoiceCapable_Name);
  }
  ...
  if (accessor.hasNetTimeFineSyncAchieved()) {
    extjson_uci::util::SerializationHelpers::serializeBoolean(accessor.getNetTimeFineSyncAchieved(), node, CommMADL_TopologyEntryType_Names::NetTimeFineSyncAchieved_Name);
  }
  if (accessor.hasPathLatencyRelay()) {
    extjson_uci::util::SerializationHelpers::serializeUnsignedByte(accessor.getPathLatencyRelay(), node, CommMADL_TopologyEntryType_Names::PathLatencyRelay_Name);
  }
  ...
  if (accessor.hasHigherDataRateCapable()) {
    extjson_uci::util::SerializationHelpers::serializeBoolean(accessor.getHigherDataRateCapable(), node, CommMADL_TopologyEntryType_Names::HigherDataRateCapable_Name);
  }
  {
