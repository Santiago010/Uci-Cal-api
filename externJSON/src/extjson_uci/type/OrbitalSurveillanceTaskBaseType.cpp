...
bool OrbitalSurveillanceTaskBaseType::deserialize(const boost::property_tree::ptree& propTree, uci::type::OrbitalSurveillanceTaskBaseType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + OrbitalSurveillanceTaskBaseType_Names::CapabilityType_Name) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setMinSize(extjson_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
...
std::string OrbitalSurveillanceTaskBaseType::serialize(const uci::type::OrbitalSurveillanceTaskBaseType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool checkIfDerivation, const bool /*topLevel*/) {
  ...
  if (!checkIfDerivation || (accessor.getAccessorType() == uci::type::accessorType::orbitalSurveillanceTaskBaseType)) {
    ...
    if (addTypeAttribute) {
      extjson_uci::util::SerializationHelpers::addTypeAttribute(node, OrbitalSurveillanceTaskBaseType_Names::Extern_Type_Name);
    }
    ...
    if (accessor.hasMinSize()) {
      extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getMinSize(), node, OrbitalSurveillanceTaskBaseType_Names::MinSize_Name);
    }
    extjson_uci::util::SerializationHelpers::serializeBoolean(accessor.getConfirmObjectAcquisition(), node, OrbitalSurveillanceTaskBaseType_Names::ConfirmObjectAcquisition_Name);
