...
bool ServiceRegistrationRequestMT::deserialize(const boost::property_tree::ptree& propTree, uci::type::ServiceRegistrationRequestMT& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + ServiceRegistrationRequestMT_Names::MessageData_Name) {
...
std::string ServiceRegistrationRequestMT::serialize(const uci::type::ServiceRegistrationRequestMT& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool topLevel) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, (topLevel ? ServiceRegistrationRequestMT_Names::Extern_Top_Type_Name : ServiceRegistrationRequestMT_Names::Extern_Type_Name));
  }
