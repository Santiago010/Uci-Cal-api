...
bool EA_TaskEscortType::deserialize(const boost::property_tree::ptree& propTree, uci::type::EA_TaskEscortType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + EA_TaskEscortType_Names::EscortedAsset_Name) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setMinDistanceOffset(extjson_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    } else if (valueType.first == nsPrefix + EA_TaskEscortType_Names::MaxDistanceOffset_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setMaxDistanceOffset(extjson_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    } else if (valueType.first == nsPrefix + EA_TaskEscortType_Names::RelativeAngleOffset_Name) {
      extjson_uci::util::DerivedTypesDeserializer::deserialize(valueType.second, accessor.enableRelativeAngleOffset(extjson_uci::util::SerializationHelpers::checkForTypeAttribute(valueType.second, nsPrefix)), nodeName, nsPrefix);
...
std::string EA_TaskEscortType::serialize(const uci::type::EA_TaskEscortType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, EA_TaskEscortType_Names::Extern_Type_Name);
  }
  {
  ...
  if (accessor.hasMinDistanceOffset()) {
    extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getMinDistanceOffset(), node, EA_TaskEscortType_Names::MinDistanceOffset_Name);
  }
  if (accessor.hasMaxDistanceOffset()) {
    extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getMaxDistanceOffset(), node, EA_TaskEscortType_Names::MaxDistanceOffset_Name);
  }
