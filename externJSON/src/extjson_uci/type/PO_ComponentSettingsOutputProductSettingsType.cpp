...
bool PO_ComponentSettingsOutputProductSettingsType::deserialize(const boost::property_tree::ptree& propTree, uci::type::PO_ComponentSettingsOutputProductSettingsType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = PO_ComponentSettingsOutputProductSettingsType_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + PO_ComponentSettingsOutputProductSettingsType_Names::ProductSettings_Name) {
...
std::string PO_ComponentSettingsOutputProductSettingsType::serialize(const uci::type::PO_ComponentSettingsOutputProductSettingsType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, PO_ComponentSettingsOutputProductSettingsType_Names::Extern_Type_Name);
  }
  if (accessor.isProductSettings()) {
    ...
    extjson_uci::util::SerializationHelpers::serializeBoolean(accessor.getAutoOutputProductSettings(), node, PO_ComponentSettingsOutputProductSettingsType_Names::AutoOutputProductSettings_Name);
  }
  if (createNode) {
