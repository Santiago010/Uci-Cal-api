...
bool ProductDisseminationGatewayType::deserialize(const boost::property_tree::ptree& propTree, uci::type::ProductDisseminationGatewayType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = ProductDisseminationGatewayType_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + ProductDisseminationGatewayType_Names::Address_Name) {
      ...
      extjson_uci::util::DerivedTypesDeserializer::deserialize(valueType.second, accessor.enableDataLinkNativeInfo(extjson_uci::util::SerializationHelpers::checkForTypeAttribute(valueType.second, nsPrefix)), nodeName, nsPrefix);
    }
  }
  return true;
}
...
std::string ProductDisseminationGatewayType::serialize(const uci::type::ProductDisseminationGatewayType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, ProductDisseminationGatewayType_Names::Extern_Type_Name);
  }
  if (accessor.hasAddress()) {
    extjson_uci::util::SerializationHelpers::serializeString(accessor.getAddress(), node, ProductDisseminationGatewayType_Names::Address_Name);
  }
