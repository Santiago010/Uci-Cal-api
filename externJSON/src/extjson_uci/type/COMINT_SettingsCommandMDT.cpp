...
bool COMINT_SettingsCommandMDT::deserialize(const boost::property_tree::ptree& propTree, uci::type::COMINT_SettingsCommandMDT& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + COMINT_SettingsCommandMDT_Names::SetAmbiguityOrdering_Name) {
...
std::string COMINT_SettingsCommandMDT::serialize(const uci::type::COMINT_SettingsCommandMDT& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, COMINT_SettingsCommandMDT_Names::Extern_Type_Name);
  }
  ...
  if (accessor.hasSpectralDensityReporting()) {
    extjson_uci::util::SerializationHelpers::serializeBoolean(accessor.getSpectralDensityReporting(), node, COMINT_SettingsCommandMDT_Names::SpectralDensityReporting_Name);
  }
  {
    ESM_MessageOutputsEnum::serializeList(accessor.getMessageOutput(), node, COMINT_SettingsCommandMDT_Names::MessageOutput_Name);
  }
  if (createNode) {
