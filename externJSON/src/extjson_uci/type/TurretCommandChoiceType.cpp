...
bool TurretCommandChoiceType::deserialize(const boost::property_tree::ptree& propTree, uci::type::TurretCommandChoiceType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + TurretCommandChoiceType_Names::FixedMode_Name) {
...
std::string TurretCommandChoiceType::serialize(const uci::type::TurretCommandChoiceType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, TurretCommandChoiceType_Names::Extern_Type_Name);
  }
