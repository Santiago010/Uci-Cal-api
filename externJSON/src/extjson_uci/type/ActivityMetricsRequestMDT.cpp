...
bool ActivityMetricsRequestMDT::deserialize(const boost::property_tree::ptree& propTree, uci::type::ActivityMetricsRequestMDT& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = ActivityMetricsRequestMDT_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + ActivityMetricsRequestMDT_Names::ActivityPlanID_Name) {
...
std::string ActivityMetricsRequestMDT::serialize(const uci::type::ActivityMetricsRequestMDT& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, ActivityMetricsRequestMDT_Names::Extern_Type_Name);
  }
  ...
  {
    ActivityPlanPartsEnum::serializeList(accessor.getActivityPlanParts(), node, ActivityMetricsRequestMDT_Names::ActivityPlanParts_Name);
  }
  if (createNode) {
