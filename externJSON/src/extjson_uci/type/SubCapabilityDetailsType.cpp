...
bool SubCapabilityDetailsType::deserialize(const boost::property_tree::ptree& propTree, uci::type::SubCapabilityDetailsType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + SubCapabilityDetailsType_Names::SelectAntenna_Name) {
...
std::string SubCapabilityDetailsType::serialize(const uci::type::SubCapabilityDetailsType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, SubCapabilityDetailsType_Names::Extern_Type_Name);
  }
