...
bool DMPI_StoreStatusType::deserialize(const boost::property_tree::ptree& propTree, uci::type::DMPI_StoreStatusType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + DMPI_StoreStatusType_Names::StoreState_Name) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setTimeOfImpact(extjson_uci::util::SerializationHelpers::deserializeDateTime(*value));
      }
    }
  }
  return true;
...
std::string DMPI_StoreStatusType::serialize(const uci::type::DMPI_StoreStatusType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, DMPI_StoreStatusType_Names::Extern_Type_Name);
  }
  ...
  if (accessor.hasReason()) {
    extjson_uci::util::SerializationHelpers::serializeString(accessor.getReason(), node, DMPI_StoreStatusType_Names::Reason_Name);
  }
  if (accessor.hasTimeOfImpact()) {
    extjson_uci::util::SerializationHelpers::serializeDateTime(accessor.getTimeOfImpact(), node, DMPI_StoreStatusType_Names::TimeOfImpact_Name);
  }
  if (createNode) {
