...
bool ObjectTypeDamageEstimateType::deserialize(const boost::property_tree::ptree& propTree, uci::type::ObjectTypeDamageEstimateType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + ObjectTypeDamageEstimateType_Names::ObjectType_Name) {
...
std::string ObjectTypeDamageEstimateType::serialize(const uci::type::ObjectTypeDamageEstimateType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, ObjectTypeDamageEstimateType_Names::Extern_Type_Name);
  }
  {
  ...
  if (accessor.hasDamageNarrative()) {
    extjson_uci::util::SerializationHelpers::serializeString(accessor.getDamageNarrative(), node, ObjectTypeDamageEstimateType_Names::DamageNarrative_Name);
  }
  if (createNode) {
