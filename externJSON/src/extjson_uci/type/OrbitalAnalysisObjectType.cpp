...
bool OrbitalAnalysisObjectType::deserialize(const boost::property_tree::ptree& propTree, uci::type::OrbitalAnalysisObjectType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + OrbitalAnalysisObjectType_Names::SpecificObject_Name) {
...
std::string OrbitalAnalysisObjectType::serialize(const uci::type::OrbitalAnalysisObjectType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, OrbitalAnalysisObjectType_Names::Extern_Type_Name);
  }
