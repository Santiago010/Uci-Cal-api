...
bool DataManagementImportExportType::deserialize(const boost::property_tree::ptree& propTree, uci::type::DataManagementImportExportType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = DataManagementImportExportType_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + DataManagementImportExportType_Names::MissionID_Name) {
...
std::string DataManagementImportExportType::serialize(const uci::type::DataManagementImportExportType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, DataManagementImportExportType_Names::Extern_Type_Name);
  }
  MissionID_Type::serialize(accessor.getMissionID(), node, DataManagementImportExportType_Names::MissionID_Name);
  extjson_uci::util::SerializationHelpers::serializeString(accessor.getWorkingPathURI(), node, DataManagementImportExportType_Names::WorkingPathURI_Name);
  if (createNode) {
