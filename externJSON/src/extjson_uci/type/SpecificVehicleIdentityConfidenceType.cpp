...
bool SpecificVehicleIdentityConfidenceType::deserialize(const boost::property_tree::ptree& propTree, uci::type::SpecificVehicleIdentityConfidenceType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = SpecificVehicleIdentityConfidenceType_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + SpecificVehicleIdentityConfidenceType_Names::Confidence_Name) {
...
std::string SpecificVehicleIdentityConfidenceType::serialize(const uci::type::SpecificVehicleIdentityConfidenceType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, SpecificVehicleIdentityConfidenceType_Names::Extern_Type_Name);
  }
  VehicleIdentificationType::serialize(accessor, node, "", false, false, false);
  extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getConfidence(), node, SpecificVehicleIdentityConfidenceType_Names::Confidence_Name);
  if (createNode) {
