...
bool ControlInterfacesCapabilityControlType::deserialize(const boost::property_tree::ptree& propTree, uci::type::ControlInterfacesCapabilityControlType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = ControlInterfacesCapabilityControlType_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + ControlInterfacesCapabilityControlType_Names::CapabilityID_Name) {
...
std::string ControlInterfacesCapabilityControlType::serialize(const uci::type::ControlInterfacesCapabilityControlType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, ControlInterfacesCapabilityControlType_Names::Extern_Type_Name);
  }
  CapabilityID_Type::serialize(accessor.getCapabilityID(), node, ControlInterfacesCapabilityControlType_Names::CapabilityID_Name);
  {
    CapabilityControlInterfacesEnum::serializeList(accessor.getAcceptedInterface(), node, ControlInterfacesCapabilityControlType_Names::AcceptedInterface_Name);
  }
  {
    ...
    for (uci::type::ControlInterfacesCapabilityControlType::CapabilityManager::size_type i = 0, end = boundedList.size(); i < end; ++i) {
      CapabilityManagerType::serialize(boundedList.at(i), node, ControlInterfacesCapabilityControlType_Names::CapabilityManager_Name);
    }
  }
  if (createNode) {
