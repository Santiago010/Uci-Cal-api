...
bool SDA_SpecialInstructionsConstraintType::deserialize(const boost::property_tree::ptree& propTree, uci::type::SDA_SpecialInstructionsConstraintType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = SDA_SpecialInstructionsConstraintType_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + SDA_SpecialInstructionsConstraintType_Names::All_Name) {
...
std::string SDA_SpecialInstructionsConstraintType::serialize(const uci::type::SDA_SpecialInstructionsConstraintType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, SDA_SpecialInstructionsConstraintType_Names::Extern_Type_Name);
  }
  if (accessor.isAll()) {
