...
bool ObservationMeasurementType::deserialize(const boost::property_tree::ptree& propTree, uci::type::ObservationMeasurementType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = ObservationMeasurementType_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + ObservationMeasurementType_Names::ObservationMeasurementID_Name) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        ...
        MeasurementType::deserialize(valueType.second, boundedList.at(boundedListSize), nodeName, nsPrefix);
      }
...
std::string ObservationMeasurementType::serialize(const uci::type::ObservationMeasurementType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, ObservationMeasurementType_Names::Extern_Type_Name);
  }
  ...
  }
  {
    ...
    for (uci::type::ObservationMeasurementType::Measurements::size_type i = 0, end = boundedList.size(); i < end; ++i) {
      MeasurementType::serialize(boundedList.at(i), node, ObservationMeasurementType_Names::Measurements_Name);
    }
  }
  {
    ...
    for (uci::type::ObservationMeasurementType::CustomCharacteristics::size_type i = 0, end = boundedList.size(); i < end; ++i) {
      NameValuePairType::serialize(boundedList.at(i), node, ObservationMeasurementType_Names::CustomCharacteristics_Name);
    }
  }
  if (createNode) {
