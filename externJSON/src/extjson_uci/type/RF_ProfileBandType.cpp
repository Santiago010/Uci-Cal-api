...
bool RF_ProfileBandType::deserialize(const boost::property_tree::ptree& propTree, uci::type::RF_ProfileBandType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + RF_ProfileBandType_Names::Frequency_Name) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setReceiveAllowed(extjson_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
    } else if (valueType.first == nsPrefix + RF_ProfileBandType_Names::TransmitAllowed_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setTransmitAllowed(extjson_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
    } else if (valueType.first == nsPrefix + RF_ProfileBandType_Names::MaximumTransmitPower_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setMaximumTransmitPower(extjson_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
...
std::string RF_ProfileBandType::serialize(const uci::type::RF_ProfileBandType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, RF_ProfileBandType_Names::Extern_Type_Name);
  }
  FrequencyRangeType::serialize(accessor.getFrequency(), node, RF_ProfileBandType_Names::Frequency_Name);
  extjson_uci::util::SerializationHelpers::serializeBoolean(accessor.getReceiveAllowed(), node, RF_ProfileBandType_Names::ReceiveAllowed_Name);
  extjson_uci::util::SerializationHelpers::serializeBoolean(accessor.getTransmitAllowed(), node, RF_ProfileBandType_Names::TransmitAllowed_Name);
  if (accessor.hasMaximumTransmitPower()) {
    extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getMaximumTransmitPower(), node, RF_ProfileBandType_Names::MaximumTransmitPower_Name);
  }
  if (accessor.hasDutyCycle()) {
    extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getDutyCycle(), node, RF_ProfileBandType_Names::DutyCycle_Name);
  }
  if (createNode) {
