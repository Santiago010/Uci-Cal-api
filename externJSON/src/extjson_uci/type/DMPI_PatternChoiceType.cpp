...
bool DMPI_PatternChoiceType::deserialize(const boost::property_tree::ptree& propTree, uci::type::DMPI_PatternChoiceType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + DMPI_PatternChoiceType_Names::XbyY_Pattern_Name) {
...
std::string DMPI_PatternChoiceType::serialize(const uci::type::DMPI_PatternChoiceType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, DMPI_PatternChoiceType_Names::Extern_Type_Name);
  }
