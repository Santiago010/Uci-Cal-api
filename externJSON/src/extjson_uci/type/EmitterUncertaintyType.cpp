...
bool EmitterUncertaintyType::deserialize(const boost::property_tree::ptree& propTree, uci::type::EmitterUncertaintyType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + EmitterUncertaintyType_Names::Uncertainty_Name) {
...
std::string EmitterUncertaintyType::serialize(const uci::type::EmitterUncertaintyType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, EmitterUncertaintyType_Names::Extern_Type_Name);
  }
  ...
  if (accessor.hasUncertaintyVertical()) {
    extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getUncertaintyVertical(), node, EmitterUncertaintyType_Names::UncertaintyVertical_Name);
  }
  if (accessor.hasUncertaintyTilt()) {
    extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getUncertaintyTilt(), node, EmitterUncertaintyType_Names::UncertaintyTilt_Name);
  }
  if (createNode) {
