...
bool AuthorizationMDT::deserialize(const boost::property_tree::ptree& propTree, uci::type::AuthorizationMDT& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + AuthorizationMDT_Names::AuthorizationID_Name) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setPrecedence(extjson_uci::util::SerializationHelpers::deserializeUnsignedInt(*value));
      }
      ...
      extjson_uci::util::DerivedTypesDeserializer::deserialize(valueType.second, accessor.enableAuthorizedArea(extjson_uci::util::SerializationHelpers::checkForTypeAttribute(valueType.second, nsPrefix)), nodeName, nsPrefix);
    }
  }
...
std::string AuthorizationMDT::serialize(const uci::type::AuthorizationMDT& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, AuthorizationMDT_Names::Extern_Type_Name);
  }
  ...
  extjson_uci::util::SerializationHelpers::serializeString(accessor.getUserIdentifier(), node, AuthorizationMDT_Names::UserIdentifier_Name);
  SystemID_Type::serialize(accessor.getSystemID(), node, AuthorizationMDT_Names::SystemID_Name);
  extjson_uci::util::SerializationHelpers::serializeUnsignedInt(accessor.getPrecedence(), node, AuthorizationMDT_Names::Precedence_Name);
