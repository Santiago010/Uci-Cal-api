...
bool MissionPlanMetricsReportMDT::deserialize(const boost::property_tree::ptree& propTree, uci::type::MissionPlanMetricsReportMDT& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + MissionPlanMetricsReportMDT_Names::MissionPlanMetricsReportID_Name) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setNumberOfReplans(extjson_uci::util::SerializationHelpers::deserializeUnsignedInt(*value));
      }
...
std::string MissionPlanMetricsReportMDT::serialize(const uci::type::MissionPlanMetricsReportMDT& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, MissionPlanMetricsReportMDT_Names::Extern_Type_Name);
  }
  ...
  extjson_uci::util::SerializationHelpers::serializeUnsignedInt(accessor.getNumberOfReplans(), node, MissionPlanMetricsReportMDT_Names::NumberOfReplans_Name);
  {
