...
bool CommUserLinkType::deserialize(const boost::property_tree::ptree& propTree, uci::type::CommUserLinkType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + CommUserLinkType_Names::UserLinkID_Name) {
...
std::string CommUserLinkType::serialize(const uci::type::CommUserLinkType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, CommUserLinkType_Names::Extern_Type_Name);
  }
