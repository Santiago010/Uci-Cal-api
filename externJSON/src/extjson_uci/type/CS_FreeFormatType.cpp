...
bool CS_FreeFormatType::deserialize(const boost::property_tree::ptree& propTree, uci::type::CS_FreeFormatType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = CS_FreeFormatType_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + CS_FreeFormatType_Names::ThreatsID_Name) {
...
std::string CS_FreeFormatType::serialize(const uci::type::CS_FreeFormatType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, CS_FreeFormatType_Names::Extern_Type_Name);
  }
