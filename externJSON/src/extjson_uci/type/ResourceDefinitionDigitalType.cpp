...
bool ResourceDefinitionDigitalType::deserialize(const boost::property_tree::ptree& propTree, uci::type::ResourceDefinitionDigitalType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + ResourceDefinitionDigitalType_Names::ResourceRequestOptionIndex_Name) {
      ...
      extjson_uci::util::SerializationHelpers::deserializeUnsignedIntList(valueType.second, accessor.getStreamIndex());
    } else if (valueType.first == nsPrefix + ResourceDefinitionDigitalType_Names::VAS_Endpoint_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setVAS_Endpoint(extjson_uci::util::SerializationHelpers::deserializeUnsignedInt(*value));
      }
...
std::string ResourceDefinitionDigitalType::serialize(const uci::type::ResourceDefinitionDigitalType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, ResourceDefinitionDigitalType_Names::Extern_Type_Name);
  }
  extjson_uci::util::SerializationHelpers::serializeUnsignedInt(accessor.getResourceRequestOptionIndex(), node, ResourceDefinitionDigitalType_Names::ResourceRequestOptionIndex_Name);
  {
    extjson_uci::util::SerializationHelpers::serializeUnsignedIntList(accessor.getStreamIndex(), node, ResourceDefinitionDigitalType_Names::StreamIndex_Name);
  }
  if (accessor.hasVAS_Endpoint()) {
    extjson_uci::util::SerializationHelpers::serializeUnsignedInt(accessor.getVAS_Endpoint(), node, ResourceDefinitionDigitalType_Names::VAS_Endpoint_Name);
  }
