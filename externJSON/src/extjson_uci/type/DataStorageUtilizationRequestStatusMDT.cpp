...
bool DataStorageUtilizationRequestStatusMDT::deserialize(const boost::property_tree::ptree& propTree, uci::type::DataStorageUtilizationRequestStatusMDT& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = DataStorageUtilizationRequestStatusMDT_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + DataStorageUtilizationRequestStatusMDT_Names::StorageDetail_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        ...
        StorageDetailType::deserialize(valueType.second, boundedList.at(boundedListSize), nodeName, nsPrefix);
      }
...
std::string DataStorageUtilizationRequestStatusMDT::serialize(const uci::type::DataStorageUtilizationRequestStatusMDT& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, DataStorageUtilizationRequestStatusMDT_Names::Extern_Type_Name);
  }
  RequestStatusBaseType::serialize(accessor, node, "", false, false, false);
  {
    ...
    for (uci::type::DataStorageUtilizationRequestStatusMDT::StorageDetail::size_type i = 0, end = boundedList.size(); i < end; ++i) {
      StorageDetailType::serialize(boundedList.at(i), node, DataStorageUtilizationRequestStatusMDT_Names::StorageDetail_Name);
    }
  }
