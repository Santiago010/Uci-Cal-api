...
bool IID2_ChoiceType::deserialize(const boost::property_tree::ptree& propTree, uci::type::IID2_ChoiceType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + IID2_ChoiceType_Names::NonIPON_IID2_Name) {
...
std::string IID2_ChoiceType::serialize(const uci::type::IID2_ChoiceType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, IID2_ChoiceType_Names::Extern_Type_Name);
  }
  if (accessor.isNonIPON_IID2()) {
    extjson_uci::util::SerializationHelpers::serializeString(accessor.getNonIPON_IID2(), node, IID2_ChoiceType_Names::NonIPON_IID2_Name);
