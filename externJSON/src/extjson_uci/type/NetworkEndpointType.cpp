...
bool NetworkEndpointType::deserialize(const boost::property_tree::ptree& propTree, uci::type::NetworkEndpointType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = NetworkEndpointType_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + NetworkEndpointType_Names::IPv4_Endpoint_Name) {
...
std::string NetworkEndpointType::serialize(const uci::type::NetworkEndpointType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, NetworkEndpointType_Names::Extern_Type_Name);
  }
