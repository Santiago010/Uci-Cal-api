...
bool ProductMetadataMDT::deserialize(const boost::property_tree::ptree& propTree, uci::type::ProductMetadataMDT& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + ProductMetadataMDT_Names::ProductMetadataID_Name) {
      ...
      extjson_uci::util::DerivedTypesDeserializer::deserialize(valueType.second, accessor.enableProductDescription(extjson_uci::util::SerializationHelpers::checkForTypeAttribute(valueType.second, nsPrefix)), nodeName, nsPrefix);
      ...
      extjson_uci::util::DerivedTypesDeserializer::deserialize(valueType.second, accessor.enableSceneKey(extjson_uci::util::SerializationHelpers::checkForTypeAttribute(valueType.second, nsPrefix)), nodeName, nsPrefix);
...
std::string ProductMetadataMDT::serialize(const uci::type::ProductMetadataMDT& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, ProductMetadataMDT_Names::Extern_Type_Name);
  }
  ...
  if (accessor.hasFileName()) {
    extjson_uci::util::SerializationHelpers::serializeString(accessor.getFileName(), node, ProductMetadataMDT_Names::FileName_Name);
  }
  ...
  extjson_uci::util::SerializationHelpers::serializeBoolean(accessor.getUntrustedModification(), node, ProductMetadataMDT_Names::UntrustedModification_Name);
  extjson_uci::util::SerializationHelpers::serializeDateTime(accessor.getTimestamp(), node, ProductMetadataMDT_Names::Timestamp_Name);
  ...
  if (accessor.hasSHA_2_Hash()) {
    extjson_uci::util::SerializationHelpers::serializeHexBinary(accessor.getSHA_2_Hash(), node, ProductMetadataMDT_Names::SHA_2_Hash_Name);
  }
