...
bool AssessmentMDT::deserialize(const boost::property_tree::ptree& propTree, uci::type::AssessmentMDT& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + AssessmentMDT_Names::AssessmentID_Name) {
...
std::string AssessmentMDT::serialize(const uci::type::AssessmentMDT& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, AssessmentMDT_Names::Extern_Type_Name);
  }
