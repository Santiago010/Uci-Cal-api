...
bool TurretReportMDT::deserialize(const boost::property_tree::ptree& propTree, uci::type::TurretReportMDT& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + TurretReportMDT_Names::TurretReportID_Name) {
...
std::string TurretReportMDT::serialize(const uci::type::TurretReportMDT& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, TurretReportMDT_Names::Extern_Type_Name);
  }
