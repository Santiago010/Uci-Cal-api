...
bool CoordinatedRequirementSetID_Type::deserialize(const boost::property_tree::ptree& propTree, uci::type::CoordinatedRequirementSetID_Type& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
...
std::string CoordinatedRequirementSetID_Type::serialize(const uci::type::CoordinatedRequirementSetID_Type& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, CoordinatedRequirementSetID_Type_Names::Extern_Type_Name);
  }
