...
bool WorkingSOB_SourceID_ChoiceType::deserialize(const boost::property_tree::ptree& propTree, uci::type::WorkingSOB_SourceID_ChoiceType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = WorkingSOB_SourceID_ChoiceType_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + WorkingSOB_SourceID_ChoiceType_Names::SystemID_Name) {
...
std::string WorkingSOB_SourceID_ChoiceType::serialize(const uci::type::WorkingSOB_SourceID_ChoiceType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, WorkingSOB_SourceID_ChoiceType_Names::Extern_Type_Name);
  }
