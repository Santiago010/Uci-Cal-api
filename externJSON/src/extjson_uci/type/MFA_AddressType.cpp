...
bool MFA_AddressType::deserialize(const boost::property_tree::ptree& propTree, uci::type::MFA_AddressType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + MFA_AddressType_Names::MFA_SupportCapabilityID_Name) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setOnAntennaProcessingIndex(extjson_uci::util::SerializationHelpers::deserializeUnsignedInt(*value));
      }
...
std::string MFA_AddressType::serialize(const uci::type::MFA_AddressType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, MFA_AddressType_Names::Extern_Type_Name);
  }
  ...
  if (accessor.hasOnAntennaProcessingIndex()) {
    extjson_uci::util::SerializationHelpers::serializeUnsignedInt(accessor.getOnAntennaProcessingIndex(), node, MFA_AddressType_Names::OnAntennaProcessingIndex_Name);
  }
  if (accessor.hasDeltaInputPowerConsumption()) {
    extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getDeltaInputPowerConsumption(), node, MFA_AddressType_Names::DeltaInputPowerConsumption_Name);
  }
  if (createNode) {
