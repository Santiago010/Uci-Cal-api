...
bool StrikeTaskMetricsTargetingType::deserialize(const boost::property_tree::ptree& propTree, uci::type::StrikeTaskMetricsTargetingType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = StrikeTaskMetricsTargetingType_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + StrikeTaskMetricsTargetingType_Names::Quality_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setQuality(extjson_uci::util::SerializationHelpers::deserializeFloat(*value));
      }
...
std::string StrikeTaskMetricsTargetingType::serialize(const uci::type::StrikeTaskMetricsTargetingType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, StrikeTaskMetricsTargetingType_Names::Extern_Type_Name);
  }
  if (accessor.isQuality()) {
    extjson_uci::util::SerializationHelpers::serializeFloat(accessor.getQuality(), node, StrikeTaskMetricsTargetingType_Names::Quality_Name);
