...
bool ESM_SubcapabilityTargetLocationDataType::deserialize(const boost::property_tree::ptree& propTree, uci::type::ESM_SubcapabilityTargetLocationDataType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = ESM_SubcapabilityTargetLocationDataType_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + ESM_SubcapabilityTargetLocationDataType_Names::EntityID_Name) {
...
std::string ESM_SubcapabilityTargetLocationDataType::serialize(const uci::type::ESM_SubcapabilityTargetLocationDataType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, ESM_SubcapabilityTargetLocationDataType_Names::Extern_Type_Name);
  }
