...
bool COMINT_SubcapabilityAcquisitionType::deserialize(const boost::property_tree::ptree& propTree, uci::type::COMINT_SubcapabilityAcquisitionType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + COMINT_SubcapabilityAcquisitionType_Names::TargetEmitterData_Name) {
...
std::string COMINT_SubcapabilityAcquisitionType::serialize(const uci::type::COMINT_SubcapabilityAcquisitionType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, COMINT_SubcapabilityAcquisitionType_Names::Extern_Type_Name);
  }
