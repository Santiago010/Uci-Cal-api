...
bool BlueVehicleType::deserialize(const boost::property_tree::ptree& propTree, uci::type::BlueVehicleType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = BlueVehicleType_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + BlueVehicleType_Names::EntityIdentity_Name) {
      extjson_uci::util::DerivedTypesDeserializer::deserialize(valueType.second, accessor.chooseEntityIdentity(extjson_uci::util::SerializationHelpers::checkForTypeAttribute(valueType.second, nsPrefix)), nodeName, nsPrefix);
...
std::string BlueVehicleType::serialize(const uci::type::BlueVehicleType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, BlueVehicleType_Names::Extern_Type_Name);
  }
  if (accessor.isEntityIdentity()) {
    ...
    extjson_uci::util::SerializationHelpers::serializeString(accessor.getModel(), node, BlueVehicleType_Names::Model_Name);
  }
  if (createNode) {
