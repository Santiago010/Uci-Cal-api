...
bool AssessmentType::deserialize(const boost::property_tree::ptree& propTree, uci::type::AssessmentType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + AssessmentType_Names::CommPointingPlan_Name) {
...
std::string AssessmentType::serialize(const uci::type::AssessmentType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, AssessmentType_Names::Extern_Type_Name);
  }
