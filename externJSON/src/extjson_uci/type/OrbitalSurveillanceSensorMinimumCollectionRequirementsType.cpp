...
bool OrbitalSurveillanceSensorMinimumCollectionRequirementsType::deserialize(const boost::property_tree::ptree& propTree, uci::type::OrbitalSurveillanceSensorMinimumCollectionRequirementsType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = OrbitalSurveillanceSensorMinimumCollectionRequirementsType_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + OrbitalSurveillanceSensorMinimumCollectionRequirementsType_Names::TargetRotationalPeriods_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setTargetRotationalPeriods(extjson_uci::util::SerializationHelpers::deserializeInt(*value));
      }
...
std::string OrbitalSurveillanceSensorMinimumCollectionRequirementsType::serialize(const uci::type::OrbitalSurveillanceSensorMinimumCollectionRequirementsType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, OrbitalSurveillanceSensorMinimumCollectionRequirementsType_Names::Extern_Type_Name);
  }
  if (accessor.isTargetRotationalPeriods()) {
    extjson_uci::util::SerializationHelpers::serializeInt(accessor.getTargetRotationalPeriods(), node, OrbitalSurveillanceSensorMinimumCollectionRequirementsType_Names::TargetRotationalPeriods_Name);
  } else if (accessor.isTime()) {
    extjson_uci::util::SerializationHelpers::serializeDuration(accessor.getTime(), node, OrbitalSurveillanceSensorMinimumCollectionRequirementsType_Names::Time_Name);
  }
  if (createNode) {
