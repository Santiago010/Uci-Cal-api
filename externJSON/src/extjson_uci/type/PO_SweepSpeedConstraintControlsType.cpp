...
bool PO_SweepSpeedConstraintControlsType::deserialize(const boost::property_tree::ptree& propTree, uci::type::PO_SweepSpeedConstraintControlsType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = PO_SweepSpeedConstraintControlsType_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + PO_SweepSpeedConstraintControlsType_Names::Controls_Name) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setSetting(extjson_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    }
  }
  return true;
...
std::string PO_SweepSpeedConstraintControlsType::serialize(const uci::type::PO_SweepSpeedConstraintControlsType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, PO_SweepSpeedConstraintControlsType_Names::Extern_Type_Name);
  }
  if (accessor.isControls()) {
    ...
    extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getSetting(), node, PO_SweepSpeedConstraintControlsType_Names::Setting_Name);
  }
  if (createNode) {
