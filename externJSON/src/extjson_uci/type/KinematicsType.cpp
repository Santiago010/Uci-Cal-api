...
bool KinematicsType::deserialize(const boost::property_tree::ptree& propTree, uci::type::KinematicsType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + KinematicsType_Names::KinematicsTimeStamp_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setKinematicsTimeStamp(extjson_uci::util::SerializationHelpers::deserializeDateTime(*value));
      }
...
std::string KinematicsType::serialize(const uci::type::KinematicsType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, KinematicsType_Names::Extern_Type_Name);
  }
  if (accessor.hasKinematicsTimeStamp()) {
    extjson_uci::util::SerializationHelpers::serializeDateTime(accessor.getKinematicsTimeStamp(), node, KinematicsType_Names::KinematicsTimeStamp_Name);
  }
