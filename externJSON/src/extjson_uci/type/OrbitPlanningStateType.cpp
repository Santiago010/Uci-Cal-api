...
bool OrbitPlanningStateType::deserialize(const boost::property_tree::ptree& propTree, uci::type::OrbitPlanningStateType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = OrbitPlanningStateType_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + OrbitPlanningStateType_Names::Time_Name) {
...
std::string OrbitPlanningStateType::serialize(const uci::type::OrbitPlanningStateType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, OrbitPlanningStateType_Names::Extern_Type_Name);
  }
  if (accessor.hasTime()) {
    extjson_uci::util::SerializationHelpers::serializeDateTime(accessor.getTime(), node, OrbitPlanningStateType_Names::Time_Name);
  }
