...
bool SensorReferencedCoverageAreaType::deserialize(const boost::property_tree::ptree& propTree, uci::type::SensorReferencedCoverageAreaType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + SensorReferencedCoverageAreaType_Names::Reference_Name) {
...
std::string SensorReferencedCoverageAreaType::serialize(const uci::type::SensorReferencedCoverageAreaType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, SensorReferencedCoverageAreaType_Names::Extern_Type_Name);
  }
