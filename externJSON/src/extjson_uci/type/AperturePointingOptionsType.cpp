...
bool AperturePointingOptionsType::deserialize(const boost::property_tree::ptree& propTree, uci::type::AperturePointingOptionsType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + AperturePointingOptionsType_Names::FieldOfRegard_Name) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setInstallationIndex(extjson_uci::util::SerializationHelpers::deserializeUnsignedInt(*value));
      }
      ...
      extjson_uci::util::DerivedTypesDeserializer::deserialize(valueType.second, accessor.chooseRequestEntityReferenceID(extjson_uci::util::SerializationHelpers::checkForTypeAttribute(valueType.second, nsPrefix)), nodeName, nsPrefix);
    }
  }
  return true;
}
...
std::string AperturePointingOptionsType::serialize(const uci::type::AperturePointingOptionsType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, AperturePointingOptionsType_Names::Extern_Type_Name);
  }
  if (accessor.isFieldOfRegard()) {
    ...
    extjson_uci::util::SerializationHelpers::serializeUnsignedInt(accessor.getInstallationIndex(), node, AperturePointingOptionsType_Names::InstallationIndex_Name);
