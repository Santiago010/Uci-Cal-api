...
bool GatewayLink16ConfigurationSlaveType::deserialize(const boost::property_tree::ptree& propTree, uci::type::GatewayLink16ConfigurationSlaveType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + GatewayLink16ConfigurationSlaveType_Names::EntityID_Name) {
...
std::string GatewayLink16ConfigurationSlaveType::serialize(const uci::type::GatewayLink16ConfigurationSlaveType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, GatewayLink16ConfigurationSlaveType_Names::Extern_Type_Name);
  }
