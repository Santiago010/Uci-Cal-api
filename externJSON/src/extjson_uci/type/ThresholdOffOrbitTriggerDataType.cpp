...
bool ThresholdOffOrbitTriggerDataType::deserialize(const boost::property_tree::ptree& propTree, uci::type::ThresholdOffOrbitTriggerDataType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + ThresholdOffOrbitTriggerDataType_Names::PositionErrorThreshold_Name) {
...
std::string ThresholdOffOrbitTriggerDataType::serialize(const uci::type::ThresholdOffOrbitTriggerDataType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, ThresholdOffOrbitTriggerDataType_Names::Extern_Type_Name);
  }
