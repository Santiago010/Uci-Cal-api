...
bool CommIFDL_NetLinkStatusType::deserialize(const boost::property_tree::ptree& propTree, uci::type::CommIFDL_NetLinkStatusType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + CommIFDL_NetLinkStatusType_Names::NetworkLinkID_Name) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setPeerFlightIdentifier(extjson_uci::util::SerializationHelpers::deserializeUnsignedShort(*value));
      }
    } else if (valueType.first == nsPrefix + CommIFDL_NetLinkStatusType_Names::PeerFlightPosition_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setPeerFlightPosition(extjson_uci::util::SerializationHelpers::deserializeUnsignedByte(*value));
      }
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setMaxRangeApproached(extjson_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
    }
  }
  return true;
...
std::string CommIFDL_NetLinkStatusType::serialize(const uci::type::CommIFDL_NetLinkStatusType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, CommIFDL_NetLinkStatusType_Names::Extern_Type_Name);
  }
  NetworkLinkID_Type::serialize(accessor.getNetworkLinkID(), node, CommIFDL_NetLinkStatusType_Names::NetworkLinkID_Name);
  extjson_uci::util::SerializationHelpers::serializeUnsignedShort(accessor.getPeerFlightIdentifier(), node, CommIFDL_NetLinkStatusType_Names::PeerFlightIdentifier_Name);
  extjson_uci::util::SerializationHelpers::serializeUnsignedByte(accessor.getPeerFlightPosition(), node, CommIFDL_NetLinkStatusType_Names::PeerFlightPosition_Name);
  ...
  if (accessor.hasMaxRangeApproached()) {
    extjson_uci::util::SerializationHelpers::serializeBoolean(accessor.getMaxRangeApproached(), node, CommIFDL_NetLinkStatusType_Names::MaxRangeApproached_Name);
  }
  if (createNode) {
