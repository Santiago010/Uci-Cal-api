...
bool SystemOrbitalPositionReportMDT::deserialize(const boost::property_tree::ptree& propTree, uci::type::SystemOrbitalPositionReportMDT& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + SystemOrbitalPositionReportMDT_Names::SystemID_Name) {
...
std::string SystemOrbitalPositionReportMDT::serialize(const uci::type::SystemOrbitalPositionReportMDT& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, SystemOrbitalPositionReportMDT_Names::Extern_Type_Name);
  }
  ...
  if (accessor.hasDisplayName()) {
    extjson_uci::util::SerializationHelpers::serializeString(accessor.getDisplayName(), node, SystemOrbitalPositionReportMDT_Names::DisplayName_Name);
  }
