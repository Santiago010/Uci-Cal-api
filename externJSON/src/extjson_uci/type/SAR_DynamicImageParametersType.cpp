...
bool SAR_DynamicImageParametersType::deserialize(const boost::property_tree::ptree& propTree, uci::type::SAR_DynamicImageParametersType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = SAR_DynamicImageParametersType_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + SAR_DynamicImageParametersType_Names::NumSubApertures_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setNumSubApertures(extjson_uci::util::SerializationHelpers::deserializeUnsignedByte(*value));
      }
    } else if (valueType.first == nsPrefix + SAR_DynamicImageParametersType_Names::PercentAperture_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setPercentAperture(extjson_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    } else if (valueType.first == nsPrefix + SAR_DynamicImageParametersType_Names::ResampleFactor_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setResampleFactor(extjson_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    } else if (valueType.first == nsPrefix + SAR_DynamicImageParametersType_Names::EqualizeResolution_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setEqualizeResolution(extjson_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
...
std::string SAR_DynamicImageParametersType::serialize(const uci::type::SAR_DynamicImageParametersType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, SAR_DynamicImageParametersType_Names::Extern_Type_Name);
  }
  SAR_ProcessingParametersType::serialize(accessor, node, "", false, false, false);
  extjson_uci::util::SerializationHelpers::serializeUnsignedByte(accessor.getNumSubApertures(), node, SAR_DynamicImageParametersType_Names::NumSubApertures_Name);
  extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getPercentAperture(), node, SAR_DynamicImageParametersType_Names::PercentAperture_Name);
  extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getResampleFactor(), node, SAR_DynamicImageParametersType_Names::ResampleFactor_Name);
  extjson_uci::util::SerializationHelpers::serializeBoolean(accessor.getEqualizeResolution(), node, SAR_DynamicImageParametersType_Names::EqualizeResolution_Name);
