...
bool StoreManagementCommandMDT::deserialize(const boost::property_tree::ptree& propTree, uci::type::StoreManagementCommandMDT& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = StoreManagementCommandMDT_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + StoreManagementCommandMDT_Names::Command_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        ...
        StoreManagementCommandType::deserialize(valueType.second, boundedList.at(boundedListSize), nodeName, nsPrefix);
      }
    }
  }
  return true;
...
std::string StoreManagementCommandMDT::serialize(const uci::type::StoreManagementCommandMDT& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, StoreManagementCommandMDT_Names::Extern_Type_Name);
  }
  {
    ...
    for (uci::type::StoreManagementCommandMDT::Command::size_type i = 0, end = boundedList.size(); i < end; ++i) {
      StoreManagementCommandType::serialize(boundedList.at(i), node, StoreManagementCommandMDT_Names::Command_Name);
    }
  }
  if (createNode) {
