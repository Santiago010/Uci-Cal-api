...
bool SystemEstimationStopType::deserialize(const boost::property_tree::ptree& propTree, uci::type::SystemEstimationStopType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + SystemEstimationStopType_Names::Time_Name) {
...
std::string SystemEstimationStopType::serialize(const uci::type::SystemEstimationStopType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, SystemEstimationStopType_Names::Extern_Type_Name);
  }
  if (accessor.isTime()) {
    extjson_uci::util::SerializationHelpers::serializeDateTime(accessor.getTime(), node, SystemEstimationStopType_Names::Time_Name);
