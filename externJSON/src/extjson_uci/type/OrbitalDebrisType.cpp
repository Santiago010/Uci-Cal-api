...
bool OrbitalDebrisType::deserialize(const boost::property_tree::ptree& propTree, uci::type::OrbitalDebrisType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + OrbitalDebrisType_Names::OrbitalDebrisID_Name) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setSize(extjson_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    }
  }
  return true;
...
std::string OrbitalDebrisType::serialize(const uci::type::OrbitalDebrisType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, OrbitalDebrisType_Names::Extern_Type_Name);
  }
  ...
  if (accessor.hasMass()) {
    extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getMass(), node, OrbitalDebrisType_Names::Mass_Name);
  }
  if (accessor.hasSize()) {
    extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getSize(), node, OrbitalDebrisType_Names::Size_Name);
  }
  if (createNode) {
