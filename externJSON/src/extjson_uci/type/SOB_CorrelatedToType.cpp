...
bool SOB_CorrelatedToType::deserialize(const boost::property_tree::ptree& propTree, uci::type::SOB_CorrelatedToType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + SOB_CorrelatedToType_Names::SOB_SatelliteRecordID_Name) {
...
std::string SOB_CorrelatedToType::serialize(const uci::type::SOB_CorrelatedToType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, SOB_CorrelatedToType_Names::Extern_Type_Name);
  }
