...
bool IPv6_SettingsType::deserialize(const boost::property_tree::ptree& propTree, uci::type::IPv6_SettingsType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + IPv6_SettingsType_Names::StaticIP_Address_Name) {
...
std::string IPv6_SettingsType::serialize(const uci::type::IPv6_SettingsType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, IPv6_SettingsType_Names::Extern_Type_Name);
  }
  ...
  if (accessor.hasPortNumber()) {
    extjson_uci::util::SerializationHelpers::serializeInt(accessor.getPortNumber(), node, IPv6_SettingsType_Names::PortNumber_Name);
  }
  if (createNode) {
