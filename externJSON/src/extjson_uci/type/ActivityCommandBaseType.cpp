...
bool ActivityCommandBaseType::deserialize(const boost::property_tree::ptree& propTree, uci::type::ActivityCommandBaseType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = ActivityCommandBaseType_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + ActivityCommandBaseType_Names::ActivityID_Name) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setDeleteActivity(extjson_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
    } else if (valueType.first == nsPrefix + ActivityCommandBaseType_Names::UnassignActivity_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setUnassignActivity(extjson_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
    }
  }
...
std::string ActivityCommandBaseType::serialize(const uci::type::ActivityCommandBaseType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool checkIfDerivation, const bool /*topLevel*/) {
  ...
  if (!checkIfDerivation || (accessor.getAccessorType() == uci::type::accessorType::activityCommandBaseType)) {
    ...
    if (addTypeAttribute) {
      extjson_uci::util::SerializationHelpers::addTypeAttribute(node, ActivityCommandBaseType_Names::Extern_Type_Name);
    }
    ...
    if (accessor.hasDeleteActivity()) {
      extjson_uci::util::SerializationHelpers::serializeBoolean(accessor.getDeleteActivity(), node, ActivityCommandBaseType_Names::DeleteActivity_Name);
    }
    if (accessor.hasUnassignActivity()) {
      extjson_uci::util::SerializationHelpers::serializeBoolean(accessor.getUnassignActivity(), node, ActivityCommandBaseType_Names::UnassignActivity_Name);
    }
    if (createNode) {
