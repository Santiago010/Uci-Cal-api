...
bool PlanningByResultTriggerType::deserialize(const boost::property_tree::ptree& propTree, uci::type::PlanningByResultTriggerType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + PlanningByResultTriggerType_Names::ReplanRequired_Name) {
      PlanTypeEnum::deserializeList(valueType.second, accessor.getReplanRequired());
      ...
      extjson_uci::util::DerivedTypesDeserializer::deserialize(valueType.second, accessor.chooseRequirementUnallocated(extjson_uci::util::SerializationHelpers::checkForTypeAttribute(valueType.second, nsPrefix)), nodeName, nsPrefix);
    }
  }
  return true;
}
...
std::string PlanningByResultTriggerType::serialize(const uci::type::PlanningByResultTriggerType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, PlanningByResultTriggerType_Names::Extern_Type_Name);
  }
  if (accessor.isReplanRequired()) {
    {
      PlanTypeEnum::serializeList(accessor.getReplanRequired(), node, PlanningByResultTriggerType_Names::ReplanRequired_Name);
    }
