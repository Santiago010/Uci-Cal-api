...
bool ExecutionSequenceReplaceOrModifyChoiceType::deserialize(const boost::property_tree::ptree& propTree, uci::type::ExecutionSequenceReplaceOrModifyChoiceType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + ExecutionSequenceReplaceOrModifyChoiceType_Names::ReplaceExecutionSequence_Name) {
...
std::string ExecutionSequenceReplaceOrModifyChoiceType::serialize(const uci::type::ExecutionSequenceReplaceOrModifyChoiceType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, ExecutionSequenceReplaceOrModifyChoiceType_Names::Extern_Type_Name);
  }
