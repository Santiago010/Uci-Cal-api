...
bool RadarAltimeterCapabilityStatusMDT::deserialize(const boost::property_tree::ptree& propTree, uci::type::RadarAltimeterCapabilityStatusMDT& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = RadarAltimeterCapabilityStatusMDT_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + RadarAltimeterCapabilityStatusMDT_Names::CapabilityStatus_Name) {
...
std::string RadarAltimeterCapabilityStatusMDT::serialize(const uci::type::RadarAltimeterCapabilityStatusMDT& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, RadarAltimeterCapabilityStatusMDT_Names::Extern_Type_Name);
  }
  CapabilityStatusBaseType::serialize(accessor, node, "", false, false, false);
  {
    ...
    for (uci::type::RadarAltimeterCapabilityStatusMDT::CapabilityStatus::size_type i = 0, end = boundedList.size(); i < end; ++i) {
      CapabilityStatusType::serialize(boundedList.at(i), node, RadarAltimeterCapabilityStatusMDT_Names::CapabilityStatus_Name);
    }
  }
  {
    ...
    for (uci::type::RadarAltimeterCapabilityStatusMDT::RF_Profile::size_type i = 0, end = boundedList.size(); i < end; ++i) {
      RF_ProfileType::serialize(boundedList.at(i), node, RadarAltimeterCapabilityStatusMDT_Names::RF_Profile_Name);
    }
  }
  ...
  {
    RadarAltimeterMessageOutputsEnum::serializeList(accessor.getMessageOutput(), node, RadarAltimeterCapabilityStatusMDT_Names::MessageOutput_Name);
  }
  {
    ...
    for (uci::type::RadarAltimeterCapabilityStatusMDT::ElectronicProtectionOptionsEnabled::size_type i = 0, end = boundedList.size(); i < end; ++i) {
      ElectronicProtectionOptionsEnabledType::serialize(boundedList.at(i), node, RadarAltimeterCapabilityStatusMDT_Names::ElectronicProtectionOptionsEnabled_Name);
    }
  }
  if (createNode) {
