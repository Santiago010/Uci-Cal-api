...
bool ServiceConfigurationParamsDataRequestMDT::deserialize(const boost::property_tree::ptree& propTree, uci::type::ServiceConfigurationParamsDataRequestMDT& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = ServiceConfigurationParamsDataRequestMDT_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + ServiceConfigurationParamsDataRequestMDT_Names::ResultsInNativeMessage_Name) {
...
std::string ServiceConfigurationParamsDataRequestMDT::serialize(const uci::type::ServiceConfigurationParamsDataRequestMDT& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, ServiceConfigurationParamsDataRequestMDT_Names::Extern_Type_Name);
  }
  RequestBaseType::serialize(accessor, node, "", false, false, false);
  extjson_uci::util::SerializationHelpers::serializeBoolean(accessor.getResultsInNativeMessage(), node, ServiceConfigurationParamsDataRequestMDT_Names::ResultsInNativeMessage_Name);
  ...
  if (accessor.hasCategory()) {
    extjson_uci::util::SerializationHelpers::serializeString(accessor.getCategory(), node, ServiceConfigurationParamsDataRequestMDT_Names::Category_Name);
  }
  if (createNode) {
