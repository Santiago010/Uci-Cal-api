...
bool BeamShapingType::deserialize(const boost::property_tree::ptree& propTree, uci::type::BeamShapingType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + BeamShapingType_Names::BeamWeighting_Name) {
...
std::string BeamShapingType::serialize(const uci::type::BeamShapingType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, BeamShapingType_Names::Extern_Type_Name);
  }
