...
bool UnitVectorType::deserialize(const boost::property_tree::ptree& propTree, uci::type::UnitVectorType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = UnitVectorType_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + UnitVectorType_Names::X_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setX(extjson_uci::util::SerializationHelpers::deserializeFloat(*value));
      }
    } else if (valueType.first == nsPrefix + UnitVectorType_Names::Y_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setY(extjson_uci::util::SerializationHelpers::deserializeFloat(*value));
      }
    } else if (valueType.first == nsPrefix + UnitVectorType_Names::Z_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setZ(extjson_uci::util::SerializationHelpers::deserializeFloat(*value));
      }
    }
  }
  return true;
...
std::string UnitVectorType::serialize(const uci::type::UnitVectorType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool checkIfDerivation, const bool /*topLevel*/) {
  ...
  if (!checkIfDerivation || (accessor.getAccessorType() == uci::type::accessorType::unitVectorType)) {
    ...
    if (addTypeAttribute) {
      extjson_uci::util::SerializationHelpers::addTypeAttribute(node, UnitVectorType_Names::Extern_Type_Name);
    }
    extjson_uci::util::SerializationHelpers::serializeFloat(accessor.getX(), node, UnitVectorType_Names::X_Name);
    extjson_uci::util::SerializationHelpers::serializeFloat(accessor.getY(), node, UnitVectorType_Names::Y_Name);
    extjson_uci::util::SerializationHelpers::serializeFloat(accessor.getZ(), node, UnitVectorType_Names::Z_Name);
    if (createNode) {
