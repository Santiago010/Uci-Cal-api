...
bool GatewayActivityType::deserialize(const boost::property_tree::ptree& propTree, uci::type::GatewayActivityType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + GatewayActivityType_Names::ConnectionStatus_Name) {
...
std::string GatewayActivityType::serialize(const uci::type::GatewayActivityType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, GatewayActivityType_Names::Extern_Type_Name);
  }
