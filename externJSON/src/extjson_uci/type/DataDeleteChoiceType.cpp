...
bool DataDeleteChoiceType::deserialize(const boost::property_tree::ptree& propTree, uci::type::DataDeleteChoiceType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + DataDeleteChoiceType_Names::ProductMetadataID_Name) {
...
std::string DataDeleteChoiceType::serialize(const uci::type::DataDeleteChoiceType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, DataDeleteChoiceType_Names::Extern_Type_Name);
  }
