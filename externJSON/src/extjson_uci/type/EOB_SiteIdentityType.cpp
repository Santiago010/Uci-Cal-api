...
bool EOB_SiteIdentityType::deserialize(const boost::property_tree::ptree& propTree, uci::type::EOB_SiteIdentityType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = EOB_SiteIdentityType_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + EOB_SiteIdentityType_Names::BE_Number_Name) {
...
std::string EOB_SiteIdentityType::serialize(const uci::type::EOB_SiteIdentityType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, EOB_SiteIdentityType_Names::Extern_Type_Name);
  }
  ...
  if (accessor.hasO_Suffix()) {
    extjson_uci::util::SerializationHelpers::serializeString(accessor.getO_Suffix(), node, EOB_SiteIdentityType_Names::O_Suffix_Name);
  }
  if (accessor.hasCategory()) {
    extjson_uci::util::SerializationHelpers::serializeString(accessor.getCategory(), node, EOB_SiteIdentityType_Names::Category_Name);
  }
  if (createNode) {
