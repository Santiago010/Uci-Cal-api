...
bool RFD_GainSettingType::deserialize(const boost::property_tree::ptree& propTree, uci::type::RFD_GainSettingType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = RFD_GainSettingType_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + RFD_GainSettingType_Names::GainRange_Name) {
      ...
      extjson_uci::util::SerializationHelpers::deserializeStringList(valueType.second, accessor.getValidGainSettings());
    }
  }
  return true;
}
...
std::string RFD_GainSettingType::serialize(const uci::type::RFD_GainSettingType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, RFD_GainSettingType_Names::Extern_Type_Name);
  }
  if (accessor.isGainRange()) {
    ...
    {
      extjson_uci::util::SerializationHelpers::serializeStringList(accessor.getValidGainSettings(), node, RFD_GainSettingType_Names::ValidGainSettings_Name);
    }
  }
  if (createNode) {
