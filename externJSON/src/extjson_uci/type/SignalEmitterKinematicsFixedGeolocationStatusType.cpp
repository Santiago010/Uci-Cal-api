...
bool SignalEmitterKinematicsFixedGeolocationStatusType::deserialize(const boost::property_tree::ptree& propTree, uci::type::SignalEmitterKinematicsFixedGeolocationStatusType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + SignalEmitterKinematicsFixedGeolocationStatusType_Names::GeolocationMethod_Name) {
...
std::string SignalEmitterKinematicsFixedGeolocationStatusType::serialize(const uci::type::SignalEmitterKinematicsFixedGeolocationStatusType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, SignalEmitterKinematicsFixedGeolocationStatusType_Names::Extern_Type_Name);
  }
