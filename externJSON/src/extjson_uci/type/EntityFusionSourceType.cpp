...
bool EntityFusionSourceType::deserialize(const boost::property_tree::ptree& propTree, uci::type::EntityFusionSourceType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + EntityFusionSourceType_Names::Contributor_Name) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setFusionContributor(extjson_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
    } else if (valueType.first == nsPrefix + EntityFusionSourceType_Names::ProbabilityOfCorrectAssociation_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setProbabilityOfCorrectAssociation(extjson_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
...
std::string EntityFusionSourceType::serialize(const uci::type::EntityFusionSourceType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, EntityFusionSourceType_Names::Extern_Type_Name);
  }
  EntityContributorID_ChoiceType::serialize(accessor.getContributor(), node, EntityFusionSourceType_Names::Contributor_Name);
  extjson_uci::util::SerializationHelpers::serializeBoolean(accessor.getFusionContributor(), node, EntityFusionSourceType_Names::FusionContributor_Name);
  extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getProbabilityOfCorrectAssociation(), node, EntityFusionSourceType_Names::ProbabilityOfCorrectAssociation_Name);
  ...
  if (accessor.hasTimestamp()) {
    extjson_uci::util::SerializationHelpers::serializeDateTime(accessor.getTimestamp(), node, EntityFusionSourceType_Names::Timestamp_Name);
  }
  if (createNode) {
