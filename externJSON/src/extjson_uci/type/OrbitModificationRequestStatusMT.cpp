...
bool OrbitModificationRequestStatusMT::deserialize(const boost::property_tree::ptree& propTree, uci::type::OrbitModificationRequestStatusMT& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + OrbitModificationRequestStatusMT_Names::MessageData_Name) {
...
std::string OrbitModificationRequestStatusMT::serialize(const uci::type::OrbitModificationRequestStatusMT& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool topLevel) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, (topLevel ? OrbitModificationRequestStatusMT_Names::Extern_Top_Type_Name : OrbitModificationRequestStatusMT_Names::Extern_Type_Name));
  }
