...
bool COMINT_CapabilityOptionsType::deserialize(const boost::property_tree::ptree& propTree, uci::type::COMINT_CapabilityOptionsType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + COMINT_CapabilityOptionsType_Names::InterruptOtherActivities_Name) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setNumberOfChannels(extjson_uci::util::SerializationHelpers::deserializeInt(*value));
      }
    } else if (valueType.first == nsPrefix + COMINT_CapabilityOptionsType_Names::AGC_Supported_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setAGC_Supported(extjson_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
    } else if (valueType.first == nsPrefix + COMINT_CapabilityOptionsType_Names::ArchiveAvailable_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setArchiveAvailable(extjson_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setScanSupport(extjson_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
    } else if (valueType.first == nsPrefix + COMINT_CapabilityOptionsType_Names::SupportedModes_Name) {
      extjson_uci::util::DerivedTypesDeserializer::deserialize(valueType.second, accessor.enableSupportedModes(extjson_uci::util::SerializationHelpers::checkForTypeAttribute(valueType.second, nsPrefix)), nodeName, nsPrefix);
    } else if (valueType.first == nsPrefix + COMINT_CapabilityOptionsType_Names::AudioFormats_Name) {
      extjson_uci::util::SerializationHelpers::deserializeStringList(valueType.second, accessor.getAudioFormats());
...
std::string COMINT_CapabilityOptionsType::serialize(const uci::type::COMINT_CapabilityOptionsType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, COMINT_CapabilityOptionsType_Names::Extern_Type_Name);
  }
  extjson_uci::util::SerializationHelpers::serializeBoolean(accessor.getInterruptOtherActivities(), node, COMINT_CapabilityOptionsType_Names::InterruptOtherActivities_Name);
  if (accessor.hasNumberOfChannels()) {
    extjson_uci::util::SerializationHelpers::serializeInt(accessor.getNumberOfChannels(), node, COMINT_CapabilityOptionsType_Names::NumberOfChannels_Name);
  }
  if (accessor.hasAGC_Supported()) {
    extjson_uci::util::SerializationHelpers::serializeBoolean(accessor.getAGC_Supported(), node, COMINT_CapabilityOptionsType_Names::AGC_Supported_Name);
  }
  if (accessor.hasArchiveAvailable()) {
    extjson_uci::util::SerializationHelpers::serializeBoolean(accessor.getArchiveAvailable(), node, COMINT_CapabilityOptionsType_Names::ArchiveAvailable_Name);
  }
  ...
  if (accessor.hasScanSupport()) {
    extjson_uci::util::SerializationHelpers::serializeBoolean(accessor.getScanSupport(), node, COMINT_CapabilityOptionsType_Names::ScanSupport_Name);
  }
  ...
  {
    extjson_uci::util::SerializationHelpers::serializeStringList(accessor.getAudioFormats(), node, COMINT_CapabilityOptionsType_Names::AudioFormats_Name);
  }
  {
