...
bool TurretCommandPositionType::deserialize(const boost::property_tree::ptree& propTree, uci::type::TurretCommandPositionType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + TurretCommandPositionType_Names::Azimuth_Name) {
...
std::string TurretCommandPositionType::serialize(const uci::type::TurretCommandPositionType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, TurretCommandPositionType_Names::Extern_Type_Name);
  }
  extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getAzimuth(), node, TurretCommandPositionType_Names::Azimuth_Name);
  extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getElevation(), node, TurretCommandPositionType_Names::Elevation_Name);
