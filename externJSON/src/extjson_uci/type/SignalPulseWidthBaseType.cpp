...
bool SignalPulseWidthBaseType::deserialize(const boost::property_tree::ptree& propTree, uci::type::SignalPulseWidthBaseType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + SignalPulseWidthBaseType_Names::PulseWidthAverage_Name) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setPulseWidthLast(extjson_uci::util::SerializationHelpers::deserializeDuration(*value));
      }
...
std::string SignalPulseWidthBaseType::serialize(const uci::type::SignalPulseWidthBaseType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool checkIfDerivation, const bool /*topLevel*/) {
  ...
  if (!checkIfDerivation || (accessor.getAccessorType() == uci::type::accessorType::signalPulseWidthBaseType)) {
    ...
    if (addTypeAttribute) {
      extjson_uci::util::SerializationHelpers::addTypeAttribute(node, SignalPulseWidthBaseType_Names::Extern_Type_Name);
    }
    if (accessor.hasPulseWidthAverage()) {
      extjson_uci::util::SerializationHelpers::serializeDuration(accessor.getPulseWidthAverage(), node, SignalPulseWidthBaseType_Names::PulseWidthAverage_Name);
    }
    if (accessor.hasPulseWidthMin()) {
      extjson_uci::util::SerializationHelpers::serializeDuration(accessor.getPulseWidthMin(), node, SignalPulseWidthBaseType_Names::PulseWidthMin_Name);
    }
    if (accessor.hasPulseWidthMax()) {
      extjson_uci::util::SerializationHelpers::serializeDuration(accessor.getPulseWidthMax(), node, SignalPulseWidthBaseType_Names::PulseWidthMax_Name);
    }
    if (accessor.hasPulseWidthLast()) {
      extjson_uci::util::SerializationHelpers::serializeDuration(accessor.getPulseWidthLast(), node, SignalPulseWidthBaseType_Names::PulseWidthLast_Name);
    }
    if (accessor.hasPulseWidthDeviation()) {
      extjson_uci::util::SerializationHelpers::serializeDuration(accessor.getPulseWidthDeviation(), node, SignalPulseWidthBaseType_Names::PulseWidthDeviation_Name);
    }
    if (createNode) {
