...
bool FGI_SourceOpenChoiceType::deserialize(const boost::property_tree::ptree& propTree, uci::type::FGI_SourceOpenChoiceType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + FGI_SourceOpenChoiceType_Names::ForeignGovernmentIdentifier_Name) {
...
std::string FGI_SourceOpenChoiceType::serialize(const uci::type::FGI_SourceOpenChoiceType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, FGI_SourceOpenChoiceType_Names::Extern_Type_Name);
  }
  if (accessor.isForeignGovernmentIdentifier()) {
    ...
    extjson_uci::util::SerializationHelpers::serializeString(accessor.getNATO_SpecialWord(), node, FGI_SourceOpenChoiceType_Names::NATO_SpecialWord_Name);
  }
  if (createNode) {
