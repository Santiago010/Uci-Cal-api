...
bool RadarAltimeterActivityPredictedActivityDetailType::deserialize(const boost::property_tree::ptree& propTree, uci::type::RadarAltimeterActivityPredictedActivityDetailType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + RadarAltimeterActivityPredictedActivityDetailType_Names::ActivityState_Name) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setEstimatedPercentageInFOV(extjson_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
...
std::string RadarAltimeterActivityPredictedActivityDetailType::serialize(const uci::type::RadarAltimeterActivityPredictedActivityDetailType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, RadarAltimeterActivityPredictedActivityDetailType_Names::Extern_Type_Name);
  }
  ...
  if (accessor.hasEstimatedRevisitPeriod()) {
    extjson_uci::util::SerializationHelpers::serializeDuration(accessor.getEstimatedRevisitPeriod(), node, RadarAltimeterActivityPredictedActivityDetailType_Names::EstimatedRevisitPeriod_Name);
  }
  if (accessor.hasEstimatedPercentageInFOV()) {
    extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getEstimatedPercentageInFOV(), node, RadarAltimeterActivityPredictedActivityDetailType_Names::EstimatedPercentageInFOV_Name);
  }
  if (accessor.hasEstimatedStartTime()) {
    extjson_uci::util::SerializationHelpers::serializeDateTime(accessor.getEstimatedStartTime(), node, RadarAltimeterActivityPredictedActivityDetailType_Names::EstimatedStartTime_Name);
  }
  if (accessor.hasEstimatedStopTime()) {
    extjson_uci::util::SerializationHelpers::serializeDateTime(accessor.getEstimatedStopTime(), node, RadarAltimeterActivityPredictedActivityDetailType_Names::EstimatedStopTime_Name);
  }
  if (accessor.hasEstimatedERP()) {
    extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getEstimatedERP(), node, RadarAltimeterActivityPredictedActivityDetailType_Names::EstimatedERP_Name);
  }
  ...
  extjson_uci::util::SerializationHelpers::serializeBoolean(accessor.getConcurrentExecutionAssumed(), node, RadarAltimeterActivityPredictedActivityDetailType_Names::ConcurrentExecutionAssumed_Name);
  if (createNode) {
