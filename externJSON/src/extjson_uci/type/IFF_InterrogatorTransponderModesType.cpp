...
bool IFF_InterrogatorTransponderModesType::deserialize(const boost::property_tree::ptree& propTree, uci::type::IFF_InterrogatorTransponderModesType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + IFF_InterrogatorTransponderModesType_Names::TransponderModesControl_Name) {
      extjson_uci::util::DerivedTypesDeserializer::deserialize(valueType.second, accessor.chooseTransponderModesControl(extjson_uci::util::SerializationHelpers::checkForTypeAttribute(valueType.second, nsPrefix)), nodeName, nsPrefix);
...
std::string IFF_InterrogatorTransponderModesType::serialize(const uci::type::IFF_InterrogatorTransponderModesType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, IFF_InterrogatorTransponderModesType_Names::Extern_Type_Name);
  }
