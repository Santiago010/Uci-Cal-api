...
bool EOB_EmitterModeType::deserialize(const boost::property_tree::ptree& propTree, uci::type::EOB_EmitterModeType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = EOB_EmitterModeType_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + EOB_EmitterModeType_Names::EmitterModeID_Name) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setInterceptCount(extjson_uci::util::SerializationHelpers::deserializeUnsignedInt(*value));
      }
    } else if (valueType.first == nsPrefix + EOB_EmitterModeType_Names::DataRate_Name) {
      extjson_uci::util::DerivedTypesDeserializer::deserialize(valueType.second, accessor.enableDataRate(extjson_uci::util::SerializationHelpers::checkForTypeAttribute(valueType.second, nsPrefix)), nodeName, nsPrefix);
...
std::string EOB_EmitterModeType::serialize(const uci::type::EOB_EmitterModeType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, EOB_EmitterModeType_Names::Extern_Type_Name);
  }
  ...
  if (accessor.hasInterceptCount()) {
    extjson_uci::util::SerializationHelpers::serializeUnsignedInt(accessor.getInterceptCount(), node, EOB_EmitterModeType_Names::InterceptCount_Name);
  }
