...
bool SECTGA_Type::deserialize(const boost::property_tree::ptree& propTree, uci::type::SECTGA_Type& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = SECTGA_Type_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + SECTGA_Type_Names::SEC_Identifier_Name) {
...
std::string SECTGA_Type::serialize(const uci::type::SECTGA_Type& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, SECTGA_Type_Names::Extern_Type_Name);
  }
  if (accessor.hasSEC_Identifier()) {
    extjson_uci::util::SerializationHelpers::serializeString(accessor.getSEC_Identifier(), node, SECTGA_Type_Names::SEC_Identifier_Name);
  }
  if (accessor.hasSEC_BE()) {
    extjson_uci::util::SerializationHelpers::serializeString(accessor.getSEC_BE(), node, SECTGA_Type_Names::SEC_BE_Name);
  }
  if (createNode) {
