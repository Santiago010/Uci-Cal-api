...
bool SecurityAuditRecordMDT::deserialize(const boost::property_tree::ptree& propTree, uci::type::SecurityAuditRecordMDT& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + SecurityAuditRecordMDT_Names::SecurityAuditRecordID_Name) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setEventTimestamp(extjson_uci::util::SerializationHelpers::deserializeDateTime(*value));
      }
...
std::string SecurityAuditRecordMDT::serialize(const uci::type::SecurityAuditRecordMDT& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, SecurityAuditRecordMDT_Names::Extern_Type_Name);
  }
  ...
  extjson_uci::util::SerializationHelpers::serializeDateTime(accessor.getEventTimestamp(), node, SecurityAuditRecordMDT_Names::EventTimestamp_Name);
