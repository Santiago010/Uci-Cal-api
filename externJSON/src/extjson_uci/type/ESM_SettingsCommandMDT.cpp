...
bool ESM_SettingsCommandMDT::deserialize(const boost::property_tree::ptree& propTree, uci::type::ESM_SettingsCommandMDT& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + ESM_SettingsCommandMDT_Names::SetAmbiguityOrdering_Name) {
...
std::string ESM_SettingsCommandMDT::serialize(const uci::type::ESM_SettingsCommandMDT& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, ESM_SettingsCommandMDT_Names::Extern_Type_Name);
  }
  ...
  if (accessor.hasRWR_AudioEnable()) {
    extjson_uci::util::SerializationHelpers::serializeBoolean(accessor.getRWR_AudioEnable(), node, ESM_SettingsCommandMDT_Names::RWR_AudioEnable_Name);
  }
  if (accessor.hasSpectralDensityReporting()) {
    extjson_uci::util::SerializationHelpers::serializeBoolean(accessor.getSpectralDensityReporting(), node, ESM_SettingsCommandMDT_Names::SpectralDensityReporting_Name);
  }
  ...
  {
    ESM_MessageOutputsEnum::serializeList(accessor.getMessageOutput(), node, ESM_SettingsCommandMDT_Names::MessageOutput_Name);
  }
  {
