...
bool SubsystemCompletedBIT_ItemType::deserialize(const boost::property_tree::ptree& propTree, uci::type::SubsystemCompletedBIT_ItemType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = SubsystemCompletedBIT_ItemType_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + SubsystemCompletedBIT_ItemType_Names::BIT_ItemName_Name) {
...
std::string SubsystemCompletedBIT_ItemType::serialize(const uci::type::SubsystemCompletedBIT_ItemType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, SubsystemCompletedBIT_ItemType_Names::Extern_Type_Name);
  }
  extjson_uci::util::SerializationHelpers::serializeString(accessor.getBIT_ItemName(), node, SubsystemCompletedBIT_ItemType_Names::BIT_ItemName_Name);
  ...
  if (accessor.hasFailReason()) {
    extjson_uci::util::SerializationHelpers::serializeString(accessor.getFailReason(), node, SubsystemCompletedBIT_ItemType_Names::FailReason_Name);
  }
  if (createNode) {
