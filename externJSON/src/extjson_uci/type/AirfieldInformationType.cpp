...
bool AirfieldInformationType::deserialize(const boost::property_tree::ptree& propTree, uci::type::AirfieldInformationType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + AirfieldInformationType_Names::ICAO_Code_Name) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setQNH_Setting(extjson_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    }
  }
  return true;
...
std::string AirfieldInformationType::serialize(const uci::type::AirfieldInformationType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, AirfieldInformationType_Names::Extern_Type_Name);
  }
  if (accessor.hasICAO_Code()) {
    extjson_uci::util::SerializationHelpers::serializeString(accessor.getICAO_Code(), node, AirfieldInformationType_Names::ICAO_Code_Name);
  }
  if (accessor.hasOperational()) {
    extjson_uci::util::SerializationHelpers::serializeString(accessor.getOperational(), node, AirfieldInformationType_Names::Operational_Name);
  }
  ...
  if (accessor.hasSHORADEZ_Active()) {
    extjson_uci::util::SerializationHelpers::serializeString(accessor.getSHORADEZ_Active(), node, AirfieldInformationType_Names::SHORADEZ_Active_Name);
  }
  {
  ...
  if (accessor.hasQNH_Setting()) {
    extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getQNH_Setting(), node, AirfieldInformationType_Names::QNH_Setting_Name);
  }
  if (createNode) {
