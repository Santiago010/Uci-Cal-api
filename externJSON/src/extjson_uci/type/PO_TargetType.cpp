...
bool PO_TargetType::deserialize(const boost::property_tree::ptree& propTree, uci::type::PO_TargetType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + PO_TargetType_Names::Geospatial_Name) {
...
std::string PO_TargetType::serialize(const uci::type::PO_TargetType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, PO_TargetType_Names::Extern_Type_Name);
  }
  if (accessor.isGeospatial()) {
    ...
    extjson_uci::util::SerializationHelpers::serializeString(accessor.getTurretSlaved(), node, PO_TargetType_Names::TurretSlaved_Name);
