...
bool NavigationReportMDT::deserialize(const boost::property_tree::ptree& propTree, uci::type::NavigationReportMDT& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + NavigationReportMDT_Names::SystemID_Name) {
...
std::string NavigationReportMDT::serialize(const uci::type::NavigationReportMDT& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, NavigationReportMDT_Names::Extern_Type_Name);
  }
