...
bool ResponsePlanConstraintType::deserialize(const boost::property_tree::ptree& propTree, uci::type::ResponsePlanConstraintType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = ResponsePlanConstraintType_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + ResponsePlanConstraintType_Names::ResponsePlanID_Name) {
...
std::string ResponsePlanConstraintType::serialize(const uci::type::ResponsePlanConstraintType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, ResponsePlanConstraintType_Names::Extern_Type_Name);
  }
  ...
  {
    ResponseTypeEnum::serializeList(accessor.getResponseType(), node, ResponsePlanConstraintType_Names::ResponseType_Name);
  }
  if (createNode) {
