...
bool ImpactConditionsType::deserialize(const boost::property_tree::ptree& propTree, uci::type::ImpactConditionsType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + ImpactConditionsType_Names::Fuze_Name) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setSpinRate(extjson_uci::util::SerializationHelpers::deserializeUnsignedInt(*value));
      }
    }
  }
  return true;
...
std::string ImpactConditionsType::serialize(const uci::type::ImpactConditionsType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, ImpactConditionsType_Names::Extern_Type_Name);
  }
  {
  ...
  if (accessor.hasImpactSpeed()) {
    extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getImpactSpeed(), node, ImpactConditionsType_Names::ImpactSpeed_Name);
  }
  ...
  if (accessor.hasSpinRate()) {
    extjson_uci::util::SerializationHelpers::serializeUnsignedInt(accessor.getSpinRate(), node, ImpactConditionsType_Names::SpinRate_Name);
  }
  if (createNode) {
