...
bool ProductDisseminationStatusType::deserialize(const boost::property_tree::ptree& propTree, uci::type::ProductDisseminationStatusType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + ProductDisseminationStatusType_Names::Product_Name) {
...
std::string ProductDisseminationStatusType::serialize(const uci::type::ProductDisseminationStatusType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, ProductDisseminationStatusType_Names::Extern_Type_Name);
  }
  ...
  if (accessor.hasStatusDetails()) {
    extjson_uci::util::SerializationHelpers::serializeString(accessor.getStatusDetails(), node, ProductDisseminationStatusType_Names::StatusDetails_Name);
  }
  if (accessor.hasEstimatedCompletionTime()) {
    extjson_uci::util::SerializationHelpers::serializeDateTime(accessor.getEstimatedCompletionTime(), node, ProductDisseminationStatusType_Names::EstimatedCompletionTime_Name);
  }
  if (accessor.hasEstimatedPercentComplete()) {
    extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getEstimatedPercentComplete(), node, ProductDisseminationStatusType_Names::EstimatedPercentComplete_Name);
  }
  if (createNode) {
