...
bool TagAssociationTargetType::deserialize(const boost::property_tree::ptree& propTree, uci::type::TagAssociationTargetType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = TagAssociationTargetType_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + TagAssociationTargetType_Names::ByMessage_Name) {
...
std::string TagAssociationTargetType::serialize(const uci::type::TagAssociationTargetType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, TagAssociationTargetType_Names::Extern_Type_Name);
  }
