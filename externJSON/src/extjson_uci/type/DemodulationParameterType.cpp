...
bool DemodulationParameterType::deserialize(const boost::property_tree::ptree& propTree, uci::type::DemodulationParameterType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = DemodulationParameterType_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + DemodulationParameterType_Names::DemodulationUsed_Name) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setAudioAmplitude(extjson_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
    } else if (valueType.first == nsPrefix + DemodulationParameterType_Names::ChannelBandwidth_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setChannelBandwidth(extjson_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
...
std::string DemodulationParameterType::serialize(const uci::type::DemodulationParameterType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, DemodulationParameterType_Names::Extern_Type_Name);
  }
  ...
  if (accessor.hasAudioAmplitude()) {
    extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getAudioAmplitude(), node, DemodulationParameterType_Names::AudioAmplitude_Name);
  }
  if (accessor.hasChannelBandwidth()) {
    extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getChannelBandwidth(), node, DemodulationParameterType_Names::ChannelBandwidth_Name);
  }
