...
bool ESM_ProfileEntryType::deserialize(const boost::property_tree::ptree& propTree, uci::type::ESM_ProfileEntryType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + ESM_ProfileEntryType_Names::EmitterEntry_Name) {
...
std::string ESM_ProfileEntryType::serialize(const uci::type::ESM_ProfileEntryType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, ESM_ProfileEntryType_Names::Extern_Type_Name);
  }
  {
  ...
  if (accessor.hasEmitterPriorityBin()) {
    extjson_uci::util::SerializationHelpers::serializeUnsignedInt(accessor.getEmitterPriorityBin(), node, ESM_ProfileEntryType_Names::EmitterPriorityBin_Name);
  }
