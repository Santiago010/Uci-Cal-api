...
bool LaunchStaticDetailsType::deserialize(const boost::property_tree::ptree& propTree, uci::type::LaunchStaticDetailsType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + LaunchStaticDetailsType_Names::LaunchTime_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setLaunchTime(extjson_uci::util::SerializationHelpers::deserializeDateTime(*value));
      }
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setLaunchAzimuth(extjson_uci::util::SerializationHelpers::deserializeDouble(*value));
      }
...
std::string LaunchStaticDetailsType::serialize(const uci::type::LaunchStaticDetailsType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, LaunchStaticDetailsType_Names::Extern_Type_Name);
  }
  if (accessor.hasLaunchTime()) {
    extjson_uci::util::SerializationHelpers::serializeDateTime(accessor.getLaunchTime(), node, LaunchStaticDetailsType_Names::LaunchTime_Name);
  }
  ...
  if (accessor.hasLaunchAzimuth()) {
    extjson_uci::util::SerializationHelpers::serializeDouble(accessor.getLaunchAzimuth(), node, LaunchStaticDetailsType_Names::LaunchAzimuth_Name);
  }
