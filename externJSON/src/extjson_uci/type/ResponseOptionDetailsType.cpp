...
bool ResponseOptionDetailsType::deserialize(const boost::property_tree::ptree& propTree, uci::type::ResponseOptionDetailsType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + ResponseOptionDetailsType_Names::OptionIndex_Name) {
      ...
      extjson_uci::util::DerivedTypesDeserializer::deserialize(valueType.second, accessor.enableObjective(extjson_uci::util::SerializationHelpers::checkForTypeAttribute(valueType.second, nsPrefix)), nodeName, nsPrefix);
    } else if (valueType.first == nsPrefix + ResponseOptionDetailsType_Names::ContinueEvaluation_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setContinueEvaluation(extjson_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
...
std::string ResponseOptionDetailsType::serialize(const uci::type::ResponseOptionDetailsType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, ResponseOptionDetailsType_Names::Extern_Type_Name);
  }
  extjson_uci::util::SerializationHelpers::serializeUnsignedInt(accessor.getOptionIndex(), node, ResponseOptionDetailsType_Names::OptionIndex_Name);
  if (accessor.hasDescriptiveLabel()) {
    extjson_uci::util::SerializationHelpers::serializeString(accessor.getDescriptiveLabel(), node, ResponseOptionDetailsType_Names::DescriptiveLabel_Name);
  }
  ...
  extjson_uci::util::SerializationHelpers::serializeBoolean(accessor.getContinueEvaluation(), node, ResponseOptionDetailsType_Names::ContinueEvaluation_Name);
  extjson_uci::util::SerializationHelpers::serializeBoolean(accessor.getEnabled(), node, ResponseOptionDetailsType_Names::Enabled_Name);
