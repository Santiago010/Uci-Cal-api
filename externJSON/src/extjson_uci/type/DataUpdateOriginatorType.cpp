...
bool DataUpdateOriginatorType::deserialize(const boost::property_tree::ptree& propTree, uci::type::DataUpdateOriginatorType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = DataUpdateOriginatorType_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + DataUpdateOriginatorType_Names::All_Producers_Name) {
...
std::string DataUpdateOriginatorType::serialize(const uci::type::DataUpdateOriginatorType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, DataUpdateOriginatorType_Names::Extern_Type_Name);
  }
  if (accessor.isAll_Producers()) {
    extjson_uci::util::SerializationHelpers::serializeString(accessor.getAll_Producers(), node, DataUpdateOriginatorType_Names::All_Producers_Name);
