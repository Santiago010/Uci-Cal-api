...
bool RSO_ApproachType::deserialize(const boost::property_tree::ptree& propTree, uci::type::RSO_ApproachType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + RSO_ApproachType_Names::RSO_Name) {
...
std::string RSO_ApproachType::serialize(const uci::type::RSO_ApproachType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool checkIfDerivation, const bool /*topLevel*/) {
  ...
  if (!checkIfDerivation || (accessor.getAccessorType() == uci::type::accessorType::rSO_ApproachType)) {
    ...
    if (addTypeAttribute) {
      extjson_uci::util::SerializationHelpers::addTypeAttribute(node, RSO_ApproachType_Names::Extern_Type_Name);
    }
