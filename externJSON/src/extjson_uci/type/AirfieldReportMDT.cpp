...
bool AirfieldReportMDT::deserialize(const boost::property_tree::ptree& propTree, uci::type::AirfieldReportMDT& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + AirfieldReportMDT_Names::AirfieldReportID_Name) {
...
std::string AirfieldReportMDT::serialize(const uci::type::AirfieldReportMDT& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, AirfieldReportMDT_Names::Extern_Type_Name);
  }
  ...
  extjson_uci::util::SerializationHelpers::serializeDateTime(accessor.getObservationTime(), node, AirfieldReportMDT_Names::ObservationTime_Name);
