...
bool RefuelCapabilityDrogueCommandType::deserialize(const boost::property_tree::ptree& propTree, uci::type::RefuelCapabilityDrogueCommandType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = RefuelCapabilityDrogueCommandType_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + RefuelCapabilityDrogueCommandType_Names::ResetReferencePressure_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setResetReferencePressure(extjson_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
    } else if (valueType.first == nsPrefix + RefuelCapabilityDrogueCommandType_Names::ResetDeliveredFuel_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setResetDeliveredFuel(extjson_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
    } else if (valueType.first == nsPrefix + RefuelCapabilityDrogueCommandType_Names::ResetMissionFuel_Name) {
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setResetMissionFuel(extjson_uci::util::SerializationHelpers::deserializeBoolean(*value));
      }
...
std::string RefuelCapabilityDrogueCommandType::serialize(const uci::type::RefuelCapabilityDrogueCommandType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, RefuelCapabilityDrogueCommandType_Names::Extern_Type_Name);
  }
  RefuelCapabilityDrogueCommonType::serialize(accessor, node, "", false, false, false);
  if (accessor.hasResetReferencePressure()) {
    extjson_uci::util::SerializationHelpers::serializeBoolean(accessor.getResetReferencePressure(), node, RefuelCapabilityDrogueCommandType_Names::ResetReferencePressure_Name);
  }
  if (accessor.hasResetDeliveredFuel()) {
    extjson_uci::util::SerializationHelpers::serializeBoolean(accessor.getResetDeliveredFuel(), node, RefuelCapabilityDrogueCommandType_Names::ResetDeliveredFuel_Name);
  }
  if (accessor.hasResetMissionFuel()) {
    extjson_uci::util::SerializationHelpers::serializeBoolean(accessor.getResetMissionFuel(), node, RefuelCapabilityDrogueCommandType_Names::ResetMissionFuel_Name);
  }
