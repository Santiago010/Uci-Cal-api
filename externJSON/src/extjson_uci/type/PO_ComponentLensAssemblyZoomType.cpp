...
bool PO_ComponentLensAssemblyZoomType::deserialize(const boost::property_tree::ptree& propTree, uci::type::PO_ComponentLensAssemblyZoomType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + PO_ComponentLensAssemblyZoomType_Names::IncrementalZoom_Name) {
...
std::string PO_ComponentLensAssemblyZoomType::serialize(const uci::type::PO_ComponentLensAssemblyZoomType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, PO_ComponentLensAssemblyZoomType_Names::Extern_Type_Name);
  }
