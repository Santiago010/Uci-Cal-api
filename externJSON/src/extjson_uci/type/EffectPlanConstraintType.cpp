...
bool EffectPlanConstraintType::deserialize(const boost::property_tree::ptree& propTree, uci::type::EffectPlanConstraintType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + EffectPlanConstraintType_Names::EffectPlanID_Name) {
...
std::string EffectPlanConstraintType::serialize(const uci::type::EffectPlanConstraintType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, EffectPlanConstraintType_Names::Extern_Type_Name);
  }
  ...
  {
    EffectTypeEnum::serializeList(accessor.getEffectType(), node, EffectPlanConstraintType_Names::EffectType_Name);
  }
  if (createNode) {
