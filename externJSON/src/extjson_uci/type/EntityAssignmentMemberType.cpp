...
bool EntityAssignmentMemberType::deserialize(const boost::property_tree::ptree& propTree, uci::type::EntityAssignmentMemberType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = EntityAssignmentMemberType_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + EntityAssignmentMemberType_Names::EntityID_Name) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setTrackIndex(extjson_uci::util::SerializationHelpers::deserializeUnsignedByte(*value));
      }
    }
  }
  return true;
...
std::string EntityAssignmentMemberType::serialize(const uci::type::EntityAssignmentMemberType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, EntityAssignmentMemberType_Names::Extern_Type_Name);
  }
  EntityID_Type::serialize(accessor.getEntityID(), node, EntityAssignmentMemberType_Names::EntityID_Name);
  extjson_uci::util::SerializationHelpers::serializeUnsignedByte(accessor.getTrackIndex(), node, EntityAssignmentMemberType_Names::TrackIndex_Name);
  if (createNode) {
