...
bool ProductDownloadReportMT::deserialize(const boost::property_tree::ptree& propTree, uci::type::ProductDownloadReportMT& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + ProductDownloadReportMT_Names::ObjectState_Name) {
...
std::string ProductDownloadReportMT::serialize(const uci::type::ProductDownloadReportMT& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool topLevel) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, (topLevel ? ProductDownloadReportMT_Names::Extern_Top_Type_Name : ProductDownloadReportMT_Names::Extern_Type_Name));
  }
