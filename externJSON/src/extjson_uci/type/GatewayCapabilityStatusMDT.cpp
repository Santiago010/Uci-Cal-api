...
bool GatewayCapabilityStatusMDT::deserialize(const boost::property_tree::ptree& propTree, uci::type::GatewayCapabilityStatusMDT& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = GatewayCapabilityStatusMDT_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + GatewayCapabilityStatusMDT_Names::GatewayServiceID_Name) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        ...
        GatewayCapabilityStatusType::deserialize(valueType.second, boundedList.at(boundedListSize), nodeName, nsPrefix);
      }
...
std::string GatewayCapabilityStatusMDT::serialize(const uci::type::GatewayCapabilityStatusMDT& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, GatewayCapabilityStatusMDT_Names::Extern_Type_Name);
  }
  ...
  ServiceID_Type::serialize(accessor.getGatewayServiceID(), node, GatewayCapabilityStatusMDT_Names::GatewayServiceID_Name);
  {
    ...
    for (uci::type::GatewayCapabilityStatusMDT::CapabilityStatus::size_type i = 0, end = boundedList.size(); i < end; ++i) {
      GatewayCapabilityStatusType::serialize(boundedList.at(i), node, GatewayCapabilityStatusMDT_Names::CapabilityStatus_Name);
    }
  }
