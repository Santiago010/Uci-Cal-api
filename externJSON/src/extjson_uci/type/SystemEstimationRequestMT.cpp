...
bool SystemEstimationRequestMT::deserialize(const boost::property_tree::ptree& propTree, uci::type::SystemEstimationRequestMT& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + SystemEstimationRequestMT_Names::MessageData_Name) {
...
std::string SystemEstimationRequestMT::serialize(const uci::type::SystemEstimationRequestMT& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool topLevel) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, (topLevel ? SystemEstimationRequestMT_Names::Extern_Top_Type_Name : SystemEstimationRequestMT_Names::Extern_Type_Name));
  }
