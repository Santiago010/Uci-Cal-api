...
bool DLZ_MDT::deserialize(const boost::property_tree::ptree& propTree, uci::type::DLZ_MDT& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + DLZ_MDT_Names::DLZ_ID_Name) {
...
std::string DLZ_MDT::serialize(const uci::type::DLZ_MDT& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, DLZ_MDT_Names::Extern_Type_Name);
  }
  ...
  extjson_uci::util::SerializationHelpers::serializeBoolean(accessor.getGeneratedByWeapon(), node, DLZ_MDT_Names::GeneratedByWeapon_Name);
