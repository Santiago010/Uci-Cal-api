...
bool CommRangeDelayChoiceType::deserialize(const boost::property_tree::ptree& propTree, uci::type::CommRangeDelayChoiceType& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  ...
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + CommRangeDelayChoiceType_Names::Active_Name) {
      ...
      if (const boost::optional<std::string> value = valueType.second.get_value_optional<std::string>()) {
        accessor.setPassive(extjson_uci::util::SerializationHelpers::deserializeDuration(*value));
      }
    }
  }
  return true;
...
std::string CommRangeDelayChoiceType::serialize(const uci::type::CommRangeDelayChoiceType& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, CommRangeDelayChoiceType_Names::Extern_Type_Name);
  }
  if (accessor.isActive()) {
    extjson_uci::util::SerializationHelpers::serializeString(accessor.getActive(), node, CommRangeDelayChoiceType_Names::Active_Name);
  } else if (accessor.isPassive()) {
    extjson_uci::util::SerializationHelpers::serializeDuration(accessor.getPassive(), node, CommRangeDelayChoiceType_Names::Passive_Name);
  }
  if (createNode) {
