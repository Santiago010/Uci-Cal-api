...
bool ACFTB_RevA_Type::deserialize(const boost::property_tree::ptree& propTree, uci::type::ACFTB_RevA_Type& accessor, std::string& nodeName, std::string& nsPrefix, const bool topLevel) {
  nodeName = ACFTB_RevA_Type_Names::Extern_Type_Name;
  const boost::property_tree::ptree& node = (topLevel ? propTree.ordered_begin()->second : propTree);
  for (const boost::property_tree::ptree::value_type& valueType : node.get_child("")) {
    if (valueType.first == nsPrefix + ACFTB_RevA_Type_Names::AC_MSN_Identifier_Name) {
...
std::string ACFTB_RevA_Type::serialize(const uci::type::ACFTB_RevA_Type& accessor, boost::property_tree::ptree& propTree, const std::string& nodeName, const bool createNode, const bool addTypeAttribute, const bool /*checkIfDerivation*/, const bool /*topLevel*/) {
  ...
  if (addTypeAttribute) {
    extjson_uci::util::SerializationHelpers::addTypeAttribute(node, ACFTB_RevA_Type_Names::Extern_Type_Name);
  }
  if (accessor.hasAC_MSN_Identifier()) {
    extjson_uci::util::SerializationHelpers::serializeString(accessor.getAC_MSN_Identifier(), node, ACFTB_RevA_Type_Names::AC_MSN_Identifier_Name);
  }
  if (createNode) {
